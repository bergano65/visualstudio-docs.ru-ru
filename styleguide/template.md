...
- **ms.assetid** — это идентификатор GUID статьи, который используется в целях внутреннего отслеживания, например для бизнес-аналитики. При создании файла Markdown идентификатор GUID можно получить на сайте [https://www.guidgenerator.com](https://www.guidgenerator.com). 
