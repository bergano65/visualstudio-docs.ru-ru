...
Интерфейсы отладки активных скриптов обеспечивают не зависящую от языка и узла отладку, а также поддерживают широкий спектр сред разработки.  
 ...
 ![Процесс основного приложения скрипта](../winscript/media/scp56activdbgarchgif.gif "Scp56ActivDbgArchgif")  
На рисунке 1  
...
## <a name="debugger-ide"></a>Интегрированная среда разработки отладчика  
 Интегрированная среда разработки является не зависящим от языка пользовательским интерфейсом отладки. Служба предоставляет:  
