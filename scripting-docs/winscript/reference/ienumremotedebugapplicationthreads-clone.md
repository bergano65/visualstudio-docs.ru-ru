---
title: 'Иенумремотедебугаппликатионсреадс:: Clone | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Параметры  
 `pperdat`  
 заполняет Возвращает интерфейс `IEnumRemoteDebugApplicationThreads` клона перечислителя.  
