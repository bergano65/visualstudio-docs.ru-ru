---
title: 'IDebugDocumentHelper:: Брингдокументтотоп | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "72577005"
---
# <a name="idebugdocumenthelperbringdocumenttotop"></a>IDebugDocumentHelper::BringDocumentToTop
Переводит этот документ в начало в пользовательском интерфейсе отладчика.  
