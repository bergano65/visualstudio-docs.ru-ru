---
title: 'Иенумдебужекстендедпропертинфо:: Clone | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Параметры  
 `ppEnum`  
 заполняет Возвращает клонированный интерфейс `IEnumDebugExtendedPropertyInfo`.  
