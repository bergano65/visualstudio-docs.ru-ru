---
title: 'IRemoteDebugApplicationEvents:: Онентербреакпоинт | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Параметры  
 `prdat`  
 окне Поток приложения, который вошел в точку останова.  
