---
title: 'Иенумдебугстаккфрамес:: Clone | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Параметры  
 `ppedsf`  
 заполняет Возвращает интерфейс `IEnumDebugStackFrames` клона перечислителя.  
