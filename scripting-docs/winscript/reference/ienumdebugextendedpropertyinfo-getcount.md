---
title: IEnumDebugExtendedPropertyInfo::GetCount | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24727264"
---
# <a name="ienumdebugextendedpropertyinfogetcount"></a>IEnumDebugExtendedPropertyInfo::GetCount
Возвращает число `ExtendedDebugPropertyInfo` структуры в перечислителе.  
...
#### <a name="parameters"></a>Параметры  
 `pcelt`  
 [out] Возвращает число `ExtendedDebugPropertyInfo` структуры в перечислителе.  
