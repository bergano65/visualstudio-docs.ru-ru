---
title: 'Идебугдокументтекст:: Жетконтекстофпоситион | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Параметры  
 ...
 `ppsc`  
 заполняет Объект контекста документа, соответствующий указанному диапазону позиций символа.  
