...
ms.locfileid: "72574449"
---
# <a name="script_e_propagate-error-code"></a>Код ошибки SCRIPT_E_PROPAGATE
Ошибка скрипта распространяется на вызывающий объект, который может находиться в другом потоке. Узел должен передать код ошибки вызывающему объекту.  
