---
title: 'Идебугасинкоператион:: Куерискомплете | Документация Майкрософт'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
## <a name="remarks"></a>Заметки  
 Этот метод определяет, завершена ли операция отладки.  
