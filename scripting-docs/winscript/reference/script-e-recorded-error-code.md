---
title: Код ошибки SCRIPT_E_RECORDED | Документация Майкрософт
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "72574432"
---
# <a name="script_e_recorded-error-code"></a>Код ошибки SCRIPT_E_RECORDED
Между обработчиком скриптов и узлом была передана ошибка. Узлу необходимо передать код ошибки вызывающему объекту.  
