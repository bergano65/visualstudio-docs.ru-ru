---
title: Перечисление PROFILER_HEAP_OBJECT_OPTIONAL_INFO_TYPE | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
|------------|-----------|-----------------|  
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_PROTOTYPE|0x00000001|Сведения о прототип объекта кучи.|  
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_FUNCTION_NAME|0x00000002|Сведения об имени функции кучи объекта.|  
...
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_INTERNAL_PROPERTY|0x00000004|Сведения о куче внутреннего объекта.|  
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_NAME_PROPERTIES|0x00000005|Сведения о свойствах имя кучи объекта.|  
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_INDEX_PROPERTIES|0x00000006|Сведения о свойствах индекс кучи объекта.|  
...
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_RELATIONSHIPS|0x00000009|Сведения о связях кучи объекта.|  
|ROFILER_HEAP_OBJECT_OPTIONAL_INFO_WINRTEVENTS|0x0000000A|Сведения о событиях кучи объекта среды выполнения Windows.|  
|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_MAX_VALUE|PROFILER_HEAP_OBJECT_OPTIONAL_INFO_WINRTEVENTS|Максимальное значение этого перечисления.|