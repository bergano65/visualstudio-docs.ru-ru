...
На этой странице приводятся ссылки на JavaScript, TypeScript и другие технологии на основе ECMAScript.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения о скриптовых интерфейсах Windows</h3>
                    </div>
                </div>
            </div>
        </div>
