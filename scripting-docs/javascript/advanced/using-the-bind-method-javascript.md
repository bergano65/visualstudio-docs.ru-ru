---
title: "Использование метода bind (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# Использование метода bind (JavaScript)
...
## Сохранение контекста выполнения с помощью привязки  
