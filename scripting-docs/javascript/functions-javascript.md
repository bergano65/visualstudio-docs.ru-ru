---
title: "Функции (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
<a name="Rest"></a>   
## Параметры Rest  
 Параметры rest, заданные с помощью оператора spread \(                       ``  \), позволяют преобразовать последовательность аргументов в вызове функции в массив.  
