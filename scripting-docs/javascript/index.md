---
layout: LandingPage
title: "JavaScript в Visual Studio"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Узнайте о новых возможностях JavaScript в Visual Studio 2017</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения о средствах для Apache Cordova</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с универсальными приложениями Windows (UWP)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения о технологиях на основе ECMAScript</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Справочник по языку JavaScript</h3>
                    </div>
                </div>
            </div>
        </div>
