---
title: "Свойство prototype (Number) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
## Заметки  
 Аргумент типа `number` представляет имя числа.  
 ...
 Например, чтобы добавить в объект `Number` метод, возвращающий число \(целое\) разрядов, объявите функцию, добавьте ее в свойство `Number.prototype`, а затем используйте ее.  
