---
title: Функция Math.Asinh (JavaScript) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638424"
---
# <a name="mathasinh-function-javascript"></a>Функция Math.asinh (JavaScript)
Возвращает ареа-синус числа.  
