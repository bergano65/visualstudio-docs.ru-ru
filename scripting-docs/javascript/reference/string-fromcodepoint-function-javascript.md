---
title: Функция String.fromCodePoint (JavaScript) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639264"
---
# <a name="stringfromcodepoint-function-javascript"></a>Функция String.fromCodePoint (JavaScript)
