---
title: "Метод bind (Function) (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
dev_langs: 
  ...
  - "DHTML"
helpviewer_keywords: 
  - "аргументы [JavaScript], bind - метод"
  - "bind - метод [JavaScript]"
  - "параметры [JavaScript], bind - метод"
  - "this - ключевое слово [JavaScript], bind - метод"
...
---
# Метод bind (Function) (JavaScript)
...
#### Параметры  
 ...
 `arg1`\[,`arg2`\[,`argN`\]\]\]  
 Необязательный.  Список аргументов, передаваемых новой функции.  
