---
title: Константа BYTES_PER_ELEMENT (Int32Array) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633964"
---
# <a name="bytesperelement-constant-int32array"></a>Константа BYTES_PER_ELEMENT (Int32Array)
