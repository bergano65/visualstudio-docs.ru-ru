---
title: Константа BYTES_PER_ELEMENT (Int16Array) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24634094"
---
# <a name="bytesperelement-constant-int16array"></a>Константа BYTES_PER_ELEMENT (Int16Array)
