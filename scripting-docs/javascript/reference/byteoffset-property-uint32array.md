---
title: Свойство byteOffset (UInt32Array) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24634084"
---
# <a name="byteoffset-property-uint32array"></a>Свойство byteOffset (UInt32Array)
