---
title: Константа BYTES_PER_ELEMENT (Uint32Array) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633674"
---
# <a name="bytesperelement-constant-uint32array"></a>Константа BYTES_PER_ELEMENT (Uint32Array)
