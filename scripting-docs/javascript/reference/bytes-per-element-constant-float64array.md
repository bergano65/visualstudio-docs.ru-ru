---
title: Константа BYTES_PER_ELEMENT (Float64Array) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24634074"
---
# <a name="bytesperelement-constant-float64array"></a>Константа BYTES_PER_ELEMENT (Float64Array)
