---
title: Функция Math.TANH (JavaScript) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24638664"
---
# <a name="mathtanh-function-javascript"></a>Функция Math.tanh (JavaScript)
...
## <a name="remarks"></a>Примечания  
 Возвращаемое значение равно `(exp(x) - exp(-x))/(exp(x) + exp(-x))`. Если значение `x` равно `NaN`, результат — `NaN`.  
