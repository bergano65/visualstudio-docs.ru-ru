...
#### <a name="parameters"></a>Параметры  
 `target`  
 Обязательно. Объект или функция, которую должен виртуализировать прокси-объект.  
  
 `handler`  
 Обязательно. Объект с методами (перехваты), которые реализуют пользовательское поведение.  
