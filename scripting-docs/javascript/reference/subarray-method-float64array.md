---
title: "Метод subarray (Float64Array) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# Метод subarray (Float64Array)
Получает новое представление Float64Array хранилища [Объект ArrayBuffer](../../javascript/reference/arraybuffer-object.md) для этого массива, указывая первый и последний член подмассива.  
