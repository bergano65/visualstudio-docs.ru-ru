---
title: Свойство byteLength (Uint8ClampedArray) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633214"
---
# <a name="bytelength-property-uint8clampedarray"></a>Свойство byteLength (Uint8ClampedArray)
Только для чтения. Длина данного массива от начала его [ArrayBuffer](../../javascript/reference/arraybuffer-object.md), в байтах, зафиксированная во время создания.  
