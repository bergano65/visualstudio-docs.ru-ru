---
title: Свойство byteLength (UInt32Array) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24633464"
---
# <a name="bytelength-property-uint32array"></a>Свойство byteLength (UInt32Array)
