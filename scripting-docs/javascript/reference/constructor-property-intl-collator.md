---
title: "Свойство constructor (Intl.Collator) | Документы Microsoft"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="constructor-property-intlcollator"></a>Свойство constructor (Intl.Collator)
Указывает функцию, которая создает средства упорядочивания.  
...
## <a name="remarks"></a>Примечания  
 Необходимая `collator` имя средства упорядочивания.  
