---
title: Метод valueOf (Set) (JavaScript) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24641244"
---
# <a name="valueof-method-set-javascript"></a>Метод valueOf (Set) (JavaScript)
