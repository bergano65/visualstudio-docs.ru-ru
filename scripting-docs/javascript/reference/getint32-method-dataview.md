---
title: "Метод getInt32 (DataView) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# Метод getInt32 (DataView)
Получает значение Int32 по указанному смещению в байтах от начала представления.  Ограничения по выравниванию отсутствуют; многобайтовые значения могут извлекаться по любому смещению.  
...
## Параметры  
 `testInt`  
 Обязательный.  Значение Int32, возвращаемое методом.  
...
## Пример  
 В следующем примере показано, как получить первое значение Int32 в DataView.  
