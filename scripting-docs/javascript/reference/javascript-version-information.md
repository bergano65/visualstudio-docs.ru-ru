...
|-------------------|-------------------------------------------------------------------------------------------------------|-------------------------------------------|-------------------------------------------|--------------------------------------------|--------------------------------------------|------------------------|-------------------------|  
|[Свойство \_\_proto\_\_ \(Object\)](../../javascript/reference/proto-property-object-javascript.md)|в|N|N|в|Y|Y|v8 \(Win\): N<br />v8.1 \(Win\): Y<br />v8.1 \(Phone\): Y|  
...
|[Функция acosh](../../javascript/reference/math-acosh-function-javascript.md)|в|N|N|N|в|Y|v8.1: N<br />v10: Y|  
...
|[Функция Array.from \(Array\)](../../javascript/reference/array-from-function-array-javascript.md)|в|N|N|N|N|в|v8.1: N<br />v10: Y|  
|[Функция Array.isArray](../../javascript/reference/array-isarray-function-javascript.md)|в|в|Y|Y|Y|Y|Y|  
|[Функция Array.of \(Array\)](../../javascript/reference/array-of-function-array-javascript.md)|в|N|N|N|N|в|v8.1: N<br />v10: Y|  
|[Объект ArrayBuffer](../../javascript/reference/arraybuffer-object.md)|в|N|в|Y|Y|Y|Y|  
...
|[Функция Object.assign \(Object\)](../../javascript/reference/object-assign-function-object-javascript.md)|в|N|N|N|N|в|v8.1: N<br />v10: Y|  
...
|[Оператор присваивания побитового ИЛИ \(&#124;\=\)](../../javascript/reference/bitwise-or-assignment-operator-decrement-equal-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
|[Оператор побитового ИЛИ \(&#124;\)](../../javascript/reference/bitwise-or-operator-decrement-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
...
|[Функция hypot](../../javascript/reference/math-hypot-function-javascript.md)|в|N|N|N|в|Y|v8.1: N<br />v10: Y|  
...
|[Метод keys \(Array\)](../../javascript/reference/keys-method-array-javascript.md)|в|N|N|N|в|Y|v8.1: N<br />v10: Y|  
...
|[Синтаксис регулярного выражения](http://msdn.microsoft.com/ru-ru/ab0766e1-7037-45ed-aa23-706f58358c0e)|Y|Y|Y|Y|Y|Y|Y|  
...
|[Функция writeln](../../javascript/reference/debug-writeln-function-javascript.md)|Y|Y|Y|Y|Y|Y|Y|  
 ...
 \* Поддерживает объекты DOM, но не поддерживает определяемые пользователем объекты. Атрибуты `enumerable` и `configurable` можно указать, но они не используются.  
