---
title: Свойство constructor (Intl.NumberFormat) | Документы Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636114"
---
# <a name="constructor-property-intlnumberformat"></a>Свойство constructor (Intl.NumberFormat)
...
## <a name="remarks"></a>Примечания  
 Необходимая `numberFormatter` имя модуля форматирования.  
