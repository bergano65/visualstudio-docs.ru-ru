---
title: "Переменные (JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
dev_langs: 
  ...
  - "DHTML"
helpviewer_keywords: 
  - "учет регистра, имя переменной JavaScript"
  - "приведение"
...
## Именование переменных  
 В языке [!INCLUDE[javascript](../javascript/includes/javascript-md.md)] учитывается регистр символов.  Это значит, что имя переменной myCounter отличается от имени переменной MYCounter.  Длина имен переменных ничем не ограничена.  Ниже приведены правила создания допустимых имен переменных.  
...
-   Имя переменной не должно совпадать с [зарезервированным словом](../javascript/reference/javascript-reserved-words.md).  
