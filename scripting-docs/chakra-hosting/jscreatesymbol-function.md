---
title: "Функция JsCreateSymbol | Документы Майкрософт"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="jscreatesymbol-function"></a>Функция JsCreateSymbol
...
#### <a name="parameters"></a>Параметры  
 `description`  
 Строковое описание символа. Может быть равен null.  
