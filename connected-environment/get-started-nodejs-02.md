---
title: Создание среды разработки Node.js с контейнерами с помощью Kubernetes в облаке — шаг 2 — создание среды разработки Kubernetes | Документы Майкрософт
author: ghogen
ms.author: ghogen
ms.date: 02/20/2018
ms.topic: tutorial
...
Предыдущий шаг: [установка средств](get-started-nodejs-01.md)
...
> [Создание контейнера Node.js в Kubernetes](get-started-nodejs-03.md)
