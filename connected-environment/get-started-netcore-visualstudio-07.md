---
title: Создание среды разработки .NET Core с контейнерами с помощью Kubernetes в облаке с Visual Studio — шаг 7 — сводка | Документы Майкрософт
author: ghogen
ms.author: ghogen
ms.date: 04/05/2018
ms.topic: tutorial
...
Предыдущий шаг: [сведения о коллективной разработке](get-started-netcore-visualstudio-06.md)
