---
title: Создание среды разработки .NET Core с контейнерами с помощью Kubernetes в облаке — шаг 1 — установка средств | Документы Майкрософт
author: ghogen
ms.author: ghogen
ms.date: 04/05/2018
ms.topic: tutorial
...
Теперь мы готовы создать среду разработки на базе Kubernetes в Azure.

> [!div class="nextstepaction"]
> [Создание среды разработки в Azure](get-started-netcore-02.md)
