---
title: Ежемесячный кредит Azure
description: Часто задаваемые вопросы, посвященные ежемесячному кредиту Azure.
ms.topic: conceptual
...
ms.locfileid: "81386253"
---
# <a name="azure-monthly-credit"></a>Ежемесячный кредит Azure
