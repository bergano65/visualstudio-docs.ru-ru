...
1. Массовое добавление использует шаблон Microsoft Excel для отправки сведений о подписчиках. В диалоговом окне "Upload Multiple Subscribers" (Отправка нескольких подписчиков) нажмите кнопку **Скачать**, чтобы скачать этот шаблон.
...
> - При первом добавлении группы на портал администрирования администратор должен являться членом клиента AAD.  После добавления группы для изменения членства в группах не требуется участие администратора. 
...
> - Поддерживаются только доверенные соглашения.
