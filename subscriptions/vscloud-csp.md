...
| Категория единицы измерения    |   Имя                 |  Units                                |           Что это                          |
|-------------------|------------------------|---------------------------------------|-------------------------------------------------|
| Visual Studio     | Enterprise             |  Subscription                         | Ежемесячная подписка на Visual Studio Enterprise   |
| Visual Studio     | Professional           |  Subscription                         | Ежемесячная подписка на Visual Studio Professional |
...
Ответ. На данный момент нет. Ваши клиенты могут воспользоваться [расценками на средства для разработки и тестирования Azure](https://azure.microsoft.com/pricing/dev-test/), но мы не предлагаем специальные условия для поставщиков облачных решений.
