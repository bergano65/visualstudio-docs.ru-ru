...
A:  Нет, цены на подписки Visual Studio фиксированы. Покупка и продление подписки стоят одинаково.
...
A: Пока что нет. Ваши клиенты могут воспользоваться [расценками на средства для разработки и тестирования Azure](http://aka.ms/azuredevtestpricing), но мы не предлагаем специальные условия для поставщиков облачных решений.