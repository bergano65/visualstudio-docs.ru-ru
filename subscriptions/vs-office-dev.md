...
- Поставьте первый флажок, чтобы принять условия. 
- Нажмите кнопку **Далее**.
    > [!div class="mx-imgBorder"]
    > ![Регистрации разработчика Office 365](_img\vs-office-dev\vs-office-dev-signup.png)
    
6.  Укажите ваши предпочтения и области интересов и нажмите кнопку **Активировать подписку**.   
    > [!div class="mx-imgBorder"]
    > ![Предпочтения разработчика Office 365](_img\vs-office-dev\vs-office-dev-preferences.png)

7.  Затем вы проверим вашу страну или регион и создадим для вас имя пользователя, домен и пароль.
    > [!div class="mx-imgBorder"]
    > ![Имя пользователя и домен для разработчика Office 365](_img\vs-office-dev\vs-office-dev-domain.png)

8.  Введите свой номер телефона и нажмите кнопку **Отправить код**.  Это позволит нам убедиться в том, что учетная запись создается человеком. 
    > [!div class="mx-imgBorder"]
    > ![Проверка номера телефона разработчика Office 365](_img\vs-office-dev\vs-office-dev-send-code.png)

9.  Введите полученный код и нажмите **Настроить**.
    > [!div class="mx-imgBorder"]
    > ![Подтверждение номера телефона разработчика Office 365](_img\vs-office-dev\vs-office-dev-setup.png)

Вот и все!  Вы увидите страницу с информацией по вашим предпочтениям.  Чтобы получить доступ к подписке разработчика, перейдите на сайт [office.com](https://www.office.com) и войдите с помощью только что созданного идентификатора пользователя и пароля.
