...
1. Перейдите на страницу [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) и войдите на портал подписки.
...
> [!NOTE]
> Чтобы войти на портал https://portal.office.com, используйте идентификатор пользователя для подписки разработчика Office 365, который вы создали ранее на шаге 7.
