---
title: "Подписки Visual Studio MPN (Microsoft Partner Network) | Документация Майкрософт"
Author: evanwindom
Ms.author: jaunger
Manager: evelynp
Ms.date: 12/11/2017
...
---
# <a name="managing-visual-studio-subscriptions-included-with-microsoft-partner-network-mpn-memberships"></a>Управление подписками Visual Studio, которые предоставляются членам программы Microsoft Partner Network (MPN)

## <a name="overview"></a>Обзор

Количество и уровень подписок Visual Studio будет разным в зависимости от уровня членства в программе Microsoft Partner Network (MPN). Эти различия описаны на странице [основных преимуществ](https://partner.microsoft.com/membership/core-benefits) MPN.  Чтобы использовать подписку, обратитесь к администратору программы и убедитесь, что подписки Visual Studio вам предоставляются.  

## <a name="resources--references"></a>Ресурсы и ссылки
...
## <a name="high-level-assignment--access-flow"></a>Обобщенная процедура назначения и доступа
...
11. Назначенное лицо получает доступ через портал [https://my.visualstudio.com](https://my.visualstudio.com?wt.mc_id=o~msft~docs).
...
3. Выберите **подписки MSDN** (Примечание. ожидается обновление подписок Visual Studio).
4. Найдите нужное **лицо**.
5. Щелкните **Отправить**.
6. Выбранное лицо получит сообщение по электронной почте.
7. Назначенное лицо получает доступ через портал [https://my.visualstudio.com](https://my.visualstudio.com?wt.mc_id=o~msft~docs).
