...
Ответ.  Да.  Сообщение указывает, что вы выполнили вход в домен, который уже имеет активные арендаторы Microsoft 365, администратором которых вы не являетесь.  Чтобы добавить Power BI Pro в клиент, необходимо быть администратором этого клиента.  Чтобы устранить эту проблему, выполните следующие действия по созданию собственного клиента.
