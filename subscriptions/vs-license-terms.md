...
3. **ДОПОЛНИТЕЛЬНЫЕ УСЛОВИЯ ЛИЦЕНЗИИ.** Приведенные ниже условия применяются к программному обеспечению, предоставляемому вместе с подпиской. 
   ...
   ж. **Карты Bing.** Это программное обеспечение может включать использования Карт Bing. Любое содержимое, предоставляемое посредством Карт Bing, включая геокоды, разрешено использовать только в том продукте, через который эти данные были предоставлены. Использование Карт Bing клиентом регулируется условиями использования Карт Bing для конечных пользователей, которые опубликованы по адресу [http://go.microsoft.com/?linkid=9710837](http://go.microsoft.com/?linkid=9710837), и заявлением о конфиденциальности Карт Bing, которое опубликовано по адресу [http://go.microsoft.com/fwlink/?LinkID=248686](http://go.microsoft.com/fwlink/?LinkID=248686).
