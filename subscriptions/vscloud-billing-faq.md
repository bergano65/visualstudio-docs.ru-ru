...
### <a name="q-can-i-buy-visual-studio-cloud-subscriptions-using-a-purchase-order"></a>Вопрос. Можно приобрести облачные подписки Visual Studio по заказу на покупку?
...
Ответ. Можно использовать почти все подписки Azure — подписки Azure, подключенные к вашему [соглашению Enterprise (EA)](https://azure.microsoft.com/pricing/enterprise-agreement/), подписки Azure, настроенные поставщиками облачных решений (CSP), подписки Azure, настроенные торговыми посредниками по программе Microsoft Open License, подписки Azure с оплатой по мере использования и даже подписки Azure, которые подписчики Visual Studio настраивают в качестве преимущества (но нельзя использовать ваш ежемесячный кредит для оплаты дополнительных подписок Visual Studio ).

Единственное важное исключение — вы не можете использовать [бесплатную пробную версию Azure](https://azure.microsoft.com/pricing/free-trial/).

### <a name="q-am-i-required-to-buy-other-azure-services"></a>Вопрос. Мне нужно приобретать другие службы Azure?
...
### <a name="q-can-i-use-an-enterprise-agreement-to-buy-visual-studio-cloud-subscriptions"></a>Вопрос. Я могу использовать соглашение Enterprise для приобретения облачных подписок Visual Studio?

Ответ. Да. Необходимо быть владельцем или участником подписки Azure, созданной для вашего соглашения Enterprise. Убедитесь, что приобретаете облачные подписки Visual Studio непосредственно в Visual Studio Marketplace. Нельзя приобретать облачные подписки Visual Studio по заказу на покупку. 
...
Ответ. Самый простой способ определить, есть ли у вас необходимые разрешения, — нажать кнопку **Купить** в Visual Studio Marketplace. Необходимо выбрать подписку Azure (которая является учетной записью для выставления счетов) из представленного списка подписок Azure, привязанных к вашему имени входа. Поскольку по умолчанию в качестве имени подписки Azure используется тип учетной записи для выставления счетов ("Оплата по мере использования", "Соглашение Enterprise" и т. д.), часто бывает очевидно, входит ли ваша подписка Azure в соглашение Enterprise.

Еще один способ — попытаться войти на [Azure Enterprise Portal](http://ea.azure.com).  Если вы можете войти, значит, у вас уже есть роль администратора предприятия или владельца учетной записи. Только владелец учетной записи может настроить новые учетные записи Azure для выставления счетов в соглашении Enterprise. Если вам не удается войти на Azure Enterprise Portal, узнайте, кто является администратором вашего предприятия, и попросите его добавить вас в качестве владельца учетной записи на Azure Enterprise Portal.  Если вы не можете найти этого человека, [отправьте запрос в службу поддержки](http://aka.ms/AzureEntSupport) и запросите контактные данные.  В запросе в службу поддержки требуется указать название вашей организации и номер регистрации соглашения Enterprise.
...
Ответ. Нет, вы не можете использовать ваш [ежемесячный кредит Azure](https://azure.microsoft.com/pricing/member-offers/credit-for-visual-studio-subscribers/) как подписчик Visual Studio для оплаты покупок в Visual Studio Marketplace. Все облачные подписки Visual Studio вы оплачиваете с кредитной карты.
...
### <a name="q-can-i-buy-visual-studio-cloud-subscriptions-from-my-software-reseller"></a>Вопрос. Можно приобрести облачные подписки на Visual Studio у торгового посредника?

Ответ. Да, можно, если торговый посредник участвует в программе для поставщиков облачных решений (CSP). Просто спросите у своего торгового посредника.
...
* [Visual Studio Professional — годовая подписка](https://marketplace.visualstudio.com/items?itemName=ms.vs-professional-annual)
* [Visual Studio Enterprise — месячная подписка](https://marketplace.visualstudio.com/items?itemName=ms.vs-enterprise-monthly)
* [Visual Studio Enterprise — годовая подписка](https://marketplace.visualstudio.com/items?itemName=ms.vs-enterprise-annual)
