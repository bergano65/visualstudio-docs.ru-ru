...
Плата за использование персонального кредита для разработки и тестирования Azure не взимается, и кредитная карта не требуется. При исчерпании месячного кредита вы не сможете больше использовать ресурсы Azure до сброса кредита в следующем месяце или удаления предельной суммы расходов и добавления метода оплаты.  

## <a name="how-to-activate-azure-monthly-credit"></a>Как активировать ежемесячный кредит Azure
