...
1. Найдите элемент "Приложения Microsoft 365 для предприятий" и щелкните **Активировать**.
...
1. В диалоговом окне "Создайте идентификатор пользователя" создайте имя пользователя и пароль для своего клиента, а затем щелкните **Создать учетную запись**.
   > [!div class="mx-imgBorder"]
...
1. После успешного создания учетной записи вы увидите диалоговое окно со ссылкой на страницу входа для портала Office и новым идентификатором пользователя.  Запишите эти сведения для последующего использования и щелкните **Начать установку**, чтобы начать установку приложений Microsoft 365.
   > [!div class="mx-imgBorder"]
