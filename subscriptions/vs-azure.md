...
A:  Сообщение об инциденте службу поддержки на портале Azure включает три шага.
...
A:  Вы получили это сообщение, так как используете преимущества Azure, связанные с вашей подпиской Visual Studio, и у этой подписки истек срок действия либо она была удалена.  Чтобы продолжить использование Azure, у вас есть несколько вариантов:
