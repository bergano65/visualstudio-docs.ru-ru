...
Когда вы получите **идентификатор контракта** и **идентификатор доступа**, вы можете отправить заявку на техническую поддержку [через Интернет](https://support.microsoft.com/oas/) или на портале [Azure](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/overview) или по телефону службы поддержки в вашей стране. Если вы отправите заявку через Интернет, представитель службы технической поддержки Майкрософт может вам перезвонить.
