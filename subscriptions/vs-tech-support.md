...
Описания на уровне продукта: разверните узел **Недоступные планы поддержки**, если видите, что план поддержки не может использоваться для поддержки указанного продукта (код 8). Договор о поддержке нельзя использовать для выбранной версии продукта.
