...
4. После завершения процесса вы получите электронное письмо с **идентификатором контракта** и **идентификатором доступа**, которые вы будете указывать при создании обращения в службу поддержки.
