...
ms.locfileid: "39078957"
---
# <a name="shader-designer"></a>Конструктор шейдеров

Этот документ описывает, как работать с конструктором шейдеров [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] для создания, изменения и экспорта пользовательских визуальных эффектов, также называемых *шейдерами*.
...
В этом разделе рассматривается, как добавить в проект [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] шейдер DGSL, а также приводятся основные сведения, которые помогут приступить к работе.
...
Команды, влияющие на состояние конструктора шейдеров, находятся на панели инструментов **Режим конструктора шейдеров** в главном окне [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. Средства проектирования и команды расположены на панели инструментов **Конструктор шейдеров** в области конструктора шейдеров.
...
|Заголовок|Описание:|
|-----------|-----------------|
|[Работа с трехмерными ресурсами для игр и приложений](../designers/working-with-3-d-assets-for-games-and-apps.md)|Обзор средств в [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)], которые можно использовать для работы с текстурами и изображениями, трехмерными моделями и эффектами шейдеров.|
...
|[Редактор моделей](../designers/model-editor.md)|Описывается использование редактора моделей [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] для работы с трехмерными моделями.|