...
|[Использование трехмерных ресурсов в игре или приложении](../designers/using-3-d-assets-in-your-game-or-app.md)|Описывается, как применять [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] для обработки трехмерных ресурсов при сборке проекта или решения, чтобы подготовить их к использованию в приложении. Кроме того, рассматриваются стратегии загрузки различных видов ресурсов в приложении.|
