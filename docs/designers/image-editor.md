...
|**Trim**|Усекает изображение до границ активного выделения.|
...
|**Текст**|**Сглаживание**<br /> Рисует текст со сглаженными краями. Это придает тексту более плавный вид.<br /><br /> **Value**<br /> Текст для отрисовки.<br /><br /> **Шрифт**<br /> Шрифт, который используется для отрисовки текста.<br /><br /> **Размер**<br /> Размер текста.<br /><br /> **Полужирный**<br /> Делает шрифт полужирным.<br /><br /> **Курсив**<br /> Выделяет шрифт курсивом.<br /><br /> **Подчеркнутый**<br /> Делает шрифт подчеркнутым.|
