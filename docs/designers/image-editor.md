...
ms.locfileid: "38978467"
---
# <a name="image-editor"></a>редактор изображений

В этом документе рассматривается, как работать с редактором изображений Visual Studio для просмотра и изменения ресурсов изображений и текстур.
...
### Свойства изображения<a name="ImageProperties"></a>
...
### <a name="work-with-tools"></a>Работа с инструментами
...
CTRL&mdash;Копирует содержимое выбранной области до изменения ее размера. Исходное изображение при этом остается неизменным; изменяется размер копии.

SHIFT&mdash;Изменяет размер выбранной области пропорционально ее исходным размерам.

ALT&mdash;Изменяет размер области выделения. Изображение при этом остается неизменным.
...
#### Свойства инструмента<a name="ToolProperties"></a> 
...
|**Text**|**Сглаживание**<br /> Рисует текст со сглаженными краями. Это придает тексту более плавный вид.<br /><br /> **Значение**<br /> Текст для отрисовки.<br /><br /> **Шрифт**<br /> Шрифт, который используется для отрисовки текста.<br /><br /> **Size**<br /> Размер текста.<br /><br /> **Полужирный**<br /> Делает шрифт полужирным.<br /><br /> **Курсив**<br /> Выделяет шрифт курсивом.<br /><br /> **Подчеркнутый**<br /> Делает шрифт подчеркнутым.|
|**Двумерный примитив**|**Сглаживание**<br /> Рисует примитивы со сглаженными краями. Это придает им более плавный вид.<br /><br /> **Толщина**<br /> Определяет толщину линии, формирующей границу примитива.<br /><br /> **Радиус X**<br /> (Скругленный прямоугольник.) Определяет радиус закругления для верхнего и нижнего краев примитива.<br /><br /> **Радиус Y**<br /> (Скругленный прямоугольник.) Определяет радиус закругления для левого и правого краев примитива.|
...
|Увеличить|**CTRL**+**Прокручивание колеса мыши вперед**<br /><br /> **CTRL**+**PageUp**<br /><br /> Знак плюса (**+**)|
|Мельче|**CTRL**-**Прокручивание колеса мыши назад**<br /><br /> **CTRL**-**PageDown**<br /><br /> Знак минуса (**-**)|
