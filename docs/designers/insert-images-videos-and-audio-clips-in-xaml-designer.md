---
title: "Вставка изображений, видео- и аудиоклипов в конструкторе XAML | Документы Майкрософт"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Изображения, видео и аудиоклипы делают ваше приложение более зрелищным.  
 ...
 ![Изображения, подобранные по размеру](../designers/media/b5_memory_images_sized.png "b5_memory_images_sized")  
