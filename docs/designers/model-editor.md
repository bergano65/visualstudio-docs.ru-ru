...
### <a name="model-editor-toolbars"></a>Панели инструментов редактора моделей  
 ...
 Команды, влияющие на состояние редактора моделей, находятся на панели инструментов **Режим редактора моделей** в главном окне [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. Инструменты моделирования и скриптовые команды расположены в панели инструментов **Редактор моделей** в области конструктора редактора моделей.  
