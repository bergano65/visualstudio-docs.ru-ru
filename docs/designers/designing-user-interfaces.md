...
|Разработка классических приложений, использующих язык XAML в стиле WPF | [Начало работы с Windows Presentation Foundation](../designers/getting-started-with-wpf.md) |
