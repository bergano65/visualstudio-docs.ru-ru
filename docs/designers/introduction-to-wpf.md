...
WPF существует в виде подмножества типов .NET, которые (в большинстве случаев), находятся в <xref:System.Windows> пространства имен. Если вы ранее создавали приложения с помощью .NET с помощью управляемых технологий, таких как ASP.NET и Windows Forms, основные принципы программирования WPF должны быть вам знакомы: Создание экземпляров классов, задать свойства, вызываете методы и обрабатываете события — с помощью своего любимого .NET языка программирования, таких как C# или Visual Basic.
