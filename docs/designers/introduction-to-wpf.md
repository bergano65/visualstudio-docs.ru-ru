---
title: "Введение в WPF | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
```  
 ...
 Этот код XAML определяет окно и кнопку с помощью элементов `Window` и `Button` соответственно. Каждый элемент настраивается с помощью атрибутов, например атрибута `Title` элемента `Window`, определяющего текст заголовка окна. Во время выполнения WPF преобразует элементы и атрибуты, определенные в разметке, в экземпляры классов WPF. Например, элемент `Window` преобразуется в экземпляр класса <xref:System.Windows.Window>, свойство <xref:System.Windows.Window.Title%2A> которого является значением атрибута `Title`.  
...
##  <a name="Controls"></a> Элементы управления  
 ...
 Более подробную информацию см. в разделе [Элементы управления](../Topic/Controls.md).  
...
### Двумерные фигуры  
 ...
 ![Окно с текстом “you clicked the ellipse&#33;”](../designers/media/wpfintrofigure12.png "WPFIntroFigure12")  
