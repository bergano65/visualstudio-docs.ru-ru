...
- **NuGet:** управление пакетами NuGet возможно как в Visual Studio, так и в Blend для Visual Studio. NuGet — это диспетчер пакетов для .NET, которая упрощает установку и удаление пакетов в решении.
