...
Выберите элемент управления и в окне **Свойства** **, найдите свойство **Стиль** или **Шаблон**. Выберите **Дополнительные параметры**, а затем выберите в контекстном меню пункт **Сброс**.
