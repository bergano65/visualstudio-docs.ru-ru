...
1. Присвойте приложению имя, например *MyAndroidApp*, а затем нажмите **OK**.
   ...
   ![Проект Native Activity в обозревателе решений](../cross-platform/media/cppmdd_rc_na_solutionexp.PNG "CPPMDD_RC_NA_SolutionExp")
...
1. Выберите пункт **x86** из раскрывающегося списка **Платформы решения** , если он еще не выбран.
     ...
     ![Выбор x86 из раскрывающегося списка решений платформ](../cross-platform/media/cppmdd_rc_na_solution_x86.png "CPPMDD_RC_NA_Solution_x86")
...
1. Нажмите **F5**, чтобы начать отладку, или **Shift**+**F5** для запуска без отладки.
   ...
   ![Эмулятор, выполняющий ваше приложение](../cross-platform/media/cppmdd_emulator_running_app.PNG "CppMDD_Emulator_Running_App")
