...
-   **Интеграция:**
    ...
    -   Исправлены проблемы с повторной загрузкой и функциями Intellisense проекта, которые возникали при добавлении или удалении скриптов, расположенных в первом проекте.
