---
title: "Требования к системе для эмулятора Visual Studio для Android | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
-   64\-разрядная версия профессионального выпуска Windows 8, Windows 8.1, Windows 10 или более поздней версии  
 ...
 ![Проверьте требования к системе](../cross-platform/media/android_emu_system_requirements.png "Android\_Emu\_System\_Requirements")  
...
>  После входа в группу выйдите из системы или выполните перезагрузку, чтобы изменения вступили в силу.  
 ...
 ![Присоединение к группе безопасности администраторов Hyper&#45;V ](../cross-platform/media/android_emu_hyperv_admin.png "Android\_Emu\_HyperV\_Admin")  
...
##  <a name="BootableVHD"></a> Запуск эмулятора с загрузочного виртуального жесткого диска не поддерживается  
 ...
 Такая конфигурация не поддерживается. Информацию о связанных проблемах см. в разделе [Устранение неполадок в эмуляторе Visual Studio для Android](../cross-platform/troubleshooting-the-visual-studio-emulator-for-android.md).  
