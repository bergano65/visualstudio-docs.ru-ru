...
- **Унифицированный процесс отладки.** Используйте средства отладки мирового класса в Visual Studio для просмотра и пошагового выполнения C++ кода на всех платформах: устройствах и эмуляторах Android, симуляторах и устройствах iOS, а также устройствах и эмуляторах Windows или Windows Storе.
