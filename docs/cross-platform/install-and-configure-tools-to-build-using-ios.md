...
-   В приложении "Терминал" на компьютере Mac введите следующую команду:  
 ...
 ![Использование vcremote для создания безопасного ПИН-кода](~/docs/cross-platform/media/cppmdd_vcremote_generateclientcert.png "CPPMDD_vcremote_generateClientCert")  
...
7.  Выберите **Связать**, чтобы активировать сопряжение.  
     ...
     ![Настройка подключения vcremote для сборок iOS](~/docs/cross-platform/media/cppmdd_options_ios.PNG "CPPMDD_Options_iOS")  
