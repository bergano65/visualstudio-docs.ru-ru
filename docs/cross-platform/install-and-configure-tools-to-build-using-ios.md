...
- Компьютер Mac с операционной системой OS X Mavericks (версии 10.9) или более поздней версии.
...
- [Xcode](https://developer.apple.com/xcode/downloads/) версии 6 или более поздней.
...
- [Node.js](https://nodejs.org/)
   ...
   Установите последнюю версию Node.js (8.x) на компьютере Mac, которая выпускается в цепочке Long Term Support (LTS). Обратите внимание, что другие последние версии могут не поддерживать некоторые модули vcremote, что может привести к сбою установки vcremote.
