---
title: Установка и настройка средств для разработки с помощью iOS | Документация Майкрософт
ms.custom: ''
ms.date: 10/17/2019
...
- [Node.js](https://nodejs.org/) 8.11.3 и npm версии 5.6.0.
   ...
   Установите версию Node.js 8.11.3 на своем компьютере Mac. Если вы установите пакет Node.js, он должен сопровождаться npm версии 5.6.0. Другие версии Node.js и npm могут не поддерживать некоторые модули, используемые в удаленном агенте `vcremote`, что может привести к сбою установки `vcremote`.
