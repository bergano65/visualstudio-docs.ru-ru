...
-   версия **Visual Studio** , поддерживающая расширение, например Visual Studio Community, Professional, Premium или Enterprise (скачать Visual Studio Community можно бесплатно);
     ...
     [Скачать Visual Studio Community](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017)
...
> [!NOTE]
>  Для Visual Studio 2017 VSTU 3 включает рабочую нагрузку Unity, которую можно выбрать из установщика.
...
#### <a name="2---configure-unity-editor-to-use-visual-studio-tools-for-unity"></a>2. Настройка редактора Unity для использования набора средств Visual Studio для Unity
 ...
 ![Импорт пакета VSTU в проект Unity.](../cross-platform/media/vstu_configure_unity_import_vstu.png "vstu_configure_unity_import_vstu")
