...
##  <a name="a-nameprereqa-pre-requisites"></a><a name="prereq"></a> Предварительные требования  
  
1.  Учетная запись Xamarin: перейдите по адресу [https://www.xamarin.com/](https://www.xamarin.com/), нажмите кнопку **Войти** в верхнем правом углу страницы, а затем щелкните элемент **Создать учетную запись** на появившейся странице. Выберите адрес электронной почты и пароль для учетной записи Xamarin; они понадобятся вам позднее.  
...
##  <a name="a-namewindowsa-windows-setup-visual-studio-and-xamarin"></a><a name="windows"></a> Настройка Windows (Visual Studio и Xamarin)  
