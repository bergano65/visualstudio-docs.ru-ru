...
* Используйте **IntelliTrace** для сбора журнала звонков и событий с сервера релиза. Ознакомьтесь со статьей [Отладка опубликованной облачной службы с помощью IntelliTrace и Visual Studio](vs-azure-tools-IntelliTrace-debug-published-cloud-services.md).
