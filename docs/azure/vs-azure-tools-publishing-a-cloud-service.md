...
1. Чтобы создать пакет службы, выполните следующие действия.
   ...
   Б. В диалоговом окне **Пакет приложения Azure** выберите конфигурацию службы, для которой требуется создать пакет, а затем выберите конфигурацию построения.
