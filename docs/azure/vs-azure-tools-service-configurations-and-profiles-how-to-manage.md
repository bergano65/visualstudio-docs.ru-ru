...
* Если вы хотите изменить конфигурацию службы, откройте контекстное меню для роли, которую нужно изменить в проекте Azure, и выберите пункт **Свойства**. См. практическое руководство по [ настройке ролей для облачной службы Azure в среде Visual Studio](vs-azure-tools-configure-roles-for-cloud-service.md).
