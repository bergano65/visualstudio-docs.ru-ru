...
**Используют старый C# и вычислители выражений VB**: отладчик будет использовать Visual Studio 2013 C#или Visual Basic, а не вычислители выражений на основе Visual Studio 2015 Roslyn.    
...
- **Применить изменения при продолжении (только машинный код)**: Visual Studio автоматически компилирует и применяет необработанные изменения кода внесенные при продолжении процесса из состояния приостановки. Если не выбран, вы можете применить изменения с помощью **применить изменения кода** раздел **Отладка** меню.  
