...
**Включить средства разработчика Microsoft Edge для приложений JavaScript UWP (экспериментальная функция)** Включает средства разработки для приложений универсальной платформы Windows JavaScript в Edge.
