...
**Используйте новый помощник по исправлению ошибок**: включает по исправлению, которая заменяет помощник по исключениям. (Помощник по исправлению ошибок поддерживается начиная с Visual Studio 2017)
