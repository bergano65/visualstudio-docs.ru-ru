...
**Включить вычисление быстрый выражений (только управляемый код)** : Позволяет отладчику попыток более быструю оценку, имитируя выполнение простых свойств и методов.
::: moniker-end
