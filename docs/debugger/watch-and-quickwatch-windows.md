...
При отладке, можно использовать **Контрольные значения** и **Быстрая проверка** windows возможность контролировать значения переменных и выражений.  Отличие в том, что в окне **Контрольные значения** могут одновременно выводиться несколько переменных, а в окне **Быстрая проверка** — только одна. 

Windows доступны только во время сеанса отладки. Чтобы открыть **Контрольные значения** окно, выберите **Отладка > Windows > Контрольные значения > Контрольные значения (1, 2, 3, 4)**). Чтобы открыть **Быстрая проверка** окна, или щелкните правой кнопкой мыши на переменную, а выберите **Быстрая проверка** или выберите **Отладка > Быстрая проверка**.
...
3.  Откройте **Быстрая проверка** окна (щелкните правой кнопкой мыши `a`, выберите **Быстрая проверка**, или выберите `a` и нажмите клавишу **клавиши SHIFT + F9**).
