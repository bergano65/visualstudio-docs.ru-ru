---
title: "Список событий графики | Microsoft Docs"
ms.custom: ""
ms.date: "12/08/2016"
...
Список событий графики в анализаторе графики Visual Studio служит для изучения событий Direct3D, возникших при отрисовке определенного кадра игры или приложения.  
 ...
 ![Список событий, имя которых включает "Index"](../debugger/media/gfx_diag_demo_event_list_orientation.png "gfx_diag_demo_event_list_orientation")  
...
|![Значок события рисования](../debugger/media/vsg_eventlist_icon_draw.png "vsg_eventlist_icon_draw")|Событие Draw<br /> Указывает на событие Draw, произошедшее во время захваченного кадра.|  
|![Пользовательский значок маркера событий](../debugger/media/vsg_eventlist_icon_user.png "vsg_eventlist_icon_user")|Пользовательская группа событий<br /> Группа связанных событий, определенная приложением.|  
|![Пользовательский значок маркера событий](../debugger/media/vsg_eventlist_icon_user.png "vsg_eventlist_icon_user")|Пользовательский маркер события<br /> Помечает расположение, определенное приложением.|  
...
|---------------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------|  
|Проверка доступности пользовательского события|[PIXGetStatus](http://msdn.microsoft.com/ru-ru/f7ebd985-fb5d-46d7-abec-099df4b9be0e)|[PIXGetStatus](http://msdn.microsoft.com/ru-ru/1046ac43-a0a3-42bf-bae8-14aa72fa7567)|  
|Начало группы событий|[PIXBeginEvent](http://msdn.microsoft.com/ru-ru/5f51fff7-f313-4558-965b-2a443653cd7b)|[PIXBeginEvent](http://msdn.microsoft.com/ru-ru/4ddb3311-b9b5-449a-bbfb-7634e0d56e87)|  
|Завершение группы событий|[PIXEndEvent](http://msdn.microsoft.com/ru-ru/fb526bf2-c17d-4a2a-8665-3b577a0f7fba)|[PIXEndEvent](http://msdn.microsoft.com/ru-ru/a3cd34a9-9dd9-40e1-ae86-0214b25ff185)|  
|Создание маркера события|[PIXSetMarker](http://msdn.microsoft.com/ru-ru/0caf49ed-c99d-405e-89f4-0c887b8474ad)|[PIXSetMarker](http://msdn.microsoft.com/ru-ru/6610e5b9-a0c5-4236-b551-b6eb9fac64c1)|  
