...
2. В правой части диалогового окна **приложения & компоненты** выберите **Управление дополнительными компонентами** (в разделе **приложения & функции**).
