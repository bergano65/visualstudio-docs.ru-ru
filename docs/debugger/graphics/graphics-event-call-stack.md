...
|Столбец|Описание|  
|------------|-----------------|  
|**Имя**|Символ, который однозначно определяет функцию, содержащую место вызова. Отладочный символ для функции отображается, если он доступен; в противном случае отображается смещение функции.|  
...
### <a name="links-to-graphics-objects"></a>Ссылки на графические объекты  
 Для анализа выбранного события графики могут понадобиться сведения об объектах Direct3D, с которыми оно связано. **Стек вызовов событий графики** окна ссылки на эти сведения.  
