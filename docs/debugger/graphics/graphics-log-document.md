...
## <a name="playback-machine"></a>Компьютер воспроизведения
 ...
 Сведения о способах указания компьютера воспроизведения см. в разделе [как: изменить компьютер воспроизведения диагностики графики](how-to-change-the-graphics-diagnostics-playback-machine.md).
 ...
 **Сведения Direct3D** выводит сведения о возможностях оборудования и драйвера видеоадаптера, который использовался во время сеанса захвата.
 ...
 **Отобразить сведения** выводит сведения о видеоадаптере, который использовался во время сеанса захвата.
 ...
 **Поэкспериментировать файле** выводит сведения о файле эксперимента, связанный с сеансом захвата.

|Свойство|Описание|
|--------------|-----------------|
|**Путь**|Путь к файлу VSGLOG. **Примечание.**  В устаревшем режиме захвата это свойство не используется.|

 **Сведения о модуле** указаны имя и версия библиотеки динамической компоновки (DLL), которые были загружены приложением во время сеанса захвата.

 **Сведения о системе** выводит сведения об оборудовании и операционной системы, в которой размещено приложение во время сеанса захвата.
 ...
 **Целевое приложение** выводит сведения о приложении, которое подлежит захвату.
 ...
 **Файл журнала VSG** вывод информации о документа журнала графики.
