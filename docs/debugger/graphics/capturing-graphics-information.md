---
title: Запись сведений о графике | Документация Майкрософт
ms.date: 02/09/2017
ms.topic: conceptual
f1_keywords:
- vs.graphics.frame
...
- В строке меню выберите **Отладка**, **графика**, **начать отладку графики**. (Сочетание клавиш: Alt+F5)
...
- В Visual Studio на панели инструментов **графика** нажмите кнопку **записать кадр** ![значок записи графики](media/debuggingdirectxgraphics.png "дебуггингдиректксграфикс").
