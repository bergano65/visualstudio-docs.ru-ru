...
Файлы скриптов на стороне сервера отображаются в обозревателе решений. Клиентские файлы скриптов отображаются только в режиме отладки или режиме приостановки. Файлы сценария на стороне клиента отображаются в **документы скриптов** узла.

> [!NOTE]
> До [!INCLUDE[vs_dev11_long](../data-tools/includes/vs_dev11_long_md.md)], клиентский сценарий файлы, созданные из серверных скриптов, появлялись в окно обозревателя скриптов.
