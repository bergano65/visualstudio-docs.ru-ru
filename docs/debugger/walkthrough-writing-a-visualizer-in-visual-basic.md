...
2. В **новый проект** выберите **Visual Basic**.

3. В разделе **.NET Standard**, нажмите кнопку **библиотеки классов**.
...
2. В **Добавление нового проекта** выберите **Visual Basic**, а затем нажмите кнопку **консольное приложение**.
