...
#### Статистическая значимость  
 ...
 ![Статистическая релевантность варианта вызова рисования](~/debugger/graphics/media/pix_frame_analysis_summary_stats.png "pix\_frame\_analysis\_summary\_stats")  
