...
1.  Для запуска процесса сбора данных откройте окно командной строки PowerShell с правами администратора, а затем выполните следующую команду:  
     ...
     `Start-IntelliTraceCollection` `"` *\<Пул приложений >* `"`  *\<Путь_к_плану_сбора >*  *\<FullPathToITraceFileDirectory >*  
...
1.  Для запуска приложения и одновременного сбора данных используйте следующий синтаксис:  
     ...
     *\<FullPathToIntelliTraceCollectorExecutable >* `\IntelliTraceSC.exe launch /cp:`  *\<Путь_к_плану_сбора >* `/f:`  *\< FullPathToITraceFileDirectoryAndFileName >*  *\<Путь_к_исполняемому_файлу_приложения_и_его_имя >*  
