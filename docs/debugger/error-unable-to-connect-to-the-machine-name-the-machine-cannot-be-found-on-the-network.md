---
title: 'Ошибка: не удалось подключиться к компьютеру &lt;name &gt;. Не удается найти компьютер в сети. | Документы Майкрософт'
ms.date: 11/04/2016
...
---
# <a name="error-unable-to-connect-to-the-machine-ltnamegt-the-machine-cannot-be-found-on-the-network"></a>Ошибка: не удалось подключиться к компьютеру &lt;name &gt;. Не удается найти компьютер в сети.
