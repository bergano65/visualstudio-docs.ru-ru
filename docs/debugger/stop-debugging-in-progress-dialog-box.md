---
title: Диалоговое окно "завершение отладки" | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.debug.stopnow
