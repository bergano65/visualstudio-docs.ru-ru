...
## <a name="in-this-section"></a>В этом разделе
 [Вкладка «Windows», диалоговое окно "Параметры сообщения"](../debugger/windows-tab-message-options-dialog-box.md) позволяет выбрать типы сообщений, чтобы получить список. Включает инструмент поиска.

 [Сообщения вкладке диалогового окна "Параметры сообщения"](../debugger/messages-tab-message-options-dialog-box.md) используется для выбора типов сообщений для просмотра.

 [Выходные данные вкладки, диалоговое окно "Параметры сообщения"](../debugger/output-tab-message-options-dialog-box.md) используется для указания данных сообщения для отображения.

## <a name="related-sections"></a>Связанные разделы
 [Диалоговое окно поиска сообщения](../debugger/message-search-dialog-box.md) используется для поиска узла для конкретного сообщения в представлении сообщения.
