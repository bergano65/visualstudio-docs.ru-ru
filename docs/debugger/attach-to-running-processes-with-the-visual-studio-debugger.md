...
|Отладка C#, Visual Basic или C++ приложения на локальном компьютере|Использовать [стандартный отладки](../debugger/getting-started-with-the-debugger.md) или **присоединение к процессу**|*\<имя_приложения > .exe*|В большинстве случаев использовать стандартный отладку и не **присоединение к процессу**.|
