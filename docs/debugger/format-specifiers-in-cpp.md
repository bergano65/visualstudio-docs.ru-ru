...
|sub|Строка Юникода (кодировка UTF-16) (без кавычек)|\<расположение > L «hello world»|Здравствуй, мир!|  
|bstr|Строка BSTR|\<расположение > L «hello world»|L"Здравствуй, мир!"|  
|env|Блок среды (нулем строку double null)|\<расположение > L "=:: =::\\\\"|L "=:: =::\\\\\\0 = C: = C:\\\\windows\\\\system32\\0ALLUSERSPROFILE =...|
...
|hr|Код ошибки HRESULT или Win32<br/>(Отладчик декодирует значения HRESULT автоматически,<br/> Поэтому описатель в этих случаях не требуется.|S_OK|S_OK|  
