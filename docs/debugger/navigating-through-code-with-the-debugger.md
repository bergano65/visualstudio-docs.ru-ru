...
Чтобы запустить приложение с подключенным отладчиком, нажмите клавишу **F5**, выберите **Отладка** > **начать отладку**или нажмите зеленую стрелку на панели инструментов Visual Studio.
...
Во время отладки желтым цветом отображается строка кода, которая будет выполнена далее.
 ...
 ![&#95;Основы&#95;режима приостановки&#95;dbg](../debugger/media/dbg_basics_break_mode.png "Режим приостановки выполнения")
...
Чтобы останавливаться на каждой строке кода или инструкции во время отладки, используйте**шаг** **отладки** > или нажмите клавишу **F11**.
...
При вызове вложенных функций команда **Шаг с заходом** позволяет попасть в самую глубокую вложенную функцию. Например, если вы используете **Шаг с заходом** в вызове `Func1(Func2())`Like, отладчик пошагов в функцию. `Func2`
...
Чтобы задать простую точку останова в коде, щелкните крайнее левое поле рядом с строкой кода, в которой нужно приостановить выполнение. Можно также выбрать линию и нажать клавишу **F9**, выбрать **отладку** > **переключения точек останова**или щелкнуть правой кнопкой мыши и выбрать **точка** > останова**Вставить точку останова**. Точка останова отображается в виде красной точки в левом поле рядом с строкой кода. Отладчик приостанавливает выполнение непосредственно перед выполнением строки.

![Задание точки останова](../debugger/media/dbg_basics_setbreakpoint.png "Задание точки останова")
...
1. Выбор**функции** " **Отладка** > **новой точки останова** > "
...
1. Во время отладки откройте окно **Стек вызовов** , выбрав **Отладка** > **стека вызовов** **Windows** > .
...
Чтобы выполнить до положения курсора, в окне исходный код или **Стек вызовов** выберите строку, которую нужно прервать, щелкните правой кнопкой мыши и выберите команду **выполнить до курсора**или нажмите **клавиши CTRL**+**F10**. Выбор команды **выполнить до курсора** аналогичен установке временной точки останова.
...
> [!NOTE]
> **Запуск до щелчка** доступен, начиная [!include[vs_dev15](../misc/includes/vs_dev15_md.md)]с.

### <a name="manually-break-into-code"></a>Приостановка выполнения кода вручную

Чтобы прервать работу в следующей доступной строке кода в работающем приложении, выберите **Отладка** > **все все**или нажмите клавиши **CTRL**+**ALT**+**break**.
...
1. Во время отладки откройте окно **модули** , выбрав пункт **Отладка** > **модулей** **Windows** > , или нажмите клавиши **CTRL**+**ALT**+**U**.
