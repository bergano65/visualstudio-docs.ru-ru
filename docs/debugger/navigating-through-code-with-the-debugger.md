---
title: Навигация по коду с помощью отладчика в Visual Studio | Документация Майкрософт
...
ms.locfileid: "49933772"
---
# <a name="navigate-code-with-the-visual-studio-debugger"></a>Навигация по коду с помощью отладчика Visual Studio
Ознакомиться с командами и сочетания клавиш для перемещения по коду в отладчике, и, чтобы быстрее и проще находить и устранять неполадки в работе приложения. При перемещении кода в отладчике, вы можете проверить состояние приложения или Дополнительные сведения о процессе его выполнения.  
...
-   **Выполнение до щелкнутого** 
    ...
    Чтобы выполнить код до точки в коде во время приостановки в отладчике, выберите **выполнить до этого здесь** зеленой стрелки (вы видите значок при наведении указателя строки кода). Это избавляет от необходимости задавать временные точки останова.
...
-   **Выполнение до функции, указанной по имени**  
     ...
     ![Точки останова диалоговое окно выбора](../debugger/media/dbg_execution_overloadedbreakpoints.png "DBG_Execution_OverloadedBreakpoints")  
...
##  <a name="BKMK_Set_the_next_statement_to_execute"></a> Переместите указатель для изменения хода выполнения  
 ...
 ![Перемещение указателя](../debugger/media/dbg_basics_example3.gif "DBG_Basics_Example3")
...
1.  Откройте окно "Модули" (Клавиатура: **Ctrl + Alt + U**).  
