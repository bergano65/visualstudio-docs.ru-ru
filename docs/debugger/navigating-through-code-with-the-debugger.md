...
1.  **Задание точек останова в коде**  
     ...
     ![Задание точки останова](~/docs/debugger/media/dbg_basics_setbreakpoint.png "DBG\_Basics\_SetBreakpoint")  
 ...
 **Выполнение до функции, указанной по имени**  
 ...
 ![Диалоговое окно «Выбор точек останова»](~/docs/debugger/media/dbg_execution_overloadedbreakpoints.png "DBG\_Execution\_OverloadedBreakpoints")  
