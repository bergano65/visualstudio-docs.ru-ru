...
|Члены|Изменение члена, ссылающегося на внедренный тип взаимодействия|
|Члены|Изменение статического члена после того, как он уже получил доступ путем выполнения кода|
...
|Iterators|Изменение итератора в проекте, ориентированном на .NET Framework 4 и ниже (см. [Подробности](https://github.com/dotnet/roslyn/wiki/EnC-Supported-Edits))|
