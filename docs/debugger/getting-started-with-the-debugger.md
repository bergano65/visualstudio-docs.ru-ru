...
Несмотря на то что демонстрационного приложения C# и C++, средства применимы к Visual Basic, JavaScript и других языков, поддерживаемых Visual Studio (за исключением оговоренных случаев). Снимки экрана написаны на C#. Для переключения между C# и C++ примера кода в этой статье, используйте фильтр язык в правом верхнем углу этой страницы.
