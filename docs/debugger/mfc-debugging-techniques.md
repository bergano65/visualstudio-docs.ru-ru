...
3. Сначала создайте новую конфигурацию проекта.  
   ...
   2.  В диалоговом окне [Диспетчер конфигураций](/previous-versions/visualstudio/visual-studio-2010/t1hy4dhz(v=vs.100))найдите нужный проект в таблице. В **конфигурации** столбец, выберите  **\<создать... >**.  
