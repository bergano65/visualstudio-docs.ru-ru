...
1.  Создание [CMemoryState](http://msdn.microsoft.com/en-us/8fade6e9-c6fb-4b2a-8565-184a912d26d2) и вызовите [CMemoryState::Checkpoint](/cpp/mfc/reference/cmemorystate-structure#checkpoint) функция-член. В результате будет создан первый снимок памяти.  
