...
|**Имя свойства**|**Параметр**|
|-----------------------|-----------------|
|**Включить оптимизацию**|Задайте значение false в качестве причины, указанной в параметре **оптимизировать код** в предыдущей таблице.|
