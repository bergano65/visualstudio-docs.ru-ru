---
title: 'Ошибка: у вас нет разрешения на проверку удостоверения процесса&#39;s | Документация Майкрософт'
ms.date: 11/04/2016
...
---
# <a name="error-you-do-not-have-permission-to-inspect-the-process39s-identity"></a>Ошибка: у вас нет разрешения на проверку удостоверения процесса&#39;s
...
7. В окне **Свойства служб терминалов** перейдите на вкладку **Общие** и задайте для параметра **Тип запуска** значение **вручную**.
