...
10. В окне проводника DOM выберите элемент DIV для раздела с идентификатором `"fView"`. Для просмотра и выбора правильного элемента DIV используйте клавиши со стрелкой. (Клавиша со стрелкой вправо позволяет просмотреть дочерние элементы элемента.)  
...
12. Откройте правило CSS для высоты. Обратите внимание, что встроенного стиля значением 100 пикс., которая отображается, соответствует значению высоты 100%, установленному `#fView` селектора CSS. Зачеркнутый текст для селектора `#fView` означает, что встроенный стиль обладает приоритетом перед этим стилем.  
...
19. Чтобы изучить вопрос, переключитесь в Visual Studio и выберите **макета** вкладку для просмотра рамочной модели элемента.  
