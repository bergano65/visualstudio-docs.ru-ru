...
11. В окне проводника DOM выберите элемент DIV для раздела с идентификатором `"fView"`. Для просмотра и выбора правильного элемента DIV используйте клавиши со стрелкой. (Клавиша со стрелкой вправо позволяет просмотреть дочерние элементы элемента.)  
...
13. Откройте правило CSS для высоты. Обратите внимание, что встроенного стиля значением 100 пикс., которая отображается, соответствует значению высоты 100%, установленному `#fView` селектора CSS. Зачеркнутый текст для селектора `#fView` означает, что встроенный стиль обладает приоритетом перед этим стилем.  
...
15. В главном окне дважды щелкните `width: 100px;height: 100px;`, нажмите клавишу **удалить** ключа, а затем нажмите клавишу **ввод**. После нажатия клавиши ВВОД новые значения немедленно отражаются в приложении, несмотря на то, что сеанс отладки еще не остановлен.  
...
16. Перейдите к приложению, выбрав его, или с помощью клавиши Alt + Tab.  
...
20. Чтобы изучить вопрос, переключитесь в Visual Studio и выберите **макета** вкладку для просмотра рамочной модели элемента.  
...
## <a name="see-also"></a>См. также  
 ...
 [Поддержка продукта и специальные возможности](https://msdn.microsoft.com/library/tzbxw1af(VS.120).aspx)