...
6.  Замените код в файле default.js следующим кодом:  
    ...
    ```  
     ...
     ![Приложение FlipView с отображением ожидаемых результатов](~/debugger/media/js_dom_appfixed.png "JS\_DOM\_AppFixed")  
...
3.  Нажмите кнопку **Обновить приложение Windows** на панели инструментов "Отладка" \(или нажмите F4\). Эта кнопка выглядит следующим образом: ![Кнопка "Обновить приложение Windows"](~/debugger/media/js_refresh.png "JS\_Refresh").  
...
-   с помощью команды `select`, входящей в [Команды консоли JavaScript](../debugger/javascript-console-commands.md).  
 ...
 ![Выделенная кнопка "Отобразить веб&#45;страницу"](~/debugger/media/js_dom_display_highlights_button.png "JS\_DOM\_Display\_Highlights\_Button")  
