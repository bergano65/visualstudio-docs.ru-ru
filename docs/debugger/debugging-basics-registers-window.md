...
Для процессоров Intel x86, может появиться следующие флаги в **регистрирует** окна. Во время сеанса отладки можно также изменить эти флаги.
