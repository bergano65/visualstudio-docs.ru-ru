...
## <a name="ChooseEvents"></a> Выбор событий, записываемых IntelliTrace (только управляемый код)
...
## <a name="Snapshots"></a> Сбор моментальных снимков

Эта возможность не включена по умолчанию, но IntelliTrace можно захватывать моментальные снимки приложения во все точки останова и отладчик шаг события можно просмотреть эти моментальные снимки в сеанс исторической отладки. Моментальный снимок дает представление состояния всего приложения. Чтобы включить захват моментальных снимков, перейдите к **Сервис > Параметры > IntelliTrace > Общие**и выберите **моментальные снимки IntelliTrace (управляемый и машинный)**. Дополнительные сведения см. в разделе [просмотреть моментальные снимки с помощью шаг назад в IntelliTrace](../debugger/how-to-use-intellitrace-step-back.md)

Моментальные снимки доступны в Visual Studio Enterprise 2017 версии 15.5 и более поздней версии и требует Юбилейное обновление Windows 10 или более поздней версии.  Для приложений .NET Core и ASP.NET Core Visual Studio Enterprise 2017 версии 15.7 является обязательным. Для неуправляемых приложений, предназначенных для Windows, Visual Studio Enterprise 2017 версии 15.9 предварительной версии 2 является обязательным.

## <a name="GoingFurther"></a> Сбор событий IntelliTrace и вызовите сведения (только управляемый код)
