...
1. Запустите Visual Studio.
    ...
    Нажмите **CTRL+Q**, чтобы открыть поле поиска, введите **консоль**, выберите **Шаблоны** и затем **Create new Console App (.NET Framework)** (Создание консольного приложения — .NET Framework) или **Create new Console App (.NET Core)** (Создание консольного приложения — .NET Core). В появившемся диалоговом окне выберите **Создать**. Введите такое имя, как **ConsoleApp-FirstApp**, и нажмите кнопку **Создать**.
    ::: moniker-end
