...
2.  Включите любые биты, применив `OR`- оператор (побитовое &#124; символ) этой временной переменной и соответствующей битовой маски (представленной в коде приложения константой манифеста).  
