...
1. Откройте окно **Администрирование**. На **запустить** последовательно выберите пункты **программы**, а затем нажмите кнопку **Администрирование**. Если пункт **Администрирование** не появляется в меню **Программы**, то следует искать его в **панели управления**.
