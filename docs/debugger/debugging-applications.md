---
title: Отладка приложений | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
...
|[Диагностика графики (Отладка DirectX графики)](../debugger/visual-studio-graphics-diagnostics.md)|Способы отладки графики DirectX.|  
|[Отладка приложений ASP.NET](../debugger/how-to-enable-debugging-for-aspnet-applications.md)|Описание способов отладки приложений ASP.NET.| 
