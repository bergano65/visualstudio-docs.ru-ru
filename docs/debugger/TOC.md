...
## [Особенности различных типов приложений](debugging-applications.md)
...
#### [Активация приостановки, возобновления и фоновых событий в приложениях Microsoft Store](how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio.md)
