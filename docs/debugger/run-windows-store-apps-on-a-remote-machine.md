---
title: "Запускайте приложения UWP и Windows 8.1 на удаленном компьютере | Документы Microsoft"
ms.custom: 
ms.date: 01/05/2018
ms.reviewer: 
ms.suite: 
...
В Windows 10, можно развернуть на USB-устройством, выбрав **устройства** вместо **удаленный компьютер** как целевой объект развертывания (это можно сделать в **Стандартная** инструментов или на странице свойств отладки). Для Windows 8.1 инструменты удаленной отладки должны устанавливаться на устройстве, прежде чем подключиться напрямую.
...
Если вы используете Windows 8.1 pre создатель версии или обновления Windows 10, затем выполните следующие действия. В противном случае этот раздел можно пропустить.
