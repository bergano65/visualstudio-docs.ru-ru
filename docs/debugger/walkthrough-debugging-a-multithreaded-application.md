...
- **Пометить** В этом столбце без метки можно пометить поток, к которому требуется уделить особое внимание. Сведения о способе пометки потока см. в разделе [как: установку и снятие отметки для потоков  
