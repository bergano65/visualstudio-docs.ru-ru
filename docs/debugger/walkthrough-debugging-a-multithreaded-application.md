...
- **Пометить** В этом столбце без метки можно пометить поток, к которому требуется уделить особое внимание. Сведения о способе пометки потока см. в разделе [как: Установка и снятие отметки для потока](../debugger/how-to-flag-and-unflag-threads.md)  
