...
> [!NOTE]
> На Windows 8.1 и pre разработчика обновления версии Windows 10 удаленные средства Visual Studio должны быть установлены на удаленном устройстве, а удаленный отладчик должен быть запущен. В Windows 8.1 необходимо также установить лицензию разработчика.
