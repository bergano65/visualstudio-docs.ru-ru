...
<h2>Начало работы с отладчиком</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Отладка приложения Visual Basic</h3>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Подробные сведения об отладчике</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения о точках останова</h3>
                    </div>
                </div>
            </div>
        </div>
