---
title: Инструменты поиска для представлений Spy++ | Документация Майкрософт
description: Сведения о диалоговых окнах, в которых можно указать, какие данные будут отображаться в окне представлений Spy++. Диалоговые окна включают следующие "Поиск в окне", "Поиск окна", "Поиск сообщений", "Поиск процесса" и "Поиск потока".
...
ms.locfileid: "98204850"
---
# <a name="search-tools-for-spy-views"></a>Средства поиска для представлений Spy++
Используйте эти диалоговые окна, чтобы указать, какие данные будут отображаться в окне представлений Spy++:
