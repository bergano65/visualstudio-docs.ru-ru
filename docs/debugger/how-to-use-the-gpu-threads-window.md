...
ms.locfileid: "72732090"
---
# <a name="how-to-use-the-gpu-threads-window-c"></a>Как использовать окно потоков GPU (C++)
С помощью окна "Потоки GPU" можно просматривать потоки, выполняющиеся в графическом процессоре (GPU), и работать с этими потоками в отлаживаемом приложении. Дополнительные сведения о приложениях, выполняющихся на GPU, см. в разделе [ C++ Обзор amp](/cpp/parallel/amp/cpp-amp-overview).
