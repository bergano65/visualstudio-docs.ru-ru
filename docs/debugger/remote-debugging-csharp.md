---
title: Удаленная отладка C# или VB проекта в Visual Studio | Документация Майкрософт
...
15. На компьютере с Visual Studio вы должны увидеть, что выполнение остановилось в точке останова.
 ...
 Если у вас есть все файлы не кода, которые должны использоваться приложением, необходимо включить их в проект Visual Studio. Создайте папку проекта для дополнительных файлов (в **обозревателе решений**, нажмите кнопку **Добавить > Новая папка**). Затем добавьте файлы в папку (в **обозревателе решений**, нажмите кнопку **Добавить > существующий элемент**, выберите файлы). На **свойства** странице для каждого файла, задайте **Копировать в выходной каталог** для **всегда Копировать**.
