...
description: 'Spy++ предоставляет четыре разных представления: "Окна", "Процессы", "Потоки" и "Сообщения". Ознакомьтесь с этой статьей, чтобы получить ссылки на сведения о представлениях и способах их отображения.'
