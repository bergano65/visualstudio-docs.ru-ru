...
Расположения файлов заголовков и файлы *.lib легко можно задать на страницах свойств (проект C++ правой кнопкой мыши и выберите **Просмотр свойств**, а затем выберите **все конфигурации**) без необходимости копировать их в папку выходных данных:
