...
ms.locfileid: "51607631"
---
# <a name="debug-dlls-in-visual-studio"></a>Отладка библиотек DLL в Visual Studio
...
- C#или библиотеки классов Visual Basic 
...
- [Параметры для проекта C# конфигураций отладки](../debugger/project-settings-for-csharp-debug-configurations.md)
- [Параметры проекта для конфигурации отладки Visual Basic](../debugger/project-settings-for-a-visual-basic-debug-configuration.md)
- [Как: набор отладочной и окончательной конфигурации.](../debugger/how-to-set-debug-and-release-configurations.md)  
...
Дополнительные сведения см. в разделе [приступить к работе с отладчиком](getting-started-with-the-debugger.md).
...
- Расположена в Интернете и доступны через URL-адрес.  
...
- Подключить отладчик к приложению, уже установлена и запущена на тестовом или рабочем компьютере. Используйте этот метод для библиотек DLL, на веб-сайтах или в веб-приложениях. Дополнительные сведения см. в разделе [как: присоединение к выполняющемуся процессу](../debugger/attach-to-running-processes-with-the-visual-studio-debugger.md).  
...
>[!NOTE]
>Можно использовать **Интерпретация** окна во время разработки с большинством типов проектов. Он в настоящее время не поддерживается для .NET Core, SQL или веб-проектов.
...
1. Можно продолжить отладку `Test` поместив в нем точку останова, и затем снова вычислив эту функцию.  
   
   Точка останова будет достигнута, и можно пошагово выполнить `Test`. После выполнения `Test`, отладчик будет находиться в режиме конструктора.
