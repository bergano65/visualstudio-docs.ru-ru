...
Во время отладки, можно использовать **модули** окно, чтобы проверить, DLL и *.exe* файлы загрузкой приложения. Чтобы открыть **модули** окне во время отладки, выберите **Отладка** > **Windows** > **модули**. Дополнительные сведения см. в разделе [Практическое руководство. Использование окна модулей](../debugger/how-to-use-the-modules-window.md). 
