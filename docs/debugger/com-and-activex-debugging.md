...
description: Ознакомьтесь с советами по отладке приложений COM и элементов управления ActiveX в Visual Studio. Узнайте, как выполнить отладку сервера и контейнера COM. Ознакомьтесь со списком средств отладки для модели COM.
