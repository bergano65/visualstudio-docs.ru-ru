...
- [Запись блога. Запуск предварительной загрузки для приложений Windows Store в Visual Studio 2013 с обновлением 2](https://devblogs.microsoft.com/devops/triggering-prefetch-for-windows-store-apps-in-visual-studio-2013-update-2/)