...
1. Необходимо установить Visual Studio и **платформу .NET Core для межплатформенной разработки** или рабочей нагрузки **разработки настольных приложений .NET** , в зависимости от типа приложения, которое вы хотите создать.
    ...
    Если у вас уже установлена среда Visual Studio без нужных рабочих нагрузок, щелкните **Сервис** > **Получить средства и компоненты**. Запускается Visual Studio Installer. Выберите рабочую нагрузку **.NET Core кросс — разработка** или **Разработка классических приложений .NET** , а затем нажмите кнопку **изменить**.

1. Запустите Visual Studio.

    ::: moniker range=">=vs-2019"
    На начальном экране выберите **Создать проект**. В поле поиска введите **Console** , а затем выберите **консольное приложение (.NET Core)** или **консольное приложение (.NET Framework)** . Щелкните **Далее**. Введите имя проекта, например **Console_Parse_JSON** , и нажмите кнопку **создать**.
    ::: moniker-end
    ::: moniker range="vs-2017"
    В верхней строке меню выберите **Файл** > **Создать** > **Проект**. В левой области диалогового окна **Новый проект** в разделе **визуальный C#** элемент выберите **консольное приложение**, а затем в средней области выберите **консольное приложение (.NET Core)** или **консольное приложение (.NET Framework)** . Введите имя, например **Console_Parse_JSON** , и нажмите кнопку **ОК**.
    ::: moniker-end

    Если вы не видите шаблон проекта **консольное приложение (.NET Core)** или **консольное приложение (.NET Framework)** , перейдите в **меню Сервис** > **получить средства и компоненты**, открывающие Visual Studio Installer. Выберите рабочую нагрузку **.NET Core кросс — разработка** или **Разработка классических приложений .NET** , а затем нажмите кнопку **изменить**.
...
Нажмите клавишу **F5** (**Отладка > начать отладку**) или нажмите кнопку **начать отладку** , чтобы ![начать отладку](../debugger/media/dbg-tour-start-debugging.png "Начать отладку") на панели инструментов Отладка.
...
Нажмите кнопку **Перезапустить** ![Перезапустить приложение](../debugger/media/dbg-tour-restart.png "RestartApp") на панели инструментов отладки (**CTRL** + **SHIFT** + **F5**). Это приведет к перезапуску приложения за меньшее количество шагов. В окне консоли вы увидите следующие выходные данные.
