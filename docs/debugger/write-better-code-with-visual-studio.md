...
* Для ознакомления функций, включенных в приложении, особенно при взаимодействии с внешними данными (например, веб-запроса) обратитесь к документации, чтобы увидеть, какие исключения функции, скорее всего, породит. Это может быть критически важные сведения для соответствующей обработки ошибок, а также для отладки приложения.
