---
title: "Краткое руководство. Отладка JavaScript с помощью консоли | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
-   Выполнение других задач, таких как очистка экрана. Полный список команд см. в разделе [Команды консоли JavaScript](../debugger/javascript-console-commands.md).  
...
9. Приложение `FlipView` должно выполняться в симуляторе или эмуляторе телефона; введите `Data.items` в строке ввода окна консоли \(рядом с символом "\>\>"\) и нажмите клавишу ВВОД.  
     ...
     ![Окно консоли JavaScript](../debugger/media/js_console_window.png "JS\_Console\_Window")  
...
5.  Выберите функцию в окне консоли, чтобы отобразить ее реализацию.  
     ...
     ![Окно консоли JavaScript, в котором показан визуализатор](../debugger/media/js_console_function_visualizer.png "JS\_Console\_Function\_Visualizer")  
