...
1. Откройте Visual Studio и создайте новый проект.
   ...
   В окне **Настройка нового проекта** введите имя или используйте имя по умолчанию в поле **имя проекта** . Затем нажмите **Создать**.
   ...
   Появится новый проект консольного приложения. После создания проекта появится исходный файл.
...
## <a name="using-the-parallel-stacks-window-threads-view"></a>Использование окна "Параллельные стеки". Представление "Потоки"
 В меню **Отладка** выберите команду **Начать отладку**. Дождитесь попадания в первую точку останова.
