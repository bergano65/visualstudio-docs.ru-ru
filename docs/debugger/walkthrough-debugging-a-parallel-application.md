...
1. Откройте Visual Studio и создайте новый проект.
    ...
    Тип **Ctrl + Q** для открытия окна поиска, введите **консоли** (или **c ++**), выберите **шаблоны**, а затем:
    ...
    Если вы не видите **консольное приложение** шаблона проекта, перейдите к **средства** > **получить средства и компоненты...** , откроется установщик Visual Studio. Выберите рабочую нагрузку **Разработка классических приложений .NET** или **Разработка классических приложений на C++**, а затем нажмите кнопку **Изменить**.
