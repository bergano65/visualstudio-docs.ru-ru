...
- С помощью [/Fx](/cpp/build/reference/fx-merge-injected-code), можно создать объединенный исходный файл, содержащий исходные и подставляемый код.  
