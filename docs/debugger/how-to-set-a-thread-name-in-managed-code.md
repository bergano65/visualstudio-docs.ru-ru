---
title: Как выполнить Установка имени потока в управляемом коде | Документация Майкрософт
ms.date: 04/27/2017
ms.topic: conceptual
dev_langs:
- CSharp
...
ms.locfileid: "54994609"
---
# <a name="how-to-set-a-thread-name-in-managed-code"></a>Как выполнить установку имени потока в управляемом коде
