...
- Где выражения контрольных значений больше, чем 4 байта в 32-разрядное оборудование и 8 байт на 64-разрядном оборудовании. Это ограничение x86 архитектуры.
