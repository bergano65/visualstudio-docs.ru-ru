...
## <a name="troubleshoot"></a>Устранение неполадок точек останова 
...
1.  Если Visual Studio отображался исходный код, не совпадает с версией отладки, выберите **Отладка > Параметры и настройки**. На странице **Отладка / Общие** снимите флажок **Требовать точного соответствия исходной версии файлов** .  
