...
##  <a name="BKMK_Overview"></a> Задание точки останова в функции в исходном коде  
 ...
 ![Задание точки останова](~/docs/debugger/media/basicbreakpoint.png "BasicBreakpoint")  
 ...
 ![Выполнение точки останова остановлено](~/docs/debugger/media/breakpointexecution.png "BreakpointExecution")  
...
##  <a name="BKMK_Specify_advanced_properties_of_a_breakpoint_"></a> Управление точками останова  
 ...
 ![Точки останова &#45; окно](~/docs/debugger/media/breakpointswindow.png "BreakpointsWindow")  
