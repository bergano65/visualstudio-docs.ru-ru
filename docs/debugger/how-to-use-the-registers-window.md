...
ms.locfileid: "45551851"
---
# <a name="view-register-values-and-use-the-registers-window-in-the-visual-studio-debugger"></a>Просмотр значений зарегистрировать и использовать окно Регистры в отладчике Visual Studio
