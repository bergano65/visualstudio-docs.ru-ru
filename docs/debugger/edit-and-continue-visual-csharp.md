...
# <a name="edit-and-continue-visual-c"></a>Режим "Изменить и продолжить" (Visual C#)
 ...
 Изменить и продолжить поддерживается в UWP в Windows 10 и x86- и x64 приложений, предназначенных для .NET Framework 4.6 рабочего стола или более поздней версии, (платформа .NET Framework — только версия рабочего стола).

 > [!NOTE]
 > Неподдерживаемые приложений и платформ включают ASP.NET 5, Silverlight 5 и Windows 8.1.
  
 Если изменить и продолжить, поддерживаемые изменения применяются автоматически при использовании команд отладчика, таких как **Продолжить**, **шаг**, **задать следующий оператор**, или выполнять вычисление функции в окне отладчика.  
  
 Дополнительные сведения см. в разделе [как: изменить и продолжить (C#)](../debugger/how-to-use-edit-and-continue-csharp.md).  
  
## <a name="see-also"></a>См. также  
 [Как: использовать изменить и продолжить (C#)](../debugger/how-to-use-edit-and-continue-csharp.md)   
