---
title: Как выполнить Отладка встроенного кода ассемблера | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
- vs.debug.inline
...
ms.locfileid: "53935428"
---
# <a name="how-to-debug-inline-assembly-code"></a>Как выполнить отладку встроенного кода ассемблера
