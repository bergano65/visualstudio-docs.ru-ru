...
1. Создайте новый проект библиотеки классов.
    ...
    Нажмите клавишу **ESC**, чтобы закрыть окно запуска. Введите **CTRL + Q** , чтобы открыть поле поиска, введите **Библиотека классов**, выберите **шаблоны**, а затем щелкните **создать новую библиотеку классов (.NET Framework)** . В появившемся диалоговом окне выберите **Создать**.
    ::: moniker-end
    ::: moniker range="vs-2017"
    В верхней строке меню последовательно выберите **Файл**  > **Создать**  > **Проект**. В левой области диалогового окна **Новый проект** в разделе **визуальный C#** элемент выберите **.NET Framework**, а затем в средней области выберите **Библиотека классов (.NET Framework)** .
    ::: moniker-end
...
2. В диалоговом окне **Новый проект** в разделе **визуальный C#** элемент выберите **.NET Framework**.
