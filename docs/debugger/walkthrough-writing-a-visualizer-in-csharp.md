...
1. Создайте новый проект библиотеки классов.
    ...
    Нажмите клавишу **ESC**, чтобы закрыть окно запуска. Тип **Ctrl + Q** для открытия окна поиска, введите **библиотеки классов**, выберите **шаблоны**, затем выберите **создать новую библиотеку классов (.NET Standard)**. В появившемся диалоговом окне выберите **Создать**.
    ::: moniker-end
    ::: moniker range="vs-2017"
    В верхней строке меню выберите **Файл** > **Создать** > **Проект**. В левой части **новый проект** диалогового **Visual C#** , выберите **.NET Standard**, а затем в средней области выберите **библиотека классов (. NET Standard)**.
    ::: moniker-end
...
1. В обозревателе решений щелкните правой кнопкой мыши решение, выберите **добавить**, а затем нажмите кнопку **новый проект**.
    ...
    ::: moniker range=">=vs-2019"
    В поле поиска введите **консольное приложение**, выберите **шаблоны**, затем выберите **создайте новое консольное приложение (.NET Framework)**. В появившемся диалоговом окне выберите **Создать**.
    ::: moniker-end
    ::: moniker range="vs-2017"
...
2. В **добавить ссылку** диалоговом окне **Обзор** вкладке, выберите Microsoft.VisualStudio.DebuggerVisualizers.DLL.
