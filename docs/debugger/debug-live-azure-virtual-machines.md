...
В этом учебнике будут выполняться следующие задачи.
...
* Коллекция моментальных снимков доступна для следующих веб-приложений Azure Virtual Мачинес\виртуал для масштабируемых наборов.
  ...
  * Приложения ASP.NET Core, выполняющиеся на платформе .NET Core 2.0 или более поздней версии под управлением Windows.
  ...
  > [!NOTE]
  >  Visual Studio Enterprise, выполняющиеся в 32-разрядной версии Windows, не смогут просматривать моментальные снимки.
...
1. Выберите **отладка > присоединить snapshot Debugger...** . Выберите масштабируемый набор виртуальных машин Azure Мачине\виртуал, в котором развернуто веб-приложение, и учетную запись хранения Azure, а затем нажмите кнопку **присоединить**. Snapshot Debugger также поддерживает [службу Azure Kubernetes](debug-live-azure-kubernetes.md) и [службу приложений Azure](debug-live-azure-applications.md).
