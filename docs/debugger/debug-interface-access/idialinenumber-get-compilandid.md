---
title: "IDiaLineNumber::get_compilandId | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Возвращает уникальный идентификатор для компилируемого объекта, который участвует в этой строке.  
