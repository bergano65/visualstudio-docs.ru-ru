---
title: "Файл исходного кода Dia2dump.cpp | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "пример Dia2dump [пакет SDK для доступа к интерфейсу отладки], пример исходного кода"
...
manager: "ghogen"
---
# Файл исходного кода Dia2dump.cpp
[!INCLUDE[vs2017banner](../../code-quality/includes/vs2017banner.md)]

Следующий исходный код Dia2dump.cpp отображает содержимое файла pdb.  Этот исходный код используется by [Пример файла Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
