---
title: Исходного кода Dia2dump.cpp | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
...
ms.locfileid: "31466062"
---
# <a name="dia2dumpcpp-source-file"></a>Файл исходного кода Dia2dump.cpp
Следующий исходный код Dia2dump.cpp отображает содержимое PDB-файл. Этот исходный код используется [Dia2dump-пример](../../debugger/debug-interface-access/dia2dump-sample.md).  
