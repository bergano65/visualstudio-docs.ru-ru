...
Определяет регистр целевого объекта.  
  
> [!NOTE]
>  Поскольку перечисление `CV_HREG_e` слишком велико для дублирования в целом ниже, сокращенная версия предоставляется в качестве ссылки.  Отсутствующие записи notated в курсивах.  Полное перечисление доступна в файле заголовка cvconst.h.  
...
## Elements  
 CV\_REG\_\*  
 Регистры, используемые 80x86 и процессорами Intel ix86 и p\-код.  
  
 CV\_R68\_\*  
 Регистры, используемые процессором 68K.  
  
 CV\_M4\_\*  
 Регистры процессора, используемые MIPS 4000 рядов.  
  
 CV\_ALPHA\_\*  
 Регистры, используемые процессором ряда альфы\-версии AXP Digital Equipment Corporation.  
  
 CV\_PPC\_\*  
 Регистры, используемые процессором PowerPC Motorola И IBM.  
  
 CV\_SH3\_\* и CV\_SH\_\*  
 Регистры, используемые процессором рядом Хитачи SH3 и Хитачи SH.  
  
 CV\_ARM\_\*  
 Регистры, используемые предварительными числом процессоров компьютера RISC \(РУКОЯТКИ\).  
  
 CV\_IA64\_\*  
 Регистры, используемые процессорами Intel IA64 ряда.  
  
 CV\_TRI\_\*  
 Регистры, используемые процессором TriCore технологий Infineon.  
  
 CV\_AM33\_\*  
 Регистры, используемые Matsushita\/Panasonic AM33 и связанные процессорами.  
  
 CV\_M32R\_\*  
 Регистры, используемые процессором Мицубиси M32R.  
  
## Заметки  
 Каждый тип процессора используется собственный уникальный набор регистров.  
  
 Значения в этом перечислении передается следующим приемам:  
