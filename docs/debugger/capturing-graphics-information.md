...
-   В Visual Studio на панели инструментов **Графика** нажмите кнопку **Захватить кадр**![Значок кнопки захвата графики](~/docs/debugger/graphics/media/debuggingdirectxgraphics.png "DebuggingDirectXGraphics").  
