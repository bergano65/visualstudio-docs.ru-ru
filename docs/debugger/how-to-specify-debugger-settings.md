---
title: Как выполнить Установка параметров отладчика | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- CSharp
...
ms.locfileid: "53847182"
---
# <a name="how-to-specify-debugger-settings"></a>Как выполнить установку параметров отладчика
