 ...
 **Приложение Windows Forms (.NET)** шаблон создает [!INCLUDE[vcprvc](../code-quality/includes/vcprvc_md.md)] приложение Windows Forms. Дополнительные сведения см. в разделе [Практическое руководство. Создание проекта приложения WPF](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/42wc9kk5(v=vs.100)).  
