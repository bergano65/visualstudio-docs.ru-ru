...
1. Запустите Visual Studio.
    ...
    ::: moniker range=">=vs-2019"
    Нажмите **CTRL+Q**, чтобы открыть поле поиска, введите **c++**, выберите **Шаблоны** и затем **Create new Console App project** (Создание проекта консольного приложения). В появившемся диалоговом окне введите такое имя, как **get-started-debugging**, а затем выберите **Создать**.
    ::: moniker-end
    ::: moniker range="vs-2017"
