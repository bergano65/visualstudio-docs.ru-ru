---
title: "Набор инструментов MSBuild (ToolsVersion) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "MSBuild, настройка для различных версий (multi-targeting)"
  - "MSBuild, указание конкретной платформы .NET Framework"
  - "настройка для различных версий (multi-targeting) [MSBuild]"
  - "указание конкретной платформы .NET Framework [MSBuild]"
