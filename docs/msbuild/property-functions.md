...
##  <a name="a-namebkmksyntaxa-property-function-syntax"></a><a name="BKMK_Syntax"></a> Синтаксис функции свойства  
...
###  <a name="a-namebkmkstringa-string-property-functions"></a><a name="BKMK_String"></a> Функции свойства строки  
...
###  <a name="a-namebkmkstatica-static-property-functions"></a><a name="BKMK_Static"></a> Функции статического свойства  
...
###  <a name="a-namebkmkinstancemethodsa-calling-instance-methods-on-static-properties"></a><a name="BKMK_InstanceMethods"></a> Вызов методов экземпляра в статических свойствах  
...
###  <a name="a-namebkmkpropertyfunctionsa-msbuild-property-functions"></a><a name="BKMK_PropertyFunctions"></a> Функции свойства MSBuild  
...
##  <a name="a-namebkmknesteda-nested-property-functions"></a><a name="BKMK_Nested"></a> Вложенные функции свойства  
