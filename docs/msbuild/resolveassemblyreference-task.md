...
|`FindRelatedFiles`|Необязательный параметр `Boolean` .<br /><br /> Если значение `true`, выполняется поиск связанных файлов, таких как PDB- и XML-файлы. Значение по умолчанию — `true`.|  
