...
### Централизованная модель ведения журнала  
 ...
 ![Централизованная модель средства ведения журнала](~/docs/msbuild/media/centralnode.png "CentralNode")  
...
### Распределенная модель ведения журнала  
 ...
 ![Распределенная модель ведения журнала](~/docs/msbuild/media/distnode.png "DistNode")  
