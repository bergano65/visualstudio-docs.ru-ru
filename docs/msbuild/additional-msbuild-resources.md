...
Если при попытке устранить проблему не удается найти необходимую информацию в документации, можно обратиться к другим ресурсам, таким как статьи базы знаний, сообщество разработчиков или служба технической поддержки.  
  
## Статьи базы знаний  
 Статьи о проблемах с теми или иными продуктами можно найти в базе знаний в Интернете.  База знаний содержит статьи не по всем вопросам, однако в ней документированы ошибки, с которыми сталкивается большинство пользователей.  Статьи базы знаний доступны на веб\-сайте [Статья базы результаты поиска \(MSBuild\)](http://search.microsoft.com/supportresults.aspx?q=knowledge+base+MSBuild&x=0&y=0).  
  
## Форумы сообщества  
 На форумах можно общаться с другими разработчиками, а также с сотрудниками корпорации Майкрософт.  Если вы столкнулись с ошибкой, решение которой найти не удается, разместите вопросы по этой проблеме на форуме.  Можно также поискать группы новостей и узнать, не размещались ли уже вопросы по этой проблеме.  Доступ к форум Visual Studio MSBuild на веб\-сайте [Форумы MSDN](http://go.microsoft.com/fwlink/?LinkId=48931).  
  
 Можно ресурсы сообщества [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] доступны на веб\-сайте [Канал 9 MSBuild](http://channel9.msdn.com/).  
  
## Поддержка продукта  
 Если у вас по\-прежнему остались вопросы, после попробуете другие ресурсы, можно обратиться в службу технической поддержки Майкрософт, посетив веб\-сайт [Справка и поддержка Майкрософт](http://go.microsoft.com/fwlink/?linkid=1782).  Сведения о поддержке продуктов, доступной в вашем регионе, см. в разделе [Обращайтесь к нам](../ide/talk-to-us.md).  
