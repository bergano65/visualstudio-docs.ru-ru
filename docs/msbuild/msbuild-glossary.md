...
## <a name="glossary"></a>Глоссарий  
 ...
 тип элемента  
 Типы элементов — это именованные списки элементов, которые можно использовать в качестве параметров для задач. Задачи используют значения элементов для выполнения этапов процесса сборки. Дополнительные сведения см. в статье [Элементы](../msbuild/msbuild-items.md).  
 ...
 Функции свойств можно объединять для образования более сложных функций. Например:  
