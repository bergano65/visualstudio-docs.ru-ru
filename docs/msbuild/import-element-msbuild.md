---
title: "Элемент Import (MSBuild) | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
>   
>  Чтобы обойти это, поместите условные импорты в файлы TARGETS или поместите код в условный блок, такой как [Элемент Choose \(MSBuild\)](../msbuild/choose-element-msbuild.md).  
