...
ms.locfileid: "58515315"
---
# <a name="clangcompile-task"></a>Задача ClangCompile

Создает программу-оболочку для компилятора Visual C++ (clang.exe).
...
|**MSCompatibility**|Необязательный параметр типа **bool**.<br/><br/>Включение полной совместимости с Microsoft Visual C++.|
