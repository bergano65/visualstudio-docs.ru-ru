...
Для выполнения пошагового руководства необходимо установить платформу .NET Framework (версии 2.0, 3.5, 4.0, 4.5 или более поздней), так как она включает MSBuild и компилятор Visual C#.
...
## <a name="extend-the-path-to-include-msbuild"></a>Расширение пути для включения MSBuild
...
Если на вашем компьютере установлено ПО Visual Studio, можно использовать **командную строку разработчика для Visual Studio**, где имеется путь с указанием папки *MSBuild*.
