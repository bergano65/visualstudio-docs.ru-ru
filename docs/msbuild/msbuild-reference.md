...
- [Справочные сведения о задачах](../msbuild/msbuild-task-reference.md)\
 В нем описаны некоторые типичные задачи, входящие в состав MSBuild.

- [Условия](../msbuild/msbuild-conditions.md)\
 Описаны условия, доступные в файлах MSBuild.
...
- [Зарезервированные и стандартные свойства MSBuild](../msbuild/msbuild-reserved-and-well-known-properties.md)\
 Описаны зарезервированные свойства MSBuild.
...
- [Справочные сведения о WPF для MSBuild](../msbuild/wpf-msbuild-reference.md)\
 Содержит справочник целевых объектов и задач MSBuild для Windows Presentation Foundation (WPF).

- [Экранируемые специальные знаки](../msbuild/special-characters-to-escape.md)\
