...
1. Щелкните правой кнопкой мыши узел **npm** в проекте и выберите команду **Обновить пакеты npm**.
    ...
    Выберите окно **Вывод**, чтобы увидеть ход установки пакетов. Установка может занять несколько минут.
...
В этом учебнике вы узнали, как создать приложение Node.js и React, транскомпилировать код JSX и выполнить отладку. Дополнительные сведения см. в разделе [Инструменты Node.js для Visual Studio](https://github.com/Microsoft/nodejstools) на GitHub.