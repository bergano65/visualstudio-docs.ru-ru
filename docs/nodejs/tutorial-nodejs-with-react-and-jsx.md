...
1. В диалоговом окне **Установка новых пакетов npm** выполните поиск пакета react и щелкните **Установить пакет**, чтобы установить его.
    ...
    Нажмите на окно **вывода**, чтобы увидеть ход установки пакета (выберите **npm** в поле **Показать выходные данные от**). После установки пакет появляется в узле **npm**.
...
1. Щелкните правой кнопкой мыши узел **npm** в проекте и выберите команду **Обновить пакеты npm**.
    ...
    Нажмите на окно **Вывод**, чтобы увидеть ход установки пакетов. Результаты могут появиться через несколько минут.
