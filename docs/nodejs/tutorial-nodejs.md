...
Мы собираемся запустить приложение с подключенным отладчиком Visual Studio. Прежде чем сделать это, необходимо задать точку останова.
