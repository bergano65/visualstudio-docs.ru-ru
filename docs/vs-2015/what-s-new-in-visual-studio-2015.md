...
Добро пожаловать в Visual Studio 2015, интегрированный набор средств обеспечения производительности разработчика, облачных служб и расширений, которые позволяют вам и вашей команде создавать уникальные приложения и игры для Интернета, Магазина Windows, настольных компьютеров, для Android и iOS.  
 ...
 Чтобы узнать больше о многочисленных усовершенствованиях и новых возможностях Visual Studio ALM, см. в разделе [новые возможности для управления жизненным циклом приложений в Visual Studio 2015](http://msdn.microsoft.com/en-us/54b98a53-6083-4303-869a-8063d8fae938).  
...
## <a name="debugging-and-diagnostics"></a>Отладка и диагностика  
 Сведения о новинках в отладке, см. в разделе [новые возможности отладчика в Visual Studio 2015](./debugger/what’s-new-for-the-debugger-in-visual-studio-2015.md).  
...
### <a name="automatic-extension-updates"></a>Автоматическое обновление расширений  
 Установленные расширения Visual Studio теперь обновляются автоматически при появлении новой версии в коллекции Visual Studio. См. в разделе [поиск и использование расширений Visual Studio](./ide/finding-and-using-visual-studio-extensions.md) Дополнительные сведения о настройке автоматического обновления расширений.  
...
### <a name="custom-layouts"></a>Пользовательские макеты  
 Можно создавать, хранить и перемещать пользовательские макеты окон. Например, можно определить один предпочитаемый макет для использования на настольном компьютере и другой макет для использования на ноутбуке или устройстве с небольшим экраном. Либо можно использовать один макет для проекта пользовательского интерфейса и другой для проекта базы данных. Привязки клавиш позволяют быстро переключаться между макетами. Эти макеты становятся доступны в любом экземпляре Visual Studio после входа. Дополнительные сведения см. в разделе [Создание пользовательских макетов окон](./misc/create-custom-window-layouts.md).  
...
-   Найти изменения в других ветвях, влияющих на ваш код.  
 ...
 См. в разделе [CodeLens](./ide/find-code-changes-and-other-history-with-codelens.md).  
...
### <a name="send-a-frown"></a>Отправьте нахмуренный смайлик  
 ...
 Щелкните желтый смайлик в окне заголовка, а затем нажмите кнопку **Отправить нахмуренный смайлик**. Сообщите нам о том, что вам не понравилось и нажмите кнопку "Отправить нахмуренный смайлик". Дополнительные сведения см. в статье [Talk to Us](./ide/talk-to-us.md) (Обращайтесь к нам).  
...
* [Новые возможности для управления жизненным циклом приложений в Visual Studio 2015](http://msdn.microsoft.com/en-us/54b98a53-6083-4303-869a-8063d8fae938)
* [Новые возможности Visual Studio 2017](https://docs.microsoft.com/en-us/visualstudio/ide/how-to-report-a-problem-with-visual-studio-2017)