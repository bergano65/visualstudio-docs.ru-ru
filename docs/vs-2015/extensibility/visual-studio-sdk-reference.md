...
## <a name="in-this-section"></a>В этом разделе
 ...
 [Настройка установки](http://msdn.microsoft.com/library/faa4ed55-66ce-4792-939f-a5b093f13a2e)  
 API конфигурации установки для обнаружения экземпляров Visual Studio 2017.

 [Открыть папку расширяемости](http://msdn.microsoft.com/library/0897ae3d-6a09-4d26-90c9-7f3d0b8e5c5d)  
