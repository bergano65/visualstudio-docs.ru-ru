...
1. Создайте начальную страницу с помощью, созданной при [создании настраиваемой начальной страницы](../extensibility/creating-a-custom-start-page.md).  
...
## <a name="testing-a-manually-created-custom-start-page"></a>Тестирование настраиваемой начальной страницы, созданной вручную  
