...
ms.locfileid: "47557827"
---
# <a name="message-enumerator"></a>Перечислитель сообщений
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [перечислитель сообщений](https://docs.microsoft.com/visualstudio/extensibility/message-enumerator).  
