...
ms.locfileid: "47558939"
---
# <a name="signing-vsix-packages"></a>Подписывание пакетов VSIX
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [подписывание пакетов VSIX](https://docs.microsoft.com/visualstudio/extensibility/signing-vsix-packages).  
