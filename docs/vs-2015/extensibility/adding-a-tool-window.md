...
ms.locfileid: "47564041"
---
# <a name="adding-a-tool-window"></a>Добавление окна инструментов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Добавление окна инструментов](https://docs.microsoft.com/visualstudio/extensibility/adding-a-tool-window).  
...
2.  Добавьте элемент кнопки внутри `<Buttons>` раздел. Этот элемент будет отображаться на панели инструментов в окне инструментов со значком поиска (с увеличительным стеклом).  
...
1.  Откройте FirstToolWindow.cs и добавьте следующий `using` инструкций.  
...
## <a name="set-the-default-position-for-the-tool-window"></a>Задание положения по умолчанию для окна инструментов  
 Затем укажите расположение по умолчанию в интегрированной среде разработки для окна инструментов. Сведения о конфигурации для окна инструментов находится в файле FirstToolWindowPackage.cs.  
  
1.  Найдите в FirstToolWindowPackage.cs, <xref:Microsoft.VisualStudio.Shell.ProvideToolWindowAttribute> атрибут `FirstToolWindowPackage` класс, который передает тип FirstToolWindow конструктору. Чтобы указать положение по умолчанию, необходимо добавить дополнительные параметры в конструктор, в следующем примере.  
...
3.  Нажмите кнопку (он имеет значок поиска) в окне инструментов. Выберите поддерживаемые звук или видео файл, например, C:\windows\media\chimes.wav, нажмите клавишу **откройте**.  
