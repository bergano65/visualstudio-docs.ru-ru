...
Последнюю версию этого раздела можно найти в [как: доступ к встроенной шрифтов и цветовой схемы](https://docs.microsoft.com/visualstudio/extensibility/how-to-access-the-built-in-fonts-and-color-scheme).  
