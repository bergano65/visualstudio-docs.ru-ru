...
ms.locfileid: "47564186"
---
# <a name="sccdirqueryinfo-function"></a>Функция SccDirQueryInfo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [функция SccDirQueryInfo](https://docs.microsoft.com/visualstudio/extensibility/sccdirqueryinfo-function).  
