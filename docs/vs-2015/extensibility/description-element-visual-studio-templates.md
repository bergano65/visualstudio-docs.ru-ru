...
ms.locfileid: "47571064"
---
# <a name="description-element-visual-studio-templates"></a>Элемент Description (шаблоны Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент Description (шаблоны Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/description-element-visual-studio-templates).  
