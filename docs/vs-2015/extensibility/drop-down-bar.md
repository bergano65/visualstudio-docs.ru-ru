...
ms.locfileid: "47561078"
---
# <a name="drop-down-bar"></a>Раскрывающийся список
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [раскрывающейся панелью](https://docs.microsoft.com/visualstudio/extensibility/drop-down-bar).  
