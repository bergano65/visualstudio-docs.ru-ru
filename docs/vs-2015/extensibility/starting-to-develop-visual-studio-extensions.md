---
title: Приступая к разработке расширений | Документация Майкрософт
ms.date: 11/15/2016
...
- Конструкторы предметно ориентированных сценариев, таких как поддержка разработки или облачных данных
  ...
  Примеры расширения, ознакомьтесь с [Visual Studio Marketplace](https://marketplace.visualstudio.com/). Вы также можете рассмотреть [откройте Visual Studio, расширения источников](https://github.com/Microsoft/extendvs/blob/master/CommunityExtensions.md).
