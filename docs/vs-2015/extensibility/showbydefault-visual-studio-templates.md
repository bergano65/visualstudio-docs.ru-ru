...
ms.locfileid: "47559575"
---
# <a name="showbydefault-visual-studio-templates"></a>Элемент ShowByDefault (шаблоны Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [ShowByDefault (шаблоны Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/showbydefault-visual-studio-templates).  
