...
ms.locfileid: "47562059"
---
# <a name="scccreatesubproject-function"></a>Функция SccCreateSubProject
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [функция SccCreateSubProject](https://docs.microsoft.com/visualstudio/extensibility/scccreatesubproject-function).  
