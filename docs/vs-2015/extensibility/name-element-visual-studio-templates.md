...
ms.locfileid: "47571234"
---
# <a name="name-element-visual-studio-templates"></a>Элемент Name (шаблоны Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент Name (шаблоны Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/name-element-visual-studio-templates).  
