...
ms.locfileid: "47573071"
---
# <a name="how-to-implement-error-markers"></a>Практическое: реализовать маркеры ошибок
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: реализуйте маркеры ошибок](https://docs.microsoft.com/visualstudio/extensibility/how-to-implement-error-markers).  
