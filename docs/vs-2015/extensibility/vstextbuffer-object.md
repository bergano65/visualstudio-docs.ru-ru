...
ms.locfileid: "47557542"
---
# <a name="vstextbuffer-object"></a>Объект VSTextBuffer
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [объект VSTextBuffer](https://docs.microsoft.com/visualstudio/extensibility/vstextbuffer-object).  
