...
ms.locfileid: "47563675"
---
# <a name="changing-the-text-of-a-menu-command"></a>Изменение текста команды меню
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [изменение текста команды меню](https://docs.microsoft.com/visualstudio/extensibility/changing-the-text-of-a-menu-command).  
