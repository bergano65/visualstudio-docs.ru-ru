...
ms.locfileid: "47573102"
---
# <a name="adding-a-submenu-to-a-menu"></a>Добавление подменю в меню
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Добавление подменю в меню](https://docs.microsoft.com/visualstudio/extensibility/adding-a-submenu-to-a-menu).  
