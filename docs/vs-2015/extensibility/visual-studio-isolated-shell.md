...
- Некоторые аспекты оболочки можно также указать при запуске приложения. Для этого обновите параметры в вызове к начальной точке входа appenvstub.dll.  
...
|Категория компонента|Компонент|  
|----------------------|-------------|  
|Возможности интегрированной среды разработки|Параметры импорта и экспорта<br /><br /> Установщик элементов управления панели элементов<br /><br /> Список задач & Список ошибок<br /><br /> Окно вывода<br /><br /> Начальная страница<br /><br /> Окно «Свойства»<br /><br /> Панель элементов<br /><br /> Обозреватель решений<br /><br /> Окно "Закладки"<br /><br /> Представление классов<br /><br /> Обозреватель объектов<br /><br /> Окно команд<br /><br /> Структура документа<br /><br /> Ресурсы<br /><br /> Внешнее средство<br /><br /> Windows Communication Foundation (WCF) Добавление ссылки на службу<br /><br /> Поддержка запросов с поддержкой языка LINQ|  
