...
## <a name="implementing-the-quickinfo-source"></a>Реализация источника краткие сведения  
...
## <a name="implementing-a-quickinfo-source-provider"></a>Реализация поставщика источника краткие сведения  
...
## <a name="implementing-a-quickinfo-controller"></a>Реализация контроллера краткие сведения  
 Контроллеры краткие сведения определяют, когда следует отображать краткие сведения. В этом примере краткие сведения отображается, когда указатель наведен на слово, соответствующее одному из имен методов. Контроллер краткие сведения реализует обработчик событий наведения указателя мыши, который запускает сеанс краткие сведения.  
