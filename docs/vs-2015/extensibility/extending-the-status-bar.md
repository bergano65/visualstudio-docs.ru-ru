...
ms.locfileid: "47568749"
---
# <a name="extending-the-status-bar"></a>Расширение строки состояния
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [расширение строки состояния](https://docs.microsoft.com/visualstudio/extensibility/extending-the-status-bar).  
