...
ms.locfileid: "47571681"
---
# <a name="sccsetoption-function"></a>Функция SccSetOption
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [функция SccSetOption](https://docs.microsoft.com/visualstudio/extensibility/sccsetoption-function).  
