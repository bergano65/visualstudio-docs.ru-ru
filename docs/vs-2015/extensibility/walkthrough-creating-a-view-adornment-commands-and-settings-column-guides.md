...
Последнюю версию этого раздела можно найти в [Создание оформления представления, команд и параметров](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-a-view-adornment-commands-and-settings-column-guides).  
 ...
 **Просмотр оформления**.  Нажмите правую кнопку указателя на узел проекта в обозревателе решений.  Выберите **добавить &#124; новый элемент...** команду, чтобы добавить новый элемент оформления представления.  Выберите **расширяемости &#124; редактор** в области навигации слева и выберите **оформление окна просмотра редактора** в области справа.  Введите имя ColumnGuideAdornment в качестве имени элемента и выберите **добавить** Чтобы добавить его.  
 ...
 Вы видите, этот шаблон элемента добавлены два файла для проекта (а также ссылки и т. д.): ColumnGuideAdornment.cs и ColumnGuideAdornmentTextViewCreationListener.cs.  Шаблоны просто нарисовать сиреневый прямоугольник в представление.  Ниже будет изменить на несколько строк в представление создания прослушивателя и замените содержимое файла ColumnGuideAdornment.cs.  
