...
ms.locfileid: "47568766"
---
# <a name="mssccprjscc-file"></a>Файл MSSCCPRJ.SCC
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [MSSCCPRJ. Файл SCC](https://docs.microsoft.com/visualstudio/extensibility/mssccprj-scc-file).  
