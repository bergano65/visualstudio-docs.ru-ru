...
ms.locfileid: "47562221"
---
# <a name="ide-constants"></a>Константы среды IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [константы среды IDE](https://docs.microsoft.com/visualstudio/extensibility/ide-constants).  
