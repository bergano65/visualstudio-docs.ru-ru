...
ms.locfileid: "47568610"
---
# <a name="sortorder-element-visual-studio-templates"></a>Элемент SortOrder (шаблоны Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент SortOrder (шаблоны Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/sortorder-element-visual-studio-templates).  
