...
ms.locfileid: "47569798"
---
# <a name="keybindings-element"></a>Элемент KeyBindings
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент KeyBindings](https://docs.microsoft.com/visualstudio/extensibility/keybindings-element).  
