...
ms.locfileid: "47558656"
---
# <a name="buttontext-element"></a>Элемент ButtonText
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент ButtonText](https://docs.microsoft.com/visualstudio/extensibility/buttontext-element).  
