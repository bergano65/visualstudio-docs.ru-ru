...
ms.locfileid: "47568573"
---
# <a name="capability-flags"></a>Флаги возможностей
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [флаги возможностей](https://docs.microsoft.com/visualstudio/extensibility/capability-flags).  
