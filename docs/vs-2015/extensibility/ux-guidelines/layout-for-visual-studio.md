...
#### <a name="control-indentation"></a>Отступ элементов управления
 ...
 ![Выравнивание вложенного элемента управления](../../extensibility/ux-guidelines/media/0801-e-controlalign.png "0801 — e_ControlAlign")
...
- Размер внутренней кнопки должен указывать на стандартный размер кнопки в 75x23 пикселях, что соответствует размеру **OK** / кнопок **"ОК"** , если это возможно. Если метка кнопки приводит к превышению стандартного размера кнопки, другие кнопки в этом наборе должны быть согласованы с этим более широким размером.

  ![Горизонтальные кнопки "ОК" и "Отмена"](../../extensibility/ux-guidelines/media/0801-f-horizokcan.png "0801 — f_HorizOKCan")

  **Рисунок 08,01-f: вертикальные внутренние кнопки с горизонтальным нажатием ОК или Отмена**

  ![Вертикальные кнопки "ОК" и "Отмена"](../../extensibility/ux-guidelines/media/0801-g-vertokcan.png "0801 — g_VertOKCan")
 ...
 **Рис. 08,01-i. диалоговое окно с темами — измерения**
 ...
 **Рисунок 08,01-k: диалоговое окно с темами — цвета**

## <a name="see-also"></a>См. также:
 [Шаблоны приложений для](../../extensibility/ux-guidelines/application-patterns-for-visual-studio.md) [диалоговых](https://msdn.microsoft.com/library/windows/desktop/dn742499\(v=vs.85\).aspx) окон [элементов управления](https://msdn.microsoft.com/library/windows/desktop/dn742399.aspx) Visual Studio (Windows)
