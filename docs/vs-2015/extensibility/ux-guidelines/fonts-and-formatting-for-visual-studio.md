 ...
 **Шовмодал** возвращает логическое значение? (логическое значение Nullable) с параметром **DialogResult**, который может использоваться при необходимости. Возвращаемое значение равно true, если диалоговое окно было закрыто с помощью **ОК**.
 ...
 **Использовать для:** заголовков разделов в диалоговых окнах подписи, верхних узлах в представлении в виде дерева, навигации по вертикальной вкладке
...
### <a name="localizable-styles"></a>Локализуемые стили
 ...
 Решением является подключение события **фонтчанжед** диалогового окна. В событии **фонтчанжед** пройдите все элементы управления и проверьте, установлен ли их шрифт. Если оно задано, измените его на новый шрифт на основе шрифта формы и предыдущего стиля шрифта элемента управления. Пример в коде:
...
|-|-|
|**Использование:** Маловероятны. Только уникальный интерфейс с фирменной символикой.<br /><br /> **Запреща**<br /><br /> — Использовать вариант предложения<br />— Всегда использовать легкий вес<br /><br /> **Чего не следует делать:**<br /><br /> — Используйте для пользовательского интерфейса, отличного от пользовательского интерфейса подписи, например начальной страницы.<br />-Полужирный, курсив или полужирный курсив<br />— Использовать для основного текста;<br />— Использовать в окнах инструментов|**Отображается как:** 34 пт Segoe UI light<br /><br /> **Визуальный пример:**<br /><br /> *Сейчас не используется. Может использоваться на начальной странице.*|

#### <a name="310-environment-font--light"></a>310% шрифт окружения + light

|Использование|Внешний вид|
|-|-|
|**Использование:**<br /><br /> -Крупный заголовок в диалоговых окнах подписи<br />— Основной заголовок отчета<br /><br /> **Запреща**<br /><br /> — Использовать вариант предложения<br />— Всегда использовать легкий вес<br /><br /> **Чего не следует делать:**<br /><br /> — Используйте для пользовательского интерфейса, отличного от пользовательского интерфейса подписи, например начальной страницы.<br />-Полужирный, курсив или полужирный курсив<br />— Использовать для основного текста;<br />— Использовать в окнах инструментов|**Отображается как:** 28 пт Segoe UI light<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта окружения 310% &#43; светлого заголовка](../../extensibility/ux-guidelines/media/0202-a-ef310.png "0202 — a_EF310")|

#### <a name="200-environment-font--semilight"></a>200% шрифта окружения + Semilight

|Использование|Внешний вид|
|-|-|
|**Использование:**<br /><br /> -Подзаголовки<br />-Заголовки в небольших и средних диалоговых окнах<br /><br /> **Запреща**<br /><br /> — Использовать вариант предложения<br />— Всегда использовать вес Semilight<br /><br /> **Чего не следует делать:**<br /><br /> -Полужирный, курсив или полужирный курсив<br />— Использовать для основного текста;<br />— Использовать в окнах инструментов|**Отображается как:** 18 пт Segoe UI семиллигхт<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта окружения 200% &#43; Semilight](../../extensibility/ux-guidelines/media/0202-b-ef200.png "0202 — b_EF200")|

#### <a name="155-environment-font"></a>шрифт окружения 155%

|Использование|Внешний вид|
|-|-|
|**Использование:**<br /><br /> — Заголовки разделов в удобном пользовательском интерфейсе документа<br />— Отчеты<br /><br /> **Выполните следующие действия.** Использовать регистр предложений<br /><br /> **Чего не следует делать:**<br /><br /> -Полужирный, курсив или полужирный курсив<br />— Использовать для основного текста;<br />— Использовать в стандартных элементах управления Visual Studio<br />— Использовать в окнах инструментов|**Отображается как:** 14 пт Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта заголовка 155 %, используемого в среде](../../extensibility/ux-guidelines/media/0202-c-ef155.png "0202 — c_EF155")|

#### <a name="133-environment-font"></a>шрифт окружения 133%

|Использование|Внешний вид|
|-|-|
|**Использование:**<br /><br /> — Мелкие подзаголовки в диалоговых окнах подписи<br />— Мелкие подзаголовки в удобном пользовательском интерфейсе документа<br /><br /> **Выполните следующие действия.** Использовать регистр предложений<br /><br /> **Чего не следует делать:**<br /><br /> -Полужирный, курсив или полужирный курсив<br />— Использовать для основного текста;<br />— Использовать в стандартных элементах управления Visual Studio<br />— Использовать в окнах инструментов|**Отображается как:** 12 пт Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта заголовка 133 %, используемого в среде](../../extensibility/ux-guidelines/media/0202-d-ef133.png "0202 — d_EF133")|
