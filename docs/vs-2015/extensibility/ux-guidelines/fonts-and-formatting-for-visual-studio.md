...
- **Текстовый редактор** — элементы, которые всплывают в коде и других текстовых редакторах, могут быть настроены на странице редактора текста в **«Инструменты > варианты».**

- **Конкретные коллекции** - дизайнер окна, которые предлагают пользовательские настройки их элементов интерфейса может подвергать шрифты, характерные для их дизайна поверхности в их собственной странице настройки в **инструменты > варианты**.
...
2. Все остальные элементы интерфейса должны быть привязаны к настройке шрифта среды и реагировать на любые глобальные изменения в среде. Это включает в себя (но не ограничивается):
    ...
    - Текст в редакции, такой как текст меню лампочки, панель быстрого поиска панели редактора и навигация по панели

    - Текст этикетки в диалоговых коробках, таких как «Найти в файлах» или «Рефактор»

### <a name="accessing-the-environment-font"></a>Доступ к шрифту среды
 В коде Native или WinForms можно получить доступ к шрифту среды, позвонив по методу **IUIHostLocale::GetDialogFont** после запроса интерфейса из службы SID_SUIHostLocale.

 Для Фонда презентации Windows (WPF) выйдите из класса окна диалогов из класса **DialogWindow** оболочки вместо класса **Windows** WPF.
...
```
 ...
 Чтобы отобразить диалог, позвоните в "**ShowModal()**" на класс ею над **ShowDialog()**. **ShowModal ()** устанавливает правильное состояние модального состояния в оболочке, гарантирует, что диалог поцентривается в родительском окне и так далее.
 ...
 **ShowModal** возвращает бул? (недействительный Boolean) с **DialogResult**, который может быть использован в случае необходимости. Значение возврата верно, если диалог был закрыт с **OK**.

 Если вам нужно отобразить некоторый UI WPF, который не является диалогом и размещается в собственном **HwndSource,** например, всплывающее окно или окно ребенка WPF родительского окна Win32/WinForms, вам нужно будет установить **FontFamily** и **FontSize** на корневой элемент элемента WPF. (Оболочка устанавливает свойства на главном окне, но они не будут унаследованы мимо HWND). Оболочка предоставляет ресурсы, к которым свойства могут быть связаны, как это:
...
### <a name="formatting-scalingbolding-reference"></a><a name="BKMK_Formatting"></a>Ссылка на форматирование (масштабирование/смазывание)
 Некоторые диалоги требуют, чтобы определенный текст был смелым или размером, кроме шрифта среды. Ранее шрифты, превышающее шрифт среды, кодировались как "экологический шрифт No2" или аналогичный. Использование предоставленных фрагментов кода будет поддерживать мониторы с высоким dPI и гарантировать, что текст отображения всегда отображается при правильном размере и весе (например, Light или Semilight).

> **Примечание: Прежде чем применить форматирование, убедитесь, что вы будете следовать указаниям, найденным в [стиле Text.](../../extensibility/ux-guidelines/fonts-and-formatting-for-visual-studio.md#BKMK_TextStyle)**
 ...
 Где "vsui" является ссылкой на пространство имен Microsoft.VisualStudio.Shell:
 ...
 **Использование для:** (редко) уникального фирменного uI, например, на стартовой странице

 **Процедурный код:** Где "textBlock" является ранее определенным TextBlock и "метка" является ранее определенной этикеткой.
 ...
 **Появляется как:** 28 pt Segoe UI Light

 **Использование для:** большие заголовки диалога подписи, основной заголовок в отчетах
 ...
 **Появляется как:** 18 pt Segoe UI Semilight

 **Использование для:** подзаголовки, названия в малых и средних диалогов
 ...
 **Появляется как:** 14 pt Segoe UI

 **Использование для:** заголовки разделов в документе хорошо UI или отчеты
 ...
 **Появляется как:** 12 pt Segoe UI

 **Использование для:** меньшие подзаголовки в диалогах подписей и документхорошо UI
 ...
 **Появляется как:** 11 pt Segoe UI

 **Используется для:** заголовки разделов в подписных диалогах, верхние узлы в представлении дерева, вертикальная навигация вкладок
 ...
 **Появляется как:** смелый 9 pt Segoe UI

 **Используется для:** меток и подголовок в диалогах подписей, отчетах и хорошо документирует uI
...
### <a name="localizable-styles"></a>Локализованные стили
 ...
 Решение состоит в том, чтобы подключить событие **FontChanged** формы диалога. В случае **FontChanged,** ходить все элементы управления и проверить, если их шрифт установлен. Если он установлен, измените его на новый шрифт на основе шрифта формы и предыдущего стиля шрифта управления. Примером этого в коде является:
...
```
 ...
 Использование этого кода гарантирует, что при обновлении шрифта формы также будут обновляться шрифты элементов управления. Этот метод также следует вызывать из конструктора формы, потому что диалог может не получить экземпляр **IUIService** и **событие FontChanged** никогда не будет гореть. Подключение **FontChanged** позволит диалогов динамически подобрать новый шрифт, даже если диалог уже открыт.

### <a name="testing-the-environment-font"></a>Тестирование шрифта среды
 Чтобы убедиться, что ваш шрифт использования среды и уважает параметры размера, откройте **инструменты > варианты > среды > шрифты и цвета** и выберите "Экологический шрифт" в меню "Показать настройки для:" выпадающие меню.

 ![Шрифты и цвета страницы в инструменты &#62; варианты диалога](../../extensibility/ux-guidelines/media/0201-a-optionsfonts.png "0201-a_OptionsFonts")

 **Настройки шрифтов и цветов в диалоге «Инструменты > варианты»**
 ...
 **Пример текста uI, который не уважает шрифт окружающей среды**
...
- определенные события в списках выпадающих редакторов Visual Basic
...
- При использовании цвета в заголовках, вы должны придерживаться [принципов цвета Windows,](https://msdn.microsoft.com/library/dn742482.aspx)включая соотношение контрастности и другие соображения доступности.
...
|||
|-|-|
|**Использование:** Редких. Уникальный фирменный только uI.<br /><br /> **Делать:**<br /><br /> - Использование приговора случае<br />- Всегда используйте легкий вес<br /><br /> **Чего не следует делать:**<br /><br /> - Использование для uI, кроме подписного uI, например Start Page<br />- Смелый, курсив, или смелый курсив<br />- Использование для текста тела<br />- Использование в окнах инструментов|**Появляется как:** 34 pt Segoe UI Light<br /><br /> **Визуальный пример:**<br /><br /> *В настоящее время не используется. Может использоваться на стартовой странице.*|

#### <a name="310-environment-font--light"></a>310% Окружающая среда шрифта

|||
|-|-|
|**Использование:**<br /><br /> - Большая заголовок в подписных диалогах<br />- Основной отчет заголовок<br /><br /> **Делать:**<br /><br /> - Использование приговора случае<br />- Всегда используйте легкий вес<br /><br /> **Чего не следует делать:**<br /><br /> - Использование для uI, кроме подписного uI, например Start Page<br />- Смелый, курсив, или смелый курсив<br />- Использование для текста тела<br />- Использование в окнах инструментов|**Появляется как:** 28 pt Segoe UI Light<br /><br /> **Визуальный пример:**<br /><br /> ![Пример 310% Окружающая среда шрифт &#43; Свет заголовок](../../extensibility/ux-guidelines/media/0202-a-ef310.png "0202-a_EF310")|

#### <a name="200-environment-font--semilight"></a>200% Окружающая среда шрифта

|||
|-|-|
|**Использование:**<br /><br /> - Подзаголовки<br />- Названия в малых и средних диалогах<br /><br /> **Делать:**<br /><br /> - Использование приговора случае<br />- Всегда используйте полулегкий вес<br /><br /> **Чего не следует делать:**<br /><br /> - Смелый, курсив, или смелый курсив<br />- Использование для текста тела<br />- Использование в окнах инструментов|**Появляется как:** 18 pt Segoe UI Semillight<br /><br /> **Визуальный пример:**<br /><br /> ![Пример 200% шрифта окружающей среды &#43; Полулайт](../../extensibility/ux-guidelines/media/0202-b-ef200.png "0202-b_EF200")|

#### <a name="155-environment-font"></a>155% Шрифт окружающей среды

|||
|-|-|
|**Использование:**<br /><br /> - Раздел заголовки в документе хорошо UI<br />- Отчеты<br /><br /> **Делать:** Использование приговора случае<br /><br /> **Чего не следует делать:**<br /><br /> - Смелый, курсив, или смелый курсив<br />- Использование для текста тела<br />- Использование в стандартных элементах управления Visual Studio<br />- Использование в окнах инструментов|**Появляется как:** 14 pt Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта заголовка 155 %, используемого в среде](../../extensibility/ux-guidelines/media/0202-c-ef155.png "0202-c_EF155")|

#### <a name="133-environment-font"></a>133% Шрифт окружающей среды

|||
|-|-|
|**Использование:**<br /><br /> - Меньшие подзаголовки в подписных диалогах<br />- Меньшие подзаголовки в документе хорошо UI<br /><br /> **Делать:** Использование приговора случае<br /><br /> **Чего не следует делать:**<br /><br /> - Смелый, курсив, или смелый курсив<br />- Использование для текста тела<br />- Использование в стандартных элементах управления Visual Studio<br />- Использование в окнах инструментов|**Появляется как:** 12 pt Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта заголовка 133 %, используемого в среде](../../extensibility/ux-guidelines/media/0202-d-ef133.png "0202-d_EF133")|

#### <a name="122-environment-font"></a>122% Окружающая среда шрифт

|||
|-|-|
|**Использование:**<br /><br /> - Раздел заголовки в подписи диалогов<br />- Верхние узлы в представлении дерева<br />- Вертикальная навигация вкладок<br /><br /> **Делать:** Использование приговора случае<br /><br /> **Чего не следует делать:**<br /><br /> - Смелый, курсив, или смелый курсив<br />- Использование для текста тела<br />- Использование в стандартных элементах управления Visual Studio<br />- Использование в окнах инструментов|**Появляется как:** 11 pt Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта заголовка 122 %, используемого в среде](../../extensibility/ux-guidelines/media/0202-e-ef122.png "0202-e_EF122")|

#### <a name="environment-font--bold"></a>Шрифт окружающей среды и жирный

|||
|-|-|
|**Использование:**<br /><br /> - Этикетки и подмыки в подписных диалогах<br />- Этикетки и поднамы в отчетах<br />- Этикетки и подмыки в документе хорошо UI<br /><br /> **Делать:**<br /><br /> - Использование приговора случае<br />- Используйте смелый вес<br /><br /> **Чего не следует делать:**<br /><br /> - курсивный или смелый курсив<br />- Использование для текста тела<br />- Использование в стандартных элементах управления Visual Studio<br />- Использование в окнах инструментов|**Появляется как:** смелый 9 pt Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта окружающей среды &#43; смелейшее заголовок](../../extensibility/ux-guidelines/media/0202-f-efb.png "0202-f_EFB")|

#### <a name="environment-font"></a>Шрифт окружающей среды

|||
|-|-|
|**Использование:** Весь другой текст<br /><br /> **Делать:** Использование приговора случае<br /><br /> **Не:** курсивили или смелые курсивом|**Появляется как:** 9 pt Segoe UI<br /><br /> **Визуальный пример:**<br /><br /> ![Пример шрифта среды разработки](../../extensibility/ux-guidelines/media/0202-g-ef.png "0202-g_EF")|
