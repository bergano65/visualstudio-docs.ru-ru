...
|Введите:|Выполняет команду по умолчанию для объекта (обычно это открытие или изменение).|
...
|-------------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
|     **Unselected**      |    По умолчанию    |                 ![Состояние кнопки по умолчанию](../../extensibility/ux-guidelines/media/0713-10-defaultstate.png "0713 — 10_DefaultState")                 |
...
|      **Пользовательский интерфейс активен**      |    По умолчанию    |                       ![Активное состояние пользовательского интерфейса](../../extensibility/ux-guidelines/media/0713-23-uiactive.png "0713 — 23_UIActive")                        |
