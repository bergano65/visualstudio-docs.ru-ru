...
|**Отладчик:** группа Windows, относящаяся к отладке задач и наблюдению за действиями|Интерпретация||
...
|**Отладчик:** группа Windows, относящаяся к отладке задач и наблюдению за действиями|Запущен||
...
|Модификатор|Операция|Исходный элемент: ссылка или ссылка|Исходный элемент: физический элемент или файловая система (CF_HDROP)|
|-|-|----------------------------------|-------------------------------------------------------------|
