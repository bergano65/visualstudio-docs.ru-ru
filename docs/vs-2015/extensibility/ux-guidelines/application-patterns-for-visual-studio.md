...
ms.locfileid: "47558610"
---
# <a name="application-patterns-for-visual-studio"></a>Шаблоны приложений для Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [шаблоны приложений для Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/application-patterns-for-visual-studio).  
...
|**Содержимое**|Справка|Окно, которое позволяет пользователям доступ к различным методам получения справки, из «Практические советы» видео на форумах MSDN.|  
...
|||Элемент источника: ссылка|Элемент источника: физической системе элемент или файл (CF_HDROP)|  
|-|-|----------------------------------|-------------------------------------------------------------|  
...
|Shift + перетаскивание|Исходный код|Удаляет ссылку на исходный элемент|Не раскрывается|  
...
|CTRL + перетаскивание|Исходный код|Сохраняет ссылку на исходный элемент|Не раскрывается|  
...
|Операции вырезания и вставки|Исходный код|Сохраняет ссылку на исходный элемент|Сохраняет исходный элемент|  
...
|Shift + перетаскивание|Исходный код|Удаляет ссылку на исходный элемент|Удаляет элемент из исходного расположения|  
...
|Операции вырезания и вставки|Исходный код|Удаляет ссылку на исходный элемент|Удаляет элемент из исходного расположения|  
