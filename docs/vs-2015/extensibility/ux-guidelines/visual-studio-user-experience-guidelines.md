...
- [Шаблоны и руководства по приложениям Windows Store](https://dev.windows.com/design/interaction-ux) являются ссылку для новых шаблонов, которые могут использоваться в некоторых случаях в среде Visual Studio.  
