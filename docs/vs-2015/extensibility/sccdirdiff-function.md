...
ms.locfileid: "47568268"
---
# <a name="sccdirdiff-function"></a>Функция SccDirDiff
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [функция SccDirDiff](https://docs.microsoft.com/visualstudio/extensibility/sccdirdiff-function).  
