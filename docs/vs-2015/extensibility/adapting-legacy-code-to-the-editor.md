...
ms.locfileid: "47570325"
---
# <a name="adapting-legacy-code-to-the-editor"></a>Адаптация кода прежних версий для редактора
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [адаптации кода прежних версий в редактор](https://docs.microsoft.com/visualstudio/extensibility/adapting-legacy-code-to-the-editor).  
