...
ms.locfileid: "47559029"
---
# <a name="commandplacements-element"></a>Элемент CommandPlacements
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент CommandPlacements](https://docs.microsoft.com/visualstudio/extensibility/commandplacements-element).  
