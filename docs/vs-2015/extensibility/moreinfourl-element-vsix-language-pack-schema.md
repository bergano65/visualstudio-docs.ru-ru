---
title: Элемент Мореинфаурл (схема языкового пакета VSIX) | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="text-value"></a>Текстовое значение  
 Необязательный элемент. Ссылка на веб-сайт. Ссылка является текстовой строкой.  
