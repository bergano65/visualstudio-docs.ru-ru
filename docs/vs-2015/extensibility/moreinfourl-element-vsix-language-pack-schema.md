---
title: Элемент MoreInfoURL (схема языкового пакета VSIX) | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47571870"
---
# <a name="moreinfourl-element-vsix-language-pack-schema"></a>Элемент MoreInfoURL (схема языкового пакета VSIX)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент MoreInfoURL (схема языкового пакета VSIX)](https://docs.microsoft.com/visualstudio/extensibility/moreinfourl-element-vsix-language-pack-schema).  
  
Необязательный. Ссылка на локализованную информацию о расширении.  
...
## <a name="text-value"></a>Текстовое значение  
 Необязательный. Ссылка на веб-сайт. Ссылка представляет собой текстовую строку.  
