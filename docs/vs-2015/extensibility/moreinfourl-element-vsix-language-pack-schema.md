...
## <a name="text-value"></a>Текстовое значение  
 Необязательный параметр. Ссылка на веб-сайт. Ссылка представляет собой текстовую строку.  
