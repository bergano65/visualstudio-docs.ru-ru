...
ms.locfileid: "47564211"
---
# <a name="package-guids-of-visual-studio-features"></a>Пакет GUID функций Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [пакет идентификаторов GUID из функции Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/package-guids-of-visual-studio-features).  
