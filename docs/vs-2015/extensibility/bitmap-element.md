...
ms.locfileid: "47559656"
---
# <a name="bitmap-element"></a>Элемент Bitmap
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [точечный рисунок элемента](https://docs.microsoft.com/visualstudio/extensibility/bitmap-element).  
