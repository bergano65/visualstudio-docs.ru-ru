...
ms.locfileid: "47572469"
---
# <a name="customparameters-element-visual-studio-templates"></a>Элемент CustomParameters (шаблоны Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент CustomParameters (шаблоны Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/customparameters-element-visual-studio-templates).  
