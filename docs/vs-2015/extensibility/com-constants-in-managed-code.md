...
ms.locfileid: "47572823"
---
# <a name="com-constants-in-managed-code"></a>Константы COM в управляемом коде
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [константы COM в управляемом коде](https://docs.microsoft.com/visualstudio/extensibility/com-constants-in-managed-code).  
