...
ms.locfileid: "47569772"
---
# <a name="document-lock-holder-management"></a>Управление контейнером блокировки документа
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [управление контейнером блокировки документа](https://docs.microsoft.com/visualstudio/extensibility/document-lock-holder-management).  
