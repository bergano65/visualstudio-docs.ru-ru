...
ms.locfileid: "47561225"
---
# <a name="how-to-use-text-markers"></a>Практическое: использовать текстовые метки
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: используйте текстовые метки](https://docs.microsoft.com/visualstudio/extensibility/how-to-use-text-markers).  
