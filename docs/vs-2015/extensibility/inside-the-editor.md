...
ms.locfileid: "47570430"
---
# <a name="inside-the-editor"></a>Компоненты редактора
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [внутри редактора](https://docs.microsoft.com/visualstudio/extensibility/inside-the-editor).  
