...
Последнюю версию этого раздела можно найти в [предоставляют поддержка структурирования в языковой службе](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-provide-expanded-outlining-support-in-a-legacy-language-service).  
