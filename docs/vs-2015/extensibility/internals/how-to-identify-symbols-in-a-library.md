...
ms.locfileid: "47571344"
---
# <a name="how-to-identify-symbols-in-a-library"></a>Практическое: определение символов в библиотеке
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: определение символов в библиотеке](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-identify-symbols-in-a-library).  
