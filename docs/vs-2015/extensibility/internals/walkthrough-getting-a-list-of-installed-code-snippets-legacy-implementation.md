...
Последнюю версию этого раздела можно найти в [начало списка из установки фрагментов кода (для прежних версий)](https://docs.microsoft.com/visualstudio/extensibility/internals/walkthrough-getting-a-list-of-installed-code-snippets-legacy-implementation).  
