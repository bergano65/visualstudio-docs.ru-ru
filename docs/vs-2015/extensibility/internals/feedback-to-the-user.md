...
ms.locfileid: "47572444"
---
# <a name="feedback-to-the-user"></a>Обратная связь с пользователем
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [обратной связи с пользователем](https://docs.microsoft.com/visualstudio/extensibility/internals/feedback-to-the-user).  
