...
ms.locfileid: "90843361"
---
# <a name="registering-a-project-type"></a>Регистрация типа проекта
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

При создании нового типа проекта необходимо создать записи реестра, которые позволяют [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] распознать тип проекта и работать с ним. Обычно эти записи реестра создаются с помощью файла скрипта реестра (RGS).  
