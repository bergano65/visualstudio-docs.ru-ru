...
ms.locfileid: "47563463"
---
# <a name="elimination-of-sak-files"></a>Устранение ~SAK-файлов
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Устранение ~ SAK-файлов](https://docs.microsoft.com/visualstudio/extensibility/internals/elimination-of-tilde-sak-files).  
