...
ms.locfileid: "47573268"
---
# <a name="image-library-viewer"></a>Средство просмотра библиотеки образов
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [средство просмотра библиотеки изображений](https://docs.microsoft.com/visualstudio/extensibility/internals/image-library-viewer).  
