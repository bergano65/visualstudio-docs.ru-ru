...
## <a name="in-this-section"></a>в этом разделе  
 ...
 Описывает, как проекты в [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] могут поддерживать несколько конфигураций.  
 ...
 Определяет действие развертывания и два способа [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] поддержки проектов, поддерживающих развертывание.  
