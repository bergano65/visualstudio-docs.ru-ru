...
ms.locfileid: "47568916"
---
# <a name="managing-configuration-options"></a>Управление параметрами конфигурации
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [управление параметры конфигурации](https://docs.microsoft.com/visualstudio/extensibility/internals/managing-configuration-options).  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Определяет процесс развертывания и два способа [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] поддерживает проекты, которые поддерживают развертывание.  
