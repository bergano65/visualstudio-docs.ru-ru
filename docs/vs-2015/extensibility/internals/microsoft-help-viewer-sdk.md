...
ms.locfileid: "47570610"
---
# <a name="microsoft-help-viewer-sdk"></a>Пакет SDK окна справки (Майкрософт)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [средстве просмотра справки Microsoft SDK](https://docs.microsoft.com/visualstudio/extensibility/internals/microsoft-help-viewer-sdk).  
