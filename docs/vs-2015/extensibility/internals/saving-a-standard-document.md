...
ms.locfileid: "47569778"
---
# <a name="saving-a-standard-document"></a>Сохранение стандартного документа
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Сохранение стандартного документа](https://docs.microsoft.com/visualstudio/extensibility/internals/saving-a-standard-document).  
