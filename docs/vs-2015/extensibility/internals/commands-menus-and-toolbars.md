...
ms.locfileid: "47558932"
---
# <a name="commands-menus-and-toolbars"></a>Команды, меню и панели инструментов
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [команд, меню и панелей инструментов](https://docs.microsoft.com/visualstudio/extensibility/internals/commands-menus-and-toolbars).  
