...
ms.locfileid: "47572042"
---
# <a name="hierarchies-and-selection"></a>Иерархии и выбор
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [иерархии и выбор](https://docs.microsoft.com/visualstudio/extensibility/internals/hierarchies-and-selection).  
