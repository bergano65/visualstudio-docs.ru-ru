...
### [Пошаговое руководство: получение списка установленных фрагментов кода (реализация прежних версий)](walkthrough-getting-a-list-of-installed-code-snippets-legacy-implementation.md)
...
# [Проекты](projects.md)
## [Создание проекта: как это работает, часть 1](new-project-generation-under-the-hood-part-one.md)
## [Создание проекта: как это работает, часть 2](new-project-generation-under-the-hood-part-two.md)
...
#### [Контрольный список. Создание новых типов проектов](checklist-creating-new-project-types.md)
...
#### [Область тестирования 2. Получение элементов из системы управления версиями](test-area-2-get-from-source-control.md)
#### [Область тестирования 3. Извлечение и отмена извлечения](test-area-3-check-out-undo-checkout.md)
#### [Область тестирования 4. Запись после изменения](test-area-4-check-in.md)
#### [Область тестирования 5. Смена системы управления версиями](test-area-5-change-source-control.md)
#### [Область тестирования 6. Удаление](test-area-6-delete.md)
#### [Область тестирования 7. Общий доступ](test-area-7-share.md)
#### [Область тестирования 8. Переключение подключаемых модулей](test-area-8-plug-in-switching.md)
