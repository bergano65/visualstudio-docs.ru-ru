...
В следующих разделах приводятся списки записей реестра для различных параметров языковой службы, доступных в [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] .  
  
 В следующем списке записей реестра *корневой каталог VS reg* равен HKEY_LOCAL_MACHINE \софтваре\микрософт\висуалстудио \\ *X. y*, где *X. y* — [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] номер версии.  
