...
ms.locfileid: "47564280"
---
# <a name="solution-configuration"></a>Конфигурация решения
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [конфигурации решения](https://docs.microsoft.com/visualstudio/extensibility/internals/solution-configuration).  
