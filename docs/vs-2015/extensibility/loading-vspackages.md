...
ms.locfileid: "47569411"
---
# <a name="loading-vspackages"></a>Загрузка пакетов VSPackage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Загрузка пакетов VSPackage](https://docs.microsoft.com/visualstudio/extensibility/loading-vspackages).  
