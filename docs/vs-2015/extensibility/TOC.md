# [SDK для Visual Studio](visual-studio-sdk.md)
...
### [Пошаговое руководство: отображение парных скобок](walkthrough-displaying-matching-braces.md)
...
### [Атрибуты Conditional](vsct-xml-schema-conditional-attributes.md)
## [GUID и константы](guids-and-constants-in-the-visual-studio-sdk.md)
...
#### [SccAddFilesFromSCC](sccaddfromscc-function.md)
