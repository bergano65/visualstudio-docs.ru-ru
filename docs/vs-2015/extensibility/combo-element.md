...
ms.locfileid: "47558931"
---
# <a name="combo-element"></a>Элемент Combo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент поля со списком](https://docs.microsoft.com/visualstudio/extensibility/combo-element).  
