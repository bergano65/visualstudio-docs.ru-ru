...
ms.locfileid: "47570683"
---
# <a name="how-to-provide-context-for-editors"></a>Практическое: предоставить контекст для редакторов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: предоставляют контекст для редакторов](https://docs.microsoft.com/visualstudio/extensibility/how-to-provide-context-for-editors).  
