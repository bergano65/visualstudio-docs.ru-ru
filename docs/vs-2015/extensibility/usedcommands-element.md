...
ms.locfileid: "47564207"
---
# <a name="usedcommands-element"></a>Элемент UsedCommands
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент UsedCommands](https://docs.microsoft.com/visualstudio/extensibility/usedcommands-element).  
