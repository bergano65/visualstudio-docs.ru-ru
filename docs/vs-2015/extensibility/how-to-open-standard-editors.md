...
ms.locfileid: "47563899"
---
# <a name="how-to-open-standard-editors"></a>Как: открытие стандартных редакторов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: открытие стандартных редакторов](https://docs.microsoft.com/visualstudio/extensibility/how-to-open-standard-editors).  
