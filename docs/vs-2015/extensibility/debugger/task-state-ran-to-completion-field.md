...
ms.locfileid: "47559618"
---
# <a name="taskstaterantocompletion-field"></a>Поле TASK_STATE_RAN_TO_COMPLETION
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поле TASK_STATE_RAN_TO_COMPLETION](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-ran-to-completion-field).  
