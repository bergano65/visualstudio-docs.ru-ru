...
ms.locfileid: "47561218"
---
# <a name="debugger-components"></a>Компоненты отладчика
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [компоненты отладчика](https://docs.microsoft.com/visualstudio/extensibility/debugger/debugger-components).  
