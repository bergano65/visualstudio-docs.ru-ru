...
ms.locfileid: "47561055"
---
# <a name="getting-a-port"></a>Получение порта
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [получение порта](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-a-port).  
