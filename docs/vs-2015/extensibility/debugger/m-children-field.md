...
ms.locfileid: "47570586"
---
# <a name="mchildren-field"></a>Поле m_children
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поля m_children](https://docs.microsoft.com/visualstudio/extensibility/debugger/m-children-field).  
