...
ms.locfileid: "47569916"
---
# <a name="debugger-concepts"></a>Отладчик: основные понятия
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [понятия отладчик](https://docs.microsoft.com/visualstudio/extensibility/debugger/debugger-concepts).  
