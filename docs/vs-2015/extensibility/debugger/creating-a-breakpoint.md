...
ms.locfileid: "47561047"
---
# <a name="creating-a-breakpoint"></a>Создание точки останова
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [создания точки останова](https://docs.microsoft.com/visualstudio/extensibility/debugger/creating-a-breakpoint).  
