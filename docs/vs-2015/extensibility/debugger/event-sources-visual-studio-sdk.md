...
ms.locfileid: "47560597"
---
# <a name="event-sources-visual-studio-sdk"></a>Источники событий (пакет SDK для Visual Studio)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [источников событий (Visual Studio SDK)](https://docs.microsoft.com/visualstudio/extensibility/debugger/event-sources-visual-studio-sdk).  
