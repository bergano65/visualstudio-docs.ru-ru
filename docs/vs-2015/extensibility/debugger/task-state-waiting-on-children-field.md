...
ms.locfileid: "47561223"
---
# <a name="taskstatewaitingonchildren-field"></a>Поле TASK_STATE_WAITING_ON_CHILDREN
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поле TASK_STATE_WAITING_ON_CHILDREN](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-waiting-on-children-field).  
