...
ms.locfileid: "47568464"
---
# <a name="mstateflags-field"></a>Поле m_stateFlags
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [m_stateFlags поле](https://docs.microsoft.com/visualstudio/extensibility/debugger/m-stateflags-field).  
