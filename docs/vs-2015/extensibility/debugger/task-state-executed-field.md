...
ms.locfileid: "47571058"
---
# <a name="taskstateexecuted-field"></a>Поле TASK_STATE_EXECUTED
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поле TASK_STATE_EXECUTED](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-executed-field).  
