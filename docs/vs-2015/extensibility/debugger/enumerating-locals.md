...
ms.locfileid: "47569730"
---
# <a name="enumerating-locals"></a>Перечисление локальных переменных
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [перечисление "Локальные"](https://docs.microsoft.com/visualstudio/extensibility/debugger/enumerating-locals).  
