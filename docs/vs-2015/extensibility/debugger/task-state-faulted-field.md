...
ms.locfileid: "47572927"
---
# <a name="taskstatefaulted-field"></a>Поле TASK_STATE_FAULTED
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поле TASK_STATE_FAULTED](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-faulted-field).  
