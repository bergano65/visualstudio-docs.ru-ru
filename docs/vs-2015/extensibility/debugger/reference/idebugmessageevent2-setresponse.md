...
#### <a name="parameters"></a>Параметры  
 `dwResponse`  
 [in] Указывает ответ, используя правила Win32 `MessageBox` функции. См. в разделе [AfxMessageBox](https://msdn.microsoft.com/library/d66d0328-cdcc-48f6-96a4-badf089099c8) функция сведения.  
