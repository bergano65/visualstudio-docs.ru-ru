...
ms.locfileid: "47568265"
---
# <a name="portsupplierdescriptionflags"></a>PORT_SUPPLIER_DESCRIPTION_FLAGS
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [PORT_SUPPLIER_DESCRIPTION_FLAGS](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/port-supplier-description-flags).  
