...
ms.locfileid: "47559237"
---
# <a name="displaying-locals"></a>Отображение локальных переменных
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в ["Локальные" Отображение](https://docs.microsoft.com/visualstudio/extensibility/debugger/displaying-locals).  
