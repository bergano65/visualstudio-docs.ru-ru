...
ms.locfileid: "47562205"
---
# <a name="evaluating-locals"></a>Вычисление локальных переменных
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [оценки "Локальные"](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
