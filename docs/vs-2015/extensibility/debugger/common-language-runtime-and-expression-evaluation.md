...
ms.locfileid: "47561158"
---
# <a name="common-language-runtime-and-expression-evaluation"></a>Вычисления выражений и среда CLR
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [общеязыковая среда выполнения и механизм вычисления выражений](https://docs.microsoft.com/visualstudio/extensibility/debugger/common-language-runtime-and-expression-evaluation).  
