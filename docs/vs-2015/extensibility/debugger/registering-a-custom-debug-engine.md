...
> [!NOTE]
> Пример того, как зарегистрировать модуль отладки можно найти в образце TextInterpreter, являющуюся частью [руководства: Создание модуля отладки с помощью ATL COM](https://msdn.microsoft.com/9097b71e-1fe7-48f7-bc00-009e25940c24).  
