...
1. Анализирует и оценивает выражение для создания универсального объекта, содержащего значение и его тип. В C# это значение представляется как `object` время в C++. оно представлено в виде `VARIANT` .  
