...
ms.locfileid: "47559164"
---
# <a name="scccloseproject-function"></a>Функция SccCloseProject
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [функция SccCloseProject](https://docs.microsoft.com/visualstudio/extensibility/scccloseproject-function).  
