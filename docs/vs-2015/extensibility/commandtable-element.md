...
ms.locfileid: "47563647"
---
# <a name="commandtable-element"></a>Элемент CommandTable
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент CommandTable](https://docs.microsoft.com/visualstudio/extensibility/commandtable-element).  
