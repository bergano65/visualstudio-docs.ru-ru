...
ms.locfileid: "47560448"
---
# <a name="private-galleries"></a>Private Galleries
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [частные коллекции](https://docs.microsoft.com/visualstudio/extensibility/private-galleries).  
