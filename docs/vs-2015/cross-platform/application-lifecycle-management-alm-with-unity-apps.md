...
|Покрытие кода|Недоступно|Неприменимо, так как модульное тестирование выполняется в среде Unity, а не в Visual Studio. См. следующий пункт.|  
...
|[Используйте автоматизацию ui для тестирования кода](../test/use-ui-automation-to-test-your-code.md)|нет|Закодированные тесты пользовательского интерфейса предполагают наличие доступных для чтения элементов управления в пользовательском интерфейсе приложения. Приложения Unity по своей сути являются графическими, и их содержимое не может считываться средствами для проведения таких тестов.|  
  
## <a name="improve-code-quality"></a>Улучшите качество кода  
 Ссылка: **[Улучшите качество кода](https://msdn.microsoft.com/library/73baa961-c21f-43fe-bb92-3f59ae9b5945)**  
