...
- [Сборка приложений для устройств Android, iOS и Windows (.NET Framework)](#NET)

  - [Целевое Android, iOS и Windows из одной базы кода](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#AndroidHTML)

  - [Целевые устройства с Windows 10](../cross-platform/cross-platform-mobile-development-in-visual-studio.md#WindowsHTML)

- [Создание приложения для Android, iOS и Windows (HTML/JavaScript)](#HTML)
...
## <a name="build-an-app-for-android-ios-and-windows-net-framework"></a><a name="NET"></a> Создание приложения для Android, iOS и Windows (.NET Framework)
...
|[Сведения об универсальных приложениях Windows в Visual Studio](https://www.visualstudio.com/vs/universal-windows-platform/) (VisualStudio.com)|
...
### <a name="target-android-ios-and-windows-from-a-single-code-base"></a><a name="AndroidHTML"></a> Целевые устройства Android, iOS и Windows из единой базы кода
 ...
 Когда все будет готово, шаблоны проектов отобразятся в диалоговом окне **Новый проект** . Чтобы найти шаблоны Xamarin, проще всего ввести "Xamarin" в строке поиска.
...
#### <a name="share-code-between-android-ios-and-windows-apps"></a><a name="ShareHTML"></a> Совместное использование кода приложениями Android, iOS и Windows
 ...
 ![Совместное использование кода между Windows, iOs и интерфейсом пользователя Android](../cross-platform/media/sharecode.png "ShareCode")
...
## <a name="build-an-app-for-android-ios-and-windows-htmljavascript"></a><a name="HTML"></a> Сборка приложения для устройств Android, iOS и Windows (HTML/JavaScript)
 ...
 ![Гибридные приложения для устройств с несколькими&#45;](../cross-platform/media/multidevicehybridapps.png "мултидевицехибридаппс")
...
## <a name="build-an-app-for-android-and-windows-c"></a><a name="CPP"></a> Создание приложения для Android и Windows (C++)
...
|**Дополнительные сведения**|
|--------------------|
|[Скачайте Visual Studio.](https://visualstudio.microsoft.com/vs/community/) (VisualStudio.com)|
...
## <a name="build-a-cross-platform-game-for-android-ios-and-windows-by-using-visual-studio-tools-for-unity"></a><a name="Unity"></a> Создание кросс-платформенной игры для Android, iOS и Windows с помощью инструментов Visual Studio для Unity
 Инструменты Visual Studio для Unity — это бесплатное расширение для Visual Studio, которое интегрирует мощные средства редактирования кода, производительности и отладки Visual Studio с *Unity*, популярную кросс-платформенную подсистему и среду разработки для впечатляющих приложений, предназначенных для Windows, iOS, Android и других платформ, включая Интернет.
