...
ms.locfileid: "47569405"
---
# <a name="validation-in-a-domain-specific-language"></a>Проверка в доменных языках
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [проверка в доменных языках](https://docs.microsoft.com/visualstudio/modeling/validation-in-a-domain-specific-language).  
...
## <a name="running-validation-when-a-change-occurs"></a>Запуск проверки при внесении изменений  
 ...
 В дополнение к коду проверки добавьте файл пользовательского кода в вашей **DslPackage** проекта с содержимым, как в следующем примере. В этом коде используется `ValidationController`, который вложен в документ. Этот контроллер отображает ошибки проверки в списке ошибок [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].  
