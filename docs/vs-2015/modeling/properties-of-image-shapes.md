...
ms.locfileid: "47572480"
---
# <a name="properties-of-image-shapes"></a>Свойства фигур изображений
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [свойства фигур изображений](https://docs.microsoft.com/visualstudio/modeling/properties-of-image-shapes).  
...
|Модификатор доступа|Модификатор доступа геометрической фигуры (общедоступного или внутреннего).|Public|  
...
|Модификатор наследования|Описывает тип наследования класса исходного кода, созданный из фигуры изображения (`none`, `abstract` или `sealed`).|Нет|  
|Базовая фигура изображения|Базовый класс для этой фигуры.|(нет)|  
...
|Тип подсказки|Место где определены подсказки (фиксированное значение, переменная или none). Если так, то значение `Fixed Tooltip Text` свойство используется в качестве подсказки; Если переменная, то подсказки определен в пользовательском коде.|Нет|  
