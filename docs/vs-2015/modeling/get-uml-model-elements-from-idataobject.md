...
## <a name="code-sample"></a>Образец кода
 Проект должен ссылаться на следующие [!INCLUDE[TLA2#tla_net](../includes/tla2sharptla-net-md.md)] сборки:
...
```
 ...
 Дополнительные сведения о `ElementGroupPrototype` и о `Store` реализации средств моделирования UML см. в статье [моделирование пакета SDK для Visual Studio — языки, относящиеся к домену](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md).
