...
ms.locfileid: "47570331"
---
# <a name="get-uml-model-elements-from-idataobject"></a>Получение элементов модели UML из IDataObject
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элементов модели получения UML из IDataObject](https://docs.microsoft.com/visualstudio/modeling/get-uml-model-elements-from-idataobject).  
