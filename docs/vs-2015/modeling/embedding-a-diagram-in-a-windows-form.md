---
title: Встраивание схемы в форму Windows Forms | Документация Майкрософт
ms.date: 11/15/2016
...
#### <a name="to-embed-a-dsl-diagram-in-a-windows-control"></a>Встраивание схемы DSL в элемент управления Windows
...
4. Чтобы проверить DSL, нажмите клавишу F5 и в экспериментальном экземпляре [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] откройте файл образца модели.
