...
### <a name="test-the-solution"></a>Тестирование решения
 ...
 Если вы запускаете решение, созданное на основе шаблона **минимального языка** , экспериментальный [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] пример будет выглядеть следующим образом:
...
> После добавления функции не забудьте нажать кнопку **преобразовать все шаблоны** на панели инструментов Обозреватель решений перед созданием и запуском DSL.
 ...
 ![Внедрение связей и установка ссылок на них](../modeling/media/music-classes.png "Music_Classes")
...
6. **Сопоставьте свойства с текстовыми декораторами.**
   ...
   4. Возле имени каждого декоратора должен быть установлен флажок.
      ...
      ![Сопоставление фигур и окно сведений DSL](../modeling/media/dsldetailswindow.png "дслдетаилсвиндов")
