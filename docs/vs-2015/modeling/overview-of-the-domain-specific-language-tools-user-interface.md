...
## <a name="the-domain-model-diagram"></a>Схема модели предметной области
 ...
 ![конструктор dsl с полосой задач](../modeling/media/dsl-desinger.png "dsl_designer")
...
## <a name="see-also"></a>См. также
 [Средства предметно-ориентированных языков](../modeling/overview-of-domain-specific-language-tools.md) [Глоссарий средств предметно-ориентированных языков](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa) [Настройка и расширение предметно-ориентированных языков](../modeling/customizing-and-extending-a-domain-specific-language.md)
