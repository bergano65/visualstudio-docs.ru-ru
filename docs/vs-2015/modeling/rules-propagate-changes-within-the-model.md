...
ms.locfileid: "47558840"
---
# <a name="rules-propagate-changes-within-the-model"></a>Правила распространяют изменения в пределах модели
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [распространение изменений в модели правил](https://docs.microsoft.com/visualstudio/modeling/rules-propagate-changes-within-the-model).  
