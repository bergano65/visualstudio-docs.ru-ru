...
ms.locfileid: "47563593"
---
# <a name="customizing-copy-behavior"></a>Настройка функции копирования
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Настройка поведения копирования](https://docs.microsoft.com/visualstudio/modeling/customizing-copy-behavior).  
