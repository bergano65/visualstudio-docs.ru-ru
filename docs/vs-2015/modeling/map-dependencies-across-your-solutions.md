...
ms.locfileid: "75847633"
---
# <a name="map-dependencies-across-your-solutions"></a>Сопоставление зависимостей во всех решениях
...
6. Для просмотра дополнительных элементов, связанных с элементами на карте, выделите нужный элемент и выберите команду **Показать связанные** на панели инструментов карты кода. После этого выберите тип связанных элементов, которые нужно добавить на карту. Также можно выбрать один или несколько элементов, открыть контекстное меню и выбрать пункт **Показать...** для типа связанных элементов, которые нужно добавить на карту. Например:
...
### <a name="share-the-map-with-other-visual-studio-users"></a>Совместное использование карты с другими пользователями Visual Studio
 ...
 Чтобы сохранить карту как часть конкретного проекта, на панели инструментов Map выберите **поделиться**, **переместить** \<*кодемапнаме*> **. DGML в**, а затем выберите проект, в котором нужно сохранить карту.
