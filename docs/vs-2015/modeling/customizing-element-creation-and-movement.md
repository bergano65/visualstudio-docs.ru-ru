...
- Код программы вызывает директиву слияния элементов.
  ...
  ![DSL&#45;емд&#95;Merge](../modeling/media/dsl-emd-merge.png "DSL-EMD_Merge") Роль директивы слияния элементов
...
4. В разделе **процесс слияния путем создания ссылок**добавьте два пути:
   ...
   3. В разделе **процесс слияния путем создания ссылок по путям**щелкните **\<add path>** .
...
6. В новом файле кода напишите разделяемый класс для принимающего класса и переопределите `MergeRelate` метод. Не забудьте вызвать базовый метод. Например:
...
10. Выполните сборку и запуск решения. Появится новый экземпляр [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] .
...
## <a name="see-also"></a>См. также:
 [Навигация и обновление модели в программном коде](../modeling/navigating-and-updating-a-model-in-program-code.md) [Настройка средств и панели элементов](../modeling/customizing-tools-and-the-toolbox.md)
