...
В предметно-ориентированном языке в [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] можно настроить внешний вид фигуры, отражающего состояние базовой модели.

 Примеры кода в этом разделе следует добавить в `.cs` файл в `Dsl` проекте. Эти инструкции понадобятся в каждом файле:
