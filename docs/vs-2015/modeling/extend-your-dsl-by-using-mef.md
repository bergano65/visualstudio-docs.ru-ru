...
6. В окно свойств убедитесь, что по крайней мере одно из свойств с именем **использует...** имеет значение `true` .
...
4. Создайте проект VSIX в том же решении. Для этого в диалоговом окне **Новый проект** разверните узел **Visual Basic** или **Visual C#**, щелкните **расширяемость**, а затем выберите **проект VSIX**.
...
9. Проверьте и обновите другие поля **source. extension. vsixmanifest**. Щелкните **Выбрать выпуски** и убедитесь, что [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] установлены правильные выпуски.
...
11. Чтобы проверить расширение, нажмите клавишу **F5**. В экспериментальном экземпляре [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] Создайте или откройте файл с примером DSL.
