...
## <a name="relationship-to-other-diagrams"></a><a name="OtherDiagrams"></a> Связь с другими схемами
...
## <a name="basic-steps-for-drawing-component-diagrams"></a><a name="Basics"></a> Основные шаги для рисования схем компонентов
...
## <a name="showing-the-internal-parts-of-a-component"></a><a name="Parts"></a> Отображение внутренних частей компонента
 ![Схема компонентов, на которой показаны внутренние части](../modeling/media/uml-compshowing.png "UML_CompShowing")
...
## <a name="designing-the-component"></a><a name="Designing"></a> Проектирование компонента
...
- Если функции, напротив, распределены между большим числом компонентов, между которыми существует много взаимодействий, производительность системы может снизиться, ее понимание будет затруднено.
  ...
  ![Схема последовательностей, на которой показаны совместно работающие части](../modeling/media/uml-compdescparts.png "UML_CompDescParts")
...
## <a name="see-also"></a>См. также:
 [Изменение моделей и схем UML](../modeling/edit-uml-models-and-diagrams.md) схемы [компонентов UML. ссылки на](../modeling/uml-component-diagrams-reference.md) [UML-схемы последовательностей: эталонные схемы](../modeling/uml-sequence-diagrams-reference.md) [вариантов использования UML](../modeling/uml-use-case-diagrams-reference.md) : Справочник по схемам [классов](../modeling/uml-class-diagrams-reference.md) UML: справочное [UML Component Diagrams: Reference](../modeling/uml-component-diagrams-reference.md) [видео: проектирование физической структуры с помощью схем компонентов](https://channel9.msdn.com/blogs/clinted/uml-with-vs-2010-part-6-designing-a-projects-physical-structure)
