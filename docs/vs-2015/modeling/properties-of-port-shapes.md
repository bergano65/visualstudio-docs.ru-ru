---
title: Свойства фигур портов | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47563738"
---
# <a name="properties-of-port-shapes"></a>Свойства фигур портов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [свойства фигур портов](https://docs.microsoft.com/visualstudio/modeling/properties-of-port-shapes).  
