...
## <a name="in-this-topic"></a>В этом разделе
 ...
 [Ссылки из одного пространства имен на другое](#References)

 [Свойства пакетов](#Properties)

## <a name="namespaces"></a><a name="Namespaces"></a> Пространства имен
...
## <a name="creating-and-viewing-packages"></a><a name="Packages"></a> Создание и просмотр пакетов
...
## <a name="creating-model-elements-inside-packages"></a><a name="Elements"></a> Создание элементов модели внутри пакетов
...
## <a name="moving-elements-into-and-out-of-packages"></a><a name="Moving"></a> Перемещение элементов в пакеты и из них
...
## <a name="pasting-elements-into-a-package"></a><a name="Pasting"></a> Вставление элементов в пакет
...
## <a name="import-relationships-between-packages"></a><a name="Import"></a> Импорт связей между пакетами
...
## <a name="references-from-one-namespace-to-another"></a><a name="References"></a> Ссылки из одного пространства имен в другое
 Если требуется сослаться на элемент одного пакета из другого, необходимо использовать полное имя этого элемента.

 Например, предположим, что пакет `SalesCommon` определяет тип `CustomerAddress`. В другом пакете `RestaurantSales` требуется определить тип `MealOrder`, который имеет атрибут типа "Адрес клиента". Имеются две возможности.

- Укажите тип атрибута, используя полное имя `SalesCommon::CustomerAddress`. Это можно сделать, только если `CustomerAddress` свойство **видимости** имеет значение **Public**.
...
## <a name="properties-of-packages"></a><a name="Properties"></a> Свойства пакетов
...
|--------------|-------------------|-----------------|
|**Имя**|(новое имя)|Имя пакета. Его можно изменить на схеме или в окне "Свойства".|
...
|**Видимость**|**Открытый**|Видимость пакета за пределами его родительского пакета.|
