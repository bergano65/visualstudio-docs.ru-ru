...
## <a name="generating-files-from-a-menu-command"></a><a name="Command"></a> Создание файлов из команды меню
...
## <a name="generating-files-from-an-application"></a><a name="Application"></a> Создание файлов из приложения
...
## <a name="generating-files-at-design-time"></a><a name="Design"></a> Создание файлов во время разработки
...
2. Создайте проект C# или Visual Basic в том же решении.
   ...
   - В обозреватель решений щелкните решение правой кнопкой мыши, наведите указатель на пункт **Добавить**и выберите пункт **Новый проект**. В разделе **Установленные шаблоны**щелкните **Visual Basic** или **Visual C#,** а затем выберите тип проекта, например **консольное приложение**.
...
3. Добавьте в проект C# или Visual Basic обычный текстовый файл. Этот файл содержит код, который можно использовать для создания нескольких текстовых шаблонов.
   ...
   - В обозревателе решений щелкните проект правой кнопкой мыши, укажите **Добавить** и выберите **Новый элемент**. Выберите **текстовый файл**.

     Вставьте текст, показанный в следующем подразделе.

4. Добавьте в проект C# или Visual Basic файл текстового шаблона.

   - В обозревателе решений щелкните проект правой кнопкой мыши, укажите **Добавить** и выберите **Новый элемент**. Выберите **текстовый шаблон**.
...
## <a name="how-to-use-text-generation"></a><a name="What"></a> Использование создания текста
