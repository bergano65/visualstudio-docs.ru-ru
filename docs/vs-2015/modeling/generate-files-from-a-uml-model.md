...
ms.locfileid: "47571298"
---
# <a name="generate-files-from-a-uml-model"></a>Создание файлов на основе модели UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Создание файлов из модели UML](https://docs.microsoft.com/visualstudio/modeling/generate-files-from-a-uml-model).  
