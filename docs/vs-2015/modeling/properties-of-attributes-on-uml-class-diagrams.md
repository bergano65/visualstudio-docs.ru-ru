...
|**Кратность**|1|**1** — этот атрибут имеет одно значение заданного типа.<br /><br /> **0..1** — этот атрибут может иметь значение `null`.<br /><br /> **\*** — значение этого атрибута представляет собой коллекцию значений.<br /><br /> **1..\***  -значение этого атрибута — это коллекция, содержащая хотя бы одно значение.<br /><br /> *n* **..** *m* — значение этого атрибута представляет собой коллекцию, которая содержит от *n* до *m* значений.|  
