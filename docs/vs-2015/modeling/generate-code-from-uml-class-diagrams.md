...
ms.locfileid: "47557837"
---
# <a name="generate-code-from-uml-class-diagrams"></a>Создание кода на основе схем классов UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [создание кода из UML-схемах классов](https://docs.microsoft.com/visualstudio/modeling/generate-code-from-uml-class-diagrams).  
