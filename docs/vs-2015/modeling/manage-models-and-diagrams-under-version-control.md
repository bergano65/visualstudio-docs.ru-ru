...
## <a name="files-in-a-modeling-project"></a><a name="ModelingProjects"></a> Файлы в проекте моделирования
...
> [!NOTE]
> Важно поддерживать согласованность между файлами. Например, если для отката изменений в UML-файле используется система управления версиями, необходимо одновременно откатить соответствующие изменения в файлах .*diagram и .layout. Элементы, представленные в. \* файл диаграммы будет потерян, если он не представлен в файле. UML.

## <a name="working-on-shared-modeling-projects"></a><a name="Shared"></a> Работа с общими проектами моделирования
...
### <a name="changes-requiring-exclusive-access-to-the-model"></a><a name="Exclusive"></a> Изменения, требующие монопольного доступа к модели
...
## <a name="merging-changes-in-model-files-and-diagrams"></a><a name="Merging"></a> Слияние изменений в файлах и схемах модели
