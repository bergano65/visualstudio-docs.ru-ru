...
Последнюю версию этого раздела можно найти в [моделями и схемами в системе управления версиями](https://docs.microsoft.com/visualstudio/modeling/manage-models-and-diagrams-under-version-control).  
  
Управления различными версиями проектов моделирования и схем, включая карты кода (файлы DGML), с помощью [систему управления версиями Team Foundation или Git](http://msdn.microsoft.com/library/33267cee-fe5f-4aa3-b2cd-6d22ceace314); либо с локальной Team Foundation Server или в облаке с Visual Studio Team Services.  
...
> [!IMPORTANT]
>  Будьте внимательны, если над одним и тем же проектом моделирования работают несколько пользователей. Узнайте, как можно [упорядочивать модели в средних или крупных проектах](../modeling/structure-your-modeling-solution.md).  
...
-   В [!INCLUDE[esprscc](../includes/esprscc-md.md)], всегда выполняют **вернуть** и **получить последнюю версию** операции с всего проекта моделирования, не для отдельных файлов.  
...
-   Дополнительные сведения о блокировках извлечения, см. в разделе [проверьте извлечение и изменение файлов](http://msdn.microsoft.com/library/eb404d63-c448-4994-9416-3e6d50ec554a).  
