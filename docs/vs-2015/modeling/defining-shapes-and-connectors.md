...
|Тип фигуры|Описание|
|----------------|-----------------|
|Геометрическая фигура|Прямоугольная или эллиптическая фигура общего назначения В определенные положения относительно границ фигуры можно включать декораторы текста и значков.<br /><br /> Сведения о вложении фигур в геометрические фигуры см. в разделе [вложение фигур](../modeling/nesting-shapes.md).|
...
## <a name="shape-inheritance"></a><a name="shapeInheritance"></a> Наследование фигур
