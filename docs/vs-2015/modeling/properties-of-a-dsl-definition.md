...
|Идентификатор GUID пакета|Идентификатор GUID для [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] пакета, созданного для этого DSL.|\<none>|
|Пространство имен пакета|Пространство имен для [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] пакета, созданного для этого DSL.|\<none>|
|Название продукта|Имя продукта, которое будет зарегистрировано для [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] пакета, созданного для этого DSL.|\<none>|
