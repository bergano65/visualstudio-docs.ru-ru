...
ms.locfileid: "47568666"
---
# <a name="about-domain-specific-languages"></a>О доменных языках
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [о предметно-ориентированных языков](https://docs.microsoft.com/visualstudio/modeling/about-domain-specific-languages).  
