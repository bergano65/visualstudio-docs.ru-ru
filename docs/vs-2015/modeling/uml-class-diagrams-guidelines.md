...
## <a name="using-uml-class-diagrams"></a><a name="Using"></a> Использование UML-схем классов
...
- Для более точного определения набора терминов, используемых для обмена сведениями между приложением и его пользователями, а также в описаниях потребностей пользователей. См. раздел [Моделирование требований пользователей](../modeling/model-user-requirements.md).
...
## <a name="basic-steps-for-drawing-class-diagrams"></a><a name="BasicSteps"></a> Основные шаги для рисования диаграмм классов
...
## <a name="using-classes-interfaces-and-enumerations"></a><a name="UsingTypes"></a> Использование классов, интерфейсов и перечислений
...
## <a name="attributes-and-operations"></a><a name="AttributesAndOperations"></a> Атрибуты и операции
...
- Параметризованное значение типа шаблона, записанного шаблона \<Parameter> . См. раздел [типы шаблонов](#Templates).
...
## <a name="drawing-and-using-associations"></a><a name="Associations"></a> Рисование и использование ассоциаций
...
### <a name="properties-of-an-association"></a>Свойства ассоциации
 ...
 Некоторые свойства каждой роли напрямую видны на схеме. Вот они:
...
## <a name="inheritance"></a><a name="Inheritance"></a> Цепочк
...
## <a name="template-types"></a><a name="Templates"></a> Типы шаблонов
...
## <a name="packages"></a><a name="Packages"></a> Пакеты
...
## <a name="generating-code-from-uml-class-diagrams"></a><a name="generating"></a> Создание кода на основе схем классов UML
