...
### <a name="relationship-to-other-diagrams"></a>Отношение к другим схемам  
 ...
 См. в разделе [UML-схемы вариантов использования: правила](../modeling/uml-use-case-diagrams-guidelines.md).  
  
##  <a name="BasicSteps"></a> Основные этапы создания схем классов  
 Справочные сведения об элементах на схемах классов UML, см. в разделе [схемы классов UML: Справочник по](../modeling/uml-class-diagrams-reference.md).  
...
##  <a name="AttributesAndOperations"></a> Атрибуты и операции  
 ...
 Чтобы просмотреть свойства параметров операции, выберите **[...]** в **параметры** свойство. Отобразится новое диалоговое окно свойств.  
...
-   Один из стандартных типов-примитивов: **логическое**, **целое число**, **строка**.  
