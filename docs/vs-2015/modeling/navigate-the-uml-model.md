...
ms.locfileid: "47562499"
---
# <a name="navigate-the-uml-model"></a>Навигация по модели UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Навигация по UML-модели](https://docs.microsoft.com/visualstudio/modeling/navigate-the-uml-model).  
