...
Последнюю версию этого раздела можно найти в [перехода и обновления модели в программном коде](https://docs.microsoft.com/visualstudio/modeling/navigating-and-updating-a-model-in-program-code).  
...
## <a name="in-this-topic"></a>В этом разделе  
 [Примере рассмотрено определение DSL](#example)  
  
 [Перемещение модели](#navigation)  
  
 [Доступ к сведениям о классе](#metadata)  
  
 [Внести изменения в транзакции](#transaction)  
 ...
 [Удаление ссылок связи](#deletelinks)  
 ...
 [Переход и обновление схемы](#diagrams)  
