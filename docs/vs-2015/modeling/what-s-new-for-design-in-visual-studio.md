...
## <a name="edition-support-for-architecture-and-modeling-tools"></a><a name="VersionSupport"></a> Поддержка выпуска для средств моделирования и архитектуры
...
|**Компонент**|**Функции корпоративного уровня**|**Professional**|**Сообщество**|**Express**|
|-----------------|--------------------|----------------------|-------------------|-----------------|
...
|**UML-схемы последовательностей**|Да|-|-|-|
|**UML-схемы вариантов использования**|Да|-|-|-|
|**UML-схемы активности**|Да|-|-|-|
|**UML-схемы компонентов**|Да|-|-|-|
|**Схемы слоев**|Да|-|-|-|
