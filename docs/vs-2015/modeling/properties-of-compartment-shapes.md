...
ms.locfileid: "47559628"
---
# <a name="properties-of-compartment-shapes"></a>Свойства фигур, состоящих из секций
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [свойства фигуры секций](https://docs.microsoft.com/visualstudio/modeling/properties-of-compartment-shapes).  
...
|--------------|-----------------|-------------|  
|По умолчанию, разверните узел свернутого состояния|Если `Expanded`, секции отображаются при создании. Если `Collapsed`, они не являются.|Развернуто|  
