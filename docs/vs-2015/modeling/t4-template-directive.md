...
ms.locfileid: "47561435"
---
# <a name="t4-template-directive"></a>Директива Template T4
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [директива Template T4](https://docs.microsoft.com/visualstudio/modeling/t4-template-directive).  
