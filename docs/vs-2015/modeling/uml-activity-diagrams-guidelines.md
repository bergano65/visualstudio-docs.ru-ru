...
## <a name="relationship-to-other-diagrams"></a><a name="Relationships"></a> Связь с другими схемами
...
## <a name="basic-steps-for-drawing-activity-diagrams"></a><a name="BasicSteps"></a> Основные шаги для рисования схем активности
...
## <a name="describing-control-flow"></a><a name="SimpleControlFlow"></a> Описание потока управления
...
## <a name="describing-data-flow"></a><a name="DataFlows"></a> Описание потока данных
...
### <a name="describing-data-flow-with-object-nodes"></a>Описание потока данных с помощью узлов объектов
 ...
 ![В узлах объектов могут показываться данные, передаваемые между действиями](../modeling/media/uml-actguidedata.png "UML_ActGuideData")
...
## <a name="defining-an-action-in-more-detail"></a><a name="Details"></a> Более подробное определение действия
...
### <a name="describing-sub-activities-with-call-behavior-actions"></a><a name="Subactivities"></a> Описание вспомогательных действий с действиями поведения вызова
 ...
 ![На отдельной схеме деятельности показаны подробные действия](../modeling/media/uml-actguidedetail.png "UML_ActGuideDetail")
...
### <a name="defining-postconditions-and-preconditions"></a><a name="Postcondition"></a> Определение постусловия и предусловий
...
## <a name="concurrent-flows"></a><a name="Concurrent"></a> Параллельные потоки
...
- Добавить комментарий к закреплению ввода или вывода.
  ...
  - Чтобы отличить это описание от общего комментария, можно начать комментарий с <\<**transformation**>> или <\<**selection**>>.
