...
ms.locfileid: "47569813"
---
# <a name="uml-activity-diagrams-guidelines"></a>UML-схемы деятельности: рекомендации
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [UML-схемы деятельности: рекомендации по](https://docs.microsoft.com/visualstudio/modeling/uml-activity-diagrams-guidelines).  
