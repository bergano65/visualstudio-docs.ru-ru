---
title: 'Практическое: Добавление команды в контекстное меню | Документация Майкрософт'
ms.custom: ''
ms.date: 2018-06-30
...
Последнюю версию этого раздела можно найти в [как: Добавление команды в контекстное меню](https://docs.microsoft.com/visualstudio/modeling/how-to-add-a-command-to-the-shortcut-menu).  
