...
## <a name="basic-steps-for-drawing-use-case-diagrams"></a><a name="BasicSteps"></a> Основные шаги для рисования схем вариантов использования
...
## <a name="drawing-actors-and-use-cases"></a><a name="Actors"></a> Рисование субъектов и вариантов использования
...
### <a name="multiplicities-between-actors-and-use-cases"></a>Кратности между субъектами и вариантами использования
 ...
 ![Вариант использования "один к одному" с субъектом](../modeling/media/uml-ucguidemulti1.png "UML_UCGuideMulti1")
...
> Кратность ассоциации на схеме вариантов использования скрывается, если они оба равны **1**.
 ...
 ![Вариант использования, показывающий кратность "многие ко многим"](../modeling/media/uml-ucguidemulti2.png "UML_UCGuideMulti2")
...
- Чтобы увидеть, что каждый субъект может одновременно участвовать в нескольких экземплярах варианта использования, задайте кратность в конце варианта использования ассоциации в **\*** .
...
3. Задайте свойство кратности, выбрав значение из списка:
   ...
   - **\*** чтобы указать, что в ссылке участвует ноль или более экземпляров этой роли.
...
## <a name="describing-use-cases-in-detail"></a><a name="Details"></a> Подробное описание вариантов использования
...
### <a name="linking-use-cases-to-work-items"></a>Связывание вариантов использования с рабочими элементами
 Если в проекте используется [!INCLUDE[vstsTfsRosarioLong](../includes/vststfsrosariolong-md.md)] и имеется [!INCLUDE[esprtfc](../includes/esprtfc-md.md)] , можно связать каждый вариант использования с рабочим элементом в [!INCLUDE[esprfound](../includes/esprfound-md.md)] . Сведения о том, как сделать эти ссылки, см. в разделе [компоновка элементов модели и рабочих элементов](../modeling/link-model-elements-and-work-items.md).
...
## <a name="structuring-use-cases"></a><a name="Structuring"></a> Структурирование вариантов использования
...
- [Отображение сведений о варианте использования с помощью включения](#Include)

- [Совместная работа с целями с помощью обобщения](#Inheritance)

- [Разделение различающихся вариантов с помощью расширения](#Extend)

### <a name="showing-the-details-of-a-use-case-with-include"></a><a name="Include"></a> Отображение сведений о варианте использования с include
...
> Не рекомендуется создавать циклы отношений включения, которые приводят к тому, что варианты использования включают сами себя. Циклы могут стать причиной ошибок.
 ...
 ![Варианты использования, разделенные с помощью include](../modeling/media/uml-ucguideinclude.png "UML_UCGuideInclude")
...
#### <a name="defining-the-order-of-the-detailed-steps"></a><a name="Steps"></a> Определение порядка подробных шагов
...
- Действия на схеме деятельности имеют те же имена, что и включенные варианты использования.
  ...
  ![Шаги варианта использования, показанные на связанной схеме деятельности](../modeling/media/uml-ucguidesteps.png "UML_UCGuideSteps")

### <a name="sharing-goals-with-generalization"></a><a name="Inheritance"></a> Совместное использование целей с обобщением
...
### <a name="separating-variant-cases-with-extend"></a><a name="Extend"></a> Отделение вариантов варианта с расширением
 ...
 ![Вариант использования, расширяющий другой вариант](../modeling/media/uml-ucguideextend.png "UML_UCGuideExtend")
...
## <a name="using-subsystem-boundaries"></a><a name="Subsystems"></a> Использование границ подсистемы
