...
## <a name="how-to-design-or-update-your-app-with-layer-diagrams"></a><a name="Update"></a> Разработка и обновление приложения с помощью схем слоев
...
2. [Определите слои, представляющие основные функциональные области или компоненты](#CreateLayers) приложения. Дайте этим слоям имена согласно их функциям, например "Презентация" или "Службы". Если у вас есть [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] решение, каждый слой можно связать с коллекцией *артефактов*, таких как проекты, пространства имен, файлы и т. д.
...
## <a name="create-a-layer-diagram"></a><a name="Create"></a> Создание схемы слоев
