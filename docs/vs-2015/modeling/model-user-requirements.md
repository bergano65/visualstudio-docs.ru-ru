...
## <a name="see-also"></a>См. также раздел
 [Изменение моделей и схем UML](../modeling/edit-uml-models-and-diagrams.md) [Разработка тестов на основе модели](../modeling/develop-tests-from-a-model.md) [Использование моделей в модели процесса разработки](../modeling/use-models-in-your-development-process.md) . пример [архитектуры приложения](../modeling/model-your-app-s-architecture.md) и [расширение: возможности моделирования доменов UML](http://go.microsoft.com/fwlink/?LinkId=213849) расширение [VS: цвет UML Элементы по](http://go.microsoft.com/fwlink/?LinkID=213841) [расширению "выборка" стереотипа: Связывание элементов UML с диаграммами, файлами и другими элементами](http://go.microsoft.com/fwlink/?LinkID=213813) [пример расширения VS: Выровняйте фигуры на схеме UML](http://go.microsoft.com/fwlink/?LinkID=213809) [видео: моделирование бизнес-домена](http://channel9.msdn.com/posts/clinted/UML-with-VS-2010-Part-3-Modeling-the-Business-Domain/)
