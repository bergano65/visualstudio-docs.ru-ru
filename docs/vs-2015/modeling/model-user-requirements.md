...
|-------------------------|-----------------------------------------------|-------------|
|Схема вариантов использования|Кто использует систему и какие действия они в ней совершают.|[Describing how your system is used](#UseCases)|
|Концептуальная схема классов|Глоссарий типов, используемых для описания требований; типы, которые видны в интерфейсе системы.|[Defining terms used to describe requirements](#RequirementsClasses)|
|схема активности|Поток работы и передачи информации в ходе взаимодействия пользователей и системы или ее частей.|[Showing work flow between users and your system](#Workflow)|
|Схема последовательностей|Последовательность взаимодействий между пользователями и системой или ее частями. Альтернативное представление схемы деятельности|[Showing interactions between users and your system](#Sequences)|
...
|Дополнительные документы или рабочие элементы|Ограничения и правила, не относящиеся к конкретному варианту использования.|[Отображение бизнес-правил](#BusinessRules)|
 ...
 Обратите внимание, что большинство типов схем можно использовать и для других целей. For an overview of diagram types, see [Create models for your app](../modeling/create-models-for-your-app.md). For basic information about drawing diagrams, see [Edit UML models and diagrams](../modeling/edit-uml-models-and-diagrams.md).
...
## <a name="BusinessRules"></a> Showing Business Rules
 ...
 Многие бизнес-правила представляют собой ограничения отношений между концептуальными классами. You can write these *static business rules* as comments associated with the relevant classes on a conceptual class diagram. Пример:
