...
## <a name="see-also"></a>См. также
 [Изменение моделей и схем UML](../modeling/edit-uml-models-and-diagrams.md) [Разработка тестов из модели](../modeling/develop-tests-from-a-model.md) [Использование моделей в процессе разработки](../modeling/use-models-in-your-development-process.md) [модель модели приложения](../modeling/model-your-app-s-architecture.md) [пример расширения VS: Функции моделирования доменов UML](https://go.microsoft.com/fwlink/?LinkId=213849) [образца расширения VS: Цвет элементов UML по стереотипу](https://go.microsoft.com/fwlink/?LinkID=213841) [пример расширения VS: Свяжите элементы UML с диаграммами, файлами и другими элементами](https://go.microsoft.com/fwlink/?LinkID=213813) [образце расширения VS: Выровняйте фигуры на схеме UML](https://go.microsoft.com/fwlink/?LinkID=213809) [видео: Моделирование бизнес-домена](https://channel9.msdn.com/blogs/clinted/uml-with-vs-2010-part-3-modeling-the-business-domain)
