...
## <a name="describing-how-your-system-is-used"></a><a name="UseCases"></a> Описание использования системы
...
## <a name="defining-terms-used-to-describe-requirements"></a><a name="RequirementsClasses"></a> Определение терминов, используемых для описания требований
...
## <a name="showing-work-flow-between-users-and-your-system"></a><a name="Workflow"></a> Отображение рабочего процесса между пользователями и системой
 ...
 ![Активность с тремя действиями и циклом.](../modeling/media/uc-reqmwfact.png "UC_ReqmWFAct")
...
## <a name="showing-interactions-between-users-and-your-system"></a><a name="Sequences"></a> Отображение взаимодействий между пользователями и системой
