...
## <a name="deploying-a-directive-processor-in-a-vsix"></a>Развертывание процессора директив в VSIX
 Вы можете добавить пользовательский обработчик директив в [расширение Visual Studio (VSIX)](https://msdn.microsoft.com/64ff1452-f7d5-42d9-98b8-76f769f76832).
...
1. Создайте проект VSIX в [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].
    ...
    - В диалоговом окне **Новый проект** разверните узел **Visual Basic** или **Visual C#** , а затем разверните узел **расширяемость**. Щелкните **проект VSIX**.
...
1. В меню [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] **Сервис** выберите пункт **Диспетчер расширений**.
...
|Class|REG_SZ|**> имя \<Namespace. Имя \<Class >**|
|CodeBase|REG_SZ|**\<Your путь > \\ < имя сборки \>**|
...
|----------|----------|----------|
|(Значение по умолчанию)|REG_SZ|(значение не задано)|
|Class|REG_SZ|\< полное**имя класса** >|
