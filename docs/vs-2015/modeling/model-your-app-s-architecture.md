---
title: Моделирование архитектуры приложения&#39;| Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="Requirements"></a>Основные сведения о требованиях
...
### <a name="components"></a>Компоненты
 ...
 ![Схема компонентов UML, отображающая части](../modeling/media/uml-barecomponent.png "UML_BareComponent")
...
### <a name="Data"></a>Модель данных компонентов и интерфейсов
