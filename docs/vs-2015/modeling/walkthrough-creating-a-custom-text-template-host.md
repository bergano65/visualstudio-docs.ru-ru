---
title: Пошаговое руководство. Создание узла пользовательского текстового шаблона | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="creating-a-custom-text-template-host"></a>Создание пользовательского основного приложения для текстовых шаблонов
...
#### <a name="to-create-a-custom-host"></a>Создание пользовательского основного приложения
...
4. Только [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] для этого откройте меню **проект** и выберите пункт **Свойства кустомхост**. В списке **начальный объект** выберите **кустомхост. Program**.

5. В меню **Файл** выберите команду **Сохранить все**.

6. В меню **Сборка** выберите **Собрать решение**.

## <a name="testing-the-custom-host"></a>Тестирование пользовательского ведущего приложения
...
2. Введите путь к исполняемому файлу пользовательского ведущего приложения, но пока не нажимайте клавишу ВВОД.
    ...
    > [!NOTE]
    > Вместо того чтобы вводить адрес, можно перейти к файлу Кустомхост. exe в **проводнике Windows** , а затем перетащить его в окно командной строки.
