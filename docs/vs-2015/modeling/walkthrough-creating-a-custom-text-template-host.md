...
Узел *текстовых шаблонов*<em>host</em> предоставляет среду, которая позволяет выполнять *обработчик преобразования текстовых шаблонов* . Основное приложение отвечает за управление взаимодействием этого процессора с файловой системой. Обработчику или *процессору директив* , которому требуется файл или сборка, может запросить ресурс от узла. В ответ основное приложение просмотрит каталоги и глобальный кэш сборок в поиске запрошенного ресурса. Дополнительные сведения см. [в разделе процесс преобразования текстовых шаблонов](../modeling/the-text-template-transformation-process.md).
...
4. [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]Только для этого откройте меню **проект** и выберите пункт **Свойства кустомхост**. В списке **начальный объект** выберите **кустомхост. Program**.
