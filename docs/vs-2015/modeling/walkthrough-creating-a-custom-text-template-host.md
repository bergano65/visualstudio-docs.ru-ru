...
4. Только для [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] откройте меню **проект** и выберите пункт **Свойства кустомхост**. В списке **начальный объект** выберите **кустомхост. Program**.
