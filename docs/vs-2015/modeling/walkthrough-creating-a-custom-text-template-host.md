...
## <a name="creating-a-custom-text-template-host"></a>Создание пользовательского ведущего приложения для текстовых шаблонов  
...
#### <a name="to-create-a-custom-host"></a>Создание пользовательского ведущего приложения  
...
4.  Для [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] только, откройте **проекта** меню и выберите пункт **Свойства CustomHost**. В **автоматически запускаемый объект** выберите **CustomHost.Program**.  
