...
|-------------------|-----------------|  
|**OPT**|Необязательный параметр. Включает последовательность, которая может не произойти. В условии можно задать требования, при соблюдении которых она возникнет.|  
