---
title: 'Сценарий: Измените дизайн с помощью визуализации и моделирования Документы Майкрософт'
ms.date: 11/15/2016
...
## <a name="scenario-overview"></a><a name="ScenarioOverview"></a>Обзор сценария
...
- [SDK моделирования для Visual Studio — доменные языки](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md)
  ...
  Для просмотра альтернативных представлений архитектуры можно использовать определенные элементы одной модели сразу на нескольких различных схемах. Например, можно перетащить компонент в другую схему компонентов или последовательностей, чтобы он мог функционировать как субъект. Смотрите [модели и диаграммы Edit UML.](../modeling/edit-uml-models-and-diagrams.md)
...
## <a name="understanding-and-communicating-information-about-the-system"></a><a name="UnderstandingCommunicating"></a>Понимание и передача информации о системе
...
- [Понимание роли системы в бизнес-процессе](#UnderstandingBPMandSystemDesign)
...
- [Общие советы по созданию и использованию моделей](#GeneralTips)

- [Планирование и отслеживание работы](#PlanningTracking)

- [Тестирование, проверка и возврат в обновленного кода](#TestValidateCheckInCode)

### <a name="understanding-the-role-of-the-system-in-the-business-process"></a><a name="UnderstandingBPMandSystemDesign"></a>Понимание роли системы в бизнес-процессе
...
|**Схема**|**Что описывает**|
|-----------------|-------------------|
|*Схема вариантов использования (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы использования UML: Справка](../modeling/uml-use-case-diagrams-reference.md)<br />-   [Диаграммы использования случая использования UML: Руководящие принципы](../modeling/uml-use-case-diagrams-guidelines.md)|- Деятельность, которую поддерживает система «Ужин сейчас»<br />- Люди и внешние системы, которые выполняют деятельность<br />- Основные компоненты системы, которые поддерживают каждое действие<br />- Части бизнес-процесса, которые выходят за рамки действующей системы, например, доставка продуктов питания|
|*Схема активности (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы активности UML: Справка](../modeling/uml-activity-diagrams-reference.md)<br />-   [Диаграммы активности UML: Руководящие принципы](../modeling/uml-activity-diagrams-guidelines.md)|Последовательность действий, выполняемых при создании заказа клиентом|
|*Схема классов (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы класса UML: Справка](../modeling/uml-class-diagrams-reference.md)<br />-   [Диаграммы класса UML: Руководящие принципы](../modeling/uml-class-diagrams-guidelines.md)|Бизнес-сущности и терминология, которая используется в переговорах и отношениях между этими сущностями. Например, в данном сценарии фигурируют термины «Заказ» и «Позиция меню».|
 ...
 ![Диаграмма использования umL](../modeling/media/uml-usecase.png "UML_UseCase")
 ...
 **Диаграмма использования umL**
 ...
 ![Диаграмма активности UML](../modeling/media/uml-dinnernowprocess.png "UML_DinnerNowProcess")

 **Диаграмма активности UML**

 На следующей схеме классов описываются сущности, участвующие в процессе заказа.

 ![Диаграмма класса UML](../modeling/media/uml-dinnerorders.png "UML_DinnerOrders")

 **Диаграмма класса UML**

### <a name="describing-new-or-updated-user-requirements"></a><a name="DescribingURM"></a>Описание новых или обновленных требований пользователей
...
|**Схема**|**Что описывает**|
|-----------------|-------------------|
|*Схема вариантов использования (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы использования UML: Справка](../modeling/uml-use-case-diagrams-reference.md)<br />-   [Диаграммы использования случая использования UML: Руководящие принципы](../modeling/uml-use-case-diagrams-guidelines.md)|Новый вариант использования для функции «Написать отзыв о ресторане»|
|*Схема активности (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы активности UML: Справка](../modeling/uml-activity-diagrams-reference.md)<br />-   [Диаграммы активности UML: Руководящие принципы](../modeling/uml-activity-diagrams-guidelines.md)|Операции, выполняемые клиентом для размещения отзыва о ресторане|
|*Схема классов (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы класса UML: Справка](../modeling/uml-class-diagrams-reference.md)<br />-   [Диаграммы класса UML: Руководящие принципы](../modeling/uml-class-diagrams-guidelines.md)|Данные, необходимые для сохранения отзыва|
 ...
 ![Диаграмма использования umL](../modeling/media/uml-writerev.png "UML_WriteRev")

 **Диаграмма использования случая umL**
 ...
 ![Диаграмма активности UML](../modeling/media/uml-writereview.png "UML_WriteReview")
 ...
 **Схема активности UML**
 ...
 ![Диаграмма класса UML](../modeling/media/uml-dinnerreviews.png "UML_DinnerReviews")

 **UML-схема классов**

### <a name="creating-tests-from-models"></a><a name="CreatingTests"></a>Создание тестов из моделей
 ...
 **Карта кода пространства имен**
 ...
 ![Граф зависимостей расширенного пространства имен](../modeling/media/dep-reviewsystem.png "Dep_ReviewSystem")
...
|**Схемы**|**Что описывает**|
|------------------|-------------------|
|*Схема активности (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы активности UML: Справка](../modeling/uml-activity-diagrams-reference.md)<br />-   [Диаграммы активности UML: Руководящие принципы](../modeling/uml-activity-diagrams-guidelines.md)|Последовательность шагов, выполняемых, когда система обнаруживает, что клиент повторно сделал заказ в ресторане, и предлагает клиенту написать отзыв.|
|*Схема классов (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы класса UML: Справка](../modeling/uml-class-diagrams-reference.md)<br />-   [Диаграммы класса UML: Руководящие принципы](../modeling/uml-class-diagrams-guidelines.md)|Логические классы и их отношения. Например, новый класс добавляется для описания элемента **Отзыв** и его отношений с другими сущностями, такими как **Ресторан**, **Меню**и **Клиент**.<br /><br /> Для связи отзывов с клиентами система должна хранить сведения о клиентах. Уточнять эти сведения поможет UML-схема классов.|
|*Схема классов на основе кода*<br /><br /> См. раздел [Практическое руководство. Добавление схем классов в проекты (конструктор классов)](../ide/how-to-add-class-diagrams-to-projects-class-designer.md).|Существующие классы в коде.|
|*Схема компонентов (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы компонентов UML: Справка](../modeling/uml-component-diagrams-reference.md)<br />-   [Диаграммы компонентов UML: Руководящие принципы](../modeling/uml-component-diagrams-guidelines.md)|Высокоуровневые части системы, такие как веб-сайт компании Dinner Now, и их интерфейсы. Эти интерфейсы определяют, как компоненты взаимодействуют между собой через предоставляемые и потребляемые методы или службы.|
|*Схема последовательностей (UML)*<br /><br /> См.<br /><br /> -   [Диаграммы последовательности UML: Справка](../modeling/uml-sequence-diagrams-reference.md)<br />-   [Диаграммы последовательности UML: Руководящие принципы](../modeling/uml-sequence-diagrams-guidelines.md)|Последовательность взаимодействий между экземплярами.|
 ...
 ![Диаграмма компонента UML](../modeling/media/uml-internal.png "UML_Internal")
 ...
 **Схема компонентов UML**
 ...
 ![Диаграмма последовательности UML](../modeling/media/uml-revsystem.png "UML_RevSystem")

 **Схема последовательностей UML**

### <a name="keeping-code-consistent-with-the-design"></a><a name="ValidatingCode"></a>Соблюдение кода в соответствии с дизайном
...
- Visual Studio поддерживает UML 2.1.2. В этом обзоре описываются только основные функции UML-схем в данном выпуске, но существует много книг, в которых подробно рассматривается язык UML и его применение.
  ...
  Смотрите [Создать модели для вашего приложения.](../modeling/create-models-for-your-app.md)

### <a name="planning-and-tracking-work"></a><a name="PlanningTracking"></a>Планирование и отслеживание работы
...
### <a name="testing-validating-and-checking-in-code"></a><a name="TestValidateCheckInCode"></a> Тестирование, проверка и возврат кода
...
- [Понимание бизнес-процессов: схемы активности](#UnderstandActivities)
...
### <a name="understand-the-user-requirements-use-case-diagrams"></a><a name="UnderstandUseCases"></a>Понимание требований пользователей: Используйте диаграммы кейса
...
|**Схема**|**Что описывает**|
|-----------------|-------------------|
|схема активности|Последовательность шагов в варианте использования, а также кто или что выполняет эти шаги в данном варианте использования.<br /><br /> Имена вариантов использования часто отражают шаги на схеме активности. Схемы активности поддерживают такие элементы, как решения, объединения, ввод и вывод данных, параллельные потоки и т. п.<br /><br /> См.<br /><br /> -   [Диаграммы активности UML: Справка](../modeling/uml-activity-diagrams-reference.md)<br />-   [Диаграммы активности UML: Руководящие принципы](../modeling/uml-activity-diagrams-guidelines.md)|
|Схема последовательностей|Последовательность взаимодействий между участниками в варианте использования.<br /><br /> См.<br /><br /> -   [Диаграммы последовательности UML: Справка](../modeling/uml-sequence-diagrams-reference.md)<br />-   [Диаграммы последовательности UML: Руководящие принципы](../modeling/uml-sequence-diagrams-guidelines.md)|
|Схема классов (UML)|Сущности или типы, участвующие в варианте использования.<br /><br /> См.<br /><br /> -   [Диаграммы класса UML: Справка](../modeling/uml-class-diagrams-reference.md)<br />-   [Диаграммы класса UML: Руководящие принципы](../modeling/uml-class-diagrams-guidelines.md)|

### <a name="understand-the-business-process-activity-diagrams"></a><a name="UnderstandActivities"></a>Понимание бизнес-процесса: Диаграммы активности
...
|**Схема**|**Описание**|
|-----------------|---------------------|
|Схема вариантов использования|Сводка действий, выполняемых каждым субъектом.<br /><br /> См.<br /><br /> -   [Диаграммы использования UML: Справка](../modeling/uml-use-case-diagrams-reference.md)<br />-   [Диаграммы использования случая использования UML: Руководящие принципы](../modeling/uml-use-case-diagrams-guidelines.md)|
|схема компонентов|Визуализация системы в виде коллекции допускающих многократное использование частей, которые предоставляют или потребляют поведение через четко определенный набор интерфейсов.<br /><br /> См.<br /><br /> -   [Диаграммы компонентов UML: Справка](../modeling/uml-component-diagrams-reference.md)<br />-   [Диаграммы компонентов UML: Руководящие принципы](../modeling/uml-component-diagrams-guidelines.md)|

### <a name="describe-the-system-structure-component-diagrams"></a><a name="DescribeComponents"></a>Опишите структуру системы: Диаграммы компонентов
...
- PaymentProcessing
  ...
  ![Компоненты внутри веб-сайта компании Dinner Now](../modeling/media/uml-dinnernow.png "UML_DinnerNow")
...
|**Схема**|**Описание**|
|-----------------|---------------------|
|Карта кода|Визуализация организации и отношений в имеющемся коде.<br /><br /> Чтобы идентифицировать кандидаты в компоненты, создайте карту кода и сгруппируйте элементы по их функции в системе.<br /><br /> См.<br /><br /> -   [Карта зависимостей через ваши решения](../modeling/map-dependencies-across-your-solutions.md)|
|Схема последовательностей|Визуализация последовательности взаимодействий между компонентами или частями внутри компонента.<br /><br /> Чтобы создать из компонента линию жизни на схеме последовательностей, щелкните компонент правой кнопкой мыши и выберите пункт **Создать линию жизни**.<br /><br /> См.<br /><br /> -   [Диаграммы последовательности UML: Справка](../modeling/uml-sequence-diagrams-reference.md)<br />-   [Диаграммы последовательности UML: Руководящие принципы](../modeling/uml-sequence-diagrams-guidelines.md)|
|Схема классов (UML)|Определение интерфейсов на предусмотренных или необходимых портах и классов, реализующих функциональные возможности компонентов.<br /><br /> См.<br /><br /> -   [Диаграммы класса UML: Справка](../modeling/uml-class-diagrams-reference.md)<br />-   [Диаграммы класса UML: Руководящие принципы](../modeling/uml-class-diagrams-guidelines.md)|
|Схема слоев|Описание логической архитектуры системы относительно компонентов. Для контроля за соответствием кода дизайну требуется проверка слоев.<br /><br /> См.<br /><br /> -   [Создание диаграмм слоя из кода](../modeling/create-layer-diagrams-from-your-code.md)<br />-   [Диаграммы слоя: Справка](../modeling/layer-diagrams-reference.md)<br />-   [Диаграммы слоя: Руководящие принципы](../modeling/layer-diagrams-guidelines.md)<br />-   [Проверка кода с диаграммами слоя](../modeling/validate-code-with-layer-diagrams.md)|
|схема активности|Визуализация внутренней обработки, выполняемой компонентами в ответ на входящие сообщения.<br /><br /> См.<br /><br /> -   [Диаграммы активности UML: Справка](../modeling/uml-activity-diagrams-reference.md)<br />-   [Диаграммы активности UML: Руководящие принципы](../modeling/uml-activity-diagrams-guidelines.md)|
...
- поиск проблемных областей, естественных слоев или шаблонов, а также других областей, улучшение которых может принести пользу.
  ...
  **Карта кода для платежной системы компании Dinner Now**
  ...
  ![Методы внутри класса PaymentProcessing и их зависимости](../modeling/media/depgraph-expandeddn.png "DepGraph_ExpandedDN")
...
|**Схема**|**Что описывает**|
|-----------------|-------------------|
|Схема слоев|Логическая архитектура системы. Для контроля за соответствием кода дизайну требуется проверка слоев.<br /><br /> Для идентификации существующих или предполагаемых слоев создайте карту кода и сгруппируйте связанные друг с другом элементы. Инструкции по созданию схемы слоев см. в следующих разделах:<br /><br /> -   [Создание диаграмм слоя из кода](../modeling/create-layer-diagrams-from-your-code.md)<br />-   [Диаграммы слоя: Руководящие принципы](../modeling/layer-diagrams-guidelines.md)|
|схема компонентов|Компоненты, их интерфейсы и отношения.<br /><br /> Для идентификации кандидатов в компоненты создайте карту кода и сгруппируйте элементы по их функции в системе.<br /><br /> См.<br /><br /> -   [Диаграммы компонентов UML: Справка](../modeling/uml-component-diagrams-reference.md)<br />-   [Диаграммы компонентов UML: Руководящие принципы](../modeling/uml-component-diagrams-guidelines.md)|
|Схема классов (UML)|Классы, их атрибуты, операции и отношения.<br /><br /> Для идентификации этих элементов создайте UML-схему классов, содержащую эти элементы.<br /><br /> См.<br /><br /> -   [Диаграммы класса UML: Справка](../modeling/uml-class-diagrams-reference.md)<br />-   [Диаграммы класса UML: Руководящие принципы](../modeling/uml-class-diagrams-guidelines.md)|
...
### <a name="describe-the-interactions-sequence-diagrams"></a><a name="DescribeSequence"></a>Опишите взаимодействия: Диаграммы последовательности
...
- Во время *синхронного* сообщения объект отправителя \<ждет элемента управления, чтобы <вернуть>> как в обычном вызове функции. В случае *асинхронного* сообщения отправитель может сразу же продолжить работу.

- Используйте \<<создавать>> сообщения, указывающие на строительство объектов другими объектами. Это сообщение должно отправляться объекту в первую очередь.
 ...
 **Сущности обработки платежа на схеме классов**
 ...
 ![Сведения о сущностях обработки платежа на схеме классов](../modeling/media/uml-payment.png "UML_Payment")
...
|**Схема**|**Описание**|
|-----------------|---------------------|
|Схема вариантов использования|Определение типов, используемых для описания целей и шагов в вариантах использования.<br /><br /> См.<br /><br /> -   [Диаграммы использования UML: Справка](../modeling/uml-use-case-diagrams-reference.md)<br />-   [Диаграммы использования случая использования UML: Руководящие принципы](../modeling/uml-use-case-diagrams-guidelines.md)|
|схема активности|Определение типов данных, передаваемых через узлы объекта, закрепления ввода, закрепления вывода и узлы параметров действий.<br /><br /> См.<br /><br /> -   [Диаграммы активности UML: Справка](../modeling/uml-activity-diagrams-reference.md)<br />-   [Диаграммы активности UML: Руководящие принципы](../modeling/uml-activity-diagrams-guidelines.md)|
|схема компонентов|Описание компонентов, их интерфейсов и отношений. Класс может также описывать компонент полностью.<br /><br /> См.<br /><br /> -   [Диаграммы компонентов UML: Справка](../modeling/uml-component-diagrams-reference.md)<br />-   [Диаграммы компонентов UML: Руководящие принципы](../modeling/uml-component-diagrams-guidelines.md)|
|Схема слоев|Определение логической архитектуры системы относительно классов.<br /><br /> Для контроля за соответствием кода дизайну требуется проверка слоев.<br /><br /> См.<br /><br /> -   [Создание диаграмм слоя из кода](../modeling/create-layer-diagrams-from-your-code.md)<br />-   [Диаграммы слоя: Справка](../modeling/layer-diagrams-reference.md)<br />-   [Диаграммы слоя: Руководящие принципы](../modeling/layer-diagrams-guidelines.md)<br />-   [Проверка кода с диаграммами слоя](../modeling/validate-code-with-layer-diagrams.md)|
...
### <a name="describe-the-logical-architecture-layer-diagrams"></a><a name="DescribeLayers"></a>Опишите логическую архитектуру: Диаграммы слоя
...
|**Схема**|**Описание**|
|-----------------|---------------------|
|Карта кода|Визуализация организации и отношений в имеющемся коде.<br /><br /> Чтобы создать слои, сформируйте карту кода, а затем сгруппируйте элементы на карте как потенциальные слои. Перетащите группы с карты на схему слоев.<br /><br /> См.<br /><br /> -   [Карта зависимостей через ваши решения](../modeling/map-dependencies-across-your-solutions.md)<br />-   [Просмотр и переустройство кодов](../modeling/browse-and-rearrange-code-maps.md)|
|схема компонентов|Описание компонентов, их интерфейсов и отношений.<br /><br /> Чтобы визуализировать слои, создайте схему компонентов, описывающую функциональные возможности различных компонентов в системе.<br /><br /> См.<br /><br /> -   [Диаграммы компонентов UML: Справка](../modeling/uml-component-diagrams-reference.md)<br />-   [Диаграммы компонентов UML: Руководящие принципы](../modeling/uml-component-diagrams-guidelines.md)|
...
## <a name="see-also"></a>См. также:
 [Визуализация моделей создания кода](../modeling/visualize-code.md) для моделей использования [приложений](../modeling/create-models-for-your-app.md) [в процессе разработки](../modeling/use-models-in-your-development-process.md) [Использование моделей в Agile development](https://msdn.microsoft.com/592ac27c-3d3e-454a-9c38-b76658ed137f) Validate [вашей системы во время разработки](../modeling/validate-your-system-during-development.md) [моделей и диаграмм расширения UML](../modeling/extend-uml-models-and-diagrams.md)
