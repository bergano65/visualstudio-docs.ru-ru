...
Последнюю версию этого раздела можно найти в [сценарий: изменение проекта с помощью визуализации и моделирования](https://docs.microsoft.com/visualstudio/modeling/scenario-change-your-design-using-visualization-and-modeling).  
...
|**Схема**|**Что описывает**|  
|-----------------|-------------------|  
|*Схема вариантов использования (UML)*<br /><br /> Пример<br /><br /> -   [Схемы вариантов использования UML: Справочник по](../modeling/uml-use-case-diagrams-reference.md)<br />-   [UML-схемы вариантов использования: рекомендации](../modeling/uml-use-case-diagrams-guidelines.md)|— Действия, которые поддерживает система компании Dinner Now<br />-Персонал и внешние системы, выполняющих действия<br />-Основные компоненты системы, которые поддерживают каждый вид деятельности<br />-Части бизнес-процесса, выходящие за рамки текущей системы, например, Доставка еды.|  
|*Схема активности (UML)*<br /><br /> Пример<br /><br /> -   [UML-схемы деятельности: ссылка](../modeling/uml-activity-diagrams-reference.md)<br />-   [UML-схемы деятельности: рекомендации](../modeling/uml-activity-diagrams-guidelines.md)|Последовательность действий клиента при размещении заказа.|  
 ...
 **Схема активности UML**  
 ...
 ![UML-схему классов](../modeling/media/uml-dinnerorders.png "UML_DinnerOrders")  
  
 **Схема классов UML**  
  
###  <a name="DescribingURM"></a> Описание новых или обновленных пользовательских требований  
...
|*Схема активности (UML)*<br /><br /> Пример<br /><br /> -   [UML-схемы деятельности: ссылка](../modeling/uml-activity-diagrams-reference.md)<br />-   [UML-схемы деятельности: рекомендации](../modeling/uml-activity-diagrams-guidelines.md)|Операции, выполняемые клиентом для размещения отзыва о ресторане|  
|*Схема классов (UML)*<br /><br /> Пример<br /><br /> -   [UML-схемы классов: ссылка](../modeling/uml-class-diagrams-reference.md)<br />-   [UML-схемы классов: рекомендации](../modeling/uml-class-diagrams-guidelines.md)|Данные, необходимые для сохранения отзыва|  
...
|**Схемы**|**Что описывает**|  
|------------------|-------------------|  
|*Схема активности (UML)*<br /><br /> Пример<br /><br /> -   [UML-схемы деятельности: ссылка](../modeling/uml-activity-diagrams-reference.md)<br />-   [UML-схемы деятельности: рекомендации](../modeling/uml-activity-diagrams-guidelines.md)|Последовательность шагов, которые выполняются, когда система обнаруживает, что клиент размещает заказ в ресторане повторно, и предлагает ему написать отзыв.|  
...
|*Схема классов на основе кода*<br /><br /> См. раздел [How to: Add Class Diagrams to Projects (Class Designer)](../ide/how-to-add-class-diagrams-to-projects-class-designer.md).|Существующие классы в коде.|  
|*Схема компонентов (UML)*<br /><br /> Пример<br /><br /> -   [Схемы компонентов UML: Справочник по](../modeling/uml-component-diagrams-reference.md)<br />-   [UML-схемы компонентов: рекомендации](../modeling/uml-component-diagrams-guidelines.md)|Высокоуровневые части системы, такие как веб-сайт компании Dinner Now, и их интерфейсы. Эти интерфейсы определяют, как компоненты взаимодействуют между собой через предоставляемые и потребляемые методы или службы.|  
|*Схема последовательностей (UML)*<br /><br /> Пример<br /><br /> -   [Схемы последовательностей UML: Справочник по](../modeling/uml-sequence-diagrams-reference.md)<br />-   [UML-схемы последовательностей: рекомендации](../modeling/uml-sequence-diagrams-guidelines.md)|Последовательность взаимодействий между экземплярами.|  
...
|**Схема**|**Описание**|  
|-----------------|---------------------|  
|Карта кода|Визуализация организации и отношений в имеющемся коде.<br /><br /> Чтобы идентифицировать кандидаты в компоненты, создайте карту кода и сгруппируйте элементы по их функции в системе.<br /><br /> Пример<br /><br /> -   [Сопоставление зависимостей во всех решениях](../modeling/map-dependencies-across-your-solutions.md)|  
|Схема последовательностей|Визуализация последовательности взаимодействий между компонентами или частями внутри компонента.<br /><br /> Чтобы создать из компонента линию жизни на схеме последовательностей, щелкните компонент правой кнопкой мыши и выберите пункт **Создать линию жизни**.<br /><br /> Пример<br /><br /> -   [Схемы последовательностей UML: Справочник по](../modeling/uml-sequence-diagrams-reference.md)<br />-   [UML-схемы последовательностей: рекомендации](../modeling/uml-sequence-diagrams-guidelines.md)|  
...
|схема активности|Визуализация внутренней обработки, выполняемой компонентами в ответ на входящие сообщения.<br /><br /> Пример<br /><br /> -   [UML-схемы деятельности: ссылка](../modeling/uml-activity-diagrams-reference.md)<br />-   [UML-схемы деятельности: рекомендации](../modeling/uml-activity-diagrams-guidelines.md)|  
...
|**Схема**|**Описание**|  
|-----------------|---------------------|  
|Схема вариантов использования|Определение типов, используемых для описания целей и шагов в вариантах использования.<br /><br /> Пример<br /><br /> -   [Схемы вариантов использования UML: Справочник по](../modeling/uml-use-case-diagrams-reference.md)<br />-   [UML-схемы вариантов использования: рекомендации](../modeling/uml-use-case-diagrams-guidelines.md)|  
...
|схема компонентов|Описание компонентов, их интерфейсов и отношений. Класс может также описывать компонент полностью.<br /><br /> Пример<br /><br /> -   [Схемы компонентов UML: Справочник по](../modeling/uml-component-diagrams-reference.md)<br />-   [UML-схемы компонентов: рекомендации](../modeling/uml-component-diagrams-guidelines.md)|  
...
###  <a name="DescribeLayers"></a> Описание логической архитектуры: схемы слоев  
