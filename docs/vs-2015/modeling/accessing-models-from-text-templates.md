...
ms.locfileid: "47568225"
---
# <a name="accessing-models-from-text-templates"></a>Обращение к моделям из текстовых шаблонов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [доступ к моделям из текстовых шаблонов](https://docs.microsoft.com/visualstudio/modeling/accessing-models-from-text-templates).  
