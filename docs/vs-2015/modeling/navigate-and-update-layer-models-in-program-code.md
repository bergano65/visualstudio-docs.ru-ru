...
## <a name="shapes-and-diagrams"></a>Фигуры и схемы
 ...
 Аналогичным образом `ILayerModel` отображается на одном [идиаграм](/previous-versions/ee789658(v=vs.140)).
