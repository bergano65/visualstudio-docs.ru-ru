...
## <a name="see-also"></a>См. также раздел
 [Определение и установка расширения моделирования](../modeling/define-and-install-a-modeling-extension.md) [расширение моделей и схем UML](../modeling/extend-uml-models-and-diagrams.md) [Определение обработчика жестов на схеме моделирования](../modeling/define-a-gesture-handler-on-a-modeling-diagram.md) [Определение настраиваемого элемента панели элементов моделирования](../modeling/define-a-custom-modeling-toolbox-item.md) [Определение ограничений проверки для изменения моделей UML](../modeling/define-validation-constraints-for-uml-models.md) [ UML-схемы последовательностей с использованием программирования UML API](../modeling/edit-uml-sequence-diagrams-by-using-the-uml-api.md) [с помощью команды UML API](../modeling/programming-with-the-uml-api.md) [Sample: для выровняйте фигуры на схеме UML](http://go.microsoft.com/fwlink/?LinkID=213809)
