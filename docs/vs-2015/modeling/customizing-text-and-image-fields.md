---
title: Настройка текста полей и изображениями | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47571706"
---
# <a name="customizing-text-and-image-fields"></a>Настройка полей с текстом и изображениями
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Настройка текст и изображение поля](https://docs.microsoft.com/visualstudio/modeling/customizing-text-and-image-fields).  
