...
Последнюю версию этого раздела можно найти в [Создание доменного языка Windows Forms-Based](https://docs.microsoft.com/visualstudio/modeling/creating-a-windows-forms-based-domain-specific-language).  
