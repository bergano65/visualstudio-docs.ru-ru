...
|-----------|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     1     |        **Class**         |                                                           Определение объектов, совместно обладающих заданными характеристиками структуры или поведения. Дополнительные сведения см. [в разделе Свойства типов на схемах классов UML](../modeling/properties-of-types-on-uml-class-diagrams.md).                                                            |
...
|    5а     |     **Статистической обработки**      |                                                                                                    Ассоциация, представляющая отношение совместного владения. Свойству **агрегирования** роли владельца присвоено значение **Shared**.                                                                                                     |
|    5б     |     **Композиция**      |                                                                                                      Ассоциация, представляющая отношение целого и части. Свойству **агрегирования** роли владельца присвоено значение **Composite**.                                                                                                      |
...
|-----------|-------------|-----------------|
|10|**Интерфейс**|Определение части наблюдаемого извне поведения объекта. Дополнительные сведения см. [в разделе Свойства типов на схемах классов UML](../modeling/properties-of-types-on-uml-class-diagrams.md).|
...
|13|**Импорт**|Отношение между пакетами, указывающее на то, что один пакет включает в себя все определения другого.|
