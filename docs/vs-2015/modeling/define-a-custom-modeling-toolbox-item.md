...
## <a name="Extension"></a>Как распределять элементы панели элементов в расширении Visual Studio
 Вы можете распределить элементы панели элементов другим пользователям [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], упаковывая их в расширение Visual Studio (VSIX). Команды, профили и другие расширения можно упаковать в один файл VSIX. Дополнительные сведения см. в разделе [развертывание расширений Visual Studio](https://go.microsoft.com/fwlink/?LinkId=160780).
