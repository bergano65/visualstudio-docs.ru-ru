...
## <a name="Schema"></a> Структура профиля  
 В XSD-файл для профилей UML можно найти в следующем примере: [Установка профилей и стереотипов XSD](http://go.microsoft.com/fwlink/?LinkID=213811). Для облегчения изменения файлов профилей установите файл `.xsd` в следующий каталог:  
...
## <a name="troubleshooting"></a>Устранение неполадок  
 ...
 При открытии модели UML, возникает следующая ошибка: **VS1707: Не удалось загрузить следующие профили, из-за ошибки сериализации: MyProfile.profile**  
