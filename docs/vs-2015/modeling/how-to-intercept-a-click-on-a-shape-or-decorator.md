---
title: 'Практическое: перехват щелчка фигуры или декоратора | Документация Майкрософт'
ms.custom: ''
ms.date: 2018-06-30
...
Последнюю версию этого раздела можно найти в [как: перехват щелчка фигуры или декоратора](https://docs.microsoft.com/visualstudio/modeling/how-to-intercept-a-click-on-a-shape-or-decorator).  
