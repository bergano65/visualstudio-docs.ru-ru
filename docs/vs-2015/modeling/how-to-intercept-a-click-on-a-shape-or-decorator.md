---
title: Как перехватить щелчок на фигуре или декораторе | Документация Майкрософт
ms.date: 11/15/2016
...
4. Переопределите метод Инитиализешапефиелдс в классах Shape, добавив следующее определение разделяемого класса.
...
## <a name="see-also"></a>См. также:
 [Реагирование и распространение изменений](../modeling/responding-to-and-propagating-changes.md) [свойств декораторов](../modeling/properties-of-decorators.md)
