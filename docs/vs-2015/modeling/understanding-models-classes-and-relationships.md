---
title: Основные сведения о моделях, классах и связях | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="the-dsl-definition"></a>Определение DSL
 При открытии `Dsl\DslDefinition.dsl` окно [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] напоминает следующий рисунок.
 ...
 ![конструктор DSL с дорожкой](../modeling/media/dsl-desinger.png "dsl_desinger")
...
## <a name="roles"></a>Роли
 ...
 ![Роли и свойства.](../modeling/media/propertycode.png "пропертикоде")
...
## <a name="multiplicities"></a>Кратности
 Кратность укажите, сколько элементов может иметь одну и ту же роль в доменной связи. В этом примере параметр кратности "нуль-ко-многим" (0.. \*) в роли **каталога** указывает, что любой экземпляр класса домена **издателя** может иметь столько **публишеркаталог** связей отношений, сколько нужно предоставить.

 Настройте кратность роли, введя на диаграмме или изменив свойство `Multiplicity` в окне **Свойства** . В следующей таблице описаны параметры этого свойства.
...
## <a name="see-also"></a>См. также раздел
 [Доменные отношения в созданном API](../misc/domain-relationships-in-the-generated-api.md) [средства предметно-ориентированных языков глоссария](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa)
