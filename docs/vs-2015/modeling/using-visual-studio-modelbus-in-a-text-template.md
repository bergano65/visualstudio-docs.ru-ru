...
1. Если целевой объект в решение DSL не содержит **ModelBusAdapter** проект, создайте его с помощью мастера расширение Modelbus:
    ...
    1. Скачайте и установите расширение [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ModelBus, если это еще не сделано. Дополнительные сведения см. в разделе [Visualization and Modeling SDK](https://www.visualstudio.com/).
...
2. В схеме определения DSL, щелкните правой кнопкой мыши пустую часть схемы, не расположено в верхней части и нажмите кнопку **включить Modelbus**.
   ...
   - Если вы не видите **включить Modelbus**, необходимо загрузить и установить расширение VMSDK ModelBus. Найти его на сайте VMSDK: [Visualization and Modeling SDK](https://www.visualstudio.com/).
...
3. Нажмите сочетание клавиш CTRL + F5.
