...
- Код, поддерживающий отладку: Visual C# .NET, Visual Basic .NET, C++, JavaScript и X++
  ...
  Пример [Видео. Визуальная отладка с интеграцией отладчика сопоставления кода (канал 9)](http://go.microsoft.com/fwlink/?LinkId=293418) • [сопоставьте стек вызовов](#MapStack) • [сделать примечания о коде](#MakeNotes) • [обновление сопоставления путем добавления следующего стека вызовов](#UpdateMap)• [Добавление связанного кода в сопоставление](#AddRelatedCode) • [поиск ошибок, используя сопоставление](#FindBugs) • [вопросы И ответы](#QA)
...
- **Что значки элементов и стрелки означают?**
  ...
  Пример [Сопоставьте стек вызовов](#MapStack) • [сделать примечания о коде](#MakeNotes) • [обновление сопоставления путем добавления следующего стека вызовов](#UpdateMap) • [Добавление связанного кода в сопоставление](#AddRelatedCode) • [поиска ошибок с помощью карты](#FindBugs)
