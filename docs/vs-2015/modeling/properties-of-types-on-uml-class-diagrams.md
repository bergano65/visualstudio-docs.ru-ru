...
ms.locfileid: "47563303"
---
# <a name="properties-of-types-on-uml-class-diagrams"></a>Свойства типов на схемах классов UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [свойства типов на UML схемах классов](https://docs.microsoft.com/visualstudio/modeling/properties-of-types-on-uml-class-diagrams).  
