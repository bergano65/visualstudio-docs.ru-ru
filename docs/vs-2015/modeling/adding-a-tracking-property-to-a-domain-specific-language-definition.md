...
Последнюю версию этого раздела можно найти в [Добавление свойства отслеживания в определение доменного языка](https://docs.microsoft.com/visualstudio/modeling/adding-a-tracking-property-to-a-domain-specific-language-definition).  
...
## <a name="adding-helper-classes-to-support-tracking-properties"></a>Добавление вспомогательных классов для поддержки свойства отслеживания  
...
#### <a name="to-add-the-helper-classes"></a>Чтобы добавить вспомогательные классы  
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Для обновления пакета DSL для использования вашего настраиваемого дескриптора типа  
...
## <a name="testing-the-language"></a>Тестирование языка  
 Следующий шаг — построение и запуск конструктора DSL в новый экземпляр класса [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] , можно проверить, правильно ли работает свойства отслеживания.  
...
2.  В меню **Отладка** щелкните **Начать отладку**.  
     ...
     Экспериментальная сборка [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] открывает **Отладка** решение, которое содержит пустой тестовый файл.  
