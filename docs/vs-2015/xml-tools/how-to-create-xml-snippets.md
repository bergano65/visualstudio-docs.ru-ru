...
ms.locfileid: "47572962"
---
# <a name="how-to-create-xml-snippets"></a>Как создавать XML-фрагменты
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: Создание XML-фрагменты](https://docs.microsoft.com/visualstudio/xml-tools/how-to-create-xml-snippets).  
