...
ms.locfileid: "47573090"
---
# <a name="context-menus-xml-schema-explorer"></a>Контекстные меню (обозреватель XML-схемы)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [контекстные меню (обозреватель XML-схем)](https://docs.microsoft.com/visualstudio/xml-tools/context-menus-xml-schema-explorer).  
