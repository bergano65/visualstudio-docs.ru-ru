...
ms.locfileid: "47560919"
---
# <a name="xml-schema-explorer"></a>Обозреватель схемы XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [обозреватель XML-схем](https://docs.microsoft.com/visualstudio/xml-tools/xml-schema-explorer).  
