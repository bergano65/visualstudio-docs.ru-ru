...
ms.locfileid: "47561229"
---
# <a name="searching-the-schema-set"></a>Поиск набора схем
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поиск набора схем](https://docs.microsoft.com/visualstudio/xml-tools/searching-the-schema-set).  
