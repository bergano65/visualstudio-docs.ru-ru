...
| SiteMapSchema.xsd |            Схема для XML-файла ASP.NET Sitemap "<http://schemas.microsoft.com/AspNet/SiteMap-File-1.0>".             |
...
|   xsdschema.xsd   |                            Схема, описывающая саму XSD-схему, http://www.w3.org/2001/XMLSchema.                            |
