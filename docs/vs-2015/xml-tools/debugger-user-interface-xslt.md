 ...
 **Имя** Этот столбец содержит имена всех локальных переменных в текущей области. Наборы узлов имеют дерево объектов, в котором можно перейти на уровень ниже, чтобы увидеть вложенные папки.

 **Значение** В этом столбце отображается значение, содержащееся в каждой переменной. Узлы атрибутов, инструкций по обработке, комментариев, текста и CDATA отображают текстовое значение узла. Узлы пространства имен отображают URI-код пространства имен.

 **Тип** В этом столбце указывается тип данных каждой переменной, указанной в столбце **имя** .
...
|`self::node()`|Значение узла контекста.|
 ...
 Дополнительные сведения см. [в разделе инструкции. изменение контекста отладчика](https://msdn.microsoft.com/library/8a69ea63-2ef0-4b4f-9521-cf8ad2e3ec5e).
...
## <a name="output-window"></a>Окно выходных данных
 ...
 Отладчик XSLT использует для отображения вывода отладки отдельное окно. Это то же окно, которое используется для отображения выходных данных команды **Показать XSL Output** .
...
## <a name="see-also"></a>См. также раздел
 Основные сведения об [отладке](../xml-tools/debugging-xslt.md) [окон переменных](https://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e) в [отладчике](../debugger/debugger-basics.md) XSLT
