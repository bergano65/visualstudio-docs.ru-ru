...
ms.locfileid: "47561646"
---
# <a name="xml-schema-designer"></a>Конструктор схемы XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [конструктор XML-схем](https://docs.microsoft.com/visualstudio/xml-tools/xml-schema-designer).  
