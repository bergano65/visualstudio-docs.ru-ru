...
ms.locfileid: "47573469"
---
# <a name="xml-editor-tasks"></a>Задачи редактора XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задачи редактора XML](https://docs.microsoft.com/visualstudio/xml-tools/xml-editor-tasks).  
