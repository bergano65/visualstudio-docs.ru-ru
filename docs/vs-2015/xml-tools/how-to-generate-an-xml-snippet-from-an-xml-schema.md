...
ms.locfileid: "47572562"
---
# <a name="how-to-generate-an-xml-snippet-from-an-xml-schema"></a>Как создать XML-фрагмент из XML-схемы
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: создания XML фрагмент из схемы XML](https://docs.microsoft.com/visualstudio/xml-tools/how-to-generate-an-xml-snippet-from-an-xml-schema).  
