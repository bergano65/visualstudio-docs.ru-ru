---
title: Практическое руководство. Создание и изменение файла схемы XSD | Документация Майкрософт
ms.date: 11/15/2016
...
1.  В Visual Studio откройте **файл** меню и выберите **New** и затем **файл**. Или используйте сочетание клавиш CTRL+N.  
  
2.  В **новый файл** выберите **схемы XML** и нажмите кнопку **откройте**.  
...
1.  Нажмите кнопку **использование редактора XML для просмотра и изменения базового файла XML-схемы** ссылку в начальном представлении.  
