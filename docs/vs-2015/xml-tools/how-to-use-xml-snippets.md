...
Можно вызывать XML-фрагменты с помощью следующих двух команд из контекстного меню XML Editor. Команда **Вставить фрагмент** вставляет XML-фрагмент в позицию курсора. Команда **окружить с помощью** оболочки фрагмента кода XML вокруг выделенного текста. Для каждого XML-фрагмента имеются назначенные типы фрагментов. Типы фрагментов определяют, доступен ли фрагмент кода с помощью команды « **Вставить фрагмент** », команды « **окружить** » или и того, и другого.
