...
- Практические руководства
  - [Большой двоичный объект хранилища](https://azure.microsoft.com/develop/python/how-to-guides/blob-service/)  
  ...
  - [Разделы и подписки служебной шины](https://azure.microsoft.com/develop/python/how-to-guides/service-bus-topics/) 
