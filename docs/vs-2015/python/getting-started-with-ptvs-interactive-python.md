...
Интерактивные запросы или циклы «чтение — вычисление — печать» (REPL) являются основным средством в эффективных языках программирования.  Они позволяют выполнить фрагменты кода для обнаружения и получения сведений об API, экспериментировать с использованием API и интерактивно разрабатывать работающий код для включения в проекты и программы.  
 ...
 Интерактивные окна можно открыть для каждой установки Python (их число не ограничено).  В верхней части окна есть кнопки для очистки экрана, сброса контекста выполнения и т. д.  Журнал останется без изменений.  
  
 Эти инструкции можно просмотреть в очень коротком [видеоролике в Youtube](https://www.youtube.com/watch?v=yc2CROtTsC0&index=5&list=PLReL099Y5nRdLgGAdrb_YeTdEnd23s6Ff).  
  
## <a name="see-also"></a>См. также:  
 [Вики-документация](https://github.com/Microsoft/PTVS/wiki/Interactive-REPL)   
