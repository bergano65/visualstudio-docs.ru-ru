---
title: Начало работы с PTVS. Настройка Visual Studio | Документы Майкрософт
ms.custom: ''
ms.date: 2018-06-30
