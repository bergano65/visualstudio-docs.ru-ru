...
Последнюю версию этого раздела можно найти в [клавиши-модификаторы инструмента прямой выбор в Blend](https://docs.microsoft.com/visualstudio/designers/direct-selection-tool-modifier-keys-in-blend).  
