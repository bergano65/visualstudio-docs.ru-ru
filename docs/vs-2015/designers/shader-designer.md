...
ms.locfileid: "47572693"
---
# <a name="shader-designer"></a>Конструктор шейдеров
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [конструктор шейдеров](https://docs.microsoft.com/visualstudio/designers/shader-designer).  
