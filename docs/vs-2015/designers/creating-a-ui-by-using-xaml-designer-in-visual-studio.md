 ...
 **Ориентация** определяет различные ориентации приложения: **Альбомная** или **книжной**.

 **Edge** указывает по различным краям для вашего приложения: **Оба**, **слева**, **справа**, или **None**.
