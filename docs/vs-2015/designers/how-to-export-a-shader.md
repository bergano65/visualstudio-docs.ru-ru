...
ms.locfileid: "47561089"
---
# <a name="how-to-export-a-shader"></a>Практическое руководство. Экспорт шейдера
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: экспорт шейдера](https://docs.microsoft.com/visualstudio/designers/how-to-export-a-shader).  
