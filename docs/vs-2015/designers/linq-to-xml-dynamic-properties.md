...
## <a name="see-also"></a>См. также раздел
 [Привязка данных WPF с помощью LINQ to XML](../designers/wpf-data-binding-with-linq-to-xml.md) [привязки данных WPF с обзором LINQ to XML общие сведения о](../designers/wpf-data-binding-with-linq-to-xml-overview.md) [LINQ-запросах (C#)](https://msdn.microsoft.com/library/37895c02-268c-41d5-be39-f7d936fa88a8)
