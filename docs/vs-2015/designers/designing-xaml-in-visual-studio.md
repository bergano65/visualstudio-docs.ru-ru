...
- **Синхронизированные макеты и параметры:** создавая пользовательские макеты, вы можете сохранять и использовать индивидуальные окна инструментов. Эти настройки синхронизируются в Visual Studio и Blend на всех устройствах, на которых вы входите в свою учетную запись Майкрософт. Дополнительные сведения см. в разделе [Настройка параметров разработки в Visual Studio](https://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3).
