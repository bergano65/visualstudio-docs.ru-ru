...
|Не знакомы с .NET?|[Общие сведения о платформе .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Основные сведения о приложениях .NET Framework](http://msdn.microsoft.com/library/653da4ba-3752-4d1f-a08a-de017dc86ecc)<br /><br /> [Начало работы с Visual C# и Visual Basic](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx)|  
...
## <a name="see-also"></a>См. также раздел  
 [Библиотека классов (WPF)](https://msdn.microsoft.com/library/ms753307\(v=vs.100\).aspx)   
