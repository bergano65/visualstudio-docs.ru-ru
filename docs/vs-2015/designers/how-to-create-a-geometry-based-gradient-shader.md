...
> На этом рисунке оранжевый цвет используется для лучшей демонстрации эффекта шейдера, но так как фигура для предварительного просмотра не имеет позиции в абсолютном пространстве, шейдер нельзя просмотреть в конструкторе шейдеров полностью. Для полноценной демонстрации эффекта нужно показывать шейдер в реальной сцене.
 ...
 ![Граф шейдера и предварительный просмотр его эффекта](../designers/media/digit-gradient-effect-graph.png "Digit-градиентный результат-граф")
 ...
 На следующем рисунке показан шейдер, описанный в этом документе, примененный к трехмерной сцене, который демонстрируется в разделе [как моделировать трехмерную ландшафта](../designers/how-to-model-3-d-terrain.md). Интенсивность цвета увеличивается вместе с высотой точки ландшафта.

 ![Градиентный эффекты, применяемые к модели 3&#45;D ландшафта](../designers/media/digit-gradient-effect-result.png "Digit-градиент-результат")
