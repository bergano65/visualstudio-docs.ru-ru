...
ms.locfileid: "47570609"
---
# <a name="pen-tool-modifier-keys-in-blend"></a>Клавиши-модификаторы инструмента «Перо» в Blend
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [пера клавиши-модификаторы инструмента в Blend](https://docs.microsoft.com/visualstudio/designers/pen-tool-modifier-keys-in-blend).  
