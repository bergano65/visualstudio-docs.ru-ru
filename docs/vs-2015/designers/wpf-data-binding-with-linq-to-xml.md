...
|[LINQ to XML динамические свойства](../designers/linq-to-xml-dynamic-properties.md)|Содержит справочные сведения о динамических свойствах, предоставляемых классами <xref:System.Xml.Linq.XAttribute> и <xref:System.Xml.Linq.XElement>.|
|[Привязка данных WPF с помощью LINQ to XML примере](../designers/wpf-data-binding-using-linq-to-xml-example.md)|Содержит пример, в котором средства WPF используются для связывания компонентов пользовательского интерфейса с источником данных XML.|
