...
ms.locfileid: "47558199"
---
# <a name="l2dbformxaml-source-code"></a>Исходный код L2DBForm.xaml
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [исходный код L2DBForm.xaml](https://docs.microsoft.com/visualstudio/designers/l2dbform-xaml-source-code).  
