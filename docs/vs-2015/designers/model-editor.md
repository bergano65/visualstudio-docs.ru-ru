...
|Имя формата|Расширение файла|Поддерживаемые операции (просмотр, правка, создание)|
|-----------------|--------------------|-------------------------------------------------|
...
### <a name="model-editor-toolbars"></a>Панели инструментов редактора моделей
 ...
 ![Модальная панель инструментов средства просмотра модели.](../designers/media/digit-mre-modal-toolbar.png "Digit-MRE-Modal-панель инструментов")
...
|**Режим сведения**|Если этот элемент включен, преобразования влияют на расположение и ориентацию *точки вращения* выбранного объекта (точка вращения определяет центр операций перевода, масштабирования и вращения). В противном случае преобразования влияют на расположение и ориентацию геометрии объекта относительно точки вращения.|
...
|**Выбрать ребро**|Задает **Режим выделения** для выбора края (линии между двумя вершинами) объекта.|
...
### <a name="creating-and-importing-3-d-objects"></a><a name="Adding3DObjects"></a> Создание и импорт трехмерных объектов
...
### <a name="working-with-the-pivot-point"></a>Работа с точкой вращения
 ...
 Демонстрация использования точки вращения см. в разделе [руководство. изменение точки вращения трехмерной модели](../designers/how-to-modify-the-pivot-point-of-a-3-d-model.md).
...
### <a name="modifying-objects"></a><a name="ModifyingObjects"></a> Изменение объектов
 ...
 **Конструктор шейдеров** можно использовать для создания пользовательских материалов шейдера, которые можно применить к объектам в трехмерной сцене. Дополнительные сведения о создании настраиваемых материалов шейдера текстуры см. в разделе [Конструктор шейдеров](../designers/shader-designer.md). Сведения о применении пользовательского материала шейдера к объекту см. в разделе [инструкции. применение шейдера к трехмерной модели](../designers/how-to-apply-a-shader-to-a-3-d-model.md).
...
|Увеличение масштаба.|Прокручивание колеса мыши вперед<br /><br /> CONTROL+ прокручивание колесика мыши вперед<br /><br /> SHIFT+прокручивание колеса мыши вперед<br /><br /> CONTROL+PAGE UP<br /><br /> Знак плюса (+)|
|Уменьшение масштаба.|Прокручивание колеса мыши назад<br /><br /> CONTROL+ прокручивание колесика мыши назад<br /><br /> SHIFT+ прокручивание колеса мыши назад<br /><br /> CONTROL+PAGE DOWN<br /><br /> Знак минуса (-)|
