...
Последнюю версию этого раздела можно найти в [специальных возможностей продуктов и служб (Blend)](https://docs.microsoft.com/visualstudio/designers/accessibility-products-and-services-blend).  
...
## <a name="customer-service-for-people-people-with-hearing-impairments"></a>Служба технической поддержки для людей с нарушениями слуха  
