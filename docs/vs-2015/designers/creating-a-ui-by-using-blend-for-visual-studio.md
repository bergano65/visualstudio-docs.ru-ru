...
## <a name="tour-of-the-tools-panel"></a><a name="Tools"></a> Обзор панели "Инструменты"
 ...
 ![Панель инструментов](../designers/media/blend5toolspanel.png "Blend5Toolspanel")

|Образ —|Тип инструмента|Образ —|Тип инструмента|
|-|-|-|-|
...
## <a name="tour-of-the-assets-panel"></a><a name="Assets"></a> Обзор панели "активы"
 Все элементы управления можно найти на панели **Ресурсы**, аналогичной **панели элементов** в Visual Studio. Помимо элементов управления, вы найдете все, что можно добавить в монтажную область на панели **активы** , включая стили, мультимедиа, поведения и эффекты.

 ![Панель "Активы"](../designers/media/blend5-assets-panel.png "Blend5_Assets_panel")
...
## <a name="tour-of-the-objects-and-timeline-panel"></a><a name="Objects"></a> Обзор панели Объекты и временная шкала
...
|![](../designers/media/b1-3.png "B1_3")|**Средство выбора раскадровки** Просмотр списка созданных раскадровок.|
...
## <a name="tour-of-the-properties-panel"></a><a name="Properties"></a> Обзор панели «Свойства»
 ...
 **Категории**. Развертывание и свертывание категорий свойств. Для отображения или скрытия сведений о категории щелкните **Развернуть** ![](../designers/media/6375953d-074c-421a-bbb3-6f5055b67b64.png "6375953d-074c-421a-bbb3-6f5055b67b64") или **Свернуть** ![Collapse](../designers/media/b5-collapse-button.png "b5_collapse_button").
 ...
 **Ознакомьтесь с коротким видео.** ![Настройка установленных компонентов](../designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Панель свойств](https://www.youtube.com/watch?v=HCqQfiobdag&list=PLBDF977B2F1DAB358&index=7).

## <a name="see-also"></a>См. также:
 [Вставка элементов управления и изменение их поведения](../designers/insert-controls-and-modify-their-behavior-in-xaml-designer.md) . [анимация объектов](../designers/animate-objects-in-xaml-designer.md) [Рисование фигур и путей](../designers/draw-shapes-and-paths.md) [Разработка XAML в Visual Studio и Blend для Visual Studio](../designers/designing-xaml-in-visual-studio.md)
