...
Последнюю версию этого раздела можно найти в [как: экспорт текстуры с предварительно умноженным альфа-](https://docs.microsoft.com/visualstudio/designers/how-to-export-a-texture-that-has-premultiplied-alpha).  
