...
1. Сначала создайте простейшую текстуру. Загрузите существующий файл изображения или создайте его, как описано в разделе [инструкции. Создание простой текстуры](../designers/how-to-create-a-basic-texture.md).
