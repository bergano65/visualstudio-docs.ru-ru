...
- [Ресурсы: Создайте цвета, стили и шаблоны и используйте их позже](#Resources)

## <a name="brushes-modify-the-appearance-of-an-object"></a><a name="Brushes"></a> Кисти: изменение внешнего вида объекта
 Примените кисть к объекту, если вы хотите изменить его внешний вид.

 **Посмотрите короткий видеоролик:** ![Настройка установленных компонентов](../designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Редактор кистей](http://www.popscreen.com/v/6A4mO/Microsoft-Expression-Blend-The-Brushes-Editor).
 ...
 **Ознакомьтесь с коротким видео:** ![Настройка](../designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [кистей плиток](http://www.popscreen.com/v/6A4iM/Microsoft-Expression-Blend-Tile-Brushes)установленных компонентов.

## <a name="styles-and-templates-create-a-consistent-look-and-feel-across-controls"></a><a name="Styles"></a> Стили и шаблоны: создание согласованного внешнего вида и поведения для элементов управления
...
- Выберите **Создать пустой**, чтобы начать "с нуля".
  ...
  Параметр **изменить текущий** отображается только при редактировании уже созданного стиля или шаблона. Он не будет отображаться для элемента управления, для которого по-прежнему используется системный шаблон по умолчанию.
 ...
 **Ознакомьтесь с коротким видео.** ![Настройка установленных компонентов](../designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Создание стиля](https://www.youtube.com/watch?v=W8YdXDPeKdc).

### <a name="apply-a-style-or-template-to-a-control"></a>Применение стиля или шаблона к элементу управления
 Щелкните правой кнопкой мыши объект на панели [Объекты и временная шкала](https://msdn.microsoft.com/135a5a5e-ec6d-4f38-8827-60e284cd5f57), выберите элемент **Изменить шаблон**, а затем нажмите кнопку **Применить ресурс**.
...
### <a name="restore-the-default-style-or-template-of-a-control"></a>Восстановление стиля или шаблона элемента управления по умолчанию
 Выберите элемент управления и на панели [Свойства](https://msdn.microsoft.com/135a5a5e-ec6d-4f38-8827-60e284cd5f57) найдите свойство **Стиль** или **Шаблон**. Затем нажмите кнопку **Дополнительные параметры** ![](../designers/media/12e06962-5d8a-480d-a837-e06b84c545bb.png "12e06962-5d8a-480d-a837-e06b84c545bb")и нажмите в контекстном меню кнопку **Сброс**.

## <a name="visual-states-change-the-appearance-of-a-control-based-on-its-state"></a><a name="Visual"></a> Визуальные состояния: изменение внешнего вида элемента управления в зависимости от его состояния
...
## <a name="resources-create-colors-styles-and-templates-and-reuse-them-later"></a><a name="Resources"></a>Ресурсы: создание цветов, стилей и шаблонов и их последующее повторное использование
 ...
 **Ознакомьтесь с коротким видео.** ![Настройка установленных компонентов позволяет](../designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [кратко коснуться ресурсов](http://www.popscreen.com/v/6A4k7/Microsoft-Expression-Blend-Brief-Touch-on-Resources).
