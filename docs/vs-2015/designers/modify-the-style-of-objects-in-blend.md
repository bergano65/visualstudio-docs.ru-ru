...
>
> Чтобы вернуться в область редактирования основного документа, нажмите кнопку **вернуть область в** ![ ](../designers/media/55844eb3-ed98-4f20-aa66-a6f5b23eeb2b.png "55844eb3-ed98-4f20-aa66-a6f5b23eeb2b").
>
...
### <a name="restore-the-default-style-or-template-of-a-control"></a>Восстановление стиля или шаблона элемента управления по умолчанию
 Выберите элемент управления и на панели [Свойства](https://msdn.microsoft.com/135a5a5e-ec6d-4f38-8827-60e284cd5f57) найдите свойство **Стиль** или **Шаблон**. Затем щелкните **Дополнительные параметры** ![ ](../designers/media/12e06962-5d8a-480d-a837-e06b84c545bb.png "12e06962-5d8a-480d-a837-e06b84c545bb"), а затем в контекстном меню выберите **Сброс** .
