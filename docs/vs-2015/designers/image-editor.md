...
|**Возмож**|Усекает изображение до границ активного выделения.|

### <a name="working-with-mip-levels"></a>Работа с уровнями MIP
 Некоторые форматы изображений, например поверхность DirectDraw (DDS), поддерживают уровни MIP для уровня детализации текстур и пространства. Сведения о том, как создавать уровни MIP и работать с ними, см [. в разделе как создавать и изменять уровни MIP.](../designers/how-to-create-and-modify-mip-levels.md)
...
### <a name="image-properties"></a><a name="ImageProperties"></a> Свойства изображения
...
> [!NOTE]
> Так как свойство **Повернуть на** применяется ко всем инструментам и выбранным областям, оно всегда отображается в нижней части окна **Свойства** вместе с другими свойствами инструмента. Свойство **Повернуть на** отображается всегда, так как все изображения неявно выбраны, если нет другого выделения или активного инструмента. Дополнительные сведения о свойстве **повернуть на** см. в разделе [Свойства инструмента](#ToolProperties).
...
#### <a name="selected-regions"></a>Выбранные области
 ...
 Большинство инструментов —**карандаш**, **кисть**, **распылитель**, **Заливка**, **Ластик**и двумерные примитивы — и преобразования —**поворот**, **усечение**, **Инверсия цветов**, **перелистывание по горизонтали**и **отражение по вертикали**— ограничены или определяются активным выделением. На некоторые инструменты, такие как **Пипетка** и **Текст**, и преобразования, например **Создать MIP-объекты**, не влияют никакие активные выделения. Эти инструменты всегда действуют так, будто все изображение является активным выделением.
...
#### <a name="tool-properties"></a><a name="ToolProperties"></a> Свойства инструмента
...
|Увеличение масштаба.|CONTROL+ прокручивание колесика мыши вперед<br /><br /> CONTROL+PAGE UP<br /><br /> Знак плюса (+)|
|Уменьшение масштаба.|CONTROL с прокручиванием колесика мыши назад<br /><br /> CTRL+PageDown<br /><br /> Знак минуса (-)|
...
|Зафиксировать текущий слой|Возвращает|
