...
|--------------------------------|-----------------|
|Создание элемента|Нажмите CTRL+N|
...
|Выбор свойства элемента|Выбрав элемент и сосредоточьтесь на окно свойств, нажмите клавишу TAB. (используйте CTRL + TAB, чтобы изменить фокус на окно свойств.) Для выбора значений свойств из раскрывающихся списков можно использовать клавиши со стрелками.|
