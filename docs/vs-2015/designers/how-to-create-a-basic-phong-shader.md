---
title: Практическое руководство. Создание простейшего шейдера освещения по методу Фонга | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="the-phong-lighting-model"></a>Модели освещения по методу Фонга  
 ...
 Дополнительные сведения о модели освещения по методу Ламберта см. в разделе [Практическое руководство. Создайте шейдер Ламберта основные](../designers/how-to-create-a-basic-lambert-shader.md).  
...
1. Создайте шейдер Ламберта, как описано в разделе [Практическое руководство. Создайте шейдер Ламберта основные](../designers/how-to-create-a-basic-lambert-shader.md).  
...
## <a name="see-also"></a>См. также  
 ...
 [Практическое руководство. Создайте шейдер Ламберта, базовый](../designers/how-to-create-a-basic-lambert-shader.md)   
