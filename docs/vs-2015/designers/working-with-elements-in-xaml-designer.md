 ...
 *Линия привязки* — это визуальная подсказка, которая помогает выстроить элемент относительно других элементов в приложении.
