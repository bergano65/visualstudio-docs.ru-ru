...
Последнюю версию этого раздела можно найти в [как: построение и выполнение примера Linqtoxmldatabinding](https://docs.microsoft.com/visualstudio/designers/how-to-build-and-run-the-linqtoxmldatabinding-example).  
