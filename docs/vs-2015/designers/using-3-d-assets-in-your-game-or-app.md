...
|[Практическое руководство. Экспорт текстуры для использования с Direct2D или Javascipt](../designers/how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps.md)|Описывает использование конвейера содержимого изображения для экспорта текстуры, которую можно использовать в приложении Direct2D или JavaScript.|  
