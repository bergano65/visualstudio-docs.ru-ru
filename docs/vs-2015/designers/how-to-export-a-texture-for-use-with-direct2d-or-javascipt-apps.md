...
Последнюю версию этого раздела можно найти в [как: экспорт текстуры для использования с Direct2D или Javascipt](https://docs.microsoft.com/visualstudio/designers/how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps).  
