...
ms.locfileid: "47563724"
---
# <a name="visualizer-api-reference"></a>Справочные сведения о прикладном программном интерфейсе визуализаторов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Справочник по API визуализатора](https://docs.microsoft.com/visualstudio/debugger/visualizer-api-reference).  
