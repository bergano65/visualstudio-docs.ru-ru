...
- **Приостановка выполнения кода вручную**  
     ...
     Чтобы приостановить выполнение на следующей доступной строке кода в выполняющемся приложении, выберите **Отладка**, **прервать все** (клавиатуры: **Ctrl + Alt + Break**).  
...
1. Откройте окно "Модули" (клавиатуры: **Ctrl + Alt + U**).  
