...
ms.locfileid: "47573399"
---
# <a name="spy-toolbar"></a>Панель инструментов Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [панель инструментов Spy ++](https://docs.microsoft.com/visualstudio/debugger/spy-increment-toolbar).  
