...
ms.locfileid: "47571584"
---
# <a name="debug-xaml-in-blend"></a>Отладка XAML в Blend
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [отладка XAML в Blend](https://docs.microsoft.com/visualstudio/debugger/debug-xaml-in-blend).  
