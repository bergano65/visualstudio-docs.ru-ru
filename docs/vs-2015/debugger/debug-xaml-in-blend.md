---
title: Отлавливайте XAML в смеси (ru) Документы Майкрософт
ms.date: 11/15/2016
...
2. В списке типов проектов нажмите **XAML (Магазин Windows).**  
  
3. В списке шаблонов проекта нажмите **Blank App**.  
  
4. В текстовом окне **имени** введите `DebuggingSample`.  
...
5. Дважды щелкните "Свойство 'Mame' не существует в пространстве `https://schemas.microsoft.com/winfx/2006/xaml` имен". Вместо символа "M" в "Mame" должен стоять символ "N". Замените "M" на "N". Теперь, когда XAML может быть проанализирован, приложение появляется на поверхности разработки.  
...
## <a name="debugging-in-visual-studio"></a>Отладка в Visual Studio  
 ...
 Для получения дополнительной информации об отладке приложения смотрите [приложения Debug Windows Store в Visual Studio.](https://msdn.microsoft.com/library/windows/apps/hh441472.aspx)  
  
## <a name="getting-help"></a>Получение справки  
 Если вам нужна дополнительная [!INCLUDE[blend_subs](../includes/blend-subs-md.md)] помощь в отладке приложения, вы можете искать [в сообществах приложений Магазина Windows](https://social.msdn.microsoft.com/Forums/windowsapps/home?category=windowsapps) для публикаций, связанных с вашей проблемой, или отправлять вопросы.
