...
5. Дважды щелкните "свойство" имени "не существует в пространстве имен"<https://schemas.microsoft.com/winfx/2006/xaml>". Вместо символа "M" в "Mame" должен стоять символ "N". Замените "M" на "N". Теперь, когда XAML может быть проанализирован, приложение появляется на поверхности разработки.  
