...
ms.locfileid: "47558817"
---
# <a name="messages-menu-commands"></a>Команды меню "Сообщения"
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [команды меню "сообщения"](https://docs.microsoft.com/visualstudio/debugger/messages-menu-commands).  
