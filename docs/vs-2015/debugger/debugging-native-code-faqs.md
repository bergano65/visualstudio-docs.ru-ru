...
ms.locfileid: "47571409"
---
# <a name="debugging-native-code-faqs"></a>Вопросы и ответы по отладке машинного кода
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [отладки собственного кода часто задаваемые вопросы о](https://docs.microsoft.com/visualstudio/debugger/debugging-native-code-faqs).  
