...
Последнюю версию этого раздела можно найти в [как: Перемещение вверх или вниз по содержимому памяти](https://docs.microsoft.com/visualstudio/debugger/how-to-page-up-or-down-in-memory).  
