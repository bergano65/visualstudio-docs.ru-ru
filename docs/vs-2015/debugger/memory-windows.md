...
ms.locfileid: "47560684"
---
# <a name="memory-windows"></a>Окно памяти
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Просмотр памяти для переменных в отладчике](https://docs.microsoft.com/visualstudio/debugger/memory-windows).  
