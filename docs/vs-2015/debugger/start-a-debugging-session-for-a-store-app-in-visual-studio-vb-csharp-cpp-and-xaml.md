...
Последнюю версию этого раздела можно найти в [запуск сеанса отладки для приложения Store в Visual Studio (VB, C#, C++ и XAML)](https://docs.microsoft.com/visualstudio/debugger/start-a-debugging-session-for-a-store-app-in-visual-studio-vb-csharp-cpp-and-xaml).  
