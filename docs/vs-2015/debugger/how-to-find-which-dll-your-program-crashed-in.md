...
Последнюю версию этого раздела можно найти в [как: найти которой DLL Your аварийное завершение в программе](https://docs.microsoft.com/visualstudio/debugger/how-to-find-which-dll-your-program-crashed-in).  
