 ...
 **Неподдерживаемые изменения статических локальных переменных**: Добавление или обновление локальной переменной или удаление статической локальной переменной, если это приведет к ошибке компиляции.  
  
 **Неподдерживаемые изменения универсальных типов**: Изменения универсального метода — его самого или его тела — не поддерживаются. Разрешено добавлять, удалять или изменять экземпляр универсального типа или вызовы существующих универсальных методов.  
...
## <a name="see-also"></a>См. также  
 [Практическое руководство. Применение изменений в режиме приостановки выполнения с помощью изменить и продолжить](../debugger/how-to-apply-edits-in-break-mode-with-edit-and-continue.md)   
