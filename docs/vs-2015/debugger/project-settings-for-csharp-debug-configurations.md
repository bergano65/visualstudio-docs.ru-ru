---
title: Параметры проекта для конфигураций отладки C# | Документация Майкрософт
ms.date: 11/15/2016
