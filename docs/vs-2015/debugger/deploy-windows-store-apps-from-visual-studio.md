---
title: Развертывание приложений Windows Store
ms.date: 11/15/2016
...
- На странице свойств "Отладка" для JavaScript установите для параметра **Разрешить замыкание на себя в локальной сети** значение **Нет**.
  ...
  **Не запускать, а отлаживать мой код при открытии (C# и VB) / запустить приложение (JavaScript и C++)** для настройки развертывания для автоматического запуска сеанса отладки при запуске приложения:
