...
## <a name="remarks"></a>Remarks  
 Если [перечисление локатионтипе](../../debugger/debug-interface-access/locationtype.md) символа равно `LocIsBitField` , то длина, возвращаемая этим методом, находится в битах; в противном случае длина задается в байтах для всех остальных типов расположения.  
