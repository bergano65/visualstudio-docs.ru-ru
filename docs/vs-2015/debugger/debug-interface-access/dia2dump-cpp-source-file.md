---
title: Исходный файл файла Dia2dump. cpp | Документация Майкрософт
ms.date: 11/15/2016
...
ms.locfileid: "68197602"
---
# <a name="dia2dumpcpp-source-file"></a>Файл исходного кода Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

В следующем исходном коде файла Dia2dump. cpp отображается содержимое PDB-файла. Этот исходный код используется [примером файла Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
