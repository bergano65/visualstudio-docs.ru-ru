---
title: Исходного кода Dia2dump.cpp | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47563855"
---
# <a name="dia2dumpcpp-source-file"></a>Файл исходного кода Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [исходного кода Dia2dump.cpp](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/dia2dump-cpp-source-file).  
  
Следующий исходный код Dia2dump.cpp отображает содержимое PDB-файл. Этот исходный код используется [пример файла Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
