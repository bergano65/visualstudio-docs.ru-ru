...
Получает флаг, указывающий ли в единице компиляции или функцию был скомпилирован с помощью проверок безопасности на переполнение буфера (например, [/GS (проверка безопасности буфера)](https://msdn.microsoft.com/library/8d8a5ea1-cd5e-42e1-bc36-66e1cd7e731e) переключатель компилятора).  
