...
ms.locfileid: "47573112"
---
# <a name="symbol-locations"></a>Местоположения символов
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [расположения символов](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/symbol-locations).  
