...
ms.locfileid: "47570743"
---
# <a name="cvhrege"></a>CV_HREG_e
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CV_HREG_e](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/cv-hreg-e).  
