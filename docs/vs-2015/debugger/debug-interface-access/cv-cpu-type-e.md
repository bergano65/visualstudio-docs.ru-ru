---
title: CV_CPU_TYPE_e | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47561388"
---
# <a name="cvcputypee"></a>CV_CPU_TYPE_e
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CV_CPU_TYPE_e](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/cv-cpu-type-e).  
