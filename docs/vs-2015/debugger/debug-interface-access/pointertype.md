...
ms.locfileid: "47573205"
---
# <a name="pointertype"></a>PointerType
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [PointerType](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/pointertype).  
