...
> [!NOTE]
> Символы будут возвращать значимые данные только для некоторых из этих методов в зависимости от типа символа. Если метод возвращает `S_OK` , то этот метод возвращал значимые данные.  
...
|[IDiaSymbol::findSymbolsForAcceleratorPointerTag](../../debugger/debug-interface-access/idiasymbol-findsymbolsforacceleratorpointertag.md)|Возвращает число тегов указателя ускорителя в функции-заглушке C++ AMP.|  
|[IDiaSymbol::get_acceleratorPointerTags](../../debugger/debug-interface-access/idiasymbol-get-acceleratorpointertags.md)|Возвращает все значения тегов указателя ускорителя, соответствующие функции-заглушке C++ AMP ускорителя.|  
...
|[IDiaSymbol::get_hasEH](../../debugger/debug-interface-access/idiasymbol-get-haseh.md)|Получает флаг, указывающий, имеет ли функция обработчик исключений в стиле C++.|  
...
|[IDiaSymbol::get_isAcceleratorGroupSharedLocal](../../debugger/debug-interface-access/idiasymbol-get-isacceleratorgroupsharedlocal.md)|Получает флаг, указывающий, соответствует ли символ общей локальной переменной группы в коде, скомпилированном для C++ AMP ускорителя.|  
|[IDiaSymbol::get_isAcceleratorPointerTagLiveRange](../../debugger/debug-interface-access/idiasymbol-get-isacceleratorpointertagliverange.md)|Получает флаг, указывающий, соответствует ли символ *символу диапазона определения* для компонента-тега в переменной-указателе в коде, скомпилированном для C++ amp ускорителя. Символ диапазона определения — это расположение переменной для диапазона адресов.|  
|[IDiaSymbol::get_isAcceleratorStubFunction](../../debugger/debug-interface-access/idiasymbol-get-isacceleratorstubfunction.md)|Указывает, соответствует ли символ символу функции верхнего уровня для шейдера, скомпилированного для ускорителя, соответствующего `parallel_for_each` вызову.|  
...
|[IDiaSymbol::get_isHotpatchable](../../debugger/debug-interface-access/idiasymbol-get-ishotpatchable.md)|Получает флаг, указывающий, был ли модуль скомпилирован с параметром компилятора [/hotpatch (Create допускающего оперативное обновление Image)](https://msdn.microsoft.com/library/aad539b6-c053-4c78-8682-853d98327798) .|  
...
|[IDiaSymbol::get_isMultipleInheritance](../../debugger/debug-interface-access/idiasymbol-get-ismultipleinheritance.md)|Указывает, `this` указывает ли указатель на элемент данных с множественным наследованием.|  
|[IDiaSymbol::get_isNaked](../../debugger/debug-interface-access/idiasymbol-get-isnaked.md)|Получает флаг, указывающий, имеет ли функция атрибут [naked](https://msdn.microsoft.com/library/69723241-05e1-439b-868e-20a83a16ab6d) .|  
...
|[IDiaSymbol::get_isPointerBasedOnSymbolValue](../../debugger/debug-interface-access/idiasymbol-get-ispointerbasedonsymbolvalue.md)|Указывает, `this` основан ли указатель на значении символа.|  
...
|[IDiaSymbol::get_isSingleInheritance](../../debugger/debug-interface-access/idiasymbol-get-issingleinheritance.md)|Указывает, `this` указывает ли указатель на элемент данных с одиночным наследованием.|  
...
|[IDiaSymbol::get_isVirtualInheritance](../../debugger/debug-interface-access/idiasymbol-get-isvirtualinheritance.md)|Указывает, `this` указывает ли указатель на элемент данных с виртуальным наследованием.|  
...
|[IDiaSymbol::get_noInline](../../debugger/debug-interface-access/idiasymbol-get-noinline.md)|Получает флаг, указывающий, помечена ли функция атрибутом [noinline](https://msdn.microsoft.com/library/f259d55b-dec7-4bde-8cf9-14521e4fdc42) .|  
|[IDiaSymbol::get_noReturn](../../debugger/debug-interface-access/idiasymbol-get-noreturn.md)|Получает флаг, указывающий, объявлена ли функция с атрибутом [noreturn](https://msdn.microsoft.com/library/9c6517e5-22d7-4051-9974-3d2200ae4d1d) .|  
...
|[IDiaSymbol::get_numberOfAcceleratorPointerTags](../../debugger/debug-interface-access/idiasymbol-get-numberofacceleratorpointertags.md)|Возвращает число тегов указателя ускорителя в функции-заглушке C++ AMP.|  
...
|[IDiaSymbol::get_oemId](../../debugger/debug-interface-access/idiasymbol-get-oemid.md)|Возвращает `oemId` значение символа.|  
|[IDiaSymbol::get_oemSymbolId](../../debugger/debug-interface-access/idiasymbol-get-oemsymbolid.md)|Возвращает `oemSymbolId` значение символа.|  
...
|[IDiaSymbol::get_restrictedType](../../debugger/debug-interface-access/idiasymbol-get-restrictedtype.md)|Указывает, `this` помечен ли указатель как ограниченный.|  
...
|[IDiaSymbol::get_thisAdjust](../../debugger/debug-interface-access/idiasymbol-get-thisadjust.md)|Извлекает логический элемент `this` настройки для метода.|  
...
|[IDiaSymbol::get_undecoratedName](../../debugger/debug-interface-access/idiasymbol-get-undecoratedname.md)|Возвращает недекорированное имя для декорированного (или) связывания C++ имени.|  
|[IDiaSymbol::get_undecoratedNameEx](../../debugger/debug-interface-access/idiasymbol-get-undecoratednameex.md)|Расширение `get_undecoratedName` метода, которое получает недекорированное имя на основе значения поля расширения.|  
