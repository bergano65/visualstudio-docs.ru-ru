...
ms.locfileid: "47570295"
---
# <a name="idiatable"></a>IDiaTable
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [IDiaTable](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiatable).  
