...
### [Лексическая иерархия символьных типов](lexical-hierarchy-of-symbol-types.md)
#### [Комментарий](annotation.md)
#### [Block](block.md)
#### [Compiland](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Custom (SDK для доступа к интерфейсу отладки)](custom-debug-interface-access-sdk.md)
#### [Data (SDK для доступа к интерфейсу отладки)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [Function (SDK для доступа к интерфейсу отладки)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [Label (SDK для доступа к интерфейсу отладки)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Thunk](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [Иерархия классов символьных типов](class-hierarchy-of-symbol-types.md)
#### [ArrayType](arraytype.md)
#### [BaseClass](baseclass.md)
#### [BaseType](basetype.md)
#### [CustomType](customtype.md)
#### [Измерение](dimension.md)
#### [Enum (SDK для доступа к интерфейсу отладки)](enum-debug-interface-access-sdk.md)
#### [Friend (SDK для доступа к интерфейсу отладки)](friend-debug-interface-access-sdk.md)
#### [FunctionArgType](functionargtype.md)
#### [FunctionType](functiontype.md)
#### [ManagedType](managedtype.md)
#### [PointerType](pointertype.md)
#### [Typedef (SDK для доступа к интерфейсу отладки)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [Ссылки](debug-interface-access-sdk-reference.md)
### [Интерфейсы (SDK для доступа к интерфейсу отладки)](interfaces-debug-interface-access-sdk.md)
...
### [Перечисления и структуры](enumerations-and-structures.md)
#### [Перечисление BasicType](basictype.md)
#### [Перечисление CV_access_e](cv-access-e.md)
#### [Перечисление CV_call_e](cv-call-e.md)
#### [Перечисление CV_CFL_LANG](cv-cfl-lang.md)
#### [Перечисление CV_CPU_TYPE_e](cv-cpu-type-e.md)
#### [Перечисление CV_HREG_e](cv-hreg-e.md)
#### [Перечисление DataKind](datakind.md)
#### [Структура DiaAddressMapEntry](diaaddressmapentry.md)
#### [Перечисление LocationType](locationtype.md)
#### [Перечисление MemoryTypeEnum](memorytypeenum.md)
#### [Перечисление NameSearchOptions](namesearchoptions.md)
#### [Перечисление StackFrameTypeEnum](stackframetypeenum.md)
#### [Перечисление SymTagEnum](symtagenum.md)
#### [Перечисление THUNK_ORDINAL](thunk-ordinal.md)
#### [Перечисление UdtKind](udtkind.md)
### [Константы (SDK для доступа к интерфейсу отладки)](constants-debug-interface-access-sdk.md)
## [Пример файла Dia2dump](dia2dump-sample.md)
## [Файл исходного кода Dia2dump.cpp](dia2dump-cpp-source-file.md)
