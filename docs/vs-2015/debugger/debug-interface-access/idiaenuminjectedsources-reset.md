...
ms.locfileid: "47562960"
---
# <a name="idiaenuminjectedsourcesreset"></a>IDiaEnumInjectedSources::Reset
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [IDiaEnumInjectedSources::Reset](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenuminjectedsources-reset).  
