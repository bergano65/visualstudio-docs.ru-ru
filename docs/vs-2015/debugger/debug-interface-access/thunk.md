...
ms.locfileid: "47570356"
---
# <a name="thunk"></a>Thunk
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [преобразователь](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/thunk).  
