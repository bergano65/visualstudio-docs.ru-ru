...
7.  **Шаг с заходом multiplyByA и изучение ее локальных переменных и переменных области видимости** пошагового выполнения остальной части `example4_a` и в строке `var x = multiplyByA(b);`.
