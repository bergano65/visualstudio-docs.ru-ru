...
ms.locfileid: "47560046"
---
# <a name="spy-reference"></a>Справочник по Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Справочник по Spy ++](https://docs.microsoft.com/visualstudio/debugger/spy-increment-reference).  
