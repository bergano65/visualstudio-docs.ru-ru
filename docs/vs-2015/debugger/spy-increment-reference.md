...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Используется для настройки шрифта символов, используемого в окне представлений Spy + +.  
 ...
 Используется для выбора сообщений, которые отображаются в представлении сообщений.  
 ...
 Используется для вывода сведений о программе Spy + +.  
