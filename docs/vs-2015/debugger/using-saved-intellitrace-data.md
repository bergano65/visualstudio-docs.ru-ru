...
ms.locfileid: "47569544"
---
# <a name="using-saved-intellitrace-data"></a>Использование сохраненных данных IntelliTrace
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [использование сохраненных данных IntelliTrace](https://docs.microsoft.com/visualstudio/debugger/using-saved-intellitrace-data).  
