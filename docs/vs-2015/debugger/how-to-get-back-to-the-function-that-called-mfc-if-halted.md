...
Последнюю версию этого раздела можно найти в [как: вернуться к функции, вызывается MFC при прерывании работы](https://docs.microsoft.com/visualstudio/debugger/how-to-get-back-to-the-function-that-called-mfc-if-halted).  
