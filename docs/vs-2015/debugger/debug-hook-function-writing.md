...
ms.locfileid: "47573269"
---
# <a name="debug-hook-function-writing"></a>Написание функций отладочных ловушек
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [написание функций отладочных ловушек](https://docs.microsoft.com/visualstudio/debugger/debug-hook-function-writing).  
