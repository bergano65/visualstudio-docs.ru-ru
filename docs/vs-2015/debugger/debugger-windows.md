...
|Auto (Автоматически)|CTRL+ALT+V, A|[Окна переменных](https://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e)|  
...
|Потоки|CTRL+ALT+H|[Как использовать окно "потоки"](../debugger/how-to-use-the-threads-window.md)|  
