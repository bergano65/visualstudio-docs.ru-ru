---
title: Отладчика Windows | Документация Майкрософт
ms.custom: ''
ms.date: 11/15/2016
...
|Авто|CTRL+ALT+V, A|[Переменной Windows](http://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e)|  
|Локальные|CTRL+ALT+V, L|[Переменной Windows](http://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e)|  
