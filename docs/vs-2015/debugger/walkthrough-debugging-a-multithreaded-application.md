...
11. На **Отладка** последовательно выберите пункты **Windows** и нажмите кнопку **потоков**.  
...
9. В окне исходного кода щелкните правой кнопкой мыши маркер потока. В контекстном меню пункты **переключиться в режим** и щелкните имя/идентификатор потока.  
     ...
     С помощью индикатора потока можно переключаться только на потоки, остановленные в этом конкретном расположении. С помощью **потоков** окна и **место отладки** панели инструментов, можно переключиться на любой поток.  
