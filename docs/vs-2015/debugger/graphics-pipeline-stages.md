...
ms.locfileid: "47558657"
---
# <a name="graphics-pipeline-stages"></a>Этапы графического конвейера
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [этапы графического конвейера](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-pipeline-stages).  
