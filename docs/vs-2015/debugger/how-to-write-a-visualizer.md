...
ms.locfileid: "47572686"
---
# <a name="how-to-write-a-visualizer"></a>Практическое руководство. Написание визуализатора
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: Написание визуализатора на](https://docs.microsoft.com/visualstudio/debugger/how-to-write-a-visualizer).  
