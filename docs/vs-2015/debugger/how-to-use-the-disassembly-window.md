---
title: Как использовать окно дизассемблирования | Документация Майкрософт
ms.date: 11/15/2016
...
Эта функция доступна только в том случае, если включена отладка на уровне адреса в диалоговом окне **Параметры** , узел **Отладка** . Она недоступна для отладки скриптов и SQL.  
...
- В меню **Отладка** выберите пункт **окна**и щелкните **Дизассемблированный код**.  
...
- Щелкните правой кнопкой мыши окно **дизассемблирования** и установите или снимите нужные параметры в контекстном меню.  
     ...
     Дополнительные сведения см. [в разделе разбиение по страницам в памяти](../debugger/how-to-page-up-or-down-in-memory.md).  
