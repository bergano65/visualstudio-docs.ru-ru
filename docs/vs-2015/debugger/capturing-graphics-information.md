...
- В строке меню выберите **Отладка**, **Графика**, **Начать диагностику**. (Клавиатура: Нажмите сочетание клавиш ALT+F5).  
...
- В Visual Studio на панели инструментов **графика** нажмите кнопку **захвата кадров** ![значок записи графики](../debugger/media/debuggingdirectxgraphics.png "DebuggingDirectXGraphics").  
...
- В интерфейсе записи Visual Studio нажмите кнопку **кадр записи** , расположенную над временной шкалой **диагностического сеанса** , или нажмите кнопку большой **фрагмент кадра захвата** , расположенную под **кадрами в секунду** дорожки-Lane и справа от всех ранее записанных кадров. Обе кнопки выделены на рисунке ниже.  
  
   ![Захват кадров с помощью средства использования GPU.](../debugger/media/pix-gpu-usage-tool-capture-frame.png "pix_gpu_usage_tool_capture_frame")  
  
   Когда вы будете готовы изучить захваченные кадры, запустите **анализатор графики Visual Studio** , следуя этому **кадру...** Щелкните ссылку над эскизами изображений или дважды щелкните эскиз.  
...
## <a name="capturing-graphics-information-remotely"></a>Удаленный захват графической информации  
 ...
 Настройка проекта для удаленной отладки зависит от типа разрабатываемого приложения и используемого языка программирования. Сведения о настройке удаленной отладки для приложения Магазина Windows см. в статье [Запуск приложений Магазина Windows на удаленном компьютере](../debugger/run-windows-store-apps-on-a-remote-machine.md). Сведения о настройке удаленной отладки для классического приложения Windows см. в разделе [Настройка удаленной отладки для проекта Visual Studio](https://msdn.microsoft.com/library/ec332dc4-400a-498b-a0e6-c8dcf10fef8a).  
