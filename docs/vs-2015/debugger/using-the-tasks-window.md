...
**Задачи** напоминает окно **потоков** окна, за исключением того, что он отображается информация о <xref:System.Threading.Tasks.Task?displayProperty=fullName>, [task_handle](http://msdn.microsoft.com/library/b4af5b28-227d-4488-8194-0a0d039173b7), или [WinJS.Promise ](http://msdn.microsoft.com/library/windows/apps/br211867.aspx) объектов, а не каждый поток. Как и потоки, задачи представляют асинхронные операции, которые могут выполняться параллельно; однако несколько задач могут выполняться в одном потоке. См. в разделе [асинхронное программирование в JavaScript (приложения Windows Store)](http://msdn.microsoft.com/library/windows/apps/hh700330.aspx) Дополнительные сведения.  
 ...
 В машинном коде, можно использовать **задачи** окно при работе с [группы задач](http://msdn.microsoft.com/library/42f05ac3-2098-494a-ba84-737fcdcad077), [параллельные алгоритмы](http://msdn.microsoft.com/library/045dca7b-4d73-4558-a44c-383b88a28473), [асинхронных агентов](http://msdn.microsoft.com/library/6cf6ccc6-87f1-4e14-af15-ea8ba58fef1a), и [упрощенных задач](http://msdn.microsoft.com/library/9aba278c-e0c9-4ede-b7c6-fedf7a365d90). Дополнительные сведения о задачах в машинном коде, см. в разделе [среда выполнения с параллелизмом](http://msdn.microsoft.com/library/874bc58f-8dce-483e-a3a1-4dcc9e52ed2c).  
...
|**task_group**|Для машинного кода, адрес [task_group](http://msdn.microsoft.com/library/b4af5b28-227d-4488-8194-0a0d039173b7) объект, который запланировал задачу. Для асинхронных агентов и упрощенных задач этот столбец содержит значение 0.|  
