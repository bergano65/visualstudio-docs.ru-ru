...
В этом пошаговом руководстве демонстрируется использование [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] средств диагностики графики, чтобы исследовать объект, который отсутствует из-за ошибки, которая происходит на этапе шейдера вершин.  
