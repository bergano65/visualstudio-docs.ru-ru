...
## <a name="BKMK_ViewingLINQResults"></a> Просмотр результатов оператора LINQ  
 ...
 В LINQ запрос вычисляется не при его создании или объявлении, а только при использовании. Таким образом, запросу не присваивается значение до тех пор, пока оно не будет вычислено. Полное описание создания и вычисления запросов см. в разделе [введение в запросы LINQ (C#)](https://msdn.microsoft.com/library/37895c02-268c-41d5-be39-f7d936fa88a8) или [Your первого запроса LINQ записи](https://msdn.microsoft.com/library/4affb732-3e9b-4479-aa31-1f9bd8183cbe).  
