...
- Приложение, вызывающее DLL-библиотеку, написано в машинном коде. В этом случае DLL-библиотека является управляемой, и для отладки должны быть включены оба отладчика — управляемый и машинного кода. Это можно проверить в диалоговом окне ** \<Project> страницы свойств** . Способ выполнения этой операции зависит от того, откуда была запущена отладка: из проекта DLL или из проекта вызывающего приложения.  
...
3. В диалоговом окне ** \<Project> страницы свойств** разверните узел **Свойства конфигурации** и выберите **Отладка**.  
