...
Последнюю версию этого раздела можно найти в [как: Открытие представления сообщений из окна поиска](https://docs.microsoft.com/visualstudio/debugger/how-to-open-messages-view-from-find-window).  
