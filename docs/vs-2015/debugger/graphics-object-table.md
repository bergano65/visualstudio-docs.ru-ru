...
Таблица графических объектов в компоненте анализа графики Visual Studio помогает разобраться в работе объектов Direct3D, которые поддерживают кадр вашей игры или вашего приложения.  
 ...
 ![Объекты Direct3D, созданные приложением.](../debugger/media/gfx-diag-demo-object-table-orientation.png "gfx_diag_demo_object_table_orientation")  
...
## <a name="graphics-object-viewers"></a>Средства просмотра объектов графики  
 ...
 ![Предварительная версия текстуры, отображающая слияние выходных данных](../debugger/media/gfx-diag-texture-preview.png "gfx_diag_texture_preview")  
