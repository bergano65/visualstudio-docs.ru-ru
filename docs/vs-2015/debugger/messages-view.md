...
ms.locfileid: "47571272"
---
# <a name="messages-view"></a>Представление сообщений
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представления сообщений](https://docs.microsoft.com/visualstudio/debugger/messages-view).  
