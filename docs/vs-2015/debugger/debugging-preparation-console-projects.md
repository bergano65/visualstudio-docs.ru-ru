...
ms.locfileid: "47558648"
---
# <a name="debugging-preparation-console-projects"></a>Подготовка к отладке: консольные проекты
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Подготовка к отладке: консольные проекты](https://docs.microsoft.com/visualstudio/debugger/debugging-preparation-console-projects).  
