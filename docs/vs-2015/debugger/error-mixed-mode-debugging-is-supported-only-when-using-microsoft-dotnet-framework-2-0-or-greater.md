...
Чтобы выполнить отладку смешанного собственного и управляемого кода, необходимо наличие [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] версии 2.0, 3.0., 3.5 или 4. Отладка в смешанном режиме не поддерживается в более ранних версиях [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)].  
  
### <a name="to-correct-this-error"></a>Исправление ошибки  
  
- Обновите [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] до версии 2.0, 3.0, 3.5 или 4.  
