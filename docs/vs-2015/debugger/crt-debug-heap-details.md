...
ms.locfileid: "47558445"
---
# <a name="crt-debug-heap-details"></a>Сведения о куче отладки CRT
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [сведения о куче отладки CRT](https://docs.microsoft.com/visualstudio/debugger/crt-debug-heap-details).  
