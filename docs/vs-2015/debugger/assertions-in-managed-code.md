...
## <a name="see-also"></a>См. также:  
 ...
 [Практические руководства. Условная компиляция с помощью Trace и Debug](https://msdn.microsoft.com/library/56d051c3-012c-42c1-9a58-7270edc624aa)   
