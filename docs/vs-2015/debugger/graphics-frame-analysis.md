...
|**Точечная фильтрация текстур**|Для всех соответствующих образцов текстур устанавливается режим фильтрации `DXD11_FILTER_MIN_MAG_MIP_POINT` (точечная фильтрация текстур).<br /><br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Texture Filtering Variants](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md).|  
|**Билинейная фильтрация текстур**|Для всех соответствующих образцов текстур устанавливается режим фильтрации `DXD11_FILTER_MIN_MAG_LINEAR_MIP_POINT` (билинейная фильтрация текстур).<br /><br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Texture Filtering Variants](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md).|  
|**Трилинейная фильтрация текстур**|Для всех соответствующих образцов текстур устанавливается режим фильтрации `DXD11_FILTER_MIN_MAG_MIP_LINEAR` (трилинейная фильтрация текстур).<br /><br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Texture Filtering Variants](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md).|  
|**Анизотропная фильтрация текстур**|Для всех соответствующих образцов текстур устанавливается режим фильтрации `DXD11_FILTER_ANISOTROPIC`, а свойству `MaxAnisotropy` присваивается значение `16` (16-кратная анизотропная фильтрация текстур).<br /><br /> For more information, see [Point, Bilinear, Trilinear, and Anisotropic Texture Filtering Variants](../debugger/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants.md).|  
