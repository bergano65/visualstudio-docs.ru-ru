...
## <a name="using-frame-analysis"></a>Использование анализа кадров  
 ...
 ![Перейдите на вкладку «Анализ кадров».](../debugger/media/pix-frame-analysis-select-tab.png "pix_frame_analysis_select_tab")  
...
#### <a name="timeline"></a>Временная шкала  
 ...
 ![На временной шкале&#45;отображаются затраты на вызов Draw.](../debugger/media/pix-frame-analysis-timeline.png "pix_frame_analysis_timeline")  
...
#### <a name="table"></a>Таблица  
 ...
 ![В сводной таблице показаны различные варианты.](../debugger/media/pix-frame-analysis-summary.png "pix_frame_analysis_summary")  
...
#### <a name="hot-draw-calls"></a>"Горячие" вызовы Draw  
 ...
 ![Этот вызов Дравиндексед имеет горячий и холодный варианты.](../debugger/media/pix-frame-analysis-hot-calls.png "pix_frame_analysis_hot_calls")  
...
#### <a name="statistical-significance"></a>Статистическая значимость  
 ...
 ![Статистическая релевантность варианта вызова Draw](../debugger/media/pix-frame-analysis-summary-stats.png "pix_frame_analysis_summary_stats")  
...
#### <a name="platforms-that-do-not-support-hardware-counters"></a>Платформы, не поддерживающие аппаратные счетчики  
 ...
 ![Таблица сведений и некоторые варианты воспроизведения.](../debugger/media/pix-frame-analysis-details.png "pix_frame_analysis_details")  
...
#### <a name="platforms-that-support-hardware-counters"></a>Платформы, поддерживающие аппаратные счетчики  
 ...
 ![Аппаратные счетчики отображаются, если они поддерживаются.](../debugger/media/pix-frame.png "pix_frame")  
...
|**0x MSAA**|Многовыборочное сглаживание (MSAA) отключается для всех целевых объектов отрисовки.<br /><br /> Дополнительные сведения см. в разделе [Варианты 0x/2x/4x MSAA](../debugger/0x-2x-4x-msaa-variants.md)|  
|**2x MSAA**|Двукратное многовыборочное сглаживание (MSAA) включается для всех целевых объектов отрисовки.<br /><br /> Дополнительные сведения см. в разделе [Варианты 0x/2x/4x MSAA](../debugger/0x-2x-4x-msaa-variants.md)|  
|**4x MSAA**|Четырехкратное многовыборочное сглаживание (MSAA) включается для всех целевых объектов отрисовки.<br /><br /> Дополнительные сведения см. в разделе [Варианты 0x/2x/4x MSAA](../debugger/0x-2x-4x-msaa-variants.md)|  
