...
## <a name="using-frame-analysis"></a>Использование анализа кадров  
 ...
 ![Перейдите на вкладку "Анализ кадра".](../debugger/media/pix-frame-analysis-select-tab.png "pix_frame_analysis_select_tab")  
...
#### <a name="timeline"></a>Временная шкала  
 ...
 ![Временная шкала с отображением затрат на вызов Draw.](../debugger/media/pix-frame-analysis-timeline.png "pix_frame_analysis_timeline")  
...
#### <a name="table"></a>Таблица  
 ...
 ![Сводная таблица с отображением различных вариантов.](../debugger/media/pix-frame-analysis-summary.png "pix_frame_analysis_summary")  
...
#### <a name="hot-draw-calls"></a>"Горячие" вызовы Draw  
 ...
 ![Этот вызов DrawIndexed имеет активные и пассивные варианты.](../debugger/media/pix-frame-analysis-hot-calls.png "pix_frame_analysis_hot_calls")  
...
#### <a name="platforms-that-support-hardware-counters"></a>Платформы, поддерживающие аппаратные счетчики  
 ...
 ![Если счетчики оборудования поддерживаются, они отображаются.](../debugger/media/pix-frame.png "pix_frame")  
