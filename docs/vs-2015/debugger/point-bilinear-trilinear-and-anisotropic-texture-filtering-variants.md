...
Последнюю версию этого раздела можно найти в [точки, билинейной, Трилинейной и текстуры анизотропной фильтрации](https://docs.microsoft.com/visualstudio/debugger/graphics/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants).  
