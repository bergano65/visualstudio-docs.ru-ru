...
ms.locfileid: "47572957"
---
# <a name="property-pages-settings-for-web-projects"></a>Параметры страниц свойств для веб-проектов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [параметры страниц свойств для веб-проектов](https://docs.microsoft.com/visualstudio/debugger/property-pages-settings-for-web-projects).  
