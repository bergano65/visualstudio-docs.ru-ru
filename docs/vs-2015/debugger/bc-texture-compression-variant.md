...
ms.locfileid: "47568271"
---
# <a name="bc-texture-compression-variant"></a>Вариант сжатия текстур BC
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [вариант сжатия текстур BC](https://docs.microsoft.com/visualstudio/debugger/graphics/bc-texture-compression-variant).  
