...
ms.locfileid: "47558186"
---
# <a name="graphics-event-list"></a>Список событий графики
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [список событий графики](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-event-list).  
