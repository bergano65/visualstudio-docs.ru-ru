...
ms.locfileid: "47563459"
---
# <a name="pseudovariables"></a>Псевдопеременные
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [псевдопеременные](https://docs.microsoft.com/visualstudio/debugger/pseudovariables).  
...
|`$dynamic`|Отображает специальный **динамическое представление** узел для объекта, реализующего `IDynamicMetaObjectProvider`. Интерфейс. Синтаксис `$dynamic,` *объект*. Эта возможность применима только к коду, который использует платформу .NET Framework 4. См. в разделе [динамическое представление](http://msdn.microsoft.com/library/4c851b17-2c12-46a0-9828-eb6ea6f5c563).|  
