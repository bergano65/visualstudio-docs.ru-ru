...
ms.locfileid: "47563528"
---
# <a name="graphics-pixel-history"></a>Журнал пикселей графики
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [журнал пикселей графики](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-pixel-history).  
