...
- В верхней части документа журнала графики выберите нужный пиксель в целевом объекте отрисовки. Выбрав пиксель, вы можете просмотреть подробные сведения о нем в окне **Журнал пикселей графики**. См. сведения см. о [журнале пикселей](../debugger/graphics-pixel-history.md).  
...
## <a name="playback-machine"></a>Компьютер воспроизведения  
 ...
 См. сведения по определению компьютера воспроизведения в руководстве по [ изменить компьютер воспроизведения диагностики графики](../debugger/how-to-change-the-graphics-diagnostics-playback-machine.md).  
