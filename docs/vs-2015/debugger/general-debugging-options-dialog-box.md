...
ms.locfileid: "47570916"
---
# <a name="general-debugging-options-dialog-box"></a>Страница "Общие", папка "Отладка", диалоговое окно "Параметры"
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [General, Debugging, диалоговое окно параметров](https://docs.microsoft.com/visualstudio/debugger/general-debugging-options-dialog-box).  
 ...
 **Прерывать выполнение, когда исключения пересекают границу AppDomain или управляемым и машинным кодом**  
 ...
 2\) когда управляемый код, выполняемый в домене приложения 1 вызывает управляемый код домена приложения 2, и код домена приложения 2 создает исключение. См. в разделе [программирование с использованием доменов приложений](http://msdn.microsoft.com/en-us/bd36055b-56bd-43eb-b4d8-820c37172131).  
 ...
 **Средства диагностики** окно отображается при отладке. Дополнительные сведения см. в разделе [интегрированные в отладчик профилирование](http://msdn.microsoft.com/library/a1f40370-7b61-42c2-afc4-0e13eba98859).  
