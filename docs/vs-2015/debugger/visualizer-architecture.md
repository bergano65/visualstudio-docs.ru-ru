...
ms.locfileid: "47568190"
---
# <a name="visualizer-architecture"></a>Архитектура визуализатора
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [архитектура визуализатора](https://docs.microsoft.com/visualstudio/debugger/visualizer-architecture).  
