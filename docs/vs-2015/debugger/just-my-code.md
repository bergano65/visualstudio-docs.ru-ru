...
|Элемент|Описание|  
|-------------|-----------------|  
|Компонент|Обязательный. Указывает одну или несколько функций как функцию, не написанную пользователем.|  
...
|**Libraries**|Массив URL-адресов или файлов, которые классифицируются как **LibraryCode**.|  
