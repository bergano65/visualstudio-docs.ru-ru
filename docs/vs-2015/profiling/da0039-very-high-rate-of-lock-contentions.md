...
ms.locfileid: "58355461"
---
# <a name="da0039-very-high-rate-of-lock-contentions"></a>DA0039. Очень большое число конфликтов при блокировке
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Самая актуальная документация по Visual Studio, см. в разделе [DA0039: очень большое из при блокировке](https://docs.microsoft.com/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions) на сайте docs.microsoft.com.  
