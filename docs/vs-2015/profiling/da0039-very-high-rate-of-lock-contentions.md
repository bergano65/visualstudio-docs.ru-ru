...
ms.locfileid: "85544928"
---
# <a name="da0039-very-high-rate-of-lock-contentions"></a>DA0039. Очень большое число конфликтов при блокировке
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю документацию по Visual Studio см. в разделе [DA0039: очень высокая доля конфликтов блокировок](/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions).  
...
> [!NOTE]
> Когда частота обнаруженных конфликтов блокировки в данных профилирования значительна, но не слишком велика, вместо этого сообщения выдается сообщение [DA0038: высокая частота конфликтов блокировки](../profiling/da0038-high-rate-of-lock-contentions.md) .  
