---
title: Правила производительности по идентификаторам | Документы Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47559350"
---
# <a name="performance-rules-by-id"></a>Правила производительности по идентификаторам
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [правила производительности по Идентификаторам](https://docs.microsoft.com/visualstudio/profiling/performance-rules-by-id).  
...
|[DA0004: потребление значительных ресурсов процессора](../profiling/da0004-high-processor-usage.md)|В данных профилирования, собранных с использованием метода инструментирования, была обнаружена значительная загрузка процессора. Рекомендуется использовать метод профилирования с помощью выборки при профилировании приложений, сильно загружающих процессор.|  
|[DA0005: частые коллекции GC2](../profiling/da0005-frequent-gc2-collections.md)|Большое число объектов памяти .NET освобождается при сборке мусора поколения 2.|  
...
|[DA0009. Большой % времени в JIT](http://msdn.microsoft.com/en-us/b60c1767-515c-41d9-81c2-c70d0b7024fd)|Значительная доля времени выполнения приложения была потрачена в JIT-компиляторе.|  
...
|[DA0011: затратное CompareTo](../profiling/da0011-expensive-compareto.md)|Метод CompareTo типа является затратным или выделяет память.|  
...
|[DA0024. Избыточное время ЦП ГК](../profiling/da0024-excessive-gc-cpu-time.md)|Данные о производительности системы, собранные во время профилирования указывают, что время, затраченное на сборку мусора, слишком велико по сравнению с общим временем обработки приложения.|  
