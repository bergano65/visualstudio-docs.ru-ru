...
ms.locfileid: "47559214"
---
# <a name="da0024-excessive-gc-cpu-time"></a>DA0024. Избыточное время ЦП ГК
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [DA0024: слишком много времени ЦПУ GC](https://docs.microsoft.com/visualstudio/profiling/da0024-excessive-gc-cpu-time).  
