...
Последнюю версию этого раздела можно найти в [DA0018: 32-битное приложение выполняется процесс с ограничениями управляемой памяти](https://docs.microsoft.com/visualstudio/profiling/da0018-32-bit-application-running-at-process-managed-memory-limits).  
  
ИД правила | DA0018 |  
| Категория | Использование средств профилирования |  
| Метод профилирования | Выборка |  
| Сообщение | Распределения управляемой памяти приближается лимит по умолчанию для 32-разрядном процессе. Приложение может быть привязанной к памяти. |  
...
-   Сокращение архитектурных ограничений на максимальный размер виртуальной памяти для 32-разрядных процессов.  
 ...
 Дополнительные сведения о повышении производительности сборки мусора см. в технической статье по .NET Framework на веб-сайте MSDN [Сведения о повышении производительности сборки мусора](http://go.microsoft.com/fwlink/?LinkId=177946).  
