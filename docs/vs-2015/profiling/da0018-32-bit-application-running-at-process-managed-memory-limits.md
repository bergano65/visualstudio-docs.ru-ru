...
- Сокращение архитектурных ограничений на максимальный размер виртуальной памяти для 32-разрядных процессов.  
  ...
  Чтобы оптимизировать использование приложением ресурсов управляемой памяти, собирайте данные о выделении управляемой памяти в сеансе профилирования выделения памяти .NET. Ознакомьтесь с отчетами [представления данных в памяти .NET](../profiling/dotnet-memory-data-views.md) , чтобы понять схему выделения памяти приложением.  
  
  Используйте [представление "время существования объекта](../profiling/object-lifetime-view.md) ", чтобы определить, какие из объектов данных программы остаются в поколении, а затем освобождаются от него.  
  ...
  Дополнительные сведения о повышении производительности сборки мусора см. в технической статье по .NET Framework на веб-сайте MSDN [Сведения о повышении производительности сборки мусора](https://msdn.microsoft.com/library/ms973837.aspx).  
