...
| Сообщение |% времени в GC достаточно велико. Это сообщение говорит о том, что чрезмерные затраты времени на сборку мусора могут повлиять на скорость отклика приложения. Чтобы лучше понимать схему выделения памяти, используемую вашим приложением, вы можете собрать данные о распределении памяти .NET и сведения о времени жизни объекта.|  
| Тип правила | Информационные |  
