...
ms.locfileid: "47561464"
---
# <a name="da0023-high-gc-cpu-time"></a>DA0023. Высокое время ЦП ГК
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [DA0023: высокое время ЦП ГК](https://docs.microsoft.com/visualstudio/profiling/da0023-high-gc-cpu-time).  
  
ИД правила | DA0023 |  
| Категория |. Использование .NET Framework |  
| Метод профилирования | Все |  
| Сообщение | % времени сборщика Мусора довольно велик. Это сообщение говорит о том, что чрезмерные затраты времени на сборку мусора могут повлиять на скорость отклика приложения. Можно собирать .NET памяти распределения данных и объект сведения о времени жизни для лучшего понимания схемы выделения памяти, используемой приложением, лучше. |  
