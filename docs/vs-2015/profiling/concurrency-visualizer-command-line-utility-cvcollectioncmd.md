...
|------------|-----------------|----------------|-------------------|  
|query|Указывает, можно ли начать сбор данных.|Отсутствуют|Значение 0, если можно начать сбор данных.<br /><br /> Значение 1, если сбор данных уже выполняется.<br /><br /> 2, если коллекция не выполняется, но один или несколько необходимых сеансов [ETW](https://msdn.microsoft.com/library/ac99a063-e2d2-40cc-b659-d23c2f783f92) уже включены.|  
