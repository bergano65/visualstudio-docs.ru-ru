...
Последнюю версию этого раздела можно найти в [служебной программы визуализатор параллелизма командной строки (CVCollectionCmd)](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-command-line-utility-cvcollectioncmd).  
...
|------------|-----------------|----------------|-------------------|  
|Запрос|Указывает, можно ли начать сбор данных.|Нет|Значение 0, если можно начать сбор данных.<br /><br /> Значение 1, если сбор данных уже выполняется.<br /><br /> Значение 2, если сбор данных не выполняется, но один или несколько требуемых сеансов [ETW](http://msdn.microsoft.com/library/ac99a063-e2d2-40cc-b659-d23c2f783f92) уже активированы.|  
...
|SymbolPath|Указывает путь к серверу символов. Более подробную информацию см. в разделе [Получение файлов символов отладки с сервера символов Microsoft](http://go.microsoft.com/fwlink/?LinkID=149389).|Имя каталога или URL-адрес.|  
