...
|SymbolPath|Указывает путь к серверу символов. Более подробную информацию см. в разделе [Получение файлов символов отладки с сервера символов Microsoft](https://go.microsoft.com/fwlink/?LinkID=149389).|Имя каталога или URL-адрес.|  
