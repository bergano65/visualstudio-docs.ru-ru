...
| Сообщение | Сбор измерений взаимодействия для многоуровневых приложений поможет понять закономерности использования баз данных и ключевые задержки доступа к данным. Попробуйте еще раз выполнить профилирование приложения, включив параметр профилирования взаимодействия уровней.|  
