...
## <a name="rule-description"></a>Описание правила  
 ...
 Дополнительные сведения см. в подразделе [Управление исключениями](https://msdn.microsoft.com/library/ms998547.aspx#scalenetchapt05_topic24) раздела **Глава 5. Улучшение производительности управляемого кода** в томе **Повышение производительности и масштабируемости приложений .NET** библиотеки **Шаблоны и практические рекомендации Майкрософт** на веб-сайте MSDN.  
