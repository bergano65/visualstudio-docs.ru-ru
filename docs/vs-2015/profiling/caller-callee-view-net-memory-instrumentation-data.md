...
Последнюю версию этого раздела можно найти в [представление "Вызывающий-вызываемый" — данные инструментирования памяти NET](https://docs.microsoft.com/visualstudio/profiling/caller-callee-view-net-memory-instrumentation-data).  
