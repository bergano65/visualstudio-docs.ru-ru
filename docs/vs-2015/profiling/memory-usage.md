...
ms.locfileid: "47561953"
---
# <a name="memory-usage"></a>Использование памяти
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [анализ использования памяти в Visual Studio](https://docs.microsoft.com/visualstudio/profiling/memory-usage).  
