...
### <a name="BKMK_CPU_utilization_timeline_graph"></a> График зависимости загрузки ЦП от времени  
 ![График &#40;график&#41; % временной шкалы](../profiling/media/cpu-use-wt-timelinegraph.png "CPU_USE_WT_TimelineGraph")  
...
#### <a name="BKMK_Select_timeline_segments_to_view_details"></a> Выбор сегментов временной шкалы для просмотра подробных сведений  
 ...
 ![Дерево&#95;щелкните выбранное](../profiling/media/cpu-use-wt-getmaxnumberreport.png "CPU_USE_WT_GetMaxNumberReport")  
...
## <a name="BKMK_Next_steps"></a> Следующие шаги  
