---
title: Как выполнить Присоединение Profiler к службе .NET для сбора данных о параллелизме при помощи командной строки | Документация Майкрософт
ms.date: 11/15/2016
