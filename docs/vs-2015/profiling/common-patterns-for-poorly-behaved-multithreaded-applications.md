...
## <a name="oversubscription"></a>Превышение лимита подписки  
 ![Превышение лимита подписки](../profiling/media/oversubscription.png "Превышение лимита подписки")  
...
## <a name="inefficient-io"></a>Неэффективный ввод-вывод  
 ![Неэффективное&#47;O](../profiling/media/inefficient-io.png "Inefficient_IO")  
