...
Последнюю версию этого раздела можно найти в [Общие шаблоны для многопоточных приложений Poorly-Behaved](https://docs.microsoft.com/visualstudio/profiling/common-patterns-for-poorly-behaved-multithreaded-applications).  
