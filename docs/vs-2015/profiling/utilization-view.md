...
ms.locfileid: "47564190"
---
# <a name="utilization-view"></a>Представление использования
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представление "использование"](https://docs.microsoft.com/visualstudio/profiling/utilization-view).  
