...
ms.locfileid: "47560654"
---
# <a name="export-button-concurrency-visualizer"></a>Кнопка экспорта (визуализатор параллелизма)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [кнопка экспорта (визуализатор параллелизма)](https://docs.microsoft.com/visualstudio/profiling/export-button-concurrency-visualizer).  
