...
## <a name="run-the-html-ui-responsiveness-tool"></a><a name="RunningProfiler"></a> Запуск средства скорости реагирования ИП HTML  
...
## <a name="isolate-an-issue"></a><a name="IsolateAnIssue"></a> Локализация проблемы  
...
### <a name="isolate-a-ui-responsiveness-problem"></a><a name="Workflow"></a> Локализация проблемы скорости реагирования ИП  
...
## <a name="analyze-data"></a><a name="AnalyzeData"></a> Анализ данных  
...
### <a name="filter-events"></a><a name="FilterEvents"></a> Фильтрация событий  
...
## <a name="save-a-diagnostic-session"></a><a name="SaveSession"></a> Сохранение диагностического сеанса  
...
## <a name="additional-information"></a><a name="Tips"></a> Дополнительные сведения  
...
- Сведения о модели и производительности однопотокового выполнения кода см. в разделе [Выполнение кода](https://msdn.microsoft.com/library/windows/apps/hh781217.aspx).  
