...
|----------|---------------------|  
|**Профилирование службы .NET**|-   [Руководство. Инструментирование службы .NET и получение подробных сведений о времени](../profiling/how-to-instrument-a-dotnet-service-and-collect-detailed-timing-data-by-using-the-profiler-command-line.md)|  
...
|**Профилирование службы C/C++**|-   [Руководство. инструментирование собственной службы и получение подробных сведений о времени](../profiling/how-to-instrument-a-native-service-and-collect-detailed-timing-data-by-using-the-profiler-command-line.md)|  
