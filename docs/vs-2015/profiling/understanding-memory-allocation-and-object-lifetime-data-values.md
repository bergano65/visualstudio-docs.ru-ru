...
Последнюю версию этого раздела можно найти в [основные сведения о выделении памяти и времени существования данных объекта](https://docs.microsoft.com/visualstudio/profiling/understanding-memory-allocation-and-object-lifetime-data-values).  
