...
ms.locfileid: "47570852"
---
# <a name="channels-threads-view"></a>Каналы (представление "Потоки")
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [каналы (представление "Потоки")](https://docs.microsoft.com/visualstudio/profiling/channels-threads-view).  
