...
ms.locfileid: "47558934"
---
# <a name="resource-details-view---contention-data"></a>Представление "Сведения о ресурсах" — сведения о состязаниях
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представление Resource Details - данные о конфликтах](https://docs.microsoft.com/visualstudio/profiling/resource-details-view-contention-data).  
