...
ms.locfileid: "47558192"
---
# <a name="modules-view---contention-data"></a>Представление "Модули" — данные по состязаниям
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представление "Модули" — данные о конфликтах](https://docs.microsoft.com/visualstudio/profiling/modules-view-contention-data).  
