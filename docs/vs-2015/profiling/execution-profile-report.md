...
ms.locfileid: "47563770"
---
# <a name="execution-profile-report"></a>Выполнение отчета профилирования
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [выполнение отчета профилирования](https://docs.microsoft.com/visualstudio/profiling/execution-profile-report).  
