...
15. Откройте объект HTMLDivElement вверху дерева объектов, как показано здесь.  
     ...
     ![Представление различий в числе объектов в куче](../profiling/media/js-mem-app-typesdiff.png "JS_Mem_App_TypesDiff")  
...
## <a name="fixing-the-memory-issue"></a><a name="FixingMemory"></a> Исправления проблемы памяти  
