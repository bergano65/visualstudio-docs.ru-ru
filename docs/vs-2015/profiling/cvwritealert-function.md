...
ms.locfileid: "47563864"
---
# <a name="cvwritealert-function"></a>Функция CvWriteAlert
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [функция CvWriteAlert](https://docs.microsoft.com/visualstudio/profiling/cvwritealert-function).  
