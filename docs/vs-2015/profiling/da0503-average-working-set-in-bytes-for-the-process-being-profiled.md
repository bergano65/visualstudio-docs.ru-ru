...
|Message|This information was gathered for information only. Счетчик рабочего набора процесса измеряет объем использования физической памяти профилируемым процессом. Полученное значение является средним значением, вычисленным в течение всех интервалов измерения.|  
