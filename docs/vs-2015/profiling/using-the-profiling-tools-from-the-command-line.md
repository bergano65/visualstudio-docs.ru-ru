...
|Задача|См. также|  
|----------|---------------------|  
|**Задайте расположение символов:** Чтобы отобразить имена функций и параметров, профилировщик должен иметь доступ к файлам символов (. pdb) профилированных двоичных файлов. К числу этих файлов должны относиться файлы символов операционной системы Майкрософт и приложений, данные для которых должны отображаться в результатах анализа. Чтобы убедиться в наличии правильных двоичных PDB-файлов, можно воспользоваться общедоступным сервером символов Майкрософт.|-   [Как указать расположение файлов символов из командной строки](../profiling/how-to-specify-symbol-file-locations-from-the-command-line.md)|  
...
|**Профилирование кода на компьютерах без Visual Studio**. С помощью автономного профилировщика средств профилирования можно собирать данные для приложений на компьютерах без установленной системы [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].|-   [Как установить изолированный профилировщик](../profiling/how-to-install-the-stand-alone-profiler.md)|  
