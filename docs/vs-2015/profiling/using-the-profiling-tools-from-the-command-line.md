...
Последнюю версию этого раздела можно найти в [с помощью средств профилирования из командной строки](https://docs.microsoft.com/visualstudio/profiling/using-the-profiling-tools-from-the-command-line).  
