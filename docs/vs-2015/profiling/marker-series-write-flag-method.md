...
ms.locfileid: "47569997"
---
# <a name="markerserieswriteflag-method"></a>Метод marker_series::write_flag
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [метод marker_series::write_flag](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-flag-method).  
