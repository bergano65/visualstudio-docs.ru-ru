...
ms.locfileid: "47561939"
---
# <a name="resource-contention-data-views"></a>Представления данных о конфликтах ресурсов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представления данных о конфликтах ресурсов](https://docs.microsoft.com/visualstudio/profiling/resource-contention-data-views).  
