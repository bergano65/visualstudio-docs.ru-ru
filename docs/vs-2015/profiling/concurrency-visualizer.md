...
ms.locfileid: "47560152"
---
# <a name="concurrency-visualizer"></a>Визуализатор параллелизма
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [визуализатор параллелизма](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer).  
