...
## <a name="what-the-energy-consumption-profiler-is-how-it-works-and-what-it-measures"></a><a name="BKMK_What_the_Energy_Consumption_tool_is__how_it_works__and_what_it_measures"></a>Что такое профилировщик потребления энергии, как он работает и как он измеряет  
...
## <a name="identify-scenarios-with-user-marks"></a><a name="BKMK_Identify_scenarios_with_user_marks"></a>Выявление сценариев с пользовательскими отметками  
 ...
 ![Пользовательские отметки на временной шкале](../profiling/media/profilers-usermarktimeline.png "PROFILERS_UserMarkTimeline")  
...
## <a name="configure-your-environment-for-profiling"></a><a name="BKMK_Configure_your_environment_for_profiling"></a>Настройка среды для профилирования  
...
## <a name="collect-energy-profile-data-for-your-app"></a><a name="BKMK_Collect_energy_profile_data_for_your_app"></a>Получение данных профиля энергопотребления для приложения  
...
2. Выберите **Расход энергии** и нажмите кнопку **Запуск**.  
    ...
    > [!NOTE]
    > При запуске профилировщика **потребления энергии** может отобразиться окно **контроля учетных записей пользователей** , запрашивающее разрешение на запуск VsEtwCollector.exe. Выберите **Да**.  
...
## <a name="collect-energy-profile-data-for-an-installed-app"></a><a name="BKMK_Collect_energy_profile_data_for_an_installed_app"></a>Получение данных профиля энергопотребления для установленного приложения  
...
## <a name="analyze-energy-profile-data"></a><a name="BKMK_Analyze_energy_profile_data"></a>Анализ данных профиля энергопотребления  
...
## <a name="optimize-energy-use"></a><a name="BKMK_Optimize_energy_use"></a>Оптимизация использования энергии  
 ...
 ![Панель включения и отключения ресурсов](../profiling/media/energyprof-resources.png "ENERGYPROF_Resources")  
 ...
 ![Область сводки расхода энергии](../profiling/media/energyprof-summary.png "ENERGYPROF_Summary")  
...
## <a name="other-resources"></a><a name="BKMK_Other_resources"></a>Другие ресурсы  
...
- Инструменты **Время выполнения функций JavaScript** и **Загрузка ЦП** позволяют снизить нагрузку на ЦП, связанную с неэффективными функциями. См. раздел [анализ загрузки ЦП](../profiling/analyze-cpu-usage-in-a-windows-universal-app.md).
