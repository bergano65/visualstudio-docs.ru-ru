...
|На странице **Выборка** измените частоту выборки, замените событие выборки циклов тактовой частоты процессора на событие счетчика производительности другого процессора либо измените оба параметра.|-   [Как выбрать события выборки](../profiling/how-to-choose-sampling-events.md)|  
...
|На странице **Взаимодействие уровней** к данным, собранным во время сеанса профилирования, добавьте сведения о вызове ADO.NET.|-   [Сбор данных об уровневом взаимодействии](../profiling/collecting-tier-interaction-data.md)|  
