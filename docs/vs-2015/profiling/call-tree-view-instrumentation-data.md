...
ms.locfileid: "47563349"
---
# <a name="call-tree-view---instrumentation-data"></a>Представление "Дерево вызовов" — данные инструментирования
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [дерева представление вызовов — данные инструментирования](https://docs.microsoft.com/visualstudio/profiling/call-tree-view-instrumentation-data).  
