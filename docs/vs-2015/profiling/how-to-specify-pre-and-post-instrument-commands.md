...
3. Введите команду в текстовое поле **Командная строка** в разделе **События до инструментирования**.  
    ...
    > [!NOTE]
    > Можно нажать кнопку с многоточием **(...)** , расположенную рядом с полем **Командная строка** , чтобы перейти к соответствующему файлу exe, CMD или bat.  
