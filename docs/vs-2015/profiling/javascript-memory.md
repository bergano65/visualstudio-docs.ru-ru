...
ms.locfileid: "47569733"
---
# <a name="javascript-memory"></a>Память JavaScript
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [анализ использования памяти JavaScript в приложениях UWP](https://docs.microsoft.com/visualstudio/profiling/javascript-memory).  
