...
|**Coverage**|Выполняет инструментирование покрытия кода. Это может быть, что он может использоваться только со следующими параметрами: **Verbose**, **OutputPath**, **Exclude** и **Logfile**.|  
