...
ms.locfileid: "85534021"
---
# <a name="da0038-high-rate-of-lock-contentions"></a>DA0038. Большое число конфликтов при блокировке
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю документацию по Visual Studio см. в разделе [DA0038: высокая доля конфликтов блокировок](/visualstudio/profiling/da0038-high-rate-of-lock-contentions).  
  
|Item|Значение|  
|-|-|  
|Идентификатор правила|DA0038|  
|Категория|Использование .NET Framework|  
|Способ профилирования|Выборка<br /><br /> Инструментирование<br /><br /> Память .NET|  
