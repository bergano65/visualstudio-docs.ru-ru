...
ms.locfileid: "47564194"
---
# <a name="modules-view---sampling-data"></a>Представление "Модули" — данные выборки
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представление "Модули" — данные выборки](https://docs.microsoft.com/visualstudio/profiling/modules-view-sampling-data).  
