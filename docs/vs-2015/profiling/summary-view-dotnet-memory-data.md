...
ms.locfileid: "47569243"
---
# <a name="summary-view---net-memory-data"></a>Представление "Сводка" — данные в памяти .NET
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [представление "Сводка" — данные памяти .NET](https://docs.microsoft.com/visualstudio/profiling/summary-view-dotnet-memory-data).  
