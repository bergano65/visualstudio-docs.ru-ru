...
ms.locfileid: "47558944"
---
# <a name="markerserieswritealert-method"></a>Метод marker_series::write_alert
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [метод marker_series::write_alert](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-alert-method).  
