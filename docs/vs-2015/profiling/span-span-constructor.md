...
ms.locfileid: "47563610"
---
# <a name="spanspan-constructor"></a>Конструктор span::span
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [конструктор span::span](https://docs.microsoft.com/visualstudio/profiling/span-span-constructor).  
