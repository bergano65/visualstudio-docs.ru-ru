...
1. В **Обозреватель производительности**в разделе **отчеты**выберите файл отчета VSP или VSPS, который необходимо использовать в качестве базовых значений для сравнения.  
...
2. В окне **Выбор файлов анализа для сравнения** найдите и выберите файл анализа **базисных** файлов (VSP или VSPS) и **файл сравнения** (VSP или VSPS).  
