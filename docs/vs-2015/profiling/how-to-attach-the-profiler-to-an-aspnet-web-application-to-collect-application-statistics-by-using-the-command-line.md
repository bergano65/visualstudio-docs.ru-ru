---
title: Практическое руководство. Подключение профилировщика к веб-приложению ASP.NET для сбора статистики приложения с помощью командной строки | Документы Майкрософт
ms.date: 11/15/2016
...
## <a name="starting-the-profiler-and-attaching-to-an-aspnet-web-application"></a>Запуск профилировщика и подключение к веб-приложению ASP.NET  
...
4. Запуск профилировщика. Тип:**VSPerfCmd** [/Start](../profiling/start.md)**: Sample** [/Output](../profiling/output.md)**:** `OutputFile` [ `Options` ]  
...
6. Подключите профилировщик к рабочему процессу ASP.NET. Тип:**VSPerfCmd** [/attach](../profiling/attach.md)**:**{ `PID`&#124;`ProcName` } [ `Sample Event` ] [[/TargetCLR](../profiling/targetclr.md)**:** `Version` ]  
