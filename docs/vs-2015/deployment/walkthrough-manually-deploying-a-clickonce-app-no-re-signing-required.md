...
1.  Откройте командную строку Visual Studio или [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] командную строку и перейдите в каталог, в котором будут храниться ваши [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] файлов.  
...
5.  Запуск графического средства MageUI.exe.  
...
8.  Выберите **параметры приложения** вкладку и нажмите кнопку **использовать манифест приложения для доверенной информации**. Это позволит сторонних фирменная символика для данного [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] приложения.  
  
9. Выберите **файлы** вкладку и нажмите кнопку **Обзор** кнопку рядом с текстовым полем каталога приложения.  
...
16. Переключиться в режим **обновление** и укажите частоту обновления приложения. Если приложение использует [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] API развертывания для проверки наличия обновлений, снимите флажок **это приложение должно проверять наличие обновлений**.  
...
21. Созданный сертификат клиент теперь подписывает манифест развертывания, открыв манифест развертывания в MageUI.exe и затем сохраните его. Когда появится диалоговое окно подписания, клиент выбирает **знак, что файл сертификата** , а затем выбирает PFX-файл, сохраненный на диске.  
