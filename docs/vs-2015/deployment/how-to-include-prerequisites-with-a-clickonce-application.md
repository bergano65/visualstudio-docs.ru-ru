...
Последнюю версию этого раздела можно найти в [как: включить необходимые компоненты, приложения ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-include-prerequisites-with-a-clickonce-application).  
