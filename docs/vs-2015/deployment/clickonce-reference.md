...
ms.locfileid: "47561156"
---
# <a name="clickonce-reference"></a>Справочные сведения ClickOnce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [справочные сведения ClickOnce](https://docs.microsoft.com/visualstudio/deployment/clickonce-reference).  
