...
6.  Создание кнопки, меню или другой элемент пользовательского интерфейса в форме Windows, который пользователь будет выбирать проверить наличие обновлений. Из этого элемента в обработчик событий вызовите метод, чтобы проверить и установить обновления. Вы найдете пример кода Visual Basic и Visual C# для такого метода в [как: поиск приложения обновления программно с помощью API развертывания ClickOnce](../deployment/how-to-check-for-application-updates-programmatically-using-the-clickonce-deployment-api.md).  
