...
ms.locfileid: "63427134"
---
# <a name="walkthrough-creating-a-custom-bootstrapper-to-show-a-privacy-prompt"></a>Пошаговое руководство. Создание пользовательского загрузчика для отображения предупреждением о конфиденциальности
