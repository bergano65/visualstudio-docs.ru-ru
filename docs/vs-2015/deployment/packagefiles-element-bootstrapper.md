...
ms.locfileid: "47560244"
---
# <a name="ltpackagefilesgt-element-bootstrapper"></a>&lt;PackageFiles&gt; элемент (установщик)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [ &lt;PackageFiles&gt; элемент (загрузчик)](https://docs.microsoft.com/visualstudio/deployment/packagefiles-element-bootstrapper).  
...
## <a name="elements-and-attributes"></a>Элементы и атрибуты  
 `PackageFiles` Элемент имеет следующий атрибут.  
