# [Развертывание приложений, служб и компонентов](deploying-applications-services-and-components.md)
...
##### [Элемент \<assembly>](assembly-element-clickonce-application.md)
##### [Элемент \<assemblyIdentity>](assemblyidentity-element-clickonce-application.md)
##### [Элемент \<trustInfo>](trustinfo-element-clickonce-application.md)
##### [Элемент \<entryPoint>](entrypoint-element-clickonce-application.md)
##### [Элемент \<dependency>](dependency-element-clickonce-application.md)
##### [Элемент \<file>](file-element-clickonce-application.md)
##### [Элемент \<fileAssociation>](fileassociation-element-clickonce-application.md)
#### [Манифест развертывания ClickOnce](clickonce-deployment-manifest.md)
##### [Элемент \<assembly>](assembly-element-clickonce-deployment.md)
##### [Элемент \<assemblyIdentity>](assemblyidentity-element-clickonce-deployment.md)
##### [Элемент \<description>](description-element-clickonce-deployment.md)
##### [Элемент \<deployment>](deployment-element-clickonce-deployment.md)
##### [Элемент \<compatibleFrameworks>](compatibleframeworks-element-clickonce-deployment.md)
##### [Элемент \<dependency>](dependency-element-clickonce-deployment.md)
##### [Элемент \<publisherIdentity>](publisheridentity-element-clickonce-deployment.md)
##### [Элемент \<Signature>](signature-element-clickonce-deployment.md)
##### [Элемент \<customErrorReporting>](customerrorreporting-element-clickonce-deployment.md)
...
#### [Элемент \<Product>](product-element-bootstrapper.md)
#### [Элемент \<Package>](package-element-bootstrapper.md)
#### [Элемент \<RelatedProducts>](relatedproducts-element-bootstrapper.md)
#### [Элемент \<InstallChecks>](installchecks-element-bootstrapper.md)
#### [Элемент \<Commands>](commands-element-bootstrapper.md)
#### [Элемент \<PackageFiles>](packagefiles-element-bootstrapper.md)
#### [Элемент \<Strings>](strings-element-bootstrapper.md)
#### [Элемент \<Schedules>](schedules-element-bootstrapper.md)
