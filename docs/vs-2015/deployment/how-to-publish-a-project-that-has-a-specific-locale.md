---
title: Практическое руководство. Публикация проекта, имеющего конкретный языковый стандарт | Документация Майкрософт
ms.date: 11/15/2016
...
4. Опубликуйте проект PublishLocales через интегрированную среду разработки Visual Studio.  
     ...
     В **обозревателе решений**, выберите проект PublishLocales. В меню **Проект** выберите пункт **Свойства**. В конструкторе проектов на **публикации** укажите расположение для публикации **http://localhost/PublishLocales**, а затем нажмите кнопку **Опубликовать сейчас**.  
...
6. Если процесс публикации завершен успешно, появится сообщение "Публикация макроса PublishLocales\PublishLocales.vbproj успешно завершена. В качестве языка публикации был выбран en. В окне сообщений нажмите кнопку **ОК**. Когда откроется веб-страница публикации, нажмите кнопку **Установить**.  
...
## <a name="see-also"></a>См. также  
 ...
 [Среда разработки макросов](http://msdn.microsoft.com/d23105d8-34fe-4ad9-8278-fae2c660aeac)   
 [Обозреватель макросов-окно](http://msdn.microsoft.com/762169e6-f83f-44b4-bffa-d0f107cae9a3)   
 [Практическое руководство. Изменение и программное создание макросов](http://msdn.microsoft.com/6716f820-1feb-48ad-a718-27eb6b473c5a)
