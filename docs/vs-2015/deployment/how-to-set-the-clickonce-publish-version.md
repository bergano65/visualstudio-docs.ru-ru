...
Последнюю версию этого раздела можно найти в [как: установка версии публикации ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-set-the-clickonce-publish-version).  
