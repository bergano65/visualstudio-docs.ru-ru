---
title: Инструкции. Публикация приложения ClickOnce с помощью мастера публикации | Документация Майкрософт
ms.date: 11/15/2016
...
4. На странице **Способ установки приложения пользователями** выберите расположение, в которое пользователи будут переходить для установки приложения:  
   ...
   - Если пользователи будут устанавливать приложение напрямую из общей папки, выберите параметр **Из UNC-пути или из общей папки** и нажмите кнопку **Далее**. (Это расположение для публикаций в формате к:\деплой\мяпп или \\ \сервер\мяпп.)  
...
3. На странице **где вы хотите опубликовать приложение?** введите путь к файлу или расположение FTP, где будет опубликовано приложение, например д:\деплой. Затем щелкните **Далее**, чтобы продолжить.  
