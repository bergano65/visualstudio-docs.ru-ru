...
ms.locfileid: "47560652"
---
# <a name="assigntargetpath-task"></a>Задача AssignTargetPath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача Assigntargetpath](https://docs.microsoft.com/visualstudio/msbuild/assigntargetpath-task).  
