...
ms.locfileid: "47558871"
---
# <a name="generatetrustinfo-task"></a>Задача GenerateTrustInfo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача GenerateTrustInfo](https://docs.microsoft.com/visualstudio/msbuild/generatetrustinfo-task).  
