...
ms.locfileid: "47559341"
---
# <a name="converttoabsolutepath-task"></a>Задача ConvertToAbsolutePath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача ConvertToAbsolutePath](https://docs.microsoft.com/visualstudio/msbuild/converttoabsolutepath-task).  
