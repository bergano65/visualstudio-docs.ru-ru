...
ms.locfileid: "47572296"
---
# <a name="how-to-exclude-files-from-the-build"></a>Практическое руководство. Исключение файлов из построения
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: исключение файлов из построения](https://docs.microsoft.com/visualstudio/msbuild/how-to-exclude-files-from-the-build).  
