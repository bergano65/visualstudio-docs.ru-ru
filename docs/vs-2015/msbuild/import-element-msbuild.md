...
ms.locfileid: "47562612"
---
# <a name="import-element-msbuild"></a>Элемент Import (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент Import (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/import-element-msbuild).  
