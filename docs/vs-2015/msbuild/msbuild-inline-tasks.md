...
ms.locfileid: "47593265"
---
# <a name="msbuild-inline-tasks"></a>Встроенные задачи MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [встроенные задачи MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-inline-tasks).  
