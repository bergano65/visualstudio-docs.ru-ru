...
#### [Практическое руководство. Использование переменных среды в сборке](how-to-use-environment-variables-in-a-build.md)
...
#### [Практическое руководство. Сборка одинаковых исходных файлов с различными параметрами](how-to-build-the-same-source-files-with-different-options.md)
#### [Функции свойств](property-functions.md)
### [Элементы](msbuild-items.md)
#### [Практическое руководство. Выбор файлов для сборки](how-to-select-the-files-to-build.md)
#### [Практическое руководство. Исключение файлов из сборки](how-to-exclude-files-from-the-build.md)
...
#### [Практическое руководство. Выбор целевого объекта для первой сборки](how-to-specify-which-target-to-build-first.md)
#### [Практическое руководство. Использование одного и того же целевого объекта в нескольких файлах проектов](how-to-use-the-same-target-in-multiple-project-files.md)
#### [Практическое руководство. Сборка конкретных целевых объектов в решениях с помощью MSBuild.exe](how-to-build-specific-targets-in-solutions-by-using-msbuild-exe.md)
#### [Практическое руководство. Инкрементная сборка](how-to-build-incrementally.md)
...
#### [Практическое руководство. Сборка проекта, содержащего ресурсы](how-to-build-a-project-that-has-resources.md)
...
#### [Практическое руководство. Пропуск специальных знаков в MSBuild](how-to-escape-special-characters-in-msbuild.md)
#### [Практическое руководство. Использование резервных символов XML в файлах проектов](how-to-use-reserved-xml-characters-in-project-files.md)
...
#### [Практическое руководство. Расширение процесса сборки Visual Studio](how-to-extend-the-visual-studio-build-process.md)
