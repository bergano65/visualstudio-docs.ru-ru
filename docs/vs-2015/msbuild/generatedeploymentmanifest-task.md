...
ms.locfileid: "47569373"
---
# <a name="generatedeploymentmanifest-task"></a>Задача GenerateDeploymentManifest
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача GenerateDeploymentManifest](https://docs.microsoft.com/visualstudio/msbuild/generatedeploymentmanifest-task).  
