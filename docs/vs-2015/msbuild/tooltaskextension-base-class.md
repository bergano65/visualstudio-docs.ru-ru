...
ms.locfileid: "47569118"
---
# <a name="tooltaskextension-base-class"></a>Базовый класс ToolTaskExtension
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [базовый класс ToolTaskExtension](https://docs.microsoft.com/visualstudio/msbuild/tooltaskextension-base-class).  
