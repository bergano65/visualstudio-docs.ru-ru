...
ms.locfileid: "47572050"
---
# <a name="generatebootstrapper-task"></a>Задача GenerateBootstrapper
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача GenerateBootstrapper](https://docs.microsoft.com/visualstudio/msbuild/generatebootstrapper-task).  
