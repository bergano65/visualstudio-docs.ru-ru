...
- **CLRUnmanagedCodeCheck**  
   ...
   Дополнительные сведения см. в разделе [/clrunmanagedcodecheck (Добавление SuppressUnmanagedCodeSecurityAttribute)](http://msdn.microsoft.com/library/73abc426-dab0-45e2-be85-0f9a14206cc2).  
