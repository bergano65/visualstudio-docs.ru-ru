...
ms.locfileid: "47562797"
---
# <a name="how-to-build-incrementally"></a>Практическое руководство. Инкрементное построение
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: инкрементная сборка](https://docs.microsoft.com/visualstudio/msbuild/how-to-build-incrementally).  
