...
ms.locfileid: "63431407"
---
# <a name="how-to-build-incrementally"></a>Практическое руководство. Последовательная сборка
...
- `BuildHelp`: Объединяет CONTENT-файлы и файлы метаданных XML для построения итогового HELP-файла.  
