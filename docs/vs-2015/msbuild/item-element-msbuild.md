...
ms.locfileid: "47562894"
---
# <a name="item-element-msbuild"></a>Элемент Item (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент Item (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/item-element-msbuild).  
