...
## <a name="using-properties-to-modify-projects"></a>Использование свойств для изменения проектов  
 ...
 Свойства можно использовать для изменения конфигурации сборки без редактирования файла проекта. Атрибут `Condition` элемента `Property` и элемент `PropertyGroup` позволяют изменять значения свойств. Дополнительные сведения об [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)] условиях см. в разделе [условия](../msbuild/msbuild-conditions.md).  
