...
ms.locfileid: "47573086"
---
# <a name="logging-in-a-multi-processor-environment"></a>Ведение журнала в многопроцессорной среде
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [ведения журналов в многопроцессорной среде](https://docs.microsoft.com/visualstudio/msbuild/logging-in-a-multi-processor-environment).  
