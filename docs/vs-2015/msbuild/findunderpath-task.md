...
ms.locfileid: "47573389"
---
# <a name="findunderpath-task"></a>Задача FindUnderPath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача FindUnderPath](https://docs.microsoft.com/visualstudio/msbuild/findunderpath-task).  
