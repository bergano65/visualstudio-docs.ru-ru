...
ms.locfileid: "47563288"
---
# <a name="msbuild-reference"></a>Справочные сведения о MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Справочник по MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-reference).  
