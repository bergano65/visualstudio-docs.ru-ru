...
ms.locfileid: "47559023"
---
# <a name="otherwise-element-msbuild"></a>Элемент Otherwise (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент Otherwise (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/otherwise-element-msbuild).  
