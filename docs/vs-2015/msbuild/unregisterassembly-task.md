...
ms.locfileid: "47573111"
---
# <a name="unregisterassembly-task"></a>Задача UnregisterAssembly
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача UnregisterAssembly](https://docs.microsoft.com/visualstudio/msbuild/unregisterassembly-task).  
