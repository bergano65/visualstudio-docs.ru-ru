...
ms.locfileid: "47558855"
---
# <a name="project-element-msbuild"></a>Элемент Project (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [элемент Project (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/project-element-msbuild).  
