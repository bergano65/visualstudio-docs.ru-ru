...
ms.locfileid: "47558825"
---
# <a name="msbuild-transforms"></a>Преобразования MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [MSBuild преобразует](https://docs.microsoft.com/visualstudio/msbuild/msbuild-transforms).  
