...
Последнюю версию этого раздела можно найти в [записи несколькими поддержкой средств ведения журнала](https://docs.microsoft.com/visualstudio/msbuild/writing-multi-processor-aware-loggers).  
