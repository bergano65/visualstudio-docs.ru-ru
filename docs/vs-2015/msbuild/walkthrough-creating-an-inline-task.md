...
ms.locfileid: "90843192"
---
# <a name="walkthrough-creating-an-inline-task"></a>Пошаговое руководство. Создание встроенной задачи
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Задачи MSBuild обычно создаются путем компиляции класса, реализующего интерфейс <xref:Microsoft.Build.Framework.ITask>. Начиная с .NET Framework 4, в файле проекта можно создавать встроенные задачи. Для размещения задачи не нужно создавать отдельную сборку. Дополнительные сведения см. в разделе [встроенные задачи](../msbuild/msbuild-inline-tasks.md).  
...
1. В Visual Studio в меню **файл** выберите пункт **создать** , а затем щелкните **проект**.  
...
### <a name="running-the-hello-task"></a>Выполнение задачи Hello  
...
2. В **окне командной строки**введите **MSBuild** без параметров командной строки и нажмите клавишу ВВОД. По умолчанию в результате обрабатывается стандартный целевой объект TestBuild, вызывающий задачу Echo.  
...
## <a name="defining-the-regx-task"></a>Определение задачи RegX  
...
2. В **окне командной строки**введите **MSBuild** без параметров командной строки и нажмите клавишу ВВОД. По умолчанию в результате обрабатывается стандартный целевой объект TestBuild, вызывающий задачу RegX.  
