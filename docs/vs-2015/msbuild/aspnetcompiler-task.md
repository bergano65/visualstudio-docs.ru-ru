...
ms.locfileid: "47573067"
---
# <a name="aspnetcompiler-task"></a>Задача AspNetCompiler
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [использование задачи AspNetCompiler для предварительной компиляции приложений ASP.NET](https://docs.microsoft.com/visualstudio/msbuild/aspnetcompiler-task).  
