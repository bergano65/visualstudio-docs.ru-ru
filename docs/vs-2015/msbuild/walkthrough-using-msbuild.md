...
ms.locfileid: "47573117"
---
# <a name="walkthrough-using-msbuild"></a>Пошаговое руководство. Использование MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Пошаговое руководство: использование MSBuild](https://docs.microsoft.com/visualstudio/msbuild/walkthrough-using-msbuild).  
