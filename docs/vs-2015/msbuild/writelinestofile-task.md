...
ms.locfileid: "47570961"
---
# <a name="writelinestofile-task"></a>Задача WriteLinesToFile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача WriteLinesToFile](https://docs.microsoft.com/visualstudio/msbuild/writelinestofile-task).  
