...
## <a name="in-this-section"></a>в этом разделе  
 ...
 Добавляет **\<hostInBrowser />** элемент в манифест приложения (*имяПроекта*. exe. manifest) при [!INCLUDE[TLA#tla_xbap](../includes/tlasharptla-xbap-md.md)] построении проекта.  
