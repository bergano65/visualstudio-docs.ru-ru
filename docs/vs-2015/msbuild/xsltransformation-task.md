...
ms.locfileid: "47568567"
---
# <a name="xsltransformation-task"></a>Задача XslTransformation
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [xsltransformation-задача](https://docs.microsoft.com/visualstudio/msbuild/xsltransformation-task).  
