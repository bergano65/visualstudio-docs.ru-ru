...
ms.locfileid: "47557671"
---
# <a name="getframeworkpath-task"></a>Задача GetFrameworkPath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [задача GetFrameworkPath](https://docs.microsoft.com/visualstudio/msbuild/getframeworkpath-task).  
