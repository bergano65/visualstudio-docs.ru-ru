---
title: Практическое руководство. Управление Windows редактор | Документация Майкрософт
ms.date: 11/15/2016
...
ms.locfileid: "63430501"
---
# <a name="how-to-manage-editor-windows"></a>Практическое руководство. Управление Windows редактора
