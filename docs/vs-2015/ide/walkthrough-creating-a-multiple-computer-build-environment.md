...
Последнюю версию этого раздела можно найти в [Пошаговое руководство: создание среды построения нескольких компьютеров](https://docs.microsoft.com/visualstudio/ide/walkthrough-creating-a-multiple-computer-build-environment).  
