...
ms.locfileid: "47572051"
---
# <a name="step-5-add-label-references"></a>Шаг 5. Добавление ссылок на метки
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Step 5: Добавление ссылок на метки](https://docs.microsoft.com/visualstudio/ide/step-5-add-label-references).  
