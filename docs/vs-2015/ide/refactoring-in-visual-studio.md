...
### <a name="refactoring-in-visual-basic"></a>Рефакторинг в Visual Basic
 [Рефакторинг и диалоговое окно "Переименовать" (Visual Basic)](http://msdn.microsoft.com/library/001d2d81-9bb6-4e8e-ae3a-20c0daaa3959)

### <a name="refactoring-in-c"></a>Рефакторинг в C++
 [Написание и рефакторинг кода (C++)](http://msdn.microsoft.com/library/56ffb9e9-514f-41f4-a3cf-fd9ce2daf3b6)
