...
ms.locfileid: "47569192"
---
# <a name="tips-and-tricks-for-visual-studio"></a>Советы и рекомендации по работе в Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [советы и рекомендации по Visual Studio](https://docs.microsoft.com/visualstudio/ide/tips-and-tricks-for-visual-studio).  
