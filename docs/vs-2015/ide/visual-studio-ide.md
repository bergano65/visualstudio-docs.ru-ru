...
ms.locfileid: "47568617"
---
# <a name="visual-studio-ide"></a>Интегрированная среда разработки Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [документация по интегрированной среде разработки Visual Studio](https://docs.microsoft.com/visualstudio/ide/index).
...
По умолчанию Visual Studio обеспечивает поддержку C#, C и C++, JavaScript, F# и Visual Basic. Visual Studio хорошо работает и интегрируется с приложениями независимых производителей, например Unity [Visual Studio Tools for Unity](../cross-platform/visual-studio-tools-for-unity.md) расширение и Apache Cordova через [средств Visual Studio для Apache Cordova](http://msdn.microsoft.com/library/db446f2c-6ba4-4c76-aac5-4c66f43b8c42). Вы также можете самостоятельно расширить Visual Studio, создав собственные инструменты для выполнения специализированных задач.

Если вы никогда не использовали Visual Studio, ознакомьтесь со статьей с нашей [начало разработки в Visual Studio](../ide/get-started-developing-with-visual-studio.md) учебники и пошаговые руководства.
...
### <a name="finding-things-and-getting-help"></a>Поиск и получение справки
 [Быстрого запуска](../ide/reference/quick-launch-environment-options-dialog-box.md) показанная ниже является возможность быстрого поиска команд Visual Studio, инструментов, функций и так далее, если вам неизвестно сочетание клавиш или меню расположение. Просто введите название нужного компонента, и на панели быстрого запуска появится ссылка на него.
...
### <a name="giving-feedback"></a>Предоставление отзывов
 Отзыв о Visual Studio можно отправить в любой момент. Щелкните значок отзыва в заголовке окна рядом с **быстрым запуском** , а затем нажмите кнопку **Сообщить о проблеме** или **Отправить предложение**. Предварительные выпуски Visual Studio также содержат функцию **Оценить этот продукт** . Мы рассмотрим все ваши комментарии и используем их для улучшения продукта. Дополнительные сведения см. в статье [Talk to Us](../ide/talk-to-us.md) (Обращайтесь к нам).
...
1.  [Рефакторинг](../ide/refactoring-in-visual-studio.md) включает в себя операции, такие как интеллектуальное переименование переменных, Перемещение выделенных строк кода в отдельную функцию, перемещение кода в другие расположения, изменение порядка параметров функции и многое другое.
...
## <a name="extending-visual-studio-through-the-visual-studio-sdk"></a>Расширение Visual Studio с помощью пакета Visual Studio SDK
 Visual Studio — это расширяемая платформа. Расширение Visual Studio представляет собой настраиваемое средство, которые интегрируется со средой IDE. Вы можете добавлять сторонние расширения или создавать собственные. Дополнительные сведения см. в разделе [разработка расширений Visual Studio](http://msdn.microsoft.com/library/5b1b5db3-6005-44cf-83b0-e608d7764d14).
