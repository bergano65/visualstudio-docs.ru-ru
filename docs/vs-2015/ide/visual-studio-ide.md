...
## <a name="writing-navigating-and-understanding-code"></a>Написание, навигация и понимание кода
 ...
 Текстовый редактор включает много интерактивных функций (если они требуются) и функций повышения производительности, помогающих ускорить написание кода. Возможности зависят от языка, и нет необходимости использовать любой из них (введите «Редактор», на панели быстрого запуска) на включение или отключение компонентов: Ниже приведены некоторые распространенные возможности повышения производительности.
...
Выходные данные сборки, включая сообщения об ошибках или успешном выполнении, отображаются в окне **вывода**. **Список ошибок** отображаются подробные сведения об ошибках сборки.
