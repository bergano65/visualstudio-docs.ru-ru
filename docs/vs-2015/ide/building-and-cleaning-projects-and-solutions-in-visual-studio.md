...
Процедуры, описанные в этом разделе, используются для построения, перестроения или очистки всех или некоторые проектов или элементов проекта в решении. Пошаговое руководство см. в разделе Пошаговое [руководство. Создание приложения](../ide/walkthrough-building-an-application.md).

> [!NOTE]
> Пользовательский интерфейс в вашем выпуске Visual Studio может отличаться от приведенного в этом разделе в зависимости от ваших текущих параметров. Чтобы изменить параметры, выберите в меню **Сервис** пункт **Импорт и экспорт параметров**. Дополнительные сведения см. [в разделе Настройка параметров разработки в Visual Studio](https://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3).
...
2. В строке меню выберите **Сборка**, а затем выберите **построить** _имя_проекта_ или **перестроить** _имя_проекта_.
    ...
    - Выберите **Сборка** _имя_проекта_ , чтобы построить только те компоненты проекта, которые были изменены с момента последней сборки.
...
3. Установите флажок **При выполнении построить только запускаемые проекты и зависимости**.
   ...
   - В строке меню выберите **Сборка**  >  **построить решение** (Ctrl + Shift + B).
...
## <a name="see-also"></a>См. также раздел
 [Как просмотреть, сохранить и настроить файлы журнала сборки](../ide/how-to-view-save-and-configure-build-log-files.md) [Получение журналов сборки](../msbuild/obtaining-build-logs-with-msbuild.md) [Компиляция и построение](../ide/compiling-and-building-in-visual-studio.md) [Общее представление о конфигурациях сборки](../ide/understanding-build-configurations.md) [Отладка и выпуск проект конфигурация проекта версия](https://msdn.microsoft.com/0440b300-0614-4511-901a-105b771b236e) [C/C++ построение Справочник](https://msdn.microsoft.com/library/100b4ccf-572c-4d1f-970c-fa0bc0cc0d2d) по [параметрам командной строки devenv](../ide/reference/devenv-command-line-switches.md) [решения и проекты](../ide/solutions-and-projects-in-visual-studio.md)
