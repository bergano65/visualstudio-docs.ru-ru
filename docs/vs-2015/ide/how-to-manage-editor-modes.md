...
## <a name="enabling-full-screen-mode"></a>Включение полноэкранного режима
 Можно скрыть все окна инструментов и просмотреть только окна документов, включив **полноэкранный** режим.

#### <a name="to-enable-full-screen-mode"></a>Включение полноэкранного режима

- Нажмите сочетание клавиш ALT + SHIFT + ВВОД, чтобы войти в **полноэкранный** режим или выйти из него.
