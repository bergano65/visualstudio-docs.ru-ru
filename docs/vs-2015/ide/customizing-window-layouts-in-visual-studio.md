...
### <a name="toolbars"></a>Панели инструментов
 Панели инструментов можно упорядочить путем перетаскивания или с помощью диалогового окна **Настройка** . Дополнительные сведения о размещении и настройке панелей инструментов см. [в разделе как настроить меню и панели инструментов](../ide/how-to-customize-menus-and-toolbars-in-visual-studio.md).

## <a name="arranging-and-docking-windows"></a>Размещение и закрепление окон
...
### <a name="docking-windows"></a>Закрепление окон
 ...
 Чтобы вернуть окно инструментов или окно документа к последнему закрепленному расположению, нажмите клавишу **CTRL** , дважды щелкнув строку заголовка или вкладку окна.
 ...
 ![Значок направляющей окна документа ромб](../ide/media/documentwindowguidediamonds.png "Documentwindowguidediamonds")
 ...
 ![Закрепление обозревателя решений в новом положении](../ide/media/vs2015-dock-diamond.png "VS2015_Dock_diamond")

### <a name="closing-and-auto-hiding-tool-windows"></a>Закрытие и автоматическое скрытие окон инструментов
 ...
 ![Автоматически скрывать](../ide/media/vs2015-auto-hide.png "vs2015_auto_hide")

> [!NOTE]
> Чтобы задать, будет ли Автоматическое скрытие работать с окнами инструментов по отдельности или как закрепленные группы, установите или снимите флажок **Автоматическое скрытие кнопка влияет на активные окна инструментов только** в диалоговом окне **Параметры** . Дополнительные сведения см. в разделе [Общие, среда, диалоговое окно "Параметры"](../ide/reference/general-environment-options-dialog-box.md).
...
### <a name="specifying-a-monitor"></a>Задание монитора
...
1. Для переключения между макетами используйте сочетания клавиш или выберите в главном меню **Окно > Применить макет окна**.

     ![Меню "Применить макет окна"](../ide/media/vs2015-applywindowlayout.png "VS2015_ApplyWindowLayout")
...
1. Пользовательский макет можно удалить, переименовать или переупорядочить, выбрав **Окно > Управление макетами окна**. Если переместить макет, привязка ключей будет настроена автоматически и отобразит новое положение в списке. Привязки невозможно изменить другим способом, таким образом, одновременно можно хранить не больше 10 макетов.
     ...
     ![Управление макетами окон](../ide/media/managewindowlayouts.png "манажевиндовлайаутс")
...
|Заголовок|Описание|
|-----------|-----------------|
|[Типы окон](../misc/kinds-of-windows.md)|Различия между окнами документов и окнами средств в интегрированной среде разработки.|
|[Практическое руководство. Размещение и закрепление окон](../misc/how-to-arrange-and-dock-windows.md)|Описание закрепления, автоскрытия и мозаичного расположения окон, а также процедуры сброса структуры окон.|
|[Руководство. Перемещение по интегрированной среде разработки](../ide/how-to-move-around-in-the-visual-studio-ide.md)|Описание циклического перемещения между окнами в интегрированной среде разработки в порядке использования. Кроме того, описание процесса перехода к определенному документу.|
|[Настройка параметров разработки в Visual Studio](https://msdn.microsoft.com/22c4debb-4e31-47a8-8f19-16f328d7dcd3)|Сведения о комбинациях параметров и влиянии этих параметров на структуру окон, сочетания клавиш и другие элементы интегрированной среды разработки.|
