...
### <a name="toolbars"></a>Панели инструментов
 Панели инструментов можно упорядочить путем перетаскивания или с помощью диалогового окна **Настройка** . Дополнительные сведения о размещении и настройке панелей инструментов см. в разделе [как: Настройка меню и панелей инструментов](../ide/how-to-customize-menus-and-toolbars-in-visual-studio.md).
...
### <a name="closing-and-auto-hiding-tool-windows"></a>Закрытие и автоматическое скрытие окон инструментов
 ...
 ![Автоматическое скрытие](../ide/media/vs2015-auto-hide.png "vs2015_auto_hide")
...
1.  Для переключения между макетами используйте сочетания клавиш или выберите в главном меню **Окно > Применить макет окна**.
     ...
     ![Применить макет меню "окно"](../ide/media/vs2015-applywindowlayout.png "VS2015_ApplyWindowLayout")
...
|[Практическое руководство: Перемещение по интегрированной среде разработки](../ide/how-to-move-around-in-the-visual-studio-ide.md)|Описание циклического перемещения между окнами в интегрированной среде разработки в порядке использования. Кроме того, описание процесса перехода к определенному документу.|
|[Настройка параметров разработки в Visual Studio](http://msdn.microsoft.com/en-us/22c4debb-4e31-47a8-8f19-16f328d7dcd3)|Сведения о комбинациях параметров и влиянии этих параметров на структуру окон, сочетания клавиш и другие элементы интегрированной среды разработки.|
