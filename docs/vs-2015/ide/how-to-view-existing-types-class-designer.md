...
Для просмотра существующего типа и его членов, добавьте его фигуру на диаграмму классов.
 ...
 Сведения о проектировании новых типов на схемах классов см. [в разделе как создавать типы с помощью Конструктор классов](../ide/how-to-create-types-by-using-class-designer.md).
...
> Если представление классов не открыт, откройте представление классов в меню **вид** . Дополнительные сведения о представлении классов см. в разделе [Просмотр классов и их членов](https://msdn.microsoft.com/71e9e8f3-261a-4e0c-87bf-5ec48b8bf333).
 ...
 Чтобы отобразить типы в расположениях по умолчанию на схеме, выберите один или несколько типов в представление классов, щелкните правой кнопкой мыши выбранные типы и выберите пункт **Просмотреть схему классов**.
