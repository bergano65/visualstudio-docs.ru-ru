...
ms.locfileid: "47569311"
---
# <a name="visual-studio-ide-64-bit-support"></a>Поддержка 64-разрядных сред IDE Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [поддержка Visual Studio IDE 64-разрядных](https://docs.microsoft.com/visualstudio/ide/visual-studio-ide-64-bit-support).  
