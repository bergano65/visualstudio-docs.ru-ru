...
> [!TIP]
> Сведения о том, как упростить написание фрагментов кода, можно найти на веб-сайте CodePlex для таких средств сообщества, как [Редактор фрагментов](https://snippeteditor.codeplex.com/).
