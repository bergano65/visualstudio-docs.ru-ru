...
> [!TIP]
>  Сведения об изменении цветов в редакторе кода, см. в разделе [как: Изменение шрифтов и цветов в редакторе](../ide/reference/how-to-change-fonts-and-colors-in-the-editor.md).
