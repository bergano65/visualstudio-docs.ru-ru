---
title: Как выполнить Отключение ведущего процесса | Документация Майкрософт
ms.date: 11/15/2016
...
---
# <a name="how-to-disable-the-hosting-process"></a>Как выполнить Отключение главного процесса
