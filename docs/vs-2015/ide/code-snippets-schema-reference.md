...
ms.locfileid: "47570380"
---
# <a name="code-snippets-schema-reference"></a>Справочник по схеме фрагментов кода
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Справочник по схеме фрагментов кода](https://docs.microsoft.com/visualstudio/ide/code-snippets-schema-reference).  
