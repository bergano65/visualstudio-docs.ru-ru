...
2. В списке **Активная платформа решения** выберите 64-разрядную платформу для нацеливания решения, а затем нажмите кнопку **Закрыть**.
   ...
   1. Если нужная платформа не отображается в списке **Активная платформа решения** , нажмите кнопку **создать**.
...
- Сведения о [!INCLUDE[csprcs](../includes/csprcs-md.md)] проектах см. в разделе [Страница "сборка" в конструкторе проектов (C#)](../ide/reference/build-page-project-designer-csharp.md).

- Сведения о [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] проектах см. в разделе [/CLR (компиляция среды CLR)](https://msdn.microsoft.com/library/fec5a8c0-40ec-484c-a213-8dec918c1d6c).

## <a name="see-also"></a>См. также:
 [Общие сведения о платформах сборки](../ide/understanding-build-platforms.md) [/Platform (параметры компилятора C#)](https://msdn.microsoft.com/library/c290ff5e-47f4-4a85-9bb3-9c2525b0be04) [64-разрядные приложения](https://msdn.microsoft.com/library/fd4026bc-2c3d-4b27-86dc-ec5e96018181) [Поддержка Visual Studio IDE 64-bit](../ide/visual-studio-ide-64-bit-support.md)
