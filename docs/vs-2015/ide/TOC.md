...
## [Практическое руководство. Перемещение по интегрированной среде разработки](how-to-move-around-in-the-visual-studio-ide.md)
...
#### [Учебник 1. Создание средства просмотра рисунков](tutorial-1-create-a-picture-viewer.md)
...
##### [Шаг 10. Написание кода для дополнительных кнопок и флажка](step-10-write-code-for-additional-buttons-and-a-check-box.md)
##### [Шаг 11. Запуск программы и изучение других функций](step-11-run-your-program-and-try-other-features.md)
#### [Учебник 2. Создание ограниченной по времени математической головоломки](tutorial-2-create-a-timed-math-quiz.md)
##### [Шаг 1. Создание проекта и добавление в форму элементов управления Label](step-1-create-a-project-and-add-labels-to-your-form.md)
...
##### [Шаг 8. Настройка теста](step-8-customize-the-quiz.md)
...
##### [Шаг 3. Назначение каждому элементу управления Label случайного значка](step-3-assign-a-random-icon-to-each-label.md)
##### [Шаг 4. Добавление обработчика событий Click к каждому элементу управления Label](step-4-add-a-click-event-handler-to-each-label.md)
##### [Шаг 5. Добавление ссылок на элементы управления Label](step-5-add-label-references.md)
...
#### [Практическое руководство. Размещение и упорядочение шаблонов](how-to-locate-and-organize-project-and-item-templates.md)
...
### [Практическое руководство. Отслеживание кода путем настройки полосы прокрутки](how-to-track-your-code-by-customizing-the-scrollbar.md)
...
#### [Практическое руководство. Восстановление фрагментов кода для рефакторинга в C#](how-to-restore-csharp-refactoring-snippets.md)
...
####### [Практическое руководство. Добавление диаграмм классов в проекты (конструктор классов)](how-to-add-class-diagrams-to-projects-class-designer.md)
####### [Практическое руководство. Настройка диаграмм классов (конструктор классов)](how-to-customize-class-diagrams-class-designer.md)
####### [Практическое руководство. Копирование элементов диаграммы классов в документ Microsoft Office (конструктор классов)](how-to-copy-class-diagram-elements-to-a-microsoft-office-document-class-designer.md)
####### [Практическое руководство. Экспорт диаграмм классов как изображений (конструктор классов)](how-to-export-class-diagrams-as-images-class-designer.md)
####### [Практическое руководство. Печать диаграмм классов (конструктор классов)](how-to-print-class-diagrams-class-designer.md)
####### [Практическое руководство. Добавление комментариев в диаграммы классов (конструктор классов)](how-to-add-comments-to-class-diagrams-class-designer.md)
...
####### [Практическое руководство. Визуализация ассоциации коллекции (конструктор классов)](how-to-visualize-a-collection-association-class-designer.md)
...
####### [Практическое руководство. Просмотр наследования между типами (конструктор классов)](how-to-view-inheritance-between-types-class-designer.md)
####### [Практическое руководство. Переключение между представлением в виде членов и представлением в виде ассоциации (конструктор классов)](how-to-change-between-member-notation-and-association-notation-class-designer.md)
...
####### [Практическое руководство. Разделение класса на разделяемые классы (конструктор классов)](how-to-split-a-class-into-partial-classes-class-designer.md)
...
### [Пошаговое руководство: Сборка приложения](walkthrough-building-an-application.md)
...
#### [Практическое руководство. Сборка в общий выходной каталог](how-to-build-to-a-common-output-directory.md)
...
#### [Практическое руководство. Сборка с использованием нескольких конфигураций](how-to-build-multiple-configurations-simultaneously.md)
### [Общие сведения о платформах построения](understanding-build-platforms.md)
#### [Практическое руководство. Настройка целевых платформ в проектах](how-to-configure-projects-to-target-platforms.md)
#### [Практическое руководство. Настройка проектов для нескольких платформ](how-to-configure-projects-to-target-multiple-platforms.md)
### [Практическое руководство. Указание событий сборки (Visual Basic)](how-to-specify-build-events-visual-basic.md)
### [Практическое руководство. Указание событий сборки (C#)](how-to-specify-build-events-csharp.md)
### [Configuring Warnings in Visual Basic](configuring-warnings-in-visual-basic.md)
### [Практическое руководство. Отключение ведущего процесса](how-to-disable-the-hosting-process.md)
#### [Главный процесс (vshost.exe)](hosting-process-vshost-exe.md)
### [Пошаговое руководство: Создание среды сборки из нескольких компьютеров](walkthrough-creating-a-multiple-computer-build-environment.md)
...
### [Практическое руководство. Настройка меню и панелей инструментов](how-to-customize-menus-and-toolbars-in-visual-studio.md)
...
#### [Практическое руководство. Сохранение и открытие файлов с определенной кодировкой](how-to-save-and-open-files-with-encoding.md)
...
#### [Командное окно](reference/command-window.md)
...
##### [Страница "Список задач", папка "Среда", диалоговое окно "Параметры"](reference/task-list-environment-options-dialog-box.md)
...
##### [Страница "Параметры", свойства узла "Шрифты и цвета"](reference/options-page-fonts-and-colors-node-properties.md)
...
###### [Диалоговое окно "Дополнительные параметры служб"](reference/advanced-settings-for-services-dialog-box.md)
...
#### [Команда "Открыть проект"](reference/open-project-command.md)
...
##### [Практическое руководство. настройка специальных возможностей в интегрированной среде разработки](reference/how-to-set-ide-accessibility-options.md)
...
#### [Ресурсы для создания приложений со специальными возможностями](reference/resources-for-designing-accessible-applications.md)
