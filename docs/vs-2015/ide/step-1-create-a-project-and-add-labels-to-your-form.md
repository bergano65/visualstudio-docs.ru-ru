...
7. Щелкните знак плюса (+) рядом со свойством **Font** , а затем измените значение свойства **size** на **15,75**.

     Можно изменить несколько свойств шрифта, как показано на следующем рисунке.

     ![Окно свойств отображения размера шрифта](../ide/media/express-setfontsize.png "Express_setFontSize") окно свойств отображения размера шрифта

8. Добавьте еще один элемент управления **Label** из панели элементов и установите его размер шрифта **15,75**.
...
1. Добавить элемент управления " **Метка** " из панели элементов, а затем задать для его свойства **Text** значение **?** (вопросительный знак).
...
8. Выберите метку **plusLeftLabel** , а затем нажмите сочетание клавиш CTRL + C или **Копировать** в меню **Правка** .

9. Вставьте метку три раза, выбрав клавиши CTRL + V или **Вставить** в меню **Правка** .
...
15. Выровнять элемент управления **NumericUpDown** с элементами управления Label для задачи сложения.

16. Измените значение свойства **(Name)** для элемента управления **NumericUpDown** на **Sum**.

     Первая строка создана, как показано на следующем рисунке.

     ![First row of math quiz](../ide/media/express-firstrow.png "Express_firstRow") Первая строка математической головоломки
...
6. Назовите **различие**элемента управления **NumericUpDown** .
...
7. Установите значение свойства **TabIndex** для элемента управления NumericUpDown с именем sum равным **2**, для элемента управления difference равным **3**, для элемента управления product равным **4**, а для элемента управления quotient равным **5**.
     ...
     ![Initial math quiz form](../ide/media/express-formlaidout.png "Express_FormLaidOut") Начальная форма математической головоломки
...
- Чтобы вернуться к обзорному разделу, см. [учебник 2. Создание математической головоломки с течением времени](../ide/tutorial-2-create-a-timed-math-quiz.md).
