...
- В меню **Вид** выберите команду **Список задач** (сочетание клавиш: CTRL+\\, T).
     ...
     ![Окно списка задач](../ide/media/vs2015-task-list.png "|::ref1::|")
...
2. Откройте папку **Среда** и выберите **Список задач**.
     ...
     Отображается [Task List, Environment, Options Dialog Box](../ide/reference/task-list-environment-options-dialog-box.md) .

     ![Список задач Visual Studio](../ide/media/vs2015-task-list-options.png "|::ref2::|")
...
## <a name="shortcuts"></a> Ярлыки
 ...
 ![Значок ярлыка списка задач Visual Studio](../ide/media/vs2015-task-list-bookmark.png "|::ref3::|")
