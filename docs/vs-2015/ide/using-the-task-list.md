...
- [Пользовательские токены](../ide/using-the-task-list.md#customTokens)

- [Комментарии TODO C++](../ide/using-the-task-list.md#cppComments)

- [Используемых](../ide/using-the-task-list.md#shortcuts)

## <a name="the-task-list-window"></a><a name="taskListWindow"></a> Окно "Список задач"
...
- В меню **вид** выберите **список задач** (клавиатура: Ctrl + \\ , T).
...
## <a name="user-tasks"></a><a name="userTasks"></a> Задачи пользователя
...
## <a name="tokens-and-comments"></a><a name="tokensComments"></a> Токены и комментарии
...
### <a name="custom-tokens"></a><a name="customTokens"></a> Пользовательские токены
...
3. В категории **токены** в текстовом поле **имя** введите имя токена, например "ошибка".

4. В раскрывающемся списке **Приоритет** выберите приоритет по умолчанию для нового токена. Выберите кнопку **Добавить**.

### <a name="c-todo-comments"></a><a name="cppComments"></a> Комментарии TODO в C++
...
## <a name="shortcuts"></a><a name="shortcuts"></a> Используемых
