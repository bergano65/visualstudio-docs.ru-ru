...
2. Если у вас Visual Basic проект, выберите вкладку **Компиляция** . Если у вас есть проект Visual C#, перейдите на вкладку **Сборка** . Если у вас есть проект C++ или проект JavaScript, перейдите на вкладку **Общие** .
...
## <a name="see-also"></a>См. также:
 [Страница "сборка" в конструкторе проектов (C#)](../ide/reference/build-page-project-designer-csharp.md) [Общая страница свойств (проект):](https://msdn.microsoft.com/library/593b383c-cd0f-4dcd-ad65-9ec9b4b19c45) [Компиляция и сборка](../ide/compiling-and-building-in-visual-studio.md)
