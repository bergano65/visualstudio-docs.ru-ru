---
title: Синхронизированные параметры в Visual Studio | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47570549"
---
# <a name="synchronized-settings-in-visual-studio"></a>Синхронизированные параметры в Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [синхронизация параметров в Visual Studio](https://docs.microsoft.com/visualstudio/ide/synchronized-settings-in-visual-studio).  
