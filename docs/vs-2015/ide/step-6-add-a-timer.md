...
1. На панели элементов в конструктор Windows Forms выберите **Timer** (в категории **компоненты** ), а затем нажмите клавишу ВВОД или дважды щелкните таймер, чтобы добавить в форму элемент управления Timer. Значок с именем таймера **Timer1** должен появиться в пространстве под формой, как показано на следующем рисунке.

     ![Таймер](../ide/media/express-timer.png "Express_Timer") Активности
...
3. Выберите значок элемента управления Timer в конструктор Windows Forms а затем нажмите клавишу ВВОД или дважды щелкните таймер, чтобы добавить пустой обработчик событий **Tick** . Замените код следующим кодом или вручную введите следующий код в обработчик событий.
...
- Следующий шаг руководства см. в разделе [Шаг 7. отображение пар](../ide/step-7-keep-pairs-visible.md).
