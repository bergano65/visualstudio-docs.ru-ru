---
title: Шаг 6. Добавление таймера | Документация Майкрософт
ms.date: 11/15/2016
...
- Предыдущий раздел руководства: [Шаг 5. Добавление ссылок на метки](../ide/step-5-add-label-references.md).
