...
- Компонент, использующий [!INCLUDE[net_v40_short](../includes/net-v40-short-md.md)], несовместим с проектом, нацеленным на [!INCLUDE[net_v45](../includes/net-v45-md.md)].  
     ...
     При создании нового приложения некоторые проекты нацелены на [!INCLUDE[net_v45](../includes/net-v45-md.md)] по умолчанию. Дополнительные сведения см. в разделе [Клиентский профиль .NET Framework](http://msdn.microsoft.com/library/f0219919-1f02-4588-8704-327a62fd91f1).  
