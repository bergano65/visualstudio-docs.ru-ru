---
title: Как выполнить Добавление и удаление ссылок с помощью диспетчера ссылок | Документация Майкрософт
ms.date: 11/15/2016
