...
|MSBuild автоматически использует H- или LIB-файлы.|Y|Файл *сдкнаме*. props сообщает Visual Studio о том, как настроить каталог Visual C++ и т. д. для автоматического использования файлов. h или. lib.|N||
...
|Механизм поддерживает указание сведений о регистрации собственных WINMD-файлов.|Y|Можно указать взаимосвязь между WINMD- и DLL-файлами в SDKManifest.xml.|N||
...
|Механизм доступен для всех типов проектов.|N|Пакет SDK поддерживает приложения [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)], начиная с [!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)].|N|Можно просмотреть список доступных проектов.|
