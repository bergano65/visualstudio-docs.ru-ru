...
ms.locfileid: "47559976"
---
# <a name="use-regular-expressions-in-visual-studio"></a>Использование регулярных выражений в Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [использование регулярных выражений в Visual Studio](https://docs.microsoft.com/visualstudio/ide/using-regular-expressions-in-visual-studio).
