...
ms.locfileid: "47561211"
---
# <a name="step-9-review-comment-and-test-your-code"></a>Шаг 9. Проверка, комментирование и тестирование кода
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Step 9: проверка, комментарий и тестирование кода](https://docs.microsoft.com/visualstudio/ide/step-9-review-comment-and-test-your-code).  
