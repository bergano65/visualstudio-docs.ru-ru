...
## <a name="file-locations"></a>Местоположение файлов
...
## <a name="see-also"></a>См. также:
 [Visual Basic фрагментов кода IntelliSense](https://msdn.microsoft.com/library/ffdde4c9-8141-4906-b09b-15181357a643) [Защита](../ide/securing-applications.md) [фрагментов кода](../ide/code-snippets.md) приложений
