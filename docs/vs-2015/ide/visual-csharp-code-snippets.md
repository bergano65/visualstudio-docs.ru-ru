...
|interface|Создает объявление [interface](https://msdn.microsoft.com/library/7da38e81-4f99-4bc5-b07d-c986b687eeba).|Внутри пространства имен (включая глобальное пространство имен), класса или структуры.|
...
## <a name="see-also"></a>См. также раздел
 [Фрагмент кода функция](../ide/code-snippet-functions.md) ["фрагменты](../ide/code-snippets.md) кода [". Создание нового фрагмента с помощью](https://msdn.microsoft.com/8d56d43c-097a-475b-aa85-cae1554b6338) [параметров шаблона](../ide/template-parameters.md) . [как использовать окружающие](../ide/how-to-use-surround-with-code-snippets.md) фрагменты кода как [восстановить C# фрагменты рефакторинга](../ide/how-to-restore-csharp-refactoring-snippets.md)
