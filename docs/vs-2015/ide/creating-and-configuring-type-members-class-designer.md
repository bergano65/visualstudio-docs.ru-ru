...
## <a name="creating-members"></a><a name="CreateMembers"></a> Создание членов
...
## <a name="modifying-type-members"></a><a name="ModifyTypeMembers"></a> Изменение членов типа
 Конструктор классов позволяет изменять члены типов, отображаемые на схеме. Можно изменить члены любого типа, которые отображаются на схеме классов и не являются доступными только для чтения. (См. раздел [Отображение информации только для чтения (конструктор классов)](https://msdn.microsoft.com/33e2d3a9-1668-4d10-ae56-fa09b3156e0a).) Вы изменяете члены типа, используя редактирование на месте в области конструктора, окно свойств и окно сведения о классах.
...
- **\<add member>**
     ...
     Последняя строка в окне Сведения о классах содержит текст **\<add member>** в ячейке **Имя**. Если выбрана данная ячейка, то можно создать новый член. Дополнительные сведения см. в разделе [Создание членов](../ide/creating-and-configuring-type-members-class-designer.md#CreateMembers).
...
2. Если окно "сведения о классах" не отображается, нажмите кнопку **окно подробного представления класса** на панели инструментов Конструктор классов.
...
## <a name="adding-parameters-to-methods"></a><a name="AddMethodParams"></a> Добавление параметров в методы
...
- **Type**
   ...
   В ячейке **типа параметра** используется технология IntelliSense, позволяющая выбирать из списка всех типов, доступных в текущем проекте или проектах, на которые имеются ссылки.
...
### <a name="to-add-a-parameter-to-a-method"></a><a name="HowToAddParameterToMethod"></a> Добавление параметра в метод
...
## <a name="class-details-usage-notes"></a><a name="ClassDetailsUsageNotes"></a> Примечания об использовании сведений о классах
...
- Весь тип доступен только для чтения, если, например, он находится в упоминаемой сборке (см. раздел [Отображение информации только для чтения (конструктор классов)](https://msdn.microsoft.com/33e2d3a9-1668-4d10-ae56-fa09b3156e0a).) При выборе фигуры в конструктор классов окно сведения о классе отображает сведения о нем в состоянии только для чтения.
...
- Если код типа является нечитаемым (нераспознанным), окно "Сведения о классе" отображает содержимое типа как доступное только для чтения.
  ...
  **окно подробного представления класса и исходный код**
...
- Если код типа является нечитаемым (нераспознанным), окно "Сведения о классе" отображает содержимое типа как доступное только для чтения.
  ...
  **Функции буфера обмена в окно подробного представления класса**
...
## <a name="display-of-read-only-information"></a><a name="ReadOnlyInfo"></a> Отображение информации только для чтения
