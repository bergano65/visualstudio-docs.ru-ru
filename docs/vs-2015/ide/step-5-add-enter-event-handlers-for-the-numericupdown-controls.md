---
title: Шаг 5. Добавление обработчиков событий входа для элементов управления NumericUpDown | Документация Майкрософт
ms.date: 11/15/2016
...
- Следующий раздел руководства: [Шаг 6. Добавить задачу на вычитание](../ide/step-6-add-a-subtraction-problem.md).  
