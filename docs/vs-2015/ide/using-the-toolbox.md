...
ms.locfileid: "47557780"
---
# <a name="using-the-toolbox"></a>Использование панели элементов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [с помощью панели элементов](https://docs.microsoft.com/visualstudio/ide/using-the-toolbox).  
