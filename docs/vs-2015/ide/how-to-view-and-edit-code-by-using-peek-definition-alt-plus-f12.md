---
title: Практическое руководство. Просмотр и изменение кода с помощью "Показать определение" (Alt + F12) | Документация Майкрософт
ms.date: 11/15/2016
...
1. Чтобы открыть окно **Показать определение**, откройте контекстное меню для нужного метода. (Клавиатура: ALT + F12)  
