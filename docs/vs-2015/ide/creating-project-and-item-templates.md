...
## <a name="visual-studio-templates"></a>Шаблоны Visual Studio
 ...
 В дополнение к установленным шаблонам в диалоговых окнах **Новый проект** и **Добавление нового элемента** можно создавать собственные шаблоны или загружать и использовать шаблоны, созданные сообществом. Дополнительные сведения см. в статьях [как создавать шаблоны проектов](../ide/how-to-create-project-templates.md) и [как создавать шаблоны элементов](../ide/how-to-create-item-templates.md).
...
## <a name="see-also"></a>См. также:
 [Как создавать шаблоны проектов](../ide/how-to-create-project-templates.md) создание шаблонов [элементов шаблоны](../ide/how-to-create-item-templates.md) [Параметры](../ide/template-parameters.md) [Настройка шаблонов](../ide/customizing-project-and-item-templates.md) [руководство: создание начальных наборов](../ide/how-to-create-starter-kits.md)
