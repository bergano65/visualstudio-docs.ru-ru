...
ms.locfileid: "47560453"
---
# <a name="step-5-add-controls-to-your-form"></a>Шаг 5. Добавление элементов управления в форму
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Step 5: Добавление элементов управления в форму](https://docs.microsoft.com/visualstudio/ide/step-5-add-controls-to-your-form).  
