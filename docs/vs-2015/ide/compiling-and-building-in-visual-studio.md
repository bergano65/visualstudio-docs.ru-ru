...
## <a name="see-also"></a>См. также
 [Пошаговое руководство: ](../ide/walkthrough-building-an-application.md) Создание приложения [Общие сведения о конфигурациях сборки](../ide/understanding-build-configurations.md) [Общие сведения о сборках платформы](../ide/understanding-build-platforms.md) [Построение (компиляция) проекты](https://msdn.microsoft.com/library/a9cbb88c-8fff-4c67-848b-98fbfd823193) [веб-сайтов как: Создание и удаление зависимостей проекта](../ide/how-to-create-and-remove-project-dependencies.md)
