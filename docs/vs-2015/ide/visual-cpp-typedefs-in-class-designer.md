...
## <a name="see-also"></a>См. также:
 [Работа с описателем typedef для Visual C++ Code (конструктор классов)](../ide/working-with-visual-cpp-code-class-designer.md) [(сборке)](https://msdn.microsoft.com/cc96cf26-ba93-4179-951e-695d1f5fdcf1)
