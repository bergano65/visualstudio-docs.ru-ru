...
> [!TIP]
>  Запуск мастера настройки источников данных позволяет автоматически создать и настроить большинство элементов данных. Дополнительные сведения см. в разделе [создание данных приложений с помощью Visual Studio](http://msdn.microsoft.com/28edce21-220a-484c-b461-a75b0232d293).  
