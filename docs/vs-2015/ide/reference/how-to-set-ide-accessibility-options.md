...
3. Выберите **панель инструментов** , а затем имя панели инструментов, содержащей кнопку, для которой требуется отобразить текст.
...
## <a name="see-also"></a>См. также:
 [Специальные возможности ресурсов Visual Studio](../../ide/reference/accessibility-features-of-visual-studio.md) [для разработки приложений со специальными возможностями](../../ide/reference/resources-for-designing-accessible-applications.md)
