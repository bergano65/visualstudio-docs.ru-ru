...
## <a name="see-also"></a>См. также раздел  
 ...
 [Вкладка "Стандартные", панель элементов](https://msdn.microsoft.com/library/35e9320d-fcbd-474b-8b8f-55705e9a1870)   
 [Элементы управления HTML](https://msdn.microsoft.com/library/83bc6f7e-a2b5-4fe9-9a34-eb34aef673be)
