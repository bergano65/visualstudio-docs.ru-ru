 ...
 **Включение ведущего процесса Visual Studio** Установите этот флажок, чтобы включить ведущий процесс Visual Studio. Это флажок установлен по умолчанию. Дополнительные сведения см. в статье [Ведущий процесс (vshost.exe)](../../ide/hosting-process-vshost-exe.md).
