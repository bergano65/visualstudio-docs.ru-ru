...
ms.locfileid: "47570733"
---
# <a name="options-text-editor-general"></a>Параметры, текстовый редактор, общие
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [параметры "," Текстовый редактор "," Общие](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-general).  
