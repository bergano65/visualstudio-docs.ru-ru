...
Последнюю версию этого раздела можно найти в [Advanced компилятора диалоговое окно параметров (Visual Basic)](https://docs.microsoft.com/visualstudio/ide/reference/advanced-compiler-settings-dialog-box-visual-basic).  
