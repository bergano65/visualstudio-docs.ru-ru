...
ms.locfileid: "47571090"
---
# <a name="build-devenvexe"></a>/Build (devenv.exe)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [-Build (devenv.exe)](https://docs.microsoft.com/visualstudio/ide/reference/build-devenv-exe).  
