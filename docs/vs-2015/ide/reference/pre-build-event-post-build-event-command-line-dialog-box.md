...
Последнюю версию этого раздела можно найти в [перед сборкой события после сборки событий командной строки "диалоговое окно"](https://docs.microsoft.com/visualstudio/ide/reference/pre-build-event-post-build-event-command-line-dialog-box).  
