...
ms.locfileid: "47571264"
---
# <a name="code-snippet-picker"></a>выбор фрагмента кода
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [средство выбора фрагмента кода](https://docs.microsoft.com/visualstudio/ide/reference/code-snippet-picker).  
