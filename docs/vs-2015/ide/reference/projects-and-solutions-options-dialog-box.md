 ...
 **Размещение пользовательских шаблонов проектов**  
 Задает расположение по умолчанию, используемое диалоговым окном **Новый проект** для создания списка **Мои шаблоны**. Дополнительные сведения см. в разделе [Практическое руководство. Размещение и упорядочение шаблонов](../../ide/how-to-locate-and-organize-project-and-item-templates.md).  
  
 **Размещение пользовательских шаблонов элементов**  
 Задает расположение по умолчанию, используемое диалоговым окном **Добавление нового элемента** для создания списка **Мои шаблоны**. Дополнительные сведения см. в разделе [Практическое руководство. Размещение и упорядочение шаблонов](../../ide/how-to-locate-and-organize-project-and-item-templates.md).  
 ...
 **Показывать окно вывода при запуске построения**  
 Автоматически отображает окно вывода в интегрированной среде разработки с самого начала построения решения. Дополнительные сведения см. в разделе [Практическое руководство. Управление окном вывода](https://msdn.microsoft.com/library/91aebd15-8854-4a7a-9f7d-57376fb4e858). Этот параметр по умолчанию включен.  
