...
ms.locfileid: "47573278"
---
# <a name="application-page-project-designer-c"></a>Страница "Приложение" в конструкторе проектов (C#)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Application Page, Project Designer (C#)](https://docs.microsoft.com/visualstudio/ide/reference/application-page-project-designer-csharp).  
...
>  Среда выполнения Windows может проецировать типы, чтобы они представлялись как собственные объекты на любом языке. Например, в приложениях JavaScript, взаимодействующих со средой выполнения Windows, она используется как набор объектов JavaScript, а в приложениях C# эта библиотека используется как коллекция объектов .NET. Упаковав выходные данные проекта в файл WinMD, можно использовать те же технологии, которые применяются в среде выполнения Windows.  
 ...
 Дополнительные сведения о свойстве **Тип приложения** см. в разделе [/target (параметры компилятора C#)](http://msdn.microsoft.com/library/a18bbd8e-bbf7-49e7-992c-717d0eb1f76f). Дополнительные сведения о программном доступе к этому свойству см. в разделе <xref:VSLangProj.ProjectProperties.OutputType%2A>.  
 ...
 **Автоматически запускаемый объект**  
 ...
 Дополнительные сведения см. в разделе [/main (параметры компилятора C#)](http://msdn.microsoft.com/library/975cf4d5-36ac-4530-826c-4aad0c7f2049). Для программного доступа к этому свойству см. раздел <xref:VSLangProj.ProjectProperties.StartupObject%2A>.  
 ...
 **Значок**  
 Задает ICO-файл для использования в качестве значка программы. Нажмите кнопку с многоточием для выбора имеющегося графического файла или введите имя нужного файла. Дополнительные сведения см. в разделе [/win32icon (параметры компилятора C#)](http://msdn.microsoft.com/library/756d9b6d-ab07-41b7-ba58-5bd88f711138). Для программного доступа к этому свойству см. раздел <xref:VSLangProj.ProjectProperties.ApplicationIcon%2A>.  
...
[Управление свойствами приложения](../../ide/application-properties.md)  
 [Написание кода в решениях Office](http://msdn.microsoft.com/library/2d4d8fd0-e881-4829-976f-0d1a9221dec0)
