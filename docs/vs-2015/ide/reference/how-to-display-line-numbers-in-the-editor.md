...
Последнюю версию этого раздела можно найти в [как: отображение номеров строк в редакторе](https://docs.microsoft.com/visualstudio/ide/reference/how-to-display-line-numbers-in-the-editor).  
