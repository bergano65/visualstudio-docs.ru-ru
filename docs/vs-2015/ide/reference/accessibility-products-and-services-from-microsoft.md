...
Последнюю версию этого раздела можно найти в [специальных возможностях в продуктах и услугах корпорации](https://docs.microsoft.com/visualstudio/ide/reference/accessibility-products-and-services-from-microsoft).  
