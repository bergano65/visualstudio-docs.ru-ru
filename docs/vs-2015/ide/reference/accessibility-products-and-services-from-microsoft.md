...
Корпорация Майкрософт стремится стремится сделать использование своих продуктов и услуг простым для всех пользователей. В следующих разделах содержатся сведения о возможностях, продуктах и службах, облегчающих работу с Microsoft Windows для людей с ограниченными возможностями.
...
### <a name="free-step-by-step-tutorials"></a>Бесплатные пошаговые учебники
 ...
 Пошаговые учебники по продуктам Microsoft доступны на веб-сайте [Microsoft Accessibility](https://www.microsoft.com/enable/default.aspx).

### <a name="assistive-technology-products-for-windows"></a>Продукты поддержки специальных возможностей для Windows
 Существует широкий спектр продуктов с поддержкой специальных возможностей, облегчающих инвалидам использование компьютера. Чтобы просмотреть каталог продуктов с поддержкой специальных возможностей для Windows, посетите веб-сайт [Microsoft Accessibility](https://www.microsoft.com/enable/default.aspx).
...
## <a name="documentation-in-alternative-formats"></a>Документация корпорации <a name="altfortmats"></a> в альтернативных форматах
...
|Learning Ally|
|----------------------------------------------|
|20 Roszel Road<br /><br /> Princeton, NJ 08540<br /><br /> Веб-сайт Learning Ally: [http://www.learningally.org](https://learningally.org/) .|

 Веб-адреса могут меняться, поэтому подключение к веб-сайту или сайтам, указанным в данном разделе, может быть невозможно.

## <a name="customer-service-for-people-with-hearing-impairments"></a><a name="hearing"></a> Служба клиента для людей с нарушениями слуха
...
## <a name="for-more-information"></a><a name="moreinfo"></a> Дополнительные сведения
 Дополнительные сведения о том, как поддержка специальных возможностей помогает улучшить жизнь людей с ограниченными возможностями, см. на веб-сайте [Microsoft Accessibility](https://www.microsoft.com/enable/default.aspx).

## <a name="see-also"></a>См. также:
 [Ресурсы для разработки](../../ide/reference/resources-for-designing-accessible-applications.md) [специальных возможностей приложений в Visual Studio](../../ide/reference/accessibility-features-of-visual-studio.md)
