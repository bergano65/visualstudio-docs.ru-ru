 ...
 ** \<** *n* **> элементы, сохраненные в проекте прочих файлов** , указывают количество файлов, сохраняемых в папке **Прочие файлы** **Обозреватель решений**. Эти файлы будут отображаться в списке, даже если они больше не открыты в редакторе. Можно указать любое целое число от 0 до 256. По умолчанию задано значение 0.
