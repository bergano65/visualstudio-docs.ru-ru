...
## <a name="tabs"></a>Вкладки
 Размер интервала табуляции Устанавливает расстояние в пробелах между табуляторами. По умолчанию этот параметр равен четырем пробелам.

 Размер отступа Устанавливается размер автоматического отступа в пробелах. По умолчанию этот параметр равен четырем пробелам. Для заполнения указанного размера вставляются символы табуляции, символы пробела или оба этих вида символов.
 ...
 Заключать вкладки при выборе. операции отступа вставляют максимально возможное количество символов ТАБУЛЯЦИи. Каждый символ ТАБУЛЯЦИи заполняет количество пробелов, указанное в поле **размер табуляции**. Если **размер отступа** не кратен **размеру интервала табуляции**, для заполнения разницы добавляются знаки пробелов.
