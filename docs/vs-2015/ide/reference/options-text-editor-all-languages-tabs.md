...
ms.locfileid: "47568444"
---
# <a name="options-text-editor-all-languages-tabs"></a>"Параметры", "Текстовый редактор", "Все языки", "Вкладки"
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [параметры "," Текстовый редактор "," все языки "," вкладки](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-all-languages-tabs).  
