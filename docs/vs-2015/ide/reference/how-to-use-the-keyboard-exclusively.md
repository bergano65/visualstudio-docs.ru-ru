...
ms.locfileid: "47559908"
---
# <a name="how-to-use-the-keyboard-exclusively"></a>Практическое руководство. Использование только клавиатуры
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [как: использование только клавиатуры](https://docs.microsoft.com/visualstudio/ide/reference/how-to-use-the-keyboard-exclusively).  
