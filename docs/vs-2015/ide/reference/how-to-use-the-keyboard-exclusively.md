...
[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] предоставляет много стандартных сочетаний клавиш, чтобы упростить навигацию и создание кода в интегрированной среде разработки (IDE). Полный список сочетаний клавиш, используемых в Visual Studio, см. в разделе [сочетания клавиш по умолчанию](../../ide/default-keyboard-shortcuts-in-visual-studio.md). Дополнительные сведения о сочетаниях клавиш, доступных для других продуктов Майкрософт, см. в разделе [http://www.microsoft.com/enable/products/keyboard.aspx](https://www.microsoft.com/enable/products/keyboard.aspx) .
...
2. Изменение настроек параметров
    ...
    - Для раскрывающихся списков используйте **сочетание клавиш ALT**  +  **стрелка вниз** , чтобы отобразить элементы, а затем используйте **стрелки** и **стрелка вниз** для изменения выбранного элемента.

    - Для кнопок нажмите клавишу **Ввод** для вызова.

    - Для перемещения по таблицам используйте клавиши со стрелками. Для раскрывающихся списков в сетках используйте **клавиши Shift**  +  **ALT**  +  **стрелка вниз** , чтобы отобразить элементы, а затем используйте **стрелки** и **стрелка вниз** для изменения выбранного элемента.
...
3. Нажмите клавиши **ALT**  +  **пробел** и выберите **переместить**.

     Появится ромб направляющей закрепления.

4. Используйте клавиши **со стрелками** для перемещения окна в новое место.

     Указатель мыши перемещается вместе с окном при использовании клавиш **со стрелками** .
