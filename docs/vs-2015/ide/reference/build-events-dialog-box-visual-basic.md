 ...
 **Командная строка события после сборки** Определяет команды, выполняемые после завершения сборки. Чтобы ввести длинные команды, нажмите кнопку **изменить событие после сборки** , чтобы отобразить поле **Командная строка командная события перед сборкой**.
