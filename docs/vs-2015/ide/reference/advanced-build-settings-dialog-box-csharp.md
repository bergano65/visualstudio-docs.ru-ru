...
- **default**
  ...
  **Проверка арифметического переполнения или потери точности** Указывает, вызывает ли исключение во время выполнения целочисленный арифметический оператор, не находящийся в области ключевых слов [checked](https://msdn.microsoft.com/library/718a1194-988d-48a3-b089-d6ee8bd1608d) или [unchecked](https://msdn.microsoft.com/library/0c021f7c-923f-4b3d-a58f-55336f5ac27e) , и результатом которого является значение вне диапазона типа данных. Дополнительные сведения см. в разделе [/checkedC# (параметры компилятора)](https://msdn.microsoft.com/library/fb7475d3-e6a6-4e6d-b86c-69e7a74c854b).
