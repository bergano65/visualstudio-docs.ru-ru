...
## <a name="see-also"></a>См. также:
 Рефакторинг при [настройке параметров редактора для конкретного языка](../../ide/reference/setting-language-specific-editor-options.md) [в C++ (блог VC)](https://devblogs.microsoft.com/cppblog/all-about-c-refactoring-in-visual-studio-2015-preview/)
