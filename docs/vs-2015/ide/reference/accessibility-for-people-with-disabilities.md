...
ms.locfileid: "47572803"
---
# <a name="accessibility-for-people-with-disabilities"></a>Специальные функции для людей с ограниченными возможностями
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [специальные возможности для людей с ограниченными возможностями](https://docs.microsoft.com/visualstudio/ide/reference/accessibility-for-people-with-disabilities).  
