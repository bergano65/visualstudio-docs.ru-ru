...
## <a name="statement-completion"></a>Завершение операторов
 Автосписок членов если этот флажок установлен, IntelliSense отображает всплывающие списки доступных элементов, свойств, значений или методов при вводе в редакторе. При выборе любого элемента из выпадающего списка он будет вставлен в код. При выборе этого параметра включается параметр **Скрывать дополнительные члены**.
