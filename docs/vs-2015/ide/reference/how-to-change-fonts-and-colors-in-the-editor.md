...
Можно изменить начертание шрифта по умолчанию, изменить размер шрифта и изменить цвет переднего плана и фона для различных **отображаемых элементов** текста в редакторе кода. При изменении параметров шрифта учитывайте следующее:
