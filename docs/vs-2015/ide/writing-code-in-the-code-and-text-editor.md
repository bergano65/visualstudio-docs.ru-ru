...
## <a name="navigate-in-the-code-window"></a>Навигация в окне кода
 ...
 ![Кнопки навигации вперед и назад](../ide/media/vs2015-nav-buttons.png "VS2015_Nav_buttons")
...
1. В текстовом поле введите имя элемента кода, который требуется найти.
    ...
    ![Переход к окну](../ide/media/vside-navigatetowindow.png "Окно "Перейти"")
...
Чтобы ограничить поиск только символами кода, передайте запрос с помощью символа "\@". Например, при поиске `@application` команда "Перейти к" отображает, скажем, только классы, которые содержат слово "application".
...
![Переход к окну "Поиск" с прописными буквами](../ide/media/vside-capitalsearch.png "Окно "Перейти" — поиск по прописным буквам")
