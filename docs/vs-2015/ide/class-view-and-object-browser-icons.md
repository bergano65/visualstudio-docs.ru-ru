...
ms.locfileid: "47572020"
---
# <a name="class-view-and-object-browser-icons"></a>Значки представления классов и обозревателя объектов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [объект браузера значки представления классов и](https://docs.microsoft.com/visualstudio/ide/class-view-and-object-browser-icons).  
