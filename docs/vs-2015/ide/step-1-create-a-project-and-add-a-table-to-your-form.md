---
title: Шаг 1. Создание проекта и Добавление таблицы в форму | Документация Майкрософт
ms.date: 11/15/2016
...
- Предыдущая статья с общими сведениями: [Руководство 3. Создать соответствующий игру](../ide/tutorial-3-create-a-matching-game.md).
