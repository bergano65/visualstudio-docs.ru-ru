...
Последнюю версию этого раздела можно найти в [Step 4: создание макета формы с элементом управления TableLayoutPanel](https://docs.microsoft.com/visualstudio/ide/step-4-lay-out-your-form-with-a-tablelayoutpanel-control).  
