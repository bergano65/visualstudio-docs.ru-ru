...
ms.locfileid: "47563796"
---
# <a name="encodings-and-line-breaks"></a>Кодировки и разрывы строк
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [кодировки и разрывы строк](https://docs.microsoft.com/visualstudio/ide/encodings-and-line-breaks).  
