...
-   **[Создание приложений Office](https://msdn.microsoft.com/library/fp161347.aspx)** : создание приложений Office, которые расширяют и настраивают Word, Excel, Outlook и PowerPoint с использованием служб Office 365.  
