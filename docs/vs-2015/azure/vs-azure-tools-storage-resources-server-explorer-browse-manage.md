...
* Вы не можете изменить значения **PartitionKey** или **RowKey** , так как хранилище таблиц в Azure не поддерживает эту операцию.
