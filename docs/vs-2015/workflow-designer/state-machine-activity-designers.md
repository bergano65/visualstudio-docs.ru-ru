---
title: Конструкторы действий конечного автомата | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="in-this-section"></a>Содержание
 ...
 [FinalState](../workflow-designer/finalstate-activity-designer.md) Представляет состояние, которое завершает работу экземпляра конечного автомата.

 [Переход](../workflow-designer/transition-activity-designer.md) на Представляет переход между двумя состояниями.
