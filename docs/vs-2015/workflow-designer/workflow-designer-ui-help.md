...
В этом разделе контекстной справки содержатся разделы, относящиеся к приложению [!INCLUDE[wfd1](../includes/wfd1-md.md)]. При работе в [!INCLUDE[vs2010](../includes/vs2010-md.md)] можно получить доступ к этим темам из пользовательского интерфейса, нажав клавишу **F1** , когда открыто диалоговое окно [!INCLUDE[wfd2](../includes/wfd2-md.md)].
