...
Диалоговое окно « **Инициализация корреляции** » используется в [!INCLUDE[wfd1](../includes/wfd1-md.md)] для изменения <xref:System.ServiceModel.Activities.InitializeCorrelation.CorrelationData%2A> свойства <xref:System.ServiceModel.Activities.InitializeCorrelation> действия. [!INCLUDE[crdefault](../includes/crdefault-md.md)] раздел [InitializeCorrelation](../workflow-designer/initializecorrelation-activity-designer.md) .
