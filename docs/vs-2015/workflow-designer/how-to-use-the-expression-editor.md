...
3. Щелкните редактор выражений в конструкторе операций для действия <xref:System.Activities.Statements.Assign>.
     ...
     Строки с серым водяным знаком **\<To >** и **\<Enter выражение VB >** являются текстовыми строками по умолчанию для редакторов выражений в действии <xref:System.Activities.Statements.Assign>.
