...
7. В текстовом поле **имя решения** введите **кппдемо**.  
...
4. Скопируйте приведенный ниже код и вставьте его в файл **Bug. cpp** в [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] редакторе.  
...
8. Скопируйте приведенный ниже код и вставьте его в файл Bug. h в [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] редакторе.  
...
4. Скопируйте приведенный ниже код и вставьте его в файл **Annotations. h** в [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] редакторе.  
...
8. Скопируйте приведенный ниже код и вставьте его в файл **Annotations. cpp** в [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] редакторе.  
