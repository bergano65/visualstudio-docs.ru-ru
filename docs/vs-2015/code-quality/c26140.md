...
ms.locfileid: "47568433"
---
# <a name="c26140"></a>C26140
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [C26140](https://docs.microsoft.com/visualstudio/code-quality/c26140).  
  
Предупреждение C26140: неопределенный вид блокировки \<блокировка > в аннотации \<заметки > блокировку \<блокировки >.  
