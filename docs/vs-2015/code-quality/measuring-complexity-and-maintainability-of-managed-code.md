---
title: Измерение сложности и удобства сопровождения управляемого кода | Документация Майкрософт
ms.date: 11/15/2016
...
Повышенная сложность современных программных приложений также повышает сложность обеспечения надежности и сопровождения кода. В последние годы были разработаны многие меры по программному обеспечению, известные как метрики кода, которые помогут разработчикам понять, где код нуждается в переработки или повышении тестирования.
...
## <a name="in-this-section"></a>в этом разделе
 ...
 [Как копировать результаты метрик кода в буфер обмена](https://msdn.microsoft.com/bce8fa29-e39c-4855-aab9-8346257657c5)

 [Руководство. Экспорт результатов метрик кода в Excel](https://msdn.microsoft.com/affc08f3-24e5-446d-9076-bf517663e582)
