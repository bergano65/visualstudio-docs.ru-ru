...
ms.locfileid: "47591945"
---
# <a name="ca1056-uri-properties-should-not-be-strings"></a>CA1056: свойства URI не должны быть строками
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1056: свойства URI не должны быть строками](https://docs.microsoft.com/visualstudio/code-quality/ca1056-uri-properties-should-not-be-strings).
