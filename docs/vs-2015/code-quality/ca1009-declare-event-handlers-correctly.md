...
ms.locfileid: "47591225"
---
# <a name="ca1009-declare-event-handlers-correctly"></a>CA1009: правильно объявите обработчики событий
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1009: правильно объявите обработчики событий](https://docs.microsoft.com/visualstudio/code-quality/ca1009-declare-event-handlers-correctly).
