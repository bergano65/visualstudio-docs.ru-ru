...
ms.locfileid: "47591150"
---
# <a name="ca2233-operations-should-not-overflow"></a>CA2233: в операциях не должно быть переполнений
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA2233: операциях не должно быть переполнений](https://docs.microsoft.com/visualstudio/code-quality/ca2233-operations-should-not-overflow).
