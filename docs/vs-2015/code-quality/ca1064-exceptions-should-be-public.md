...
ms.locfileid: "47591858"
---
# <a name="ca1064-exceptions-should-be-public"></a>CA1064: исключения должны быть открытыми
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1064: исключения должны быть открытыми](https://docs.microsoft.com/visualstudio/code-quality/ca1064-exceptions-should-be-public).
