...
ms.locfileid: "47563600"
---
# <a name="quick-start-code-analysis-for-cc"></a>Краткое руководство. Анализ кода для C/C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [краткое руководство: анализ кода для C/C++](https://docs.microsoft.com/visualstudio/code-quality/quick-start-code-analysis-for-c-cpp).  
