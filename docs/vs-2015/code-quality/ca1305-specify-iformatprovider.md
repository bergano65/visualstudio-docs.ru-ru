...
ms.locfileid: "47591333"
---
# <a name="ca1305-specify-iformatprovider"></a>CA1305: укажите IFormatProvider
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1305: укажите IFormatProvider](https://docs.microsoft.com/visualstudio/code-quality/ca1305-specify-iformatprovider).
