...
Последнюю версию этого раздела можно найти в [CA1005: Избегайте чрезмерного параметров в универсальных типах](https://docs.microsoft.com/visualstudio/code-quality/ca1005-avoid-excessive-parameters-on-generic-types).
