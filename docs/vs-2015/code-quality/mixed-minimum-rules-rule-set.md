...
ms.locfileid: "47571047"
---
# <a name="mixed-minimum-rules-rule-set"></a>Набор правил "Минимальные правила для смешанного кода"
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [смешанной минимальные правила набора правил](https://docs.microsoft.com/visualstudio/code-quality/mixed-minimum-rules-rule-set).  
