...
## <a name="how-to-fix-violations"></a>Устранение нарушений
 Чтобы устранить нарушение этого правила, измените параметр на <xref:System.Uri> тип. Это критическое изменение. Кроме того, можно предоставить перегрузку метода, который принимает <xref:System.Uri> параметр; это неразрывное изменение.
