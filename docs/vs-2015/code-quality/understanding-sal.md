...
```  
 ...
 Можно ли узнать, что делает эта функция? При реализации или вызове функции необходимо поддерживать определенные свойства, чтобы обеспечить правильность программы. Просто взглянув на объявление, такое как в примере, вы не понимаете, что они представляют. Без аннотаций SAL вам пришлось полагаться на документацию или комментарии к коду. Вот что написано в документации MSDN `memcpy` :  
...
### <a name="example-the-_in_opt_-annotation"></a>Пример: \_ In_opt \_ Аннотация  
...
### <a name="example-the-_out_opt_-annotation"></a>Пример: \_ Out_opt \_ Аннотация  
...
### <a name="example-the-_inout_opt_-annotation"></a>Пример: \_ Inout_opt \_ Аннотация  
...
### <a name="example-the-_outptr_opt_-annotation"></a>Пример: \_ Outptr_opt \_ Аннотация  
