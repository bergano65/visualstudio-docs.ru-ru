...
4. Чтобы выполнить анализ кода при каждом построении проекта с использованием выбранной конфигурации, установите флажок **Включить анализ кода при сборке (определяет CODE_ANALYSIS константа)** . Вы также можете запустить анализ кода вручную, открыв меню **анализ** и выбрав пункт **запустить анализ кода в** *имя_проекта*.
...
6. В списке **выполнить этот набор правил** выполните одно из следующих действий.
    ...
    - Нажмите, **\<Browse...>** чтобы указать существующий настраиваемый набор правил, отсутствующий в списке.
