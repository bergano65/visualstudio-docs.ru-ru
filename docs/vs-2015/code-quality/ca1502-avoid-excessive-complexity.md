...
ms.locfileid: "47591279"
---
# <a name="ca1502-avoid-excessive-complexity"></a>CA1502: избегайте чрезмерной сложности
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1502: Избегайте чрезмерной сложности](https://docs.microsoft.com/visualstudio/code-quality/ca1502-avoid-excessive-complexity).
