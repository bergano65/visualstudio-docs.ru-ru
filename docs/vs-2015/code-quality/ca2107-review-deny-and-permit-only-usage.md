...
ms.locfileid: "47591168"
---
# <a name="ca2107-review-deny-and-permit-only-usage"></a>CA2107: проверьте использование deny и permit only
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA2107: Проверьте использование deny и разрешить использование только](https://docs.microsoft.com/visualstudio/code-quality/ca2107-review-deny-and-permit-only-usage).
