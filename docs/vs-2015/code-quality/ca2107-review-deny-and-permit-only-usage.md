...
## <a name="rule-description"></a>Описание правила
 [С помощью метода PermitOnly](https://msdn.microsoft.com/8c7bdb7f-882f-45b7-908c-6cbaa1767649) и <xref:System.Security.CodeAccessPermission.Deny%2A?displayProperty=fullName> действий безопасности следует использовать только те, у кого есть опыт работы с [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] безопасностью. Код, который использует эти действия безопасности, должен быть тщательно проанализирован на предмет безопасности.
...
- @No__t_0 может завершить анализ стека до достижения Deny или PermitOnly.
...
**LinkDemand: этот запрет не оказывает влияния на Код, защищенный с проверкой LinkDemand.**
