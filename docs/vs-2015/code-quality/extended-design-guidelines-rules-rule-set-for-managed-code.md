...
|[CA1007](../code-quality/ca1007-use-generics-where-appropriate.md)|Используйте универсальные типы в том случае, если это уместно|  
...
|[CA1023](../code-quality/ca1023-indexers-should-not-be-multidimensional.md)|Индексаторы не должны быть многомерными|  
...
|[CA1708](../code-quality/ca1708-identifiers-should-differ-by-more-than-case.md)|Идентификаторы должны отличаться регистром|  
...
|[CA1040](../code-quality/ca1040-avoid-empty-interfaces.md)|Избегайте пустых интерфейсов|  
...
|[CA1504](../code-quality/ca1504-review-misleading-field-names.md)|Проверьте имена полей, вводит в заблуждение|  
|[CA1505](../code-quality/ca1505-avoid-unmaintainable-code.md)|Избегайте кода, неудобного для поддержки|  
|[CA1506](../code-quality/ca1506-avoid-excessive-class-coupling.md)|Избегайте чрезмерного соединения классов|  
|[CA1700](../code-quality/ca1700-do-not-name-enum-values-reserved.md)|Не значения перечислений именем «Reserved»|  
|[CA1701](../code-quality/ca1701-resource-string-compound-words-should-be-cased-correctly.md)|Составных словах строк ресурса должны иметь правильный регистр|  
|[CA1702](../code-quality/ca1702-compound-words-should-be-cased-correctly.md)|Составные слова должны иметь правильный регистр|  
|[CA1703](../code-quality/ca1703-resource-strings-should-be-spelled-correctly.md)|Строки ресурсов должны иметь правильное правописание|  
...
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|Не добавляйте префикс в виде значения перечисления с именем типа|  
...
|[CA1714](../code-quality/ca1714-flags-enums-should-have-plural-names.md)|Перечислений флагов должны быть имена во множественном числе|  
...
|[CA1719](../code-quality/ca1719-parameter-names-should-not-match-member-names.md)|Имена параметров не должны совпадать с именами элементов|  
|[CA1720](../code-quality/ca1720-identifiers-should-not-contain-type-names.md)|Идентификаторы не должны содержать имен типов|  
|[CA1721](../code-quality/ca1721-property-names-should-not-match-get-methods.md)|Методы get не должны совпадать с именами свойств|  
...
|[CA1724](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|Имена типов не должны совпадать с пространствами имен|  
...
|[CA1726](../code-quality/ca1726-use-preferred-terms.md)|Используйте предпочитаемые термины|  
