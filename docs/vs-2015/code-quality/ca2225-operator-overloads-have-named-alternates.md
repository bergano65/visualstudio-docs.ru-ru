...
Последнюю версию этого раздела можно найти в [CA2225: перегрузки оператора существуют дополнения с именами](https://docs.microsoft.com/visualstudio/code-quality/ca2225-operator-overloads-have-named-alternates).
