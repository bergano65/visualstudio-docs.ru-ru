...
ms.locfileid: "47572811"
---
# <a name="native-recommended-rules-rule-set"></a>Набор правил "Рекомендуемые правила для машинного кода"
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [собственного рекомендуемые правила набора правил](https://docs.microsoft.com/visualstudio/code-quality/native-recommended-rules-rule-set).  
