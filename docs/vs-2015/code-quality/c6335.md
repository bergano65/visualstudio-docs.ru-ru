...
```  
 ...
 Дополнительные сведения см. в разделе [функция CreateProcess](https://go.microsoft.com/fwlink/?LinkId=181206) и [функция CloseHandle](https://go.microsoft.com/fwlink/?LinkId=181207).
