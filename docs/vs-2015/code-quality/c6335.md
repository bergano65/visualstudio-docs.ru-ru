...
```  
 ...
 Дополнительные сведения см. в разделе [функция CreateProcess](https://msdn.microsoft.com/library/ms682425.aspx) и [функция CloseHandle](https://msdn.microsoft.com/library/ms724211.aspx).
