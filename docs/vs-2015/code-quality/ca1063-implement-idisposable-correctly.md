...
ms.locfileid: "47591174"
---
# <a name="ca1063-implement-idisposable-correctly"></a>CA1063: следует правильно реализовывать IDisposable
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [ca1063 следует: реализовывать IDisposable правильно](https://docs.microsoft.com/visualstudio/code-quality/ca1063-implement-idisposable-correctly).
