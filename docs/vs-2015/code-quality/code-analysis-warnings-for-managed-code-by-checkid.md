...
|CA1063|[CA1063: СЛЕДУЕТ Правильно реализуйте IDisposable](../code-quality/ca1063-implement-idisposable-correctly.md)|Все типы IDisposable должны правильно реализовывать шаблон "Dispose".|  
