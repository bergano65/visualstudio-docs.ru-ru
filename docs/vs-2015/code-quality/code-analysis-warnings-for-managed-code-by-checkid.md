---
title: Предупреждения анализа управляемого кода по идентификатору CheckId кода | Документация Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
Последнюю версию этого раздела можно найти в [предупреждения при анализе управляемого кода по идентификатору CheckId](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-warnings-for-managed-code-by-checkid).  
...
|CA1404|[CA1404: вызывайте GetLastError сразу после P/Invoke](../code-quality/ca1404-call-getlasterror-immediately-after-p-invoke.md)|Выполняется вызов метода Marshal.GetLastWin32Error или эквивалентной [!INCLUDE[TLA2#tla_win32](../includes/tla2sharptla-win32-md.md)] Функция GetLastError, а непосредственно предшествующий вызов не операционную систему вызов метода.|  
