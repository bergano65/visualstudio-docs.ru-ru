...
ms.locfileid: "47592009"
---
# <a name="ca1024-use-properties-where-appropriate"></a>CA1024: используйте свойства, если это уместно
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1024: используйте свойства, если это уместно](https://docs.microsoft.com/visualstudio/code-quality/ca1024-use-properties-where-appropriate).
