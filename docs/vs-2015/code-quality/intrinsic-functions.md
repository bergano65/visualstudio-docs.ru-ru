...
ms.locfileid: "47571362"
---
# <a name="intrinsic-functions"></a>Встроенные функции
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [встроенные функции](https://docs.microsoft.com/visualstudio/code-quality/intrinsic-functions).  
