...
ms.locfileid: "47591240"
---
# <a name="ca1050-declare-types-in-namespaces"></a>CA1050: объявляйте типы в пространствах имен
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [CA1050: объявляйте типы в пространствах имен](https://docs.microsoft.com/visualstudio/code-quality/ca1050-declare-types-in-namespaces).
