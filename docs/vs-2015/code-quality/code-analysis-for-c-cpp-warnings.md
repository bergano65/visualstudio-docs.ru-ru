...
ms.locfileid: "77275332"
---
# <a name="code-analysis-for-cc-warnings"></a>Анализ кода для предупреждений C/C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

В этом разделе перечислены предупреждения анализа кода C и C++. Дополнительные сведения об анализе кода см. в разделе [/Analyze (анализ кода)](https://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08) и [быстрое начало: анализ кода для C/C++](../code-quality/quick-start-code-analysis-for-c-cpp.md).  
  
## <a name="see-also"></a>См. также:  
 [Рекомендации по написанию безопасного кода](https://msdn.microsoft.com/9892fd19-45cd-44b6-9fa8-10f1b5cb6ea4)   
 [Анализ качества кода C/C++ с помощью анализа кода](../code-quality/analyzing-c-cpp-code-quality-by-using-code-analysis.md)   
