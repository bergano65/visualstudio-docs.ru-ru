...
Последнюю версию этого раздела можно найти в [как: Создание или обновление стандартный анализ кода политики](https://docs.microsoft.com/visualstudio/code-quality/how-to-create-or-update-standard-code-analysis-check-in-policies).  
