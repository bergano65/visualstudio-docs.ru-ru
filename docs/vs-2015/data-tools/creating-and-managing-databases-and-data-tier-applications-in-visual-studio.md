...
Внимание!
> Проекты баз данных, включенные в более ранние версии [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], теперь доступны в [!INCLUDE[sql_Denali_long](../includes/sql-denali-long-md.md)] средствах. Дополнительные сведения см. в разделе [SQL Server Developer Tools](https://go.microsoft.com/fwlink/?LinkId=228126).
