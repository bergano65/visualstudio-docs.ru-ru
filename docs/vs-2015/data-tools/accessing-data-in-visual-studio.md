...
## <a name="in-this-section"></a>Содержание раздела
 ...
 [Visual Studio data tools для .NET](http://msdn.microsoft.com/6b145922-2f00-47db-befc-bf351b4809a1) описывается использование окон инструментов Visual Studio для подключения к источникам данных, создать наборы данных или модели Entity Framework и привязки данных к элементам пользовательского интерфейса.
...
## <a name="related-topics"></a>См. также
 ...
 [ADO.NET](http://msdn.microsoft.com/library/5b96ed06-9759-4966-a797-a1d5f6ee50ca) описание архитектуры ADO.NET и способов использования классов ADO.NET для управления данными приложения и взаимодействия с источниками данных и XML.
 ...
 [Службы данных WCF 4.5](http://msdn.microsoft.com/library/73d2bec3-7c92-4110-b905-11bb0462357a) описывается использование [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] для развертывания служб данных в Интернете или интрасети, которые реализуют [Open Data Protocol (OData)](http://go.microsoft.com/fwlink/?LinkID=182204).

 [Данные в решениях Office](http://msdn.microsoft.com/library/8478c095-864b-4ed3-8a70-1fc19b411c6a) содержит ссылки на разделы с пояснением работы данных в решениях Office. Сюда входят сведения о схемо ориентированном программировании, кэшировании данных и доступа к данным на стороне сервера.

 [LINQ (Language-Integrated Query)](http://msdn.microsoft.com/library/a73c4aec-5d15-4e98-b962-1274021ea93d) описывает возможности запросов, встроенных в C# и Visual Basic и общей модели для запроса реляционных баз данных, XML документы, наборы данных и коллекциям в памяти.
 ...
 [XML-документы и данные](http://msdn.microsoft.com/library/e695047f-3c0f-4045-8708-5baea91cc380) здесь приводится обзор подробного и интегрированного набора классов, которые работают с XML-документами и данными в .NET Framework.
