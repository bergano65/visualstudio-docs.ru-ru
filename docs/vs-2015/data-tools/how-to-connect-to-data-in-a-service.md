...
ms.locfileid: "65684743"
---
# <a name="how-to-connect-to-data-in-a-service"></a>Практическое руководство. подключение к данным в службе
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Подключение приложения к данным, возвращаемым службой, выполнив [мастер настройки источника данных](https://msdn.microsoft.com/library/c4df7de5-5da0-4064-940c-761dd6d9e28f) и выбрав **службы** на **Выбор типа источника данных**страницы.  
  
 После завершения работы мастера, добавляется в проект ссылку на службу и немедленно становится доступной в [окна "Источники данных"](https://msdn.microsoft.com/library/0d20f699-cc95-45b3-8ecb-c7edf1f67992).  
