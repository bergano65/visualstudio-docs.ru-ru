...
ms.locfileid: "47563451"
---
# <a name="query-datasets"></a>Наборы данных запросов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [запрашивайте наборы данных](https://docs.microsoft.com/visualstudio/data-tools/query-datasets).  
