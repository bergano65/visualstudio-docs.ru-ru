...
ms.locfileid: "47560723"
---
# <a name="save-data-to-a-database-multiple-tables"></a>Сохранение данных в базе данных (несколько таблиц)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [сохранение данных в базе данных (несколько таблиц)](https://docs.microsoft.com/visualstudio/data-tools/save-data-to-a-database-multiple-tables).  
