...
- Конструктор наборов данных предоставляет свойство **проекта набора данных** , позволяющее отделить набор данных (уровень сущностей данных) и `TableAdapter`s (уровень доступа к данным) в отдельные проекты.
 ...
 *Уровень данных* — это, по сути, сервер, на котором хранятся данные приложения (например, сервер, на котором работает [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]).
...
## <a name="help-for-n-tier-development"></a>Справка по N-уровневой разработке
 ...
 [Пошаговое руководство. Добавление проверки в N-уровневое приложение для данных](https://msdn.microsoft.com/library/b35d072c-31f0-49ba-a225-69177592c265)
...
## <a name="see-also"></a>См. также раздел
 <xref:System.Data.Linq.ITable.Attach%2A> [Пошаговое руководство. Создание](../data-tools/walkthrough-creating-an-n-tier-data-application.md) [иерархического обновления](../data-tools/hierarchical-update.md) набора данных многоуровневых приложений с данными [в Visual Studio](../data-tools/dataset-tools-in-visual-studio.md) [доступ к данным в Visual Studio](../data-tools/accessing-data-in-visual-studio.md)
