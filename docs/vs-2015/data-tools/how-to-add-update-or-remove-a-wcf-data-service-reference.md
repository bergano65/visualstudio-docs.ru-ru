...
Ссылка на службу позволяет проекту получить доступ к одному или нескольким *службам* [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] . Используйте диалоговое окно **Добавление ссылки на службу** для поиска [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] в текущем решении, локально, в локальной сети или в Интернете.
...
4. В поле **Пространство имен** введите пространство имен, которое хотите использовать для ссылки.

5. Нажмите кнопку **OK**, чтобы добавить ссылку на проект.
...
## <a name="updating-a-service-reference"></a>Обновление ссылки на службу
 EDM в [!INCLUDE[ssAstoria](../includes/ssastoria-md.md)] некоторых случаях меняется. В этом случае необходимо обновить ссылку на службу.
