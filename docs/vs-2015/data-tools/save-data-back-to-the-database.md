...
- На уровне представления данных, путем добавления проверки форм. Дополнительные сведения см. в разделе [проверка входных данных пользователя в Windows Forms](https://msdn.microsoft.com/library/4ec07681-1dee-4bf9-be5e-718f635a33a1).  
