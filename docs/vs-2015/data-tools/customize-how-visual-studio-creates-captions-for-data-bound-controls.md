...
При перетаскивании элементов из [окна «Источники данных](https://msdn.microsoft.com/library/0d20f699-cc95-45b3-8ecb-c7edf1f67992) » на конструктор Windows Forms возникает особое внимание: имена столбцов в заголовках записываются в более удобочитаемую строку, если найдено два или более слов для сцепления. соединять. Можно настроить способ создания этих меток, установив значения **смарткаптионекспрессион**, **смарткаптионреплацемент**и **смарткаптионсуффикс** в **HKEY_CURRENT_USER\Software\Microsoft\VisualStudio\ 10.0 \ Data Designers** , раздел реестра.
...
>
> В следующей статье базы знаний содержатся инструкции по резервному копированию, изменению и восстановлению реестра: [Описание реестра Microsoft Windows](http://support.microsoft.com/default.aspx?scid=kb;en-us;256986) (http://support.microsoft.com/default.aspx?scid=kb; en-US; 256986)
