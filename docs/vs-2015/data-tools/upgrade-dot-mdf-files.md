...
ms.locfileid: "47563291"
---
# <a name="upgrade-mdf-files"></a>Обновление MDF-файлов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [обновление MDF-файлов](https://docs.microsoft.com/visualstudio/data-tools/upgrade-dot-mdf-files).  
