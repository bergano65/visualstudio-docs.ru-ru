...
1. В [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] в строке меню выберите **файл**  > **Новый** **файл** > .
...
5. Снимите флажок **Добавить в систему управления версиями** , если он еще не снят, а затем нажмите кнопку **ОК** .
     ...
     Проект базы данных будет создан и отобразится в **Обозреватель решений**.
...
1. В строке меню выберите **проект**  > **Импорт**  > **Скрипт**.
