...
5. Используйте [Visual Database Tools](https://msdn.microsoft.com/6b145922-2f00-47db-befc-bf351b4809a1) в Visual Studio для прямого доступа к `Customers` данных таблицу и изменить запись.  
