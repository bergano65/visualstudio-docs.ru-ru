...
Последнюю версию этого раздела можно найти в [фильтрации и сортировки данных в приложении Windows Forms](https://docs.microsoft.com/visualstudio/data-tools/filter-and-sort-data-in-a-windows-forms-application).  
