---
title: Свойства соединения в файле настройки приложения пропущены или неверны | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="see-also"></a>См. также  
 ...
 [NIB: Практическое руководство. Добавить или удалить параметры приложения](https://msdn.microsoft.com/a233965c-126d-46ab-add4-efb758f576f4)   
