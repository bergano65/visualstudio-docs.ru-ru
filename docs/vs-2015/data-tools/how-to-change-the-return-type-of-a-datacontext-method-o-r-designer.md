...
2. Выберите **Тип возвращаемого значения** в окне **Свойства** и потом доступный класс сущностей в списке **Типов возврата**. Если нужный класс сущностей отсутствует в списке, добавьте его в или создайте в, [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] чтобы добавить его в список.
