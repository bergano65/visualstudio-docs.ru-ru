...
ms.locfileid: "47560456"
---
# <a name="add-new-connections"></a>Добавление новых подключений
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [Добавление новых подключений](https://docs.microsoft.com/visualstudio/data-tools/add-new-connections).  
