...
### <a name="create-a-typed-collection-of-objects"></a>Создайте коллекцию типизированных объектов
 Можно создать классы коллекций для объектов или использовать типизированные коллекции, автоматически предоставляемые [компонент BindingSource](https://msdn.microsoft.com/library/3e2faf4c-f5b8-4fa6-9fbc-f59c37ec2fb9).
...
### <a name="addobjects-to-a-collection"></a>Addobjects в коллекцию
 ...
 Пример добавления в коллекцию с помощью <xref:System.Windows.Forms.BindingSource>, см. в разделе `LoadCustomers` метод в [Пошаговое руководство: Подключение к данным в объектах (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).

 Пример добавления объектов в пользовательскую коллекцию, см. в разделе `LoadOrders` метод в [Пошаговое руководство: Подключение к данным в объектах (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).
