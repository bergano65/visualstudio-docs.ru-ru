...
### <a name="addobjects-to-a-collection"></a>Аддобжектс в коллекцию
 ...
 Пример добавления в коллекцию с помощью см <xref:System.Windows.Forms.BindingSource> . в описании `LoadCustomers` метода в разделе [Пошаговое руководство. подключение к данным в объектах (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).

 Пример добавления объектов в пользовательскую коллекцию см. в описании `LoadOrders` метода в разделе [Пошаговое руководство. подключение к данным в объектах (Windows Forms)](https://msdn.microsoft.com/library/21a7fba2-b38b-4726-8cbe-d22154b75a05).
