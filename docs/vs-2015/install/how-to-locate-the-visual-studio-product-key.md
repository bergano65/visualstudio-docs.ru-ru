---
title: 'Практическое: поиск ключа продукта Visual Studio | Документация Майкрософт'
ms.custom: ''
ms.date: 11/15/2016
...
## <a name="see-also"></a>См. также  
 [Практическое: обновление с пробного выпуска Visual Studio](../install/how-to-upgrade-from-a-trial-edition-of-visual-studio.md)   
 [Установка Visual Studio](../install/install-visual-studio-2015.md)   
 [Visual Studio и MSDN, руководство по лицензированию](http://go.microsoft.com/fwlink/?LinkId=191417)