...
4. 1.  Запустите *Product.exe* /Layout *диска:* \IDEinstall на компьютере с доступом к Интернету. (Например, выполните команду `vs_enterprise.exe /Layout d:\IDEinstall`.)
...
6. 1.  Запустите *Product.exe* /Layout *диска:* \IDEinstall на компьютере с доступом к Интернету. (Например, выполните команду `vs-enterprise.exe /Layout d:\IDEinstall`.)
