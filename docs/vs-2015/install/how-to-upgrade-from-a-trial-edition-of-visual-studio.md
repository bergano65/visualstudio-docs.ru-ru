---
title: 'Практическое: обновление с пробного выпуска Visual Studio | Документация Майкрософт'
ms.custom: ''
ms.date: 2018-06-30
...
У вас есть возможность оценить предварительную версию Visual Studio на протяжении 14 дней, не регистрируя продукт. После регистрации путем входа в систему с учетной записью Майкрософт лицензия на предварительную версию действует до указанной даты.  
 ...
 Вы можете ознакомиться с готовой версией выпусков Visual Studio Professional и Enterprise в течение 30 дней, начиная со дня установки продукта. [Вход в Visual Studio](../ide/signing-in-to-visual-studio.md) добавляет 60 дней к ознакомительному периоду, в течение 90 дней. Если не зарегистрировать пробный выпуск Visual Studio в течение 30 дней, пробный период истечет через 30 дней после установки.  
...
>  Пробный период для готовых версий выпусков Visual Studio Express также составляет 30 дней. Чтобы продлить пробный период выпусков Visual Studio Express на неопределенный срок, войдите в Visual Studio или зарегистрируйте продукт.  
 ...
 Перед обновлением рекомендуем загрузить и просмотреть [Visual Studio и MSDN Licensing White Paper](http://www.microsoft.com/download/details.aspx?id=13350) из веб-сайте Майкрософт. Для получения дополнительных сведений см. в разделе [поддержка Visual Studio](http://support.microsoft.com/ph/1117/en-us).  
...
1.  Запустите Visual Studio **Запуск от имени администратора** режим.  
  
2.  В меню **Справка**выберите команду **Зарегистрировать продукт**.  
  
3.  Выберите **Изменить мою лицензию на продукт** ссылку.  
  
4.  Введите действительный ключ продукта, а затем нажмите **применить** кнопки.  
...
## <a name="see-also"></a>См. также  
 ...
 [Практическое: поиск ключа продукта Visual Studio](../install/how-to-locate-the-visual-studio-product-key.md)   
 [Поиск или изменение ключа продукта для Team Foundation Server](http://msdn.microsoft.com/library/64f29927-b520-4c9f-b633-bcb527e562cd)   
