...
Самую актуальную документацию по Visual Studio см. в разделе [Установка языковых пакетов](/visualstudio/install/install-visual-studio?view=vs-2019#step-6---install-language-packs-optional).
