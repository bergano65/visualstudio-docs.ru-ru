...
|[Знакомство с конструктором проектов](http://msdn.microsoft.com/898dd854-c98d-430c-ba1b-a913ce3c73d7)|Обзор конструктора проектов, который позволяет централизованно управлять свойствами, параметрами и ресурсами проекта.|
...
|[Практическое руководство. Добавьте файл конфигурации приложения для C# проекта](../csharp-ide/how-to-add-an-application-configuration-file-to-a-csharp-project.md)|Описание способа добавления файла конфигурации (app.config) в проект C#.|
...
## <a name="see-also"></a>См. также
 [C#](http://msdn.microsoft.com/library/7f4f8103-7068-4f1d-92c7-3c4519b6edbc)[Приступая к работе с C# ](http://msdn.microsoft.com/library/d6ec050f-3956-4737-8030-a4fa3521d29f) [ C# ссылки](http://msdn.microsoft.com/library/06de3167-c16c-4e1a-b3c5-c27841d4569a)