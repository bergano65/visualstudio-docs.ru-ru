---
title: Метаданные в качестве источника | Документация Майкрософт
ms.date: 11/15/2016
...
## <a name="viewing-metadata-as-source-in-the-code-editor"></a>Просмотр метаданных в виде исходного кода в редакторе кода
 ...
 ![Метаданные как исходный код](../csharp-ide/media/metadatasource.png "метадатасаурце")
