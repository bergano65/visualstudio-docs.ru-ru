---
title: 'Ошибка: &#39;файл&#39; зависимостей в проекте &#39;&#39; проекта не может быть скопирован в каталог выполнения, так как он будет конфликтовать &#39;с&#39; файлом зависимостей | Документация Майкрософт'
ms.date: 11/15/2016
...
---
# <a name="error-the-dependency-39file39-in-project-39project39-cannot-be-copied-to-the-run-directory-because-it-would-conflict-with-dependency-39file39"></a>&#39;Ошибка: файл&#39; зависимостей в &#39;проекте&#39; проекта не может быть скопирован в каталог выполнения, так как он будет конфликтовать &#39;с файлом зависимостей&#39;
