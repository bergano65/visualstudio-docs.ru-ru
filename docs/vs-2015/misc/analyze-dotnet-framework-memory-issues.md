...
- **Размер (в байтах)** — это размер всех экземпляров типа, исключая размер объектов, на которые он ссылается. Компонент  
...
- **Размер (в байтах)** — это размер объекта, исключая размер объектов, на которые он ссылается. Компонент  
