...
## <a name="projects"></a><a name="project"></a> Макропроекты
...
|SDK для Visual Studio/VSIX|После обновления проекта пакета SDK для Visual Studio до Visual Studio 2013 его невозможно будет открыть в Visual Studio 2012. Дополнительные сведения см. в статье [Практическое руководство. Перенос проектов расширяемости в Visual Studio 2015](../extensibility/how-to-migrate-extensibility-projects-to-visual-studio-2015.md).|
...
|Другое|Проекты большинства других типов можно открыть в Visual Studio 2012, Visual Studio 2013 и Visual Studio 2010 с пакетом обновления 1 (SP1).|
...
## <a name="files"></a><a name="file"></a> Файла
...
## <a name="integration-assets"></a><a name="integration"></a> Активы интеграции
