...
Последнюю версию этого раздела можно найти в [UWP Windows для тестирования приложений и Windows 8.1 Store с помощью закодированных тестов пользовательского интерфейса](https://docs.microsoft.com/visualstudio/test/test-windows-store-8-1-apps-with-coded-ui-tests).  
