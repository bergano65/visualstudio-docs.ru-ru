...
2.  Чтобы увидеть, какие строки были выполнены, выберите ![значок цветов отображения покрытия кода](../test/media/codecoverage-showcoloringicon.png "CodeCoverage-ShowColoringIcon")**Цвета отображения покрытия кода**.  
     ...
     Чтобы изменить цвета или использовать полужирный шрифт, последовательно щелкните **средства**, **параметры**, **среды**, **шрифты и цвета**, **Показать параметры для: текстовый редактор**. В разделе **Отображаемые элементы** настройте элементы покрытия.  
