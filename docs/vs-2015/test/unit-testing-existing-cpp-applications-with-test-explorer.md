...
2. Добавьте тестовые классы и методы в файлы кода модульного теста. Пример:  
   ...
   Дополнительные сведения см. в разделе [Модульное тестирование машинного кода с использованием обозревателя тестов](http://msdn.microsoft.com/8a09d6d8-3613-49d8-9ffe-11375ac4736c).  
...
2. В разделе "Обозреватель тестов" выберите **Запустить все**.  
   ...
   Дополнительные сведения см. в разделе [быстрого запуска: Разработка с использованием обозревателя тестов на основе тестирования](../test/quick-start-test-driven-development-with-test-explorer.md).
