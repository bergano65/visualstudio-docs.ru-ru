...
2. **Добавление файла закодированного теста пользовательского интерфейса.**
...
### <a name="debugging"></a><a name="debugging"></a> Отладка
...
- [Руководство. Настройка и запуск запланированных тестов после сборки приложения](https://msdn.microsoft.com/32acfeb1-b1aa-4afb-8cfe-cc209e6183fd)
