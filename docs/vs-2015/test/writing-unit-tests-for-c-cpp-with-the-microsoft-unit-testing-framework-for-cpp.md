...
1. В меню **Файл** последовательно выберите пункты **Создать**и **Проект**.
     ...
     ![Создание проекта модульного теста C&#43; &#43;](../test/media/utecpp01.png "UteCpp01")

2. В новом проекте изучите файл **unittest1.cpp**.

     ![Тестовый проект с&#95;тестовым классом и методом теста&#95;](../test/media/utecpp2.png "UteCpp2")
...
3. Убедитесь в том, что тесты выполняются в обозревателе тестов.
    ...
    2. В меню **Тест** выберите **Запуск**, **Все тесты**.
         ...
         ![Обозреватель модульных тестов с одним прошедший тестом](../test/media/utecpp04.png "UteCpp04")
...
1. Создайте проект **Visual C++** с помощью шаблона **Проект Win32**.
     ...
     ![Создание проекта C&#43; &#43; Win32](../test/media/utecpp05.png "UteCpp05")
...
2. В мастере приложения Win32 выберите параметры **DLL** и **Экспортировать символы**.
     ...
     ![Мастер&#43; &#43; проектов C задает библиотеку DLL и экспортирует символы](../test/media/utecpp06.png ""Utecpp06")
...
1. Добавьте проект DLL в ссылки тестового проекта.
   ...
   1. Откройте свойства тестового проекта и выберите **Общие свойства**, **.NET Framework и ссылки**.
        ...
        ![Платформа&#43; &#43; и ссылки &#45; свойств проекта C](../test/media/utecpp08.png "UteCpp08")
...
5. В разделе "Обозреватель тестов" выберите **Запустить все**.
    ...
    ![Базовый тест обозревателя &#45; модульных тестов пройден](../test/media/utecpp10.png "UteCpp10")
...
4. Выполните сборку решения, а затем в обозревателе тестов щелкните **Запустить все**.
     ...
     ![Тест диапазона обозревателя &#45; модульных тестов пройден](../test/media/utecpp12.png "UteCpp12")
