...
|-----------|-----------------------|
|**Краткие и подробные руководства.** В следующих статьях можно изучить модульное тестирование в Visual Studio на конкретных примерах кода.|-   [Пошаговое руководство. Создание и запуск модульных тестов для управляемого кода](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md)<br />-   [Быстрое начало: Разработка на основе тестирования с помощью обозревателя тестов](../test/quick-start-test-driven-development-with-test-explorer.md)<br />-   [Добавление модульных тестов в существующие приложения C++](../test/unit-testing-existing-cpp-applications-with-test-explorer.md)<br />-   [Модульное тестирование машинного кода с помощью обозревателя тестов](https://msdn.microsoft.com/8a09d6d8-3613-49d8-9ffe-11375ac4736c)|
|**Модульное тестирование с помощью обозревателя тестов.** Узнайте, как с помощью обозревателя тестов создавать более производительные и более эффективные модульные тесты.|-   [Основы модульного тестирования](../test/unit-test-basics.md)<br />-   [Создание проекта модульного теста](../test/create-a-unit-test-project.md)<br />-   [Выполнение модульных тестов с помощью обозревателя тестов](../test/run-unit-tests-with-test-explorer.md)<br />-   [Установка платформ модульного тестирования сторонних производителей](../test/install-third-party-unit-test-frameworks.md)<br />-   [Обновление модульных тестов с версии Visual Studio 2010](https://msdn.microsoft.com/9bb75856-f68a-4de2-a084-b08a947a1172)|
|**Модульное тестирование управляемого кода**|-   [Написание модульных тестов для .NET Framework с помощью платформы модульных тестов Майкрософт для управляемого кода](../test/writing-unit-tests-for-the-dotnet-framework-with-the-microsoft-unit-test-framework-for-managed-code.md)|
|**Модульное тестирование кода на C++**|-   [Написание модульных тестов для C/C++ с помощью платформы модульного тестирования Майкрософт для C++](../test/writing-unit-tests-for-c-cpp-with-the-microsoft-unit-testing-framework-for-cpp.md)|
|**Изоляция модульных тестов**|-   [Изоляция тестируемого кода с помощью подмышлений Майкрософт](../test/isolating-code-under-test-with-microsoft-fakes.md)|
...
## <a name="related-tasks"></a>Связанные задачи
 ...
 [Выполнение системных тестов с помощью Microsoft Visual Studio](https://msdn.microsoft.com/library/19fae5c4-5798-4c4c-b531-3e8f901b1130)
...
## <a name="reference"></a>Справочник
 ...
 <xref:Microsoft.VisualStudio.TestTools.UnitTesting.Web> Описывает пространство имен UnitTesting. Web, которое расширяет пространство имен UnitTesting, предоставляя поддержку [!INCLUDE[vstecasp](../includes/vstecasp-md.md)] модульных тестов веб-служб и.
