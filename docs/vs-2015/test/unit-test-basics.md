...
- [Пошаговое руководство: Создание и выполнение модульных тестов для управляемого кода](../test/walkthrough-creating-and-running-unit-tests-for-managed-code.md)  
