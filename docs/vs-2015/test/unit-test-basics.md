...
- [Краткое руководство: Разработки на основе тестирования с использованием обозревателя тестов](../test/quick-start-test-driven-development-with-test-explorer.md)  
 ...
 **Ответ.** Используйте обозреватель тестов для запуска сеанса отладки для тестов. Пошагово выполняя код, отладчик Visual Studio плавно переключается назад и вперед между модульными тестами и проектом для тестирования. Начало отладки  
