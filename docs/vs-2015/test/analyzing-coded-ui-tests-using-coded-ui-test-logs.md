...
Последнюю версию этого раздела можно найти в [анализ закодированного пользовательского интерфейса тестов с помощью пользовательского интерфейса журналов закодированных тестов](https://docs.microsoft.com/visualstudio/test/analyzing-coded-ui-tests-using-coded-ui-test-logs).  
