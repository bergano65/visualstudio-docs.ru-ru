...
## <a name="using-test-explorer"></a>Использование обозревателя тестов
 ![Обозреватель модульных тестов с кнопкой "Запустить все"](../test/media/unittestexplorer-beta.png "UnitTestExplorer (бета-версия)")
...
## <a name="walkthrough-using-unit-tests-to-develop-a-method"></a><a name="walkthrough"></a> Пошаговое руководство. Использование модульных тестов для разработки метода
...
2. Создайте тестовый проект.
   ...
   - В диалоговом окне **Создать проект** выберите **Visual C#**, **Тест** , а затем выберите **Проект модульного теста**.
        ...
        ![Новые проекты кода и тестов](../test/media/unittestexplorerwalk1.png "UnitTestExplorerWalk1")
...
4. Создайте метод из теста.
   ...
   2. В диалоговом окне **Сформировать новый тип** установите **Проект** в проект библиотеки классов. В нашем примере поисковый запрос будет выглядеть так: `MyMath`.
