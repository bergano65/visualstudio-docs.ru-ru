---
title: Краткое руководство. Разработка с использованием обозревателя тестов на основе тестирования | Документация Майкрософт
ms.date: 11/15/2016
...
ms.locfileid: "66261649"
---
# <a name="quick-start-test-driven-development-with-test-explorer"></a>Краткое руководство. Разработка на основе тестирования с помощью обозревателя тестов
...
> [!NOTE]
> Если тест не отображается, убедитесь в том, что установлен адаптер для связи обозревателя тестов с используемой для тестов платформой. Дополнительные сведения см. в разделе [использовать другой платформы тестирования](/visualstudio/test/getting-started-with-unit-testing#use-a-third-party-test-framework).  
  
## <a name="walkthrough"></a> Пошаговое руководство. Использование модульных тестов для разработки метода  
 В данном пошаговом руководстве показано, как разработать тестируемый метод в C# с помощью платформы для выполнения модульных тестов Microsoft. Можно легко адаптировать его для других языков, а также использовать другие тестовые платформы, например NUnit. Дополнительные сведения см. в разделе [использовать другой платформы тестирования](/visualstudio/test/getting-started-with-unit-testing#use-a-third-party-test-framework).  
