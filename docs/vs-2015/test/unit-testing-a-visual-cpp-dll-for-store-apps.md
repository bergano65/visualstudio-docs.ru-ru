...
Последнюю версию этого раздела можно найти в [модульное тестирование DLL Visual C++ для приложений Store](https://docs.microsoft.com/visualstudio/test/unit-testing-a-visual-cpp-dll-for-store-apps).  
