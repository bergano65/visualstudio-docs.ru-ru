...
## <a name="why-should-i-do-this"></a>Почему требуется сделать это?
 ...
 ![Редактор теста пользовательского интерфейса](../test/media/uitesteditor.png "уитестедитор")
...
## <a name="open-a-coded-ui-test"></a>Открытие кодированного теста пользовательского интерфейса
 ...
 ![Изменение контекстного меню с помощью построителя кодированных тестов ИП](../test/media/editcodeduitest.png "едиткодедуитест")
...
## <a name="CodedUITestEditor_DeleteUIActions"></a> Удаление ненужных действий пользовательского интерфейса
 ...
 ![Действие удаления пользовательского интерфейса](../test/media/codeduideleteuiaction.png "кодедуиделетеуиактион")
...
- ![Совет](../test/media/tip.png "Совет") Новый метод можно переименовать. Выберите метод в области действий пользовательского интерфейса и на панели редактора закодированных тестов пользовательского интерфейса нажмите кнопку **Переименовать** .
...
## <a name="CodedUITestEditor_LocateUIControl"></a> Поиск элемента управления пользовательского интерфейса в тестируемом приложении
 ...
 ![Обнаружение элемента управления ИП](../test/media/codeduilocatecontrol.png "кодедуилокатеконтрол")
...
## <a name="CodedUITestEditor_LocateDecendants"></a> Определение расположения элемента управления и его потомков
 ...
 ![Нахождение всех элементов управления потомками](../test/media/codeduilocateall.png "кодедуилокатеалл")

 ![Все элементы управления расположены](../test/media/codeduilocateall2.png "CodedUILocateAll2")
...
## <a name="CodedUITestEditor_InsertDelay"></a> Вставка задержки перед действием пользовательского интерфейса
 ...
 ![Вставить задержку перед действием пользовательского интерфейса](../test/media/codeduidelay.png "кодедуиделай")

 ![Задержка добавлена с 5 секундами](../test/media/codeduidealy2.png "CodedUIDealy2")
