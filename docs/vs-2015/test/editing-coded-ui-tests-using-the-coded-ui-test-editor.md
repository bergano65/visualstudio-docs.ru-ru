...
Последнюю версию этого раздела можно найти в [Изменение закодированных тестов пользовательского интерфейса с помощью редактора закодированных тестов пользовательского интерфейса](https://docs.microsoft.com/visualstudio/test/editing-coded-ui-tests-using-the-coded-ui-test-editor).  
...
Изменение свойств действия пользовательского интерфейса  
 ...
 Например, если сервер недоступен и имеется действие пользовательского интерфейса, связанный с веб-браузере, сообщающее **на веб-странице "http://Contoso1/default.aspx"**, можно изменить URL-адрес `‘ http://Contoso2/default.aspx’`.  
