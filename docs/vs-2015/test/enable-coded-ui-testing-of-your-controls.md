...
Последнюю версию этого раздела можно найти в [включить закодированного пользовательского интерфейса тестирования для элементов управления](https://docs.microsoft.com/visualstudio/test/enable-coded-ui-testing-of-your-controls).  
