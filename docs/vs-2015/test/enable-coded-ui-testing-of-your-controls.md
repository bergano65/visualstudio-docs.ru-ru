...
4. [Поддержка действий, учитывающих намерения, путем реализации фильтра действий](../test/enable-coded-ui-testing-of-your-controls.md#intentawareactions)

   ![ПОСТРОИТЕЛЬ КОДИРОВАННЫХ&#95;Full](../test/media/cuit-full.png "CUIT_Full")

## <a name="support-record-and-playback-and-property-validation-by-implementing-accessibility"></a><a name="recordandplayback"></a> Поддержка записи и воспроизведения и проверки свойств путем реализации специальных возможностей
...
## <a name="support-custom-property-validation-by-implementing-a-property-provider"></a><a name="customproprties"></a> Поддержка проверки пользовательских свойств путем реализации поставщика свойств
...
## <a name="support-code-generation-by-implementing-a-class-to-access-custom-properties"></a><a name="codegeneration"></a> Поддержка создания кода путем реализации класса для доступа к пользовательским свойствам
...
## <a name="support-intent-aware-actions-by-implementing-an-action-filter"></a><a name="intentawareactions"></a> Поддержка действий, учитывающих намерение, путем реализации фильтра действий
...
2. Переопределите метод `UITestActionFilter.ProcessRule`. Ниже приведен пример замены действия двойного щелчка на действие одним щелчком.
