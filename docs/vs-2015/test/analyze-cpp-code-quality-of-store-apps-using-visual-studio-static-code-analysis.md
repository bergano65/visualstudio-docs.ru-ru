---
title: C++приложения из хранилища анализа статического кода
ms.date: 11/15/2016
...
## <a name="BKMK_Analyze"></a> Анализ и разрешение предупреждений анализа кода
 ...
 ![Предупреждение анализа расширенного кода](../test/media/ca-cpp-expanded-callout.png "CA_CPP_Expanded_Callout")
