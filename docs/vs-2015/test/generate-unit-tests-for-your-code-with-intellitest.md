...
2. Щелкните правой кнопкой мыши метод в коде и выберите пункт **Запустить IntelliTest** , чтобы создать модульные тесты для кода в используемом методе.
     ...
     ![&#45;щелкните в своем методе, чтобы создать модульные тесты](../test/media/runpex.png "рунпекс")
     ...
     ![Окно "Результаты просмотра" отображается с тестами](../test/media/pexexplorationresults.png "пексексплоратионресултс")
...
1. Выберите строки данных, которые следует сохранить с параметризованным модульным тестом в тестовый проект.
     ...
     ![Выберите тесты; Щелкните правой кнопкой мыши&#45;выберите команду Сохранить.](../test/media/savepextests.png "савепекстестс")
     ...
     ![Откройте файл класса в методе теста для просмотра модульного теста](../test/media/testmethodpex.png "тестмесодпекс")
...
2. После изучения кода и выбора цели тестирования можно исправить предупреждение, чтобы выбрать классы для тестирования интерфейса.
     ...
     ![&#45;щелкнуть предупреждение правой кнопкой мыши и выбрать команду исправить.](../test/media/pexfixwarning.png "пексфиксварнинг")
...
3. Теперь можно перезапустить IntelliTest, чтобы создать параметризованный модульный тест и данные теста c использованием одного только исправленного класса.
     ...
     ![Перезапустите IntelliTest, чтобы создать данные теста](../test/media/pexwarningsfixed.png "пексварнингсфиксед")
...
## <a name="q--a"></a><a name="QandALink"></a> Вопросы и ответы
 ...
 **Ответ.** Да, щелкните правой кнопкой мыши в коде класса или метода и выберите пункт **Создать IntelliTest**.
 ...
 ![Создание IntelliTest с MSTest по умолчанию](../test/media/pexcreateintellitestmstest.png "пекскреатеинтеллитестмстест")
 ...
 **Ответ.** Да, выполните инструкции по [поиску и установке других платформ](../test/install-third-party-unit-test-frameworks.md). Перезапустив Visual Studio и открыв решение повторно, щелкните правой кнопкой мыши в коде класса или метода и выберите пункт **Создать IntelliTest**. Выберите установленную платформу здесь:
 ...
 ![Выбор другой платформы модульного тестирования для IntelliTest](../test/media/pexcreateintellitestextensions.png "пекскреатеинтеллитестекстенсионс")
