...
Последнюю версию этого раздела можно найти в [выполнение модульных тестов для приложений Store в Visual Studio](https://docs.microsoft.com/visualstudio/test/run-unit-tests-for-store-apps-in-visual-studio).  
