...
ms.locfileid: "47571671"
---
# <a name="unit-testing-visual-c-code-in-a-store-app"></a>Модульное тестирование кода Visual C# в приложениях Магазина
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [модульное тестирование кода Visual C# в приложении Store](https://docs.microsoft.com/visualstudio/test/unit-testing-visual-csharp-code-in-a-store-app).  
