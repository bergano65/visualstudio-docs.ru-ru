...
- Visual Studio Enterprise
  ...
  См. видео (1 ч. 16 мин.): [Тестирование нетестируемого кода с помощью Fakes в Visual Studio 2012](https://channel9.msdn.com/Events/TechEd/Europe/2012/DEV411)

## <a name="example-the-y2k-bug"></a><a name="BKMK_Example__The_Y2K_bug"></a> Пример. Ошибка 2000 года
...
## <a name="how-to-use-shims"></a><a name="BKMK_Fakes_requirements"></a> Использование оболочек совместимости

### <a name="add-fakes-assemblies"></a><a name="AddFakes"></a> Добавление фиктивных сборок

1. В обозреватель решений разверните **ссылки**проекта модульного теста.
...
### <a name="use-shimscontext"></a><a name="ShimsContext"></a> Использование ShimsContext
...
### <a name="write-a-test-with-shims"></a><a name="WriteShims"></a> Создание теста с оболочками
...
## <a name="shims-for-different-kinds-of-methods"></a><a name="BKMK_Shim_basics"></a> Оболочки для различных видов методов
...
### <a name="static-methods"></a><a name="BKMK_Static_methods"></a> Статические методы
...
### <a name="instance-methods-for-all-instances"></a><a name="BKMK_Instance_methods__for_all_instances_"></a> Методы экземпляра (для всех экземпляров)
...
### <a name="instance-methods-for-one-runtime-instance"></a><a name="BKMK_Instance_methods__for_one_instance_"></a> Методы экземпляра (для одного экземпляра)
...
### <a name="constructors"></a><a name="BKMK_Constructors"></a> Конструкторы
...
### <a name="base-members"></a><a name="BKMK_Base_members"></a> Базовые члены
...
### <a name="finalizers"></a><a name="BKMK_Finalizers"></a> Методы завершения
 Методы завершения не поддерживаются в Fakes.

### <a name="private-methods"></a><a name="BKMK_Private_methods"></a> Закрытые методы
...
### <a name="binding-interfaces"></a><a name="BKMK_Binding_interfaces"></a> Интерфейсы привязки
...
## <a name="changing-the-default-behavior"></a><a name="BKMK_Changing_the_default_behavior"></a> Изменение поведения по умолчанию
...
## <a name="detecting-environment-accesses"></a><a name="BKMK_Detecting_environment_accesses"></a> Обнаружение доступа к среде
...
## <a name="concurrency"></a><a name="BKMK_Concurrency"></a> Параллелизма
...
## <a name="calling-the-original-method-from-the-shim-method"></a><a name="BKMK_Calling_the_original_method_from_the_shim_method"></a> Вызов исходного метода из метода оболочки совместимости
...
## <a name="see-also"></a>См. также:
 [Изоляция тестируемого кода с помощью подпрограммы Microsoft имитирует](../test/isolating-code-under-test-with-microsoft-fakes.md) [блог Питер Провоста: видео о оболочках Visual Studio 2012](http://www.peterprovost.org/blog/2012/04/25/visual-studio-11-fakes-part-2) [(1:16): тестирование Нетестируемого кода с имитациями в Visual Studio 2012](https://channel9.msdn.com/Events/TechEd/Europe/2012/DEV411)
