...
### <a name="hands-on-lab"></a>Практическое лабораторное занятие  
 [Виртуальная лаборатория MSDN. Введение в создание закодированных тестов пользовательского интерфейса с помощью Visual Studio 2010](http://go.microsoft.com/fwlink/?LinkID=22508)  
...
## <a name="see-also"></a>См. также раздел  
 ...
 [Начало работы с конструктором WPF](https://msdn.microsoft.com/18e61d03-b96a-4058-a166-8ec6b3f6116b)   
