...
8. Если панель элементов еще не открыта, откройте ее. В меню **вид** выберите пункт **панель элементов**.
...
10. Выберите элемент управления "Кнопка". В окно свойств измените значение свойства **имя** с \<No Name> на Button1. Затем измените значение свойства **Содержимое** с "Button" на "Start".

11. Выберите элемент управления ProgressBar. В окно свойств измените значение свойства **Name** с \<No Name> на progressBar1. Затем измените значение свойства **Максимум** с **100** на **10000**.

12. Выберите элемент управления Checkbox. В окно свойств измените значение свойства **Name** с \<No Name> на CheckBox1 и очистите свойство с **включенным** .
...
1. Найдите созданное ранее приложение SimpleWPFApp. По умолчанию приложение будет расположено по адресу C:\Users \\<имя_пользователя \> \Documents\Visual Studio \<version>\Projects\SimpleWPFApp\SimpleWPFApp\bin\Debug\SimpleWPFApp.exe
...
3. В обозреватель решений щелкните решение правой кнопкой мыши, выберите **Добавить** , а затем выберите **Новый проект**.
...
13. В окне "UIMap — Построитель кодированных тестов ИП" выберите **создать код**.
...
9. На [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] панели инструментов нажмите кнопку **сохранить**.
...
14. В меню **Сборка** выберите пункт **собрать решение**.
...
3. В меню **Сборка** выберите пункт **собрать решение**.

4. В обозревателе тестов запустите **CodedUITestMethod1**.
...
13. В меню **Сборка** выберите пункт **собрать решение**.
