...
|MFC|Поддерживается частично. Дополнительные сведения о поддерживаемых функциях см. на следующем [веб-сайте корпорации Майкрософт](https://go.microsoft.com/fwlink/?LinkId=206511) .|
...
|Клиент Dynamics (Ax) 2012|Запись и воспроизведение действий поддерживаются частично. Дополнительные сведения см. на следующем [веб-сайте корпорации Майкрософт](https://go.microsoft.com/fwlink/?LinkId=232677) .|
