---
title: Тестирование крупного приложения с несколькими картами пользовательского интерфейса | Документы Майкрософт
ms.custom: ''
ms.date: 2018-06-30
...
Последнюю версию этого раздела можно найти в [тестирование крупного приложения с несколькими картами пользовательского интерфейса](https://docs.microsoft.com/visualstudio/test/testing-a-large-application-with-multiple-ui-maps).  
...
1.  Чтобы создать папку в проекте закодированного теста ИП для хранения всех карт пользовательского интерфейса, в **обозревателе решений** щелкните правой кнопкой файл проекта теста, выберите пункт **Добавить** и выберите **Создать папку**. Например, можно указать имя `UIMaps`.  
...
4.  Выберите **Добавить**.  
     ...
     Окно [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] свернется и появится диалоговое окно **Построитель кодированных тестов ИП**.  
