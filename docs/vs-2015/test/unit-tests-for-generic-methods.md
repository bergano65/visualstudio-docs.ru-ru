...
ms.locfileid: "47562933"
---
# <a name="unit-tests-for-generic-methods"></a>Модульные тесты для универсальных методов
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Последнюю версию этого раздела можно найти в [модульные тесты для универсальных методов](https://docs.microsoft.com/visualstudio/test/unit-tests-for-generic-methods).  
