...
- Параметры поведения ([описанные в этой статье](#r-tools--advanced-options)): в меню **Инструменты R** > **Параметры** или **Инструменты R** > **Параметры** прокрутите экран к разделу **Инструменты R**.
