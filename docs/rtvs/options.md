...
Параметры доступны в меню **Инструменты R > Параметры**, а также в меню **Сервис > Параметры** в разделе **Инструменты R**.
  ...
  ![Диалоговое окно параметров инструментов R](~/rtvs/media/options-dialog.png)
...
![Макет окна для обработки и анализа данных в Visual Studio](~/rtvs/media/installation-data-scientist-layout-result.png)
