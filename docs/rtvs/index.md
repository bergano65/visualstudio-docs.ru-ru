...
description: "Инструменты R для Visual Studio 2017 (RTVS)\_— это бесплатное расширение с открытым исходным кодом, предоставляющее множество языковых функций, включая IntelliSense, отладку и удаленные рабочие области."
ms.date: 11/13/2017
ms.topic: overview
author: kraigb
ms.author: kraigb
...
| [Полнофункциональная отладка](debugging-r-in-visual-studio.md) | Включает интеграцию с помощью интерактивного окна. | [Отладка в Visual Studio](/visualstudio/debugger/debugger-feature-tour) |
