...
![Диалоговое окно предупреждения самозаверяющего сертификата](~/rtvs/media/workspaces-remote-self-signed-certificate-warning.png)
...
![Команда импорта сертификата](~/rtvs/media/workspaces-remote-certificate-import.png)
...
1. В появившемся диалоговом окне выберите **Добавить** и введите `NETWORK SERVICE` в качестве имени учетной записи.
    ...
    ![Диалоговое окно управления закрытыми ключами, добавление NETWORK_SERVICE](~/rtvs/media/workspaces-remote-manage-private-key-dialog.png)
