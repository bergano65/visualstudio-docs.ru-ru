---
title: "Редактирование кода с помощью инструментов R для Visual Studio | Документы Майкрософт"
ms.custom: 
ms.date: 12/04/2017
ms.reviewer: 
ms.suite: 
...
Также см. разделы, посвященные [IntelliSense](code-intellisense.md), [анализу кода](code-linting.md), [фрагментам кода](code-snippets.md) и [R Markdown](rmarkdown.md).
