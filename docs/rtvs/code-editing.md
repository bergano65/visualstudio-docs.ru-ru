...
![Цветовая раскраска синтаксических конструкций для кода R](~/rtvs/media/editing-syntax-colors.png)
...
![Параметры шрифтов и цвета для кода R](~/rtvs/media/editing-syntax-colors-options.png)

Visual Studio также подчеркивает синтаксические ошибки в редакторе.

![Выделение синтаксической ошибки в коде R](~/rtvs/media/editing-syntax-error.png)
...
![Анимация встроенного форматирования](~/rtvs/media/editing-inline-formatting.gif)
...
![Анимация автоматического отступа](~/rtvs/media/editing-auto-indentation.gif)
...
![Создание сворачиваемой области кода с комментариями](~/rtvs/media/editing-collapsible-regions.gif)
...
![Анимация выполнения команды "Показать определение"](~/rtvs/media/editing-peek-definition.gif)
...
![Анимация вставки примечания Roxygen](~/rtvs/media/editing-roxygen-comments.gif)
