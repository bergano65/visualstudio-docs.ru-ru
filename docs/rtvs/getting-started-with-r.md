...
Возможности редактора, конечно, гораздо больше. Дополнительные сведения см. в разделах [Редактирование кода](editing-r-code-in-visual-studio.md), [IntelliSense](r-intellisense.md) и [Фрагменты кода](code-snippets-for-r.md).
