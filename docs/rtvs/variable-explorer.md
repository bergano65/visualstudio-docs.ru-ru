...
![Окно обозревателя переменных в Visual Studio](~/rtvs/media/variable-explorer-window.png)
...
![Расширенное представление обозревателя переменных](~/rtvs/media/variable-explorer-expanded-results.png)
...
![Табличное представление в обозревателе переменных](~/rtvs/media/variable-explorer-table-view.png)
...
![Табличное представление данных, сортировка по двум столбцам.](~/rtvs/media/variable-explorer-table-view-sorting.png)
...
![Обозреватель переменных с областью пакета](~/rtvs/media/variable-explorer-package-scopes.png)
...
![Обозреватель переменных с блоком данных во время отладки](~/rtvs/media/variable-explorer-as-locals-window.png)
...
![Диалоговое окно импорта набора данных](~/rtvs/media/variable-explorer-import-dataset-dialog.png)
