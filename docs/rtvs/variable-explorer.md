...
![Окно обозревателя переменных в Visual Studio](~/docs/rtvs/media/variable-explorer-window.png)
...
![Расширенное представление обозревателя переменных](~/docs/rtvs/media/variable-explorer-expanded-results.png)
...
![Табличное представление в обозревателе переменных](~/docs/rtvs/media/variable-explorer-table-view.png)
...
![Табличное представление данных, сортировка по двум столбцам.](~/docs/rtvs/media/variable-explorer-table-view-sorting.png)
...
![Обозреватель переменных с областью пакета](~/docs/rtvs/media/variable-explorer-package-scopes.png)
...
![Обозреватель переменных с блоком данных во время отладки](~/docs/rtvs/media/variable-explorer-as-locals-window.png)
...
![Диалоговое окно импорта набора данных](~/docs/rtvs/media/variable-explorer-import-dataset-dialog.png)
