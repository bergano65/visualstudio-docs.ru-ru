...
![Содержимое проекта R, созданного на основе шаблона](~/docs/rtvs/media/projects-template-results.png)
...
![Visual Studio в обозревателе решений с несколькими проектами, объединенными в одном решении](~/docs/rtvs/media/projects-polyglot.png)
