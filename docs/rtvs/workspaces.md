...
![Окно "Рабочие области" в инструментах R для Visual Studio (VS2017)](~/rtvs/media/workspaces-window.png)
...
![Добавление новой рабочей области](~/rtvs/media/workspaces-add-new.png)
...
![Сообщение об ошибке при отсутствии рабочих областей, привязанных к RTVS](~/rtvs/media/workspaces-disconnected-interactive-window.png)
...
![Предупреждение о самозаверяющем сертификате при подключении к удаленной рабочей области](~/rtvs/media/workspaces-remote-self-signed-certificate-warning.png)
...
![Окно свойств проекта со вкладкой "Выполнение" и настройками передачи файлов](~/rtvs/media/workspaces-remote-file-transfer-filter-settings.png)
