...
![Добавление элемента "SQL-запрос" в проект](~/rtvs/media/sql-add-item.png)
...
![Диалоговое окно подключения SQL](~/rtvs/media/sql-connection-dialog.png)

После установления соединения можно выполнять запросы и просматривать результаты.

![Окно с результатами выполнения SQL-запроса](~/rtvs/media/sql-query-results.png)
...
1. Выберите **Инструменты R > Данные > Добавить подключение к базе данных**, чтобы отобразить диалоговое окно **Свойства подключения**, в котором укажите имя источника данных (в данном случае — SQL Server), имя сервера, режим проверки подлинности и имя базы данных. Можно нажать кнопку **Проверить подключение** для проверки введенных данных, прежде чем закрывать диалоговое окно.
    ...
    ![Диалоговое окно подключения SQL](~/rtvs/media/sql-connection-string-dialog.png)
...
![Файл Settings.R для SQL](~/rtvs/media/sql-settings-dot-r.png)
...
![Развернутое окно обозревателя решений с хранимой процедурой SQL с R](~/rtvs/media/sql-solution-explorer-expanded.png)
...
![Считывание содержимого файла SQL в строковую переменную R](~/rtvs/media/sql-reference-sql-file-from-r.png)
...
1. В появившемся диалоговом окне выберите для параметра **Публикация в:** значение **База данных**, укажите целевой объект, нажмите **Опубликовать**, после чего RTVS создаст и опубликует хранимую процедуру.
    ...
    ![Диалоговое окно публикации хранимой процедуры](~/rtvs/media/sql-publish-with-options.png)
