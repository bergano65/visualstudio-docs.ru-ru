...
![Кнопка запуска отладчика для R](~/docs/rtvs/media/debugger-start-button.png)
...
![Обозреватель среды в интерактивном окне](~/docs/rtvs/media/debugger-environment-browser.png)
