...
![Кнопка запуска отладчика для R](~/rtvs/media/debugger-start-button.png)
...
![Обозреватель среды в интерактивном окне](~/rtvs/media/debugger-environment-browser.png)
