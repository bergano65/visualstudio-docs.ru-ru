...
![Анимации использования фрагмента кода для вставки вызова read.csv](~/docs/rtvs/media/code-snippet-expansion.gif)
...
![Диалоговое окно "Диспетчер фрагментов кода" для R](~/docs/rtvs/media/code-snippet-dialog.png)
