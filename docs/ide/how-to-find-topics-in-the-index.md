---
title: "Использование указателя окна справки Visual Studio | Документация Майкрософт"
ms.custom: 
ms.date: 11/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="finding-topics-by-using-the-help-viewer-index"></a>Поиск разделов с помощью указателя окна справки
...
Использовать указатель просто. Однако если вы понимание, как лучше всего ввести ключевые слова, производительность поиска в указателе может повыситься.  
