...
:::image type="content" source="media/git-create-repository.png" alt-text="Снимок экрана: диалоговое окно &quot;Создание репозитория GIT&quot; в Visual Studio":::
...
:::image type="content" source="media/git-clone-repository.png" alt-text="Снимок экрана: диалоговое окно &quot;Клонирование репозитория GIT&quot; в Visual Studio":::
...
:::image type="content" source="media/git-local-repositories.png" alt-text="Снимок экрана: параметр &quot;Локальные репозитории&quot; в меню GIT в Visual Studio":::
...
:::image type="content" source="media/git-solution-explorer-views.png" alt-text="Снимок экрана: обозреватель решений с нажатой кнопкой &quot;Переключить представления&quot; в Visual Studio":::
...
:::image type="content" source="media/git-changes-window.png" alt-text="Снимок экрана: окно &quot;Изменения GIT&quot; в Visual Studio":::
...
:::image type="content" source="media/git-file-version-compare.png" alt-text="Снимок экрана: построчное сравнение версий файла в Visual Studio":::
...
:::image type="content" source="media/git-changes-current-branch-selector.png" alt-text="Снимок экрана: текущие ветви, которые можно просмотреть с помощью селектора в верхней части окна &quot;Изменения GIT&quot; в Visual Studio":::

Текущая ветвь также доступна в строке состояния в правом нижнем углу интегрированной среды разработки Visual Studio.

:::image type="content" source="media/git-changes-current-branch-status-bar.png" alt-text="Снимок экрана: текущие ветви, которые можно просмотреть с помощью строки состояния в правом нижнем углу интегрированной среды разработки Visual Studio":::
...
:::image type="content" source="media/git-changes-create-new-branch.png" alt-text="Снимок экрана: диалоговое окно &quot;Создание новой ветви&quot; в Visual Studio":::
...
:::image type="content" source="media/git-repo-drop-down-indicator.png" alt-text="Снимок экрана: окно &quot;Изменения GIT&quot; с индикатором под раскрывающимся списком в Visual Studio":::
...
:::image type="content" source="media/git-branch-commit-history.png" alt-text="Снимок экрана: окно &quot;Репозиторий GIT&quot; с журналом фиксаций для ветви в Visual Studio":::
...
:::image type="content" source="media/git-branch-commit-details.png" alt-text="Снимок экрана: диалоговое окно &quot;Сведения о фиксации&quot; в Visual Studio":::
...
:::image type="content" source="media/git-merge-conflict-gold-bar.png" alt-text="Снимок экрана с сообщением &quot;Объединение завершено с конфликтами&quot; в Visual Studio":::
...
:::image type="content" source="media/git-merge-progress-conflicts-message.png" alt-text="Снимок экрана с сообщением &quot;Слияние выполняется с конфликтами&quot; в Visual Studio":::
...
:::image type="content" source="media/git-merge-editor.png" alt-text="Снимок экрана: редактор слияния в Visual Studio":::
...
:::image type="content" source="media/git-options-settings.png" alt-text="Снимок экрана: диалоговое окно &quot;Параметры&quot; в интегрированной среде разработки Visual Studio, в котором можно выбрать параметры персонализации и настройки":::
