...
После запуска Visual Studio вы прежде всего увидите окно запуска. Окно запуска помогает быстрее перейти к работе с кодом. Здесь есть действия, позволяющие клонировать или извлечь код, открыть существующий проект или решение, создать новый проект или просто открыть папку с файлами кода.

[![](media/vs-2019/start-window-labeled.png "Окно запуска в Visual Studio 2019")](media/vs-2019/start-window-labeled.png#lightbox)
...
1. На начальном экране выберите **Создать проект**.
   ...
   Откроется окно с заголовком **Создание проекта**. Это окно иногда называют диалоговым окном **Новый проект**, и здесь вы можете просмотреть и выбрать шаблон проекта. Здесь также поддерживается список последних открытых шаблонов проекта.
...
1. Если вы выбрали язык C#, Visual Basic или F#, выберите шаблон **Консольное приложение (.NET Framework)** и щелкните **Далее**. (Для другого языка просто выберите любой шаблон. Рассматриваемый нами пользовательский интерфейс выглядит одинаково для всех языков программирования.)
...
2. Введите **детализация** в поле поиска **Быстрый запуск**. В списке результатов выберите **Проекты и решения --> Сборка и запуск** в категории **Параметры**.
...
1. Найдите поле поиска **Быстрый запуск** в верхней части интегрированной среды разработки, справа от строки меню. (Или нажмите **CTRL**+**Q**, чтобы получить доступ.)

2. Введите **детализация** в поле поиска **Быстрый запуск**. В отображаемом списке результатов выберите **Change MSBuild verbosity** (Изменить уровень детализации MSBuild).

   ![Поле поиска "Быстрый запуск" в Visual Studio 2019](media/vs-2019/quick-launch-verbosity.png)
