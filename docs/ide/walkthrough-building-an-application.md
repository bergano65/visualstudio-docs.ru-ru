...
3.  В диалоговом окне **Создание конфигурации решения** введите для новой конфигурации имя `Test`, скопируйте параметры из существующей конфигурации отладки и нажмите кнопку **ОК**.  
     ...
     ![Диалоговое окно конфигурации нового решения](~/docs/ide/media/buildwalk_newsolutionconfigdlgbox.png "BuildWalk_NewSolutionConfigDlgBox")  
...
5.  В диалоговом окне **Создание платформы решения** выберите **x64** и не копируйте параметры из платформы x86.  
     ...
     ![Диалоговое окно платформы нового решения](~/docs/ide/media/buildwalk_newsolutionplatform.png "BuildWalk_NewSolutionPlatform")  
...
-   В строке меню последовательно выберите **Сборка**и **Собрать решение**.  
 ...
 ![Окно выходных данных Visual Basic](~/docs/ide/media/buildwalk_vbbuildoutputwnd.png "BuildWalk_VBBuildOutputWnd")  
...
4.  Постройте решение.  
 ...
 ![Окно выходных данных, предупреждения сборки Visual Basic](~/docs/ide/media/buildwalk_visualbasicbuildwarnings.png "BuildWalk_VisualBasicBuildWarnings")  
