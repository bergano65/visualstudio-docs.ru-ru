...
Вы можете использовать клавиатуру в дополнение к мыши для навигации в конструкторе классов и окне **Сведения о классе**.  
...
-   [Использование мыши в окне «Сведения о классе»](../ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer.md#MouseClassDetails)  
...
-   [Использование клавиатуры в окне «Сведения о классе»](../ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer.md#KeyboardClassDetails)  
...
##  <a name="MouseClassDetails"></a> Использование мыши в окне «Сведения о классе»  
...
|CTRL\+DELETE|Все контексты|Вызывает команду **Удалить из кода** для выделения.|  
...
##  <a name="KeyboardClassDetails"></a> Использование клавиатуры в окне «Сведения о классе»  
  
> [!NOTE]
>  Следующие сочетания клавиш были выбраны специально для имитации ввода кода.  
