---
title: "Практическое руководство. Разблокирование Visual Studio | Документы Майкрософт"
ms.custom: 
ms.date: 07/20/2017
ms.reviewer: 
ms.suite: 
...
2.  Введите учетные данные для учетной записи Майкрософт, рабочей или школьной учетной записи. Visual Studio выполняет поиск подписки Visual Studio или Visual Studio Team Services, связанной с вашей учетной записью.  
