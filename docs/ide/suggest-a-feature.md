---
title: Предложить функцию для Visual Studio
...
**Closed - Other Product** (Закрыто — другой продукт) означает, что сейчас мы не можем реализовать ваше предложение функции, так как его нельзя применить к продукту, для которого оно предназначалось. Но мы предоставим сведения о том, где можно поделиться предложением такой функции для соответствующего продукта.
- - -
