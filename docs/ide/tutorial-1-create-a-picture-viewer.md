...
-   Создавать методы обработчика событий.
 ...
 ![Изображение результата, создаваемого в этом учебнике](../ide/media/express_pictureviewerdone.png) Изображение результата, создаваемого в этом учебнике
