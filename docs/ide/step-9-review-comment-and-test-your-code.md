...
**_Кнопка_* _ _"Сохранить все"*
     ...
     ![Программа просмотра изображений](../ide/media/express_pictureviewerdonerun.png)<br>**_Программа просмотра изображений_* _

## <a name="to-test-your-app"></a>Тестирование приложения

1. Нажмите клавишу _ *F5** или кнопку **Начать отладку** на панели инструментов.
