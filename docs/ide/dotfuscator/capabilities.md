...
Тем не менее приложения, созданные для .NET, похожи на раскрытые книги; легко реконструирования сборки .NET, [как они содержат высокоуровневые метаданные и промежуточный код][assemblies].
...
Злоумышленники могут пытаться перехватить приложение для обхода политик лицензирования (то есть пиратства), кражи или изменения обрабатываемых приложением конфиденциальных данных, или для изменения поведения приложения.
