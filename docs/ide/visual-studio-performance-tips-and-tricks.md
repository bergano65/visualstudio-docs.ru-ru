...
- **Включение загрузки упрощенного решения**
    ...
    В этом режиме не работают некоторые возможности IDE. Чтобы определить, поможет ли вам этот вариант, см. запись блога о [сокращении времени загрузки решения](https://blogs.msdn.microsoft.com/visualstudio/2016/10/11/shorter-solution-load-time-in-visual-studio-15/) и статью об [оптимизации загрузки решения](../ide/optimize-solution-loading-in-visual-studio).
