---
title: Советы и рекомендации по улучшению работы Visual Studio
ms.date: 08/31/2017
...
Если отключить автоматическое восстановление файлов, быстро перейти к нужным файлам можно с помощью команды [Перейти к](../ide/go-to.md). Выберите пункты **Правка** > **Перейти к** > **Перейти ко всем** или нажмите **Ctrl**+**T**.
