...
При создании проекта .NET Framework, можно указать определенную версию .NET Framework, который требуется использовать. (При создании проекта .NET Core, не указывайте версию платформы.)

::: moniker range="vs-2017"

Чтобы указать версию .NET Framework, выберите **Framework** раскрывающееся меню в **новый проект** диалоговое окно.
...
Чтобы указать версию .NET Framework, выберите **Framework** раскрывающееся меню на **создайте новый проект** страницы.
