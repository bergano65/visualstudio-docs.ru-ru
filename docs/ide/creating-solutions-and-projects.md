...
1. Чтобы добавить в решение дополнительный проект, выберите узел решения в **обозревателе решений**, а затем выберите **Проект** > **Добавить новый элемент**.
