...
> [!NOTE]
>  Если вы не хотите, не используйте решения или проекты. Можно просто открыть файлы в Visual Studio и начать редактирование кода. Дополнительные сведения см. в статье [Открытие папки в Visual Studio](https://blogs.msdn.microsoft.com/visualstudio/2016/04/12/open-any-folder-with-visual-studio-15-preview/).
 ...
 ![Проекты и решения Visual Studio](../ide/media/vs2015_project_diagram.png "схема_проекта_vs2015")  
