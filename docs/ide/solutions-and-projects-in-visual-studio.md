...
Если вы часто настраиваете проекты определенным образом, можете создать пользовательский шаблон проекта, на основе которого будете создавать новые проекты. Дополнительные сведения см. в статье [Создание шаблонов проектов и элементов](../ide/creating-project-and-item-templates.md).
