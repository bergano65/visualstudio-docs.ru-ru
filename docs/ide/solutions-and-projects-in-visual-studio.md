...
> [!TIP]
> Если вы закрыли Обозреватель решений и хотите вновь открыть его, выберите **Окно** > **Сброс макета окон** в строке меню.
...
Описание некоторых значков, отображаемых в Обозревателе решений, см. в статье [Значки представления классов и обозревателя объектов](class-view-and-object-browser-icons.md).
