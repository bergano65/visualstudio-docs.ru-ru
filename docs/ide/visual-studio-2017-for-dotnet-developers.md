...
|- | - | -|
| Найти все ссылки | **SHIFT**+**F12**| Результаты выделяются цветом и могут быть сгруппированы по проекту, определению и ссылочному типу, например read или write. Также можно "блокировать" результаты. |
