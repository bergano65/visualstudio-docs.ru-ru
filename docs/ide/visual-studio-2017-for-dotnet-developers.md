...
- Мы рекомендуем установить [расширение языковых служб EditorConfig](https://aka.ms/editorconfig) для добавления и редактирования файла EDITORCONFIG в Visual Studio. 
- Ознакомиться со всеми вариантами соглашений о написании кода в .NET можно в [этой документации](https://aka.ms/editorconfigDocs).
...
![Рефакторинг в Visual Studio](../ide/media/VSGuide_CodeAnalysis.png "VSGuide_CodeAnalysis")
...
## <a name="i-want-to-debug-my-code"></a>Мне нужно выполнить отладку кода.
Мы добавили в Visual Studio 2017 множество новых возможностей отладки. 
...
![Новый помощник по исправлению ошибок Visual Studio 2017](../ide/media/VSGuide_Debugging.png "VSGuide_Debugging")
...
| Режим завершения/подсказки | Изменяет работу завершения в IntelliSense — разработчики, использующие фоновые действия IntelliJ, как правило, изменяют этот режим на отличный от режима по умолчанию. | **Меню > Правка > IntelliSense > Переключить режим завершения** |
...
![Фрагменты кода в Visual Studio](../ide/media/VSGuide_SmartEditor.png)
