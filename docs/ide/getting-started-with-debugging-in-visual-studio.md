...
### <a name="configuring-a-build"></a>Настройка сборки  
 ...
 ![Кнопка "Отладочная сборка" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_type1.PNG "Vs_ide_gs_debug_build_type1")  
 ...
 ![Окно диспетчера файлов конфигурации в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr.PNG "Vs_ide_gs_debug_build_cf_mgr")  
 ...
 ![Окно диспетчера конфигурации в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr_2.PNG "Vs_ide_gs_debug_build_cf_mgr_2")  
...
### <a name="building-your-code"></a>Сборка кода  
 ...
 ![Выбор пункта меню "Собрать проект" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_menu_item.png "Vs_ide_gs_debug_build_menu_item")  
 ...
 ![Выходные данные при успешной сборке в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_success_build.PNG "vs_ide_gs_debug_success_build")  
...
### <a name="reviewing-the-error-list"></a>Просмотр списка ошибок  
 ...
 ![Выходные данные и список ошибок в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_bad_build_error_list.PNG "Vs_ide_gs_debug_bad_build_error_list")  
 ...
 ![Редактор Visual Studio с номерами строк](~/docs/ide/media/vs_ide_gs_debug_line_numbers.png "Vs_ide_gs_debug_line_numbers")  

 ![Параметр "Номера строк" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_options_line_numbers.png "Vs_ide_gs_debug_options_line_numbers")  
 ...
 ![Ошибка при наведении курсора мыши в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_hover1.png "Vs_ide_gs_debug_error_hover1")  

 Пройдите список ошибок и устраните все ошибки в коде.  

 ![Окно ошибок отладчика в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_list.PNG "Vs_ide_gs_debug_error_list")  
...
### <a name="reviewing-errors-in-detail"></a>Просмотр подробных сведений об ошибках  
 ...
 ![Bing-поиск списка ошибок в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_list_error_help.png "Vs_ide_gs_debug_error_list_error_help")  
...
### <a name="performing-static-code-analysis"></a>Выполнение статического анализа кода  
 ...
 ![Пункт меню "Анализ кода" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_run_code_analysis.png "Vs_ide_gs_debug_run_code_analysis")  
 ...
 ![Список ошибок с предупреждениями в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_error_list.PNG "vs_ide_gs_debug_code_analysis_warning_error_list")  
 ...
 ![Предупреждение анализа кода в Visual Studio при наведении указателя мыши](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_hover.png "vs_ide_gs_debug_code_analysis_warning_hover")  
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>Использование значка лампочки для исправления или рефакторинга кода  
 ...
 ![Лампочка в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb1.png "Vs_ide_gs_debug_light_bulb1")  

 Вы увидите список возможных исправлений или операций рефакторинга, которые можно применить к соответствующей строке кода.  

 ![Предварительный просмотр лампочки в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb_preview_changes.PNG "Vs_ide_gs_debug_light_bulb_preview_changes")  
 ...
 ![Текст "Параметры недоступны" при использовании лампочки в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb_no_options.PNG "Vs_ide_gs_debug_light_bulb_no_options")  
...
### <a name="debugging-your-running-code"></a>Отладка выполняемого кода  
 ...
 ![Окна "Видимые" и "Стеки вызовов" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_autos_and_call_stack.PNG "Vs_ide_gs_debug_autos_and_call_stack")  
 ...
 ![Кнопка "Прервать все" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_break_all_button.png "vs_ide_gs_debug_break_all_button")  

 Нажмите клавишу F5 для продолжения выполнения приложения (или нажмите кнопку **Продолжить**).  

 ![Кнопка "Продолжить отладку" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_continue_button.png "Vs_ide_gs_debug_continue_button")  
...
### <a name="setting-conditional-breakpoints"></a>Задание условных точек останова  
 ...
 ![Параметры точки останова в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint_settings.png "Vs_ide_gs_debug_breakpoint_settings")  

 Появится диалоговое окно, где можно задать определенные условия для останова, которое выглядит следующим образом.  

 ![Условная точка останова в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint_conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")  
...
### <a name="inspecting-your-code-at-run-time"></a>Проверка кода во время выполнения  
 ...
 ![Проверка значения времени выполнения в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_inspect_value.PNG "vs_ide_gs_debug_inspect_value")  
 ...
 ![Окно "Средства диагностики" в Visual Studio](~/docs/ide/media/vs_ide_gs_debug_diagnostic_tools.PNG "Vs_ide_gs_debug_diagnostic_tools")  
