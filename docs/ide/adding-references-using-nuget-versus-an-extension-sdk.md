...
|MSBuild автоматически использует H- или LIB-файлы.|Y|Файл *имя_пакета_SDKN*.props указывает Visual Studio, как настроить каталог Visual C++ и т. д. для автоматического использования H- или LIB-файлов.|в||
