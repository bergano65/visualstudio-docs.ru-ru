---
title: Определение целевой версии .NET
ms.date: 03/21/2019
ms.topic: conceptual
helpviewer_keywords:
...
В этой статье описывается, как выбрать целевую определенной версии платформы .NET Framework при создании проекта .NET Framework. Кроме того, она описывает, как изменить целевую версию для существующего проекта Visual Basic, C# или F#.
...
1. Выбор шаблона .NET Framework для типа проекта, который вы хотите создать.
...
1. В раскрывающемся списке **Платформа** в нижней части диалогового окна выберите целевую версию .NET Framework для проекта.
   ...
   > [!NOTE]
   > Некоторые типы проектов, например .NET Core, не отображают **Framework** стрелку раскрывающегося списка.

   ::: moniker range="vs-2017"

   ![Раскрывающийся список в диалоговое окно Новый проект Visual Studio 2017 Framework](media/vside-newproject-framework.png)
...
Можно изменить целевую версию .NET в Visual Basic, C#, или F# проекта, воспользовавшись следующей процедурой.
...
1. В открывшемся диалоговом окне проверки нажмите кнопку **Да**.
    ...
    Проект будет выгружен. При его перезагрузке он предназначен для версии .NET, только что выбранный вами.

    > [!NOTE]
    > Если код содержит ссылки на другую версию .NET, отличный от целевой, при компиляции или выполнения кода могут появиться сообщения об ошибках. Для устранения этих ошибок необходимо изменить ссылки. См. в разделе [.NET, устранение неполадок с нацеливанием](../msbuild/troubleshooting-dotnet-framework-targeting-errors.md).
