...
-   [Увеличение или уменьшение масштаба отображения схемы классов](how-to-customize-class-diagrams.md#ZoomInOut)  
  
-   [Настройка способа группировки и сортировки членов типа](how-to-customize-class-diagrams.md#CustomizeGroupingSorting)  
  
-   [Скрытие секций в типе](how-to-customize-class-diagrams.md#HideCompartments)  
  
-   [Скрытие отдельных членов в типе](how-to-customize-class-diagrams.md#HideMembers)  
  
-   [Отображение скрытых секций и членов в типе](how-to-customize-class-diagrams.md#DisplayHiddenCompartmentsAndMemberrs)  
  
-   [Скрытие отношений](how-to-customize-class-diagrams.md#HideAssociationAndInheritance)  
  
-   [Отображение скрытых отношений](how-to-customize-class-diagrams.md#DisplayAssociationAndInheritance)  
  
-   [Удаление фигуры со схемы классов](how-to-customize-class-diagrams.md#RemoveCodeAndShape)  
  
-   [Удаление фигуры типа и ее кода](how-to-customize-class-diagrams.md#DeleteTypeShapeAndCode)  
