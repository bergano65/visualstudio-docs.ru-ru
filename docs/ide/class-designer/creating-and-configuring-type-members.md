...
2.  В контекстном меню выберите пункт **Сведения о классах**.
...
#### <a name="to-create-a-member-using-the-class-details-window-toolbar"></a>Создание члена с помощью панели инструментов окна "Сведения о классе"
...
#### <a name="to-create-a-member-using-the-class-details-window"></a>Создание члена с помощью окна "Сведения о классах"
