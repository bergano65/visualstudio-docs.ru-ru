---
title: Рефакторинг классов и типов (конструктор классов)
ms.date: 11/04/2016
...
|**Типы рефакторинга, члены типов и параметры:** при помощи конструктора классов можно переименовывать типы, переопределять члены типов или перемещать их из одного типа в другой. Можно также создать типы, допускающие значение NULL.|-   [Переименование типов и членов типов](refactoring-classes-and-types.md#rename)<br />-   [Перемещение членов типа из одного типа в другой](refactoring-classes-and-types.md#move)<br />-   [Практическое руководство. Создание типа, допускающего значение NULL](how-to-create-a-nullable-type.md)|
...
#### <a name="to-rename-a-name-in-the-class-details-window"></a>Изменение имени в окне "Сведения о классах"
