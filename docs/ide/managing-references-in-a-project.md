---
title: "Управление ссылками в проекте | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
helpviewer_keywords: 
  ...
  - "ссылочные объекты, ссылки на проект"
  - "ссылки на внешние компоненты"
  - "создание ссылок на пространства имен"
  - "Проекты Visual Basic, ссылки"
  - "ссылочные компоненты, внешние компоненты"
  - "Веб-ссылки, типы ссылок на проект"
  - "пространства имен [Visual Studio], ссылки"
  - "Компоненты COM, ссылки"
  - "объекты [Visual Studio], ссылки"
...
Перед написанием кода для внешних компонентов или подключенных служб необходимо включить в проект ссылки на них. По сути, ссылка — это запись в файле проекта, которая содержит сведения, необходимые Visual Studio для поиска компонента или службы.  
 ...
 ![Добавить ссылку в Visual C&#43;&#43;](../ide/media/vs2015_cpp_add_reference.png "vs2015\_cpp\_add\_reference")  
...
## Ссылки на файлы  
 Ссылки на файлы — это прямые ссылки на сборки вне контекста проекта Visual Studio. Они создаются на вкладке **Обзордиспетчера ссылок**. Ссылку на файл следует использовать в случае, если имеется лишь сборка или компонент, а проект, который создает ее в качестве выходных данных, отсутствует.  
  
## См. также  
 [Диагностика неработающих ссылок](../ide/troubleshooting-broken-references.md)   
 [Программирование с использованием сборок](../Topic/Programming%20with%20Assemblies.md)   
