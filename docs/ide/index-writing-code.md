...
title: "Создание кода и управление им с помощью Visual Studio | Документация Майкрософт"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с C# и ASP.NET в Visual Studio</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Начало работы с C++ в Visual Studio</h3>
                    </div>
                </div>
            </div>
        </div>
