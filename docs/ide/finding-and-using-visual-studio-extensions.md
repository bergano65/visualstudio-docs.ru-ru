...
Начиная с **Visual Studio 2017 версии 15.6 (предварительная версия 3)**, система оповещает еще и о тех расширениях, которые могут приводить к зависанию интерфейса.
