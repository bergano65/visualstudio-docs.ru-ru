...
![Обозреватель сервера, отображающий развернутый узел инструментов Azure](../ide/media/vs2015_serverexplorer.png)
...
1. Создайте проект приложения UWP на C#.
...
![Средство выбора учетной записи Visual Studio](../ide/media/vs2015_acct_picker.png)
...
![Диспетчер учетных записей](../ide/media/vs2015_accountmanager.gif)
