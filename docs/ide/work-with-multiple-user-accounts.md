...
### <a name="access-your-azure-account-in-server-explorer"></a>Доступ к учетной записи Azure в обозревателе сервера  
 ...
 ![Обозреватель сервера, отображающий развернутый узел инструментов Azure](~/docs/ide/media/vs2015_serverexplorer.png "Обозреватель_сервера_VS2015_")  
 ...
 ![Диалоговое окно "Управление подписками Azure"](~/docs/ide/media/vs2015_manage_subs.png "управление_подписками_vs2015")  
...
###  <a name="access_azure"></a> Доступ к Azure Active Directory в веб-проекте  
 ...
 ![Диалоговое окно "Изменение проверки подлинности" для ASP.NET](~/docs/ide/media/vs2015_change_authentication.png "изменение_проверки_подлинности_VS2015")  
...
## <a name="add-a-second-user-account-to-visual-studio"></a>Добавление учетной записи второго пользователя в Visual Studio  
 ...
 ![Средство выбора учетной записи Visual Studio](~/docs/ide/media/vs2015_acct_picker.png "средство_выбора_учетной_записи_VS2015")  
