...
**_Подсказка окна_* _ _IntelliSense*
...
*Перегрузка метода*  ***Next()** _ _в* ***IntelliSense**_
...
_*_Математическая головоломка_*_ _с задачей на вычитание*
