...
![Установщик Visual Studio](../install/media/vs2017-workloads.png)
...
## <a name="collaborate-with-others-and-control-your-source-code"></a>Возможности совместной работы Visual Studio и управление исходным кодом
Вы можете управлять исходным кодом в репозиториях Git, размещенных любым поставщиком, в том числе и GitHub. С помощью [Visual Studio Team Services (VSTS)](https://www.visualstudio.com/team-services/) можно управлять кодом, а также ошибками и рабочими элементами для всего проекта.
...
Если вы еще не использовали Visual Studio, тогда ознакомьтесь со статьей [Начало работы с Visual Studio](../ide/get-started-with-visual-studio.md) или воспользуйтесь бесплатными курсами Visual Studio, доступными на веб-сайте [Microsoft Virtual Academy](https://mva.microsoft.com/product-training/visual-studio-courses#!index=2&lang=1033). Сведения о новых возможностях Visual Studio 2017 см. в [этой статье](../ide/whats-new-in-visual-studio.md).
