...
Эта обзорная статья описывает создание простого проекта и использование некоторых возможностей Visual Studio, таких как изменение цветовой темы, использование [IntelliSense](using-intellisense.md) в качестве вспомогательного средства написания кода и отладку приложения для просмотра значения переменной во время выполнения программы. Чтобы приступить к работе, [скачайте и установите Visual Studio 2017](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017).
