...
- [Team Explorer](/vsts/user-guide/work-team-explorer) позволяет отслеживать рабочие элементы и использовать код совместно с другими пользователями с помощью технологий управления версиями, таких как [Git](https://git-scm.com/) и система управления версиями Team Foundation (TFVC) (/vsts/tfvc/overview).
...
Документацию по Visual Studio Team Services и Team Foundation Server см. в разделе [Visual Studio Team Services](/vsts/index).
