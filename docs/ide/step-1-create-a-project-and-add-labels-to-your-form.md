...
1.  В списке **Установленные шаблоны** выберите **C#** или **Visual Basic**.

1.  В списке шаблонов выберите шаблон **Приложение Windows Forms**, назовите его **Математическая головоломка**, а затем нажмите кнопку **ОК**.
...
1. Присвойте проекту имя **Mатематическая головоломка** и нажмите кнопку **Создать**.

::: moniker-end

1.  Выберите форму и измените значение свойства **Text** на **Математическая головоломка**.
