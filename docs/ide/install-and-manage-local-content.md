---
title: Установка локальной справочной документации по Visual Studio
ms.date: 11/04/2016
...
1.  На вкладке **Управление содержимым** щелкните переключатель **Диск**.
    ...
    > [!NOTE]
    > Параметр **Диск** недоступен, если администратор запретил вам изменять источник установки содержимого. Дополнительные сведения см. в [руководстве по окну справки для администраторов](../ide/help-viewer-administrator-guide.md).
