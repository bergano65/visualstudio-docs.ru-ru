...
- **Перейти к недавнему файлу** (**CTRL**+**1**, **CTRL**+**R**). Переход к указанному недавно просмотренному файлу в решении (новая возможность в Visual Studio 2017 версии 15.8).
