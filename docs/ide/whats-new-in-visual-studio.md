...
* ![Значок перемещаемого и установленного расширения](../ide/media/vs2017ide-roamedinstalledicon.png) **_Перемещено и установлено_**: Все расширения из списка перемещаемых, установленные в среде разработки.
