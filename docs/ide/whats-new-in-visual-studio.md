...
#### <a name="updated-for-the-154-release"></a>Обновлено для выпуска 15.4
...
Если вы хотите внести предложение по улучшению Visual Studio или сообщить о проблеме, см. страницу [Talk to Us](../ide/talk-to-us.md) (Обращайтесь к нам).  
