...
#### <a name="updated-for-the-157-releasehttpswwwvisualstudiocomnewsreleasenotesvs2017-relnotes"></a>Обновлено для [выпуска 15.7](https://www.visualstudio.com/news/releasenotes/vs2017-relnotes)
...
Если вы хотите внести предложение по улучшению Visual Studio или сообщить о проблеме, см. страницу [Обращайтесь к нам](../ide/talk-to-us.md).  
