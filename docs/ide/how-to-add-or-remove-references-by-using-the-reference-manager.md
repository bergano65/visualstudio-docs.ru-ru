...
- [Сборки](#assemblies) с подгруппами "Платформа" и "Расширения".

- [COM](#com) содержит список всех COM-компонентов, ссылки на которые можно добавить.

- [Решение](#solution) с подгруппой "Проекты".

- [Windows](#windows) с подгруппами "Ядро" и "Расширения". Для просмотра ссылок в Windows SDK и пакетах SDK расширений можно использовать **Обозреватель объектов**.

- [Обзор](#browse) с подгруппой последних ссылок.
...
## <a name="a-idassemblies-assemblies-tab"></a><a id="assemblies" />Вкладка "Сборки"
...
## <a name="a-idcom-com-tab"></a><a id="com" />Вкладка COM
...
## <a name="a-idsolution-solution-tab"></a><a id="solution" />Вкладка "Решение"
...
## <a name="a-idwindows-windows-tab"></a><a id="windows" />Вкладка "Окна"
...
## <a name="a-idbrowse-browse-button"></a><a id="browse" />Кнопка "Обзор"
