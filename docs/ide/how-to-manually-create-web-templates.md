...
3.  Создайте XML-файл и сохраните его, используя расширение VSTEMPLATE, в одном каталоге с проектом. Не добавляйте его в проект в [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
...
8.  Поместите ZIP-файл шаблона в каталог шаблонов проекта [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. По умолчанию это каталог \My Documents\Visual Studio *версия*\My Exported Templates\\.  
