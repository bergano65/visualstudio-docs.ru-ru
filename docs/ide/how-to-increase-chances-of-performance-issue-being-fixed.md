...
3. Выполните действия, описанные в разделе [Как сообщить о проблеме](/visualstudio/ide/how-to-report-a-problem-with-visual-studio-2017), и приложите к новому элементу отзыва соответствующий дамп кучи.
...
4. Выполните действия, описываемые в разделе [Как сообщить о проблеме](/visualstudio/ide/how-to-report-a-problem-with-visual-studio-2017), вплоть до шага "Предоставьте дамп трассировки и кучи (необязательно)".
