...
Пользователи Visual Studio широко используют средство [Сообщить о проблеме](./how-to-report-a-problem-with-visual-studio.md?view=vs-2019) для отправки отчетов о возникающих проблемах. Команда разработчиков Visual Studio анализирует отзывы пользователей, выявляет наблюдаемые в них тенденции к возникновению сбоев или снижению производительности и устраняет проблемы, которые могут затрагивать многих пользователей. Чем больше полезной информации содержит отзыв в запросе, тем выше вероятность, что команде разработчиков удастся быстро выявить и решить проблему. В этом документе приводятся рекомендации по включению полезной информации в сообщения о сбоях или проблемах с производительностью.
...
На [экране "Запись"](./how-to-report-a-problem-with-visual-studio.md?view=vs-2019#record-a-repro) выберите сеанс Visual Studio, который не отвечает.
