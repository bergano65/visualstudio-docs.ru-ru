...
Пользователи Visual Studio широко используют средство [Сообщить о проблеме](https://aka.ms/vs-rap) для отправки отчетов о возникающих проблемах. Команда разработчиков Visual Studio анализирует отзывы пользователей, выявляет наблюдаемые в них тенденции к возникновению сбоев или снижению производительности и устраняет проблемы, которые могут затрагивать многих пользователей. Чем больше полезной информации содержит отзыв в запросе, тем выше вероятность, что команде разработчиков удастся быстро выявить и решить проблему. В этом документе приводятся рекомендации по включению полезной информации в сообщения о сбоях или проблемах с производительностью.
...
Если вы столкнулись с проблемами такого вида, выполните указанные в [этом разделе](https://docs.microsoft.com/visualstudio/ide/how-to-report-a-problem-with-visual-studio-2017) шаги и включите в отчет следующее:
...
Задайте количество дампов и папку для их размещения. Дополнительные сведения об этих параметрах см. в [этом разделе](https://docs.microsoft.com/windows/win32/wer/collecting-user-mode-dumps?redirectedfrom=MSDN).
...
3.  Выполните действия, описанные в разделе [Сообщение о проблеме](https://docs.microsoft.com/visualstudio/ide/how-to-report-a-problem-with-visual-studio-2017), и приложите к новому элементу отзыва соответствующий дамп кучи.
...
4.  Выполните действия, описываемые в разделе [Сообщение о проблеме](https://docs.microsoft.com/visualstudio/ide/how-to-report-a-problem-with-visual-studio-2017), вплоть до шага "Укажите дамп трассировки и кучи (необязательно)".
