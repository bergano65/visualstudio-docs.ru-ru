...
## <a name="navigate-in-the-code-window"></a>Навигация в окне кода  
 ...
 ![Кнопки перехода вперед и назад](../ide/media/vs2015_nav_buttons.png "кнопки_навигации_VS2015_")  
...
Чтобы ограничить область поиска только символами кода, добавьте символ "@" перед запросом перехода. Например, при поиске `@application` команда "Перейти к" отображает, скажем, только классы, которые содержат слово "application".
...
![Окно "Перейти к" — поиск с использованием прописных букв](../ide/media/vside_capitalsearch.png "Окно "Перейти к" — поиск с использованием прописных букв")
