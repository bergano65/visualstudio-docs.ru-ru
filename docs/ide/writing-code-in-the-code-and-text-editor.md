---
title: "Использование редактора кода в Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 09/27/2017
ms.reviewer: 
ms.suite: 
...
Дополнительные сведения о настройке редактора см. в разделе [Настройка редактора](../ide/customizing-the-editor.md). Параметры редактора для JavaScript см. в статье ["Параметры", "Текстовый редактор", JavaScript, "Форматирование"](../ide/reference/options-text-editor-javascript-formatting.md).
