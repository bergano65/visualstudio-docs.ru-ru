...
|||
|-|-|
|[Форматировать документ](code-styles-and-quick-actions.md#format-document-command)|Установка правильного отступа строк кода и перемещение фигурных скобок для разделения строк в документе.|
...
Дополнительные сведения о настройке редактора см. в статье [Настройка редактора](../ide/customizing-the-editor.md). Параметры редактора для JavaScript см. в статье о [параметрах редактора JavaScript](../ide/reference/options-text-editor-javascript-formatting.md).
