...
В таблицах ниже собраны некоторые символы, операторы, конструкции и примеры для регулярных выражений. Более подробный справочник по регулярным выражениям вы найдете [здесь](/dotnet/standard/base-types/regular-expression-language-quick-reference).
