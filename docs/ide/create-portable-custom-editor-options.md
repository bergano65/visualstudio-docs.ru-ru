...
![Иерархия EditorConfig](~/docs/ide/media/vside_editorconfig_hierarchy.png)
...
![Параметр "Табуляция" в текстовом редакторе](~/docs/ide/media/vside_editorconfig_tabsetting.png)
...
![Код до использования EditorConfig](~/docs/ide/media/vside_editorconfig_before.png)
...
![Файл .editorconfig, добавленный в проект](~/docs/ide/media/vside_editorconfig_addconfig.png)

Теперь при нажатии клавиши TAB вместо пробелов будут применяться символы табуляции.

![TAB добавляет символ табуляции](~/docs/ide/media/vside_editorconfig_tab.png)
