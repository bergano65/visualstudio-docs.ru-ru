...
1.  В диалоговом окне **Новый проект** создайте классическое приложение C# WPF и присвойте ему имя. Представьте, что это и есть проект, в котором предстоит работать над пользовательским интерфейсом, вследствие чего для окна конструктора следует выделить максимальное пространство и закрыть остальные окна средства.  
