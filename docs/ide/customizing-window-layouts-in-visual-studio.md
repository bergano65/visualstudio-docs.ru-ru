...
Окна инструментов и документов можно упорядочить путем перетаскивания, с помощью команд меню **Окно** и щелчка строки заголовка окна правой кнопкой мыши.
