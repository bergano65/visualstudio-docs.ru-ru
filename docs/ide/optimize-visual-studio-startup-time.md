...
!["Управление производительностью Visual Studio" — всплывающее окно с сообщением "Мы обнаружили расширение, замедляющее работу Visual Studio"](~/docs/ide/media/vside_perfdialog_popup.PNG)
...
!["Управление производительностью Visual Studio" — представление расширений](~/docs/ide/media/vside_perfdialog_extensions.PNG)
...
!["Управление производительностью Visual Studio" — представление окон инструментов](~/docs/ide/media/vside_perfdialog_toolwindows.PNG)
...
![Сервис, Параметры](~/docs/ide/media/VSIDE_LightweightSolutionLoad.png)
...
![обозреватель решений](~/docs/ide/media/VSIDE_LSL Solution Setting.png)
...
![Всплывающее окно](~/docs/ide/media/VSIDE_LSL Popup.png)
