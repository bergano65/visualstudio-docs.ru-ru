...
## [Оптимизация производительности Visual Studio](optimize-visual-studio-startup-time.md)
## [Оптимизация загрузки решения](optimize-solution-loading-in-visual-studio.md)
...
## [Добавление URL-адресов в частной сети в список разрешений](whitelisting-urls-in-a-private-network.md)
