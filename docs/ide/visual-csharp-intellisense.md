...
### <a name="add-using"></a>Добавить директиву using  
 ...
 ![Добавить использование изображения смарт-тега](~/docs/ide/media/addusesmart.gif "AddUseSmart")  
 ...
 ![Добавить использование расширенного изображения смарт-тега](~/docs/ide/media/addusesmartexp.gif "AddUseSmartExp")  
...
## <a name="generate-event-handlers"></a>Сформировать обработчики событий  
 ...
 ![Автопривязка кнопки](~/docs/ide/media/vxautohookup.gif "vxAutoHookUp")  
 ...
 ![Генерация обработчика событий](~/docs/ide/media/vxgenerateeventhandler.gif "vxGenerateEventHandler")  
