---
title: Просмотр структуры кода в Visual Studio | Документация Майкрософт
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-general
...
---
# <a name="view-the-structure-of-code"></a>Просмотр структуры кода

Вы можете проверять объекты и элементы в проектах Visual Studio, компонентах .NET Framework, компонентах COM, библиотеках динамической компоновки (DLL) и библиотеках типов (TLB).
