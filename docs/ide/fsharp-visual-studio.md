...
|ClickOnce|Нет|По возможности используйте клиентский проект на другом языке .NET Framework.|
...
|Пути для ссылок|[Управление ссылками в проекте](managing-references-in-a-project.md)|Здесь можно указать, где следует искать сборки, от которых зависит код.|
