...
|ClickOnce|Нет|Используйте проект клиента на другом языке .NET, если применимо.|
...
| - |-------------|-----------|
|Приложение|[Страница "Приложение" в конструкторе проектов](reference/application-page-project-designer-csharp.md)|Позволяет указать параметры на уровне приложения и свойства, например при создании библиотеки или исполняемого файла, какая версия .NET предназначено приложение, а также сведения о том, где хранятся файлы ресурсов, используемых приложением.|
...
|Переход к определению .NET API|Когда курсор находится на .NET API, показан код, созданный из метаданных .NET.|Нет|
