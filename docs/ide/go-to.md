...
![Перейти ко всем](~/docs/ide/media/gotoall.png)
...
* Введите знак вопроса (?), чтобы получить дополнительную справку.
  ![Справка по команде "Перейти ко всем"](~/docs/ide/media/gotoall_help.png)
...
:----: | ---- | -------- | ---
#      | ![Значок символа](~/docs/ide/media/gotoall_symbolicon.png) | CTRL+1, Ctrl+S | Поиск совпадающих символов
f      | ![Значок файла](~/docs/ide/media/gotoall_fileicon.png)     | CTRL+1, Ctrl+F | Поиск совпадающих имен файлов
m      | ![Значок члена](~/docs/ide/media/gotoall_membericon.png) | Ctrl+1, Ctrl+M | Поиск совпадающих членов
т      | ![Значок типа](~/docs/ide/media/gotoall_typeicon.png)     | Ctrl+1, Ctrl+T | Поиск совпадающих типов
:      | ![Значок строки](~/docs/ide/media/gotoall_lineicon.png)     | CTRL+G         | Переход к введенному номеру строки
...
Значок | Описание
---- | ---
![Текущий документ](~/docs/ide/media/gotoall_currentdocument.png) | Поиск только в текущем документе
![Внешние документы](~/docs/ide/media/gotoall_external.png) | Поиск во внешних документах наряду с документами, находящимися в проекте или решении

### <a name="settings"></a>Параметры
Щелкните значок шестеренки ![Значок шестеренки](~/docs/ide/media/gotoall_gear.png) в правом нижнем углу, чтобы изменить порядок работы этой функции.
