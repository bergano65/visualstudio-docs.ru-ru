...
description: Сведения о разработке приложений в Visual Studio на различных языках программирования.
ms.date: 01/01/2018
layout: LandingPage
author: gewarren
ms.author: gewarren
...
ms.locfileid: "53027280"
---
# <a name="visual-studio-documentation"></a>Документация по Visual Studio

Сведения о разработке приложений в Visual Studio на различных языках программирования.
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Узнайте об установке и настройке среды Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Общие сведения о Visual Studio</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Studio 2017 на портале Microsoft Virtual Academy</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Обзор интегрированной среды разработки (IDE)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Сведения о проектах и решениях</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Выберите цвета темы и текста для персонализации</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Создание веб-приложения на C#</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Создание консольного приложения на C++</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Создание веб-приложения на Python</h3>
                    </div>
                </div>
            </div>
        </div>
...
src="https://docs.microsoft.com/media/common/i_debug.svg"><span>Отладка</span></a></div>