---
title: Синхронизация параметров в Visual Studio
ms.date: 01/23/2017
...
В Visual Studio версии 15.3 и выше мы перестали дублировать определенные настройки (например, структуру окна инструментов) в параллельно установленных версиях Visual Studio 15.3. Для этого мы изменили расположение файла *CurrentSettings.vssettings* и перенесли его из папки *%userprofile%\Documents\Visual Studio 2017\Settings* в папку определенной установки: *%localappdata%\Microsoft\VisualStudio\2017.0_xxxxxxxx\Settings*.

> [!NOTE]
> Чтобы использовать новые индивидуальные параметры для установки, необходимо обновить установку. При обновлении уже установленной системы Visual Studio 2017 до последней версии будет использоваться предыдущее общее расположение. Если у вас есть параллельно установленные версии Visual Studio 2017 и вы хотите, чтобы в обновленной версии использовалось собственное расположение файла параметров, сделайте следующее:
