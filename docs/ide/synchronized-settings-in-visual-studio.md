---
title: "Синхронизированные параметры в Visual Studio | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Синхронизированные параметры в Visual Studio
...
-   Параметры разработки \(необходимо выбрать набор параметров при первом запуске Visual Studio, но этот выбор можно изменить в любое время\).  Дополнительные сведения см. в статье [Customizing Development Settings in Visual Studio](http://msdn.microsoft.com/ru-ru/22c4debb-4e31-47a8-8f19-16f328d7dcd3).  
  
-   Следующие параметры на страницах **Сервис &#124; Параметры**:  
  
    -   Параметры регистра в разделе **Тема** и строки меню на странице параметров **Среда**, **Общие**  
...
## Выключение синхронизации параметров для конкретного компьютера  
...
## Синхронизация параметров в разных семействах продуктов и выпусках Visual Studio  
