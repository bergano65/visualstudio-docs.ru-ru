...
## <a name="related-sections"></a>Связанные разделы  
 ...
 Описывает элемент управления **Целевая рабочая среда** в конструкторе проектов для проектов [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)].  
  
 [Страница "Приложение" в конструкторе проектов (Visual Basic)](../ide/reference/application-page-project-designer-visual-basic.md)  
 Описывает элемент управления **Целевая рабочая среда** в конструкторе проектов для проектов [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
