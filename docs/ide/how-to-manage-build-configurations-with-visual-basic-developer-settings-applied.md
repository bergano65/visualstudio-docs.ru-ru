...
description: Сведения о расширенных параметрах конфигурации сборки, которые скрыты при применении параметров разработчика Visual Basic, а также о том, как включить эти параметры вручную.
titleSuffix: ''
