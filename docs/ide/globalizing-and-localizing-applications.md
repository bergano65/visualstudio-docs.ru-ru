...
## <a name="in-this-section"></a>Содержание  
 ...
 Содержит ссылки на сведения о настройке приложений для заданного языка и заданного набора региональных параметров.  
...
## <a name="related-sections"></a>Связанные разделы  
 [Глобализация приложения (HTML)](http://go.microsoft.com/fwlink/?LinkId=258266)  
 Содержит инструкции и рекомендации по глобализации и локализации вашего приложения Windows 8.1, созданного с помощью HTML.  
  
 [Глобализация приложения (XAML)](http://go.microsoft.com/fwlink/?LinkId=258267)  
 Содержит инструкции и рекомендации по глобализации и локализации вашего приложения Windows 8.1, созданного с помощью XAML.  
 ...
 Указывает классы в этом пространстве имен, определяющие сведения, которые относятся к языку и региональным параметрам, такие как язык, страна или регион, используемые календари, шаблоны форматирования дат, денежных единиц и чисел, а также порядок сортировки строк.  
