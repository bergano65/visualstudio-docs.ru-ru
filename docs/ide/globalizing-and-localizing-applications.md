...
<a id="related-sections" class="xliff"></a>  
 ...
 Содержит инструкции и рекомендации по глобализации и локализации вашего приложения [!INCLUDE[win8_appname_long](../debugger/includes/win8_appname_long_md.md)], созданного с помощью XAML и Visual C#, Visual Basic или Visual C++.  
