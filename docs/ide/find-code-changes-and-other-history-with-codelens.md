...
2. Если вы еще этого не сделали, создайте приложение для загрузки индикаторов тестов CodeLens. Убедитесь, что включено [обнаружение по скомпилированным сборкам](../test/test-explorer-faq.md#3-assembly-based-discovery-is-no-longer-working-for-my-project-how-do-i-turn-it-back-on).
...
**Ответ**. Перестройте проект, чтобы индикаторы тестов CodeLens загружались в файл. Убедитесь, что включено [обнаружение по скомпилированным сборкам](../test/test-explorer-faq.md#3-assembly-based-discovery-is-no-longer-working-for-my-project-how-do-i-turn-it-back-on). Для повышения производительности Visual Studio больше не получает сведения об источнике для индикаторов тестов при загрузке файлов кода. Индикаторы тестов загружаются после сборки или при переходе к тесту двойным щелчком в **обозревателе тестов**.
