...
2.  Можно переместить курсор в другую точку окна определения кода. При этом вы сохраняете возможность перемещаться по исходному окну кода.  
...
1. Выберите элементы **Сервис**, **Параметры**, **Текстовый редактор**, **Общие**.  

2. Выберите параметр **Открыть определение в быстром редакторе**.  
