...
Чтобы перейти непосредственно на странице справочника по .NET для компонента, нажмите клавишу **F1** в элемент **элементов** или элементе компонента в области конструктора.
