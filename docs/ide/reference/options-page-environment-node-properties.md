---
title: "Страница “Параметры”, свойства узла “Среда” | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
helpviewer_keywords: 
  ...
  - "Параметры средств, свойства узла "Среда""
...
|AutohidePinActiveTabOnly|Get\/Set \(Boolean\)|Определяет, применяется ли действие кнопки **Автоматически скрыть** только к активной вкладке.|  
...
|ShowOutputWindowBeforeBuild|Get\/Set \(Boolean\)|Определяет, отображать ли окно **Вывод** при начале построения.|  
|ShowTaskListAfterBuild|Get\/Set \(Boolean\)|Определяет, должна ли неудавшаяся операция построения отображать **Список задач** по окончании построения.|  
