...
|**Применить настройки квалификации this.**|Если этот параметр выбран, применяет настройки `this.` при запуске **Edit.FormatDocument**.| [Параметры квалификации this. EditorConfig](../../ide/editorconfig-language-conventions.md#this-and-me)<br/><br/>**Сервис** > **Параметры** > **Текстовый редактор** > **C#**  > **Стиль кода** > **Предпочтения this.** |
