...
description: Узнайте, как использовать диалоговое окно "Дополнительные параметры компилятора" для установки дополнительных свойств конфигурации сборки.
...
2. В меню **Проект** выберите **Свойства** . После открытия окна **Конструктор проектов** перейдите на вкладку **Компиляция** .
