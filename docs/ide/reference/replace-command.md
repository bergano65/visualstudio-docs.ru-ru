...
Необязательный элемент. Выполняет поиск скрытого или свернутого текста, например метаданных элемента управления времени разработки, скрытой области структурированного документа либо свернутого класса или метода.
