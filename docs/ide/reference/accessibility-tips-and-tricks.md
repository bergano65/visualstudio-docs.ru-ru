...
Некоторые люди хуже различают отдельные цвета. Если вы хотите повысить контрастность при написании кода, но не желаете использовать основные темы с высокой контрастностью, мы предлагаем вам новую тему — "Синий (дополнительный контраст)".
  ...
  ![Сравните синюю тему и синюю тему с дополнительный контрастностью](media/blue-extra-contrast-theme.png "Снимок экрана, где показаны различия между синей темой и синей темой с дополнительный контрастностью")
...
Редактор Visual Studio содержит множество текстовых крайних элементов, позволяющих узнать о характеристиках и возможностях отдельных элементов в строке кода, например значков отвертки и лампочки, закладок, волнистых линий, обозначающих ошибки и предупреждения, и т. д. Вы можете использовать набор команд "Показать заметки линий" для поиска этих элементов оформления и перемещения между ними.
  ...
  ![Используйте набор команд "Показать заметки линий"](media/show-line-annotations-command-set.png "Снимок экрана пункта меню \"Показать заметки линий\"")
...
1. В любой точке интегрированной среды разработки нажмите следующие два сочетания клавиш один за другим: **CTRL**+ **&#92;** , а затем **CTRL**+**N**.
   ...
   ![Окно инструментов "Уведомления" в интегрированной среде разработки Visual Studio](media/toast-notification.png "Снимок экрана окна \"Уведомления\" в интегрированной среде разработки Visual Studio")
...
1. В поле **поиска** на компьютере под управлением Windows 10 введите **изменение системных звуков**.
   ...
   ![Поле поиска в Windows 10](media/type-here-to-search.png "Снимок экрана поля поиска в Windows 10")
...
1. Дважды щелкните элемент **Изменение системных звуков**.
   ...
   ![Результаты поиска в Windows 10](media/change-system-sounds.png "Снимок экрана результатов поиска элемента \"Изменение системных звуков\" в Windows 10")
