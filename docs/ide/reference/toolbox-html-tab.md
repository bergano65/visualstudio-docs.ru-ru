 ...
 **Указатель**  
 ![Указатель HTMLpage конструктора мобильных устройств ASP.NET](~/docs/ide/reference/media/vxpointer.gif "vxPointer")  
 ...
 **Ввод (кнопка)**  
 ![Кнопка веб-страницы HTML](~/docs/ide/reference/media/vxbutton.gif "vxButton")  
 ...
 **Ввод (кнопка сброса)**  
 ![Снимок экрана HTMLpageResetButton](~/docs/ide/reference/media/vxreset.gif "vxReset")  
 ...
 **Ввод (кнопка отправки)**  
 ![Снимок экрана HTMLpageToolbarSubmitButton](~/docs/ide/reference/media/vxsubmit.gif "vxSubmit")  
 ...
 **Ввод (текст)**  
 ![Снимок экрана HTMLpageToolbarTextField](~/docs/ide/reference/media/vxtextfield.gif "vxTextfield")  
 ...
 **Ввод (файл)**  
 ![Поле файла страницы HTML](~/docs/ide/reference/media/vxfilefield.gif "vxFilefield")  
 ...
 **Ввод (пароль)**  
 ![Поле пароля Visual Studio](~/docs/ide/reference/media/vxpassword.gif "vxPassword")  
 ...
 **Ввод (флажок)**  
 ![Параметр Checkbox панели элементов веб-страницы HTML](~/docs/ide/reference/media/vxcheckbox.gif "vxCheckbox")  
 ...
 **Ввод (переключатель)**  
 ![Снимок экрана VisualStudioHTMLpageRadioButton](~/docs/ide/reference/media/vxradio.gif "vxRadio")  
 ...
 **Ввод (скрытое поле)**  
 ![Скрытый элемент страницы HTML](~/docs/ide/reference/media/vxhidden.gif "vxhidden")  
 ...
 **Текстовая область**  
 ![Область текста панели инструментов HTMLpage](~/docs/ide/reference/media/vxtextarea.gif "vxTextarea")  
 ...
 **Таблица**  
 ![Снимок экрана HTMLpageToolbarTable](~/docs/ide/reference/media/vxtable.gif "vxTable")  
...
**Изображение**  
 ![Элемент изображения страницы HTML](~/docs/ide/reference/media/vximage.gif "vxImage")  
 ...
 **Выбрать**  
 ![Открывающаяся панель элементов страницы HTML](~/docs/ide/reference/media/vxdropdown.gif "vxDropdown")  
 ...
 **Горизонтальная линия**  
 ![Элемент горизонтальной линии страницы HTML](~/docs/ide/reference/media/vxhorizontal.gif "vxHorizontal")  
 ...
 **ДИВ**  
 ![Метка страницы HTML](~/docs/ide/reference/media/vxlabel.gif "vxLabel")  
