...
Выберите этот параметр, чтобы использовать IIS Express вместо Visual Studio Development Server. Дополнительные сведения см. в разделе [Introducing IIS Express](https://weblogs.asp.net/scottgu/introducing-iis-express) (Знакомство с IIS Express) и [IIS Express Overview](/iis/extensions/introduction-to-iis-express/iis-express-overview) (Обзор IIS Express).
