---
title: Введение локальной переменной в Visual Studio | Документы Майкрософт
ms.custom: ''
ms.date: 01/26/2018
...
1. Выберите **Введите локальное значение для (все вхождения) "*выражение*"** в раскрывающемся меню.
