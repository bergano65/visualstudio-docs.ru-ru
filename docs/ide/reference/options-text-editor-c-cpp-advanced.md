...
description: Узнайте, как использовать страницу "Дополнительно" в разделе "C/C++" для изменения поведения, связанного с IntelliSense и базой данных просмотра.
