...
**Зачем?** Интерфейсы — это отличные конструкции для объектно-ориентированных разработок.  Представьте классы различных животных (собака, кот, птица), которые могут иметь общие методы, например, еда, питье, сон.  Благодаря интерфейсу IAnimal классы "собака", "кот" и "птица" смогут иметь общую "сигнатуру" для этих методов.
