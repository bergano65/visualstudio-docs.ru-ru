...
-   **Создание доступных веб-страниц с помощью языка DHTML**. В этой технической статье перечислены доступные элементы HTML 4.0, а также советы по проектированию специальных возможностей на веб-сайтах. Дополнительные сведения см. в статье [http://msdn2.microsoft.com/library/ms528445.aspxx](http://msdn2.microsoft.com/library/ms528445.aspx).  
