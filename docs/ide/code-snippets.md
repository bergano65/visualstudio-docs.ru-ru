...
Чтобы вставить этот фрагмент, выберите в контекстном меню окна кода команду **Вставить фрагмент кода**, затем команду **Visual C#**, после чего введите `tryf` и нажмите клавишу **TAB**. Либо можно ввести `tryf` и два раза нажать клавишу **TAB**.
...
Например, в Visual Basic имеется фрагмент кода, который вставляет свойство. Чтобы вставить фрагмент кода, выберите **Фрагмент кода...** > **Вставить фрагмент кода** в контекстном меню в файле кода Visual Basic. Выберите **Шаблоны кода** > **Свойства, процедуры, события** > **Определить свойство**.
