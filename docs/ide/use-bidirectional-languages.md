---
title: Поддержка арабского и иврита
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
ms.locfileid: "66824150"
---
# <a name="support-for-bidirectional-languages-in-visual-studio"></a>Поддержка языки с двунаправленным письмом в Visual Studio

Visual Studio может правильно отобразить текст на арабском и иврите и позволяет вводить двунаправленный текст для значений и имен объектов.
...
Во время разработки в Visual Studio можно использовать языки с двунаправленным написанием при вводе текста, в именах объектов и при сохранении и открытии файлов.
...
Следующие элементы можно присваивать имена на арабском или иврите и обрабатываются правильно в Visual Studio:
...
- Элементы данных.
   ...
   **Обозреватель серверов** правильно отображает эти элементы и их можно изменять.
...
- [Разрабатывайте глобализованные и локализованные приложения](globalizing-and-localizing-applications.md)
