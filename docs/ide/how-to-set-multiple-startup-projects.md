...
description: Узнайте, как Visual Studio позволяет указать выполнение нескольких проектов при запуске отладчика.
...
ms.locfileid: "92136996"
---
# <a name="how-to-set-multiple-startup-projects"></a>Руководство. Назначение нескольких запускаемых проектов
