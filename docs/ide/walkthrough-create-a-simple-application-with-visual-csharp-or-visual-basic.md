---
title: Пошаговое руководство. Создание простого приложения с помощью C# или Visual Basic
ms.date: 10/03/2017
...
#### <a name="create-the-wpf-project"></a>Создание проекта WPF
...
2.  Выберите шаблон приложения WPF Visual Basic или Visual C#, например, выбрав в левой области **Установленные** > **Visual C#** > **Классический рабочий стол Windows**, а затем **Приложение WPF (.NET Framework)** в средней области.  В нижней части диалогового окна **Новый проект** назовите проект `HelloWPFApp`.
...
2.  При необходимости снова разместите элемент TextBlock по центру и сохраните изменения, нажав сочетание клавиш **CTRL**+**S** или выбрав пункт в меню **Файл**.
...
1.  На поверхности разработки дважды щелкните кнопку **Display** .
     ...
     Будет открыт файл *Greetings.xaml.vb* или *Greetings.xaml.cs*, а курсор установлен на событии `Button_Click`.
...
#### <a name="clean-the-solution-files-and-build-a-release-version"></a>Очистка файлов решения и сборка окончательной версии
...
Поздравляем с завершением этого пошагового руководства! Построенный файл *.exe* находится в каталоге решения и проекта (*...\HelloWPFApp\HelloWPFApp\bin\Release*). Чтобы изучить больше примеров, см. раздел [Примеры Visual Studio](../ide/visual-studio-samples.md).
