...
description: Используйте функции Конструктор XAML в Blend для Visual Studio для рисования контуров и фигур, их изменения и объединения.
