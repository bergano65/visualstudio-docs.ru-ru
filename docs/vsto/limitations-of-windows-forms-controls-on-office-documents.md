...
## <a name="limitations-of-methods-and-properties-of-windows-forms-controls"></a>Ограничения методов и свойств элементов управления Windows Forms  
 Существует несколько методов и свойств элементов управления Windows Forms, которые работают так же, как в документе в форме Windows Forms, и, таким образом, рекомендуется, что они не будут использоваться. Например, такие как установка свойства `Dock` и `Anchor` влияет только на положение элемента управления относительно контейнера элемента управления ActiveX, а не в документе. Ниже приведен список неподдерживаемых методов и свойств элементов управления Windows Forms для Word и Excel.  
...
-   Неподдерживаемые методы и свойства элементов управления Word:  
 ...
 Также нельзя задать `Left` или `Top` свойства элементов управления Windows Forms, в тексте в документе Word. Элементы управления Windows Forms добавляются в текст в следующих случаях:  
