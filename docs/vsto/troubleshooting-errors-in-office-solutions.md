---
title: Устранение неполадок в решениях Office
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
-   [Создание, обновление и открывать проекты](#creating)  
  
-   [Использовать конструкторы](#designers)  
...
##  <a name="creating"></a> Создание, обновление и открывать проекты  
...
### <a name="control-properties-are-lost-when-you-create-a-new-project-based-on-a-document-from-an-existing-project"></a>Свойства элемента управления теряются при создании нового проекта, основанного на документе из существующего проекта  
...
### <a name="errors-when-you-create-an-excel-workbook-project-based-on-an-existing-workbook"></a>Ошибки при создании проекта книги Excel на основе существующей книги  
 При создании проекта книги Excel на основе существующей книги, могут возникнуть следующие ошибки.  
...
##  <a name="designers"></a> Использовать конструкторы  
...
### <a name="insert-clip-art-command-does-nothing-in-the-visual-studio-designer"></a>Вставка картинки из коллекции картинок не выполняет никаких действий в конструкторе Visual Studio  
 Если Excel или Word открыты в конструкторе Visual Studio, при нажатии **картинки** кнопку **иллюстрации** не удается открыть вкладку на ленте **картинки** области задач. Чтобы добавить картинку из коллекции картинок, необходимо открыть копию книги или документа из главной папки проекта (но не копию в *\bin* папки) вне Visual Studio, добавить картинки из коллекции картинок, а затем сохраните книгу или документ.  
...
### <a name="cannot-build-a-document-level-project-that-is-based-on-a-document-with-restricted-permissions"></a>Не удалось создать проект уровня документа, основанного на документе с ограниченными разрешениями  
...
### <a name="cannot-run-or-debug-any-office-solution-on-the-development-computer"></a>Не удается запустить или отладить решение Office на компьютере разработчика  
...
### <a name="error-when-stopping-the-debugger-in-a-document-level-project-after-using-edit-and-continue"></a>Ошибка при остановке отладчика в проекте уровня документа после использования, изменить и продолжить  
 Если вы используете **изменить** и **Продолжить** для внесения изменений в код в проекте уровня документа для Excel или Word, когда проект находится в режиме приостановки выполнения, может появиться диалоговое окно с следующее сообщение об ошибке, если вы впоследствии остановите отладчик.  
