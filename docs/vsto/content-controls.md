...
### <a name="build-block-gallery"></a>Построение Коллекция блоков  
 Коллекция стандартных блоков позволяет пользователям выбрать из списка *стандартные блоки документа* для вставки в документ. Стандартный блок документа — это фрагмент содержимого, который был создан для многократного применения, например, общая титульная страница, отформатированная таблица или заголовок. Дополнительные сведения см. в описании типа <xref:Microsoft.Office.Tools.Word.BuildingBlockGalleryContentControl>. Дополнительные сведения о стандартных блоках см. в разделе [Новинки для разработчиков в Word 2007](http://msdn.microsoft.com/74aa6688-65b3-4167-997d-131f26ad8f84).  
