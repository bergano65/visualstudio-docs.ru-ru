...
# Привязка данных к элементам управления в решениях Office
 ...
 ![ссылка на видео](~/data-tools/media/playvideo.gif "ссылка на видео") Соответствующие демонстрационные видеоролики см.по ссылке [Инструкции. Использование данных из базы данных в Excel](http://go.microsoft.com/fwlink/?LinkID=130287).  
