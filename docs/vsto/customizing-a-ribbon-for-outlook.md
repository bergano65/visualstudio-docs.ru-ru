...
# Настройка ленты для Outlook
 ...
 ![ссылка на видео](../vsto/media/playvideo.png "ссылка на видео") Для просмотра связанных демонстрационных видеороликов перейдите по ссылке [Как использовать конструктор ленты для настройки ленты в Outlook](http://go.microsoft.com/fwlink/?LinkID=130312).  
