---
title: "Практическое руководство. Заполнение документов данными из базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
# Практическое руководство. Заполнение документов данными из базы данных
 ...
 ![ссылка на видео](../vsto/media/playvideo.png "ссылка на видео") Демонстрационные видеоматериалы см. в статье [Привязка данных к элементам управления содержимым Word 2007 с помощью набора средств Visual Studio для Office \(3.0\)](http://go.microsoft.com/fwlink/?LinkId=136785).  
