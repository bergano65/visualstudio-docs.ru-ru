...
description: Узнайте, как элемент настройки пространства имен vstov4 описывает конкретное решение Office.
titleSuffix: ''
...
### <a name="document-level-customizations"></a>Настройки Document-Level
