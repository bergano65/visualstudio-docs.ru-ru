---
title: "Настройка пользовательского интерфейса Office | Документы Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
-   В надстройку VSTO можно добавить настраиваемую область задач. Пользователи могут закреплять настраиваемые области задач с разных сторон окна приложения, или их можно перетаскивать в любое место в окне.  
 ...
 Дополнительные сведения о панелях действий см. в разделе [Общие сведения о панели действий](../vsto/actions-pane-overview.md). Дополнительные сведения о настраиваемых областях задач см. в разделе [настраиваемые области задач](../vsto/custom-task-panes.md).  
...
##  <a name="FormRegion"></a>Области формы Outlook  
 ...
 Дополнительные сведения см. в разделе [Creating Outlook Form Regions](../vsto/creating-outlook-form-regions.md).  
