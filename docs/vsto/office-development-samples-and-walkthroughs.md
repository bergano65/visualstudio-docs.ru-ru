...
# <a name="office-development-samples-and-walkthroughs"></a>Примеры разработки решений Office и пошаговые руководства
 ...
 Сведения о безопасности приложений см. в разделе [решений Office, защита](../vsto/securing-office-solutions.md).  
...
|[Данные в пошаговых руководствах решений Office](../vsto/data-in-office-solutions-walkthroughs.md)|Список пошаговых руководств, которые показывают, как работать с данными в решениях.|  
...
|[Развертывание и безопасность пошаговые руководства](../vsto/security-and-deployment-walkthroughs.md)|Список пошаговых руководств, показывающих, как можно установить политику безопасности, чтобы решение для запуска и развертывание решения.|  
