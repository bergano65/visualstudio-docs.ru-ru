---
title: "Пошаговое руководство: Получение кэшированных данных из книги на сервере | Документы Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="walkthrough-retrieving-cached-data-from-a-workbook-on-a-server"></a>Пошаговое руководство. Получение кэшированных данных из книги на сервере
...
## <a name="retrieving-data-from-the-cached-dataset-by-using-the-console-application"></a>Загрузка данных из кэшированного набора данных с помощью консольного приложения  
...
#### <a name="to-retrieve-data-from-the-cached-dataset"></a>Для получения данных из кэшированного набора данных  
...
8.  Добавьте следующий код в метод `Main` . Этот код объявляет следующие объекты:  
    ...
    -   Объект <xref:Microsoft.VisualStudio.Tools.Applications.ServerDocument> объект, используемый для доступа к кэшу данных в книге.  
        ...
        > [!NOTE]  
        >  В следующем коде предполагается, сохранении книги с помощью расширение XLSX. Если книга в проекте имеет другое расширение, измените путь соответственно.  
...
2.  Нажмите клавишу ВВОД, чтобы закрыть приложение.  
