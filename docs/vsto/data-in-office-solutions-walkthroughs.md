---
title: Данные в пошаговые руководства по решениям Office | Документы Microsoft
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
## <a name="caching-data-in-document-level-solutions"></a>Кэширование данных в решениях на уровне документа  
