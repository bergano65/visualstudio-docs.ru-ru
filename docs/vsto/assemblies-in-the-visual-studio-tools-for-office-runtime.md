...
## <a name="assemblies-in-the-office-extensions-for-the-net-framework-4-and-the-includenet_v45includesnet-v45-mdmd"></a>Сборки в расширениях Office для .NET Framework 4 и [!INCLUDE[net_v45](includes/net-v45-md.md)]
 В приведенной ниже таблице перечислены сборки, включенные в расширения Office для [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] и [!INCLUDE[net_v45](includes/net-v45-md.md)]. Документацию по пространствам имен и типам в этих сборках см. в разделе [управляемые справочные &#40;материалы&#41;по разработке решений Office в Visual Studio](managed-reference-office-development-in-visual-studio.md).
...
|Microsoft.Office.Tools.Excel.v4.0.Utilities.dll|Предоставляет следующие типы:<br /><br /> — Базовые классы для созданных классов `ThisWorkbook` и `Sheet` в проектах уровня документа для Excel.<br />— Windows Forms элементы управления, которые можно использовать на листах в проектах Excel.|
...
|Microsoft.Office.Tools.Word.v4.0.Utilities.dll|Предоставляет следующие типы:<br /><br /> — Базовые классы для созданного класса `ThisDocument` в проектах уровня документа для Word.<br />— Windows Forms элементы управления, которые можно использовать для документов в проектах Word.|
