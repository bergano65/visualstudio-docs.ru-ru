---
title: "Справочные материалы по пользовательскому интерфейсу (разработка решений Office в Visual Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "справочные материалы [разработка решений Office в Visual Studio], пользовательский интерфейс"
...
---
# Справочные материалы по пользовательскому интерфейсу (разработка решений Office в Visual Studio)
...
## В этом подразделе  
 ...
 [Мастер публикации &#40;разработка для Office в Visual Studio&#41;](../vsto/publish-wizard-office-development-in-visual-studio.md)  
