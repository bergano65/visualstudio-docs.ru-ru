...
-   [Понимать настроек](#UnderstandingCustomizations)  
...
#### <a name="developer-and-end-user-perspective-compared"></a>Зрения разработчика и конечного пользователя по сравнению  
...
|Excel|Слово|  
|-----------|----------|  
|Книга Excel (*.xlsx*)<br /><br /> Excel книги с поддержкой макросов (*.xlsm*)<br /><br /> Двоичная книга Excel (*.xlsb*)<br /><br /> Книга Excel 97-2003 (*.xls*)<br /><br /> Шаблон Excel (*.xltx*)<br /><br /> Excel-шаблон поддержкой макросов (*.xltm*)<br /><br /> Шаблон Excel 97-2003 (*.xlt*)|Документ Word (*.docx*)<br /><br /> Документ с поддержкой макросов (*.docm*)<br /><br /> Документ Word 97-2003 (*.doc*)<br /><br /> Шаблон Word (*.dotx*)<br /><br /> Шаблон Word с поддержкой макросов (*.dotm*)<br /><br /> Шаблон Word 97-2003 (*.dot*)|  
...
2.  Если расширения управляемого кода присутствуют, приложение загружает *VSTOEE.dll*, который загружает *VSTOLoader.dll*. Эти файлы представляют неуправляемые библиотеки DLL, которые являются компонентами загрузчика для средств Visual Studio 2010 для Office runtime. Дополнительные сведения см. в разделе [средств Visual Studio для среды](../vsto/visual-studio-tools-for-office-runtime-overview.md).  
