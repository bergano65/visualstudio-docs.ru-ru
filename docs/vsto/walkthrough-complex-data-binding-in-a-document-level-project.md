...
1. Выберите ячейку в объекте списка.
    ...
    Появится новая строка в нижней части списка, со звездочкой ( **\*** ) в первую ячейку новой строки.
...
- Кэширование данных использования в автономном режиме. Дополнительные сведения см. в разделе [Практическое руководство. Кэшировать данные для использования в автономном режиме или на сервере](../vsto/how-to-cache-data-for-use-offline-or-on-a-server.md).
