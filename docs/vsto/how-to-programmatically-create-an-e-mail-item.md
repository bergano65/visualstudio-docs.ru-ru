---
title: "Практическое руководство. Программное создание элемента электронной почты | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "электронная почта [разработка решений Office в Visual Studio], создание"
  - "Outlook [разработка решений Office в Visual Studio], создание электронной почты"
  - "элементы почты [разработка решений Office в Visual Studio], создание"
...
---
# Практическое руководство. Программное создание элемента электронной почты
