...
> [!NOTE]  
>  Узнайте, как использовать новую [модель надстроек Office](https://msdn.microsoft.com/en-us/library/office/jj220082.aspx) для расширения возможностей пользователей в Office. Эти надстройки требуют очень мало ресурсов по сравнению с традиционными надстройками и решениями VSTO. Их можно создавать с помощью почти любой технологии веб\-программирования, такой как HTML5, JavaScript, CSS3 и XML.  
...
## В этом подразделе  
 ...
 [Справочные материалы по управляемому коду &#40;разработка решений Office в Visual Studio&#41;](../vsto/managed-reference-office-development-in-visual-studio.md)  
...
## Связанные подразделы  
 ...
 [Программирование для .NET Framework в Visual Studio](http://msdn.microsoft.com/ru-ru/f3f63195-82c6-48e8-a4a0-612810e7d093)  
