---
title: Как выполнить Изменение размера элементов управления Bookmark
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "53942454"
---
# <a name="how-to-resize-bookmark-controls"></a>Как выполнить Изменение размера элементов управления Bookmark
