---
title: "Работа с элементами контактов | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Outlook [разработка решений Office в Visual Studio], контакты"
  - "контакты [разработка решений Office в Visual Studio], сведения о контактах"
  - "электронная почта [разработка решений Office в Visual Studio], контакты"
  - "контакты [разработка решений Office в Visual Studio]"
...
|Задача|Процедура|  
|------------|---------------|  
|Извлечение всех контактов, в фамилии которых содержится заданная строка.|[Практическое руководство. Программное получение доступа к контактам Outlook](../vsto/how-to-programmatically-access-outlook-contacts.md)|  
