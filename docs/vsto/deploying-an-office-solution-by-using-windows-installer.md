...
Дополнительные сведения о создании файла установщика Windows с помощью [!INCLUDE[vs_dev10_long](../sharepoint/includes/vs-dev10-long-md.md)], в разделе [развертывания Visual Studio 2010 Tools для решения Office с помощью установщика Windows](http://go.microsoft.com/fwlink/?LinkId=201807).  
...
> [!NOTE]  
> Для настроек уровня документа расположение документа также должно быть доверенным. Дополнительные сведения см. в разделе [предоставить доверие к документам](../vsto/granting-trust-to-documents.md).  
...
#### <a name="to-add-the-visual-studio-2010-tools-for-office-runtime-as-a-prerequisite"></a>Для добавления в качестве необходимого компонента средств Visual Studio 2010 для среды выполнения Office  
...
10. Из вашего **Desktop** папку, скопируйте *Visual Studio 2010 Tools for Office Runtime.prq* файл в один из следующих каталогов на компьютере.  
...
3. В списке для свойства **AllUSERS** укажите, следует ли установить это решение для всех пользователей компьютера или только для пользователя, устанавливающего решение.  
   ...
   В следующей процедуре вы создадите разделы реестра, которые позволят приложению Office обнаружить и загрузить надстройку VSTO. В разделе [записи реестра для надстроек VSTO](../vsto/registry-entries-for-vsto-add-ins.md).  
...
> [!IMPORTANT]  
> При создании пользовательской области формы в надстройке VSTO для Outlook для регистрации этой области в Outlook необходимо создать дополнительные записи реестра. Дополнительные сведения см. в разделе [записи реестра для Outlook области формы](../vsto/registry-entries-for-vsto-add-ins.md#OutlookEntries).  
...
9. В строке меню выберите **построения** > **сборка OfficeAddInSetup**.  
   ...
   После завершения сборки, можно найти *setup.exe* файл **OfficeAddInSetup** проектов в следующем расположении: *OfficeAddInSetupProjectRoot *** \OfficeAddInSetup\ Express\SingleImage\DiskImages\DISK1\**  
  
  
## <a name="see-also"></a>См. также  
[Необходимые компоненты для развертывания решений Office](http://msdn.microsoft.com/en-us/library/9f672809-43a3-40a1-9057-397ce3b5126e)  
...
[Развертывание Visual Studio 2010 Tools для решения Office с помощью установщика Windows](http://go.microsoft.com/fwlink/?LinkId=201807)  
