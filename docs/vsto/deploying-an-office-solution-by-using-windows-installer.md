...
2. В строке меню последовательно выберите пункты **файл**  > **Добавить**  > **Новый проект**.
...
1. В **обозревателе решений**разверните узел проекта **OfficeAddInSetup** и выберите файл **Project Assistant** , как показано на следующем рисунке.
   ...
   ![Файл помощника по проекту в обозреватель решений](../vsto/media/installshield-projectassistant.png "Файл помощника по проекту в обозревателе решений")
...
3. В нижней части страницы **Project assistant** , нажмите кнопку **Файлы приложения** , как показано на следующем рисунке.
   ...
   ![Кнопка файлы приложения.](../vsto/media/installshield-applicationfiles.png "Кнопка файлов приложения.")
...
1. В **обозревателе решений**последовательно разверните узел проекта **OfficeAddInSetup** и узел **Specify Application Data** и выберите файл **Redistributables** , как показано на следующем рисунке.
   ...
   ![Распространяемый файл в обозреватель решений](../vsto/media/installshield-redistributablesfile.png "Файл распространяемых компонентов в обозревателе решений")
...
|----------------------------| - |
| 32-разрядная<br /><br /> | **HKEY_LOCAL_MACHINE\SOFTWARE (32-разрядная версия) \Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин**<br /><br /> |
| 64-разрядная<br /><br /> | **\Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин HKEY_LOCAL_MACHINE\SOFTWARE (64-разрядная версия)**<br /><br /> |
...
|-----------------------------| - |
| 32-разрядная<br /><br /> | **HKEY_LOCAL_MACHINE\SOFTWARE (32-разрядная версия) \Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин**<br /><br /> |
| 64-разрядная<br /><br /> | **HKEY_LOCAL_MACHINE\SOFTWARE (32-разрядная версия) \Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин**<br /><br />**\Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин HKEY_LOCAL_MACHINE\SOFTWARE (64-разрядная версия)**<br /><br /> |
...
|Тип значения<br /><br />|Название<br /><br />|
|--------------|--------|
...
14. В файле проекта найдите элемент **&gt; &lt;SolutionID** , скопируйте его значение в буфер обмена, а затем закройте Блокнот.
...
9. В строке меню выберите **сборка**  > **Сборка OfficeAddInSetup**.
   ...
   После завершения сборки можно будет указать файл *Setup. exe* проекта **OfficeAddInSetup** в следующем расположении: <em>оффицеаддинсетуппрожектрут</em> **\OfficeAddInSetup\Express\SingleImage\DiskImages\DISK1 \\**
