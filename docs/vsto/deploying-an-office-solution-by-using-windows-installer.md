...
Сведения о создании файла установщик Windows с помощью [!INCLUDE[vs_dev10_long](../sharepoint/includes/vs-dev10-long-md.md)]см. в разделе [развертывание решения Visual Studio 2010 Tools for Office с помощью установщик Windows](http://go.microsoft.com/fwlink/?LinkId=201807).
...
1. В **обозревателе решений**разверните узел проекта **OfficeAddInSetup** и выберите файл **Project Assistant** , как показано на следующем рисунке.
   ...
   ![Файл помощника по проекту в Обозреватель решений](../vsto/media/installshield-projectassistant.png "Файл помощника по проекту в Обозреватель решений")
...
3. В нижней части страницы **Project assistant** , нажмите кнопку **Файлы приложения** , как показано на следующем рисунке.
   ...
   ![Кнопка файлы приложения.](../vsto/media/installshield-applicationfiles.png "Кнопка файлы приложения.")
...
1. В **обозревателе решений**последовательно разверните узел проекта **OfficeAddInSetup** и узел **Specify Application Data** и выберите файл **Redistributables** , как показано на следующем рисунке.
   ...
   ![Распространяемый файл в Обозреватель решений](../vsto/media/installshield-redistributablesfile.png "Распространяемый файл в Обозреватель решений")
...
11. На странице **Redistributables** проекта InstallShield, нажмите кнопку **Обновить** , чтобы обновить список распространяемых компонентов, как показано на следующем рисунке.
   ...
   ![Кнопка "Обновить".](../vsto/media/installshield-refreshbutton.png "Кнопка \"Обновить\".")
...
|----------------------------| - |
| 32-разрядная версия<br /><br /> | **HKEY_LOCAL_MACHINE\SOFTWARE (32-разрядная версия) \Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин**<br /><br /> |
| 64-разрядная версия<br /><br /> | **\Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин HKEY_LOCAL_MACHINE\SOFTWARE (64-разрядная версия)**<br /><br /> |
...
|-----------------------------| - |
| 32-разрядная версия<br /><br /> | **HKEY_LOCAL_MACHINE\SOFTWARE (32-разрядная версия) \Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин**<br /><br /> |
| 64-разрядная версия<br /><br /> | **HKEY_LOCAL_MACHINE\SOFTWARE (32-разрядная версия) \Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин**<br /><br />**\Микрософт\оффице\ексцел\аддинс\самплекомпани.ексцеладдин HKEY_LOCAL_MACHINE\SOFTWARE (64-разрядная версия)**<br /><br /> |
...
13. Откройте файл проекта решения в Блокноте. Для проектов Visual Basic имя файла — *ExcelWorkbook. vbproj*. Для C# проектов имя файла — *ExcelWorkbook. csproj*.
...
9. В строке меню выберите **Сборка** > сборка**OfficeAddInSetup**.
   ...
   После завершения сборки вы можете разместить файл *Setup. exe* проекта **OfficeAddInSetup** по следующему адресу: <em>Оффицеаддинсетуппрожектрут</em> **\OfficeAddInSetup\Express\SingleImage\DiskImages\DISK1\\**

## <a name="see-also"></a>См. также

- [Предварительные требования для развертывания решений Office](https://msdn.microsoft.com/library/9f672809-43a3-40a1-9057-397ce3b5126e)
