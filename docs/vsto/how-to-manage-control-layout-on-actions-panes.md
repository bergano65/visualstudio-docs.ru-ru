---
title: Практическое руководство. Управление макетом элемента управления на панелях действий
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "71255828"
---
# <a name="how-to-manage-control-layout-on-actions-panes"></a>Практическое руководство. Управление макетом элемента управления на панелях действий
...
1. Откройте проект уровня документа для Microsoft Office слово, которое содержит панель действий с несколькими пользовательскими элементами управления или вложенными элементами управления панели действий. Дополнительные сведения см. в разделе [Практическое руководство. Добавление панели действий в документы Word или книги](../vsto/how-to-add-an-actions-pane-to-word-documents-or-excel-workbooks.md)Excel.
...
3. В обработчике <xref:Microsoft.Office.Tools.ActionsPane.OrientationChanged> событий панели действия проверьте, является ли ориентация панели действий горизонтальной.
...
5. В C#необходимо добавить обработчик `ActionsPane` <xref:Microsoft.Office.Tools.Word.Document.Startup> событий для обработчика событий. Дополнительные сведения о создании обработчиков событий см [. в разделе как Создание обработчиков событий в проектах](../vsto/how-to-create-event-handlers-in-office-projects.md)Office.
