...
-   [Word, InfoPath и PowerPoint](#WordAndInfoPath)  
 ...
 ![ссылка на видео](~/data-tools/media/playvideo.gif "ссылка на видео") Демонстрационные видеоматериалы см. в разделе [Практические советы. Управление областями задач в надстройках VSTO для Word](http://go.microsoft.com/fwlink/?LinkId=136781).  
