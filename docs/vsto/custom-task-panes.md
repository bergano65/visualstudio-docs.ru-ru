---
title: "Настраиваемые области задач | Документы Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
> [!NOTE]  
>  Настраиваемая область задач отличается от панели действий. Панель действий является частью настроек на уровне документа для Microsoft Office Word и Microsoft Office Excel. Дополнительные сведения см. в разделе [Actions Pane Overview](../vsto/actions-pane-overview.md).  
...
## <a name="creating-a-custom-task-pane"></a>Создание настраиваемой области задач  
...
### <a name="instantiating-the-custom-task-pane"></a>Создание экземпляра настраиваемой области задач  
...
### <a name="controlling-the-task-pane-in-multiple-windows"></a>Управление областью задач в нескольких окнах  
...
## <a name="accessing-the-application-from-the-task-pane"></a>Доступ к приложению из области задач  
...
### <a name="making-the-custom-task-pane-visible"></a>Настройка отображения настраиваемой области задач  
...
### <a name="modifying-the-appearance-of-the-task-pane"></a>Изменение внешнего вида области задач  
...
### <a name="programming-custom-task-pane-events"></a>Программирование событий настраиваемой области задач  
...
## <a name="cleaning-up-resources-used-by-the-task-pane"></a>Освобождение ресурсов, используемых областью задач  
...
-   [Word, InfoPath и PowerPoint](#WordAndInfoPath)  
 ...
 ![ссылка на видео](../vsto/media/playvideo.gif "ссылку видео") связанные демонстрационные видеоролики см. в разделе [практические советы Управление областями задач в надстройках VSTO для Word?](http://go.microsoft.com/fwlink/?LinkId=136781).  
...
### <a name="preventing-multiple-instances-of-a-custom-task-pane-in-outlook"></a>Предотвращение появления нескольких экземпляров настраиваемой области задач в Outlook  
