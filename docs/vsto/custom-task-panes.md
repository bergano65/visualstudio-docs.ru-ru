---
title: "Настраиваемые области задач | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
-   [Word, InfoPath и PowerPoint](#WordAndInfoPath)  
 ...
 ![ссылка на видео](../vsto/media/playvideo.png "ссылка на видео") Демонстрационные видеоматериалы см. в разделе [Практические советы. Управление областями задач в надстройках VSTO для Word](http://go.microsoft.com/fwlink/?LinkId=136781).  
