---
title: "Страница публикации в конструкторе проектов (разработка для Office в Visual Studio)"
ms.custom: ""
ms.date: "02/02/2017"
 ...
 **Язык публикации**  
 ...
 Дополнительные сведения об изменении **языка публикации** см. в разделе [Практическое руководство. Изменение языка публикации для приложения ClickOnce](~/deployment/how-to-change-the-publish-language-for-a-clickonce-application.md).  
