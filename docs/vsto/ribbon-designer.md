...
|Действие|Сочетание клавиш|
|------------|-----------------------|
|Выберите родительский элемент управления, если она открыта, а элемент управления на раскрывающейся панели.|**Left**|
|Закрытие раскрывающейся панели, если она открыта и выделен родительский элемент управления.|**Left**|
|Открытие раскрывающейся панели.|**Right**|
|Выберите первый элемент управления на раскрывающейся панели, если она открыта.|**Right**|
