...
## <a name="add-a-ribbon-visual-designer-item-to-a-project"></a>Добавьте в проект элемент Лента (визуальный конструктор)  
 Чтобы использовать конструктор лент, добавьте новый **Лента (визуальный конструктор)** в проект. Дополнительные сведения см. в разделе [как: работа с настройкой ленты](../vsto/how-to-get-started-customizing-the-ribbon.md).  
...
|**Коллекция**|Меню, предоставляющее массив или сетку визуальных вариантов, из которых могут выбирать пользователи. Можно управлять размещением выбранные элементы в меню. Используйте <xref:Microsoft.Office.Tools.Ribbon.RibbonGallery.ColumnCount%2A> и <xref:Microsoft.Office.Tools.Ribbon.RibbonGallery.RowCount%2A> свойства, чтобы указать число строк и столбцов, которые будут отображать элементы и кнопки коллекции.|  
...
##  <a name="HandleEventsSetProperties"></a> Обработка событий и задание свойств  
 ...
 Сведения об обработке событий ленты и установки свойств элементов управления ленты во время выполнения см. в разделе [Обзор модели объекта ленты](../vsto/ribbon-object-model-overview.md).  
  
##  <a name="CustomizingMicrosoftOfficeButton"></a> Настраивать представление Backstage  
...
|------------|-----------------------|  
|Перемещение элемента управления до предыдущего элемента управления в списке.|**CTRL**+**вверх**<br /><br /> **CTRL**+**влево**|  
|Переместите элемент управления после следующего элемента управления в списке.|**CTRL**+**вниз**<br /><br /> **CTRL**+**вправо**|  
...
|Действие|Сочетание клавиш|  
|------------|-----------------------|  
|Выберите родительский элемент управления, если она открыта и элемент управления, выбранного на панели «раскрывающийся список».|**Слева**|  
|Закройте панель раскрывающийся список, если она открыта и выделен родительский элемент управления.|**Слева**|  
|Откройте панель раскрывающегося списка.|**Справа**|  
|Выберите первый элемент управления на панели «раскрывающийся список», если она открыта.|**Справа**|  
