...
>  Имеется ряд задач, которые невозможно выполнить с помощью конструктора лент.  Дополнительные сведения об этих задачах и о способах их выполнения см. в разделе [Обзор ленты](../vsto/ribbon-overview.md).  
 ...
 ![ссылка на видео](../vsto/media/playvideo.png "ссылка на видео") Для просмотра соответствующих демонстрационных видеороликов перейдите по ссылке [How Do I: Use the Ribbon Designer to Customize the Ribbon in Outlook?](http://go.microsoft.com/fwlink/?LinkID=130312).  
...
-   Откройте **Редактор коллекции вкладок** и нажмите кнопку **Добавить**.  
     ...
     Чтобы открыть **Редактор коллекции вкладок**, выберите в окне **Свойства** свойство **Вкладки** и нажмите кнопку с многоточием ![Эллипс конструктора ASP.NET для мобильных устройств](../sharepoint/media/mwellipsis.png "Эллипс конструктора ASP.NET для мобильных устройств").  
