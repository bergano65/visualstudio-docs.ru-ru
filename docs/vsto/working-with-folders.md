---
title: "Работа с папками | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "папки [разработка решений Office в Visual Studio], о папках в Outlook"
  - "элементы почты [разработка решений Office в Visual Studio], папки"
  - "папки [разработка решений Office в Visual Studio]"
  - "электронная почта [разработка решений Office в Visual Studio], папки"
  - "Outlook [разработка решений Office в Visual Studio], папки"
