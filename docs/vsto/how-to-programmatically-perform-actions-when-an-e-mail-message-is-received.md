...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Outlook [разработка решений Office в Visual Studio], действия при получении электронной почты"
  - "NewMail - событие"
  - "элементы почты [разработка решений Office в Visual Studio], настраиваемые действия"
  - "электронная почта [разработка решений Office в Visual Studio], настраиваемые действия"
...
---
# Практическое руководство. Программное выполнение действий при получении сообщения электронной почты
