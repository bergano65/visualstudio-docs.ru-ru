...
## <a name="cant-update-or-publish-to-a-network-file-share"></a>Не удается обновить или опубликовать в общей сетевой папки  
 Решения Office, которые находятся в общей сетевой папки могут отображать вводящее в заблуждение сообщение во время обновления, если решение *Setup.exe* файл был заблокирован в процессе, во время публикации обновления. Сообщение может говорить следующее: "Не удается добавить ’setup.exe’ на веб-сайт. Файл ’setup.exe’ уже существует на этом веб-сайте".  
