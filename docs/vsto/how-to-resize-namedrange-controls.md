---
title: Как выполнить Изменение размера элементов управления NamedRange
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "54869948"
---
# <a name="how-to-resize-namedrange-controls"></a>Как выполнить Изменение размера элементов управления NamedRange
