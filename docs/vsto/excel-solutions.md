...
##  <a name="applevel"></a> Разработка надстроек VSTO для Excel  
 ...
 ![ссылка на видео](~/data-tools/media/playvideo.gif "ссылка на видео")Демонстрационные видеоматериалы см. в разделе [Инструкции. Автоматизация PowerPoint с помощью надстройки Excel](http://go.microsoft.com/fwlink/?LinkID=130300).  
