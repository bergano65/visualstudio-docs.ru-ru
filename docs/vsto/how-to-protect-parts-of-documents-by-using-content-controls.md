---
title: Как выполнить Защита частей документов с помощью элементов управления содержимым
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "53989261"
---
# <a name="how-to-protect-parts-of-documents-by-using-content-controls"></a>Как выполнить Защита частей документов с помощью элементов управления содержимым
