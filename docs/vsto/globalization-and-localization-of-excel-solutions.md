...
## <a name="format-data-in-excel-with-various-regional-settings"></a>Формат данных в Excel с помощью различных региональных параметров  
...
### <a name="pass-other-locale-ids-to-the-excel-object-model"></a>Передайте других кодов языков в объектную модель Excel  
