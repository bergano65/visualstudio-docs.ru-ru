...
### <a name="text-direction"></a>Направление текста
 В Excel можно задать свойство листа для вывода текста справа налево. Размещение элементов управления или любой элемент, имеющий `RightToLeft` свойства, который помещается в конструкторе автоматически соответствовать этим параметрам во время выполнения. Word нет параметра документа для двунаправленного текста (просто меняется выравнивание текста), поэтому элементы управления не может быть сопоставлен этот параметр. Вместо этого нужно задать выравнивание текста для каждого элемента управления. Можно написать код для последовательного перебора всех элементов управления и применения к ним способа вывода текста справа налево.
