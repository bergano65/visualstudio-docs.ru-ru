...
|Задача|Процедура|
|----------|---------------|
|Создание таблицы, применение стиля и доступ к таблице в коде.|[Практическое руководство. Программное создание таблиц Word](../vsto/how-to-programmatically-create-word-tables.md)|
|Создание таблицы, ее форматирование и вставка данных в ячейки.|[Практическое руководство. Программное заполнение таблиц Word свойствами документа](../vsto/how-to-programmatically-populate-word-tables-with-document-properties.md)|
