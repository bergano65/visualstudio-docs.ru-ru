...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "таблицы [разработка решений Office в Visual Studio]"
  - "документы Office [разработка решений Office в Visual Studio], таблицы"
  - "Word [разработка решений Office в Visual Studio], таблицы"
  - "документы [разработка решений Office в Visual Studio], таблицы"
...
|Задача|Процедура|  
|------------|---------------|  
|Создание таблицы, применение стиля и доступ к таблице в коде.|[Практическое руководство. Программное таблиц в Word](../vsto/how-to-programmatically-create-word-tables.md)|  
