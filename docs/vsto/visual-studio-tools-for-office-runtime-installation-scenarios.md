---
title: "Сценарии установки среды выполнения Visual Studio Tools for Office | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "среда выполнения Visual Studio Tools for Office, сценарии установки"
...
### Установка среды выполнения с Visual Studio или Microsoft Office Developer Tools для Visual Studio  
...
>  Создать проект Office, ориентированный на платформу .NET Framework 3.5, с помощью [!INCLUDE[vs_dev12](../vsto/includes/vs-dev12-md.md)] или более поздней версии, нельзя.  
 ...
 Дополнительные сведения об установке Office Developer Tools см. в статье [Практическое руководство. Настройка компьютера для разработки решений Office](../vsto/how-to-configure-a-computer-to-develop-office-solutions.md).  
  
### Установка среды выполнения с Office  
...
### Установка среды выполнения с помощью распространяемого пакета среды выполнения  
 ...
 Дополнительные сведения о включении в решение ClickOnce необходимых компонентов см. в статье [Практическое руководство. Установка компонентов, необходимых для выполнения решений Office, на компьютерах конечных пользователей](http://msdn.microsoft.com/ru-ru/74dd2c52-838f-4abf-b2b4-4d7b0c2a0a98).  Дополнительные сведения об установке среды выполнения из распространяемого пакета вручную см. в статье [Практическое руководство. Установка распространяемого пакета среды выполнения Visual Studio Tools for Office](../vsto/how-to-install-the-visual-studio-tools-for-office-runtime-redistributable.md).  
