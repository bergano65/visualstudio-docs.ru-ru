---
title: "Практическое руководство. Программное добавление записи в контакты Outlook | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "контакты [разработка решений Office в Visual Studio], создание"
...
---
# Практическое руководство. Программное добавление записи в контакты Outlook
  Пример помогает создать новый контакт и ввести данные.  
