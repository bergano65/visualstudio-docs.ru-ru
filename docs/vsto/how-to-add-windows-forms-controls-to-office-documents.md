---
title: 'Как: Добавление элементов управления Windows forms в документы Office'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "34264551"
---
# <a name="how-to-add-windows-forms-controls-to-office-documents"></a>Как: Добавление элементов управления Windows Forms в документы Office
...
2.  В **стандартные элементы управления** вкладке **элементов**, щелкните элемент управления, который требуется добавить и перетащите его в документ.  
...
2.  В **стандартные элементы управления** вкладке **элементов**, щелкните элемент управления, который требуется добавить.  
...
2.  В **стандартные элементы управления** вкладке **элементов**, щелкните элемент управления, необходимо добавить  
...
2.  В **стандартные элементы управления** вкладке **элементов**, дважды щелкните элемент управления, который требуется добавить.  
...
2.  В **стандартные элементы управления** вкладке **элементов**, щелкните элемент управления, который требуется добавить и нажмите клавишу **ввод** ключа.  
...
### <a name="to-add-a-windows-forms-control-at-runtime"></a>Чтобы добавить элемент управления Windows Forms во время выполнения  
  
1.  Используйте метод с именем Add\<*класса элемента управления*> (где *класса элемента управления* — это имя класса элемента управления Windows Forms, который вы хотите добавить, например <xref:Microsoft.Office.Tools.Word.ControlExtensions.AddButton%2A>).  
...
1.  Используйте метод с именем Add\<*класса элемента управления*> (где *класса элемента управления* — это имя класса элемента управления Windows Forms, который вы хотите добавить, например <xref:Microsoft.Office.Tools.Word.ControlExtensions.AddButton%2A>).  
    ...
    > [!NOTE]  
    >  В надстройке VSTO проекты, предназначенные [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] или более поздней версии, необходимо добавить ссылку на *Microsoft.Office.Tools.Excel.v4.0.Utilities.dll* или *Microsoft.Office.Tools.Word.v4.0.Utilities.dll* сборки, чтобы получить доступ к Add\<*класса элемента управления*> методы.  
