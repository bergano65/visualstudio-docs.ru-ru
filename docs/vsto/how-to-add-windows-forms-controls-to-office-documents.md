...
-   [добавление элементов управления во время выполнения в надстройки VSTO.](#runtimeaddin)  
 ...
 ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "ссылка на видео") Связанный демонстрационный видеоролик можно просмотреть в статье [Как добавить элементы управления на поверхность документа во время выполнения](http://go.microsoft.com/fwlink/?LinkId=132782).  
