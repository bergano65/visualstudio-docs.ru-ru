...
# Решения PowerPoint
 ...
 ![ссылка на видео](~/data-tools/media/playvideo.gif "ссылка на видео") Демонстрационные видеоматериалы см. в разделе [Практическое руководство. Создание надстройки для Microsoft PowerPoint](http://go.microsoft.com/fwlink/?LinkId=132767).  
