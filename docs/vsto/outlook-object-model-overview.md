...
# Общие сведения об объектной модели Outlook
 ...
 ![ссылка на видео](~/data-tools/media/playvideo.gif "ссылка на видео") Соответствующие демонстрационные видеоролики см. в разделе [Инструкции. Использование Outlook для создания настраиваемого отчета о задаче](http://go.microsoft.com/fwlink/?LinkID=130315).  
