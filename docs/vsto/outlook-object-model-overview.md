...
# Общие сведения об объектной модели Outlook
 ...
 ![ссылка на видео](../vsto/media/playvideo.png "ссылка на видео") Соответствующие демонстрационные видеоролики см. в разделе [Инструкции. Использование Outlook для создания настраиваемого отчета о задаче](http://go.microsoft.com/fwlink/?LinkID=130315).  
