...
|Заполнение диапазона на основе начального значения.|[Практическое руководство. Программным образом автоматически заполнить диапазонов с постепенным изменением данных](../vsto/how-to-programmatically-automatically-fill-ranges-with-incrementally-changing-data.md)|
|Получение и установка значений даты в ячейках.|[Практическое руководство. Программным способом хранения и извлечения значений дат в диапазонах Excel](../vsto/how-to-programmatically-store-and-retrieve-date-values-in-excel-ranges.md)|
...
|Поиск текста в диапазонах листа.|[Практическое руководство. Программный поиск текста в диапазонах листа](../vsto/how-to-programmatically-search-for-text-in-worksheet-ranges.md)|
