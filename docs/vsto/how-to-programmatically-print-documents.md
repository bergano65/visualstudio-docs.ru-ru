---
title: 'Практическое: программная печать документов'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "35673926"
---
# <a name="how-to-programmatically-print-documents"></a>Практическое: программная печать документов
