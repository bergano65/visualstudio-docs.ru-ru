---
title: Элементы управления Windows Forms на общие сведения о документах Office
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
### <a name="create-custom-user-controls"></a>Создавать пользовательские элементы управления
...
### <a name="prevent-old-data-from-appearing-in-excel-workbooks-during-loading"></a>Не старые данные появлялись в книгах Excel во время загрузки
...
### <a name="layout-style-of-controls-on-a-word-document"></a>Стиль макета элементов управления в документ Word
 ...
 При добавлении элемента управления в документ Word во время выполнения, можно указать нужный стиль макета нового элемента управления с помощью различных `Add` \< *класс элемента управления*> перегрузки метода <xref:Microsoft.Office.Tools.Word.ControlCollection> класса:
...
### <a name="add-components-at-design-time"></a>Добавление компонентов во время разработки
