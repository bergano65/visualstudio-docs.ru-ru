---
title: "Пошаговые руководства с использованием Word | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "пошаговые руководства [разработка решений Office в Visual Studio], Word"
  - "Word [разработка решений Office в Visual Studio], пошаговые руководства"
...
## Пошаговые руководства на уровне документа  
 ...
 Показано, как создать базовую настройку на уровне документа для Word.  
...
## Пошаговые руководства на уровне приложения  
 ...
 Показано, как создать базовую надстройку VSTO для Word.  
