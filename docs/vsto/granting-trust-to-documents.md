...
-   Хотя сам документ является надежным при использовании надежного расположения, для предоставления доверия в целях настройки необходимы дополнительные разрешения. Можно предоставить полное доверие в целях настройки, используя подписание манифестов сертификатом, щелкнув запрос о доверии или при установке решения Office для *Program Files* каталога.  
