...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "разработка решений Office в Visual Studio, архитектура"
  - "архитектура [разработка решений Office в Visual Studio], решения"
  - "приложения Office [разработка решений Office в Visual Studio], архитектура"
