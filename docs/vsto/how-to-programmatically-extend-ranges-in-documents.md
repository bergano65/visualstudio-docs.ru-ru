---
title: "Как: программное расширение диапазонов в документах | Документы Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
1.  Определите диапазон символов. Дополнительные сведения см. в разделе [как: программное определение и выберите диапазонов в документах](../vsto/how-to-programmatically-define-and-select-ranges-in-documents.md).  
...
## <a name="document-level-customization-code"></a>Код настройки на уровне документа  
