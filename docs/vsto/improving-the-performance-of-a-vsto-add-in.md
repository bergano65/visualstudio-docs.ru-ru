...
2.  Создайте событие после сборки, которое обновляет реестр с помощью скрипта.  
    ...
    ```  
     ...
     Сведения о создании события после сборки в проекте C\# см. в разделе [Практическое руководство. Назначение событий построения &#40;C&#35;&#41;](../Topic/How%20to:%20Specify%20Build%20Events%20(C%23).md).  
  
     Сведения о создании события после сборки в проекте Visual Basic см. в разделе [Практическое руководство. Назначение событий построения &#40;C&#35;&#41;](../Topic/How%20to:%20Specify%20Build%20Events%20(C%23).md).  
