---
title: "Основные сборки взаимодействия Office | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  ...
  - "сборки [разработка решений Office в Visual Studio], основные сборки взаимодействия"
...
-   [Полный список основных сборок взаимодействия для приложений Microsoft Office](#pialist)  
 ...
 Дополнительные сведения об основных сборках взаимодействия см. в разделе [Основные сборки взаимодействия](http://msdn.microsoft.com/ru-ru/b977a8be-59a0-40a0-a806-b11ffba5c080).  
...
### Основные сборки взаимодействия в каталоге файлов программы  
...
### Основные сборки взаимодействия в глобальном кэше сборок  
 ...
 Присутствие основных сборок взаимодействия Office на компьютере конечного пользователя не требуется для запуска решений Office. Дополнительные сведения см. в разделе [Проектирование и создание решений Office](../vsto/designing-and-creating-office-solutions.md).  
...
|Библиотека типов Microsoft Smart Tags 2.0 **Note:**  Смарт\-теги объявлены нерекомендуемыми в [!INCLUDE[Excel_14_short](../vsto/includes/excel-14-short-md.md)] и [!INCLUDE[Word_14_short](../vsto/includes/word-14-short-md.md)].|Microsoft.Office.Interop.SmartTag.dll|  
...
## См. также  
 ...
 [Общие справочные материалы &#40;разработка решений Office в Visual Studio&#41;](../vsto/general-reference-office-development-in-visual-studio.md)  
