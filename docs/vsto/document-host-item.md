...
## <a name="understand-the-document-host-item-in-document-level-projects"></a>Понимать ведущий элемент документа в проектах уровня документа  
...
### <a name="limitations-of-the-document-host-item-in-document-level-projects"></a>Ограничения ведущих элементов документа в проектах уровня документа  
 Проект уровня документа может содержать только один ведущий элемент <xref:Microsoft.Office.Tools.Word.Document> (то есть класс `ThisDocument` ). Вы не можете добавлять новые <xref:Microsoft.Office.Tools.Word.Document> ведущих элементов в проект во время разработки и не может создавать новые <xref:Microsoft.Office.Tools.Word.Document> ведущие элементы во время выполнения в настройке уровня документа.  
...
## <a name="understand-document-host-items-in-application-level-projects"></a>Понять документ-ведущие элементы в проектах уровня приложения  
 ...
 Для создания <xref:Microsoft.Office.Tools.Word.Document> ведущего элемента, используйте `GetVstoObject` метод. Дополнительные сведения см. в разделе [документов расширить Word и книг Excel в надстройках VSTO во время выполнения](../vsto/extending-word-documents-and-excel-workbooks-in-vsto-add-ins-at-run-time.md).  
