...
-   [Добавление элементов управления Windows Forms в документы](#WindowsForms).  
 ...
 ![ссылка на видео](~/data-tools/media/playvideo.gif "ссылка на видео") Сопутствующий демонстрационный видеоролик см. в разделе [Практические советы. Добавление элементов управления в рабочую область документа во время выполнения](http://go.microsoft.com/fwlink/?LinkId=132782).  
