 ...
 **Новая область формы Outlook** мастер копирует OFS-файла в каталог проекта и добавляет ссылки на файл конструктора областей формы элементы управления. Затем события элементов управления можно обработать в файле кода области формы.  
 ...
 Для обработки событий в проекте C# подпишитесь на события элементов управления в методе <xref:Microsoft.Office.Tools.Outlook.FormRegionControl.FormRegionShowing>. Дополнительные сведения см. в разделе [как: подписка и Отмена подписки на события &#40; И &#35; Руководство по программированию &#41; ](/dotnet/csharp/programming-guide/events/how-to-subscribe-to-and-unsubscribe-from-events).  
