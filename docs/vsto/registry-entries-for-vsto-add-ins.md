...
|------------------|------------------|
|Visio|*Root*\СОФТВАРЕ\МИКРОСОФТ\\*идентификатор надстройки*\\*Visio*\аддинс|
|Все остальные|*Root*\софтваре\микрософт\оффице\\*имя приложения Office*\аддинс *идентификатор надстройки*\\|
...
|Элемент|Тип|{2&gt;Value&lt;2}|
|-----------|----------|-----------|
|**Описание**|REG_SZ|Обязательное Краткое описание надстройки VSTO.<br /><br /> Это описание отображается, когда пользователь выбирает надстройку VSTO на панели **Надстройки** диалогового окна **Параметры** в приложении Microsoft Office.|
|**FriendlyName**|REG_SZ|Обязательное Описательное имя надстройки VSTO, которое отображается в диалоговом окне **Надстройки COM** в приложении Microsoft Office. Значением по умолчанию является идентификатор надстройки VSTO.|
