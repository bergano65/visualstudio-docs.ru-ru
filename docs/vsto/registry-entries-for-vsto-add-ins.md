...
|--------------------|------------------------|
|32-разрядная|*Root*\софтваре\микрософт\оффице\\*имя приложения*\аддинс *идентификатор надстройки*\\|
|64-разрядная|*Root*\Software\Wow6432Node\Microsoft\Office\\*имя приложения*\аддинс *идентификатор надстройки*\\|

 **Visio**

|Версия Office|Путь конфигурации|
|--------------------|------------------------|
|32-разрядная|*Идентификатор надстройки* *корневого*\\\софтваре\микрософт\висио\аддинс|
|64-разрядная|*Идентификатор надстройки* *корневого*\\\Software\Wow6432Node\Visio\Addins|
