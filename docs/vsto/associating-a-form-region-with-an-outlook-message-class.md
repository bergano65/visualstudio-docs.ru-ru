...
## <a name="see-also"></a>См. также  
 ...
 [Имя формы и классов сообщений Обзор](http://msdn.microsoft.com/library/office/ff867629.aspx)   
 [О совместной работе форм Outlook и элементов](http://msdn.microsoft.com/library/office/ff869706.aspx)  
