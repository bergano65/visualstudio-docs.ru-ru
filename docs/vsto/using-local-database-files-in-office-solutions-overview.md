---
title: Файлы локальной базы данных в решений Office с помощью | Документы Microsoft
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
## <a name="importing-the-database-file-into-a-project"></a>Импортирование файла базы данных в проект  
...
## <a name="deploying-the-database-file"></a>Развертывание файла базы данных  
