...
1. Назовите проект **QuickDate** и нажмите кнопку **Создать**.
   ...
   >
   >Простой способ установить новую рабочую нагрузку при создании нового проекта — выбрать ссылку **Установить дополнительные средства и компоненты** под текстом **Не можете найти то, что ищете?** . После запуска Visual Studio Installer выберите рабочую нагрузку **Разработка классических приложений .NET** и нажмите кнопу **Изменить**.
   >
...
2. В левой области разверните узел **Visual C#** и выберите категорию **Тест**. В средней области выберите шаблон проекта **Тестовый проект MSTest(.NET Core)**. Укажите **QuickTest** в качестве имени проекта и нажмите кнопку **ОК**.
...
1. В левой области разверните узел **Проекты** и выберите **Решение**. В средней области установите флажок рядом с пунктом **QuickDate** и нажмите кнопку **ОК**.
   ...
   ![Обозреватель решений Visual Studio 2019 со ссылкой на проект](media/vs-2019/tutorial-projects-solution-explorer-reference.png "Обозреватель решений со ссылкой на проект в Visual Studio.")
