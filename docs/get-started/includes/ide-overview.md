...
- [Быстрый запуск](../../ide/reference/quick-launch-environment-options-dialog-box.md)
   ...
   ![Поле поиска "Быстрый запуск" в Visual Studio 2019](../media/vs-2019/quick-launch-nuget.png)
...
1. Запустите Visual Studio.
   ...
   Откроется окно запуска, откуда можно клонировать репозиторий, открыть недавно использованные проекты или создать новый проект.

1. Выберите **Создать проект**.

   ![Окно Visual Studio для создания нового проекта.](../media/vs-2019/start-window-create-new-project.png)
