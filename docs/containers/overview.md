...
Visual Studio легко интегрируется с Azure Pipelines для автоматической и непрерывной интеграции и поставки изменений в код и настройки служб. Чтобы приступить к работе, см. статью о [создании конвейера](/azure/devops/pipelines/create-first-pipeline?view=azure-devops&tabs=tfs-2018-2&preserve-view=true).
...
Сведения касательно Kubernetes см. в статье о [развертывании приложения из контейнера Docker в Службе Azure Kubernetes](/azure/devops/pipelines/apps/cd/deploy-aks?view=azure-devops&preserve-view=true).
