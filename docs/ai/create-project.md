...
После [установки инструментов Visual Studio для сценариев ИИ](installation.md) можно легко создать новый проект Python с использованием широкого спектра шаблонов.
