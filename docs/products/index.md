            ...
            <li>
                ...
                <ul id="products">
                    <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Интегрированная среда разработки Visual Studio</h3>
                                                    <p>Создавайте приложения и игры при помощи Windows для устройств на платформе Android, iOS, Windows, а также веб-устройств или облачных устройств.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <p style="font-size:1.12em">Инструменты для разработчиков, облачные службы, программное обеспечение, поддержка и обучение</p>
                    <p style="margin-top:24px;">
                                <a href="https://aka.ms/vs-subscriptions/">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Подписка Visual Studio<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </p></div>
                    </li>
                </ul>
