---
title: Как выполнить Укажите, какие файлы публикуются с помощью ClickOnce | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
ms.locfileid: "54926893"
---
# <a name="how-to-specify-which-files-are-published-by-clickonce"></a>Как выполнить задание файлов, публикуемых с помощью ClickOnce
