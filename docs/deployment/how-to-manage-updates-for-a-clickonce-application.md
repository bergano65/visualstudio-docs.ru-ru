...
5.  В **обновить расположение** введите расположение обновлений с полный URL-адрес в формате http://Hostname/ApplicationName, или UNC-путь в формате \\\Server\ApplicationName или щелкните **Обзор** кнопку, чтобы найти местоположение для обновления.  
...
5.  В **обновить расположение** введите расположение обновлений с полный URL-адрес в формате http://Hostname/ApplicationName, или UNC-путь в формате \\\Server\ApplicationName или щелкните **Обзор** кнопку, чтобы найти местоположение для обновления. Расположение обновлений — место, где приложение будет искать обновленную версию самого себя.  
