---
title: Как выполнить Управление обновлениями для ClickOnce-приложения | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
---
# <a name="how-to-manage-updates-for-a-clickonce-application"></a>Как выполнить управление обновлениями для приложения ClickOnce
