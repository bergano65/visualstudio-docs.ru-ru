...
ms.locfileid: "49861635"
---
# <a name="quickstart-first-look-at-deployment-in-visual-studio"></a>Краткое руководство. Знакомство с интегрированной средой разработки Visual Studio
...
- **ASP.NET**, **ASP.NET Core**, **Node.js**, **Python** и .**NET Core**. Используйте для публикации в локальную папку средство "Опубликовать". Выбор варианта зависит типа приложения. В обозревателе решений щелкните проект правой кнопкой мыши и выберите пункт **Опубликовать**. (Если ранее вы настроили профили публикации, затем необходимо выбрать команду **Создать новый профиль**.) Далее выберите **Папка**. Дополнительные сведения см. в статье [Развертывание в локальную папку](quickstart-deploy-to-local-folder.md).
...
- **ASP.NET**, **ASP.NET Core**, **Python** и **Node.js**. С помощью средства "Опубликовать" вы можете быстро развертывать приложения в службе приложений Azure или на виртуальной машине Azure. В обозревателе решений щелкните проект правой кнопкой мыши и выберите пункт **Опубликовать**. (Если ранее вы настроили профили публикации, затем необходимо выбрать команду **Создать новый профиль**.) В диалоговом окне публикации выберите **Служба приложений** или **Виртуальная машина Azure** и выполните инструкции по настройке.
    ...
    Информацию о приложениях Python см. в статье [Python. Публикация в службу приложений Azure](/visualstudio/python/publishing-python-web-applications-to-azure-from-visual-studio?toc=/visualstudio/deployment/toc.json&bc=/visualstudio/deployment/_breadcrumb/toc.json).
...
- **ASP.NET**, **ASP.NET Core**, **Node.js** и **Python**. С помощью средства "Опубликовать" вы можете развернуть веб-сайт, используя FTP или веб-развертывание. Дополнительные сведения см. в статье [Развертывание на веб-сайт](quickstart-deploy-to-a-web-site.md).
...
- **Универсальная платформа Windows**. Вы можете создать пакет приложения и развернуть его с помощью меню. Дополнительные сведения см. в статье [Упаковка приложения UWP с помощью Visual Studio](/windows/uwp/packaging/packaging-uwp-apps).
