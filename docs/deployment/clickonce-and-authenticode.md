---
title: "ClickOnce и технология Authenticode | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
helpviewer_keywords: 
  - "PFX-файлы"
  - "развертывание ClickOnce, Authenticode"
  - "Authenticode, ClickOnce"
  - "развертывание ClickOnce, сертификаты"
...
-   создать собственный с помощью MakeCert.exe, который входит в состав [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)].  
...
### Польза центров сертификации для пользователей  
 ...
 Дополнительные сведения о создании автосертификатов см. в разделе [Makecert.exe \(Certificate Creation Tool\)](../Topic/Makecert.exe%20\(Certificate%20Creation%20Tool\).md).  
...
### Метки времени  
 ...
 Чтобы включить метку времени на сервер приложений, должен быть доступен сервер меток времени. Сведения о выборе сервера меток времени см. в разделе [Практическое руководство. Подписание манифестов приложения и развертывания](../ide/how-to-sign-application-and-deployment-manifests.md).  
