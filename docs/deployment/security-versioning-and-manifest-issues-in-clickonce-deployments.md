...
## <a name="versioning-issues"></a>Проблемы с управлением версиями  
 ...
 Эта ошибка может возникать только в том случае, если вы изменяете вашей [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] манифесты вручную; Эта ошибка не должна возникать при создании развертывания с использованием [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)].  
