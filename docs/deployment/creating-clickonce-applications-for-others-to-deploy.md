...
ms.locfileid: "39081430"
---
# <a name="create-clickonce-applications-for-others-to-deploy"></a>Создание приложений ClickOnce для других пользователей для развертывания
