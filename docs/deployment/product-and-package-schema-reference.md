...
|[\<Команды > элемент](../deployment/commands-element-bootstrapper.md)|Обязательный элемент.  Выполняет одну или более проверок установки в соответствии с `InstallChecks`и указывает, какой пакет следует установить проверка завершилась ошибкой.|Нет|  
