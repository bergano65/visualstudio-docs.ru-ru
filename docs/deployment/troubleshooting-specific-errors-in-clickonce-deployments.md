...
|Не удалось выполнить загрузку приложения. Проверьте сетевое подключение, или обратитесь к системному администратору или поставщика сетевых услуг.|[!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] не удается установить сетевое подключение к серверу. Проверьте доступность сервера и состояние сети.|  
