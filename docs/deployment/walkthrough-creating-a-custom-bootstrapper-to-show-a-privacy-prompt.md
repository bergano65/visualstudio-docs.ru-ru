---
title: 'Пошаговое руководство: Создание пользовательского загрузчика с предупреждением о конфиденциальности | Документы Microsoft'
ms.custom: ''
ms.date: 11/04/2016
...
## <a name="create-an-update-consent-dialog-box"></a>Создание диалогового окна подтверждения обновления  
...
## <a name="create-the-custom-bootstrapper-package"></a>Создание пользовательского пакета загрузчика  
...
## <a name="set-the-update-consent-application-as-a-prerequisite"></a>Установите приложение согласия обновления в качестве необходимого компонента  
