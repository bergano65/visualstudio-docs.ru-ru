...
titleSuffix: ''
description: Сведения о доступных вариантах для публикации приложения с помощью мастера публикации
...
При выборе варианта "Сервер FTP или FTPS" Visual Studio запросит имя профиля, а затем дополнительные сведения о **подключении**, включая данные о целевом сервере или расположении, имя узла и учетные данные. Вы можете выбрать следующие варианты поведения на вкладке **Параметры**.
...
При выборе варианта "Веб-сервер (IIS)" Visual Studio запросит имя профиля, а затем дополнительные сведения о **подключении**, включая данные о целевом сервере или расположении, имя узла и учетные данные. Вы можете выбрать следующие варианты поведения на вкладке **Параметры**.
...
- Если уже настроена публикация в IIS или Службу приложений Azure, но вы намерены ускорить настройку развертывания для публикации в другой службе или для новых членов группы в той же службе.
