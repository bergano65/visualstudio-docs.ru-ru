...
|[Страница публикации в конструкторе проектов](../ide/reference/publish-page-project-designer.md)|Создает и изменения манифестов приложения и развертывания для Visual Basic и Visual C# приложений.|  
|[*Mage.exe* (инструмент создания и изменения манифестов)](/dotnet/framework/tools/mage-exe-manifest-generation-and-editing-tool)|Создает манифестов приложения и развертывания для Visual Basic, Visual C#и приложений Visual C++.<br /><br /> Подписывает и повторного подписывания манифестов приложения и развертывания.<br /><br /> Можно запустить из пакетных сценариев и командной строке.|  
|[*MageUI.exe* (инструмент создания и изменения манифестов, графический клиент)](/dotnet/framework/tools/mageui-exe-manifest-generation-and-editing-tool-graphical-client)|Создания и изменения манифестов приложения и развертывания.<br /><br /> Подписывает и повторного подписывания манифестов приложения и развертывания.|  
