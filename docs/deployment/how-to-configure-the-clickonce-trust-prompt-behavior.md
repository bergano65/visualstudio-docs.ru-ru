---
title: Как выполнить Настройка поведения запроса о доверии ClickOnce | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
1.  Создайте в Visual Basic или Visual C# консольное приложение в Visual Studio.  
