...
description: Узнайте, как развертывать необходимые компоненты для приложения ClickOnce с помощью пакета, содержащего один манифест продукта и манифест пакета для каждого языкового стандарта.
