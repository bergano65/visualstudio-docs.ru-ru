...
## <a name="command-sets-and-properties"></a>Команда наборы и свойства
...
## <a name="task-list-guids"></a>Список идентификаторов GUID задач
...
## <a name="component-selector-page-guids"></a>Страницу селектора компонентов идентификаторы GUID
...
- [Команды, определенные в интегрированной среде разработки, для расширения ystems проекта s](../extensibility/internals/ide-defined-commands-for-extending-project-systems.md)