---
title: "Идентификаторы GUID IDE | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="ide-guids"></a>Идентификаторы GUID интегрированной среды разработки
<xref:Microsoft.VisualStudio.VSConstants>Класс публикует идентификаторов GUID для некоторых частей интегрированную среду разработки (IDE), перечисленные в следующей таблице.</xref:Microsoft.VisualStudio.VSConstants>  
...
|<xref:Microsoft.VisualStudio.VSConstants.GUID_TextEditorFactory></xref:Microsoft.VisualStudio.VSConstants.GUID_TextEditorFactory>|8B382828-6202-11D1-8870-0000F87579D2|  
...
## <a name="broadly-visible-components"></a>Широко видимые компоненты  
...
## <a name="files-virtual-and-physical-folders-and-subprojects"></a>Файлы, виртуальных и физических папок и подпроекты  
...
## <a name="command-sets-and-properties"></a>Наборы команд и свойств  
...
## <a name="task-list-guids"></a>Идентификаторы GUID для списка задач  
...
## <a name="component-selector-page-guids"></a>Идентификаторы GUID страница выбора компонента  
...
## <a name="miscellaneous-shell-guids"></a>Прочие оболочки GUID  
...
## <a name="see-also"></a>См. также  
 ...
 [Константы интегрированной среды разработки](../extensibility/ide-constants.md)   
