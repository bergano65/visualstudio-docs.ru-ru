---
title: "Идентификаторы GUID интегрированной среды разработки | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
<xref:Microsoft.VisualStudio.VSConstants> Класс публикует идентификаторы GUID некоторые части интегрированной среды разработки (IDE), перечисленные в следующей таблице.  
  
## <a name="core-systems"></a>Основной системы  
...
## <a name="broadly-visible-components"></a>Широко видимых компонентов  
...
## <a name="files-virtual-and-physical-folders-and-subprojects"></a>Файлы, папки виртуальных и физических и подпроекты  
...
## <a name="task-list-guids"></a>Идентификаторы списка задач  
...
## <a name="component-selector-page-guids"></a>GUID страницы выбора компонентов  
