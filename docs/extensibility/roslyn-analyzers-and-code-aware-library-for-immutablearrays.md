...
В главном меню выберите **файл &#124; New &#124; проекта...** .  В **новый проект** диалогового окна в разделе **C#** проектов на панели навигации слева выберите расширяемости и в области справа выберите **анализатора с исправить код** проекта шаблон.  Введите имя и диалоговое окно подтверждения.
