...
-   **VsDpiAwareness.h**  
    ...
    -   Требуется, при использовании вспомогательных методов распознавания DPI для получения текущего значения DPI.  
...
3. Вкладка окна инструментов, когда достаточно небольшой вкладок (также используется в **Ctrl**+**вкладке** окон).
