...
-   Запуск [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] и создайте [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)] VSPackage с именем `MyPackage`, как описано в [Пошаговое руководство: создание команды меню VSPackage](http://msdn.microsoft.com/en-us/d699c149-5d1e-47ff-94c7-e1222af02c32).  
