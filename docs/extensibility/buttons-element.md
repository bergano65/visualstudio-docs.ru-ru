---
title: "Кнопки элемент | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[Элемент Button](../extensibility/button-element.md)|Определяет команду, которую пользователь может взаимодействовать с.|  
