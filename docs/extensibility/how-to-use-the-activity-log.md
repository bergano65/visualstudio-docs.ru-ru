---
title: Как выполнить Использование журнала действий | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "54929356"
---
# <a name="how-to-use-the-activity-log"></a>Как выполнить Использование журнала действий
