...
![Окно инструментов, разрешающее команду «Новое окно» при включенном экземпляра окна](../../extensibility/ux-guidelines/media/0702-02_toolwindowenablingcommand.png "0702-02_ToolWindowEnablingCommand")<br />Окно инструментов, разрешающее команду «Новое окно» при включенном экземпляра окна  
