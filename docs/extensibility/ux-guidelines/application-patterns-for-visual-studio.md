...
| Окно инструментов | Функция | 
| --- | --- | 
| Справка | Окно, которое позволяет пользователям доступ к различным методам получения справки, из «Практические советы» видео на форумах MSDN. | 
