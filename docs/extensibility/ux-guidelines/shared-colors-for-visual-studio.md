...
![Красная линия кнопки](~/docs/extensibility/ux-guidelines/media/0303-155_buttoncontrolredline.png "0303 155_ButtonControlRedline")
...
![Стандартной кнопки](~/docs/extensibility/ux-guidelines/media/03.03.Button.Standard.png "03.03.Button.Standard")<br />Стандартной кнопки
...
![Кнопка по умолчанию](~/docs/extensibility/ux-guidelines/media/03.03.Button.Default.png "03.03.Button.Default")<br />Кнопка по умолчанию
...
![Неактивная кнопка](~/docs/extensibility/ux-guidelines/media/03.03.Button.Disabled.png "03.03.Button.Disabled")<br />Неактивная кнопка  
...
![Кнопка при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/03.03.Button.hover.png "03.03.Button.hover")<br />Кнопка при наведении курсора мыши  
...
![Кнопка в нажатом состоянии](~/docs/extensibility/ux-guidelines/media/03.03.Button.Pressed.png "03.03.Button.Pressed")<br />Кнопка в нажатом состоянии  
...
![Кнопка с фокусом ввода](~/docs/extensibility/ux-guidelines/media/03.03.Button.Focused.png "03.03.Button.Focused")<br />Кнопка с фокусом ввода  
...
![Флажок (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-161_checkboxredline.png "0303-161_CheckboxRedline")<br />Флажок (красная линия)  
...
![По умолчанию раскрывающегося списка/со списком](~/docs/extensibility/ux-guidelines/media/0303-168_dropdowncombobox.png "0303-168_DropDownComboBox")<br />По умолчанию раскрывающегося списка/со списком
...
![Отключенные раскрывающегося списка/со списком](~/docs/extensibility/ux-guidelines/media/0303-169_dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")<br />Отключенные раскрывающегося списка/со списком
...
**Раскрывающиеся списки и поля со списком полей элемента представления списка: нажата состояния**  
 ...
 ![Раскрывающийся список/со списком нажатии элемента представления списка](~/docs/extensibility/ux-guidelines/media/0303-174_dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")<br />Раскрывающийся список/со списком нажатии элемента представления списка  
...
![Элемент управления сетки и табличных данных (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-197_tabulardatagridcontrolredline.png "0303-197_TabularDataGridControlRedline")<br />Элемент управления сетки или табличных данных (красная линия)
...
![Пояснительный текст по умолчанию](~/docs/extensibility/ux-guidelines/media/0303_InstructionalText.png "0303_InstructionalText.png")<br />Пояснительный текст по умолчанию
...
![Дополнительный текст инструкции](~/docs/extensibility/ux-guidelines/media/0303_SecondaryInstructionalText.png "0303_SecondaryInstructionalText.png")<br />Дополнительный текст инструкции
...
![Текст подсказки по умолчанию](~/docs/extensibility/ux-guidelines/media/0303_HintText.png "0303_HintText.png")<br />Текст подсказки по умолчанию
...
![Требуется указание текста](~/docs/extensibility/ux-guidelines/media/0303_RequiredHintText.png "0303_RequiredHintText.png")<br />Требуется указание текста
...
![Текст элемента управления в поле поиска](~/docs/extensibility/ux-guidelines/media/0303_SearchBoxControl.png "0303_SearchBoxControl.png")<br />Текст элемента управления в поле поиска
...
![Отключенные гиперссылки](~/docs/extensibility/ux-guidelines/media/0303-137_hyperlinkdisabled.png "0303-137_HyperlinkDisabled")<br />Отключенные гиперссылки  
...
![Информационная панель (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-138_infobarredline.png "0303-138_InfobarRedline")<br />Информационная панель (красная линия)
...
![Информационная панель по умолчанию](~/docs/extensibility/ux-guidelines/media/0303-139_infobar.png "0303-139_Infobar")<br />Информационная панель по умолчанию
...
![По умолчанию закройте информационную панель (&times;) кнопки](~/docs/extensibility/ux-guidelines/media/0303_InfobarCloseDefault.png "0303_InfobarCloseDefault.png")<br />По умолчанию закройте информационную панель (&times;) кнопки
...
![Закрыть информационную панель (&times;) кнопка при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303_InfobarCloseHover.png "0303_InfobarCloseHover.png")<br />Закрыть информационную панель (&times;) кнопка при наведении курсора мыши
...
![Нажата закрыть информационную панель (&times;) кнопки](~/docs/extensibility/ux-guidelines/media/0303_InfobarClosePressed.png "0303_InfobarClosePressed.png")<br />Нажата закрыть информационную панель (&times;) кнопки
...
![Кнопка гиперссылки информационная панель по умолчанию](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonDefault.png "0303_InfobarHyperlinkButtonDefault.png")<br />Кнопка гиперссылки информационная панель по умолчанию
...
![Информационная панель гиперссылки кнопка при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonHover.png "0303_InfobarHyperlinkButtonHover.png")<br />Информационная панель гиперссылки кнопка при наведении курсора мыши
...
![Кнопка гиперссылки нажатая информационная панель](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonPressed.png "0303_InfobarHyperlinkButtonPressed.png")<br />Кнопка гиперссылки нажатая информационная панель
...
![Информационная панель Гиперссылка по умолчанию встроенной кнопки](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonDefault.png "0303_InfobarHyperlinkButtonDefault.png")<br />Информационная панель Гиперссылка по умолчанию встроенной кнопки
...
![Информационная панель встроенной гиперссылки, кнопки при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkInlineHover.png "0303_InfobarHyperlinkInlineHover.png")<br />Информационная панель встроенной гиперссылки, кнопки при наведении курсора мыши
...
![Активная кнопка гиперссылки встроенная информационная панель](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkInlinePressed.png "0303_InfobarHyperlinkInlinePressed.png")<br />Активная кнопка гиперссылки встроенная информационная панель
...
![Кнопка по умолчанию информационной панели](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonDefault.png "0303_InfobarButtonDefault.png")<br />Кнопка по умолчанию информационной панели
...
![Информационная панель Кнопка при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonHover.png "0303_InfobarButtonHover.png")<br />Информационная панель Кнопка при наведении курсора мыши
...
![Информационная панель нажатой кнопки](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonPressed.png "0303_InfobarButtonPressed.png")<br />Информационная панель нажатой кнопки
...
![Кнопка отключенные информационной панели](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonDisabled.png "0303_InfobarButtonDisabled.png")<br />Кнопка отключенные информационной панели
...
![Кнопка конкретное информационной панели](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonFocus.png "0303_InfobarButtonFocus.png")<br />Кнопка конкретное информационной панели
...
![Полоса прокрутки (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-140_scrollbarredline.png "0303-140_ScrollbarRedline")<br />Полоса прокрутки (красная линия)
...
![Стрелки полосы прокрутки по умолчанию](~/docs/extensibility/ux-guidelines/media/0303-142_scrollbararrow.png "0303-142_ScrollbarArrow")<br />Стрелки полосы прокрутки по умолчанию
...
![Поле ввода окна поиска без фокуса ввода, неактивные](~/docs/extensibility/ux-guidelines/media/0303-114-1_searchinputfieldunfocusedinactive.png "0303-114-1_SearchInputFieldUnfocusedInactive")<br />Поле ввода окна поиска без фокуса ввода, неактивные  
...
![Кнопка раскрывающегося списка поиска без фокуса ввода](~/docs/extensibility/ux-guidelines/media/0303-116_searchdropdownbuttonunfocused.png "0303-116_SearchDropdownButtonUnfocused")<br />Кнопка раскрывающегося списка поиска без фокуса ввода
...
![Параметры поиска](~/docs/extensibility/ux-guidelines/media/0303-127_searchoptions.png "0303-127_SearchOptions")<br />Параметры поиска по умолчанию (ссылка)  
...
![Нажата параметры поиска (флажок)](~/docs/extensibility/ux-guidelines/media/0303-131_searchsuggestedpressed.png "0303-131_SearchSuggestedPressed")<br />Нажата параметры поиска (флажок)   
...
![Элемент дерева при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303-149_treeviewhover.png "0303-149_TreeViewHover")<br />Элемент дерева при наведении курсора мыши
...
![Элемент выбранные и имеющего фокус дерева при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303-153_treeviewfocusedhover.png "0303-153_TreeViewFocusedHover")<br />Элемент выбранные и имеющего фокус дерева при наведении курсора мыши  
...
![Элемент дерева выбранной и без фокуса ввода при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303-154_treeviewunfocusedhover.png "0303-154_TreeViewUnfocusedHover")<br />Элемент дерева выбранного и без фокуса ввода при наведении курсора мыши  
...
![Командная Полка Visual Studio (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-188_commandshelfredline.png "0303-188_CommandShelfRedline")<br />Командная Полка Visual Studio (красная линия)  
...
![Красная линия пунктов меню](~/docs/extensibility/ux-guidelines/media/0303-009_menuitemredline.png "0303 009_MenuItemRedline")  
...
![Элементы меню по умолчанию](~/docs/extensibility/ux-guidelines/media/0303-010_menudefault.png "0303-010_MenuDefault")<br />Элементы меню по умолчанию  
...
![Выбранное меню](~/docs/extensibility/ux-guidelines/media/0303-012_menuselected.png "0303-012_MenuSelected")<br />Выбранного пункта меню    
...
![Значок команды по умолчанию](~/docs/extensibility/ux-guidelines/media/0303-023_commandicondefault.png "0303-023_CommandIconDefault")<br />Значок команды по умолчанию
...
![Команда панели поле поля со списком ввода](~/docs/extensibility/ux-guidelines/media/0303-030_comboboxinputfield.png "0303-030_ComboBoxInputField")<br />Команда панели поле поля со списком ввода  
...
![Раскрывающегося списка командной строки](~/docs/extensibility/ux-guidelines/media/0303-032_comboboxdropdownlist.png "0303-032_ComboBoxDropdownList")<br />Раскрывающегося списка командной строки
...
![Кнопка раскрывающегося списка командной строки при наведении курсора мыши](~/docs/extensibility/ux-guidelines/media/0303-047_dropdownbuttonhover.png "0303-047_DropdownButtonHover")<br />Кнопка раскрывающегося списка командной строки при наведении курсора мыши  
...
![С плавающей запятой рамка окна документа с фокусом ввода, по умолчанию](~/docs/extensibility/ux-guidelines/media/0303-067_framefocused.png "0303-067_FrameFocused")<br />С плавающей запятой рамка окна документа с фокусом ввода, по умолчанию
...
![Открытой вкладки документов (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-073_opendocumenttabredline.png "0303-073_OpenDocumentTabRedline")<br />Открытой вкладки документов (красная линия)
...
![Вкладка предварительного просмотра без фокуса ввода, выбранной](~/docs/extensibility/ux-guidelines/media/0303-080_previewtabunfocused.png "0303-080_PreviewTabUnfocused")<br />Вкладка предварительного просмотра без фокуса ввода, выбранного
...
![Добавление тегов в Visual Studio (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-176_taggingredline.png "0303-176_TaggingRedline")<br />Добавление тегов в Visual Studio (красная линия)  
...
![Тег по умолчанию](~/docs/extensibility/ux-guidelines/media/0303-177_tag.png "0303-177_Tag")<br />Тег по умолчанию
...
![Выбранный тег](~/docs/extensibility/ux-guidelines/media/0303-180_tagselected.png "0303-180_TagSelected")<br />Выбранный тег  
...
![Закрыть активный (&times;) глиф тега](~/docs/extensibility/ux-guidelines/media/0303-183_tagglyphpressed.png "0303-183_TagGlyphPressed")<br />Закрыть активный (&times;) глиф тега
...
![Окно панели элементов по принципу (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-189_toolboxredline.png "0303-189_ToolboxRedline")<br />Окно панели элементов по принципу (красная линия)
...
![Дочерний узел панели инструментов выбранной, без фокуса ввода](~/docs/extensibility/ux-guidelines/media/0303-196_toolboxchildnodeunfocused.png "0303-196_ToolboxChildNodeUnfocused")<br />Дочерний узел панели инструментов выбранной, без фокуса ввода  
...
![Панель заголовка без фокуса ввода](~/docs/extensibility/ux-guidelines/media/0303-094_titlebarunfocused.png "0303-094_TitleBarUnfocused")<br />Заголовок окна без фокуса ввода
...
![Строка кнопки заголовка (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-095_titlebarbuttonredline.png "0303-095_TitleBarButtonRedline")<br />Строка кнопки заголовка (красная линия)  
...
![По умолчанию, кнопки в строке заголовка без фокуса ввода](~/docs/extensibility/ux-guidelines/media/0303-097_titlebarbuttonunfocused.png "0303-097_TitleBarButtonUnfocused")<br />По умолчанию, кнопки в строке заголовка без фокуса ввода    
...
![Вкладка окна инструментов установлен, без фокуса ввода](~/docs/extensibility/ux-guidelines/media/0303-104_toolwindowtabunfocused.png "0303-104_ToolWindowTabUnfocused")<br />Выбранная вкладка окна инструментов без фокуса ввода
...
![По умолчанию фоновая вкладка окна инструментов](~/docs/extensibility/ux-guidelines/media/0303-105_toolwindowbackgroundtab.png "0303-105_ToolWindowBackgroundTab")<br />По умолчанию фоновая вкладка окна инструментов  
...
![Автоматически скрываемые вкладки (красная линия)](~/docs/extensibility/ux-guidelines/media/0303-107_autohideredline.png "0303 107_AutoHideRedline")автоматического скрытия вкладок (красная линия)
