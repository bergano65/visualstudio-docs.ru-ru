...
![Отключенные информационной панели кнопку](../../extensibility/ux-guidelines/media/0303_InfobarButtonDisabled.png "0303_InfobarButtonDisabled.png")<br />Кнопка отключенные информационной панели
...
![Древовидная элемента представления на перетаскивания над](../../extensibility/ux-guidelines/media/0303-150_treeviewdragover.png "0303 150_TreeViewDragOver")<br />Перетащите элемент дерева на  
...
![Команда панели Разворачивающаяся кнопка нажата](../../extensibility/ux-guidelines/media/0303-056_splitbuttonpressed.png "0303 056_SplitButtonPressed")<br />Панель команд нажатой Разворачивающаяся кнопка  
...
![Отключить команду Панель Разворачивающаяся кнопка](../../extensibility/ux-guidelines/media/0303-057_splitbuttondisabled.png "0303 057_SplitButtonDisabled")<br />Кнопка разделения отключенной командной строки
...
![По умолчанию кнопки «Дополнительные параметры» на панели команд](../../extensibility/ux-guidelines/media/0303-059_moreoptions.png "0303 059_MoreOptions")<br />По умолчанию панели команд кнопку «Дополнительные параметры»

![По умолчанию кнопка «Переполнение» на панели команд](../../extensibility/ux-guidelines/media/0303-060_overflow.png "0303 060_Overflow")<br />По умолчанию кнопки «Переполнение» командной строки
...
![Кнопка «Дополнительно» при наведении курсора мыши на панели команд](../../extensibility/ux-guidelines/media/0303-061_moreoptionshover.png "0303 061_MoreOptionsHover")<br />Команда панели кнопку «Дополнительные параметры» при наведении курсора мыши  
...
![Переполнение при нажатии](../../extensibility/ux-guidelines/media/0303-064_overflowpressed.png "0303 064_OverflowPressed")<br />Активная кнопка «Переполнение» командной строки  
...
![Рамка окна документа без фокуса ввода, с плавающей запятой при наведении курсора мыши](../../extensibility/ux-guidelines/media/0303-070_frameunfocusedhover.png "0303 070_FrameUnfocusedHover")<br />Без фокуса ввода, с плавающей запятой рамка окна документа при наведении курсора мыши
...
![Конкретное плавающей рамка окна документа на клавишу](../../extensibility/ux-guidelines/media/0303-071_framefocusedpressed.png "0303 071_FrameFocusedPressed")<br />Конкретное плавающей рамка окна документа на машине
...
![Вкладки документов с фокусом ввода, выбран](../../extensibility/ux-guidelines/media/0303-074_selectedtabfocused.png "0303 074_SelectedTabFocused")<br />Вкладка выбранного документа с фокусом ввода
...
![Вкладки документов по умолчанию фон](../../extensibility/ux-guidelines/media/0303-076_backgroundtab.png "0303 076_BackgroundTab")<br />Вкладка документа фона по умолчанию  
...
![Вкладка предварительного просмотра без фокуса ввода, выбранный](../../extensibility/ux-guidelines/media/0303-080_previewtabunfocused.png "0303 080_PreviewTabUnfocused")<br />Вкладка предварительного просмотра без фокуса ввода, выбранной
...
![Кнопка переполнения документа на клавишу](../../extensibility/ux-guidelines/media/0303-086_overflowpressed.png "0303 086_OverflowPressed")<br />Кнопка переполнения документа на машине
...
![По умолчанию тег](../../extensibility/ux-guidelines/media/0303-177_tag.png "0303 177_Tag")<br />Тег по умолчанию
...
![Активный тег](../../extensibility/ux-guidelines/media/0303-179_tagpressed.png "0303 179_TagPressed")<br />Активен тег  
...
![Выбрать тег](../../extensibility/ux-guidelines/media/0303-180_tagselected.png "0303 180_TagSelected")<br />Выбранный тег  
...
![По умолчанию для выбранного тега с закрыть (&times;) глиф](../../extensibility/ux-guidelines/media/0303-184_tagselected.png "0303 184_TagSelected")<br />По умолчанию для выбранного тега с закрыть (&times;) глифа
...
![Активный тег с закрыть, выбран (&times;) глиф](../../extensibility/ux-guidelines/media/0303-186_tagselectedpressed.png "0303 186_TagSelectedPressed")<br />Активный тег с закрыть, выбран (&times;) глифа
...
![Окно инструментов с плавающей запятой, без фокуса ввода](../../extensibility/ux-guidelines/media/0303-091_toolwindowunfocused.png "0303 091_ToolWindowUnfocused")<br />Плавающее окно, окно инструментов без фокуса ввода  
...
![Конкретное заголовок](../../extensibility/ux-guidelines/media/0303-093_titlebarfocused.png "0303 093_TitleBarFocused")<br />Заголовок окна с фокусом ввода
...
![Нажмите клавишу основное внимание уделено кнопки в заголовке окна](../../extensibility/ux-guidelines/media/0303-100_titlebarbuttonfocusedpressed.png "0303 100_TitleBarButtonFocusedPressed")<br />Кнопки панели заголовка с фокусом ввода на машине
...
![Кнопки панели заголовка без фокуса ввода на клавишу](../../extensibility/ux-guidelines/media/0303-101_titlebarbuttonunfocusedpressed.png "0303 101_TitleBarButtonUnfocusedPressed")<br />Кнопки панели заголовка без фокуса ввода на машине  
