...
|||  
|-|-|  
|**Использование:**<br /><br /> -Больше заголовок в диалоговых окнах подписи<br />-Заголовок основного отчета<br /><br /> **Выполните действия.**<br /><br /> -Используйте регистр предложения<br />-Всегда используется упрощенная<br /><br /> **Не надо:**<br /><br /> — Используйте для пользовательского интерфейса Кроме подписи пользовательского интерфейса, такие как начальная страница<br />-Полужирный, курсив или полужирный курсив.<br />— Используйте для основного текста<br />— Следует использовать в окнах инструментов|**Отображается в виде:** 28 pt Segoe UI Light<br /><br /> **Наглядный пример:**<br /><br /> ![Пример шрифта среды 310% &#43; света заголовок](../../extensibility/ux-guidelines/media/0202-a_ef310.png "0202 a_EF310")|  
