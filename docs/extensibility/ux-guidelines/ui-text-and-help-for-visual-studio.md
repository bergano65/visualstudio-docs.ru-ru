...
|Хорошо|Неверный|  
|------------|--------------|  
|«Номер набран больше не службы. Проверьте номер и наберите его еще раз или набрать 0 для оператора.»|-   «Ошибка \(449\): недопустимое число»<br />-   «Эта ошибка необработанное исключение указывает, что операция завершилась успешно».<br /><br /> ![Bad error message in Visual Studio](~/docs/extensibility/ux-guidelines/media/0602-a_errordialog.png "0602\-a\_ErrorDialog")|  
