...
- Таким образом, чтобы они вопрос ответят что раздела, ссылки справки фразы.
     ...
     Неправильно:    «Дополнительные сведения о ценах на мобильные службы Windows Azure»

     Правильно:    «Какие параметры ценообразования доступны для мобильных служб Windows Azure»?
...
- Никогда не ссылку только слово «сюда». Это вызывает неудобства для некоторых средств чтения с экрана, которые будут голосовая связь только с гиперссылкой слово.
     ...
     Неправильно:    «Сведения о мобильных служб Windows Azure **здесь**"
...
|Оператор delete|Уничтожения данных. Используйте только в том случае, если удаляемый элемент будут окончательно удалены или удален с диска.|Обычно «Удалить» требуется строка, если результат является удаление файла с диска.|
