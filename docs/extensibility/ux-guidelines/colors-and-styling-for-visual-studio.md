...
Таблицы на [блог группы разработчиков WPF: Справочник по SystemColors](https://blogs.msdn.microsoft.com/wpf/2010/11/30/systemcolors-reference/) указывает полный набор названий цветов системы и соответствующие тона, отображаемых в каждой темы.
