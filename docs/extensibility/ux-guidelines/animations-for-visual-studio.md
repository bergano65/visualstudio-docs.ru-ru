...
-   **Особенность важен.** В большинстве случаев анимации не должен внимания пользователя запросу для выполнения ее задач. Незначительные изменения в синхронизации, упорядочивания и поведение может значительно повлиять на восприятие и может не дать эффективный и неэффективными анимации.  
...
-   Представляет изменения во времени, используя ползунки времени, регистрацию и выбора колеса и элементы управления движением (воспроизведения, остановки и приостановки) 
...
-   Переместите "Удалить", отменять и повторять  
...
![Анимация "цветовой переход"](../../extensibility/ux-guidelines/media/1202-d_colorblend.png "1202 d_ColorBlend")<br />Анимация цвета blend  
...
![Анимация поворота элемента пользовательского интерфейса](../../extensibility/ux-guidelines/media/1202-g_rotate.png "1202 g_Rotate")<br />Анимация поворота элемент пользовательского интерфейса  
...
![Анимация переупорядочивания в Visual Studio вкладку](../../extensibility/ux-guidelines/media/1202-j_tabreorder.png "1202 j_TabReorder")<br />Анимация переупорядочивания вкладок
...
![Закрыть плавающей анимации документа](../../extensibility/ux-guidelines/media/1202-k_closefloatingdocument.png "1202 k_CloseFloatingDocument")<br />Анимация закрытия с плавающей запятой документа  
...
![Анимация показа окна средства автоматического скрытия](../../extensibility/ux-guidelines/media/1202-o_autohidetoolwindowreveal.png "1202 o_AutoHideToolWindowReveal")<br />Автоматическое скрытие анимация показа окна инструментов  
