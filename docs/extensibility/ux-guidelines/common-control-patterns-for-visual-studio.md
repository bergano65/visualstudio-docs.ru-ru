...
> **Примечание:** пользователям нужно переместиться на эти кнопки (отсутствуют ключи доступа), поэтому размещайте их в порядке, разумно. Карта `name` свойства кнопки действие, необходимое, чтобы средства чтения с экрана правильно интерпретировать действие кнопки.  
