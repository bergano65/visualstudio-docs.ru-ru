...
![Неверный: ширина раскрывающегося списка, слишком велика для содержимого, которое будет отображаться.](~/docs/extensibility/ux-guidelines/media/0707-03_incorrectdropdownlayout.png "0707-03_IncorrectDropDownLayout")<br />Неверный: ширина раскрывающегося списка, слишком велика для содержимого, которое будет отображаться.
...
![Сведения о статического текста в текстовых элементов управления](~/docs/extensibility/ux-guidelines/media/DisplayingStaticText.png "DisplayingStaticText.png")<br />Сведения о статического текста в текстовых элементов управления
...
![Статический текст в окне «Свойства»](~/docs/extensibility/ux-guidelines/media/PropertiesWindow.png "PropertiesWindow.png")<br />Статический текст в окне «Свойства»
...
![Только для чтения текстовом поле отображается активным и неактивным состоянием](~/docs/extensibility/ux-guidelines/media/ReadOnlyTextBox.png "ReadOnlyTextBox.png")<br />Только для чтения текстовом поле отображается активным и неактивным состоянием
...
![Пример текста водяного знака](~/docs/extensibility/ux-guidelines/media/WatermarkTextExample.gif)<br />Пример текста водяного знака
...
| Удалить | ![Графическая кнопка «Удалить»](~/docs/extensibility/ux-guidelines/media/070703-09_buttonremove.png "070703 09_ButtonRemove") |
...
| Переместить вниз | ![Графическая кнопка «Вниз»](~/docs/extensibility/ux-guidelines/media/070703-13_buttonmovedown.png "070703 13_ButtonMoveDown") |
| Удаление | ![Графическая кнопка «Delete»](~/docs/extensibility/ux-guidelines/media/070703-14_buttondelete.png "070703 14_ButtonDelete") |
...
![И вертикальной и горизонтальной полосы прокрутки отображаются, так как содержимое превышен лимит элемента управления иерархического представления.](~/docs/extensibility/ux-guidelines/media/070705-4_scrollbars.png "070705-4_Scrollbars")<br />И вертикальной и горизонтальной полосы прокрутки отображаются, так как содержимое превышен лимит элемента управления иерархического представления.
