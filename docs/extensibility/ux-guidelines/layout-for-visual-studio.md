...
### <a name="utility-dialog-layout-examples"></a>Примеры макета диалогового окна программы
 ...
 ![Межоконное пространство для меток выше элементов управления](../../extensibility/ux-guidelines/media/0801-a_utilityspacingabove.png "0801-a_UtilitySpacingAbove")

 **Рис. 08,01-a: рекомендации по расстоянию для диалоговых окон программы с метками над элементами управления**

 ![Межоконное пространство для меток слева от элементов управления](../../extensibility/ux-guidelines/media/0801-b_utilityspacingleft.png "0801-b_UtilitySpacingLeft")
...
- Кнопки команды должны быть на 6 пикселах.
  ...
  ![Выравнивание по кнопке "базовый"](../../extensibility/ux-guidelines/media/0801-c_buttonalign.png "0801-c_ButtonAlign")
...
- Использовать вертикальное выравнивание (столбец) внутренних кнопок, если кнопка " **ОК** **" / "Отмена"** горизонтально ориентирована в нижнем правом углу.

- Используйте горизонтальное выравнивание (строку) внутренних кнопок, если кнопка " **ОК** **" / "Отмена"** вертикально в правом верхнем углу. Такая ситуация менее распространена.

- Размер внутренней кнопки должен указывать на стандартный размер кнопки в 75x23 пикселях, что соответствует размеру кнопок " **ОК** **" / "Отмена"** по возможности. Если метка кнопки приводит к превышению стандартного размера кнопки, другие кнопки в этом наборе должны быть согласованы с этим более широким размером.

  ![Кнопки "по горизонтали" и "Отмена"](../../extensibility/ux-guidelines/media/0801-f_horizokcan.png "0801-f_HorizOKCan")

  **Рисунок 08,01-f: вертикальные внутренние кнопки с горизонтальным нажатием ОК или Отмена**

  ![Кнопки "ОК" и "Отмена" по вертикали](../../extensibility/ux-guidelines/media/0801-g_vertokcan.png "0801-g_VertOKCan")
...
## <a name="BKMK_ThemedDialogLayout"></a>Макет диалогового окна с темой
...
### <a name="themed-dialog-layout-examples"></a>Примеры макета диалогового окна с темой
 ![Макет диалогового окна с темой](../../extensibility/ux-guidelines/media/0801-h_themeddialog.png "0801-h_ThemedDialog")

 **Рис. 08,01-h. диалоговое окно с темой**

 ![Размеры диалоговых окон с темами](../../extensibility/ux-guidelines/media/0801-i_themeddialogdimensions.png "0801-i_ThemedDialogDimensions")

 **Рис. 08,01-i. диалоговое окно "темы" — измерения**

 ![Шрифты диалоговых окон с темой](../../extensibility/ux-guidelines/media/0801-j_themeddialogfonts.png "0801-j_ThemedDialogFonts")

 **Рис. 08,01-j: диалоговое окно с темой — шрифты**

 ![Цвета диалоговых окон с темами](../../extensibility/ux-guidelines/media/0801-k_themeddialogcolors.png "0801-k_ThemedDialogColors")
