...
## <a name="creating-an-asyncpackage"></a>Создание AsyncPackage  
 Сначала нужно создать проект VSIX (**файл / создать / Project / Visual C# / расширяемости / проект VSIX**) и добавление в проект VSPackage (щелкните проект правой кнопкой мыши и **добавить новый элемент / C# элемента или расширяемость/Visual Пакет Studio**). Затем можно создать служб и добавить эти службы в пакет.  
