 ...
 **VSIX**.  Используйте **файл &#124; Новые функции...**  команду, чтобы создать проект.  Выберите узел расширения в C# в левой области навигации и щелкните **проект VSIX** в правой области.  Введите имя ColumnGuides и выберите **ОК** для создания проекта.  
