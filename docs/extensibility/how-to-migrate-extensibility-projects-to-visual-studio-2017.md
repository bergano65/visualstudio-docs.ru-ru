...
![Средства построения VSSDK](~/extensibility/media/vssdk-build-tools.png)
...
* Выберите **необходимые компоненты** и нажмите **New** кнопки.
  ...
  ![Конструктор манифеста VSIX](~/extensibility/media/vsix-manifest-designer.png)

* **Добавление новых необходимых компонентов** окно.

  ![Добавление необходимых компонентов vsix](~/extensibility/media/add-vsix-prerequisite.png)
...
* Обновите версию, если это требуется.
  ...
  ![Добавление необходимых компонентов roslyn](~/extensibility/media/add-roslyn-prerequisite.png)
...
![Запуск внешней программы](~/extensibility/media/start-external-program.png)
...
![Установщик VSIX в Visual Studio 2017 г.](~/extensibility/media/vsixinstaller-vs-2017.png)
...
![VS запущенных процессов](~/extensibility/media/vs-running-processes.png)
...
![отсутствует необходимый компонент vsixinstaller](~/extensibility/media/vsixinstaller-missing-prerequisite.png)
