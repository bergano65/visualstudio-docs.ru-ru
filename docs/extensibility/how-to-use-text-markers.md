---
title: Как выполнить Использование меток текста | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "54967473"
---
# <a name="how-to-use-text-markers"></a>Как выполнить Использовать текстовые метки
