...
3.  Когда появится в конструкторе манифеста VSIX, закройте его.  
...
10. В **обозревателе решений**, откройте контекстное меню для **решения «NativeMath»**, а затем выберите **открыть папку в проводнике**.  
  
11. В **проводника**, скопируйте \NativeMath\NativeMath.h, а затем в **обозреватель решений**в **NativeMathVSIX** проекта, вставьте его в \DesignTime\ Папка CommonConfiguration\Neutral\Include\.  
  
     Скопируйте \Debug\NativeMath\NativeMath.lib и вставьте его в папке \DesignTime\Debug\x86\.  
...
18. В **проводнике**, перейдите в папку \bin\Debug\, а затем запустите NativeMathVSIX.vsix, чтобы начать установку.  
  
19. Выберите **установить** кнопку, дождитесь завершения установки и перезапустите Visual Studio.  
...
4.  На **общие свойства**, **.NET Framework и ссылки** свойство в список ссылочных типов, разверните узел **Windows**, а затем выберите **расширения** . В области сведений выберите **собственного пакета SDK математические** расширения и нажмите кнопку **добавить новую ссылку** кнопки.  
  
5.  В **добавить ссылку** выберите **собственного пакета SDK математические** флажок и нажмите кнопку **ОК** кнопки.  
  
6.  Откройте окно свойств проекта для NativeMathSDKSample.  
...
7.  В **обозревателе решений**файл MainPage.XAML и выполните следующий код XAML, чтобы заменить его содержимое:  
...
11. В приложении, ввести любых двух чисел, выберите операцию и выберите  **=**  кнопки.  
