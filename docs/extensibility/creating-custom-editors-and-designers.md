...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Пошаговое руководство: Добавление компонентов к пользовательского редактора](../extensibility/walkthrough-adding-features-to-a-custom-editor.md)  
