---
title: Как выполнить Предоставить контекст для редакторов | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "54945870"
---
# <a name="how-to-provide-context-for-editors"></a>Как выполнить Предоставить контекст для редакторов
