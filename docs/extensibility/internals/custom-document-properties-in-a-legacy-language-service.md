...
## <a name="customize-the-documentproperties-class"></a>Настроить класс DocumentProperties  
...
### <a name="example"></a>Пример  
 Ниже приведен пример класса, производного от <xref:Microsoft.VisualStudio.Package.DocumentProperties>, показывающая два свойства `Filename` и `Description`. При обновлении свойства, пользовательский метод на <xref:Microsoft.VisualStudio.Package.LanguageService> вызывается для записи свойства исходного файла.  
...
## <a name="instantiate-the-custom-documentproperties-class"></a>Создать экземпляр пользовательского класса DocumentProperties  
...
### <a name="example"></a>Пример  
 В этом примере хранит свойства `Filename` и `Description` первые две строки исходного файла, внедренные в заголовке специальный комментарий, как:  
