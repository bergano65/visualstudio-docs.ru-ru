...
## <a name="command-menu-access"></a>Доступ к меню команд
 ...
 Общий доступ: **Файловый** -> ресурс**системы управления версиями** -> **Share**.
