...
### <a name="command-flags"></a>Флаги команд  
 ...
 `DynamicVisibility`  
 Видимость команды можно изменить с помощью `QueryStatus` метода или идентификатор GUID, включенный в контексте `VisibilityConstraints` раздел.  
