...
### <a name="case-4a-modified-items"></a>4A регистра: измененные элементы
...
### <a name="case-4b-adding-files"></a>4b регистра: Добавление файлов
...
### <a name="case-4c-adding-projects"></a>Случай 4c: Добавление проектов
