...
## <a name="extensibility-architecture"></a>Архитектура расширяемости  
 ...
 ![График архитектуры окружения](~/docs/extensibility/internals/media/environment.gif "environment")  
...
## <a name="tool-windows"></a>Окна инструментов  
 ...
 ![Снимок экрана](~/docs/extensibility/internals/media/t1gui.png "T1gui")  
