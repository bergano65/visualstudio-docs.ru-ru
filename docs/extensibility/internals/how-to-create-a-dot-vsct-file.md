...
Можно создать на базе XML *.vsct* файл из существующей таблицы команды *.ctc* исходный файл. Таким образом, можно воспользоваться преимуществами нового на базе XML [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] форматом компилятора таблицы (VSCT) команд.  
