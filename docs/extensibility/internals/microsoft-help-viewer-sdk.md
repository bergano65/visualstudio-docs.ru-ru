...
2. Зарегистрируйте пространство имен партнеров в разделе реестра Help 2,3:
   ...
   - Для 32-разрядных операционных систем:
      ...
      HKEY_LOCAL_MACHINE<em> \\ пространства имен \><</em> \software\microsoft\help\v2.3\partner

      «Location» = «offline»

   - Для 64-разрядных операционных систем:

      HKEY_LOCAL_MACHINE<em> \\ пространства имен \><</em> \software\wow6432node\microsoft\help\v2.3\partner
...
**Справка по HKEY_CURRENT_USER \Software\Microsoft\VisualStudio\15.0\Dynamic**

::: moniker-end

::: moniker range=">=vs-2019"

**Справка по HKEY_CURRENT_USER \Software\Microsoft\VisualStudio\16.0\Dynamic**
...
Вы можете отправить предложения о функциях в [сообщество разработчиков](https://developercommunity.visualstudio.com/content/idea/post.html?space=8).
