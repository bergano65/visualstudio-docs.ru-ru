...
|Компонент:|**Отзыв, нижний колонтитул и эмблема**|  
...
|Компонент:|**Отказ от ответственности**|  
...
|OnlineText|Online|  
|Компонент:|**Элемент управления видео аудио**|  
...
|Компонент:|**Элемент управления содержимым не установлен**|  
...
|Компонент:|**Элемент управления не удалось найти раздел**|  
...
|Компонент:|**Раздел поврежден управления**|  
...
|Компонент:|**Домашняя страница управления**|  
...
||< HOME_PAGE_BOOKS_INSTALLED_SECTION_ADD / >|Заголовок раздела тег Branding.xml\<HomePageInstalledBooks >, данные, созданные из приложения, \<HomePageNoBooksInstalled > Если никакие книги не установлены.|  
||< HOME_PAGE_SETTINGS_SECTION_ADD / >|Заголовок раздела тег Branding.xml \<HomePageHelpSettings >, статьи текст \<HomePageHelpSettingsText >.|  
...
Чтобы напрямую обратиться к группе PM средство просмотра справки отправьте сообщение электронной почтыhlpfdbk@microsoft.com