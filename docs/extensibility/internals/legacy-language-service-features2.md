---
title: Устаревший языковой службы Features2 | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
В следующих разделах перечислены некоторые возможности службы прежних версий языка, которые может создать.  
...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Объясняет, как реализовать Цветовая подсветка синтаксиса.  
 ...
 Объясняет, как реализовать подсказка Info параметра IntelliSense.  
 ...
 Объясняет, как реализовать списка операторов IntelliSense и элемента списка завершения.  
 ...
 Описаны шаги по реализации поддержки отладчика...  
