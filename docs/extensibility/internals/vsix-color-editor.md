...
-   **Имя категории:** логическую группировку набор цветов. Используйте существующее имя категории, если уже есть цвета, характерные для нужного элемента пользовательского интерфейса, или группы элементов пользовательского интерфейса.  
  
-   **Имя токена:** описательное имя для токен цвета и наборы маркеров. Наборы включают фона и имена токенов передний план (текст), а также все их состояния, и эти должна называться, так как это легко определить пары и состояния, которые они применяются к.  
  
-   **Цвета значения (или тона):** необходимые для каждой цветной темы. Всегда создавайте фона и текста цветовых значений в парах. Цвета сопоставляются для фона и цвета переднего плана, чтобы цвет текста (основной) всегда читается цвете фона, на котором он отрисовывается. Эти цвета связаны и будет использоваться совместно в пользовательском Интерфейсе. Если фон не предназначен для использования с текстом, не определяет цвет переднего плана.  
 ...
 **Шаг 1: Определение категории и имена токенов для новых цвет маркеров.**  
 ...
 **Шаг 2: Выбор оттенки элемент пользовательского интерфейса, используемых для каждой темы и системный цвет для режима высокой контрастности.**  
 ...
 **Шаг 3: Использование редактора цвета для создания новых цвет маркеров.**  
 ...
 **Шаг 4: Использование цвета в расширении Visual Studio.**  
