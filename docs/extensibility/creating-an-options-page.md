...
7. В экспериментальном экземпляре Visual Studio на **средства** меню **параметры**.
     ...
     Параметры страницы возможности доступны также в поле поиска Visual Studio. В поле поиска в верхней части интегрированной среды разработки, введите **My Category** и вы увидите **My Category "->" мою страницу сетки** указаны в результатах.
