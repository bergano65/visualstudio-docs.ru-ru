...
6. Выберите издателя, которого вы хотите использовать для отправки расширения.  Издатели можно изменить, щелкнув имя издателя в левом верхнем углу.

  ![Издатель изменений Marketplace](media/change-marketplace-publisher.png)
...
9. Нажмите кнопку **сохранить и отправить**. Откроется страница управления обратно к издателю.  Расширение не опубликован.  Чтобы опубликовать вашего расширения при наведении указателя мыши на этот элемент расширения и выберите команду **...**  и затем **предоставить открытый**.  Можно просмотреть, как расширение будет выглядеть как на Marketplace, выбрав **в подробностях**.  Для получения числа, нажмите кнопку **отчеты**.  Чтобы внести изменения в модуль, щелкните **изменить*.
...
3. Наведите указатель мыши на элемент расширения и выберите команду **...**  и **удалить...** Будет предложено подтвердить, следует ли удалить расширение.  Нажмите кнопку **ОК**.
