...
8. В **2. предоставление сведений о расширении**. Некоторые поля автоматически заполняются из файла *source. extension. vsixmanifest* из расширения. Дополнительные сведения см. здесь:
    ...
    * **Тип**. Наиболее распространенным типом расширений являются **средства**.
...
3. Затем можно указать адрес электронной почты пользователя, которого вы хотите добавить, и предоставить правильный уровень доступа в разделе **Выбор роли**.  Вы можете выбрать один из следующих параметров:
