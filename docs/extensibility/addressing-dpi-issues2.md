...
Ниже приведены примеры способ масштабирования изображения соответствующих точек на дюйм коэффициенты масштабирования. Образы, описанные в оранжевый обозначения наши рекомендации по состоянию на Visual Studio 2013 (100 – 200% масштабирование):
...
- Для масштабирования больших уровней не кратна 100% (например, 250% или 350%), масштабирование изображений иллюстрациях с бикубическую приводит нечетких соответствий, размытый вид пользовательского интерфейса. Наилучшего результата получается путем первой масштабирования изображения с NearestNeighbor до наибольшего кратного 100% (например, 200 или 300%) и масштабирования с бикубическую оттуда. См. в разделе особый случай: prescaling изображений WPF для DPI в больших уровни Дополнительные сведения.
...
Шаг 1. Prescale изображение, %, 200, 300% и т. д. с помощью NearestNeighbor.
