...
# [Создание первого расширения: Hello World](extensibility-hello-world.md)
...
# [Практическое руководство. Расширение перехода для Visual Studio](how-to-roundtrip-VSIXs.md)
# [Протокол языкового сервера](language-server-protocol.md)
##[Добавление расширения протокола языкового сервера](adding-an-lsp-extension.md)
#[Открыть папку](open-folder.md)
##[Рабочие области](workspaces.md)
##[Контексты файла](workspace-file-contexts.md)
##[Индексация](workspace-indexing.md)
##[Языковые службы](workspace-language-services.md)
##[Сборка](workspace-build.md)
...
### [Поддержка EditorConfig](supporting-editorconfig.md)
...
### [Справочник по схеме языкового пакета 2.0 VSIX](vsix-language-pack-schema-2-0-reference.md)
