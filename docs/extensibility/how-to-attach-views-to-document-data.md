---
title: Как выполнить Присоединение представлений в данные документа | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "55010042"
---
# <a name="how-to-attach-views-to-document-data"></a>Как выполнить Присоединение представлений данных документа
