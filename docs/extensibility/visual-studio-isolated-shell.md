...
> [!NOTE]
>  Дополнительные сведения о развертывании изолированного приложения командной строки см. в разделе [Пошаговое руководство: создание базового приложения Isolated Shell](../extensibility/walkthrough-creating-a-basic-isolated-shell-application.md).  
...
-   Пакеты VSPackage и Managed Extensibility Framework (MEF) компонентов можно использовать для расширения приложения изолированной оболочки, так же, как вы будете использовать их в любое другое расширение Visual Studio. Дополнительные сведения см. в разделе [расширение изолированной оболочки](../extensibility/extending-the-isolated-shell.md).  
...
-   Некоторые аспекты оболочки также можно указать при запуске приложения. Для этого измените значение параметра в вызове начальную точку входа appenvstub.dll.  
 ...
 Дополнительные сведения о различных элементах, которые можно настроить в разделе [элементы изолированной оболочки](../extensibility/elements-of-the-isolated-shell.md).  
