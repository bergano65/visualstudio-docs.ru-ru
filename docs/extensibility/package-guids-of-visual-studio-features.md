---
title: "Пакет GUID функций Visual Studio | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="package-guids-of-visual-studio-features"></a>GUID пакета возможностей Visual Studio
Следующие идентификаторы GUID в файле .pkgundef приложении изолированной оболочки можно использовать для исключения определенных пакетов из приложения.  
  
## <a name="package-guids"></a>GUID пакета  
  
|Область функций|Имя необработанного пакета|GUID пакета|  
|------------------|----------------------|------------------|  
|Базовая интегрированная среда разработки|Отмена пакета|{1D76B2E0-F11B-11D2-AFC3-00105A9991EF}|  
...
||Directory Listing Package|{5010C52F-44AB-4051-8CE1-D36C20D989B4}|  
...
|Справка|Visual Studio Help Package|{4A791146-19E4-11D3-B86B-00C04F79F802}|  
|Список задач, список ошибок|ErrorListPackage|{4A9B7E50-AA16-11D0-A8C5-00A0C921A4D2}|  
|Структура класса|Class Outline Package|{21AF45B0-FFA5 -&11;D&0;-G63F-00A0C922E851}|  
...
||Visual Web Developer проекта сохраняемости пакета|{8FF02D1A-C177-4AC8-A62F-88FC6EA65F57}|  
||Visual Web Developer веб-миграции пакета|{C1DAB116-2D63-493A-B970-10D7DD0B476E}|  
...
|Редактор HTML|Visual Studio HTM Editor Package|{1B437D20-F8FE-11D2-A6AE-00104BCC7269}|  
||Visual Web Developer HTML Source Editor Package|{BFCC0C3C-6F87-4285-A6C8-BB616061800D}|  
|редактор CSS|Visual Studio CSS Editing Package|{A764E895-518D-11d2-9A89-00C04F79EFC3}|  
|XML-редактор|Visual Studio XML Editor Package|{87569308-4813-40A0-9CD0-D7A30838CA3F}|  
|Веб-браузер|Visual Studio Web Browser Package|{E8B06F41-6D01-11D2-AA7D-00C04F990343}|  
||Фабрики проекта приложения Web для представления функциональных возможностей браузера|{349C5851-65DF-11DA-9384-00065B846F21}|  
|двоичный редактор|Visual Studio Binary Editor Package|{5B98C2C0-CD7B-11D0-92DF-00A0C9138C45}|  
|Конструктор Windows Forms|Размещения пакет для конструктора Windows Forms|{68939055-38E0-4D17-92CB-8909710D8178}|  
...
|Инструменты базы данных|Visual Database Tools Package|{220A4C17-7E7C-4663-BBCC-5E607C6543CD}|  
...
||Конструктор отчетов (Microsoft)|{F3A96850-E2AE-4E00-9278-8FE23F225A0D}|  
...
|Поддержка SourceSafe|Visual SourceSafe Provider Package|{AA8EB8CD-7A51-11D0-92C3-00A0C9138C45}|  
...
|Фрагменты кода|Visual Studio Code Snippets Package|{0B680757-2C29-4531-80FA-535A5178AA98}|  
...
|Экспорт шаблона...|Export Template Package|{F1E4CFCA-4573-4345-8718-7BDE2b1F0BE8}|  
  
 Некоторые пакеты не следует удалять, так как многие другие возможности принимать зависимости от их. Например перечисленных в разделе «Основные IDE» не следует удалять.  
  
 Некоторые функции не может быть полностью удален. Например, не найден пакет, который можно отменить регистрацию для удаления **представление классов** и его связанные меню, параметры и служб. **Представление классов** окна обеспечивается пакета среды Visual Studio, который также предоставляют другие ключевые функции интегрированной среды разработки. Если вы хотите удалить **представление классов**, необходимо также удалить **поиск и замена**, среды **параметры** страниц, **командное окно**и **вывода** окна.
