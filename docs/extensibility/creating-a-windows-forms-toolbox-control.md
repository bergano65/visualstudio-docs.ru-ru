...
2. После открытия проекта добавьте Windows Forms шаблон элемента **элемента управления панели элементов** с именем `Counter` . В **Обозреватель решений**выберите и удерживайте (или щелкните правой кнопкой мыши) узел проекта и выберите команду **Добавить**  >  **новый элемент**. В диалоговом окне **Добавление нового элемента** перейдите в раздел расширяемость **Visual C#**  >  **Extensibility** и выберите **Windows Forms элемент управления панели элементов** .
...
1. В **Обозреватель решений**дважды нажмите или дважды щелкните *Counter.CS* , чтобы открыть его в конструкторе.
...
1. Дважды коснитесь или дважды щелкните форму, чтобы открыть обработчик событий Load в окне кода.
...
7. Вернитесь в режим конструктора и дважды коснитесь или дважды щелкните кнопку **Сброс** , чтобы создать `btnReset_Click` обработчик событий. Затем заполните его, как показано в следующем примере.
...
3. В **Обозреватель решений**дважды коснитесь или дважды щелкните *Form1.CS* , чтобы открыть его в конструкторе, если он еще не открыт.
...
8. Дважды коснитесь или дважды щелкните кнопку, чтобы открыть *Form1.CS* в представлении кода и создать обработчик щелчка.
