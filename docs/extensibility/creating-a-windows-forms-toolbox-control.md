...
5. В окне **Свойства** задайте следующие значения для элементов управления в области конструктора.
    ...
    |Элемент Control|Свойство|Значение|
    |-------------|--------------|-----------|
    |`Label1`|**Текстовые**|""|
    |`Button1`|**Name**|бтнресет|
    |`Button1`|**Текстовые**|Reset|
...
7. Вернитесь в режим конструктора и дважды щелкните кнопку **Сброс** , чтобы создать `btnReset_Click` обработчик событий, а затем заполните его, как показано в следующем примере.
