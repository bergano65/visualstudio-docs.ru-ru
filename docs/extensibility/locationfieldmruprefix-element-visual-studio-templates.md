---
title: Элемент LocationFieldMRUPrefix (шаблоны Visual Studio) | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-general
...
Указывает недавно использовавшихся (файлов MRU) пути в **новый проект** и **Добавление нового элемента** диалоговое окно.  
