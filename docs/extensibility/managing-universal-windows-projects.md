...
4.  Теперь попробуйте все в деле. Нажмите клавишу **F5** запустить экспериментальный экземпляр. Создайте проект приложения универсальной концентратора C# в экспериментальном экземпляре (в **новый проект** диалоговом окне **Visual C#** > **Windows**  >   **Windows 8** > **универсальной** > **приложение центра**) перейдите к **средства** меню и выберите пункт **Invoke TestUniversalProject**, а затем проверить текст в **вывода** области. Вы должны увидеть примерно следующее:  
