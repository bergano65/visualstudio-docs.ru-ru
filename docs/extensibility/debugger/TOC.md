...
# [Примеры отладки Visual Studio](visual-studio-debugging-samples.md)
...
### [Анализ выражений (пакет SDK для отладки Visual Studio)](expression-evaluation-visual-studio-debugging-sdk.md)
### [События элементов управления](control-events.md)
## [Отправка событий](sending-events.md)
### [Источники событий (пакет SDK для Visual Studio)](event-sources-visual-studio-sdk.md)
...
### [Обработка исключений (пакет SDK для Visual Studio)](exception-handling-visual-studio-sdk.md)
## [Практическое руководство. Отладка пользовательского модуля отладки](how-to-debug-a-custom-debug-engine.md)
# [Приступая к работе с расширением отладчика](getting-started-with-debugger-extensibility.md)
...
### [Серверы (пакет SDK для Visual Studio)](servers-visual-studio-sdk.md)
...
### [Модули](modules.md)
### [Точки останова (пакет SDK для Visual Studio)](breakpoints-visual-studio-sdk.md)
...
# [Запись вычислителя выражений среды CLR](writing-a-common-language-runtime-expression-evaluator.md)
...
## [Внутренние элементы: класс Task](task-class-internal-members.md)
...
## [Внутренние элементы: класс TaskScheduler](taskscheduler-class-internal-members.md)
...
## [Внутренние элементы: класс ContingentProperties](contingentproperties-class-internal-members.md)
### [Поля m_children](m-children-field.md)
## [Внутренние элементы: структура AsyncTaskMethodBuilder](asynctaskmethodbuilder-structure-internal-members.md)
### [Свойство AsyncTaskMethodBuilder.ObjectIdForDebugger](asynctaskmethodbuilder-objectidfordebugger-property.md)
### [Поле AsyncTaskMethodBuilder.m_builder](asynctaskmethodbuilder-m-builder-field.md)
## Внутренние элементы: структура [AsyncTaskMethodBuilder<TResult>](asynctaskmethodbuilder-tresult-structure-internal-members.md)
### Свойство [AsyncTaskMethodBuilder<TResult>.ObjectIdForDebugger](asynctaskmethodbuilder-tresult-objectidfordebugger-property.md)
### Поле [AsyncTaskMethodBuilder<TResult>.m_task](asynctaskmethodbuilder-tresult-m-task-field.md)
## [Внутренние элементы: структура AsyncVoidMethodBuilder](asyncvoidmethodbuilder-structure-internal-members.md)
### [Свойство AsyncVoidMethodBuilder.ObjectIdForDebugger](asyncvoidmethodbuilder-objectidfordebugger-property.md)
### [Поле AsyncVoidMethodBuilder.m_objectIdForDebugger](asyncvoidmethodbuilder-m-objectidfordebugger-field.md)
