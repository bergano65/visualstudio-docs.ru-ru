...
Возвращает указанный процесс, работающий с портом.  
...
#### <a name="parameters"></a>Параметры  
 `ProcessId`  
 [in] [AD_PROCESS_ID](../../../extensibility/debugger/reference/ad-process-id.md) структура, которая указывает идентификатор процесса.  
