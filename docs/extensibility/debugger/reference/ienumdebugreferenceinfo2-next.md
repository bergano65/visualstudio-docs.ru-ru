---
title: IEnumDebugReferenceInfo2::Следующий Документы Майкрософт
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
(в, вне) Массив [DEBUG_REFERENCE_INFO](../../../extensibility/debugger/reference/debug-reference-info.md) элементов, которые должны быть заполнены.
