---
title: IEnumCodePaths2::Следующий Документы Майкрософт
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
(в, вне) Массив [элементов CODE_PATH,](../../../extensibility/debugger/reference/code-path.md) которые должны быть заполнены.
