---
title: IEnumDebugFields::Next | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
#### <a name="parameters"></a>Параметры  
 ...
 `rgelt`  
 [in, out] Массив [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) элементы, которые должны заполняться в.  
