# [Справочник (API-интерфейсы отладки Visual Studio)](reference-visual-studio-debugging-apis.md)
...
### [Перечисления (отладка Visual Studio)](enumerations-visual-studio-debugging.md)
