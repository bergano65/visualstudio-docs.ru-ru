---
title: IDebugComPlusSymbolProvider::GetAttributedClassesForLanguage Документы Майкрософт
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`guidLanguage`\
(в) Уникальный идентификатор для языка.

`pstrAttribute`\
(в) Строка атрибута.

`ppEnum`\
(ваут) Возвращает перечисление классов атрибутов.
