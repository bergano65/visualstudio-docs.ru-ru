---
title: IdebugComplussymbolprovider::GetaddressesinModuleFromposition Документы Майкрософт
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
ms.locfileid: "80734032"
---
# <a name="idebugcomplussymbolprovidergetaddressesinmodulefromposition"></a>IDebugComPlusSymbolProvider::GetAddressesInModuleFromPosition
Отображает положение документа в указанном модуле с массивом адресов отладки.
...
`fStatmentOnly`\
(в) Если `TRUE`адреса отладки ограничены одной выпиской.

`ppEnumBegAddresses`\
(ваут) Возвращает регистратор для начальных отладить адреса, связанные с этой выпиской или строкой.

`ppEnumEndAddresses`\
(ваут) Возвращает регистратор для адресов окончания отладки, связанных с этой выпиской или строкой.
