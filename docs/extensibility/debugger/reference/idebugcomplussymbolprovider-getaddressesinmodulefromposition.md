...
#### <a name="parameters"></a>Параметры  
 ...
 `fStatmentOnly`  
 [in] Если `TRUE`, ограничивает адреса отладки в одной инструкции.  
  
 `ppEnumBegAddresses`  
 [out] Возвращает перечислитель для начала отладки адресов, связанных с этой инструкции или строке.  
  
 `ppEnumEndAddresses`  
 [out] Возвращает перечислитель для конечного адреса отладки, связанные с этой инструкции или строке.  
