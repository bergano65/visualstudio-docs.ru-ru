...
## <a name="notes-for-implementers"></a>Примечания для разработчиков  
 Реализуется отладчики и используемые [!INCLUDE[vsprvs](../../../code-quality/includes/vsprvs_md.md)] отладочный пакет.  
...
## <a name="remarks"></a>Примечания  
 Это необязательный интерфейс, который обычно не обязательно должны быть реализованы.  
