---
title: IEnumDebugFrameInfo2:Следующим Документы Майкрософт
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`rgelt`\
(в, вне) Массив элементов [FRAMEINFO,](../../../extensibility/debugger/reference/frameinfo.md) которые должны быть заполнены.
