...
Извлекает владельца типа или метода данного универсального параметра.  
...
#### Параметры  
 `ppOwner`  
 \[out\] возвращает IDebugField объект, к которому принадлежит универсальный шаблон параметр.  
