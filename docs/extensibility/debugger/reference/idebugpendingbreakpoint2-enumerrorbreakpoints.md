---
title: "IDebugPendingBreakpoint2::EnumErrorBreakpoints | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: f819625accf3982675524b2a6049cccbb36199c5
...
#### <a name="parameters"></a>Параметры  
 `bpErrorType`  
 [in] Сочетание значений из [BP_ERROR_TYPE](../../../extensibility/debugger/reference/bp-error-type.md) перечисления, которое выбирает тип ошибки для перечисления.  
...
## <a name="example"></a>Пример  
 Приведенный ниже показано, как реализовать этот метод для простого `CPendingBreakpoint` объекта, который предоставляет [IDebugPendingBreakpoint2](../../../extensibility/debugger/reference/idebugpendingbreakpoint2.md) интерфейса.  
