---
title: Поле AsyncVoidMethodBuilder.m_objectIdForDebugger | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.reviewer: ''
ms.suite: ''
...
Представляет объект отложенной инициализацией, используемые отладчиком для уникальной идентификации этого конструктора.  
