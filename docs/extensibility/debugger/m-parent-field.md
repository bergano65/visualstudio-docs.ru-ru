---
title: m_parent поле | Документы Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
ms.locfileid: "31099198"
---
# <a name="mparent-field"></a>m_parent поля
Резервное поле для <xref:System.Threading.Tasks.Task?displayProperty=fullName> `Parent` свойство.  
