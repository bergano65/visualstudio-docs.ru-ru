...
3. Реализуйте фабрику редактора, настроив <xref:Microsoft.VisualStudio.Shell.Interop.IVsEditorFactory> интерфейс.
     ...
     Дополнительные сведения см. в разделе [фабрики редактора](../vs-2015/extensibility/editor-factories.md?view=vs-2015&preserve-view=true).
...
12. Реализация поддержки контекстно-зависимой справки.
     ...
     Этот шаг позволяет предоставить справку F1 и поддержку окна динамической справки для элементов в редакторе. Дополнительные сведения см. [в разделе руководство. Предоставление контекста для редакторов](../vs-2015/extensibility/how-to-provide-context-for-editors.md?view=vs-2015&preserve-view=true).
