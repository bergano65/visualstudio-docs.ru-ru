...
1. В строке состояния отображается циклическая анимация, которая указывает на выполнение длительной операции (например, создание нескольких проектов в решении). Если вы не видите эту анимацию, убедитесь, что у вас есть правильные параметры **инструментов**  >  **Options** :
