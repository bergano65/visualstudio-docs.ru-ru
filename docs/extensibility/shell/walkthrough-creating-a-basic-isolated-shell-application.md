...
## <a name="prerequisites"></a>Предварительные требования  
 Для выполнения этого пошагового руководства необходимо установить пакет SDK для Visual Studio. Дополнительные сведения см. в разделе [пакет SDK для Visual Studio](../visual-studio-sdk.md). Чтобы развернуть изолированной оболочки, воспользуйтесь распространяемый пакет оболочки Visual Studio (изолированной).  
...
4.  В **представление > Другие окна**, нажмите кнопку **веб-браузер**. **Веб-браузер** окне отображается домашняя страница корпорации Майкрософт.  
...
> [!NOTE]
>  Возможностей идентификаторы GUID в Visual Studio, см [пакета GUID из функции Visual Studio](package-guids-of-visual-studio-features.md).  
...
4.  Начать отладку приложения и приложения изолированной оболочки откройте **Справка > о** поле. Вы увидите измененных строк. Заголовок Справка/о поле совпадает со значением `AssemblyTitle` значения в файл AssemblyInfo.cs.  
