...
```  
 ...
 Список строки подстановки см. в разделе [использовать строки подстановки в. Pkgdef и. Файлы pkgundef-файлов](substitution-strings-used-in-dot-pkgdef-and-dot-pkgundef-files.md).  
