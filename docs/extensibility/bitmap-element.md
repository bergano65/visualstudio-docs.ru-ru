...
|Атрибут|Описание|  
|---------------|-----------------|  
|guid|Обязательный. Идентификатор GUID идентификатор GUID или идентификатор команды.<br /><br /> Атрибут guid для растрового изображения не связан с любой VSPackage или другие группы команд.  Он должен быть уникальным на определении точечного рисунка и не должны использоваться для других целей.|  
