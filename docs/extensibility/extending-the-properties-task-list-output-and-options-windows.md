...
9. Откройте страницу **Tools**  >  **Параметры** инструментов. На левой панели отобразится категория ToDo. Категории перечислены в алфавитном порядке, поэтому их следует искать в службах терминалов.
...
4. Теперь измените параметр на странице "Параметры" в **меню "Сервис**"  >  **Options**  >  **ToDo** с **2** на **0**.
