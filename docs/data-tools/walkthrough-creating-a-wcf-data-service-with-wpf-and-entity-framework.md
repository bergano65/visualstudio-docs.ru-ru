...
3.  В **имя** текста введите `NorthwindCustomers`, а затем выберите **добавить** кнопки.
     ...
     **NorthwindCustomers.svc** файл появится в **редактор кода**.
...
## <a name="creating-the-client-application"></a>Создание клиентского приложения
 Чтобы создать клиентское приложение, добавить второй проект, добавьте ссылку на службу в проект, настроить источник данных и создать пользовательский интерфейс для отображения данных из службы.
