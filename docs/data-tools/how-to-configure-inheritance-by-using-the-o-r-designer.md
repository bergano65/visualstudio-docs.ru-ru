...
description: Узнайте, как настроить наследование с помощью реляционный конструктор объектов (реляционный конструктор), который поддерживает наследование одной таблицы. Созданы унаследованные классы данных.
