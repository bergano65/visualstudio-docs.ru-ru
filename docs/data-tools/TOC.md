...
### [Практическое руководство. Включение и выключение преобразования во множественную форму (реляционный конструктор объектов)](how-to-turn-pluralization-on-and-off-o-r-designer.md)
...
### [Пошаговое руководство. Создание службы WCF на основе Windows Forms](walkthrough-creating-a-simple-wcf-service-in-windows-forms.md)
