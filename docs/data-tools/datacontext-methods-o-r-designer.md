...
description: Общие сведения о методах DataContext в контексте средств LINQ to SQL для Visual Studio. Эти методы запускают хранимые процедуры и функции в базе данных.
