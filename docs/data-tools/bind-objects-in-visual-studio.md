---
title: Привязка данных пользовательских объектов
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
Хотя существует множество способов реализовать логику приложения при работе с объектами в качестве источника данных, для SQL базы данных существует являются несколько стандартных операций, которые можно упростить с помощью объектов TableAdapter создаются в Visual Studio. Этой странице объясняется, как реализовать эти стандартные процессы, с помощью адаптеров таблиц. Он не предназначен для справки по созданию пользовательских объектов. Например обычно выполняют следующие стандартные операции независимо от конкретной реализации объектов или логикой приложения.
...
### <a name="display-object-data-to-users"></a>Отображение объекта данных для пользователей
...
### <a name="save-data-in-objects-back-to-the-database"></a>Сохранить данные в объектах в базе данных
