...
## <a name="to-add-code-to-datasets-in-n-tier-applications"></a>Чтобы добавить код к наборам данных в n уровневых приложениях
...
- [Средства набора данных в Visual Studio](../data-tools/dataset-tools-in-visual-studio.md)