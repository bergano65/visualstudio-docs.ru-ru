        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения о проектировании, развертывании и обслуживании баз данных с SQL Server Data Tools</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Сведения об использовании Azure Data Lake при разработке приложений для больших данных с помощью U-SQL и .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Сведения о выполнении запросов Hive с помощью Hadoop в Azure HDInsight</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Сведения о разработке решений для больших данных в режиме, близком к реальному времени, с помощью Azure Streaming Analytics</h3>
                    </div>
                </div>
            </div>
        </div>
