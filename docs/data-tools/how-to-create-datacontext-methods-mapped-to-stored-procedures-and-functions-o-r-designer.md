...
description: Научитесь создавать методы DataContext, сопоставленные с хранимыми процедурами (sprocs) и функциями, с помощью реляционный конструктор объектов (реляционный конструктор R).
