...
## <a name="add-a-user-control-to-the-project"></a>Добавьте пользовательский элемент управления в проект.
...
8.  Выберите таблицу `Customers` и нажмите Готово **.
    ...
    Объект NorthwindDataSet**добавляется в проект, и таблица** отображается в окне Источники данных`Customers`.
...
## <a name="add-controls-to-the-form"></a>Добавить к выбранной форме элементы управления.
