---
title: Использование хранимых процедур в LINQ to SQL для обновления данных
description: Используйте хранимые процедуры в LINQ to SQL реляционный конструктор объектов (реляционный конструктор R) для выполнения операций обновления, вставки и удаления данных.
...
- [Операции вставки, обновления и удаления (платформа .NET Framework)](/dotnet/framework/data/adonet/sql/linq/insert-update-and-delete-operations)
