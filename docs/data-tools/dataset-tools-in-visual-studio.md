...
Наборы данных и родственные классы, определенные в <xref:System.Data?displayProperty=fullName> пространства имен в .NET API. Вы можете создавать и изменять наборы данных динамически в коде с помощью ADO.NET. Документация в этом разделе показано, как работать с наборами данных с помощью конструкторов Visual Studio. Наборы данных, которые создаются с помощью конструкторов **TableAdapter** объектов для взаимодействия с базой данных. Наборы данных, которые создаются программно использовать **DataAdapter** объектов. Сведения о создании наборов данных программными средствами, см. в разделе [объекты DataAdapter и DataReader](/dotnet/framework/data/adonet/dataadapters-and-datareaders).
