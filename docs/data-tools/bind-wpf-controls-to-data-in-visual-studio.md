...
description: Привязка элементов управления WPF к данным. Чтобы создать эти элементы управления с привязкой к данным, перетащите элементы из окна Источники данных на конструктор WPF в Visual Studio.
ms.date: 11/04/2016
ms.topic: how-to
helpviewer_keywords:
- data [WPF], displaying
