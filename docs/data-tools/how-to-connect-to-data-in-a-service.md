---
title: Как выполнить подключение к данным в службе
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
ms.locfileid: "53923878"
---
# <a name="how-to-connect-to-data-in-a-service"></a>Как выполнить Подключение к данным в службе
