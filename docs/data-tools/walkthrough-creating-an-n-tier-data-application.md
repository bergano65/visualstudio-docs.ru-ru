...
-   Написание кода для заполнения таблиц данных.  
 ...
 ![ссылка на видео](../data-tools/media/playvideo.png "PlayVideo") Видеоверсию этого раздела см. на странице [Видео: создание N\-уровневого приложения для работы с данными](http://go.microsoft.com/fwlink/?LinkId=115188).  
