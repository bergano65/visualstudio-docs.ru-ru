...
ms.locfileid: "99867442"
---
# <a name="add-new-data-sources"></a>Добавление новых источников данных

:::moniker range="vs-2019"
> [!NOTE]
> Функции, описанные в этой статье, применимы к платформа .NET Framework Windows Forms и разработке WPF. В Visual Studio 2019 (и предыдущих версиях) функции не поддерживаются для разработки .NET Core, как для WPF, так и для Windows Forms.
:::moniker-end
