...
description: Создание таблиц подстановок в приложениях WPF. Таблица подстановки — это элемент управления, отображающий данные из таблицы данных на основе значения поля внешнего ключа в другой таблице.
