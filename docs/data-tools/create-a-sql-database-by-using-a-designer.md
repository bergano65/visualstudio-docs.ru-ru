---
title: "Создание файла базы данных и использование конструктора таблиц в Visual Studio | Документы Microsoft"
ms.custom: 
ms.date: 11/03/2017
ms.reviewer: 
ms.suite: 
...
11. Один **Выбор объектов базы данных** страницы, появится сообщение об ошибке базы данных не содержит все объекты. Выберите **Готово**.
