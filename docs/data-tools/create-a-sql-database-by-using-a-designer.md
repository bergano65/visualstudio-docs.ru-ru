...
Для выполнения этого пошагового руководства, необходимо иметь необязательный **хранение и обработка данных** рабочей нагрузки, установленная в Visual Studio. Чтобы установить его, откройте **установщик Visual Studio** и выберите **изменить** или **дополнительные** > **изменить** рядом с версии Visual Studio, которое вы хотите изменить.

::: moniker range=">=vs-2019"

На **рабочих нагрузок** в списке **другие наборы инструментов**, выберите **хранение и обработка данных**, а затем нажмите кнопку **изменить** добавить рабочую нагрузку для Visual Studio.

::: moniker-end

::: moniker range="=vs-2017"

На **рабочих нагрузок** в списке **Интернет и облако**, выберите **хранение и обработка данных**, а затем нажмите кнопку **изменить** добавить рабочую нагрузку для Visual Studio.
