...
|[Практическое руководство. Сохранение данных с помощью транзакции](../data-tools/save-data-by-using-a-transaction.md)|Как сохранить данные в транзакции в системе. Transactions-пространство имен и объект TransactionScope|
...
- После отправки изменений набора данных к другому процессу, например к веб-службе XML.
