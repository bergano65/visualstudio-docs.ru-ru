...
[Платформа искусственного интеллекта майкрософт](https://azure.microsoft.com/overview/ai-platform/?v=17.42w) &mdash;Provides введение в интеллектуальное облако Майкрософт, включая Кортану Analytics Suite и поддержку "Интернет вещей".

[Служба хранилища Microsoft Azure](/azure/storage/) &mdash;Describes хранилище Azure и создание приложений с помощью больших двоичных объектов, таблиц, очередей и файлов Azure.

[База данных SQL azure](/azure/sql-database/) &mdash;Describes как подключиться к базе данных SQL Azure, реляционной базе данных как к службе.

[SQL Server Data Tools](/sql/ssdt/download-sql-server-data-tools-ssdt) &mdash;Describes средства, упрощающие проектирование, изучение, тестирование и развертывание приложений и баз данных, подключенных к данным.
...
[LINQ (интегрированный в язык запрос)](/dotnet/csharp/linq/) &mdash;Describes возможности запросов, встроенные в C# и Visual Basic, и общую модель для запросов к реляционным базам данных, XML-документам, наборам данных и коллекциям в памяти.

[Средства XML в Visual Studio](../xml-tools/xml-tools-in-visual-studio.md) &mdash;Discusses работе с XML-данными, отладкой XSLT, функциями XML .NET и АРХИТЕКТУРОЙ XML-запросов.

[XML-документы и данные](/dotnet/standard/data/xml/index) &mdash;Provides обзор полного и интегрированного набора классов, работающих с XML-документами и данными в .NET.
