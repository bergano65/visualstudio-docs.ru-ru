...
### <a name="wcf-programming-model"></a>Модель программирования WCF
 Модель программирования WCF основана на связи между двумя сущностями: службы WCF и клиент WCF. Модель программирования инкапсулируется в <xref:System.ServiceModel> пространства имен в [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)].
...
При добавлении в проект ссылки на службу в локальном проекте создаются все типы, заданные в службе. Во многих случаях это создает повторяющиеся типы Если служба использует Общие [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] типы или типы заданы в общей библиотеке.
