...
ms.locfileid: "37089034"
---
# <a name="n-tier-data-applications-overview"></a>Общие сведения о данных в N-уровневых приложениях
...
*Уровень данных* представляет собой сервер, на котором хранятся данные приложения (например, сервер под управлением [!INCLUDE[ssNoVersion](../data-tools/includes/ssnoversion_md.md)]).
