...
1. Выберите Microsoft Edge или Chrome в качестве текущего целевого объекта отладки.
    ...
    ::: moniker range=">=vs-2019"
    Если Chrome установлен на вашем компьютере, но отсутствует в списке, выберите **Web Browser (browsername)** (Веб-браузер (название браузера)) > **Select Web Browser** (Выбрать веб-браузер) в раскрывающемся списке целевых объектов отладки, а затем установите **Chrome** в качестве целевого браузера по умолчанию.
    ::: moniker-end
    ::: moniker range="vs-2017"
    Если Chrome установлен на вашем компьютере, но отсутствует в списке, выберите**Web Browser (browsername)** (Веб-браузер (название браузера)) > **Google Chrome** в раскрывающемся списке целевых объектов отладки, а затем установите **Chrome** в качестве целевого браузера по умолчанию.
    ::: moniker-end
