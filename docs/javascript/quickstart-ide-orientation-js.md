...
[![](media/vs-2019/start-window.png "Окно запуска в Visual Studio 2019")](media/vs-2019/start-window.png)
...
1. В **окне запуска** выберите **Создать новый проект** и в поле поиска введите **javascript**, чтобы отфильтровать список и вывести только типы проектов, содержащих "javascript" в имени или типе языка.
