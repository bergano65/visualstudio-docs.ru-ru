...
|/productName|Нет|Задает имя продукта для удаляемых книг. Имя продукта определяется файлом *helpcontentsetup.msha* или *books.html*, поставляемым вместе с содержимым. Можно удалить книги только из одного продукта за раз. Чтобы удалить книги из нескольких продуктов, необходимо выполнить несколько установок.|
