...
|Панель инструментов|**CTRL** + **Г**|Добавление текущего раздела на вкладку **Избранное**|
...
|Содержимое, индекс и поиск|**CTRL** + **Г**|Добавление указанного раздела на вкладку **Избранное**|
...
|Поиск|**SHIFT** + **Введите**|Перевод фокуса на предыдущий элемент|
