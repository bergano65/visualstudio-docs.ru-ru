...
После создания проекта рабочего процесса с помощью средства [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] прежних версий, предоставленного средой [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)], который ориентируется на работу с [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] или [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)], в проект можно добавлять элементы [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)] и другие знакомые элементы [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
