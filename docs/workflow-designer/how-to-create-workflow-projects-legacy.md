...
Выполните следующие шаги для создания проекта [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)], ориентированного на [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] или [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)]. В этой процедуре используется средство [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] более ранней версии, поставляемое вместе с [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)].  
