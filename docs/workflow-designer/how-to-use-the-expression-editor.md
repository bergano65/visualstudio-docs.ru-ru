---
title: 'Конструктор рабочих процессов - способов: с помощью редактора выражений'
ms.date: 11/04/2016
ms.topic: conceptual
...
> [!NOTE]
> Технология IntelliSense для редактора выражений доступна только внутри Visual Studio 2010. В Visual Studio 2010 и сценариях с повторным размещением компилятор проверяет выражение после ввода, а редактор выражений показывает значок ошибки, если выражение является недопустимым.

## <a name="use-the-expression-editor"></a>С помощью редактора выражений

1.  В Visual Studio 2010 откройте проект нового или существующего рабочего процесса.
