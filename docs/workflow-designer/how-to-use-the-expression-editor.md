---
title: Конструктор рабочих процессов. использовать редактор выражений
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
3. Щелкните редактор выражений в конструкторе операций для действия <xref:System.Activities.Statements.Assign>.
     ...
     Строки серого водяного знака **\<To >** и **\<Enter выражение VB >** являются текстовыми строками по умолчанию для редакторов выражений в действии <xref:System.Activities.Statements.Assign>.
