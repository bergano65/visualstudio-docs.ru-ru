---
title: Диалоговое окно "Обзор и выбор типа .NET"
description: Узнайте, как можно использовать диалоговое окно Обзор и выбор типа .NET, чтобы выбрать тип из древовидного представления сборок и проектов в конструктор рабочих процессов.
