...
description: Сведения о конструкторах действий блок-схемы, которые содержат предоставляемые системой действия, которые можно использовать для управления блоками-схемами в рабочем процессе.
