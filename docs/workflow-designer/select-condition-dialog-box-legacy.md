...
|**ХОРОШО**|Щелкните, чтобы назначить выбранное условие правила условию действия.|  
 ...
 Дополнительные сведения о создании и изменении условий для правил см. в разделе [условие редактора диалогового окна правила (для прежних версий)](../workflow-designer/rule-condition-editor-dialog-box-legacy.md).  
...
## <a name="see-also"></a>См. также  
 ...
 [Использование действия у операции WhileActivity](http://go.microsoft.com/fwlink?LinkID=65091)   
