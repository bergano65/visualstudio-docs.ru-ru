---
title: "Как изменить вариант пошаговой отладки (для прежних версий) | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
ms.topic: "reference"
helpviewer_keywords: 
  - "пошаговое выполнение ветви"
  - "отладка рабочих процессов, параметры пошагового выполнения"
  - "отладка, параметры пошагового выполнения"
  - "пошаговое выполнение экземпляра"
  - "пошаговое выполнение, изменение параметров"
...
manager: "erikre"
---
# Как изменить вариант пошаговой отладки (для прежних версий)
В этом разделе описывается изменение варианта пошаговой отладки для приложений [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)] прежних версий [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] с параллельными действиями.[!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)] прежних версий используется при создании приложений для [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] или [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)].  
 ...
 При отладке действий прежних версий, которые выполняются параллельно, например действия **ParallelActivity** или **ConditionedActivityGroup**, можно использовать один из двух вариантов для пошаговой проверки кода.  
  
 Выполните следующие действия, чтобы изменить вариант пошаговой отладки в проекте рабочего процесса прежних версий.  
  
## Процедуры  
  
#### Изменение варианта пошаговой отладки  
...
3.  В меню **Рабочий процесс** в [!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)] прежних версий укажите пункт **Отладка** и пункт **Варианты пошаговой отладки**.  
  
4.  Выберите вариант **Экземпляр** или **Ветвь**.  
