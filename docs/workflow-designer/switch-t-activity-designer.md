...
**Switch < T\>**  конструктора действий используется для создания и настройки <xref:System.Activities.Statements.Switch%601> действие в конструкторе рабочих процессов.
...
Доступ **коммутатора\<T >** конструктора действий в **поток управления** категории **элементов**. После его перетаскивания в конструкторе рабочих процессов, он отображает **Выбор типов** диалогового окна, чтобы позволить пользователю указать универсальный тип *T* используется в <xref:System.Activities.Statements.Switch%601> действия. Значение по умолчанию — **Int32**. Как только универсальный тип *T* был выбран, **Switch < T\>**  добавляется в конструкторе рабочих процессов.
...
- Выбор вариантов, щелкните правой кнопкой мыши отображается контекстное меню и выберите **удалить**.
