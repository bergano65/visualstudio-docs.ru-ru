...
description: Узнайте, как можно использовать конструктор действий InitializeCorrelation для создания и настройки действия InitializeCorrelation.
