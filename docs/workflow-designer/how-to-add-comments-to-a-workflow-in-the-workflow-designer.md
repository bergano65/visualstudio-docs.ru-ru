...
description: Узнайте, как .NET Framework 4,5 позволяет разработчику добавлять заметки к определенным типам элементов в конструкторе, например действия, состояния и элементы перехода.
...
Чтобы упростить создание больших и сложных рабочих процессов, .NET Framework 4,5 позволяет разработчику добавлять заметки к следующим типам элементов в конструкторе:
