...
3.  На элементе появится значок заметки. Если навести курсор мыши на значок заметки, отобразится текст заметки.  
     ...
     ![Последовательность действий, примечанием](../debugger/debug-interface-access/annotation.md "заметки")  
...
3.  Для отображения заметки за пределами конструктора действий, наведите указатель мыши на область заметки в конструкторе действия и нажмите кнопку **открепить** значок  
...
3.  Для отображения всех заметок вне конструкторов действий, щелкните правой кнопкой мыши действие и выберите **заметки**, **скрыть все заметки**.  
