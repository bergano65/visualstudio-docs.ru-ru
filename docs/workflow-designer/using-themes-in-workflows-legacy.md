---
title: "Использование тем в рабочих процессах (для прежних версий) | Документы Microsoft"
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
- workflows, themes
...
В этом разделе описывается использование тем в [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)] при использовании в конструкторе рабочих процессов прежних версий Windows, предназначенного [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] или [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)].
