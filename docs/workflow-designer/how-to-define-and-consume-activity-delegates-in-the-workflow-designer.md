...
10. В браузере типов введите **действия ActivityAction** в поле **имя типа** . Выберите **действия activityaction \<T >** в представлении в виде дерева. Выберите **объект** в раскрывающемся списке, в котором будет присвоено значение type **действия ActivityAction \<Object >** аргументу.
