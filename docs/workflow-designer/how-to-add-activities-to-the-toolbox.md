...
3. Выполните построение проекта. Если сборка прошла успешно, отобразится новая категория на **панели элементов** с именем "\<*имя проекта*>" с настраиваемым действием, включенным в эту категорию.
...
2. Выполните построение обоих проектов. Если сборки были выполнены успешно, отобразится новая категория на **панели элементов** с именем "\<*имя проекта*>" с настраиваемым действием, включенным в эту категорию.
