...
3. Постройте проект. Если сборка прошла успешно, отобразится новая категория на **панели элементов** с именем "\<*имя проекта*>" с настраиваемым действием, включенным в эту категорию.
