...
description: Узнайте о конструкторе Инвокеделегате и о том, как можно использовать конструктор Инвокеделегате для создания и настройки действия Инвокеделегате.
