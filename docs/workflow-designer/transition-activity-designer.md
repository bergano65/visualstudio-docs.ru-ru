---
title: Конструктор рабочих процессов - конструктор действий переходов
ms.date: 11/04/2016
ms.topic: reference
