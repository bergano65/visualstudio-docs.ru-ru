---
title: Конструктор рабочих процессов - в конструкторе рабочих процессов прежних версий состояния компьютера
ms.date: 11/04/2016
ms.topic: conceptual
