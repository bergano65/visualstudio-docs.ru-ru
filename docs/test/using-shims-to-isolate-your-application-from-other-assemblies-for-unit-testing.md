---
title: "Использование оболочек совместимости для изоляции приложения от других сборок при модульном тестировании | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
-   Visual Studio Enterprise  
 ...
 См. [Видео \(1:16\): тестирование нетестируемого кода с помощью Fakes в Visual Studio 2012](http://go.microsoft.com/fwlink/?LinkId=261837)  
...
-   [Добавление сборок имитаций](#AddFakes)  
...
-   [Привязка интерфейсов](../test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md#BKMK_Binding_interfaces)  
 ...
 [Параллельность](../test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md#BKMK_Concurrency)  
...
###  <a name="AddFakes"></a> Добавление сборок имитаций  
...
###  <a name="WriteShims"></a> Создание теста с оболочками  
 В коде теста вставьте *обход* для метода, который требуется подменить.  Пример:  
...
###  <a name="BKMK_Private_methods"></a> Закрытые методы  
 Генератор кода Fakes создает свойства оболочки совместимости для закрытых методов, которые имеют только видимые типы в сигнатуре, например  видимые типы параметров и возвращаемого значения.  
...
##  <a name="BKMK_Concurrency"></a> Параллельность  
...
## См. также  
 ...
 [Peter Provost’s blog: Visual Studio 2012 Shims  \(Блог Питера Провоста: оболочки совместимости Visual Studio 2012\)](http://www.peterprovost.org/blog/2012/04/25/visual-studio-11-fakes-part-2)   
 [Видео \(1:16\): тестирование нетестируемого кода с помощью Fakes в Visual Studio 2012](http://go.microsoft.com/fwlink/?LinkId=261837)