---
title: Добавление контекстных параметров к параметрам запуска нагрузочного теста в Visual Studio | Документы Майкрософт
ms.date: 10/19/2016
ms.topic: article
helpviewer_keywords:
...
5.  Повторите шаги 3–5, чтобы использовать другую строку для свойства **Значение** (например, http://корпоративный_рабочий_веб-сервер) (необязательно).
