---
title: Анализ действий виртуальных пользователей во время нагрузочного теста в Visual Studio | Документы Майкрософт
ms.date: 10/03/2016
ms.topic: article
f1_keywords:
...
**Диаграмма активности виртуальных пользователей**
 ...
 ![Диаграмма активности виртуальных пользователей](../test/media/virtual_actchart.png "Virtual_ActChart")
...
> [!NOTE]
> Перед запуском нагрузочного теста, в котором планируется использовать диаграмму активности виртуальных пользователей, необходимо проверить, задано ли для свойства **Хранилище сведений о синхронизации** в редакторе тестовой нагрузки задано значение **Все индивидуальные сведения**. Дополнительные сведения см. в статье [Практическое руководство. Настройка сбора полных сведений для отображения информации об активности виртуальных пользователей](../test/how-to-configure-load-tests-to-collect-full-details.md).
...
|-----------|-----------------------|
|**Настройка нагрузочного теста для использования диаграммы активности виртуальных пользователей**. Перед запуском нагрузочного теста, для которого требуется просмотреть сведения о действиях виртуальных пользователей, необходимо сначала настроить параметры свойств нагрузочных тестов.|-   [Практическое руководство. Настройка сбора полных сведений для отображения информации об активности виртуальных пользователей](../test/how-to-configure-load-tests-to-collect-full-details.md)|
|**Выполнение нагрузочного теста**. После того как нагрузочный тест создан и настроен для сбора сведений о действиях виртуальных пользователей, необходимо запустить нагрузочный тест и дождаться его завершения, чтобы можно было просмотреть диаграмму активности виртуальных пользователей.||
