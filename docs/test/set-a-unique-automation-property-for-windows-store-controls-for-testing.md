---
title: Назначение уникального свойства автоматизации элементам управления универсальной платформы Windows для тестирования в Visual Studio | Документы Майкрософт
ms.date: 11/04/2016
