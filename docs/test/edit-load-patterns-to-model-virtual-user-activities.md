...
|-----------|-----------------------|
|**Задание начального шаблона нагрузки для нагрузочного теста**. При создании нагрузочного теста с помощью мастера тестовой нагрузки вы выбираете шаблон нагрузки.|-   [Изменение шаблона нагрузки](../test/edit-load-patterns-to-model-virtual-user-activities.md#changing-the-load-pattern)|
