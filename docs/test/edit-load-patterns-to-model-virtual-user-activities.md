...
> [!NOTE]
> Для программного изменения свойств нагрузки служит подключаемый модуль нагрузочного теста. Дополнительные сведения см. в разделе [Как Создание подключаемого модуля нагрузочных тестов](../test/how-to-create-a-load-test-plug-in.md).
