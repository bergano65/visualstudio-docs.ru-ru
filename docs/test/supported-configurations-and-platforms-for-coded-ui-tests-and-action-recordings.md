---
title: Конфигурации и платформы для закодированных тестов пользовательского интерфейса в Visual Studio | Документы Майкрософт
ms.date: 2015-10-04
...
|Пограничный случай|Запись этапов действий и просмотр свойств объектов с помощью построителя не поддерживаются. Тесты можно воспроизводить в браузере Microsoft Edge при использовании Visual Studio 2015 с обновлением 2 или более поздней версии с помощью [расширения для проведения кроссбраузерных закодированных тестов пользовательского интерфейса](https://visualstudiogallery.msdn.microsoft.com/11cfc881-f8c9-4f96-b303-a2780156628d).|
