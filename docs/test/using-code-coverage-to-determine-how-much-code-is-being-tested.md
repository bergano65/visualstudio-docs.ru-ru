...
2. Чтобы после выполнения тестов увидеть, какие строки были выполнены, щелкните ![значок "Цвета отображения покрытия кода"](../test/media/codecoverage-showcoloringicon.png) **Цвета отображения покрытия кода** в окне **Результаты покрытия кода**. По умолчанию код, охватываемый тестами, выделяется голубым цветом.
