...
2.  Чтобы увидеть, какие строки были выполнены, выберите ![значок цветов отображения покрытия кода](~/docs/test/media/codecoverage-showcoloringicon.png "CodeCoverage-ShowColoringIcon")**Цвета отображения покрытия кода**.  
...
2.  На странице **Процесс** разверните **Автоматизированные тесты**, **Исходный код теста**, **Параметры запуска**. Задайте для параметра **Тип файла параметров запуска** значение **Оценка объемов протестированного кода включена**.  
 ...
 ![Задание определения сборки для объема протестированного кода](~/docs/test/media/codecoverage-plaincc.png "CodeCoverage-plainCC")  
