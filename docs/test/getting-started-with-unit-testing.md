...
1. В строке меню выберите **Инструменты** > **Расширения и обновления**.

2. В диалоговом окне **Расширения и обновления** разверните категорию **В сети** и выберите пункт **Visual Studio Marketplace**. Затем выберите **Средства** > **Тестирование**.
...
2. В диалоговом окне **Управление расширениями** разверните категорию **В сети** и выберите пункт **Visual Studio Marketplace**. Затем выберите **Средства** > **Тестирование**.

   ![Visual Studio Marketplace](media/extensions-and-updates-testing.png)

::: moniker-end

3. Выберите платформу или адаптер, которые нужно установить, и нажмите **Скачать**.

4. Создайте проект библиотеки классов и добавьте его в решение.

   ![Присвоение имени проекту для библиотеки классов и его добавление](media/create3rdpartyunittest3.png)

5. Установите подключаемый модуль. В **обозревателе решений** выберите проект библиотеки классов, а затем в его контекстном меню выберите пункт **Управление пакетами NuGet**.
...
6. В окне **Диспетчер пакетов NuGet** выполните поиск и выберите подключаемый модуль, после чего нажмите **Установить**.
...
7. В узле **Ссылки** проекта библиотеки классов выберите **Добавить ссылку**.

   ![Добавление ссылки на проект](media/createunittest6.png)

8. В диалоговом окне **Диспетчер ссылок** выберите проект, содержащий тестируемый код.

   ![Выбор проекта кода для проверки](media/createunittest7.png)

9. Напишите код модульного теста.
