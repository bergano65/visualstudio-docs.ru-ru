...
### [Тестирование приложений Магазина Windows 8.1 с помощью закодированных тестов пользовательского интерфейса](test-windows-store-8-1-apps-with-coded-ui-tests.md)
### [Тестирование приложений Windows Phone 8.1 с помощью закодированных тестов пользовательского интерфейса](test-windows-phone-8-1-apps-with-coded-ui-tests.md)
...
## [Анализ качества приложения](../code-quality)
