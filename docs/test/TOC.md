...
#### [Написание модульных тестов для библиотек DLL на C/C++](how-to-write-unit-tests-for-cpp-dlls.md)
...
## [Тестирование приложений UWP в Visual Studio](testing-store-apps-with-visual-studio.md)
### [Создание и запуск модульных тестов для приложений UWP в Visual Studio](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
...
#### [Модульное тестирование приложений UWP в Visual Studio](run-unit-tests-for-store-apps-in-visual-studio.md)
### [Анализ качества кода приложений UWP с помощью функций анализа статического кода Visual Studio](analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
#### [Анализ качества кода Visual Basic и C# в приложениях UWP с помощью функций анализа статического кода Visual Studio](analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md)
#### [Анализ качества кода C++ в приложениях UWP с помощью функций анализа статического кода Visual Studio](analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
