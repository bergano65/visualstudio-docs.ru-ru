...
Для обнаружения "узких мест", определения ошибок и оценки улучшений в работе приложения можно использовать **анализатор тестовой нагрузки**. Анализ результатов нагрузочных тестов осуществляется следующими способами.
