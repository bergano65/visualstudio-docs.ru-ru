...
Инструмент IntelliTest находит входные данные, относящиеся к тестируемой программе, поэтому его можно использовать для создания всем известной строки **Hello World** string. Здесь предполагается, что вы создали проект тестов C# на основе MSTest и добавили ссылку на **Microsoft.Pex.Framework**. При использовании другой платформы тестирования создайте библиотеку классов C# и прочитайте о настройке проекта в документации к этой платформе тестирования.
