...
ms.locfileid: "62950295"
---
# <a name="how-to-add-custom-counter-sets-using-the-load-test-editor"></a>Как выполнить Добавление пользовательских наборов счетчиков с помощью редактора тестовой нагрузки
