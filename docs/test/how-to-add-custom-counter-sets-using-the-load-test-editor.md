...
4. Чтобы добавить счетчики в пользовательский набор, щелкните правой кнопкой мыши новый набор счетчиков и выберите команду **Добавить счетчики**. Дополнительные сведения о добавлении счетчиков см. в статье [Практическое руководство. Добавление счетчиков в наборы счетчиков с помощью редактора тестовой нагрузки](../test/how-to-add-counters-to-counter-sets-using-the-load-test-editor.md).
