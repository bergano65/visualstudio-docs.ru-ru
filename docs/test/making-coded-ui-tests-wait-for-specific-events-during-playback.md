---
title: Настройка закодированного теста пользовательского интерфейса в Visual Studio таким образом, чтобы он дожидался определенных событий | Документы Майкрософт
ms.date: 11/04/2016
