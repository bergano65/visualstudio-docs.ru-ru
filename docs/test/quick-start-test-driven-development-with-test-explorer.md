---
title: Разработка на основе тестирования с использованием обозревателя тестов в Visual Studio
ms.date: 11/04/2016
...
1.  Создайте модульные тесты, которые используют выбранные тестовые среды.
    ...
    1.  Создайте тестовый проект.
         ...
         В диалоговом окне **Новый проект** разверните узел **Visual Basic** > **Visual C#** или **Visual C++**, а затем выберите **Тест**.
...
2.  Создайте тестовый проект.
    ...
    -   В диалоговом окне **Новый проект** выберите **Visual C#** > **Тест**, а затем выберите **Проект модульного теста**.
