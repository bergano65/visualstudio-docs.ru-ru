...
|-------|----------------------|-----------------|
| Определите компьютеры, где требуется развернуть сборку и выполнить тесты. | Создайте в Microsoft Test Manager стандартную лабораторную среду с этими компьютерами. | Недоступно |
