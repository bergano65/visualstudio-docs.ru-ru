---
title: Настройка модульных тестов в Visual Studio с помощью файла RUNSETTINGS
ms.date: 02/28/2018
...
Для настройки любого другого типа адаптера диагностических данных нужно использовать [файл параметров тестирования](../test/collect-diagnostic-information-using-test-settings.md).
