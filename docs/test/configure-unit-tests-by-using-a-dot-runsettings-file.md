...
>   
>  Существует два вида типов файлов для настройки тестов. RUNSETTINGS-файлы используются для модульных тестов. А \*TESTSETTINGS-файлы применяются для [тестирования в лабораторной среде](/devops-test-docs/test/specifying-test-settings-for-visual-studio-tests), тестов веб-производительности и нагрузки, а также для настройки некоторых типов адаптеров диагностических данных, таких как Intellitrace и адаптеры журналов событий.  
>   
