...
ms.locfileid: "66747242"
---
# <a name="how-to-create-an-add-in-for-the-web-performance-test-results-viewer"></a>Практическое руководство. Создание надстройки для просмотра результатов веб-тестов производительности
...
2. Выберите **приложения** вкладку **требуемой версии .NET framework** стрелку раскрывающегося списка, а затем **.NET Framework 4** (или более поздней версии). Закрыть **свойства** окна.
...
## <a name="run-the-web-performance-test-using-the-web-test-results-viewer"></a>Запуск веб-теста производительности, с помощью просмотра результатов веб-тестов
