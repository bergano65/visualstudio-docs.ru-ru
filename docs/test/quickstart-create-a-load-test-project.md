...
3. На странице **Создание проекта** введите **веб-тест** в поле поиска и в результатах выберите шаблон для C# **Проект веб-тестов производительности и нагрузочных тестов \[Нерекомендуемое]**. Щелкните **Далее**.
