...
3. В диалоговом окне **Создание нового проекта** введите **веб-тест** в поле поиска и в результатах выберите шаблон для C# **Проект с веб-тестами производительности и нагрузочными тестами \[нерекомендуемый]**. Нажмите кнопку **Далее**.
