---
title: Создание проекта веб-теста производительности и нагрузочного теста в Visual Studio | Документы Майкрософт
ms.date: 03/14/2018
ms.topic: quickstart
helpviewer_keywords:
...
1. Нажмите кнопку **Изменить**.
   ...
   Выполняется установка компонента "Инструменты веб-тестирования производительности и нагрузочного тестирования".
