---
title: Тестовый набор браузеров для сценария тестовой нагрузки в Visual Studio | Документы Майкрософт
ms.date: 10/19/2016
ms.topic: article
helpviewer_keywords:
...
## <a name="adding-new-browsers-to-a-scenario"></a>Добавление браузеров в сценарий
...
##  <a name="EditingTestMixSpecifyBrowserRemovingBrowserTypes"></a> Удаление браузеров из сценария
