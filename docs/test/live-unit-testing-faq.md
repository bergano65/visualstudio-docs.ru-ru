...
## <a name="set-the-location-of-live-unit-testing-build-artifacts"></a>Задание расположения артефактов сборки Live Unit Testing
...
## <a name="why-doesnt-live-unit-testing-capture-coverage-from-a-new-process-created-by-a-test"></a>Почему функция Live Unit Testing не записывает покрытие из созданного тестом процесса?
