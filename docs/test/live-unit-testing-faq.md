...
Сведения о новых возможностях и улучшениях в Live Unit Testing см. в статье [Новые возможности в Live Unit Testing](live-unit-testing-whats-new.md).
...
Да. Функция Live Unit Testing совместима с .NET Core и .NET Framework. Поддержка .NET Core была добавлена в Visual Studio 2017 версии 15.3. Выполните обновление до этой или более поздней версии Visual Studio, если требуется поддержка Live Unit Testing для .NET Core.
...
Это известная проблема, которая должна быть устранена в следующем выпуске.

## <a name="including-or-excluding-tests-doesnt-work"></a>Включение и исключение тестов не работает
