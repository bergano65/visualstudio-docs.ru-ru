...
Начнем с создания нового тестового проекта. В меню **Файл** последовательно выберите пункты **Создать**и  > **Проект**. В диалоговом окне **Создание нового проекта** в поле поиска введите "тест" и задайте **Язык** как C++. В списке шаблонов проектов выберите **Приложение модульного тестирования (универсальное приложение Windows)** .
...
Начнем с создания нового тестового проекта. В меню **Файл** последовательно выберите пункты **Создать**и  > **Проект**. В диалоговом окне **Новый проект** разверните узел **Установленные** > **Visual C++** и выберите **Универсальные приложения Windows**. В списке шаблонов проектов выберите **Приложение модульного тестирования (универсальное приложение Windows)** .
