---
title: "Тестирование библиотеки DLL на Visual C++ для приложений UWP | Документы Майкрософт"
ms.custom: 
ms.date: 11/04/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-test-a-visual-c-dll-for-uwp-apps"></a>Тестирование библиотеки DLL на Visual C++ для приложений UWP 
...
##  <a name="In_this_topic"></a> Содержание раздела  
 ...
 [Создание решения и проекта модульного теста](#Create_the_solution_and_the_unit_test_project)  
  
 [Убедитесь в том, что тесты выполняются в обозревателе тестов.](#Verify_that_the_tests_run_in_Test_Explorer)  
  
 [Добавление в решение проекта библиотеки DLL](#Add_the_DLL_project_to_the_solution)  
  
 [Сделайте функции DLL доступными для кода тестов](#make_the_dll_functions_visible_to_the_test_code)  
  
 [Итеративное расширение тестов и обеспечение их успешного выполнения](#Iteratively_augment_the_tests_and_make_them_pass)  
  
 [Отладка непройденного теста](#Debug_a_failing_test)  
  
 [Рефакторинг кода без изменения тестов](#Refactor_the_code_without_changing_tests)  
...
2.  В диалоговом окне "Новый проект" разверните узел **Установленные**, а затем — узел **Visual C#** и выберите **Универсальная платформа Windows**. В списке шаблонов проектов выберите **Библиотека модульных тестов (приложения для универсальной платформы Windows)**.  
  
     ![Создание библиотеки модульных тестов на C&#43;&#43;](../test/media/ute_cpp_windows_unittestlib_create.png "UTE_Cpp_windows_UnitTestLib_Create")  
