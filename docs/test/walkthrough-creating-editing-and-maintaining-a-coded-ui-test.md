...
1. В области **Установленные** разверните узел **Visual C#** и выберите **Тест**.

1. В средней области выберите шаблон **Проект закодированных тестов пользовательского интерфейса**.
...
1. Нажмите кнопку **ОК**.
     ...
     В решение будет добавлен новый проект закодированных тестов пользовательского интерфейса с именем **CodedUITestProject1**.
...
1. Щелкните **Начать запись** в диалоговом окне **UIMap — построитель кодированных тестов ИП**.
     ...
     ![Начало записи](../test/media/cuit_builder_record.png)
...
![ссылка на видео](../data-tools/media/playvideo.gif) [Getting started with Coded UI tests](http://go.microsoft.com/fwlink/?LinkID=230573) (Начало работы с закодированными тестами пользовательского интерфейса).

![ссылка на видео](../data-tools/media/playvideo.gif) [Maintenance And debugging of coded UI tests](http://go.microsoft.com/fwlink/?LinkID=230574) (Обслуживание и отладка закодированных тестов пользовательского интерфейса)

![ссылка на видео](../data-tools/media/playvideo.gif) [Hand coding coded UI tests](http://go.microsoft.com/fwlink/?LinkID=230575) (Кодирование закодированных тестов пользовательского интерфейса вручную)
