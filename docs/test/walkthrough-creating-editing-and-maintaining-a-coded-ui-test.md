...
12. Выберите элемент управления Checkbox. В окне "Свойства" измените значение свойства **Имя** с \<No Name> на checkBox1 и очистите свойство **IsEnabled**.  
     ...
     ![Простое приложение WPF](~/docs/test/media/codedui_wpfapp.png "CodedUI_WPFApp")  
...
8.  Щелкните **Начать запись** в окне "UIMap — построитель кодированных тестов ИП".  
     ...
     ![Начать запись](~/docs/test/media/cuit_builder_record.png "CUIT_Builder_Record")  
  
     Вы можете приостановить запись, например если вы работаете с входящей почтой.  
  
     ![Приостановка записи](~/docs/test/media/cuit_.png "CUIT_")  
...
### <a name="videos"></a>Видеоролики  
 ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode1-GettingStarted](http://go.microsoft.com/fwlink/?LinkID=230573)  
  
 ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode2-MaintainenceAndDebugging](http://go.microsoft.com/fwlink/?LinkID=230574)  
  
 ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Coded UI Tests-DeepDive-Episode3-HandCoding](http://go.microsoft.com/fwlink/?LinkID=230575)  
