...
Решение — это просто контейнер для одного или нескольких проектов. Чтобы создать решение, откройте Visual Studio и сделайте следующее:
