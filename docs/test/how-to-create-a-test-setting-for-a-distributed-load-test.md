---
title: Создание параметра тестирования для распределенного нагрузочного теста в Visual Studio | Документы Майкрософт
ms.date: 10/19/2016
ms.topic: article
helpviewer_keywords:
...
9. Выберите пункт **Роли**.
     ...
     ![Роль параметров тестирования](../test/media/load_testtestrole.png "Load_TestTestRole")
...
17. Выберите пункт **Данные и диагностика**.
     ...
     ![Данные и диагностика параметров тестирования](../test/media/load_testtest.png "Load_TestTest")
