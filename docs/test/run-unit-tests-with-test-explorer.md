...
При [построении проекта тестирования](../test/getting-started-with-unit-testing.md) тесты появляются в обозревателе тестов. Если Обозреватель тестов не виден, выберите **Тест** в меню Visual Studio, выберите **Windows**, затем выберите **Обозреватель тестов**.
