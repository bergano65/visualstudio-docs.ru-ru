...
Если вы хотите создать список воспроизведения для признаков, используйте приведенный ниже формат. Убедитесь в наличии пробела между вашим названием `TestCategory` и `[Value]`.
```xml
...
![Группировка по состоянию, а затем классу](../test/media/vs-2019/test-explorer-columns-16-2.png)
