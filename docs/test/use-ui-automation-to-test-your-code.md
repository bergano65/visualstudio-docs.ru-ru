...
- **Построитель кодированных тестов ИП** используется для добавления элементов управления и проверок в тесты. См. подраздел [Добавление элементов управления и проверка их свойств](#VerifyingCodeUsingCUITGenerateAssertions) в этом разделе.
