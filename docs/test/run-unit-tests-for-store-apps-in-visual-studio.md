...
|||  
|-|-|  
|![Кнопка группы обозревателя тестов](~/docs/test/media/ute_groupby_btn.png "UTE_GroupBy_btn")|Чтобы сгруппировать тесты по длительности выполнения, откройте список **Критерий группировки** и выберите параметр **Длительность**. Чтобы вернуться к исходной группировке, выберите параметр **Результат теста**.|  
