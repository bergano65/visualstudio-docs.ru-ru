...
> [!NOTE]
> Visual Studio включает несколько типов тестового проекта. Если вы создадите новый закодированный тест пользовательского интерфейса, он будет создан в типе проекта закодированных тестов пользовательского интерфейса.
...
## <a name="compatibility-issues-between-visual-studio-2010-and-visual-studio-2012-or-later"></a>Проблемы совместимости между Visual Studio 2010 и Visual Studio 2012 или более поздней версии  
...
##  <a name="UpgradingCodedUIFromVS2010_Update"></a> Обновление Visual Studio 2010 с пакетом обновления 1 (SP1)  
 Обновление до [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)] с пакетом обновления 1 (SP1) с поддержкой совместимости для Visual Studio 2012 или более поздней версии и Windows 8 или более поздней версии доступно для скачивания в [Центре загрузки Майкрософт](http://www.microsoft.com/download/details.aspx?id=34677), а также как обновление Visual Studio.  
...
-   **Покрытия кода:** неспособность открыть файл покрытия кода (.coverage), созданный Visual Studio 2012 в [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)] SP1.  
