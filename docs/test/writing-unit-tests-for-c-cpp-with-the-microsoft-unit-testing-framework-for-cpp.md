...
2.  В новом проекте изучите файл **unittest1.cpp**.  
     ...
     ![Проект теста с TEST&#95;CLASS и TEST&#95;METHOD](~/docs/test/media/utecpp2.png "UteCpp2")  
...
3.  Убедитесь в том, что тесты выполняются в обозревателе тестов.  
    ...
    2.  В меню **Тест** выберите **Запуск**, **Все тесты**.  
         ...
         ![Обозреватель модульных тестов с одним пройденным тестом](~/docs/test/media/utecpp04.png "UteCpp04")  
...
3.  Объявите экспортированную функцию в основном H-файле.  
     ...
     ![Новый проект кода DLL и H-файл с макросами API](~/docs/test/media/utecpp07.png "UteCpp07")  
...
5.  В разделе "Обозреватель тестов" выберите **Запустить все**.  
     ...
     ![Обозреватель модульных тестов — базовый тест пройден](~/docs/test/media/utecpp10.png "UteCpp10")  
