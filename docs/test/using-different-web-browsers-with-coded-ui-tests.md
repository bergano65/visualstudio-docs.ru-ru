...
-   ![Предварительное требование](~/docs/test/media/prereq.png "Предварительное требование") Веб-браузер Apple Safari не поддерживается.  
  
-   ![Предварительное требование](~/docs/test/media/prereq.png "Предварительное требование") Действие запуска веб-браузера должно быть частью закодированного теста пользовательского интерфейса.  
...
-   ![Предварительное требование](~/docs/test/media/prereq.png "Предварительное требование") Автоматизация действий пользовательского интерфейса в зависимости от браузера, таких как развертывание, сворачивание и восстановление, не поддерживается.  
  
 **Советы**  
  
-   ![Совет](~/docs/test/media/tip.png "Совет") Выходные данные можно настроить таким образом, чтобы они включали снимки экрана в журналах закодированного пользовательского интерфейса. Для этого необходимо задать некоторые параметры конфигурации в файле QTAgent32.exe.config. По умолчанию этот файл устанавливается в следующую папку:  
