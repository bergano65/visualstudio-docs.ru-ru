...
Также рассмотрите, будет ли проще использовать [вместо этого управление сборками и выпусками](lab-management/use-build-or-rm-instead-of-lab-management.md).
