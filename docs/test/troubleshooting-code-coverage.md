---
title: "Устранение неполадок с покрытием кода | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
### Недоступны PDB\-файлы \(файлы символов\)  
 ...
 Если PDB\-файл и DLL\-файл или EXE\-файл находятся в разных местах, скопируйте PDB\-файл в тот же каталог.  Также можно настроить анализатор покрытия кода для поиска PDB\-файлов в другом расположении.  Дополнительные сведения см. в разделе [Настройка анализа покрытия кода](../test/customizing-code-coverage-analysis.md).  
...
### Сборка установлена с помощью NGen  
 ...
 Объяснение  
 Из соображений производительности сборки образов в машинном коде не анализируются.  Дополнительные сведения см. в разделе [Ngen.exe \(Native Image Generator\)](../Topic/Ngen.exe%20\(Native%20Image%20Generator\).md).  
...
### Пользовательский RUNSETTINGS\-файл с неверным синтаксисом  
 ...
 Объяснение  
 Можно выполнить модульные тесты, используя пользовательский RUNSETTINGS\-файл, чтобы настроить параметры покрытия кода.  С помощью параметров можно включать или исключать файлы.  Дополнительные сведения см. в разделе [Настройка анализа покрытия кода](../test/customizing-code-coverage-analysis.md).  
...
### Пользовательский RUNSETTINGS\-файл с неверными исключениями  
 ...
 Убедитесь, что узел DataCollectors определяет покрытие кода.  Сравните его с примером в разделе [Настройка анализа покрытия кода](../test/customizing-code-coverage-analysis.md).  
