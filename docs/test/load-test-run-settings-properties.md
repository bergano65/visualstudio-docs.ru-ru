...
|**Название**|Имя параметра запуска в том виде, как оно отображается в узле **Параметры запуска** **редактора тестовой нагрузки**.|
...
|Свойство|Определение|
|-|----------------|
|**Тип хранилища**|Способ хранения счетчиков производительности, полученных при выполнении нагрузочного теста. Существуют следующие варианты выбора.<br /><br /> -   **База данных** — требуется база данных SQL, содержащая **хранилище результатов нагрузочного теста**.<br />-   **None**.|
