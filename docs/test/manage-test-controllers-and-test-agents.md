...
|Ready|Доступен для выполнения тестов и сбора данных и диагностики|
|Вне сети|Недоступен для выполнения тестов и сбора данных и диагностики|
|Отключено|Агент тестирования не запущен|
...
|Свойство агента тестирования|Description|
|-|-----------------|
