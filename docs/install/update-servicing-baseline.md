...
ms.locfileid: "66501118"
---
# <a name="update-visual-studio-while-on-a-servicing-baseline"></a>Обновление Visual Studio во время обслуживания

Visual Studio 2019 будет часто обновляться в ходе своего [жизненного цикла](/visualstudio/productinfo/release-rhythm#release-channel-updates). Это будут как промежуточные обновления (например, с версии 16.0 до версии 16.1), при которых будут добавляться новые функции и компоненты, так и служебные обновления (примером, с версии 16.0.4 до версии 16.0.5), когда вносятся только исправления известных серьезных проблем. 
