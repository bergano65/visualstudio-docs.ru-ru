---
title:
- "Идентификаторы рабочих нагрузок и компонентов Visual Studio 2017 | Документация Майкрософт"
...
На этих страницах перечислены идентификаторы рабочих нагрузок и компонентов, которые можно использовать в командной строке при установке Visual Studio или в качестве зависимости в манифесте VSIX.
