...
| Visual Studio 2019: RTW                         | Предприятие            | Версия 16.0.13    |
| Visual Studio 2017: Последняя версия (версия 15.9)           | Enterprise, Community | Версия 15.9.22   |
