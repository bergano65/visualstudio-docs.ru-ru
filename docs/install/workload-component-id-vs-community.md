---
title: Идентификаторы рабочих нагрузок и компонентов для Visual Studio Community
titleSuffix: ''
...
ms.locfileid: "84184381"
---
# <a name="visual-studio-community-component-directory"></a>Каталог компонентов Visual Studio Community
