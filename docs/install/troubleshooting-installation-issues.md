...
1. Скачайте [средство сбора журналов для Microsoft Visual Studio и платформы .NET Framework](https://aka.ms/vscollect) и запустите его. Это средство собирает и компилирует все доступные журналы установки для Visual Studio, .NET Framework и SQL Server.
