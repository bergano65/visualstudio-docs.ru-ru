...
> [!NOTE]
> При запуске виртуального экземпляра Visual Studio должны быть также виртуализированы локальная папка AppData и реестр. Для устранения неполадок с виртуальными экземплярами запустите программу *C:\Program Files (x86)\Microsoft Visual Studio\ <версия\> \Common7\IDE\DDConfigCA.exe*.  
