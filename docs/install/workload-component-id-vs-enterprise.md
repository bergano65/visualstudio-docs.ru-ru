---
title:
- "Идентификаторы рабочих нагрузок и компонентов для Visual Studio Enterprise 2017 | Документация Майкрософт"
...
Microsoft.VisualStudio.Component.TestTools.CodedUITest | Закодированный тест ИП
...
Microsoft.VisualStudio.Component.TestTools.WebLoadTest | Инструменты веб-тестирования производительности и нагрузочного тестирования
