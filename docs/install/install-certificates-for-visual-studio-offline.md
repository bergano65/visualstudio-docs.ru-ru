...
При настройке развертывания Visual Studio в автономной среде на клиентских рабочих станциях с помощью сценариев 6необходимо выполнить следующие действия.
