---
title: Установка сертификатов, необходимых для установки Visual Studio в автономном режиме | Документы Майкрософт
...
* Файл **Vs_installer_opc.SignCertificates.p12** содержит следующие сертификаты:
    ...
    * Корневой сертификат: **Microsoft Root Certificate Authority**
        * Обязательно. Этот сертификат поставляется с системами под управлением Windows 7 или более поздней версии.
