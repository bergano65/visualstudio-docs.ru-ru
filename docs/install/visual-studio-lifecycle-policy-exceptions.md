---
title: "Исключения политики жизненного цикла Visual Studio | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Исключения политики жизненного цикла Visual Studio
...
## Внешние компоненты, в отношении которых действуют политики жизненного цикла, отличные от политики Visual Studio  
...
|[Веб\-инструменты Майкрософт для разработчиков 2013](http://go.microsoft.com/fwlink/?LinkId=328952)|Веб\-инструменты Майкрософт для разработчиков 2013|  
|Обновления для этих компонентов распространяются с помощью NuGet и не следуют стандартным политикам жизненного цикла Майкрософт.  Более подробную информацию см. на сайте [http:\/\/docs.nuget.org\/](http://docs.nuget.org/).|Веб\-обработчик токенов JSON для Microsoft .Net Framework 4.5<br /><br /> NuGet 2.7<br /><br /> SignalR<br /><br /> Web Optimization Framework<br /><br /> WebGrease|  
...
|[Microsoft Azure](http://support.microsoft.com/gp/azure-cloud-lifecycle-faq)<br /><br /> <br />> См. также [Политика жизненного цикла в Интернете](http://support.microsoft.com/gp/OSSLpolicy)|Пакет SDK для мобильных служб Microsoft Azure<br /><br /> Инструменты мобильных служб Microsoft Azure|