...
description: Сведения о методе SuspendProfile, который увеличивает значение счетчика приостановки и возобновления для указанного уровня профилирования.
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
- SuspendProfile
