---
title: Как выполнить Запуск автономного приложения в машинном коде с профилировщиком для сбора данных параллелизма при помощи командной строки | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "53903842"
---
# <a name="how-to-launch-a-stand-alone-native-application-with-the-profiler-to-collect-concurrency-data-by-using-the-command-line"></a>Как выполнить Запуск собственного автономного приложения с профилировщиком для сбора данных о параллелизме с помощью командной строки
