...
В задачах, описанных в таблице ниже, перечислены параметры, которые можно задать в диалоговом окне *Сеанс производительности***Страницы свойств** при профилировании с использованием параллелизма.
