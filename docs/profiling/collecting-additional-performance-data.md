...
Кроме данных, собираемых с помощью метода профилирования, средства профилирования [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] позволяют выполнять регистрировать и просматривать дополнительные данные.  
