...
![Выделение кучи Windows](~/docs/profiling/media/heap-example-windows-heap.png)
...
![Включение профилирования кучи](~/docs/profiling/media/heap-enable-heap.png)
...
![Выбор кучи](~/docs/profiling/media/heap-example-custom-heap.png)
...
![Куча NT со средством отслеживания](~/docs/profiling/media/heap-example-windows-heap.png)
