...
Для использования средства профилирования, описанного в этой статье, то есть [Профилировщика производительности](../profiling/profiling-feature-tour.md), требуется Windows 7 или более поздней версии.
...
|**Собственное время ЦП (мс)**|Время в миллисекундах, затраченное на вызовы функции в выбранном временном интервале, и функций, которые были вызваны этой функцией, за исключением действий функций, вызываемых этой функцией.|  
