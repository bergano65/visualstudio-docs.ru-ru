...
1.  В Visual Studio установите для решения конфигурацию **Выпуск** и выберите цель развертывания.  
     ...
     ![Выбор выпуска и локального компьютера](~/docs/profiling/media/cpuuse_selectreleaselocalmachine.png "CPUUSE_SelectReleaseLocalMachine")  
...
3.  Нажмите **Использование ЦП** и **Запуск**.  
     ...
     ![Выбор загрузки ЦП](~/docs/profiling/media/cpuuse_lib_choosecpuusage.png "CPUUSE_LIB_ChooseCpuUsage")  
