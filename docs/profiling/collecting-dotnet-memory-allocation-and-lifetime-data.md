...
Задачи в следующей таблице описывают параметры, которые можно задать в диалоговом окне *Сеанс производительности***Страницы свойств** при сборе данных об использовании памяти .NET.
