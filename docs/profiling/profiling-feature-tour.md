...
![Окно "Средства диагностики"](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Средства диагностики")
...
![Сводка в окне "Средства диагностики"](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Сводка в окне "Средства диагностики"")
...
![Включение отображения данных о загрузке ЦП в окне "Средства диагностики"](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Данные о загрузке ЦП в окне "Средства диагностики"")
...
![Представление данных о загрузке ЦП в окне "Средства диагностики"](~/docs/profiling/media/prof-tour-cpu-usage.png "Данные о загрузке ЦП в окне "Средства диагностики"")
...
![Представление "бабочки" с вызывающей и вызываемой функциями в окне "Средства диагностики"](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Представление вызывающей и вызываемой функциями в окне "Средства диагностики"")
...
![Представление событий в окне "Средства диагностики"](~/docs/profiling/media/prof-tour-events.png "Представление событий в окне "Средства диагностики"")
...
![Обзор профилирования — советы по повышению производительности](~/docs/profiling/media/prof-tour-perf-tips.png "Обзор профилирования — советы по повышению производительности")
...
![Представление "События" с параметром "Анализ пользовательского интерфейса" в окне "Средства диагностики"](~/docs/profiling/media/prof-tour-ui-analysis.png "Представление "События" с параметром "Анализ пользовательского интерфейса" в окне "Средства диагностики"")
...
![Профилировщик производительности](~/docs/profiling/media/prof-tour-performance-profiler.png "Профилировщик производительности")
...
![Средство профилирования — временная шкала приложения](~/docs/profiling/media/prof-tour-application-timeline.gif "Обзор профилирования — временная шкала приложения")
...
![Средство профилирования — использование GPU](~/docs/profiling/media/prof-tour-gpu-usage.png "Диалоговое окно "Использование GPU"")
...
![Средство профилирования — использование сети](~/docs/profiling/media/prof-tour-network-usage.png "Диалоговое окно "Использование сети"")

Выберите операцию в представлении "Сводка", чтобы просмотреть более подробные сведения.

![Подробные сведения в средстве профилирования сети](~/docs/profiling/media/prof-tour-network-usage-details.png "Окно с подробными сведениями об использовании сети")
...
![Средство "Обозреватель производительности"](~/docs/profiling/media/prof-tour-performance-explorer.png "Обозреватель производительности")
