...
- [Использования памяти для кода .NET](../profiling/dotnet-alloc-tool.md).
- [Использование памяти](#analyze-memory-usage).
