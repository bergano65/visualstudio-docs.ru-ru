...
![Сводка по средствам диагностики](../profiling/media/prof-tour-cpu-and-memory-graph.gif "Сводка по средствам диагностики")
...
![Средства диагностики — Включить использование ЦП](../profiling/media/prof-tour-enable-cpu-profiling.png "Средства диагностики — Включить использование ЦП")
...
![Средства диагностики — Загрузка ЦП](../profiling/media/prof-tour-cpu-usage.png "Средства диагностики — Загрузка ЦП")

Дважды щелкните нужную функцию, после чего откроется подробное представление с тремя панелями: выбранная функция будет находиться в центре окна, вызываемая функция — в левой части, вызывающая функция — в правой части. В разделе **Тело функции** также показан общий объем времени (и доля времени), затраченного в теле функции за исключением времени, затраченного в вызываемых и вызывающих функциях. Эти данные помогут оценить, оказывает ли негативное влияние на производительность сама функция.

![Средства диагностики — представление вызываемой и вызывающей функций](../profiling/media/prof-tour-cpu-usage-caller-callee.png "Средства диагностики — представление вызываемой и вызывающей функций")
...
![Средства диагностики — создание моментальных снимков](../profiling/media/prof-tour-take-snapshots.gif "Средства диагностики — создание моментальных снимков")
...
![Средства диагностики — разностное представление кучи](../profiling/media/prof-tour-mem-usage-diff-heap.png "Средства диагностики — разностное представление кучи")
...
![Средства диагностики — представление событий](../profiling/media/prof-tour-events.png "Средства диагностики — представление событий")
...
![Средства диагностики — представление "События", параметр "Анализ пользовательского интерфейса"](../profiling/media/prof-tour-ui-analysis.png "Средства диагностики — представление "События", параметр "Анализ пользовательского интерфейса"")
...
![Обзор профилирования — временная шкала приложения](../profiling/media/prof-tour-application-timeline.gif "Обзор профилирования — временная шкала приложения")
...
![Схема использования GPU](../profiling/media/prof-tour-gpu-usage.png "Схема использования GPU")
...
![Схема использования памяти JavaScript](../profiling/media/diagjsmemory.png "Схема использования памяти JavaScrip")
...
![Схема реагирования пользовательского интерфейса HTML](../profiling/media/diaghtmlresp.png "Схема реагирования пользовательского интерфейса HTML")
...
![Схема использования сети](../profiling/media/prof-tour-network-usage.png "Схема использования сети")

Выберите операцию в представлении "Сводка", чтобы просмотреть более подробные сведения.

![Сведения об использовании сети](../profiling/media/prof-tour-network-usage-details.png "Сведения об использовании сети")
...
![Обозреватель производительности](../profiling/media/prof-tour-performance-explorer.png "Обозреватель производительности")
