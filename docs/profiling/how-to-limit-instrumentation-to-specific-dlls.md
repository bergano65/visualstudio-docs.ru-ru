...
1.  Откройте решение, содержащее библиотеку DLL, в [!INCLUDE[vsPreLong](../code-quality/includes/vsprelong_md.md)].  
