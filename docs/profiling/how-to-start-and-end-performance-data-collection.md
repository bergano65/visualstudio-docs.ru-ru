---
title: Как выполнить Начало и окончания сбора данных о производительности | Документация Майкрософт
ms.date: 11/04/2016
ms.topic: conceptual
f1_keywords:
...
ms.locfileid: "56622544"
---
# <a name="how-to-start-and-end-performance-data-collection"></a>Как выполнить Начало и окончания сбора данных о производительности
