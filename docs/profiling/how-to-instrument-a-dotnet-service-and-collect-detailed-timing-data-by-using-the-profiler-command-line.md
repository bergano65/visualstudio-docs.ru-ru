...
В этой статье описывается использование программ командной строки средств профилирования Visual Studio для инструментирование службы .NET Framework и Сбор подробных данных о времени.
