...
Эта статья описывает использование программ командной строки для Средств профилирования [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] с целью инструментирования службы [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)], а также для сбора подробных данных по использованию времени.  
