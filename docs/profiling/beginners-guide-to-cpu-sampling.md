---
title: "Руководство по выборке циклов ЦП для начинающих | Документы Майкрософт"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="a-namestep1a-create-and-run-a-performance-session"></a><a name="Step1"></a> Создание и выполнение сеанса производительности  
...
##  <a name="a-namestep2a-step-2-analyze-sampling-data"></a><a name="Step2"></a> Шаг 2. Анализ данных выборки  
...
##  <a name="a-namestep3a-step-3-revise-code-and-rerun-a-session"></a><a name="Step3"></a> Шаг 3. Пересмотр кода и повторный запуск сеанса  
