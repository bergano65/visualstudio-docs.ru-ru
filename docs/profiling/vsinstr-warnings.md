...
|--------------------|-----------------|  
|**VSP1026**|Покрытие не поддерживается в библиотеках, которые не ссылаются на MSCorLib. Такое часто случается с переносимыми библиотеками.|  
