---
title: "Визуализатор параллелизма | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  - "Визуализатор параллелизма, Визуализатор параллелизма"
...
>   
>      [Служебная программа с интерфейсом командной строки визуализатора параллелизма \(CVCollectionCmd\)](../profiling/concurrency-visualizer-command-line-utility-cvcollectioncmd.md) позволяет собирать трассировки из командной строки, которые можно просмотреть в визуализаторе параллелизма для Visual Studio 2015. Это средство можно использовать на компьютерах без установленной среды Visual Studio.  
...
|[Представления отчетов средств профилирования](../profiling/performance-report-views.md)|Содержит справочные сведения по отчетам и представлениям средств профилирования Visual Studio.|  
