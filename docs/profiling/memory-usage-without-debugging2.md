...
### <a name="monitor-memory-use"></a>Мониторинг использования памяти 
...
## <a name="snapshot-difference-diff-reports"></a>Разностные отчеты по снимкам  
