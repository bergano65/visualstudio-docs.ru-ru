...
##  <a name="Isolate"></a> Локализация утечки памяти  
...
##  <a name="SnapshotSummary"></a> Просмотр сводки снимков  
...
##  <a name="JSConsoleCommands"></a> Связывание исходного кода с данными об использовании памяти  
