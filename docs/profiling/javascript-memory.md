...
-   уменьшать объем информации, не предполагающей действий, в данных кучи JavaScript.  
 ...
 [Локализация утечки памяти](#Isolate)   
 [Просмотр сводки использования памяти в реальном времени](#LiveMemory)   
 [Просмотр сводки снимков](#SnapshotSummary)   
...
##  <a name="a-nameruna-run-the-javascript-memory-analyzer"></a><a name="Run"></a> Запуск анализатора памяти JavaScript  
 Анализатор памяти можно использовать при наличии работающего приложения Магазина Windows, открытого в Visual Studio или установленного на компьютере под управлением ОС [!INCLUDE[win8](../debugger/includes/win8_md.md)] или более поздних версий.  
...
##  <a name="a-namechecka-check-memory-usage"></a><a name="Check"></a> Проверка использования памяти  
...
##  <a name="a-nameisolatea-isolate-a-memory-leak"></a><a name="Isolate"></a> Локализация утечки памяти  
...
##  <a name="a-namelivememorya-view-live-memory-usage-summary"></a><a name="LiveMemory"></a> Просмотр сводки использования памяти в реальном времени  
...
##  <a name="a-namesnapshotsummarya-view-a-snapshot-summary"></a><a name="SnapshotSummary"></a> Просмотр сводки снимков  
...
##  <a name="a-namesnapshotdetailsa-view-snapshot-details"></a><a name="SnapshotDetails"></a> Просмотр сведений о снимке  
...
##  <a name="a-namesnapshotdiffa-view-a-snapshot-diff"></a><a name="SnapshotDiff"></a> Просмотр разницы между снимками  
...
##  <a name="a-namefoldobjectsa-view-objects-by-dominator"></a><a name="FoldObjects"></a> Просмотр объектов по доминатору  
...
##  <a name="a-namefiltera-filter-data-by-identifier"></a><a name="Filter"></a> Фильтрация данных по идентификатору  
...
##  <a name="a-nameshowinrootsviewa-find-an-object-in-the-object-tree"></a><a name="ShowInRootsView"></a> Поиск объекта в дереве объектов  
...
##  <a name="a-namereferencesa-view-shared-object-references"></a><a name="References"></a> Просмотр общих ссылок на объекты  
...
##  <a name="a-namebuiltinvaluesa-show-built-in-objects"></a><a name="BuiltInValues"></a> Отображение встроенных объектов  
...
##  <a name="a-namesavea-save-diagnostic-session-files"></a><a name="Save"></a> Сохранение файлов диагностических сеансов  
...
##  <a name="a-namejsconsolecommandsa-associate-source-code-with-memory-usage-data"></a><a name="JSConsoleCommands"></a> Связывание исходного кода с данными об использовании памяти  
...
-   `console.takeHeapSnapshot` делает снимок кучи, который отображается в анализаторе памяти JavaScript. Эта команда является частью набора [Команды консоли JavaScript](../debugger/javascript-console-commands.md).  
...
##  <a name="a-nametipsa-tips-for-identifying-memory-issues"></a><a name="Tips"></a> Советы по выявлению проблем памяти  
...
-   Попробуйте найти объекты, которые случайно сохраняются в памяти после перехода пользователя на новую страницу, что является распространенной причиной проблем с памятью. Примеры.  
    ...
    -   Возможно, потребуется удалить один или несколько прослушивателей событий. Дополнительные сведения см. в статье [View DOM event listeners](../debugger/view-dom-event-listeners.md) (Просмотр прослушивателей событий DOM).  
