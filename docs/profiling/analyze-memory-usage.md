...
Средство **выделения объектов .NET** помогает определять закономерности и аномалии выделения в коде .NET. Оно используется только в качестве инструмента последующего анализа. Это средство можно запускать на локальных или удаленных компьютерах.
