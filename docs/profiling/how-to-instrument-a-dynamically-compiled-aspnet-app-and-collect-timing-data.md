...
1. Измените файл *web.config* для целевого приложения. См. статью [Практическое руководство. Изменение файлов web.config для инструментирования и профилирования динамически скомпилированных веб-приложений ASP.NET](../profiling/how-to-modify-web-config-files-to-instrument-dynamically-compiled-aspnet-apps.md).
