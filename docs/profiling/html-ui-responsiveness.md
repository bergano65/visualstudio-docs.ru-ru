...
##  <a name="RunningProfiler"></a> Запуск средства скорости реагирования пользовательского интерфейса HTML  
...
###  <a name="TimelineDetails"></a> Просмотр сведений на временной шкале  
...
###  <a name="FilterTimelineDetails"></a> Фильтрация сведений на временной шкале  
...
###  <a name="GroupFrames"></a> Группировка событий по кадрам  
...
-   **GC.** Указывается время, затраченное на сборку мусора.  
