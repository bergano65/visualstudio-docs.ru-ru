...
## <a name="lock-contention-and-serialized-execution"></a>Конфликт блокировок и сериализованное выполнение  
 ![Результирующий конфликт блокировки в сериализованном выполнении](~/docs/profiling/media/lockcontention_serialized.png "LockContention_Serialized")  
 ...
 ![Конфликты блокировок](~/docs/profiling/media/lockcontention_2.png "LockContention_2")  
  
## <a name="uneven-workload-distribution"></a>Неравномерное распределение рабочей нагрузки  
 ![Неравномерная рабочая нагрузка](~/docs/profiling/media/unevenworkload_1.png "UnevenWorkLoad_1")  
 ...
 ![Неравномерная рабочая нагрузка](~/docs/profiling/media/unevenworkload_2.png "UnevenWorkLoad_2")  
  
## <a name="oversubscription"></a>Превышение лимита подписки  
 ![Превышение лимита подписки](~/docs/profiling/media/oversubscription.png "Oversubscription")  
...
## <a name="inefficient-io"></a>Неэффективный ввод-вывод  
 ![Неэффективный ввод-вывод](~/docs/profiling/media/inefficient_io.png "Inefficient_IO")  
...
## <a name="lock-convoys"></a>Колонны блокировок  
 ![Колонны блокировок](~/docs/profiling/media/lock_convoys.png "Lock_Convoys")  
