...
## <a name="span-category"></a>Категория диапазона  
 ...
 ![Пять диапазонов в различных категориях](~/docs/profiling/media/cvmarkerspancategory.png "CVMarkerSpanCategory")  
...
## <a name="span-aggregation-markers"></a>Маркеры объединенных диапазонов  
 ...
 ![Маркер объединенных диапазонов в визуализаторе параллелизма](~/docs/profiling/media/cvmarkerspanaggregate.png "CVMarkerSpanAggregate")  
