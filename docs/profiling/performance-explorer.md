---
title: "Использование средств профилирования | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  - "средства повышения производительности [Visual Studio ALM]"
...
|------------|--------------------------|  
|**Новые методики для Windows 8**|[Профилирование приложений для Windows 8 и Windows Server 2012](../profiling/performance-tools-on-windows-8-and-windows-server-2012-applications.md)|  
...
|**Выявление проблем с производительностью:** научитесь просматривать и анализировать собранные данные о производительности в окне представления отчетов средств профилирования.|[Анализ данных средств профилирования](../profiling/analyzing-performance-tools-data.md)|  
|**Анализ изменений производительности:** узнайте, как сравнить два файла данных профилировщика для анализа изменений производительности.|[Сравнение файлов данных средств профилирования](../profiling/comparing-performance-data-files.md)|  
...
|**Устранение неполадок профилирования**|[Устранение неполадок средств профилирования](../profiling/troubleshooting-performance-tools-issues.md)|  
