...
ms.locfileid: "70766228"
---
# <a name="create-dependency-diagrams-from-your-code"></a>Создание схем зависимостей на основе кода

Для визуализации высокоуровневой логической архитектуры программной системы Создайте *схему зависимостей* в Visual Studio. Чтобы убедиться в том, что код остается согласованным с этой структурой, проверьте код с помощью схемы зависимостей. Вы можете создавать схемы зависимостей для визуальных C# и Visual Basic проектов. Чтобы узнать, какие выпуски Visual Studio поддерживают эту функцию, см. раздел [Поддержка архитектуры и средств моделирования в выпуске](../modeling/what-s-new-for-design-in-visual-studio.md#edition-support-for-architecture-and-modeling-tools).
...
## <a name="CreateDiagram"></a>Создание схемы зависимостей
...
5. Выберите все узлы на карте кода (используйте _сочетание клавиш CTRL_ + _A_или используйте выбор с резиновой полосой, нажав клавишу _SHIFT_ перед нажатием, перетаскиванием и выпуском.
...
## <a name="CreateLayers"></a>Создание слоев на основе артефактов
...
|Скопировать ссылку из одного слоя в другой|1.  Откройте контекстное меню для ссылки артефакт и выберите команду **Копировать**.<br />2.  На схеме зависимостей откройте контекстное меню слоя и выберите команду **Вставить**.|
...
## <a name="EditDependencies"></a>Изменение слоев и зависимостей для отображения предполагаемого дизайна
