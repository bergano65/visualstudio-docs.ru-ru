...
|**Имя**|Имя данного свойства домена. Он должен быть допустимым идентификатором, например **SongTitle**.|\<None >|  
...
|**Тип**|Тип свойства. Чтобы добавить в список доступных типов, щелкните правой кнопкой мыши корень DSL в обозреватель DSL и нажмите кнопку **добавить внешний тип**.|`String`|  
