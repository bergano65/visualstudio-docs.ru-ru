...
Чтобы сохранить карту как часть конкретного проекта, на панели инструментов Map выберите **Share** > **переместить \<кодемапнаме >. DGML в**, а затем выберите проект, в котором нужно сохранить карту.
