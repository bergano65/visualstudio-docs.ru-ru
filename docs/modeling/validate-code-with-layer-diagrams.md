...
Можно проверить код вручную из схемы откройте зависимостей в Visual Studio или из командной строки. Можно также проверять код автоматически при выполнении локальных сборок или конвейеры Azure сборок. См. в разделе [видео Channel 9: проектирования и проверки архитектуры с помощью схем зависимостей](http://go.microsoft.com/fwlink/?LinkID=252073).
...
| DV9001: **архитектуры обнаружены внутренние ошибки** | Результат может быть неполным. Для получения дополнительных сведений см. подробный журнал событий построения или окно вывода. |
