...
> [!IMPORTANT]
> Если вы хотите выполнить проверку слоев с помощью Team Foundation Server, необходимо также установить ту же версию Visual Studio на сервере сборки.
