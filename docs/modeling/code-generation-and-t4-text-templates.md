...
## <a name="in-this-section"></a>В этом разделе  
 ...
 Если установлен пакет SDK для визуализации и моделирования [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] , то созданное программное обеспечение будет обновляться в соответствии с изменениями в модели.  
