---
title: "Создание кода и текстовые шаблоны T4 | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
```  
 ...
 Приложение может выполняться на компьютере, который не имеет [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] установлен.  
...
## <a name="in-this-section"></a>Содержание  
 ...
 Если вы установили [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] визуализации и моделирования SDK, можно обеспечить созданного программного обновляет с изменениями в модели.  
