...
ms.locfileid: "31950417"
---
# <a name="update-shapes-and-connectors-to-reflect-the-model"></a>Обновление фигур и соединителей в соответствии с моделью
...
В примерах кода в этом разделе, которые должны быть добавлены в `.cs` файла в вашей `Dsl` проекта. Необходимо, чтобы эти инструкции в каждом файле:
