---
title: "Моделирование архитектуры приложения | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Чтобы гарантировать, что программной системы или приложения требованиям пользователей, можно создавать модели в Visual Studio как часть описания общей структуры и поведения программной системы или приложения. С помощью моделей также можно описывать шаблоны, используемые при разработке. Такие модели помогают понять существующую архитектуру, обсуждать изменения и четко формулировать свои намерения.  
...
##  <a name="a-namerequirementsa-understanding-the-requirements"></a><a name="Requirements"></a>Понимание требований  
...
##  <a name="a-namebigdecisionsa-architectural-patterns"></a><a name="BigDecisions"></a>Архитектурные шаблоны  
...
##  <a name="a-namepatternsa-design-patterns"></a><a name="Patterns"></a>Шаблоны проектирования  
