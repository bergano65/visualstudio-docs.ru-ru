---
title: "Определение фигур и соединителей | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
##  <a name="shapeTypes"></a> Основные типы фигур и соединителей  
 На схеме DSL отображается коллекция *фигур*, связанных линиями или *соединителями*.  Как правило, но не всегда:  
...
|Тип фигуры|Описание|  
|----------------|--------------|  
|Геометрическая фигура|Прямоугольная или эллиптическая фигура общего назначения  В определенные положения относительно границ фигуры можно включать декораторы текста и значков.<br /><br /> Инструкции по вложению фигур внутрь геометрических фигур см. в разделе [Создание вложенных фигур](../modeling/nesting-shapes.md).|  
