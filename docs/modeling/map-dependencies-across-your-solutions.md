...
- Машинный или управляемый C++ C или код C++ в визуальных проектах, файлах заголовков ( *. h* или `#include`) или двоичных файлах
...
1. На панели инструментов **Обозреватель решений** нажмите кнопку](../modeling/media/createnewgraphfromselectedbutton.gif) **отобразить на карте** ![кода создать новый граф из выбранных узлов. Также можно открыть контекстное меню для одной или группы элементов и выбрать команду « **отобразить на карте кода**».
