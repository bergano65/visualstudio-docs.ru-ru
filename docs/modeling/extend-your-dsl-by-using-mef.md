...
2. В новом проекте добавьте ссылку на сборку DSL.
   ...
   - Если у вас есть доступ к проекту DSL, файл сборки можно найти в каталоге **\\ \\ \* bin/DSL*
...
4. Создайте новый проект _ *VSIX Project**.
...
8. Добавьте ссылку VSIX в DSL.
   ...
   2. В диалоговом окне щелкните **добавить полезные данные** , а затем найдите VSIX файл DSL. VSIX-файл строится в решении DSL в **DslPackage \\ bin \\ \** _.
...
9. Проверьте и обновите другие поля _ * Source. extension. vsixmanifest * *. Щелкните **Выбрать выпуски** и убедитесь, что установлены правильные выпуски Visual Studio.
