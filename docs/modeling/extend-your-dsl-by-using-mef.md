...
1. Создайте новый **библиотеки классов** проекта.
...
4. Создайте новый **проект VSIX** проекта.

5. В **обозревателе решений**, щелкните правой кнопкой мыши проект VSIX и выберите **Назначить запускаемым проектом**.
