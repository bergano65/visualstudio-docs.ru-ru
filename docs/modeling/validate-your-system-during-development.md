...
|**Категории**|**Ссылки**|  
|------------------|---------------|  
|**Видео**|![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9: семь дуг: понимание кода и разработка систем в Visual Studio 2010](http://go.microsoft.com/fwlink/?LinkId=216100)<br /><br /> ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9: разработка архитектуры приложения с помощью схемы зависимостей](http://go.microsoft.com/fwlink/?LinkID=201117)<br /><br /> ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [MSDN как серия: проверка кода с помощью схем зависимостей](http://go.microsoft.com/fwlink/?LinkID=214405)|  
