 ...
 **Подключение входит в тип OutPort вложенного компонента**  
 ...
 ![Построитель подключения](~/docs/modeling/media/connectionbuilder_3.png "ConnectionBuilder_3")  
 ...
 **Директива подключения связи в обозреватель DSL**  
 ...
 ![Изображение мастера подключения](~/docs/modeling/media/connectionbuilder_4a.png "ConnectionBuilder_4a")  
