...
5. Чтобы проверить DSL, нажмите клавишу F5 или CTRL + F5 и в экспериментальном экземпляре Visual Studio, откройте пример файла модели. На панели элементов должно появиться новое средство. Перетащите его на схему, чтобы проверить, создает ли оно новый элемент.
     ...
     Если средство не появляется, остановите экспериментальном экземпляре Visual Studio. В Windows **запустить** меню **Сброс экспериментального экземпляра Microsoft Visual Studio 2010**. В меню **Построить** выберите пункт **Перестроить решение**. Затем проверьте DSL еще раз.
 ...
 **Директива подключения связи в окно сведений DSL**
 ...
 ![Директива подключения связи в окно сведений DSL](../modeling/media/connectionbuilder_4b.png)
