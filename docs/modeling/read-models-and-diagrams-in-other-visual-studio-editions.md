...
## <a name="obtaining-access-to-a-model-and-diagrams"></a>Получение доступа к модели и схемам
 ...
 По этой причине если вы хотите прочитать схему зависимостей, также необходим доступ к проекту моделирования, в котором он был создан. Для этого нужно либо открыть проект из [!INCLUDE[esprscc](../code-quality/includes/esprscc_md.md)], либо получить копию файлов проекта.
