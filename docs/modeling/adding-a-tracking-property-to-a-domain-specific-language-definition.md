...
ms.locfileid: "31953865"
---
# <a name="add-a-tracking-property-to-a-domain-specific-language-definition"></a>Добавление свойства отслеживания в определение доменного языка
...
## <a name="add-helper-classes-to-support-tracking-properties"></a>Добавление вспомогательных классов для поддержки отслеживания свойства
...
## <a name="add-custom-code-for-the-custom-type-descriptor"></a>Добавить пользовательский код для настраиваемого дескриптора типа
...
## <a name="add-custom-code-for-the-tracking-property"></a>Добавить пользовательский код для отслеживания свойства
