...
## <a name="troubleshoot-code-maps-for-c-and-c-code"></a>Устранение неполадок в картах C++ кода для C и кода
...
Эти проблемы могут возникнуть при создании карт кода для C и C++ кода:
