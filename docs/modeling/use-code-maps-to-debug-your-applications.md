...
## <a name="share-your-discovery-and-next-steps"></a>Совместное использование обнаружения и следующие действия  
 ...
 ![Карта кода &#45; Комментарий и помеченные элементы](../modeling/media/codemapstoryboardpaint12a.png "CodeMapStoryboardPaint12A")  
 ...
 ![Карта кода &#45; Общий доступ, экспорт почты](../modeling/media/codemapstoryboardpaint13.png "CodeMapStoryboardPaint13")  
