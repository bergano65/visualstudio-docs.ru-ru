...
![Карта кода &#45; сопоставить связи в коде](../modeling/media/codemapstoryboardpaint.png)
...
## <a name="start-mapping-the-code"></a>Запуск сопоставления кода
 ...
 ![Карта кода &#45; Показать метода и соответствующих полей](../modeling/media/codemapstoryboardpaint3.png)
...
## <a name="understand-relationships-between-pieces-of-code"></a>Отношения между частями кода
 ...
 ![Карта кода &#45; найти все ссылки](../modeling/media/codemapstoryboardpaint6.png)
...
## <a name="share-your-discovery-and-next-steps"></a>Совместное использование обнаружения и следующие действия
 ...
 ![Карта кода &#45; общего ресурса, экспорт, почта](../modeling/media/codemapstoryboardpaint13.png)
...
## <a name="fix-the-problem-and-show-what-you-did"></a>Устранение проблемы и отображение сделанного
 ...
 ![Карта кода &#45; подтверждение исправление кода](../modeling/media/codemapstoryboardpaint15.png)
...
> При обновлении карты можно увидеть сообщение об обновлении индекса кода, используемого для создания карты. Это значит, что кто-то изменил код, в результате чего ваша карта не соответствует текущему коду. Это не помешает обновить карту, однако может потребоваться заново создать карту, чтобы убедиться, что она соответствует коду.
 ...
 Теперь после завершения анализа. Вы успешно нашли и устранили проблему путем сопоставления кода. Также у вас есть карта, с помощью которой можно переходить по коду, вспоминать предыдущие действия и просматривать действия, предпринятые для решения проблемы.
