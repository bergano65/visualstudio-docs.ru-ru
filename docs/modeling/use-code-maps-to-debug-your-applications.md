...
## Определение проблемы  
 ...
 ![Карта кода — поиск кода](~/docs/modeling/media/codemapstoryboardpaint1.png "CodeMapStoryboardPaint1")  
...
## Запуск сопоставления кода  
 ...
 ![Карта кода — отображение метода и соответствующих полей](~/docs/modeling/media/codemapstoryboardpaint3.png "CodeMapStoryboardPaint3")  
...
## Отношения между частями кода  
 ...
 ![Открытие карты кода из редактора кода](~/docs/modeling/media/codemapstoryboardpaint6a.PNG "CodeMapStoryboardPaint6A")  
