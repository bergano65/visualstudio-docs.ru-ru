...
Если обозреватель не отображается в экземпляре отладки Visual Studio, в меню **вид** выберите пункт **другие окна**, а затем щелкните *\<язык >* **Explorer**.
