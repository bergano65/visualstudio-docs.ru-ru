...
Чтобы создать новый доменный язык, создайте новое решение Visual Studio с помощью шаблона проекта предметно-ориентированного языка.
...
Если обозреватель не отображается в экземпляре отладки Visual Studio, выберите в меню **вид** пункт **другие окна**, а затем щелкните *\<Your язык >* **Explorer**.
...
Дополнительные сведения см. в статьях [Создание кода на основе предметно-](../modeling/generating-code-from-a-domain-specific-language.md) ориентированного языка и [написание кода для настройки предметно-](../modeling/writing-code-to-customise-a-domain-specific-language.md)ориентированного языка.
