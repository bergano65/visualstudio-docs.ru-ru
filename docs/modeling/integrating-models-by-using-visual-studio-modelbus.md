...
ms.locfileid: "72667783"
---
# <a name="integrate-models-by-using-visual-studio-modelbus"></a>Интеграция моделей с помощью Visual Studio ModelBus

Visual Studio ModelBus предоставляет метод для создания связей между моделями и из других средств в модели. Например, можно связать модели доменного языка (DSL) и модели UML. или создать интегрированный набор DSL.
...
- В проекте DSL ссылка добавляется в **Microsoft. VisualStudio. моделирование. SDK. Integration. 11.0. dll**
