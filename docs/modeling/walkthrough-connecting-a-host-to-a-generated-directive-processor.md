...
## <a name="use-domain-specific-language-tools-to-generate-a-directive-processor"></a>Использование Средства предметно-ориентированных языков для создания обработчика директив
