...
![DSL&#45;ЕМД&#95;Merge](../modeling/media/dsl-emd_merge.png)
...
4. Повторно создайте решение. Это займет больше времени, чем обычно, поскольку созданный код будет обновлен из модели.
...
3. Повторно создайте решение. Это займет больше времени, чем обычно, поскольку созданные файлы кода будут обновлены из модели.
