---
title: Практическое руководство. Расширение конструктора предметно-ориентированных языков
ms.date: 11/04/2016
ms.topic: conceptual
author: gewarren
ms.author: gewarren
...
1.  Создайте новый проект с помощью **библиотеки классов** шаблона проекта. Этот проект будет содержать код вашего расширения.

2.  Создайте новый **проект VSIX** проекта.
