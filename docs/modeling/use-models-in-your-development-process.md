...
|**Категории**|**Ссылки**|  
|------------------|---------------|  
|**Видео**|![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [MSDN видеоролики: как создание и использование моделей и схем UML (Visual Studio 2010 Ultimate)](http://go.microsoft.com/fwlink/?LinkId=214460)<br /><br /> ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9: UML в Visual Studio 2010](http://go.microsoft.com/fwlink/?LinkID=201106)<br /><br /> ![ссылка на видео](~/docs/data-tools/media/playvideo.gif "PlayVideo") [MSDN как серия: средства UML и расширяемость (Visual Studio 2010 Ultimate)](http://go.microsoft.com/fwlink/?LinkID=214467)|  
