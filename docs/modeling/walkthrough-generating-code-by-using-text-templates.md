...
ms.locfileid: "62934330"
---
# <a name="walkthrough-generate-code-by-using-text-templates"></a>Пошаговое руководство. Создание кода с помощью текстовых шаблонов
...
В строго типизированной версии изменение схемы XML приводит изменения к классам. Компилятор выделит части кода приложения, который должен быть изменен. В нетипизированной версии, использующей универсальный XML-код, такая поддержка отсутствует.
...
Добавление файла текстового шаблона, а также присваивается расширение выходного *.cs*.
...
## <a name="complete-the-text-template"></a>Завершить текстового шаблона
...
### <a name="run-the-test-program"></a>Запустите программу тестирования
...
### <a name="write-and-update-the-application"></a>Запись и обновление приложения
...
Для повторного создания классов после изменения образца XML файла, нажмите кнопку **преобразовать все шаблоны** в **обозревателе решений** панели инструментов.
...
## <a name="troubleshoot-the-text-template"></a>Текстовый шаблон
