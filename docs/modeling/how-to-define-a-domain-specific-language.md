...
- Visual Studio
- Visual Studio рабочей нагрузки разработки расширений (включает пакет SDK для Visual Studio)
- Пакет SDK моделирования (установить как отдельного компонента в Visual Studio)
...
1. Создайте новый **доменный язык** проекта.
...
1. **Щелкните преобразовать все шаблоны** на панели инструментов в обозревателе решений, чтобы сгенерировать код конструктора DSL. Этот шаг можно автоматизировать. Дополнительные сведения см. в разделе [как автоматизировать преобразовать все шаблоны](/previous-versions/visualstudio/visual-studio-2012/ff521399\(v\=vs.110\)).
