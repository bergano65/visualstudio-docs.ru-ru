...
##  <a name="Update"></a> Разработка или обновление приложения с помощью схем зависимостей
...
2.  [Определите слои для представления первичных функциональных областей или компонентов](#CreateLayers) приложения. Дайте этим слоям имена согласно их функциям, например "Презентация" или "Службы". Если у вас есть [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] решение, можно связать каждый слой с коллекцией *артефакты*, таких как проекты, пространства имен, файлы и т. д.
