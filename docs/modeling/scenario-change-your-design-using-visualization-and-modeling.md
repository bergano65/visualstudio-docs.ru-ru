...
- [Планирование и мониторинг работы](#plan-and-track-work)
...
Обе команды также используют проверку зависимостей, чтобы убедиться, что код в разработке остается согласованным с архитектурой. См.:
...
### <a name="ValidatingCode"></a>Обеспечение соответствия кода дизайну
...
- [TFVC запись с проверкой изменений](/azure/devops/pipelines/build/triggers#gated)
...
|**Схема**|**Описание**|
|-|-|
|Схема зависимостей|Определение логической архитектуры системы относительно классов.<br /><br /> Используйте проверку зависимостей, чтобы убедиться, что код остается согласованным с макетом.<br /><br /> См.:<br /><br /> - [создания схем зависимостей из кода](../modeling/create-layer-diagrams-from-your-code.md)<br />- [схемы зависимостей: справочные материалы](../modeling/layer-diagrams-reference.md)<br />[схемы зависимостей - : рекомендации](../modeling/layer-diagrams-guidelines.md)<br />- [проверки кода с помощью схем зависимостей](../modeling/validate-code-with-layer-diagrams.md)|
|Карта кода|Визуализация организации и отношений в имеющемся коде.<br /><br /> Для идентификации классов, их отношений и методов создайте карту кода, показывающую эти элементы.<br /><br /> См.:<br /><br /> - [сопоставлять зависимости в решениях](../modeling/map-dependencies-across-your-solutions.md)|

### <a name="DescribeLayers"></a>Опишите логическую архитектуру: схемы зависимостей
...
|**Схема**|**Описание**|
|-|-|
|Карта кода|Визуализация организации и отношений в имеющемся коде.<br /><br /> Чтобы создать слои, сформируйте карту кода, а затем сгруппируйте элементы на карте как потенциальные слои. Перетащите группы из схемы на схему зависимостей.<br /><br /> См.:<br /><br /> - [сопоставлять зависимости в решениях](../modeling/map-dependencies-across-your-solutions.md)<br />- [просмотра и реорганизации карт кода](../modeling/browse-and-rearrange-code-maps.md)|
