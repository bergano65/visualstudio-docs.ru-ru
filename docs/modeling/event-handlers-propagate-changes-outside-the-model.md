...
## <a name="use-events-to-make-undoable-adjustments-in-the-store"></a>События можно использовать для корректировки отменяемой в хранилище
