...
## <a name="AddRelatedCode"></a> Добавление связанного кода в сопоставление
 ...
 Теперь у вас есть Map-то, что дальше? Если вы работаете с C# или Visual Basic, добавьте элементы, такие как поля, свойства и другие методы, чтобы отвести данные о происходящих в коде.
