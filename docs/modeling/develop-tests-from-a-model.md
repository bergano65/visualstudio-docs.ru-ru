...
#### <a name="linking-tests-to-use-cases"></a>Связывание тестов и вариантов использования
 Если вы используете [!INCLUDE[TCMlong](../modeling/includes/tcmlong_md.md)] для разработки и выполнения тестов, можно организовать тесты по требование вариант использования и истории рабочих элементов. В модели эти рабочие элементы можно связать с вариантами использования. Это позволит быстро отслеживать изменения требований в тестах и фиксировать выполнение каждого варианта использования.
...
1. В [!INCLUDE[TCMlong](../modeling/includes/tcmlong_md.md)] создайте требование и набор тестов на его основе.
    ...
    Создаваемое требование является рабочим элементом в [!INCLUDE[vstsTfsShort](../modeling/includes/vststfsshort_md.md)]. Возможно, пользовательская История, требование или вариант использования рабочий элемент, в зависимости от шаблона процесса, который используется в проекте в Team Foundation. Дополнительные сведения см. в разделе [о гибкие инструменты и гибкого управления проектами](/azure/devops/boards/backlogs/backlogs-overview?view=vsts).

2. Свяжите рабочий элемент "требование" с одним или несколькими вариантами использования в модели.

    В схему вариантов использования щелкните вариант использования правой кнопкой мыши и выберите **связать с рабочим элементом**.
...
2. Свяжите рабочий элемент "требование" с одним или несколькими элементами в модели.
    ...
    В схеме моделирования щелкните элемент, комментарий или отношение правой кнопкой мыши и выберите **связать с рабочим элементом**.
