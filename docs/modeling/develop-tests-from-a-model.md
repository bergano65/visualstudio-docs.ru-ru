...
1. В [!INCLUDE[TCMlong](../modeling/includes/tcmlong_md.md)] создайте требование и набор тестов на его основе.
    ...
    Создаваемое требование является рабочим элементом в [!INCLUDE[vstsTfsShort](../modeling/includes/vststfsshort_md.md)]. Возможно, пользовательская История, требование или вариант использования рабочий элемент, в зависимости от шаблона процесса, который используется в проекте в Team Foundation. Дополнительные сведения см. в разделе [о гибкие инструменты и гибкого управления проектами](/azure/devops/boards/backlogs/overview?view=vsts).
