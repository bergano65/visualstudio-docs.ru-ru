...
|Включить перетаскивания из схемы, другие DSL и Windows элементов|См. в разделе [как: Добавление обработчика перетаскивания и вставки](../modeling/how-to-add-a-drag-and-drop-handler.md)|
