...
ms.locfileid: "66744716"
---
# <a name="customize-the-properties-window"></a>Настройка окна свойств
...
## <a name="expose-style-features"></a>Предоставляют возможности стиля
...
## <a name="forwarding-display-properties-of-related-elements"></a>Перенаправление: Отображение свойств связанных элементов
...
### <a name="add-property-forwarding"></a>Добавить свойство переадресации
...
#### <a name="forward-a-property-from-another-element"></a>Пересылка свойство из другого элемента
...
### <a name="define-a-domain-property-that-has-an-external-type"></a>Определить свойство домена, которое имеет внешний тип
...
### <a name="set-a-property-editor"></a>Установите редактор свойств
...
Можно указать собственный редактор или редактор .NET, такие как <xref:System.Windows.Forms.Design.FileNameEditor> или <xref:System.Drawing.Design.ImageEditor>. Например используйте следующую процедуру, должен иметь свойство, в котором пользователь может ввести имя файла.

#### <a name="define-a-file-name-domain-property"></a>Определить свойство домена имя файла
...
### <a name="define-your-own-property-editor"></a>Определить собственный редактор свойств
...
## <a name="provide-a-drop-down-list-of-values"></a>Укажите список раскрывающегося списка значений
