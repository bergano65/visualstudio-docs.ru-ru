...
1. Создайте [!INCLUDE[dsl](../modeling/includes/dsl_md.md)] решение, которое содержит по крайней мере два класса, которые в этом примере называются **Book** и **Author**. Между **книгой** и **автором**должна быть связь любого вида.
