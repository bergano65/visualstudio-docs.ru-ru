...
Разрешить для создаваемого кода вручную в дополнение к сгенерированному коду. Это нередко схеме создания кода иметь возможность учесть все возможные варианты, которые могут возникнуть. Таким образом следует ожидать добавить или переопределить некоторые из созданного кода. Где автоматически создаваемый материал — на языке .NET, такие как C# или Visual Basic, которые удобно использовать две стратегии:
...
Создайте код, не файлы конфигурации.
...
Используйте папку с созданным кодом.
