...
## <a name="dependency-links"></a>Связи зависимостей  
 ...
 ![ILayerDependencyLink соединяет два элемента Ilayer. ] (~/docs/modeling/media/layerapi_dependency.png "LayerApi_Dependency")  
...
## <a name="comments"></a>Комментарии  
 ...
 ![Комментарии можно прикрепить к любому элементу слоя. ] (~/docs/modeling/media/layerapi_comments.png "LayerApi_Comments")  
...
```  
 ...
 ![Каждый элемент ILayerElement представлен фигурой IShape. ] (~/docs/modeling/media/layerapi_shapes.png "LayerApi_Shapes")  
