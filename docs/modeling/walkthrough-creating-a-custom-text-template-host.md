...
ms.locfileid: "31977206"
---
# <a name="walkthrough-create-a-custom-text-template-host"></a>Пошаговое руководство: Создание основное приложение текстового шаблона
...
## <a name="create-a-custom-text-template-host"></a>Создайте основное приложение текстового шаблона
...
4.  Для [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] , откройте **проекта** меню и выберите пункт **Свойства CustomHost**. В **автоматически запускаемый объект** выберите **CustomHost.Program**.

5.  На **файл** меню, нажмите кнопку **сохранить все**.

6.  В меню **Сборка** выберите **Собрать решение**.

## <a name="test-the-custom-host"></a>Тестирование пользовательского основного приложения
...
2.  Введите путь к исполняемому файлу пользовательского основного приложения, но пока не нажимайте клавишу ВВОД.
    ...
    > [!NOTE]
    > Вместо того чтобы вводить адрес, можно просмотреть файл CustomHost.exe в **Проводник** и перетащить его в окно командной строки.
...
4.  Введите путь к файлу текстового шаблона и нажмите клавишу ВВОД.
    ...
    > [!NOTE]
    > Вместо того чтобы вводить адрес, можно просмотреть файл TestTemplate.tt в **Проводник** и перетащить его в окно командной строки.

     Пользовательское ведущее приложение запустится и выполнит процесс преобразования текстового шаблона.

5.  В **Проводник**, перейдите в папку, содержащую файл TestTemplate.tt.
