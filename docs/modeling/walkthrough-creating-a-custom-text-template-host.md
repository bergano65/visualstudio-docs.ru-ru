---
title: Пошаговое руководство. Создание пользовательского основного приложения для текстовых шаблонов
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
Объект *основное приложение текстовых шаблонов* предоставляет среду, которая позволяет *модуль преобразования текстового шаблона* для запуска. Основное приложение отвечает за управление взаимодействием этого процессора с файловой системой. Подсистема или *процессора директив* , требуется файл или сборка, могут запросить ресурс с узла. В ответ основное приложение просмотрит каталоги и глобальный кэш сборок в поиске запрошенного ресурса. Дополнительные сведения см. в разделе [процесс преобразования текстового шаблона](../modeling/the-text-template-transformation-process.md).
