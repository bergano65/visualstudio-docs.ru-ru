...
|**Показать представление модели содержимого**|Переключается в представление модели содержимого. Доступ к этому представлению можно получить с помощью сочетания клавиш: **Ctrl**+**2**.|
