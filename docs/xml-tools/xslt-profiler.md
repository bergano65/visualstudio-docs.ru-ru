---
title: "Профилировщик XSLT | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
> [!NOTE]
>  Вид некоторых окон может по-разному в вашей версии Visual Studio не в следующих разделах, так как некоторые визуальные элементы были изменены с момента были записаны эти снимки экрана.  
