---
title: "Пошаговое руководство: Отладка таблицы стилей XSLT | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
2.  Тип `$bookAverage` в **имя** и нажмите клавишу ВВОД.  
  
     В окне отобразится значение переменной `$bookAverage`.  
  
3.  Тип `self::node()` в **имя** и нажмите клавишу ВВОД.  
...
1.  Нажмите клавишу **F5** для продолжения.  
...
2.  Нажмите клавишу **F5** для продолжения.  
...
3.  Нажмите клавишу **F5** для продолжения.  
