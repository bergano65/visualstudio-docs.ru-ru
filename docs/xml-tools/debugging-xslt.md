---
title: "Отладка XSLT | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
Для отладки XSLT вы можете использовать отладчик среды Visual Studio.Отладчик поддерживает задание точек останова, просмотр состояний выполнения XSLT и т. д.Отладка XSLT доступна в Visual Studio Team System и в выпуске Professional Edition.  
  
## В этом подразделе  
 [Новые возможности отладчика XSLT](../xml-tools/what-s-new-in-the-xslt-debugger.md)  
 Описывает новые функции данной версии отладчика XSLT.  
  
 [Практическое руководство. Запуск отладки XSLT.](../Topic/How%20to:%20Start%20Debugging%20XSLT.md)  
 ...
 Описывает, как вычислить выражение XPath с помощью диалогового окна **QuickWatch**.  
...
## Связанные подразделы  
 ...
 [Справочник по XSLT](http://msdn.microsoft.com/ru-ru/678bcd68-cbbb-4be5-9dd2-40f94488a1cf)  
