---
title: Проверки узлов с использованием представления модели содержимого в конструктор XML-схем
ms.date: 11/04/2016
ms.topic: conceptual
...
8. Нажмите кнопку **Показать документацию** кнопки в панели инструментов XSD для переключения документации. Включение и отключение документации можно также осуществлять щелчком правой кнопкой мыши области конструктора.

9. Щелкните правой кнопкой мыши `purchaseOrder` узел и выберите **Создание образца XML** Чтобы просмотреть документ экземпляра XML.
