...
## <a name="keyword-search"></a>Поиск по ключевому слову
 ...
 Обозреватель XML-схем поиск схемы для следующих атрибутов:

-   Атрибутам `name` или `ref`, удовлетворяющим указанному ключевому слову. Это позволяет найти элементы, атрибуты, типы и т. д., по имени.
