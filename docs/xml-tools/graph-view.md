---
title: Представление графика конструктора схемы XML
ms.date: 11/04/2016
ms.topic: reference
...
![Представление графика конструктора схемы XML](../xml-tools/media/xsddesigner_graphview.gif)
...
![Конструктор XSD; представление графика](../xml-tools/media/xsdgraphviewwatermark.gif)
