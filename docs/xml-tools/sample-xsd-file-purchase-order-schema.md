...
description: Просмотрите пример XSD-файла для схемы заказа на покупку, который используется в различных примерах в документации по конструктору схем XSD.
