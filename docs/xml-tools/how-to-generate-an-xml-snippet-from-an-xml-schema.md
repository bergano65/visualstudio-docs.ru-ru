...
ms.locfileid: "34477682"
---
# <a name="how-to-generate-an-xml-snippet-from-an-xml-schema"></a>Как: создать XML-фрагмент из XML-схемы

Редактор XML может создавать XML-фрагменты из схемы на языке XSD. Например, во время работы в XML-файл, если курсор находится рядом с именем элемента, можно нажать клавишу **вкладке** чтобы заполнить элемент XML-данными, созданными из информации схемы для этого элемента.
...
## <a name="example"></a>Пример
 ...
 Шаги в этом разделе показано, как использовать функцию фрагмент XML в редакторе XML сформированные схемой.
...
6.  Нажмите кнопку **ОК**.
     ...
     Схема XML теперь является связанный с XML-документа.
