---
title: Добавить узлы в рабочую область из начального представления в конструктор XML-схем
ms.date: 11/04/2016
...
2.  Щелкните правой кнопкой мыши в редакторе XML и выберите **конструктор представлений**.
     ...
     В **сведения о наборе схем** Обратите внимание, что имеются два (**2**) **глобальных сложных типов**.

3.  Щелкните **добавить** ссылку справа от **глобальных сложных типов** заголовок.
