---
title: "Интеграция XML-литералов с обозревателем XML-схем | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
Visual Basic поддерживает XML\-литералы, что означает возможность включать XML\-фрагменты непосредственно в код Visual Basic.Дополнительные сведения содержатся в разделе [Общие сведения об XML\-литералах](http://go.microsoft.com/fwlink/?LinkId=140325).  
 ...
 Данная возможность впервые появилась в Visual Studio 2008 SP1.Просмотреть интервью, в котором подробно обсуждается данная возможность, можно по ссылке [Интервью канала 9: Обозреватель XML\-схем в Visual Studio 2008 SP1](http://go.microsoft.com/fwlink/?LinkId=140183).  
