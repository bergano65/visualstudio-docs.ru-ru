---
title: "Как: Создание и изменение файла XSD-схемы | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  В Visual Studio откройте **файл** и выбрать пункт **New** и затем **файл**. Или используйте сочетание клавиш CTRL+N.  
  
2.  В **новый файл** выберите **XML-схема** и нажмите кнопку **откройте**.  
