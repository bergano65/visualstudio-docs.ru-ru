...
10. В **укажите имя рабочего процесса для отладки** примите имя по умолчанию (**ExpenseReport — Workflow1**). Оставьте значение по умолчанию шаблон рабочего процесса типа (**рабочий процесс списка)**. Нажмите кнопку **Далее**.  
