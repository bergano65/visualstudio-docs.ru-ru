...
### Объектная модель автоматизации Visual Studio  
 ...
 Дополнительные сведения об объектной модели автоматизации см. в разделах [Расширение среды Visual Studio](../Topic/Extending%20the%20Visual%20Studio%20Environment.md) и [Справочник по автоматизации и возможностям расширения среды](../Topic/Automation%20and%20Extensibility%20Reference.md).  
