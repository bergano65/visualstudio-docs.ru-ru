...
ms.locfileid: "34691421"
---
# <a name="browsing-sharepoint-connections-that-use-server-explorer"></a>Просмотр подключений SharePoint, использующие обозреватель сервера
...
## <a name="node-shortcut-menu-commands"></a>Команды контекстного меню узла
 Каждый узел имеет контекстное меню, который можно открыть, щелкнув правой кнопкой мыши узел или выбрав его и затем выбрав **Shift**+**F10** ключей. Команды узла может включать следующее:  
