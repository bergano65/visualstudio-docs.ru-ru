---
title: Как выполнить Службе SharePoint Project | Документация Майкрософт
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "54869007"
---
# <a name="how-to-retrieve-the-sharepoint-project-service"></a>Как выполнить Получить службы проектов SharePoint
