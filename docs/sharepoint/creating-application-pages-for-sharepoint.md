...
>  Проектировать страницу можно только в **источника** представлении конструктора. **Разработки** представление конструктора для страниц приложений отключен.  
 ...
 Чтобы перейти на страницу приложения, нужно вручную перейти к расположению страницы приложения (например: http://*имя_сервера*/_layouts/*Project_Name*  /ApplicationPage1.aspx).  
