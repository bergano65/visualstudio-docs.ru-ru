---
title: "Как: построение решений SharePoint | Документы Microsoft"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
1.  Решите, осуществляется ли отладки или выпуска. Дополнительные сведения см. в разделе [параметры проекта отладчика](/visualstudio/debugger/debugger-project-settings).  
