...
- [Addg компонента и приемника событий компонента](#add-a-feature-and-feature-event-receiver).

- [Настройка и развертывание приложения SharePoint](#configure-and-deploy-the-sharepoint-application).

- [Запуск приложения SharePoint](#run-the-sharepoint-application).

- [Просмотр и Интерпретация результатов профиля](#view-and-interpret-the-profile-results).
