...
1. Обратите внимание, что в разделе **функции, выполняющие наиболее индивидуальную работу** в отчете профилирования выборки, `TimeCounter` находится ближе к началу списка.
