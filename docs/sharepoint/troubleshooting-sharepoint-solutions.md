...
-   Windows PowerShell Можно удалить модель, введя следующую команду в командной строке: **Remove-SPBusinessDataCatalogModel**. Дополнительные сведения см. в разделе [основные командлеты (SharePoint Server 2010)](http://go.microsoft.com/fwlink/?LinkID=182375) на сайте Microsoft TechNet.  
