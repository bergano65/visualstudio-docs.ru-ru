...
-   Убедитесь, что у вас есть права администратора на сайте SharePoint. Дополнительные сведения см. в разделе [!INCLUDE[TLA2#tla_office](../sharepoint/includes/tla2sharptla-office-md.md)] интерактивной статьи [назначать или удалять администраторов приложений служб в SharePoint Server](https://docs.microsoft.com/en-us/sharepoint/administration/assign-or-remove-administrators-of-service-applications).  
