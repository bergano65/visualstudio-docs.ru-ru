...
### <a name="resolution"></a>Разрешение
 ...
 Чтобы устранить эту проблему, разверните решение в строке меню, выбрав **сборка** > **развернуть**. (Не отлаживать решение, нажав клавишу **F5** ). Затем удалите экземпляр списка в SharePoint.
