...
# Reference (SharePoint Tools Extensibility)
  Данный раздел содержит справочную документацию для расширения инструментов SharePoint в Visual Studio.  
...
## Содержание  
 ...
 Содержит справочную документацию API для расширения инструментов SharePoint в Visual Studio.  
