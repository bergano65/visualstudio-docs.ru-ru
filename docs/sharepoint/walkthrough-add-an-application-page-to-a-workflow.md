...
15. Отображать страницу приложения сводки отчета по расходам, открыв следующий URL-адрес в веб-браузер: **http://***имя_системы***/_layouts/ExpenseReport/ApplicationPage1.aspx**.  
