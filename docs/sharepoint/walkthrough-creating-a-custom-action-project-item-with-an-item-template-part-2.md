...
4.  В разделе **Communications** заголовок в верхней части страницы выберите **Центр разработчиков SharePoint** связать, убедитесь, что в браузере откроется веб-сайт http://msdn.microsoft.com/sharepoint/default.aspxи затем закройте браузер.  
