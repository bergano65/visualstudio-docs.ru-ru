...
14. В списке **Свойства** выберите свойство **Сортировка и группировка**, затем нажмите кнопку ![Значок эллипса](~/docs/sharepoint/media/ellipsisicon.gif "Значок эллипса") с многоточием, чтобы открыть диалоговое окно **Сортировка и группировка**.  
