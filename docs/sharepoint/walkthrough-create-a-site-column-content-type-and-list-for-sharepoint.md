...
2. В диалоговом окне **Новый проект** в области **визуальный C#**  или **Visual Basic**разверните узел **Office/SharePoint** и выберите пункт **решения SharePoint**.
...
1. Добавьте новый столбец сайта. Для этого в **Обозреватель решений**щелкните правой кнопкой **мыши проект курса** и выберите **добавить** > **новый элемент**.
...
3. В файле *Elements. XML* в столбце сайта оставьте значение параметра **тип** как **текст**, измените параметр **группы** на " **курсовые столбцы сайта**". По завершении файл *Elements. XML* столбца site должен выглядеть, как в следующем примере.
...
3. В **визуальном C#**  элементе или **Visual Basic**разверните узел **SharePoint** .
