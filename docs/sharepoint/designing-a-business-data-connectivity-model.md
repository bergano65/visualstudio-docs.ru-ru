...
ms.locfileid: "34766068"
---
# <a name="design-a-business-data-connectivity-model"></a>Разработка модели подключения к бизнес-данным
...
## <a name="add-filter-descriptors"></a>Добавьте дескрипторы фильтров
...
## <a name="debug-the-solution-that-contains-the-model"></a>Отладка решения, которая содержит модель
...
## <a name="locate-documentation-for-bdc-model-elements"></a>Найдите в документации для элементов модели BDC
