...
|![Обучение](../sharepoint/media/vs-icon-training.gif "Обучение")|**Блоги**<br /><br /> -   [Блог о разработке приложений SharePoint в Visual Studio](https://blogs.msdn.microsoft.com/vssharepointtoolsblog/)|
