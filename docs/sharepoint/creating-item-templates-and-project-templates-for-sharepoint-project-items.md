...
|----------------------| - |
| *Elements.XML* | Объект *элемента Feature* файл. Этот файл определяет пользовательский Интерфейс и поведение настройки, созданные элементом проекта. Каждый тип настройки, такие как экземпляры списков, типы содержимого или пользовательские действия, имеет другую схему, который определяет содержимое этого файла. Дополнительные сведения см. в разделе [стандартный блок: функции](http://go.microsoft.com/fwlink/?LinkId=169183) и [Feature Schemas](http://go.microsoft.com/fwlink/?LinkId=169192). |
| *Schema.XML* | Файл схемы для определения списков. Дополнительные сведения см. в разделе [стандартный блок: списков и библиотек документов](http://go.microsoft.com/fwlink/?LinkId=177792) и [Schema.xml](http://go.microsoft.com/fwlink/?LinkId=177793). |
| *.WebPart* | Объект *определение веб-части* файл. Этот файл содержит параметры свойств для веб-части. Дополнительные сведения см. в разделе [стандартный блок: веб-частей](http://go.microsoft.com/fwlink/?LinkId=177791). |
