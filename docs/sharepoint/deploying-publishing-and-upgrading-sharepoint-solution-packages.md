...
|Без активации|Эта конфигурация развертывания выполняется те же действия, как конфигурация по умолчанию, но пропускает этап активации.|  
 ...
 Можно также добавить команды, выполняемые до и после развертывания. Дополнительные сведения см. в разделе [как: команд развертывания SharePoint задать](../sharepoint/how-to-set-sharepoint-deployment-commands.md).  
