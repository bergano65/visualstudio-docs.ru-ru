...
3. В верхней части диалогового окна убедитесь, что **.NET Framework 3,5** отображается в списке версий .NET Framework.
    ...
    Проекты для [!INCLUDE[wss_14_long](../sharepoint/includes/wss-14-long-md.md)] и [!INCLUDE[moss_14_long](../sharepoint/includes/moss-14-long-md.md)] нуждаются в этой версии .NET Framework.
