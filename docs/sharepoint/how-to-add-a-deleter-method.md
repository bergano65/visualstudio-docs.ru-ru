---
title: Как выполнить Добавление метода Deleter | Документация Майкрософт
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "53924180"
---
# <a name="how-to-add-a-deleter-method"></a>Как выполнить Добавление метода Deleter
