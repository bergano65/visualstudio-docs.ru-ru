...
- Поддерживаемые версии Microsoft Windows, SharePoint и [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)].
...
2. В файле кода SiteColumnProjectItemTypeProvider добавьте точку останова в первой строке кода в `InitializeType` метод, а затем выберите **F5** клавишу, чтобы начать отладку.
