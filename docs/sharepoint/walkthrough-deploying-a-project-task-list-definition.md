...
2.  В диалоговом окне **Опубликовать** выберите переключатель **Опубликовать в файловой системе**.  
     ...
     Можно изменить целевое расположение в диалоговом окне **Опубликовать** с помощью кнопки с многоточием ![Значок эллипса](~/sharepoint/media/ellipsisicon.gif "Значок эллипса") и выбора другого расположения.  
