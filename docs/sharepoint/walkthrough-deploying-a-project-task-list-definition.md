---
title: "Пошаговое руководство. Развертывание определения списка задач проекта | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
2.  В диалоговом окне **Опубликовать** выберите переключатель **Опубликовать в файловой системе**.  
     ...
     Можно изменить целевое расположение в диалоговом окне **Опубликовать** с помощью кнопки с многоточием ![Значок эллипса](../sharepoint/media/ellipsisicon.png "Значок эллипса") и выбора другого расположения.  
