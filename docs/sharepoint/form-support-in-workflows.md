...
|Изменение|Не применяется Формы изменения ASPX не могут быть созданы в SharePoint Designer.|Не применяется Формы изменения InfoPath не могут быть созданы в SharePoint Designer, за исключением встроенного рабочего процесса SharePoint Server, который не включается в WSP-файл при экспорте рабочего процесса.|
