...
## <a name="form-support-in-imported-sharepoint-reusable-workflows"></a>Поддержка форм в рабочих процессах импортированных SharePoint для повторного использования  
