...
|-------------------------------|------------------------------------|  
|Имя|Обязательный. Имя пакета по умолчанию равно *ProjectName*.|  
|Сброс веб-сервера|Необязательно. Выберите, чтобы перезапустить веб-сервера после установки WSP-файл на сервере SharePoint.|  
|Тип сервера развертывания|Обязательный. Область по умолчанию имеет значение ApplicationServer.<br /><br /> ApplicationServer: Описание сервера, на котором размещены службы.<br /><br /> WebFrontEnd: Описание сервера, на котором размещается веб-сайтов.|  
|Элементы в решении|Все элементы проекта SharePoint и компонентов, которые могут быть добавлены в пакет.|  
|Элементы в пакете|Необязательно. Все элементы SharePoint и компонентов, которые вы хотите развернуть пакет.|  
