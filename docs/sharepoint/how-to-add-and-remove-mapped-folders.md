...
ms.locfileid: "34767213"
---
# <a name="how-to-add-and-remove-mapped-folders"></a>Как: Добавление и удаление сопоставленных папок
...
## <a name="change-the-deployment-location-of-a-mapped-folder"></a>Изменение расположения сопоставленной папки развертывания  
