...
11. Поскольку шаблон **Импорт повторно используемого рабочего процесса SharePoint 2010** не импортирует связанные значения свойств импортируемого рабочего процесса, их необходимо ввести самостоятельно.  Описание процедуры  
    ...
    2.  Нажмите кнопку с многоточием \(![Эллипс конструктора ASP.NET для мобильных устройств](~/docs/sharepoint/media/mwellipsis.gif "Эллипс конструктора ASP.NET для мобильных устройств")\) рядом с одним из списковых свойств, например свойство **Конечный список**.  
