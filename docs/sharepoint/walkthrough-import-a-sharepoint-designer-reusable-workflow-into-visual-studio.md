...
2.  В **новый пустой веб-сайт** диалоговом окне перейдите на сайт SharePoint, где вы хотите создать рабочий процесс или использовать значение http://*имя_системы*/ и затем выберите **ОК** кнопка.  
