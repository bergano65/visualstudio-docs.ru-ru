---
title: "Практическое руководство. Добавление пользовательской сборки в функцию BDC | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
3.  В окне **Свойства** выберите свойство **Сборки** и нажмите кнопку многоточия \(![Эллипс конструктора ASP.NET для мобильных устройств](../sharepoint/media/mwellipsis.png "Эллипс конструктора ASP.NET для мобильных устройств")\).  
