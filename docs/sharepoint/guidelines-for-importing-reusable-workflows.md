...
ms.locfileid: "34767323"
---
# <a name="guidelines-for-importing-reusable-workflows"></a>Рекомендации по Импорт рабочих процессов с возможностью повторного использования
...
## <a name="import-reusable-workflows-by-using-the-import-reusable-workflow-template"></a>Импортировать рабочие процессы с помощью шаблона импорта рабочего процесса с возможностью повторного использования
...
### <a name="import-task-forms"></a>Импорт формы задач
...
## <a name="import-reusable-workflows-by-using-the-import-sharepoint-2010-solution-package-template"></a>Импортировать рабочие процессы с помощью шаблона импорта пакета решения SharePoint 2010
...
## <a name="import-globally-reusable-workflow-solutions"></a>Импорт решений глобального рабочего процесса
