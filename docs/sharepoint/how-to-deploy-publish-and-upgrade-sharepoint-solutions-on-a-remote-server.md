---
title: Развертывание, публикация и обновление решений SharePoint удаленно
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
5. Если необходима проверка подлинности пользователя, войдите на удаленный сервер
...
8. Если необходима проверка подлинности пользователя, войдите на удаленный сервер
