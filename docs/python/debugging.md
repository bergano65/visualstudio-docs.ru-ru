...
> [!Note]
> Отладчик всегда начинает работу с запуска активной среды Python для проекта. Сведения о том, как сделать активной другую среду, см. в статье [Среды Python](managing-python-environments-in-visual-studio.md).
