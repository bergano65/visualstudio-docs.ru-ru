...
![Точки останова в Visual Studio](~/python/media/debugging-breakpoints.png)
...
![Создание точки трассировки с помощью точки останова](~/python/media/debugging-tracepoint.png)
...
![Подсказки в отладчике](~/python/media/debugging-quick-tips.png)
...
![Окно видимых переменных в отладчике](~/python/media/debugging-autos-window.png)

Окно локальных переменных (**Отладка > Windows > Локальные**) отображает все переменные в текущей области, которые можно изменить.

![Окно "Локальные" в отладчике](~/python/media/debugging-locals-window.png)
...
![Окно контрольных значений в отладчике](~/python/media/debugging-watch-window.png)
...
![Визуализаторы строк](~/python/media/debugging-string-visualizers.png)
...
![Всплывающее окно исключения](~/python/media/debugging-exception-popup.png)
...
![Окно исключений](~/python/media/debugging-exception-settings.png)
...
![Свойства отладки проекта](~/python/media/debugging-project-properties.png)
...
![Интерактивное окно отладки Python](~/python/media/debugging-interactive.png)
...
Обратите внимание, что стандартные окна отладчика, такие как окно процессов, окно потоков и окно стека вызовов, не синхронизируются с интерактивным окном отладки. Это означает, что изменение активного процесса, потока или кадра в интерактивным окне отладки не влияет на другие окна отладчика, также как изменение активного процесса, потока или кадра в других окнах отладчика не влияет на интерактивное окно отладки.
...
![Параметры интерактивного окна отладки](~/python/media/debugging-interactive-options.png)
