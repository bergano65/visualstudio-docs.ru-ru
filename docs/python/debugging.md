...
>
> Чтобы управлять окружением и аргументами, создайте проект для кода, что можно легко сделать с помощью шаблона проекта [На основе существующего кода Python](python-projects.md#creating-a-project-from-existing-files).
