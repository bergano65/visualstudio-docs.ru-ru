...
|   |   |
|---|---|
| ![значок камеры для видеоролика](../install/media/video-icon.png "Посмотрите видео") | [Deep Dive: Use source control with Python projects (Подробный обзор. Использование системы управления версиями в проектах Python](https://youtu.be/Aq8eqApnugM) (8 мин 55 с, youtube.com). |
