...
1. Когда вам будет предложено установить внешние пакеты, выберите вариант **Install into a virtual environment** (Установить в виртуальной среде). Обратите внимание на элемент управления **Показать необходимые пакеты** в нижней части диалогового окна, который сообщает вам, какие пакеты будут установлены.
...
1. После создания проекта его можно тестировать локально, выбрав пункт меню **Отладка > Начать отладку** или нажав клавишу F5. По умолчанию приложение использует размещенный в памяти репозиторий, не требующий никакой настройки. При остановке веб-сервера все данные будут утеряны.
