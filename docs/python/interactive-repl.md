...
Наконец, можно выбрать код в файле и использовать описанную ниже команду [Send code to interactive](#send-code-to-interactive) (Отправить код в интерактивное окно).
