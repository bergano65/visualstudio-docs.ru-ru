...
![Интерактивное окно Python](~/python/media/interactive-window.png)
...
![Ссылка на интерактивное окно в окне Python Environments (Среды Python)](~/python/media/interactive-window-opening.png)
...
![Пункты меню интерактивного окна после выбора "Просмотр" > "Другие окна"](~/python/media/interactive-window-menu.png)
...
![Пункт меню Execute Project in Python Interactive (Выполнить проект в интерактивном окне Python)](~/python/media/interactive-execute-project.png)
...
![Области интерактивного окна](~/python/media/interactive-scopes.png)
...
![Интерактивное окно в области importlib](~/python/media/interactive-importlib-scope.png)
...
![Команда меню "Отправить в Interactive"](~/python/media/interactive-send-to.png)
