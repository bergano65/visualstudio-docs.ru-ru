...
1. Чтобы проверить, содержит ли папка файл `ls ../home/python361x64`python.exe`dir ..\home\python361x64` и (или) другие файлы интерпретатора, введите команду вида *или*.
...
Дополнительные сведения о содержимом файла [web.config](publishing-python-web-applications-to-azure-from-visual-studio.md) для веб-приложений Bottle, Flask и Django см. в руководстве по *публикации в Azure*.
