---
title: "Работа с Python в Visual Studio. Шаг 0 — установка | Документация Майкрософт"
description: "Шаг 0 (необходимые условия) базового руководства по работе с Python в среде Visual Studio описывает, как установить поддержку Python в Visual Studio."
ms.custom: 
ms.date: 01/16/2018
ms.reviewer: 
ms.suite: 
...
> [!Note]
> Сейчас Python поддерживается только в Visual Studio для Windows. В Mac и Linux его поддержка реализуется посредством Visual Studio Code. См. [вопросы и ответы](overview-of-python-tools-for-visual-studio.md#questions-and-answers).
