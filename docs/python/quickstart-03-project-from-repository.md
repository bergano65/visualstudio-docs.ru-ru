...
5. По завершении клонирования дважды щелкните папку репозитория в нижней части окна Team Explorer, чтобы перейти на панель мониторинга репозитория. В разделе **Решения** щелкните **Создать...**.
...
7. Выберите пункт меню **Вид > Обозреватель решений**.
