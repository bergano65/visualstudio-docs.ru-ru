...
![Отладка в смешанном режиме](~/python/media/mixed-mode-debugging.png) 
...
1. Щелкните правой кнопкой мыши проект в обозревателе решений и выберите **Свойства**, щелкните вкладку **Отладка**, а затем установите флажок **Включить отладку машинного кода**. Включится смешанный режим для всех сеансов отладки.
    ...
    ![Включение отладки машинного кода](~/python/media/mixed-mode-debugging-enable-native.png)
...
1. При присоединении к существующему процессу отладчика смешанного режима (**Отладка > Присоединиться к процессу...**) нажмите кнопку **Выбрать...**, чтобы открыть диалоговое окно **Выбор типа кода**, установите переключатель **Выполнять отладку кода следующих типов** и выберите в списке **Машинный код** и **Python**.
    ...
    ![Выбор типов кода Python и машинного кода](~/python/media/mixed-mode-debugging-code-type.png)
...
>
> ![Выбор Python в качестве типа отладки при подсоединении отладчика](~/python/media/mixed-mode-debugging-attach-type.png)
...
![Объединенный стек вызовов](~/python/media/mixed-mode-debugging-call-stack.png)
...
![Представление Python](~/python/media/mixed-mode-debugging-python-view.png)
...
![Включение представления Python](~/python/media/mixed-mode-debugging-enable-python-view.png)
...
![Включение представления C++](~/python/media/mixed-mode-debugging-enable-cpp-view.png)
...
![Представление C++](~/python/media/mixed-mode-debugging-cpp-view.png)
