...
![Выбор параметра "Собственные средства разработки Python"](~/docs/python/media/cpp-install-native.png)
...
1. В коде C++ установите точку останова на первой строке в методе `tanh`, а затем запустите отладчик. Вы увидите, что при вызове этого кода отладчик останавливается:
    ...
    ![Остановка на точке останова в коде C++](~/docs/python/media/cpp-debugging.png)
