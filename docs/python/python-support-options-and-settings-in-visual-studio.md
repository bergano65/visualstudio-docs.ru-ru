---
title: "Параметры и настройки Python в Visual Studio | Документация Майкрософт"
...
| Автоматически создавать базу данных завершения при первом использовании | включить | Чтобы обеспечить работу [завершений IntelliSense](editing-python-code-in-visual-studio.md#intellisense) для библиотеки, Visual Studio необходимо создать для нее базу данных завершения. Создание осуществляется в фоновом режиме при установке библиотеки, но может быть не закончено, когда вы начинаете вводить код. Если этот параметр выбран, Visual Studio повышает приоритет создания базы данных для библиотеки, когда вы вводите использующий ее код. |
