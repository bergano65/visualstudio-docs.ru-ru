...
(Вкладка **Средства** > **Параметры** > **Python** > **Conda**.)
...
![Диалоговое окно параметров Python, вкладка "Языковой сервер"](media/options-conda.png)
