...
ms.locfileid: "54060768"
---
# <a name="tutorial-get-started-with-the-flask-web-framework-in-visual-studio"></a>Учебник. Начало работы с веб-платформой Flask в Visual Studio
...
1. В нижней части диалогового окна в полях введите следующие сведения (как показано на предыдущем рисунке), а затем нажмите кнопку **ОК**.
    ...
    - **Создать каталог для решения**: оставить установленным (по умолчанию).
...
Дополнительные сведения о системе управления версиями для автоматизации см. в статье [Источник истины: роль репозиториев в DevOps](https://msdn.microsoft.com/magazine/mt763232) в журнале MSDN Magazine, написанной для мобильных приложений, которая также применяется к веб-приложениям.
...
### <a name="question-what-is-the-purpose-of-the-name-argument-to-the-flask-class"></a>Вопрос. Для чего предназначен аргумент __name__ в классе Flask?
