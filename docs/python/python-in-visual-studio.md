...
Visual Studio предоставляет средства [с открытым кодом](https://github.com/Microsoft/ptvs) для поддержки Python, в том числе рабочую нагрузку Python (в Visual Studio 2017) и бесплатное расширение "Инструменты Python для Visual Studio" (для Visual Studio 2015 и более ранних версий). 
...
Рекомендуем также ознакомиться на YouTube с серией [видео для начала работы и более подробного изучения](https://www.youtube.com/playlist?list=PLReL099Y5nRdLgGAdrb_YeTdEnd23s6Ff), в которых дается обзор основных функций.
...
- [Visual Studio 2013 Express для Web с обновлением 2 или более поздней версии](http://www.microsoft.com/en-us/download/details.aspx?id=40747)
- [Visual Studio 2013 Express для настольных систем с обновлением 2 или более поздней версии](http://www.microsoft.com/en-us/download/details.aspx?id=40787)
