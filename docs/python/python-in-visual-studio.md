...
Visual Studio предоставляет средства [с открытым кодом](https://github.com/Microsoft/ptvs) для поддержки языка Python, в том числе рабочую нагрузку Python (в Visual Studio 2017) и бесплатное расширение "Инструменты Python для Visual Studio" (для Visual Studio 2015 и более ранних версий). 
...
- [Предварительный выпуск Visual Studio 2017](https://www.visualstudio.com/vs/preview)
