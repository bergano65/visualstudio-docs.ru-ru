---
title: "Удаленная отладка Azure с помощью Инструментов Python для Visual Studio | Документация Майкрософт"
ms.custom: 
ms.date: 3/7/2017
