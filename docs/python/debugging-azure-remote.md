...
![Включение веб-сокетов на портале Azure](~/docs/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![Отладка веб-сайта, размещенного в службе приложений Azure](~/docs/python/media/azure-remote-debugging-attached.png)
...
![Страница информации о прокси удаленной отладки в Azure](~/docs/python/media/azure-remote-debugging-proxy-info-page.png)
...
![Определение конечной точки отладчика в службе приложений Azure](~/docs/python/media/azure-remote-debugging-secret.png)
...
![Диалоговое окно "Присоединение к процессу" для присоединения к веб-сайту Azure](~/docs/python/media/azure-remote-debugging-manual-attach.png)
