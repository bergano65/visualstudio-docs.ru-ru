...
>[!NOTE]
>Если вы только начинаете работу с Python в Visual Studio, ознакомьтесь с необходимыми базовыми сведениями в следующих статьях:
>
...
> [!Note]
> Приведенные в этом разделе снимки экрана представляют Visual Studio 15.8. Пользовательский интерфейс может немного отличаться от вашей версии Visual Studio.
