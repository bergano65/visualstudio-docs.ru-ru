...
[Поддержка Python в Visual Studio](installation.md) также добавляет в меню **Правка > Дополнительно** полезную команду [Заполнить абзац комментариев](#fill-comment-paragraph-command).
