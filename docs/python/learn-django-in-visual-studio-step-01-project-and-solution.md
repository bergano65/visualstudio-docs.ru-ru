...
- Код проекта Django: [Написание первого приложения Django, часть 1](https://docs.djangoproject.com/en/2.0/intro/tutorial01/) (docs.djangoproject.com)
