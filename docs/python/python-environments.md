---
title: "Среды Python в Visual Studio | Документы Майкрософт"
ms.custom: 
ms.date: 07/25/2017
ms.reviewer: 
ms.suite: 
...
Глобальные (или системные) среды доступны для всех проектов на компьютере. Visual Studio обычно обнаруживает глобальные среды автоматически, и их можно просмотреть в [окне сред Python](#managing-python-environments-in-visual-studio). В противном случае можно добавить среду вручную с помощью этого же окна.
