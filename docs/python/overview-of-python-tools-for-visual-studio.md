...
1. Поддержка Git для Visual Studio 2012 доступна в расширении "Инструменты Visual Studio Tools для Git", которое можно найти в [коллекции Visual Studio](https://marketplace.visualstudio.com/items?itemName=TFSPowerToolsTeam.VisualStudioToolsforGit).

1. Для развертывания на веб-сайте Azure требуется [пакет Azure SDK для .NET 2.1 — Visual Studio 2010 с пакетом обновления 1 (SP1)](https://go.microsoft.com/fwlink/?LinkId=313855). Более поздние версии не поддерживают Visual Studio 2010.

1. Поддержка веб-роли и рабочей роли Azure требует [пакет Azure SDK для .NET 2.3 — VS 2012](https://go.microsoft.com/fwlink/?LinkId=323511) или более поздней версии.

1. Поддержка веб-роли и рабочей роли Azure требует [пакет Azure SDK для .NET 2.3 — VS 2013](https://go.microsoft.com/fwlink/?LinkId=323510) или более поздней версии.
