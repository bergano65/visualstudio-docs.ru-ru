...
---
# <a name="working-with-python-in-visual-studio-on-windows"></a>Работа с Python в Visual Studio под управлением Windows
...
- Документы: [Управление окружениями Python](managing-python-environments-in-visual-studio.md)
...
Visual Studio предоставляет первоклассный редактор Python, включающий цветовую разметку синтаксиса, автозаполнение во всем коде и библиотеках, форматирование кода, справку по сигнатурам, рефакторинг, подсказки по типам и анализ кода на наличие потенциальных ошибок (изображен ниже). Visual Studio также предоставляет уникальные функции, такие как представление классов, переход к определению, поиск всех ссылок и фрагменты кода. Непосредственная интеграция с [интерактивным окном](#interactive-window) помогает быстро разрабатывать код на Python, который уже сохранен в файле.
...
- Документы: [Редактирование кода Python](editing-python-code-in-visual-studio.md)
- Документы: [Форматирование кода](formatting-python-code.md)
- Документы: [Рефакторинг](refactoring-python-code.md)
- Документы: [Linting](linting-python-code.md)
- Документы по основным возможностям Visual Studio: [Создание кода в редакторе кода и текста](../ide/writing-code-in-the-code-and-text-editor.md)
...
Кроме того, Visual Studio обеспечивает тесную интеграцию между редактором кода Python и интерактивным окном. При помощи сочетания клавиш **CTRL+ВВОД** можно легко отправить текущую строку кода (или блок кода) из редактора в интерактивное окно и перейти к следующей строке (или блоку). Сочетание клавиш **CTRL+ВВОД** позволяет легко использовать пошаговое выполнение кода без запуска отладчика. Нажатием этих же клавиш можно также отправить выделенный код в интерактивное окно и вставить код из интерактивного окна в редактор. Вместе эти возможности позволяют работать с сегментами кода в интерактивном окне и легко сохранять результаты в файл в редакторе.

Visual Studio также поддерживает IPython и Jupyter в REPL, включая встроенные диаграммы, .NET и Windows Presentation Foundation (WPF).
...
- Документы: [Интерактивное окно](python-interactive-repl-in-visual-studio.md)
...
[![Проект Python и шаблоны элементов в Visual Studio](media/project-and-item-templates.png)](media/project-and-item-templates.png)

Дополнительные сведения:

- Документы: [Управление проектами Python](managing-python-projects-in-visual-studio.md)
...
- Документы: [Работа с C++ и Python](working-with-c-cpp-python-in-visual-studio.md)
...
- Документы по основным возможностям Visual Studio: [Решения и проекты в Visual Studio](../ide/solutions-and-projects-in-visual-studio.md)

## <a name="full-featured-debugging"></a>Полнофункциональная отладка

Одним из основных преимуществ Visual Studio является его мощный отладчик. В частности, для Python среда Visual Studio включает отладку в смешанном режиме на Python и C++, удаленную отладку в Linux, удаленную отладку в Azure, отладку в интерактивном окне и отладку модульных тестов Python.
...
- Документы: [Отладка Python](debugging-python-in-visual-studio.md)
...
- Документы по основным возможностям Visual Studio: [Обзор возможностей отладчика Visual Studio](../debugger/debugger-feature-tour.md)
...
[![Результаты профилирования проекта Python в Visual Studio](media/profiling-results.png)](media/profiling-results.png)
...
Обнаружение, выполнение и управление тестами в Visual Studio Test Explorer, а также легкая отладка модульных тестов.
...
## <a name="publishing-to-azure-and-azure-sdk-for-python"></a>Публикация в Azure и Azure SDK для Python

Visual Studio предоставляет встроенную поддержку для публикации веб-приложений и облачных служб в Azure. Visual Studio включает в себя основные шаблоны элементов `web.config` как для динамического, так и для статического содержимого. Рабочая нагрузка Python также включает пакет SDK Azure для Python, что упрощает использование служб Azure в Windows, Mac OS X и Linux.

![Публикация приложения на Python в Azure из Visual Studio](media/azure-publish-dialog.png)

Дополнительные сведения:

- Документы: [Публикация в Azure](publishing-python-web-applications-to-azure-from-visual-studio.md)
