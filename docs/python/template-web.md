---
title: "Шаблоны веб-проектов для Python в Visual Studio | Документы Майкрософт"
ms.custom: 
ms.date: 07/13/2017
ms.reviewer: 
ms.suite: 
...
Облачные службы Microsoft Azure *поддерживают* файл `requirements.txt`. Дополнительные сведения см. в статье [Проекты облачных служб Azure](template-azure-cloud-service.md).
