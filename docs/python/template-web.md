...
![Новые шаблоны веб-проектов](~/docs/python/media/template-web-new-project.png)
...
![Диалоговое окно, с помощью которого можно установить необходимые пакеты для шаблона проекта](~/docs/python/media/template-web-requirements-txt-wizard.png)
...
Когда вы запускаете отладку веб-проекта, Visual Studio локально запускает веб-сервер и открывает страницу с указанным здесь адресом и портом в браузере по умолчанию. Чтобы указать дополнительные параметры, щелкните правой кнопкой мыши проект, выберите **Свойства** и **Web Launcher** (Веб-средство запуска):
  ...
  ![Свойства веб-средства запуска для универсального веб-шаблона](~/docs/python/media/template-web-launcher-properties.png)
...
![Команда публикации в контекстном меню проекта](~/docs/python/media/template-web-publish-command.png)
...
![Добавление расширения сайта на портале Azure](~/docs/python/media/template-web-site-extensions.png)
...
![Шаблоны элементов Azure](~/docs/python/media/template-web-azure-items.png)
...
![Изменение конфигурации публикации](~/docs/python/media/template-web-publish-config.png)
...
![Команда "Преобразовать в проект облачной службы Microsoft Azure"](~/docs/python/media/template-web-convert-menu.png)
