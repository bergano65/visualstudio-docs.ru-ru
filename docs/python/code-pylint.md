...
![Команда PyLint в контекстном меню для проектов Python](~/docs/python/media/code-pylint-command.png)
...
![Список ошибок PyLint](~/docs/python/media/code-pylint-error-list.png)
