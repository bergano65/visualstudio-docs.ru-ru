...
![Команда PyLint в контекстном меню для проектов Python](~/python/media/code-pylint-command.png)
...
![Список ошибок PyLint](~/python/media/code-pylint-error-list.png)
