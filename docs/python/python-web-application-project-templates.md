...
Все другие шаблоны основаны на веб-платформах Bottle, Flask или Django и делятся на три общие группы, как описано в следующих разделах. Приложения, созданные с помощью любого из этих шаблонов, содержат код, который обеспечивает локальное выполнение и отладку приложений. Кроме того, каждый из них предоставляет необходимый [объект приложения WSGI](http://www.python.org/dev/peps/pep-3333/) (python.org) для использования с рабочими веб-серверами.
