...
![Автозавершение элементов](~/python/media/code-editing-completions-simple.png)
...
![Автозавершение элементов с использованием фильтрации](~/python/media/code-editing-completion-filtering.png)
...
![Автозавершение элементов при наличии нескольких типов](~/python/media/code-editing-completion-types.png)
...
![Автозавершение закрытых элементов](~/python/media/code-editing-completion-dunder.png)
...
![Автозавершение импорта](~/python/media/code-editing-completion-import.png)
...
![Автозавершение исключений](~/python/media/code-editing-completion-exception.png)
...
![Автозавершение декораторов](~/python/media/code-editing-completion-decorator.png)
...
![Справка по сигнатурам](~/python/media/code-editing-signature-help.png)
...
![Краткие сведения](~/python/media/code-editing-quick-info.png)
...
![Цветовая маркировка синтаксиса](~/python/media/code-editing-code-coloring.png)
...
![Параметр "Шрифты и цвета"](~/python/media/code-editing-customize-colors.png)
...
![Фрагменты кода](~/python/media/code-editing-code-snippets.png)
...
![Диспетчер фрагментов кода](~/python/media/code-editing-code-snippets-manager.png)
...
![Панель переходов](~/python/media/code-editing-navigation-bar.png)
...
![Перейти к определению](~/python/media/code-editing-go-to-definition.png)
...
![Перейти к](~/python/media/code-editing-navigate-to.png)
...
![Результаты выполнения команды "Найти все ссылки"](~/python/media/code-editing-find-all-references.png)
