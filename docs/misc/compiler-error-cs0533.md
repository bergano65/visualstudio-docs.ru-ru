...
"член\_производного\_класса" скрывает наследуемый абстрактный член "член\_базового\_класса"  
 ...
 Метод базового [класса](/dotnet/csharp/language-reference/keywords/class) скрыт. Проверьте правильность синтаксиса объявления.  
  
 Для получения дополнительной информации см. [базу](/dotnet/csharp/language-reference/keywords/base).  
