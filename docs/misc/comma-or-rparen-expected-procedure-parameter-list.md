...
## См. также  
 [Практическое руководство. Определение параметра для процедуры](../Topic/How%20to:%20Define%20a%20Parameter%20for%20a%20Procedure%20\(Visual%20Basic\).md)   
 [Список параметров](/dotnet/visual-basic/language-reference/statements/parameter-list)