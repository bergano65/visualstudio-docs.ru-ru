...
Все проекты в решении [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] должны быть предназначены для одной и той же платформы, но проект, который вы добавляете, предназначен для платформы, отличной от указанной в решении.  
