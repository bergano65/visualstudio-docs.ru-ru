...
Выражение, используемое для аргумента атрибута, приводится к типу данных, отличному от соответствующего параметра атрибута, но в [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] не допускается преобразование требуемого типа для аргументов атрибута.  
