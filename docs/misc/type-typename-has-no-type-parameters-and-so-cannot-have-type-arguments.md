...
Оператор объявления или назначения включает предложение [Of](/dotnet/visual-basic/language-reference/statements/of-clause) при вызове типа, не являющегося универсальным.  
