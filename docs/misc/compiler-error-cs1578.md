...
Требуется имя файла, однострочный комментарий или признак конца строки  
 ...
 После директивы [\#line](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-line) допускается только имя файла \(заключенное в двойные кавычки\) или однострочный комментарий.  
