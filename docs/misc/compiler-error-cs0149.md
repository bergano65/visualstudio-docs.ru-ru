...
Требуется имя метода.  
 ...
 При создании [делегата](/dotnet/csharp/language-reference/keywords/delegate) укажите метод. Дополнительные сведения см. в разделе [Делегаты](/dotnet/csharp/programming-guide/delegates/index).  
