...
Указатели и буферы фиксированного размера можно использовать только в небезопасном контексте.  
 ...
 Указатели могут использоваться только с ключевым словом [unsafe](/dotnet/csharp/language-reference/keywords/unsafe). Для получения дополнительной информации см. [Небезопасный код и указатели](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
