...
Правая часть присваивания оператора fixed не может быть выражением приведения типа  
 ...
 В правой части [фиксированного](/dotnet/csharp/language-reference/keywords/fixed-statement) выражения нельзя использовать приведение. Для получения дополнительной информации см. [Небезопасный код и указатели](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
