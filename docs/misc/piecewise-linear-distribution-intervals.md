...
---
# piecewise_linear_distribution::intervals
Возвращает хранимые интервалы распределения.  
...
## Заметки  
 Эта функция\-член возвращает хранимые интервалы распределения.  
...
## См. также  
 ...
 [Класс piecewise\_linear\_distribution](/visual-cpp/standard-library/piecewise-linear-distribution-class)