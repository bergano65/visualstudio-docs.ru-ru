...
## См. также  
 ...
 [Эффективное сочетание операторов](/dotnet/visual-basic/programming-guide/language-features/operators-and-expressions/efficient-combination-of-operators)   
 [Порядок применения операторов в Visual Basic](/dotnet/visual-basic/language-reference/operators/operator-precedence)