---
title: "Внутренняя ошибка в выполняемом модуле Microsoft Visual Basic. | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "wpickett"
---
# Внутренняя ошибка в выполняемом модуле Microsoft Visual Basic.
Внутренняя ошибка в среде выполнения [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] Майкрософт.  
