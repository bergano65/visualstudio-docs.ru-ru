...
Процедура объявлена с параметрами или типом возвращаемого значения, которые не могут быть представлены в [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
...
## См. также  
 [Типы данных](/dotnet/visual-basic/language-reference/data-types/data-type-summary)