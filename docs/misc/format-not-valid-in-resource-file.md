...
Файл ресурсов в проекте не соответствует стандартному формату для файла ресурса Windows, или существует несоответствие между файлом ресурсов и проектом [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
