...
В условных выражениях присваивание всегда постоянное. Предполагалось использовать \=\=, а не \= ?  
 ...
 Условное выражение, использующее [оператор \=\-](/dotnet/csharp/language-reference/operators/assignment-operator), но не [оператор \=\=\-](/dotnet/csharp/language-reference/operators/equality-comparison-operator).  
