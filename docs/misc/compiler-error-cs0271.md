---
title: "Ошибка компилятора CS0271 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
Свойство или индексатор "свойство\/индексатор" не может использоваться в данном контексте, так как метод доступа get недоступен  
 ...
 Эта ошибка возникает при попытке получить доступ к недоступному методу доступа `get`. Чтобы устранить эту ошибку, повысьте уровень доступности метода доступа или измените расположение вызова. Дополнительные сведения см. в разделах [Доступность методов доступа](/dotnet/csharp/programming-guide/classes-and-structs/restricting-accessor-accessibility) и [Свойства](/dotnet/csharp/programming-guide/classes-and-structs/properties).  
