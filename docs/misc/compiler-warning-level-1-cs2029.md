...
Недопустимое значение для "\/define"; "идентификатор" не является допустимым идентификатором  
 ...
 Это предупреждение возникает, если значение, которое используется в параметре [\/define](/dotnet/csharp/language-reference/compiler-options/define-compiler-option), содержит недопустимые знаки.  
