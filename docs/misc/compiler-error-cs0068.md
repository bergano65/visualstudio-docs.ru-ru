...
"событие": событие в интерфейсе не может иметь инициализатора  
 ...
 Событие в интерфейсе не может иметь инициализатора. Для получения дополнительной информации см. [Интерфейсы](/dotnet/csharp/programming-guide/interfaces/index).  
