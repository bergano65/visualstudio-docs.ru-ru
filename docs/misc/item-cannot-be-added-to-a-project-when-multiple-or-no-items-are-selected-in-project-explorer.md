...
Эта ошибка обычно возникает, когда в обозревателе решений не выбран ни один элемент или выбрано несколько элементов.  
  
### Чтобы исправить эту ошибку  
  
1.  Выберите в обозревателе решений только один элемент.  
