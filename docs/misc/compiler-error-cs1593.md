...
Делегат "делегат" не принимает "число" аргументов  
 ...
 Число аргументов, переданных при вызове [делегата](/dotnet/csharp/language-reference/keywords/delegate), не совпадает с числом параметров, указанных в объявлении делегата.  
