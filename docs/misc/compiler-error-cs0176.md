...
Доступ к статическому члену "член" по ссылке на экземпляр невозможен. Уточните имя, указав тип.  
 ...
 Для уточнения [статической](/dotnet/csharp/language-reference/keywords/static) переменной можно использовать только имя класса; имя экземпляра не может быть квалификатором. Для получения дополнительной информации см. [Статические классы и члены статических классов](/dotnet/csharp/programming-guide/classes-and-structs/static-classes-and-static-class-members).  
