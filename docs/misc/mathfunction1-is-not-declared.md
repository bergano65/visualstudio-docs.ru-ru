...
"\<математическая\_функция1\>" не объявлена. Функция перенесена в класс System.Math и теперь называется "\<математическая\_функция2\>".  
 ...
 Несколько функций, которые были встроенными в [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] в предыдущих версиях, были перемещены в пространство имен <xref:System.Math?displayProperty=fullName>. Это делает их функциональность более доступной для всех языков программирования.  
