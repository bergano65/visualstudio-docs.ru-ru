...
"конструктор": статический конструктор не должен иметь параметры  
 ...
 [Статический](/dotnet/csharp/language-reference/keywords/static) конструктор не может объявляться с одним или несколькими параметрами. Для получения дополнительной информации см. [Конструкторы](/dotnet/csharp/programming-guide/classes-and-structs/constructors).  
