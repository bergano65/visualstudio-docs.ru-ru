...
Эта ошибка обычно возникает, когда элемент поврежден или у компьютера недостаточно памяти.  
  
### Чтобы исправить эту ошибку  
  
1.  Закройте другие открытые приложения и попытайтесь снова переместить элемент.  
  
     —или—  
  
2.  Выберите для перемещения другой элемент.  
