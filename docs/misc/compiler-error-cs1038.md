...
Требуется директива \#endregion  
 ...
 Директива [\#region](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-region) не имеет соответствующую директиву [\#endregion](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-endregion).  
