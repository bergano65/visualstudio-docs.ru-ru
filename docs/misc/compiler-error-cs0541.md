...
"объявление": явное объявление может содержаться только в классе или в структуре  
 ...
 Явное объявление [интерфейса](/dotnet/csharp/language-reference/keywords/interface) найдено вне [класса](/dotnet/csharp/language-reference/keywords/class) или [структуры](/dotnet/csharp/language-reference/keywords/struct).  
