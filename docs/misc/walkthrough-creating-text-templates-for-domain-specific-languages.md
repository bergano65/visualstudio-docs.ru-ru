...
В этом разделе, консолидированна с другим содержимым.  Перейдите к сущности [Создание кода из доменного языка](../modeling/generating-code-from-a-domain-specific-language.md).