...
Член "член" не скрывает унаследованный член. Новое ключевое слово не требуется  
 ...
 Объявление класса включает ключевое слово [new](/dotnet/csharp/language-reference/keywords/new), хотя это объявление не переопределяет существующее определение в базовом классе. Вы можете удалить ключевое слово **new**.  
