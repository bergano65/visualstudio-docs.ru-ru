...
Указатель должен быть проиндексирован только по одному значению.  
 ...
 Указатель не может иметь несколько индексов. Дополнительные сведения см. в разделе [Типы указателей](/dotnet/csharp/programming-guide/unsafe-code-pointers/pointer-types).  
