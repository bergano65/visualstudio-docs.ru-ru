...
"метод": не все пути кода возвращают значение  
 ...
 Метод, возвращающий значение, должен иметь оператор `return` во всех путях кода. Для получения дополнительной информации см. [Методы](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
