...
Требуется тип byte, sbyte, short, ushort, int, uint, long или ulong.  
 ...
 Некоторые типы данных, например [перечисления](/dotnet/csharp/language-reference/keywords/enum), могут быть объявлены только для хранения данных определенных типов.  
