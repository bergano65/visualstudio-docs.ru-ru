---
title: "Предупреждение компилятора (уровень&#160;3) CS0067 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
Событие "событие" не используется  
 ...
 [Событие](/dotnet/csharp/language-reference/keywords/event) объявлено, но ни разу не используется в классе, в котором объявлено.  
