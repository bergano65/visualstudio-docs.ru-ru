...
Требуется объект с типом, который можно преобразовать в "тип"  
 ...
 Оператор return присутствует, но оператор не возвращает значение ожидаемого типа. Дополнительные сведения см. в разделе [Свойства](/dotnet/csharp/programming-guide/classes-and-structs/properties).  
