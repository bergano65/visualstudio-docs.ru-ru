...
"событие": событие должно иметь тип delegate  
 ...
 Для ключевого слова event требуется тип [delegate](/dotnet/csharp/language-reference/keywords/delegate). Дополнительные сведения см. в разделах [События](/dotnet/csharp/programming-guide/events/index) и [Делегаты](/dotnet/csharp/programming-guide/delegates/index).  
