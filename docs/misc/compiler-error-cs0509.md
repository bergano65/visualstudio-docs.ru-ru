...
"класс1": не может быть производным от запечатанного типа "класс2"  
 ...
 [Запечатанный](/dotnet/csharp/language-reference/keywords/sealed) класс не может использоваться в качестве [базового](/dotnet/csharp/language-reference/keywords/base). Структуры являются запечатанными по умолчанию.  
