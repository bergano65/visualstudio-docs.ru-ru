...
"тип": в интерфейсах невозможно объявлять типы  
 ...
 [Интерфейс](/dotnet/csharp/language-reference/keywords/interface) не может содержать пользовательский тип; в интерфейсах должны содержаться только методы и свойства.  
