...
XML\-комментарий в члене "член" имеет синтаксически недопустимый атрибут cref "недопустимый\_синтаксис"  
 ...
 Один из параметров, переданных в тег для комментариев документации, имеет недопустимый синтаксис. Для получения дополнительной информации см. [Рекомендуемые теги для комментариев документации](/dotnet/csharp/programming-guide/xmldoc/recommended-tags-for-documentation-comments).  
