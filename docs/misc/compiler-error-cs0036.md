---
title: "Ошибка компилятора CS0036 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
manager: "wpickett"
---
# Ошибка компилятора CS0036
Выходной параметр не может иметь атрибут "\[In\]"  
  
 В настоящее время атрибут **In** запрещен в параметре [out](/dotnet/csharp/language-reference/keywords/out).  
