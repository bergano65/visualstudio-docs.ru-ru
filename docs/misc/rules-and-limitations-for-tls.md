---
title: "Правила и ограничения протокола TLS | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
Это содержимое перемещено в раздел [Локальное хранилище потока \(TLS\)](/visual-cpp/parallel/multithreading/thread-local-storage-tls)