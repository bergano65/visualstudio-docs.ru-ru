...
Недостаточно памяти  
 ...
 Эта ошибка также может возникать в результате несовпадения версий компилятора [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)] и C\# или наличия одного или нескольких поврежденных файлов, которые поддерживают компилятор C\#. Переустановите Visual Studio.