...
"член": невозможно переопределить наследуемый член "наследуемый\_член", так как он запечатан  
 ...
 Член не может [переопределить](/dotnet/csharp/language-reference/keywords/override)[запечатанный](/dotnet/csharp/language-reference/keywords/sealed) наследуемый член. Для получения дополнительной информации см. [Checked и Unchecked](/dotnet/csharp/language-reference/keywords/checked-and-unchecked).  
