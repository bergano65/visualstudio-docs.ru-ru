...
Поскольку "функция" возвращает значение void, после ключевого слова return не должно задаваться выражение объекта  
 ...
 Метод с типом возврата [void](/dotnet/csharp/language-reference/keywords/void) не может возвращать значение. Дополнительные сведения см. в разделе [Методы](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
