...
В выражении stackalloc после типа требуется \[\]  
 ...
 Размер выделенной памяти, запрошенной с помощью оператора [stackalloc](/dotnet/csharp/language-reference/keywords/stackalloc), необходимо указывать в квадратных скобках.  
