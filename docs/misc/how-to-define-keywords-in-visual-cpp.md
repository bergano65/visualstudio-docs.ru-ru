...
6.  Задайте свойства шрифта и цвета ваших пользовательских ключевых слов, как описано в разделе [Страница "Шрифты и цвета", папка "Среда", диалоговое окно "Параметры"](../ide/reference/fonts-and-colors-environment-options-dialog-box.md).  
  
 Дополнительные сведения см. в разделе [Ключевые слова в C\+\+](/visual-cpp/cpp/keywords-cpp).  
  
## См. также  
 [Запуск от имени участника группы "Пользователи"](/visual-cpp/top/running-as-a-member-of-the-users-group)   
