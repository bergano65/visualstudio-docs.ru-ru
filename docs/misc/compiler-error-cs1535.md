...
Перегруженный унарный оператор "оператор" принимает один параметр  
 ...
 Определение унарного [перегружаемого оператора](/dotnet/csharp/programming-guide/statements-expressions-operators/overloadable-operators) должно принимать один параметр.  
