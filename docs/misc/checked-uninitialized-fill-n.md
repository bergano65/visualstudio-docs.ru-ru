...
---
# checked_uninitialized_fill_n
`checked_uninitialized_fill_n` не рекомендуется к использованию. Сведения о проверенных итераторах см. в разделе [Проверяемые итераторы](/visual-cpp/standard-library/checked-iterators).  
