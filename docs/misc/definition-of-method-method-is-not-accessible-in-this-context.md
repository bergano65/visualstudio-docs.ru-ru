...
-   Добавьте метод в качестве пользовательской агрегатной функции \(метода расширения\). Дополнительные сведения о создании пользовательской агрегатной функции см. в разделе [Предложение Aggregate](/dotnet/visual-basic/language-reference/queries/aggregate-clause).  
