...
-   Аргумент типа должен наследовать не более чем от одного класса.  
 ...
 Вы можете объединить эти требования для одного параметра типа.[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] не может создать тип, если код не предоставляет аргументы, которые удовлетворяют каждому ограничению на каждый тип параметра, определенного в универсальном типе.  
