...
Не используйте System.ParamArrayAttribute. Используйте ключевое слово "params".  
 ...
 Компилятор C\# не допускает использование <xref:System.ParamArrayAttribute?displayProperty=fullName>. Используйте вместо этого ключевое слово [params](/dotnet/csharp/language-reference/keywords/params).  
