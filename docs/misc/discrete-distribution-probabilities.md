...
---
# discrete_distribution::probabilities
Возвращает хранимые вероятности распределения.  
...
## Заметки  
 Эта функция\-член возвращает хранимые вероятности распределения.  
...
## См. также  
 ...
 [Класс discrete\_distribution](/visual-cpp/standard-library/discrete-distribution-class)