...
В этом разделе описывается, как выполнить сборку и установку пакетов VSPackage и как поддержать пользователей, работающих одновременно в нескольких версиях [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
...
## Связанные подразделы  
 ...
 Предоставляется набор тестов, помогающий убедиться в правильности интеграции пакетов VSPackage в [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
 [Выпуск продукта](../misc/releasing-a-visual-studio-integration-product.md)  
 Показано, как выпустить интеграционный продукт [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].