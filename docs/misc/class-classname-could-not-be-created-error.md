...
Ошибка инициализации класса. Одной из возможных причин является повреждение установки [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)].  
...
2.  Переустановите [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] и выполните повторную компиляцию программы.  
  
3.  Если устранить ошибку не удается, переустановите компилятор [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
