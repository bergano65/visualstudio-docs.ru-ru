---
title: "Ошибка компилятора CS0079 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
Событие "событие" может находиться только в левой части операции \+\= или \-\=  
 ...
 [Событие](/dotnet/csharp/language-reference/keywords/event) было вызвано неправильно. Дополнительные сведения см. в разделах [События](/dotnet/csharp/programming-guide/events/index) и [Делегаты](/dotnet/csharp/programming-guide/delegates/index).  
