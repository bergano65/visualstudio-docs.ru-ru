---
title: "Подробные сведения об этой ошибке Visual Basic отсутствуют. | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "wpickett"
---
# Подробные сведения об этой ошибке Visual Basic отсутствуют.
Подробные сведения об этой ошибке отсутствуют.  Можно выполнить поиск по номеру ошибки и тексту сообщения об ошибке в Интернете.  Также можно обратиться с вопросом к другим разработчикам на следующих форумах:  
 ...
 Форум для вопросов и общих обсуждений проблем, связанных с синтаксисом и компилятором языка [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
  
 [Взаимодействие и обновление Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145966)  
 Форум предназначен для вопросов по обновлению до [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] и работе с функциями взаимодействия.  
  
 [Среда IDE Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145971)  
 Форум предназначен для вопросов о работе в среде [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
 [Общие сведения о Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145973)  
 Форум предназначен для вопросов по работе [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] и соответствующим проблемам, которые не обсуждаются на других форумах.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 Форум предназначен для вопросов по работе [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] и соответствующим проблемам.  
  
 См. также:  
 [Дополнительные ресурсы для программистов, использующих Visual Basic](/dotnet/visual-basic/getting-started/additional-resources)  
  
## См. также  
 [Руководство по программированию на Visual Basic](/dotnet/visual-basic/programming-guide/index)   
