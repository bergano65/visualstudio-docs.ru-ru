...
"член": новый защищенный член объявлен в запечатанном классе  
 ...
 [Запечатанный](/dotnet/csharp/language-reference/keywords/sealed) класс не может вводить [защищенный](/dotnet/csharp/language-reference/keywords/protected) член, так как никакому другому классу не удастся наследовать от класса с атрибутом `sealed` и использовать член с атрибутом `protected`.  
