...
- Режим низкой задержки сборки [мусора](/dotnet/standard/garbage-collection/index) (GC) для визуальных C# элементов и Visual Basic отключен.
