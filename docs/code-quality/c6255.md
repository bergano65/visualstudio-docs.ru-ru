...
ms.locfileid: "74878571"
---
# <a name="c6255"></a>C6255
Предупреждение C6255: _alloca указывает наличие сбоя путем создания ошибки переполнения стека. Вместо этого рекомендуется использовать _malloca
