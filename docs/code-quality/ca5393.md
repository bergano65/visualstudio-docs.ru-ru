---
title: 'CA5393: не использовать ненадежное значение Дллимпортсеарчпас'
...
ms.locfileid: "85289739"
---
# <a name="ca5393-do-not-use-unsafe-dllimportsearchpath-value"></a>CA5393: не использовать ненадежное значение Дллимпортсеарчпас
...
[CA5392: Используйте атрибут Дефаултдллимпортсеарчпасс для вызовов P/Invoke](ca5392.md)
