---
title: 'CA2249: попробуйте использовать "String. Contains" вместо "String. IndexOf"'
ms.date: 08/27/2020
ms.topic: reference
f1_keywords:
- CA2249
...
ms.locfileid: "89176903"
---
# <a name="ca2249-consider-using-stringcontains-instead-of-stringindexof"></a>CA2249: рекомендуется использовать String. Contains вместо String. IndexOf
