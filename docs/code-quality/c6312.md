...
ms.locfileid: "72449707"
---
# <a name="c6312"></a>C6312
предупреждение C6312: возможный бесконечный цикл: использование константы EXCEPTION_CONTINUE_EXECUTION в выражении фильтра исключений для try-except
