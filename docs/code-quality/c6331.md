...
ms.locfileid: "72012863"
---
# <a name="c6331"></a>C6331
C6331 предупреждения: Недопустимый параметр: передача MEM_RELEASE и MEM_DECOMMIT в сочетании с \<function > запрещена. Это приводит к сбою этого вызова
...
```
 ...
 Чтобы устранить это предупреждение, не передавайте значение MEM_DECOMMIT в вызов VirtualFree, как показано в следующем коде:
