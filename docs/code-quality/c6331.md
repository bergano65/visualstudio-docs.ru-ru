...
ms.locfileid: "72449651"
---
# <a name="c6331"></a>C6331
предупреждение C6331: недопустимый параметр: передача MEM_RELEASE и MEM_DECOMMIT в сочетании с \<function > запрещена. Это приводит к сбою этого вызова
