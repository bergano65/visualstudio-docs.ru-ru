---
title: 'CA3009: Проверка кода на наличие уязвимостей при внедрении XML'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809953"
---
# <a name="ca3009-review-code-for-xml-injection-vulnerabilities"></a>CA3009: Проверка кода на наличие уязвимостей при внедрении XML
