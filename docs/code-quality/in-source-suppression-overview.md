...
Общая форма подавления включает категорию правила и идентификатор правила, который содержит представление необязательное понятное имя правила. Например:

`[SuppressMessage("Microsoft.Design", "CA1039:ListsAreStrongTyped")]`

При возникновении соображений производительности, сводя к минимуму метаданных подавления в исходном коде, можно опустить имя правила. Категория правил и идентификатор правила вместе составляют достаточно уникальное обозначение правила. Например:
