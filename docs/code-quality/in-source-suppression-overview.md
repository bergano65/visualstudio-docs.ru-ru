...
## <a name="suppressmessage-usage"></a>Использование SuppressMessage  
 ...
 Общая форма подавления включает категорию правила и идентификатор правила, которая содержит представление необязательное понятное имя правила. Например:  
  
 `[SuppressMessage("Microsoft.Design", "CA1039:ListsAreStrongTyped")]`  
  
 При наличии соображений производительности минимизация метаданных подавления в исходном коде, само имя правила можно не использовать. Категория правила и идентификатор правила вместе составляют достаточно уникальное обозначение правила. Например:  
