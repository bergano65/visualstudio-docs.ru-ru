...
## <a name="_pre_defensive_-and-_post_defensive_"></a>\_Pre \_defensive \_ и \_Post \_defensive \_
...
@No__t_0 аннотации означает, что у вас есть буфер. В нем `cb` выделенных байтов с первым байтом, инициализированным при выходе. Эта аннотация не является строго неправильной и полезна для выражения выделенного размера. Однако он не указывает, сколько элементов инициализируется функцией.
...
## <a name="_out_-pstr"></a>\_Out \_ ПСТР
...
## <a name="true-in-_success_"></a>TRUE в \_Success \_
