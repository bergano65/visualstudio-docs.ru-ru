---
title: "Рекомендации и примеры (SAL) | Документы Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="wrong-context-in-when"></a>Неправильный контекст в _When\_  
...
## <a name="true-in-success"></a>Значение TRUE в _Success\_  
