---
title: "Предупреждения глобализации | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  - "глобализация [Visual Studio], предупреждения"
  - "предупреждения глобализации"
  - "предупреждения при анализе управляемого кода, предупреждения глобализации"
  - "предупреждения, глобализация"
...
|[CA1304: укажите CultureInfo](../Topic/CA1304:%20Specify%20CultureInfo.md)|Метод или конструктор вызывает член, имеющий перегрузку, которая принимает параметр System.Globalization.CultureInfo, вместо того чтобы вызвать перегрузку, принимающую параметр CultureInfo.  Если объект CultureInfo или System.IFormatProvider не предоставляется, значение по умолчанию, поставляемое перегруженным членом, может не оказать ожидаемого воздействия во всех языковых стандартах.|  
