...
ms.locfileid: "72746146"
---
# <a name="c6401"></a>C6401
Warning C6401: использование \<function name > в языковом стандарте по умолчанию для выполнения сравнения с константной строкой \< строкового имени > с учетом регистра. Выдает непредвиденные результаты в локализованных языковых стандартах
