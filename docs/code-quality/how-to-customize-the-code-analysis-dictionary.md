...
ms.date: 11/04/2016
description: Сведения о словаре анализа кода, который определяет ошибки в соглашениях об именах и орфографических ошибках. Узнайте, как создать пользовательский словарь и применить его к проекту.
