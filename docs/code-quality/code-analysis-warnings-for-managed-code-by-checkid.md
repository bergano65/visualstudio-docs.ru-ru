...
| CA2205 | [CA2205: Используйте управляемые эквиваленты Win32 API](../code-quality/ca2205-use-managed-equivalents-of-win32-api.md) | Вызова операционной системы определен метод и метод с эквивалентной функциональностью находится в библиотеке классов .NET Framework. |
