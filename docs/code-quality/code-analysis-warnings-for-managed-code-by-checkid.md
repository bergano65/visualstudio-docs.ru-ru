...
| Идентификатор правила | Предупреждение | Описание |
|---------| - | - |
...
| CA1416 | [CA1416: Проверка совместимости платформы](../code-quality/ca1416.md) | Использование зависящих от платформы API-интерфейсов в компоненте делает код больше не работает на всех платформах. |
