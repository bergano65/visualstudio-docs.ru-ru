...
| CA1508 | [CA1508: Избегайте появления неиспользуемого условного кода](../code-quality/ca1508.md) | Метод имеет условный код, который всегда вычисляется `true` как `false` или во время выполнения. Это приводит к неработающему коду `false` в ветви условия. |
...
| CA1827 |[CA1827: Не используйте Count/LongCount, если можно использовать Any](../code-quality/ca1827.md) | <xref:System.Linq.Enumerable.Count%2A>метод <xref:System.Linq.Enumerable.LongCount%2A> или был использован, <xref:System.Linq.Enumerable.Any%2A> когда метод был бы более эффективным. |
| CA1828 |[CA1828: Не используйте CountAsync/LongCountAsync, если можно использовать AnyAsync](../code-quality/ca1828.md) | <xref:Microsoft.EntityFrameworkCore.EntityFrameworkQueryableExtensions.CountAsync%2A>метод <xref:Microsoft.EntityFrameworkCore.EntityFrameworkQueryableExtensions.LongCountAsync%2A> или был использован, <xref:Microsoft.EntityFrameworkCore.EntityFrameworkQueryableExtensions.AnyAsync%2A> когда метод был бы более эффективным. |
