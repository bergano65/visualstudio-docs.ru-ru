---
title: 'CA1835: предпочитать перегрузки методов ReadAsync/WriteAsync, основанные на памяти, в классах, основанных на потоках'
ms.date: 05/11/2020
ms.topic: reference
f1_keywords:
...
![Исправление кода для CA1836 — предпочитать перегрузки методов ReadAsync/WriteAsync, основанные на памяти, в классах, основанных на потоках](media/ca1836-codefix.png)
