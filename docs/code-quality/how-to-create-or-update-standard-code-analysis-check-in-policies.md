...
description: Узнайте, как обеспечить выполнение анализа кода для всех проектов кода в проекте Azure DevOps. См. раздел Настройка политики возврата для анализа кода проекта.
