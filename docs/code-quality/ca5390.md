---
title: 'CA5390: не жестко кодировать ключ шифрования'
...
ms.locfileid: "84184839"
---
# <a name="ca5390-do-not-hard-code-encryption-key"></a>CA5390: не жестко кодировать ключ шифрования
