---
title: 'CA2305: не используйте небезопасный десериализатор Лосформаттер'
ms.date: 05/01/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "72442559"
---
# <a name="ca2305-do-not-use-insecure-deserializer-losformatter"></a>CA2305: не используйте небезопасный десериализатор Лосформаттер
