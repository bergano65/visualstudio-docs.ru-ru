...
ms.locfileid: "72012791"
---
# <a name="c6333"></a>C6333
C6333 предупреждения: Недопустимый параметр: передача MEM_RELEASE и ненулевого параметра Двсизе в \<function > не разрешена. Это приводит к сбою этого вызова
