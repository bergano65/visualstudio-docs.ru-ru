...
- Имя строковой переменной, передаваемой <xref:System.Console.Write%2A> методу или <xref:System.Console.WriteLine> , — "value" или "Format".
...
Чтобы устранить нарушение этого правила, исправьте написание слова или добавьте слово в пользовательский словарь. Сведения о том, как использовать пользовательские словари, [см. в разделе как Настройка словаря](../code-quality/how-to-customize-the-code-analysis-dictionary.md)анализа кода.
