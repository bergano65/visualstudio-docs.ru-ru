...
ms.locfileid: "74877797"
---
# <a name="c6400"></a>C6400
Warning C6400: использование \<имени функции > для выполнения сравнения с константной строкой \<строкового имени >. При применении для языков, отличных от английского, могут возникнуть непредвиденные результаты.
