---
title: 'CA2353: ненадежный набор данных или DataTable в типе Serializable'
ms.date: 07/14/2020
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "86393364"
---
# <a name="ca2353-unsafe-dataset-or-datatable-in-serializable-type"></a>CA2353: ненадежный набор данных или DataTable в типе Serializable
