---
title: 'CA5360: не вызывайте опасные методы при десериализации'
...
ms.locfileid: "85289770"
---
# <a name="ca5360-do-not-call-dangerous-methods-in-deserialization"></a>CA5360: не вызывайте опасные методы при десериализации
