...
Чтобы выполнить анализ кода в проекте вручную, в строке меню выберите **анализ** > **запустить анализ кода** > **запустить анализ кода в \<проекта >** .
