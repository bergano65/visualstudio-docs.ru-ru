...
- Используйте <xref:System.Xml.XmlSecureResolver>instead класса XmlResolver для ограничения ресурсов, к которым может получить доступ XmlTextReader.
