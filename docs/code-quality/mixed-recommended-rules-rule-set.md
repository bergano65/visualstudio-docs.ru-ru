...
|[C28023](../code-quality/c28023.md)|Назначенная или передаваемая функция должна иметь \_ \_ \_ заметку класса функции по крайней мере для одного из классов (ES).|
...
|[C28205](../code-quality/c28205.md)|\_Успех \_ или \_ \_ отказ, \_ использованный в недопустимом контексте|
...
|[C28213](../code-quality/c28213.md)|\_ \_ \_ Аннотацию use decl \_ следует использовать для ссылки, без изменения, перед объявлением.|
...
|[C28275](../code-quality/c28275.md)|Параметр для \_ значения макроса \_ имеет значение \_ null|
