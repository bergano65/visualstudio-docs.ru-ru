---
title: 'CA3005: Проверка кода на наличие уязвимостей при вставке LDAP'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809609"
---
# <a name="ca3005-review-code-for-ldap-injection-vulnerabilities"></a>CA3005: Проверка кода на наличие уязвимостей при вставке LDAP
