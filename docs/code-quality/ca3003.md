---
title: 'CA3003: Проверка кода на наличие уязвимостей при внедрении пути к файлам'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809922"
---
# <a name="ca3003-review-code-for-file-path-injection-vulnerabilities"></a>CA3003: Проверка кода на наличие уязвимостей при внедрении пути к файлам
