...
Минимальные правила Microsoft Native сосредоточены на наиболее критических проблемах в родном коде, включая потенциальные дыры в безопасности и сбои приложений.
