...
ms.locfileid: "37946294"
---
# <a name="c26130"></a>C26130
Предупреждение C26130: отсутствует заметка \_требует\_блокировки\_удерживаются\_(\<блокировки >) или \_нет\_конкурирующих\_поток\_ на функции \<func >. В противном случае возможно гонки. Переменной \<var > должна быть защищена блокировкой \<блокировки >.
