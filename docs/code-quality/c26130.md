...
ms.locfileid: "74879169"
---
# <a name="c26130"></a>C26130
Warning C26130: Missing \_требуется\_Lock\_удерживается\_(\<Lock >) или \_не\_конкурирующих\_Thread\_ в функции \<Func >. В противном случае возможно состояние гонки. Переменная \<var > должна быть защищена блокировкой \<Lock >.
