---
title: 'CA5399: определенно отключить проверку списка отзыва сертификатов HttpClient'
...
ms.locfileid: "84184887"
---
# <a name="ca5399-definitely-disable-httpclient-certificate-revocation-list-check"></a>CA5399: определенно отключить проверку списка отзыва сертификатов HttpClient
