...
8. Скопируйте следующий код и вставьте его в *Bug.cpp* файла в редакторе Visual Studio.
...
8. Скопируйте следующий код и вставьте его в *annotations.cpp* файла в редакторе Visual Studio.
