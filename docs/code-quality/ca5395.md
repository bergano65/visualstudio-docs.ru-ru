---
title: 'CA5395: атрибут промаха Хттпверб для методов действия'
...
ms.locfileid: "85289738"
---
# <a name="ca5395-miss-httpverb-attribute-for-action-methods"></a>CA5395: атрибут промаха Хттпверб для методов действия
