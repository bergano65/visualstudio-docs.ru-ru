---
title: CA0054 | Документы Microsoft
ms.custom: ''
ms.date: 10/19/2016
ms.technology:
...
Пользовательская сборка правил содержит недопустимые XML-ресурсы  
 ...
 Это происходит, если пользовательская сборка правил содержит недопустимые XML-ресурсы, описывающие эти правила. Неправильный формат выглядит следующим образом:  
