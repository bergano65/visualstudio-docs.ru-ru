---
title: 'CA2300: Не используйте небезопасных десериализатор BinaryFormatter'
ms.date: 04/05/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
---
# <a name="ca2300-do-not-use-insecure-deserializer-binaryformatter"></a>CA2300: Не используйте небезопасных десериализатор BinaryFormatter
