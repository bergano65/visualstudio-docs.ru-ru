 ...
 **Ошибка политики анализа кода. В проекте возникли ошибки {0} или построение не обновлен.**
 ...
 **Версия "{0}" не подходит. Имеет строгое имя, указанное в политике "{1}".**
 ...
 **"{0}" сборка, заданная в политике не существует.**
 ...
 **Проект {0} параметры правила не соответствуют политике анализа кода.**
 ...
 **Анализ кода не включен в активной конфигурации. Переключитесь в конфигурации {0} и постройте проект {1} перед возвратом.**
