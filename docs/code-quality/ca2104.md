...
Поля массива, доступные только для чтения, исключены из этого правила, но вызывают нарушение [CA2105: Поля массивов не должны быть доступны только для чтения в правиле @ no__t-0.
