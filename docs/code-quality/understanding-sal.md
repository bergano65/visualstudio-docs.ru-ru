...
### <a name="example-the-_in_-annotation"></a>Пример \_В\_ заметке
...
### <a name="example-the-_in_opt_-annotation"></a>Пример В заметке opt\_ \_ \_
...
### <a name="example-the-_out_opt_-annotation"></a>Пример \_\_Аннотация out\_
...
### <a name="example-the-_inout_opt_-annotation"></a>Пример Аннотация \_по\_требованию\_ для InOut
...
### <a name="example-the-_outptr_opt_-annotation"></a>Пример \_\_Аннотация аутптр\_
...
Заметка приводит к тому, что Visual Studio Codeный анализ проверит, что вызывающий объект передает указатель, `pInt`отличный от NULL, в буфер для и что буфер инициализируется функцией перед возвратом. `_Out_`
