...
Это правило срабатывает, если для экземпляра [Newtonsoft.Json.JsOnserializeа](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) выполняется оба следующих условия:
