...
В методах завершения должен использоваться модификатор доступа из семейства. Это правило обеспечивается компиляторами C#, Visual Basic и. C++
