---
title: 'CA5376: использование Шаредакцесспротокол Хттпсонли'
...
ms.locfileid: "85289747"
---
# <a name="ca5376-use-sharedaccessprotocol-httpsonly"></a>CA5376: использование Шаредакцесспротокол Хттпсонли
