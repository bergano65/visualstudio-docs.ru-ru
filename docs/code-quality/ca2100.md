...
То же самое применимо при использовании `ToString()` неявно.
...
- [Общие сведения о безопасности для служб R SQL Server](/dotnet/framework/data/adonet/security-overview)
