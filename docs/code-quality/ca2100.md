...
Обратите внимание, что это правило нарушается, если метод ToString типа используется явно или неявно для создания строки запроса. Ниже приведен пример.
