...
[C26448 USE_GSL_FINALLY](c26448.md) Используйте `gsl::finally`, если предполагалось финальное действие. См. в разделе [C++ Core Guidelines: GSL.util: служебные программы](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#SS-utilities).
