...
ms.locfileid: "74877947"
---
# <a name="c6332"></a>C6332
предупреждение C6332: недопустимый параметр: передача нуля в качестве параметра Двфритипе в \<функции > запрещено. В результате возникает сбой вызова.
