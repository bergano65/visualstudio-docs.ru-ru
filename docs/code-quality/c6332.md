...
ms.locfileid: "72017554"
---
# <a name="c6332"></a>C6332
C6332 предупреждения: Недопустимый параметр: передача нуля в качестве параметра Двфритипе в \<function > не разрешена. Это приводит к сбою этого вызова
