...
Не удалось загрузить файл набора правил или один из его зависимых файлов наборов правил.  
 ...
 Изучите **путь** все значения атрибута **Include** элементов. Включить пути можно использовать относительные пути к родительским или текущая файл набора правил, переменные среды и абсолютные пути. Например:  
