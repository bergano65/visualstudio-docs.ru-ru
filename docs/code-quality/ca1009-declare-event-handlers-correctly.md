...
## <a name="see-also"></a>См. также
 <xref:System.EventArgs?displayProperty=fullName> <xref:System.Object?displayProperty=fullName> [Обработка и вызов событий](/dotnet/standard/events/index)