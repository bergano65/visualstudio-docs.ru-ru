...
## <a name="see-also"></a>См. также
 <xref:System.Security.SuppressUnmanagedCodeSecurityAttribute?displayProperty=fullName> [Правила написания безопасного кода](/dotnet/standard/security/secure-coding-guidelines) [данных и моделирование](/dotnet/framework/data/index) [требования связывания](/dotnet/framework/misc/link-demands)
