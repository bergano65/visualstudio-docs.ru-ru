...
В этом пошаговом руководстве представлены шаги по процесс с помощью функций анализа кода для анализа вашей сборок управляемого кода .NET на соответствие рекомендациям по .NET.
