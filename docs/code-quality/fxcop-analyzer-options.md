...
| Описание | Допустимые значения | Значение по умолчанию | Настраиваемые правила |
| - | - | - | - |
| Следует ли исключить из правила [Параметры типа](/dotnet/csharp/programming-guide/generics/generic-type-parameters) из одного символа, например `S` в `Collection<S>` | `true`<br/>`false` | `false` | [CA1715](ca1715.md) |
