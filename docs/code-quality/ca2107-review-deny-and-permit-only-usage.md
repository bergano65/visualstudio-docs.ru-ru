...
## <a name="rule-description"></a>Описание правила
 <xref:System.Security.CodeAccessPermission.Deny%2A?displayProperty=fullName> Действие по обеспечению безопасности должен использоваться только те, кто имеет специальными знаниями в области из [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] безопасности. Код, который использует эти действия безопасности, должен быть тщательно проанализирован на предмет безопасности.
