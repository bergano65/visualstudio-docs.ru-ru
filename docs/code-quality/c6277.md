...
ms.locfileid: "72017968"
---
# <a name="c6277"></a>C6277
C6277 предупреждения: ПУСТое имя приложения с путем, не заключенным в кавычки, в вызове \<function >: приводит к уязвимости системы безопасности, если путь содержит пробелы
