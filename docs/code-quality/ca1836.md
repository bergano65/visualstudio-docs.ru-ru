---
title: 'CA1836: предпочитать IsEmpty для счетчика, если доступно'
ms.date: 06/09/2020
ms.topic: reference
f1_keywords:
- UseCountProperly
...
ms.locfileid: "86454269"
---
# <a name="ca1836-prefer-isempty-over-count-when-available"></a>CA1836: предпочитать IsEmpty для счетчика, если доступно
