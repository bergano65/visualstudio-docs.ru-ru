...
Чтобы создать настраиваемый набор правил, можно открыть набор встроенных правил в **редакторе набора правил**. После этого можно добавить или удалить определенные правила, а также изменить действие, возникающее при нарушении правила&mdash;например, отобразить предупреждение или ошибку.
...
3. Выберите **\<выберите несколько наборов правил, >** из **набора выполнять этот набор правил**.

::: moniker-end

::: moniker range=">=vs-2019"

3. Выберите **\<выберите несколько наборов правил >** из **активных правил**.
...
## <a name="rule-precedence"></a>Приоритет правила
...
Чтобы изменить отображаемое имя набора правил, открытого в редакторе, откройте окно « **Свойства** », выбрав в строке меню **вид** > **Свойства** . Введите отображаемое имя в поле **имя** . Можно также ввести описание набора правил.
