...
Чтобы создать настраиваемый набор правил, можно открыть набор встроенных правил в **редакторе набора правил**. После этого можно добавить или удалить определенные правила, а также изменить действие, возникающее при нарушении правила @ no__t-0for, а также отобразить предупреждение или ошибку.
...
1. Выберите **файл** > **Новый** **файл** >  или нажмите клавиши **CTRL**+**N**.
...
3. Выберите **\<Choose несколько наборов правил, >** из **набора выполнять этот набор правил**.

::: moniker-end

::: moniker range=">=vs-2019"

3. Выберите **\<Choose несколько наборов правил >** из **активных правил**.
...
- Если одно и то же правило указано в наборе правил с *одинаковой* степенью серьезности, в **Список ошибок**может появиться следующее предупреждение:
   ...
   @NO__T 0CA0063: Не удалось загрузить файл набора правил "\[your]. RuleSet" или один из его зависимых файлов набора правил. Файл не соответствует схеме набора правил. **
...
Чтобы изменить отображаемое имя набора правил, открытого в редакторе, откройте окно **Свойства** , выбрав **вид** > **окно свойств** в строке меню. Введите отображаемое имя в поле **имя** . Можно также ввести описание набора правил.
...
- [Практическое руководство. Настройка анализа кода для проекта управляемого кода @ no__t-0
