...
> [!NOTE]
> В реализации этого правила с помощью средства FxCop Analyzer также входят функции [правила CA1053](../code-quality/ca1053-static-holder-types-should-not-have-constructors.md).
