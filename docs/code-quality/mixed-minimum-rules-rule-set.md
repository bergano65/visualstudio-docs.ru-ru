...
ms.locfileid: "81649308"
---
# <a name="mixed-minimum-rules-rule-set"></a>Набор правил "Минимальные правила для смешанного кода"

Минимальные правила Microsoft Mixed сосредоточены на самых важных проблемах в проектах C++, поддерживающих среду CLR, включая потенциальные бреши в системе безопасности и сбои приложений.
