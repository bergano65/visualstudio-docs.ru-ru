...
Нарушение этого правила можно отключить, если предполагается создание копии. Кроме [обычных способов отключения предупреждений анализа кода](in-source-suppression-overview.md), можно также добавить явное приведение, чтобы избежать предупреждения.
