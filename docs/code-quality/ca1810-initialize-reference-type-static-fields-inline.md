...
Обратите внимание на добавление `beforefieldinit` флага в определении MSIL `NoStaticConstructor` для класса.
...
- [CA2207: Встроенная Инициализация статических полей типа значения](../code-quality/ca2207-initialize-value-type-static-fields-inline.md)