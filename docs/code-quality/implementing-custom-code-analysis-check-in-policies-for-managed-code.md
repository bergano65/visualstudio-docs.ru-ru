---
title: Реализация пользовательских политик анализом кода возврата для управляемого кода в Visual Studio | Документы Microsoft
ms.date: 11/04/2016
...
## <a name="create-the-team-project-custom-check-in-rule-set"></a>Создание набора настраиваемое правило командного проекта
...
1. В командном обозревателе разверните узел командного проекта и нажмите кнопку **системы управления версиями**.
...
4. [Укажите правила](../code-quality/how-to-create-a-custom-rule-set.md) следует включить в наборе правил, а затем сохранить правило для файла набора, созданную папку набора правил.
...
## <a name="synchronize-code-projects-to-the-check-in-policy-rule-set"></a>Синхронизация проектов кода в набор правил политики возврата
