...
Можно использовать функции отслеживания рабочего элемента для журнала рабочего элемента из среды Visual Studio. Чтобы воспользоваться этой функцией, проект должен быть командный проект в [!INCLUDE[esprfound](../code-quality/includes/esprfound_md.md)].
...
2. Выберите **действия**, затем выберите **создать рабочий элемент** и выберите тип создаваемого рабочего элемента.
     ...
     Следует указать сведения дефект создается новый рабочий элемент.
...
2. Пункты **создать рабочий элемент** и выберите тип создаваемого рабочего элемента.
     ...
     Один рабочий элемент создается для всех выбранных предупреждений следует указать сведения об ошибках.