---
title: 'CA3012: Просмотр кода для уязвимости к внедрению регулярных выражений'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "59018587"
---
# <a name="ca3012-review-code-for-regex-injection-vulnerabilities"></a>CA3012: Просмотр кода для уязвимости к внедрению регулярных выражений
