...
|[C28023](../code-quality/c28023.md)|Назначенная или передаваемая функция должна иметь \_функцию\_класса\_ заметку по крайней мере для одного из классов.|
...
|[C28205](../code-quality/c28205.md)|\_успешное\_ или \_\_сбоя\_ использован в недопустимом контексте|
...
|[C28213](../code-quality/c28213.md)|\_использовать аннотации\_decl\_\_ заметки, которые необходимо использовать для ссылки, без изменения, перед объявлением.|
...
|[C28275](../code-quality/c28275.md)|Параметр для \_макроса\_значение\_ имеет значение null|
