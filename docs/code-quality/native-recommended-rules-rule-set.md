...
|[C28023](../code-quality/c28023.md)|Назначаемая или передаваемая функция должна иметь \_функция\_класс\_ заметки для по крайней мере для одного из классов|
...
|[C28244](../code-quality/c28244.md)|Аннотация для функции содержит нераспознанным параметра или внешнюю аннотацию|
