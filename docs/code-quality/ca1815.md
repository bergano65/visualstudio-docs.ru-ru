...
- @NO__T 0CA2224: Переопределить Equals при перегрузке оператора равным @ no__t-0
...
- @NO__T 0CA2226: Операторы должны иметь симметричную перегрузку @ no__t-0
