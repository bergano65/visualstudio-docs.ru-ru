...
Azure Repos предоставляет две модели управления версиями: Git, распределенную систему контроля версий, и систему управления версиями Team Foundation (TFVC), централизованную систему контроля версий. В этой статье представлены общие сведения и отправная точка для использования TFVC в Visual Studio для Mac.
