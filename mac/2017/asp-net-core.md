...
![Диалоговое окно "Новый проект"](media/asp-net-core-image1.png)

Отображается диалоговое окно "Новый проект", где можно выбрать шаблон для создания приложения.

Существует несколько проектов с готовым шаблоном для создания приложения ASP.NET Core. а именно:
...
- Документы по [ASP.NET Core](/aspnet/core/#build-web-apis-and-web-ui-using-aspnet-core-mvc).
