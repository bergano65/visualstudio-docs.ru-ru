...
- Организация или коллекция Azure DevOps Services — отображает все организации, подключенные к учетной записи Майкрософт, под которой вы вошли в систему.
...
1. Войдите в организацию Azure DevOps Services в качестве владельца (https://dev.azure.com/{organization}/{project}).
