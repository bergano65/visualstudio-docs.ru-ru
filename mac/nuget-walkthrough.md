...
![Контекстное меню "Зависимости" с выделенной командой "Обновить"](media/nuget-walkthrough-packages-menu-update.png)
...
### <a name="updating-to-pre-release-versions-of-packages"></a>Обновление до предварительных выпусков версий пакетов
...
![Контекстное меню "Зависимости "с выделенным пунктом "Управление пакетами NuGet..."](media/nuget-walkthrough-packages-menu-manage-nuget-packages.png)

Установите флажок **Показать пакеты предварительного выпуска** в нижней части диалогового окна.

![Открытое диалоговое окно "Управление пакетами NuGet" с выбранным параметром "Показать пакеты предварительного выпуска"](media/nuget-walkthrough-show-pre-release-packages.png)
...
![Диалоговое окно "Управление пакетами NuGet", открытое на вкладке "Установленные", с выбранным пакетом и открытым раскрывающимся списком "Новая версия".](media/nuget-walkthrough-packages-nuget-dialog-update-installed-package.png)
...
![Диалоговое окно "Добавление источника пакета" с запросом на ввод имени, URL-адреса расположения, имени пользователя и пароля.](media/nuget-walkthrough-PackageSource2.png)

После этого при поиске пакетов можно выбрать различные источники:

![Диалоговое окно "Добавление источника пакета", в котором отображается раскрывающийся список источников пакетов.](media/nuget-walkthrough-PackageSource3.png)
