...
## [Настройка интерфейса IDE](customizing-the-ide.md)
## [Расширение Visual Studio для Mac](extending-visual-studio-mac.md)

# Проекты и решения
## [Обзор](projects-and-solutions.md)
...
## Docker
### [Начало работы с Docker](docker-quickstart.md)
### [Создание многоконтейнерного приложения с Docker Compose](docker-multi-container.md)
...
# [Заметки о выпуске](/visualstudio/releasenotes/vs2019-mac-relnotes)
# [Предварительные заметки о выпуске](/visualstudio/releasenotes/vs2019-mac-preview-relnotes)
# Примеры
## [Подборка примеров](samples/index.yml)
## [Все примеры ASP.NET Core](/samples/browse/?products=aspnet-core)
## [Все примеры .NET Core](/samples/browse/?products=dotnet-core)
## [Все примеры Xamarin.Forms](/xamarin/xamarin-forms/samples/)
## [Все образцы Xamarin.iOS](/xamarin/ios/samples/)
## [Все примеры Xamarin.Android](/xamarin/android/samples/)
## [Все образцы Xamarin.Mac](/xamarin/mac/samples/)
