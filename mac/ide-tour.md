...
## <a name="visual-studio-for-mac-2019-start-window"></a>Окно запуска Visual Studio для Mac 2019

> [!TIP]
> Предварительная версия Visual Studio 2019 для Mac [доступна для загрузки](install-preview.md) и тестирования.

При запуске предварительной версии Visual Studio для Mac 2019 новые пользователи увидят окно входа. Войдите с учетной записью Майкрософт, чтобы активировать платную лицензию (если она у вас есть) или связать ее с подписками Azure. Можно нажать клавишу **Пропустить** и войти в систему позднее с помощью пункта меню **Visual Studio > Вход**:
...
## <a name="welcome-screen-in-visual-studio-for-mac-2017"></a>Экран приветствия в Visual Studio для Mac 2017
